---
description: Возвращает среднюю частоту кадров содержимого видео в кадрах в секунду.
...
ms.locfileid: "104262416"
---
# <a name="avencstatvideooutputframerate-property"></a>Авенкстатвидеуутпутфрамерате, свойство

Возвращает среднюю частоту кадров содержимого видео в кадрах в секунду.
...
**КОДЕКАПИ \_ авенкстатвидеуутпутфрамерате**
