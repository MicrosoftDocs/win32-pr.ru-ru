...
-   **SetLength** указывает длину допустимых данных в буфере.

Для обработки на месте интерфейс **имедиабуффер** не требуется. В следующем коде показана минимальная реализация **имедиабуффер**:
