...
ms.locfileid: "119330454"
---
# <a name="finland-channel-assignments"></a>Назначения каналов Финляндии

В этом разделе перечислены частоты таблиц, используемых для настройки аналогового ТВ-телевидения для Финляндии.
