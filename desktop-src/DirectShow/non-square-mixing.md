...
В режиме смешения с квадратом VMR-9 выбирает один входной поток в качестве целевого размера и НОМИНАЛа. Микшер VMR не масштабирует видео из этого потока или из других потоков с тем же размером изображения и НОМИНАЛом. Потоки с другим размером или пропорциями масштабируются в соответствии с целевыми НОМИНАЛами и леттербоксед в соответствии с конечным размером выходного изображения.
