---
description: Указывает, создает ли кодировщик закодированные поля или закодированные фреймы. Это свойство применяется к кодировщикам видео MPEG.
...
ms.locfileid: "104140319"
---
# <a name="avencmpvframefieldmode-property"></a>Авенкмпвфрамефиелдмоде, свойство

Указывает, создает ли кодировщик закодированные поля или закодированные фреймы. Это свойство применяется к кодировщикам видео MPEG.
...
**КОДЕКАПИ \_ авенкмпвфрамефиелдмоде**
