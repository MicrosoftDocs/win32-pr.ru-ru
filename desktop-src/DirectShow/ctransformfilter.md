...
В зависимости от фильтра может потребоваться зарегистрировать некоторые типы носителей, поддерживаемые фильтром, чтобы объект [сопоставителя фильтров](filter-mapper.md) мог нахождение фильтра. дополнительные сведения см. [в статье регистрация DirectShow фильтров](how-to-register-directshow-filters.md).
...
| [**Позиции**](ctransformfilter-stop.md)                                     | Останавливает фильтр.                                                                                       |
