---
description: Метод Жеткуррентсампле не реализован.
ms.assetid: 0c903498-3c1d-4e95-a797-ca8cfded25f2
title: 'Метод Исамплеграббер:: Жеткуррентсампле (Кедит. h)'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117818009"
---
# <a name="isamplegrabbergetcurrentsample-method"></a>Метод Исамплеграббер:: Жеткуррентсампле
...
Метод `GetCurrentSample` не реализован.
