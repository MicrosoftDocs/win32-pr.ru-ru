...
ms.locfileid: "117820399"
---
# <a name="ec_dvd_program_cell_change"></a>\_ \_ \_ изменение ячейки DVD в программе EC \_

Посылается при изменении номера ячейки или номера этой программы DVD.
