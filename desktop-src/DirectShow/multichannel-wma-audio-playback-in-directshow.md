...
ms.locfileid: "119830984"
---
# <a name="multichannel-wma-audio-playback-in-directshow"></a>Многоканальное воспроизведение звука WMA в DirectShow

для воспроизведения многоканального Windowsного звукового файла мультимедиа в DirectShow необходимо задать свойство **мфпкэй \_ вмадек \_ хиресаутпут** непосредственно в декодере после его подключения к модулю чтения WM ASF. это свойство определено в файле заголовка вмкодекдсп. h, который доступен в Windows SDK.
...
Эти шаги демонстрируются в следующих фрагментах кода. В этом коде предполагается, что исходный файл содержит аудиопоток и не имеет потока видео. видеокодек DMO не поддерживает свойство **мфпкэй \_ вмадек \_ хиресаутпут** .
