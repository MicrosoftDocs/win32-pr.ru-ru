...
Индексы частоты в таблицах Великобритании не подходят для использования в качестве номеров каналов.

### <a name="united-kingdom-broadcast-assignments"></a>Широковещательные назначения для Великобритании
...
### <a name="united-kingdom-cable-assignments"></a>Назначения кабелей Великобритании
