...
---
# <a name="eastern-europe"></a>Восточная Европа

Описание следующих таблиц см. в разделе [таблицы и назначения](tables-and-assignments.md).

Индексы частоты в Восточной Европе не подходят для использования в качестве номеров каналов.

### <a name="eastern-europe-broadcast-assignments"></a>Назначения трансляции Восточной Европы
...
### <a name="eastern-europe-cable-assignments"></a>Назначения кабелей Восточной Европы
