---
description: Метод GetObject извлекает указатель на объект расписания часов.
ms.assetid: ae509f16-d85f-4365-8cf2-c6585cbbdc3d
title: Метод Кбасереференцеклокк. метод Schedule (Рефклокк. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117822840"
---
# <a name="cbasereferenceclockgetschedule-method"></a>Кбасереференцеклокк. метод Schedule

`GetSchedule`Метод получает указатель на объект расписания часов.
