---
description: Добавление поддержки Region-Change в приложение
...
---
# <a name="adding-region-change-support-to-an-application"></a><span data-ttu-id="a5d8c-103">Добавление поддержки Region-Change в приложение</span><span class="sxs-lookup"><span data-stu-id="a5d8c-103">Adding Region-Change Support to an Application</span></span>

<span data-ttu-id="a5d8c-104">Следующие функции предоставляются разработчикам, желающим интегрировать поддержку изменения региона в свои декодеры или DVD-приложения.</span><span class="sxs-lookup"><span data-stu-id="a5d8c-104">The following functions are provided for developers who wish to integrate region-change support into their decoders or DVD applications.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a5d8c-105">См. также</span><span class="sxs-lookup"><span data-stu-id="a5d8c-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a5d8c-106">Поддержка смены региона DVD в Windows</span><span class="sxs-lookup"><span data-stu-id="a5d8c-106">DVD Region Change Support in Windows</span></span>](dvd-region-change-support-in-windows.md)
</dt> </dl>
