...
ms.locfileid: "119813394"
---
# <a name="cpersiststreamcpersiststream-constructor"></a>Кперсистстреам. Кперсистстреам, конструктор
...
Указатель на интерфейс **IUnknown** делегированного объекта.
...
Указатель на общее возвращаемое значение COM. Это значение изменяется только в случае сбоя этой функции.
