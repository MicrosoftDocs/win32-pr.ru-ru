...
ms.locfileid: "119755624"
---
# <a name="video-streaming-sample-code"></a>Пример кода для потоковой передачи видео
...
Этот пример кода считывает файл и готовит его к просмотру на основной поверхности DirectDraw. Для краткости в этом примере выполняется минимальная проверка ошибок.
