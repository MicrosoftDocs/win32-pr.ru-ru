...
Индексы частоты в таблицах Китая подходят для использования в качестве номеров каналов.

### <a name="china-broadcast-assignments"></a>Широковещательные назначения в Китае
...
### <a name="china-cable-assignments"></a>Назначение кабелей в Китае
