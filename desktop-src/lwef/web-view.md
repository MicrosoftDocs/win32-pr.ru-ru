...
Веб-представление — это мощный и гибкий способ использования проводника Windows для отображения сведений о содержимом папки оболочки.
...
> [!Note]  
> Сведения в этом документе не относятся к Windows XP, описанные методики относятся только к предыдущим версиям Windows.
...
Область, доступная для веб-представления, зависит от размера окна веб-представления и объема, занимаемого панелью проводника Windows. Эта область изменяется всякий раз, когда изменяется размер окна или панели проводника Windows. Поэтому макет должен быть сопоставлен с доступной областью, когда веб-представление загружается и соответствующим образом изменяется при изменении размера. Большая часть макета задается в таблице стилей. Область сведений, например, определяется таким образом, чтобы занимать самые левые 30% веб-представления.
