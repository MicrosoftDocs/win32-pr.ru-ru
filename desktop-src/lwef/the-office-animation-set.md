---
title: набор анимации Office
description: набор анимации Office
...
ms.locfileid: "118975554"
---
# <a name="the-office-animation-set"></a>набор анимации Office
...
| **Обдумывание\***          | Нет           | Выполнение сложных вычислений, таких как поиск решения                                                          | Символ выглядит поверх и царапины в головном офисе. Анимация должна иметь быструю запись в цикл, а затем быстро выйти                             |
| **Звуков**                | Нет           | Сопроводительные оповещения                                                                                  | Звуков. Аналогично предупреждению, но не по времени или франтик                                                                                     |
| **Запись\***           | Нет           | Клиент изменяет что-либо в параметрах инструментов; Клиент вводит запрос Интеллисеарч                   | Извлекает панель и запускает каракули. Анимация должна иметь быструю запись в цикл, а затем быстро выйти                                   |
