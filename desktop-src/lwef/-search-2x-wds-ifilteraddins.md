...
-   [Интерфейс иперсистстораже](/windows/win32/api/objidl/nn-objidl-ipersiststorage) — для загрузки данных из структурированного хранилища OLE COM.
...
| Код GUID                                 | пропспек      | Понятное имя  | Описание                                                                                                                                     |
|--------------------------------------|---------------|----------------|-------------------------------------------------------------------------------------------------------------------------------------------------|
...
3.  Зарегистрируйте реализацию IFilter с помощью Windows Desktop Search со следующим ключом и значением:
