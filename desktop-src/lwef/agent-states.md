...
| **Читая**                      | Когда символ считывает что-то, но не принимает входные данные.                                              | Символы считываются из фрагмента бумаги. Примечание. Эта анимация выполняет циклические переходы к некоторым промежуточным кадрам, происходящим после перемещения символа в соответствующую точку.<br/>                                           |
...
| **Текста**                      | Когда символ записывает сведения для пользователя.                                                  | Символьная запись на бумаге. Примечание. Эта анимация выполняет циклы.<br/>                                                                                                                                             |
