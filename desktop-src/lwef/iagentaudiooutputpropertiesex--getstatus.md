...
Этот параметр позволяет клиентскому приложению запрашивать состояние канала вывода звука. С помощью этого метода можно определить, следует ли говорить, что ваш символ говорит, или попытаться включить режим прослушивания (с помощью [**иажентчарактерекс:: Listen**](lwef.iagentcharacterex::listen_method)).
