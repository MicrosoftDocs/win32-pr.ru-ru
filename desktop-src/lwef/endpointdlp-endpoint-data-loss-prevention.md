...
| ENDPOINTDLP_WINDOWS_DEFENDER_REGKEY | "программное обеспечение \\ Microsoft \\ Защитник Windows" | Защитник Windows раздел реестра в разделе HKLM, где хранятся параметры DLP для конечной точки |
