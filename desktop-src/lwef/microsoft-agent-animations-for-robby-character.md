...
| **Читая**               | Да, с использованием ветвей выхода | Нет                | **Да**       | Нет                                         | Печать, чтение и поиск (анимация с \* циклическими операциями)          |
...
| **Обдумывани**              | Нет                       | Нет                | **Да**       | Нет                                         | Заголовок «царапины» ( \* циклическая анимация)                       |
...
| **Текста**               | Да, с использованием ветвей выхода | Нет                | **Да**       | Нет                                         | Показывает карандаш и буфер обмена, записи ( \* циклическая анимация) |
