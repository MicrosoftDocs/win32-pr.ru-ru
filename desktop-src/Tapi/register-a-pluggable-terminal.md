...
ms.locfileid: "119060432"
---
# <a name="register-a-pluggable-terminal"></a>Регистрация подключаемого терминала

Регистрация подключаемого терминала может быть вызвана функцией **DllRegisterServer** компонента, который реализует терминал. Следующий пример кода можно вставить в код для **DllRegisterServer**.
