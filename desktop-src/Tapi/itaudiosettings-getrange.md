...
ms.locfileid: "119992014"
---
# <a name="itaudiosettingsgetrange-method"></a>Метод Итаудиосеттингс:: Range
...
Метод **дальнего действия** извлекает диапазон допустимых значений для заданного [**Свойства звуковых параметров**](audiosettingsproperty.md).
