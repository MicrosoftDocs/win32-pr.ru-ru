...
ms.locfileid: "119518114"
---
# <a name="unregister-a-pluggable-terminal"></a>Отмена регистрации подключаемого терминала

В общем случае этот метод будет вызываться из **DllUnregisterServer**. Приведенный ниже пример кода можно разместить в коде для **DllUnregisterServer**.
