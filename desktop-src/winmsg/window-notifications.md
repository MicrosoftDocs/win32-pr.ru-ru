---
description: Уведомления окна
ms.assetid: f99a572e-110d-4971-a660-e861dbe32cfe
title: Уведомления окна
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "108083362"
---
# <a name="window-notifications"></a>Уведомления окна

## <a name="in-this-section"></a>в этом разделе

-   [**WM \_ активатеапп**](wm-activateapp.md)
-   [**WM \_ канцелмоде**](wm-cancelmode.md)
-   [**WM \_ чилдактивате**](wm-childactivate.md)
-   [**\_Закрыть WM**](wm-close.md)
-   [**\_Сжатие WM**](wm-compacting.md)
-   [**\_Создание WM**](wm-create.md)
-   [**WM \_ destroy**](wm-destroy.md)
-   [**WM \_ DPICHANGED**](../hidpi/wm-dpichanged.md)
-   [**\_Включение WM**](wm-enable.md)
...
-   [**WM \_ нккалксизе**](wm-nccalcsize.md)
-   [**WM \_ нккреате**](wm-nccreate.md)
-   [**WM \_ нкдестрой**](wm-ncdestroy.md)
-   [**WM \_ null**](wm-null.md)
-   [**WM \_ куеридрагикон**](wm-querydragicon.md)
-   [**WM \_ куерйопен**](wm-queryopen.md)
-   [**\_выход WM**](wm-quit.md)
...
-   [**WM \_ семечанжед**](wm-themechanged.md)
-   [**WM \_ усерчанжед**](wm-userchanged.md)
