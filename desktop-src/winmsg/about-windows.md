...
-   [Окна приложений](#application-windows)
...
Окно рабочего стола использует точечный рисунок для рисования фона экрана. Шаблон, созданный точечным рисунком, называется *фоновым рисунком рабочего стола*. По умолчанию окно рабочего стола использует точечный рисунок из BMP-файла, указанного в реестре, в качестве фонового рисунка рабочего стола.
