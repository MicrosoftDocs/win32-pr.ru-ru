...
keywords:
- структурированные служба хранилища стрктд Stg, примеры, вритереад
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "120034744"
---
# <a name="writeread-sample"></a>Пример Вритереад

Вритереад. cpp создает набор свойств, записывает свойство, закрывает и повторно открывает набор свойств и считывает свойство. Этот пример приложения создает файл "Вритереад. STG" в текущем каталоге. Он создает наборы свойств в файле хранилища структуры, но изменение одной строки приводит к созданию наборов свойств файловой системы NTFS.
