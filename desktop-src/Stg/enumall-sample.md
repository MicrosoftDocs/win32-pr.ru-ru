...
keywords:
- структурированные служба хранилища стрктд Stg, примеры, енумалл
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119683034"
---
# <a name="enumall-sample"></a>Пример Енумалл

Пример приложения Енумалл. cpp помещает все свойства во все наборы свойств файла хранилища.
