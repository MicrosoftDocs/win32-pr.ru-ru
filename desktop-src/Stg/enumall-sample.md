---
title: Пример Енумалл
description: Помещает все свойства во все наборы свойств файла хранилища.
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- Структурированное хранилище Стрктд STG, примеры, Енумалл
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104329547"
---
# <a name="enumall-sample"></a><span data-ttu-id="c044e-104">Пример Енумалл</span><span class="sxs-lookup"><span data-stu-id="c044e-104">EnumAll Sample</span></span>

<span data-ttu-id="c044e-105">Пример приложения Енумалл. cpp помещает все свойства во все наборы свойств файла хранилища.</span><span class="sxs-lookup"><span data-stu-id="c044e-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
