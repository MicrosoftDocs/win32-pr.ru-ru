...
ms.locfileid: "119662714"
---
# <a name="ipaperredraw"></a>Ипапер:: перерисовка

Метод **ипапер:: Redraw** основан на технологии точки подключения.

Следующий пример кода — это метод **перерисовки** из документа paper. cpp.
...
Дополнительные сведения см. в разделе метод [**ипаперсинк**](ipapersink-methods.md) .
