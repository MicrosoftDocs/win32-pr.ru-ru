---
description: В следующем примере содержится запрос на \# Обновление PKCS 7. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
ms.assetid: 3752600c-40a9-401b-9949-8536203d7f14
title: '\#Запрос на продление PKCS 7'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105664254"
---
# <a name="pkcs-7-renewal-request"></a>\#Запрос на продление PKCS 7

В следующем примере содержится запрос на \# Обновление PKCS 7. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
