...
---
# <a name="pkcs-7-renewal-request"></a><span data-ttu-id="1487c-105">\#Запрос на продление PKCS 7</span><span class="sxs-lookup"><span data-stu-id="1487c-105">PKCS \#7 Renewal Request</span></span>

<span data-ttu-id="1487c-106">В следующем примере содержится запрос на \# Обновление PKCS 7.</span><span class="sxs-lookup"><span data-stu-id="1487c-106">The following example contains a PKCS \#7 renewal request.</span></span> <span data-ttu-id="1487c-107">Пример был создан с помощью средств Certreq.exe и Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="1487c-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="1487c-108">INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.</span><span class="sxs-lookup"><span data-stu-id="1487c-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="1487c-109">В конфигурации указывается тип запроса (PKCS \# 7) и серийный номер сертификата, на основе которого основан запрос.</span><span class="sxs-lookup"><span data-stu-id="1487c-109">The configuration specifies the type of request (PKCS \#7) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="1487c-110">При этом создаются следующие выходные данные.</span><span class="sxs-lookup"><span data-stu-id="1487c-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1487c-111">См. также</span><span class="sxs-lookup"><span data-stu-id="1487c-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1487c-112">Примеры запросов</span><span class="sxs-lookup"><span data-stu-id="1487c-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
