---
description: В следующем примере содержится запрос PKCS \# 7 "регистрация от имени" (еобо). Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
ms.assetid: e9e54f26-223d-493a-b4d5-ca7c2bd22756
title: '\#Запрос PKCS 7 еобо'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105684165"
---
# <a name="pkcs-7-eobo-request"></a>\#Запрос PKCS 7 еобо

В следующем примере содержится запрос PKCS \# 7 "регистрация от имени" (еобо). Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
