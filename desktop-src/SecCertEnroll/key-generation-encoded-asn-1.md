---
description: В следующем примере содержится запрос на создание ключа, показанный в формате ASN. 1.
ms.assetid: d08c33f8-f372-44d3-8c8e-a26440e85c34
title: Создание ключа, закодированное ASN. 1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105663631"
---
# <a name="key-generation-encoded-asn1"></a><span data-ttu-id="a1210-103">Создание ключа, закодированное ASN. 1</span><span class="sxs-lookup"><span data-stu-id="a1210-103">Key Generation Encoded ASN.1</span></span>

<span data-ttu-id="a1210-104">В следующем примере содержится запрос на создание ключа, показанный в формате ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="a1210-104">The following example contains a key generation request shown in ASN.1 format.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a1210-105">См. также</span><span class="sxs-lookup"><span data-stu-id="a1210-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a1210-106">Примеры запросов</span><span class="sxs-lookup"><span data-stu-id="a1210-106">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
