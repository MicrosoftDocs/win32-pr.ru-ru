...
ms.locfileid: "119993594"
---
# <a name="key-generation-encoded-asn1"></a>Создание ключа, закодированное ASN. 1

В следующем примере содержится запрос на создание ключа, показанный в формате ASN. 1.
