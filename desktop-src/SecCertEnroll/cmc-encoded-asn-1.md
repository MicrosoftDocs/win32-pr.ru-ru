---
description: В следующем примере содержится запрос CMC, показанный в формате ASN. 1. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
ms.assetid: 57e99f2c-76c3-4b4c-8e78-9b45bfa55d9a
title: В формате CMC с кодировкой ASN. 1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118902030"
---
# <a name="cmc-encoded-asn1"></a>В формате CMC с кодировкой ASN. 1

В следующем примере содержится запрос CMC, показанный в формате ASN. 1. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
