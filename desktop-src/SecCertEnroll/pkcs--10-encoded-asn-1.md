---
description: Следующий пример содержит \# запрос PKCS 10, показанный в формате ASN. 1. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
...
Следующий пример содержит \# запрос PKCS 10, показанный в формате ASN. 1. Пример был создан с помощью средств Certreq.exe и Certutil.exe. INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.
...
Эта конфигурация создает следующий пример выходных данных. В конфигурации указывается субъект, тип запроса (PKCS \# 10) и шаблон сертификата (пользователь). В пользовательском шаблоне указывается следующее:
