...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="c6968-105">Запрос на продление CMC</span><span class="sxs-lookup"><span data-stu-id="c6968-105">CMC Renewal Request</span></span>

<span data-ttu-id="c6968-106">В следующем примере содержится запрос на обновление CMC.</span><span class="sxs-lookup"><span data-stu-id="c6968-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="c6968-107">Пример был создан с помощью средств Certreq.exe и Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="c6968-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="c6968-108">INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.</span><span class="sxs-lookup"><span data-stu-id="c6968-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="c6968-109">В конфигурации указывается тип запроса (CMC) и серийный номер сертификата, на основе которого основан запрос.</span><span class="sxs-lookup"><span data-stu-id="c6968-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="c6968-110">При этом создаются следующие выходные данные.</span><span class="sxs-lookup"><span data-stu-id="c6968-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c6968-111">См. также</span><span class="sxs-lookup"><span data-stu-id="c6968-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c6968-112">Примеры запросов</span><span class="sxs-lookup"><span data-stu-id="c6968-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
