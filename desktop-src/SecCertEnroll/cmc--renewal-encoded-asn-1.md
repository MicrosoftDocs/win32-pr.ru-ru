...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="fc2e2-105">Обновление CMC в кодировке ASN. 1</span><span class="sxs-lookup"><span data-stu-id="fc2e2-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="fc2e2-106">В следующем примере содержится запрос обновления CMC, показанный в формате ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="fc2e2-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="fc2e2-107">Пример был создан с помощью средств Certreq.exe и Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="fc2e2-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="fc2e2-108">INF-файл, используемый в качестве входных данных для Certreq.exe, содержит следующую конфигурацию.</span><span class="sxs-lookup"><span data-stu-id="fc2e2-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="fc2e2-109">В конфигурации указывается тип запроса (CMC) и серийный номер сертификата, на основе которого основан запрос.</span><span class="sxs-lookup"><span data-stu-id="fc2e2-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="fc2e2-110">При этом создаются следующие выходные данные.</span><span class="sxs-lookup"><span data-stu-id="fc2e2-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="fc2e2-111">См. также</span><span class="sxs-lookup"><span data-stu-id="fc2e2-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="fc2e2-112">Примеры запросов</span><span class="sxs-lookup"><span data-stu-id="fc2e2-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
