...
-   *Остановлена*. Часы презентации остановлены. Выступающий отклоняет все запланированные выборки.
