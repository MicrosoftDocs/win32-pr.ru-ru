...
-   [сетенкодингтипе](#setencodingtype)
-   [сетинпуттипе](#setinputtype)
-   [жетаутпуттипе](#getoutputtype)
...
В Media Foundation кодировщики реализуются как [Media Foundation преобразования](media-foundation-transforms.md) (МФТС) и предоставляют интерфейс [**имфтрансформ**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) .
...
`Initialize`Метод создает экземпляр кодировщика WMA.
...
## <a name="setencodingtype"></a>сетенкодингтипе
...
## <a name="setinputtype"></a>сетинпуттипе
...
## <a name="getoutputtype"></a>жетаутпуттипе
