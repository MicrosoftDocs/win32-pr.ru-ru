...
ms.locfileid: "117871280"
---
# <a name="using-the-sample-grabber-sink"></a>Использование приемника образца захвата

Приемник образца захвата — это приемник мультимедиа, который перенаправляет полученные данные в интерфейс обратного вызова приложения.

> [!Note]  
> [Модуль чтения исходного кода](source-reader.md) является альтернативой приемнику образца захвата и имеет более простую модель программирование.

 

## <a name="1-implement-the-callback-interface"></a>1. Реализация интерфейса обратного вызова
...
## <a name="2-create-the-sample-grabber-sink"></a>2. Создание приемника образца захвата
...
## <a name="3-create-a-topology"></a>3. Создание топологии
...
## <a name="4-run-the-media-session"></a>4. Запуск сеанса мультимедиа
...
Ниже приведен полный пример кода для этого раздела.
