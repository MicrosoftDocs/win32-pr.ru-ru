...
Media Foundation использовать модель *извлечения* , в которой конвейер запрашивает образцы из источника мультимедиа. это отличается от модели, используемой DirectShow, в которой отправляются образцы источников push-уведомлений.
