...
Указывает, должна ли в образце выделения MFT (SA) выделять базовую текстуру Direct3D с помощью флага [D3D11_RESOURCE_MISC_SHARED_DISPLAYABLE](/windows/win32/api/d3d11/ne-d3d11-d3d11_resource_misc_flag) . 
...
Уровень платформы Media Foundation задает атрибут **MF_SA_D3D11_ALLOCATE_DISPLAYABLE_RESOURCES** при отрисовке видео. Приложение также может установить этот атрибут, если требуется реализовать собственный модуль подготовки видео и использовать D3D11 ресурсы. 

## <a name="example"></a>Пример

В следующем примере кода показано использование атрибута **MF_SA_D3D11_ALLOCATE_DISPLAYABLE_RESOURCES** .
