...
Видеодекодер MPEG4 Part 2 поддерживает следующие выходные типы выходных данных, когда он выступает в качестве DMO.
...
## <a name="interfaces-for-the-dmo"></a>Интерфейсы для DMO

если вы создаете в качестве DMO экземпляр видеодекодера MPEG4 Part 2, декодер предоставляет следующие интерфейсы.
...
| Профиль         | Уровень | Типичное разрешение |
|-----------------|-------|--------------------|
