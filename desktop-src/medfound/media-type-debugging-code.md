---
description: Для просмотра содержимого типа мультимедиа во время отладки можно использовать следующий код.
ms.assetid: 1132c936-c3a7-4d98-bc90-957c170d307a
title: Код отладки типа носителя
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105693872"
---
# <a name="media-type-debugging-code"></a><span data-ttu-id="2171e-103">Код отладки типа носителя</span><span class="sxs-lookup"><span data-stu-id="2171e-103">Media Type Debugging Code</span></span>

<span data-ttu-id="2171e-104">Для просмотра содержимого типа мультимедиа во время отладки можно использовать следующий код.</span><span class="sxs-lookup"><span data-stu-id="2171e-104">You can use the following code to view the contents of a media type while debugging.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2171e-105">См. также</span><span class="sxs-lookup"><span data-stu-id="2171e-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2171e-106">Атрибуты типа мультимедиа</span><span class="sxs-lookup"><span data-stu-id="2171e-106">Media Type Attributes</span></span>](media-type-attributes.md)
</dt> <dt>

[<span data-ttu-id="2171e-107">Типы носителей</span><span class="sxs-lookup"><span data-stu-id="2171e-107">Media Types</span></span>](media-types.md)
</dt> <dt>

[<span data-ttu-id="2171e-108">**имфмедиатипе**</span><span class="sxs-lookup"><span data-stu-id="2171e-108">**IMFMediaType**</span></span>](/windows/desktop/api/mfobjects/nn-mfobjects-imfmediatype)
</dt> </dl>
