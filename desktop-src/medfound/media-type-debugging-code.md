...
ms.locfileid: "118974193"
---
# <a name="media-type-debugging-code"></a>Код отладки типа носителя

Для просмотра содержимого типа мультимедиа во время отладки можно использовать следующий код.
