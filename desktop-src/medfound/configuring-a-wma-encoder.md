...
-   Свойства конфигурации, заданные для кодировщика.
    ...
    свойства конфигурации описаны в документации по api-кодекам Windows Media Audio, Video и DSP. Дополнительные сведения см. в разделе "свойства аудиопотока в [свойствах кодировки](configuring-the-encoder.md)".
