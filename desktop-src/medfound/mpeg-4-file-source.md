...
если установлено обновление платформы для Windows Vista, источник файлов MPEG-4 доступен в Windows Vista, но доступен только в Windows Vista только с помощью [модуля чтения исходного кода](source-reader.md).
...
-   файлы размером более 4 гигабайт (гб) поддерживаются в Windows 8 приемника MPEG-4 для нефрагментированного MP4.
