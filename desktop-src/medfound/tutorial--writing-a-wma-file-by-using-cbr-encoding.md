...
-   вы знакомы с Windows кодировщиками мультимедиа и различными типами кодировок, особенно CBR. дополнительные сведения см. в разделе [Windows Media encoders](windows-media-encoders.md) .
