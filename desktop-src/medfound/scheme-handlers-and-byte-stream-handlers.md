...
где *<scheme>* — это схема URL-адресов, которую обработчик предназначен для синтаксического анализа. Схема включает символ ":" в конце; Например, "http:".
...
где *<ExtensionOrMimeType>* — это расширение имени файла или тип MIME. Расширения файлов включают в себя начальный символ "."; Например, ". wmv".
