...
Каждый дескриптор презентации содержит список из одного или нескольких *потоковых дескрипторов*. Они описывают потоки в презентации. Можно выбрать или отменить выбор потоков. Данные создаются только выбранными потоками. Невыбранные потоки не являются активными и не создают никаких данных. Каждый дескриптор потока имеет *обработчик типа мультимедиа*, который используется для изменения типа носителя потока или получения текущего типа мультимедиа потока. (Дополнительные сведения о типах носителей см. в разделе [типы носителей](media-types.md).)
