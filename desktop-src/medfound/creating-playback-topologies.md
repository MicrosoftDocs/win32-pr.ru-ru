...
-   [Подключение потоков к приемникам мультимедиа](#connecting-streams-to-media-sinks)
...
## <a name="connecting-streams-to-media-sinks"></a>Подключение потоков к приемникам мультимедиа
