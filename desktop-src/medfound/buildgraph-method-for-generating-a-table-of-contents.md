...
ms.locfileid: "104342565"
---
# <a name="buildgraph-function-for-generating-a-table-of-contents"></a><span data-ttu-id="ee283-103">Функция Буилдграф для создания оглавления</span><span class="sxs-lookup"><span data-stu-id="ee283-103">BuildGraph Function for Generating a Table of Contents</span></span>

<span data-ttu-id="ee283-104">Следующая функция является вспомогательной функцией в примере программы, которая обсуждается в разделе [Создание](generating-a-table-of-contents-automatically.md)оглавления автоматически.</span><span class="sxs-lookup"><span data-stu-id="ee283-104">The following function is a helper function in an example program that is discussed in [Generating a Table of Contents Automatically](generating-a-table-of-contents-automatically.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="ee283-105">См. также</span><span class="sxs-lookup"><span data-stu-id="ee283-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="ee283-106">Автоматическое формирование оглавления</span><span class="sxs-lookup"><span data-stu-id="ee283-106">Generating a Table of Contents Automatically</span></span>](generating-a-table-of-contents-automatically.md)
</dt> </dl>
