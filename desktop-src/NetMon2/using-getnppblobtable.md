...
ms.locfileid: "119962794"
---
# <a name="using-getnppblobtable"></a>Использование Жетнппблобтабле

В следующем примере показано, как использовать функцию [**жетнппблобтабле**](getnppblobtable.md) для получения таблицы больших двоичных объектов НПП, представляющей зарегистрированные сетевые адаптеры на локальном компьютере.
