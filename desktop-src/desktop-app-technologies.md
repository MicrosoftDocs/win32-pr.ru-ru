...
---
# <a name="desktop-app-technologies"></a><span data-ttu-id="a943f-103">Технологии классических приложений</span><span class="sxs-lookup"><span data-stu-id="a943f-103">Desktop app technologies</span></span>

<span data-ttu-id="a943f-104">В этом разделе содержатся подробные инструкции и примеры кода о функциях Windows, доступных для классических приложений с помощью API Win32.</span><span class="sxs-lookup"><span data-stu-id="a943f-104">This section provides in-depth guidance and code examples about Windows features that are available to desktop applications by using the Win32 API.</span></span>

## <a name="in-this-section"></a><span data-ttu-id="a943f-105">В этом разделе</span><span class="sxs-lookup"><span data-stu-id="a943f-105">In this section</span></span>

| <span data-ttu-id="a943f-106">Раздел</span><span class="sxs-lookup"><span data-stu-id="a943f-106">Topic</span></span> | <span data-ttu-id="a943f-107">Описание</span><span class="sxs-lookup"><span data-stu-id="a943f-107">Description</span></span>  |  
|----------------------------------|---|
| [<span data-ttu-id="a943f-108">Специальные возможности</span><span class="sxs-lookup"><span data-stu-id="a943f-108">Accessibility</span></span>](accessibility/accessibility.md) | <span data-ttu-id="a943f-109">Предоставляет рекомендации для разработчиков Windows, создающих доступные приложения, разработчики вспомогательных технологий, такие как средства чтения с экрана и экранные лупы, а также инженеры по тестированию программного обеспечения, создающие автоматизированные сценарии для тестирования приложений Windows.</span><span class="sxs-lookup"><span data-stu-id="a943f-109">Provides guidance for Windows developers designing accessible applications, assistive technology developers building tools such as screen readers and magnifiers, and software test engineers creating automated scripts for testing Windows applications.</span></span> |
| [<span data-ttu-id="a943f-110">Пользовательский интерфейс классического приложения</span><span class="sxs-lookup"><span data-stu-id="a943f-110">Desktop user interface</span></span>](windows-application-ui-development.md) | <span data-ttu-id="a943f-111">Содержит сведения, позволяющие разрабатывать графические интерфейсы пользователя для приложений, включая такие функции, как Windows и сообщения, ресурсы и элементы управления.</span><span class="sxs-lookup"><span data-stu-id="a943f-111">Provides information that enables you to develop graphical user interfaces for your apps, including features such as windows and messages, resources, and controls.</span></span> |
| [<span data-ttu-id="a943f-112">Среда рабочего стола</span><span class="sxs-lookup"><span data-stu-id="a943f-112">Desktop environment</span></span>](user-interface.md) | <span data-ttu-id="a943f-113">Содержит рекомендации по интеграции и расширению функций Windows для настольных пользователей, включая панель задач, Рабочий стол и проводник.</span><span class="sxs-lookup"><span data-stu-id="a943f-113">Provides guidance for integrating and extending the desktop user-facing features of Windows, including the Taskbar, the desktop, and File Explorer.</span></span> |
| [<span data-ttu-id="a943f-114">Установка и обслуживание приложения</span><span class="sxs-lookup"><span data-stu-id="a943f-114">Application installation and servicing</span></span>](application-installing-and-servicing.md) | <span data-ttu-id="a943f-115">Содержит сведения об использовании интерфейсов API и служб, предоставляемых Windows для установки и обслуживания классических приложений, а также управления ими.</span><span class="sxs-lookup"><span data-stu-id="a943f-115">Provides information about using APIs and services provided by Windows to install, manage, and service your desktop apps.</span></span> |
| [<span data-ttu-id="a943f-116">Звук и видео</span><span class="sxs-lookup"><span data-stu-id="a943f-116">Audio and video</span></span>](audio-and-video.md) | <span data-ttu-id="a943f-117">Содержит рекомендации по использованию аудио и видео функций, предоставляемых Windows.</span><span class="sxs-lookup"><span data-stu-id="a943f-117">Provides guidance about using audio and video features provided by Windows.</span></span> |
| [<span data-ttu-id="a943f-118">Доступ к данным и хранилище</span><span class="sxs-lookup"><span data-stu-id="a943f-118">Data access and storage</span></span>](data-access-and-storage.md) | <span data-ttu-id="a943f-119">Содержит сведения о функциях доступа к данным и хранилища, которые можно использовать в приложениях для настольных систем, включая Управление файловой системой и облачные модули синхронизации.</span><span class="sxs-lookup"><span data-stu-id="a943f-119">Provides information about data access and storage features you can use in your desktop applications, including file system management and cloud sync engines.</span></span>  |
| [<span data-ttu-id="a943f-120">Устройства</span><span class="sxs-lookup"><span data-stu-id="a943f-120">Devices</span></span>](devices.md) | <span data-ttu-id="a943f-121">Описание интерфейсов API для взаимодействия с устройствами и датчиками.</span><span class="sxs-lookup"><span data-stu-id="a943f-121">Describes APIs for interacting with devices and sensors.</span></span> |
| [<span data-ttu-id="a943f-122">Error Handling</span><span class="sxs-lookup"><span data-stu-id="a943f-122">Diagnostics</span></span>](diagnostics.md) | <span data-ttu-id="a943f-123">Содержит рекомендации по отладке и обработке ошибок, профилированию производительности, мониторингу сети и другим функциям диагностики.</span><span class="sxs-lookup"><span data-stu-id="a943f-123">Provides guidance about debugging and error handling, performance profiling, network monitoring, and other diagnostics features.</span></span> |
| [<span data-ttu-id="a943f-124">Документы и печать</span><span class="sxs-lookup"><span data-stu-id="a943f-124">Documents and printing</span></span>](printdocs/documents-and-printing.md) | <span data-ttu-id="a943f-125">Описывает документы и функции печати Windows, позволяющие приложениям сохранять, просматривать и печатать.</span><span class="sxs-lookup"><span data-stu-id="a943f-125">Describes the documents and printing features of Windows that enable applications to save, view, and print.</span></span>  |
| [<span data-ttu-id="a943f-126">Графика и игры</span><span class="sxs-lookup"><span data-stu-id="a943f-126">Graphics and gaming</span></span>](graphics-and-multimedia.md) | <span data-ttu-id="a943f-127">Содержит сведения о графических и игровых функциях Windows, включая DirectX и Digital Imaging.</span><span class="sxs-lookup"><span data-stu-id="a943f-127">Provides information about graphics and gaming features of Windows, including DirectX and digital imaging.</span></span>  |
| [<span data-ttu-id="a943f-128">Сеть и Интернет</span><span class="sxs-lookup"><span data-stu-id="a943f-128">Networking and Internet</span></span>](networking.md) | <span data-ttu-id="a943f-129">Содержит рекомендации по работе с сетью и Интернет-компонентами Windows, включая управление сетью, API-интерфейсы HTTP и удаленный вызов процедур (RPC).</span><span class="sxs-lookup"><span data-stu-id="a943f-129">Provides guidance about the networking and Internet-related features of Windows, including network management, HTTP APIs, and Remote Procedure Call (RPC).</span></span> |
| [<span data-ttu-id="a943f-130">Безопасность и удостоверения</span><span class="sxs-lookup"><span data-stu-id="a943f-130">Security and identity</span></span>](security.md) | <span data-ttu-id="a943f-131">Предоставляет сведения о проверке подлинности, авторизации, шифровании и других функциях безопасности Windows.</span><span class="sxs-lookup"><span data-stu-id="a943f-131">Provides information about authentication, authorization, cryptography, and other security features of Windows.</span></span> |
| [<span data-ttu-id="a943f-132">Системные службы</span><span class="sxs-lookup"><span data-stu-id="a943f-132">System services</span></span>](system-services.md) | <span data-ttu-id="a943f-133">Предоставляет рекомендации по основным функциям ОС, таким как процессы и потоки, службы, библиотеки динамической компоновки, COM, реестр и многое другое.</span><span class="sxs-lookup"><span data-stu-id="a943f-133">Provides guidance about fundamental OS features such as process and threads, services, dynamic-link libraries, COM, the registry, and more.</span></span> |
