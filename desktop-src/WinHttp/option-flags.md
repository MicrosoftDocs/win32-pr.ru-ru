...
**Windows Server 2003 с пакетом обновления 1 и Windows XP с пакетом обновления 2 (SP2):** Этот флаг устарел.
...
извлекает длинное целое число без знака, содержащее код ошибки сокетов Microsoft Windows, который был сопоставлен с ошибкой сообщения WINHTTP, которые были \_ \_ \* возвращены в этом контексте потока. В качестве значения Handle можно передать значение **null** .
...
<span id="WINHTTP_OPTION_IPV6_FAST_FALLBACK"></span><span id="winhttp_option_ipv6_fast_fallback"></span>**\_параметр WINHTTP \_ \_ FAST \_ отката IPV6**
</dt> <dd> <dl> <dt>
...
возвращает значение, указывающее, может ли быть получен ответ на возвращаемый Подключение прокси-сервера.
...
**Windows XP с пакетом обновления 1 (SP1) и Windows 2000 с SP3:** Этот флаг устарел.
...
попытка задать или запросить флаг параметра в Windows версии, где она не поддерживается, приведет к **ошибке \_ \_ "недопустимый \_ параметр WINHTTP"**.
...
| \_Параметры WinHTTP \_ фоновых \_ подключений<br/>**DWORD** | X | \- | \- | X | Windows 10 Версия 21H1 |
...
| \_параметр WinHTTP \_ Отключить \_ \_ Построение цепочки сертификатов \_<br/>**ЛОГИЧЕСКОМ** | X | \- | \- | X | Windows 10 Версия 21H1 |
...
| \_Параметр WinHTTP \_ включить \_ \_ \_ \_ контекст сертификата клиента \_ HTTP2 Plus<br/>**ЛОГИЧЕСКОМ** | X | \- | \- | X | Windows 10 Версия 21H1 |
...
| \_параметр WinHTTP \_ первое \_ доступное \_ подключение<br/>**ЛОГИЧЕСКОМ** | X | \- | \- | X | Windows 10 Версия 21H1 |
...
| \_Параметр WinHTTP \_ HTTP2 \_ KeepAlive<br/>**DWORD** | X | \- | \- | X | Windows 10 Версия 21H1 |
| \_Параметр WinHTTP \_ HTTP2 \_ и \_ \_ Кодировка перемещения<br/>**ЛОГИЧЕСКОМ** | X | X | \- | X | Windows 10 Версия 21H1 |
| \_параметр WinHTTP \_ игнорировать \_ отзыв сертификата в \_ \_ автономном режиме<br/>**ЛОГИЧЕСКОМ** | \- | X | \- | X | Windows 10 Версия 2004 |
| \_параметр WINHTTP \_ \_ FAST \_ отката IPV6<br/>**ЛОГИЧЕСКОМ** | X | \- | \- | X | Windows 10 Версия 1903 |
...
| \_параметр WinHTTP \_ требует \_ \_ завершения потока<br/>**ЛОГИЧЕСКОМ** | X | X | \- | X | Windows 10 Версия 21H1 |
| \_ \_ имя узла для разрешения параметров WinHTTP \_<br/>**LPWSTR** | \- | X | \- | X | Windows 10 Версия 21H1 |
...
| \_ \_ код ошибки в потоке параметров WinHTTP \_ \_<br/>**DWORD** | \- | X | X | \- | Windows 10 Версия 21H1 |
...
| \_небезопасный \_ \_ \_ \_ откат протокола TLS с параметром WinHTTP<br/>**ЛОГИЧЕСКОМ** | X | \- | \- | X | Windows 10 Версия 21H1 |
