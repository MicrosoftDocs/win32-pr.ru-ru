...
Перечисление **винхттпрекуестоптион** включает параметры, которые могут быть установлены или получены для текущего сеанса служб Microsoft Windows HTTP (WinHTTP).
...
**Windows XP с SP1 и windows 2000 с пакетом обновления 3 (SP3):** Это значение перечисления не поддерживается.
