...
---
# <a name="net-tracelogging-examples"></a><span data-ttu-id="8c58b-103">Примеры .NET Трацелоггинг</span><span class="sxs-lookup"><span data-stu-id="8c58b-103">.NET Tracelogging Examples</span></span>

<span data-ttu-id="8c58b-104">В этом разделе содержится пример управляемого кода Трацелоггинг, в котором показано, как вести журнал событий только в том случае, если уровень детализации сеанса является подробным и как регистрировать данные структурированных событий.</span><span class="sxs-lookup"><span data-stu-id="8c58b-104">This topic contains a managed code Tracelogging example that illustrates how to log an event only when the session verbosity level is verbose, and how to log structured event data.</span></span>
