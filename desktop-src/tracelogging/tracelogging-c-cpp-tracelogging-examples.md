...
---
# <a name="cc-tracelogging-examples"></a>Примеры Трацелоггинг в C/C++

Этот раздел содержит примеры Трацелоггинг C/C++.

> [!IMPORTANT]
> Свяжите advapi32. lib при компиляции этих примеров.

 

-   [Встроенные типы данных журнала](#log-intrinsic-data-types)
-   [Поля "имя события"](#name-event-fields)
-   [Уровень детализации событий журнала](#log-event-verbosity-level)
-   [Ключевые слова событий Log](#log-event-keywords)
-   [Данные события массива журнала](#log-array-event-data)
-   [Данные события структуры журнала](#log-structure-event-data)

### <a name="log-intrinsic-data-types"></a>Встроенные типы данных журнала

В этом примере показано, как вести журнал встроенных типов данных, таких как целые числа, логические значения и т. д.
...
### <a name="name-event-fields"></a>Поля "имя события"

В примере показано, как присвоить имя полям событий.
...
### <a name="log-event-verbosity-level"></a>Уровень детализации событий журнала

В этом примере показано, как регистрировать события по уровню детализации.
...
### <a name="log-event-keywords"></a>Ключевые слова событий Log

В этом примере показано, как задать ключевые слова событий. Фильтрацию событий можно выполнять по уровню и ключевому слову. Например, события завершения сценария или события сбоя могут быть сгруппированы под отдельными ключевыми словами, чтобы можно было легко фильтровать эти события.
...
### <a name="log-array-event-data"></a>Данные события массива журнала

В этом примере показано, как записывать в журнал массивы как данные событий.
...
### <a name="log-structure-event-data"></a>Данные события структуры журнала

В этом примере показано, как записывать данные события структуры в журнал.
...
### <a name="how-to-fix-tracelogging-cc-build-errors"></a>Исправление ошибок сборки C/C++ Трацелоггинг
...
Устраните эту ошибку, связав advapi32. lib в проекте.
