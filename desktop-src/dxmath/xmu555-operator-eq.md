---
description: Присваивает данные компонента вектора текущему экземпляру XMU555.
ms.assetid: 'overload:microsoft.directx_sdk.reference.xmu555.operator = '
title: Оператор XMU555 = операторы
ms.topic: reference
ms.date: 12/06/2018
topic_type:
- APIRef
...
ms.locfileid: "105701836"
---
# <a name="xmu555-operator--operators"></a>Оператор XMU555 = операторы

Присваивает данные компонента вектора текущему экземпляру `XMU555` .

Присваивает данные компонента вектора текущему экземпляру [**XMU555**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmu555).
...
[Операторы XMU555](ovw-xmu555-operators.md)
</dt> <dt>
