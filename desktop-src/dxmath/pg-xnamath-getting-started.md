...
библиотека директксмас включена в Windows SDK. кроме того, его можно загрузить с [GitHub/микрософт/директксмас](https://github.com/Microsoft/DirectXMath). Этот сайт также содержит связанные образцы проектов.
