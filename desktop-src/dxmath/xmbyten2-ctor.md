---
description: Конструкторы, предоставляемые XMBYTEN2.
ms.assetid: 4fad24ee-f825-454d-a712-7917116de0b3
title: Конструкторы XMBYTEN2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Конструкторы, предоставляемые `XMBYTEN2` .

Конструирует экземпляры структуры [**XMBYTEN2**](/windows/desktop/api/DirectXPackedVector/ns-directxpackedvector-xmbyten2) .
...
[Расширения XMBYTEN2](ovw-xmbyten2-extensions.md)
</dt> <dt>
