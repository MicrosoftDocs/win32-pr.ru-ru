---
description: Обращается к конкретным элементам матрицы, на которые ссылается строка и столбец из текущего экземпляра XMFLOAT4X4.
ms.assetid: de367692-6974-4e54-9f1e-d8c56b3aa752
title: Операторы XMFLOAT4X4 operator ()
ms.topic: reference
ms.date: 12/06/2018
topic_type:
- APIRef
...
Обращается к конкретным элементам матрицы, на которые ссылается строка и столбец из текущего экземпляра `XMFLOAT4X4` .

Обращается к конкретным элементам матрицы, на которые ссылается строка и столбец из текущего экземпляра [ **XMFLOAT4X4**](/windows/win32/api/directxmath/ns-directxmath-xmfloat4x4)
