---
description: Присваивает данные компонента вектора текущему экземпляру XMUDEC4.
ms.assetid: 'overload:microsoft.directx_sdk.reference.xmudec4.operator = '
title: Оператор XMUDEC4 = операторы
ms.topic: reference
ms.date: 12/06/2018
topic_type:
- APIRef
...
Присваивает данные компонента вектора текущему экземпляру `XMUDEC4` .

Присваивает данные компонента вектора текущему экземпляру [**XMUDEC4**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmudec4).
...
[Операторы XMUDEC4](ovw-xmudec4-operators.md)
</dt> <dt>
