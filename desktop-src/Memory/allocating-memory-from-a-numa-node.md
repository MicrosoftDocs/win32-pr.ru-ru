...
ms.locfileid: "120078254"
---
# <a name="allocating-memory-from-a-numa-node"></a>Выделение памяти из узла NUMA

В следующем примере кода демонстрируется использование функций NUMA [**жетнумахигхестноденумбер**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber), [**жетнумапроцессорноде**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode)и [**виртуалаллоцекснума**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma). Также демонстрируется использование функции [**куериворкингсетекс**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) для получения узла NUMA, на котором выделены страницы.
...
[Поддержка NUMA](../procthread/numa-support.md)
</dt> </dl>
