---
description: В следующем примере кода демонстрируется использование функций NUMA Жетнумахигхестноденумбер, Жетнумапроцессорноде и Виртуалаллоцекснума.
ms.assetid: df025b35-fb6b-4987-806e-9c76e6b130a1
title: Выделение памяти из узла NUMA
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104145334"
---
# <a name="allocating-memory-from-a-numa-node"></a><span data-ttu-id="6540e-103">Выделение памяти из узла NUMA</span><span class="sxs-lookup"><span data-stu-id="6540e-103">Allocating Memory from a NUMA Node</span></span>

<span data-ttu-id="6540e-104">В следующем примере кода демонстрируется использование функций NUMA [**жетнумахигхестноденумбер**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber), [**жетнумапроцессорноде**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode)и [**виртуалаллоцекснума**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma).</span><span class="sxs-lookup"><span data-stu-id="6540e-104">The following sample code demonstrates the use of the NUMA functions [**GetNumaHighestNodeNumber**](/windows/win32/api/systemtopologyapi/nf-systemtopologyapi-getnumahighestnodenumber), [**GetNumaProcessorNode**](/windows/win32/api/winbase/nf-winbase-getnumaprocessornode), and [**VirtualAllocExNuma**](/windows/win32/api/memoryapi/nf-memoryapi-virtualallocexnuma).</span></span> <span data-ttu-id="6540e-105">Также демонстрируется использование функции [**куериворкингсетекс**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) для получения узла NUMA, на котором выделены страницы.</span><span class="sxs-lookup"><span data-stu-id="6540e-105">It also demonstrates the use of the [**QueryWorkingSetEx**](/windows/win32/api/psapi/nf-psapi-queryworkingsetex) function to retrieve the NUMA node on which pages are allocated.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="6540e-106">См. также</span><span class="sxs-lookup"><span data-stu-id="6540e-106">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="6540e-107">Поддержка NUMA</span><span class="sxs-lookup"><span data-stu-id="6540e-107">NUMA Support</span></span>](../procthread/numa-support.md)
</dt> </dl>
