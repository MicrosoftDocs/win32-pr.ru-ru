...
---
# <a name="awe-example"></a>Пример расширений AWE

В следующем образце программы показано использование [**расширений окна адресов**](address-windowing-extensions.md).
