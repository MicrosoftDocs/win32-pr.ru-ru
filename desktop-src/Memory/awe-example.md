---
description: В следующем образце программы показано использование расширений окна адресов.
ms.assetid: 1a67bd2f-afc0-48f4-91f2-34fd2b94910d
title: Пример расширений AWE
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105650544"
---
# <a name="awe-example"></a><span data-ttu-id="e0aa3-103">Пример расширений AWE</span><span class="sxs-lookup"><span data-stu-id="e0aa3-103">AWE Example</span></span>

<span data-ttu-id="e0aa3-104">В следующем образце программы показано использование [**расширений окна адресов**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="e0aa3-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
