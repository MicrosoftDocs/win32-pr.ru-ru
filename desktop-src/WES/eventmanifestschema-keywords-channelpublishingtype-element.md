---
title: Элемент keywords (Чаннелпублишингтипе)
description: Битовая маска, определяющая категорию событий, записываемых в канал.
ms.assetid: 5157e63f-3e46-4248-b0ca-116a5d5ada2c
keywords:
- Журнал событий элемента keywords
topic_type:
- apiref
api_name:
- keywords
...
ms.locfileid: "118343598"
---
# <a name="keywords-channelpublishingtype-element"></a>Элемент keywords (Чаннелпублишингтипе)

Битовая маска, определяющая категорию событий, записываемых в канал.
