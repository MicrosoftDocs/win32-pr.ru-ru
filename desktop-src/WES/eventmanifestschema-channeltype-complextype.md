...
если имя канала соответствует соглашению об именовании каналов, Windows Просмотр событий будет перечислять канал, используя строку, следующую за обратной косой чертой. Например, если имя канала — "компания-продукт — компонент/Рабочая", то Просмотр событий будет перечислять канал как работоспособный в рамках поставщика компонентов компании и продукта. В противном случае в поставщике отображается имя всего канала. Локализованное отображаемое имя используется, если оно указано.
