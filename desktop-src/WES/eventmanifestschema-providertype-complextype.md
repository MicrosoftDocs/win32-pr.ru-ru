...
Windows Просмотр событий (Eventvwr.exe) будет использовать локализованную строку сообщения, если она доступна; в противном случае используется строка из атрибута Name.
