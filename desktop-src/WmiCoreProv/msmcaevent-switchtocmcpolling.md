---
description: Представляет исправленную обработку проверки компьютера (CMC) для переключения из драйвера прерываний для опроса. этот класс доступен только в 64-разрядных Windows системах.
