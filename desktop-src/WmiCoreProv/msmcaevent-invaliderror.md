...
Класс **мсмкаевент \_ инвалидеррор** указывает на недействительную ошибку архитектуры проверки машин (MCA). Недопустимая ошибка MCA определяет формат ошибки, который не соответствует спецификациям Windows. Этот класс доступен только в 64-разрядных системах Windows.
