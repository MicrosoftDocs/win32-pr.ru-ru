...
Класс **мсмкаевент \_ пЦибусеррор** представляет ошибку шины PCI архитектуры MCA. Этот класс доступен только для компьютеров, работающих в 64-разрядной операционной системе Windows.
...
| Значение                                                                                                | Значение                                                     |
|------------------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| <span id="0"></span><dl> <dt>**0**</dt> </dl> | Неизвестная или OEM-ошибка, специфичная для системы.<br/>            |
| <span id="1"></span><dl> <dt>**1**</dt> </dl> | Ошибка четности данных.<br/>                               |
| <span id="2"></span><dl> <dt>**2**</dt> </dl> | Системная ошибка.<br/>                                    |
| <span id="3"></span><dl> <dt>**3-5**</dt> </dl> | Прекращение работы мастера.<br/>                                    |
| <span id="4"></span><dl> <dt>**четырех**</dt> </dl> | Истекло время ожидания шины или отсутствует устройство (нет ДЕВСЕЛ \# ).<br/> |
| <span id="5"></span><dl> <dt>**5.0**</dt> </dl> | Ошибка четности основных данных.<br/>                        |
