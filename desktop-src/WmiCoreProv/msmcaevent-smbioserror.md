...
Класс **мсмкаевент \_ смбиосеррор** указывает на ошибку BIOS системы архитектуры MCA. Этот класс доступен только в 64-разрядных системах Windows.
...
| Значение                                                                                                  | Значение                                                                                                                     |
|--------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| <span id="0"></span><dl> <dt>**0**</dt> </dl>   | Зарезервировано.<br/>                                                                                                        |
...
| <span id="3"></span><dl> <dt>**3-5**</dt> </dl>   | Ошибка четности памяти.<br/>                                                                                             |
| <span id="4"></span><dl> <dt>**четырех**</dt> </dl>   | Время ожидания шины истекло.<br/>                                                                                                    |
| <span id="5"></span><dl> <dt>**5.0**</dt> </dl>   | Проверка канала ввода-вывода.<br/>                                                                                               |
