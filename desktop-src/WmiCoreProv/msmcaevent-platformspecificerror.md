---
description: Указывает на ошибку платформы проверки машинного уровня (MCA). этот класс доступен только в 64-разрядных Windows системах.
...
ms.locfileid: "120120974"
---
# <a name="msmcaevent_platformspecificerror-class"></a>\_Класс мсмкаевент платформспеЦифицеррор

Класс **мсмкаевент \_ платформспеЦифицеррор** указывает на ошибку платформы проверки компьютера (MCA), относящуюся к конкретной платформе. этот класс доступен только в 64-разрядных Windows системах.
