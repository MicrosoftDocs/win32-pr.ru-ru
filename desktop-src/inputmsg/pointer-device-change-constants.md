...
ms.locfileid: "119602554"
---
# <a name="pointer-device-change"></a>Изменение указателя в устройстве

Значения, которые могут быть переданы в параметре *wParam* сообщения [**WM_POINTERDEVICECHANGE**](wm-pointerdevicechange.md) .
...
Изменение отображения в сопоставлении с дигитайзером.
