...
все объявления функций, скопированные из Windows. h в исходный код, могли измениться, а локальное объявление может устареть. Удалите локальное объявление.
