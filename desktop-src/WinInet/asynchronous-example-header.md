...
---
# <a name="asynchronous-example-header"></a>Заголовок асинхронного примера

Ниже приведен заголовочный файл для [асинхронного примера приложения](asynchronous-example-application.md).
