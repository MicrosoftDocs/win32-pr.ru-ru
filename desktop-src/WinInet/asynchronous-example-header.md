---
title: Заголовок асинхронного примера
description: Ниже приведен заголовочный файл для асинхронного примера приложения.
...
ms.locfileid: "104253013"
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="c53f9-103">Заголовок асинхронного примера</span><span class="sxs-lookup"><span data-stu-id="c53f9-103">Asynchronous Example Header</span></span>

<span data-ttu-id="c53f9-104">Ниже приведен заголовочный файл для [асинхронного примера приложения](asynchronous-example-application.md).</span><span class="sxs-lookup"><span data-stu-id="c53f9-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
