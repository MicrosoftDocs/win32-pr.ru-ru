---
title: Асинхронный пример приложения
description: В следующем примере демонстрируется асинхронная отправка запроса.
...
ms.locfileid: "104258576"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="48c7c-103">Асинхронный пример приложения</span><span class="sxs-lookup"><span data-stu-id="48c7c-103">Asynchronous Example Application</span></span>

<span data-ttu-id="48c7c-104">В следующем примере демонстрируется асинхронная отправка запроса.</span><span class="sxs-lookup"><span data-stu-id="48c7c-104">The following example demonstrated sending a request asynchronously.</span></span>
