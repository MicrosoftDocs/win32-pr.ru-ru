...
ms.locfileid: "118562327"
---
# <a name="asynchronous-example-application"></a>Асинхронный пример приложения

В следующем примере демонстрируется асинхронная отправка запроса.
