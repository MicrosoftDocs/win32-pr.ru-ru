...
ms.locfileid: "119707174"
---
# <a name="xmlbufferexample"></a>ксмлбуфферексампле

В этом примере показано использование API-интерфейсов буфера XML.

## <a name="xmlbuffercpp"></a>Ксмлбуффер. cpp
