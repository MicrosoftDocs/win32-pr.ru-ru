---
title: ксмлбуфферексампле
description: В этом примере показано использование API-интерфейсов буфера XML.
ms.assetid: cf4530c7-48f4-4a76-bd3d-1f21b5469902
keywords:
- Ксмлбуфферексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068039"
---
# <a name="xmlbufferexample"></a><span data-ttu-id="e270d-106">ксмлбуфферексампле</span><span class="sxs-lookup"><span data-stu-id="e270d-106">XmlBufferExample</span></span>

<span data-ttu-id="e270d-107">В этом примере показано использование API-интерфейсов буфера XML.</span><span class="sxs-lookup"><span data-stu-id="e270d-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="e270d-108">Ксмлбуффер. cpp</span><span class="sxs-lookup"><span data-stu-id="e270d-108">XmlBuffer.cpp</span></span>
