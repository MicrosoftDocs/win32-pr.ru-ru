...
---
# <a name="httpclientwithsslexample"></a>хттпклиентвиссслексампле

В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ" с защитой транспорта SSL.

-   [Хттпклиентвисссл. cpp](#httpclientwithsslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httpclientwithsslcpp"></a>Хттпклиентвисссл. cpp
