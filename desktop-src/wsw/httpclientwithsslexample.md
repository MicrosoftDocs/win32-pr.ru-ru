---
title: хттпклиентвиссслексампле
description: В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ" с защитой транспорта SSL.
ms.assetid: 0e73baee-a56d-446e-ae2e-a3aae31d8508
keywords:
- Хттпклиентвиссслексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103772626"
---
# <a name="httpclientwithsslexample"></a><span data-ttu-id="2005a-106">хттпклиентвиссслексампле</span><span class="sxs-lookup"><span data-stu-id="2005a-106">HttpClientWithSslExample</span></span>

<span data-ttu-id="2005a-107">В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ" с защитой транспорта SSL.</span><span class="sxs-lookup"><span data-stu-id="2005a-107">This example shows a HTTP client that sends request-reply messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="2005a-108">Хттпклиентвисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="2005a-108">HttpClientWithSsl.cpp</span></span>](#httpclientwithsslcpp)
-   [<span data-ttu-id="2005a-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2005a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2005a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2005a-110">Makefile</span></span>](#makefile)

## <a name="httpclientwithsslcpp"></a><span data-ttu-id="2005a-111">Хттпклиентвисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="2005a-111">HttpClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2005a-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2005a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2005a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2005a-113">Makefile</span></span>
