...
ms.locfileid: "118963333"
---
# <a name="httpclientwithusernameoversslexample"></a>хттпклиентвисусернамеоверсслексампле
...
-   [Хттпклиентвисусернамеоверссл. cpp](#httpclientwithusernameoversslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a>Хттпклиентвисусернамеоверссл. cpp
