...
ms.locfileid: "119083138"
---
# <a name="streaminghttpserverexample"></a>стреамингхттпсерверексампле

В этом примере показан HTTP-сервер, принимающий канал и выполняющий обработку запросов и ответов в потоковой передаче.

-   [Стреамингхттпсервер. cpp](#streaminghttpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streaminghttpservercpp"></a>Стреамингхттпсервер. cpp
