---
title: стреамингхттпсерверексампле
description: В этом примере показан HTTP-сервер, принимающий канал и выполняющий обработку запросов и ответов в потоковой передаче.
ms.assetid: c108a5b3-923c-439c-8d86-7003a76ff45d
keywords:
- Стреамингхттпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103889275"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="cf383-106">стреамингхттпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="cf383-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="cf383-107">В этом примере показан HTTP-сервер, принимающий канал и выполняющий обработку запросов и ответов в потоковой передаче.</span><span class="sxs-lookup"><span data-stu-id="cf383-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="cf383-108">Стреамингхттпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="cf383-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="cf383-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cf383-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="cf383-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="cf383-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="cf383-111">Стреамингхттпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="cf383-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="cf383-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="cf383-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cf383-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="cf383-113">Makefile</span></span>
