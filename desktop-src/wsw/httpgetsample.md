...
---
# <a name="httpgetsample"></a><span data-ttu-id="2c644-108">хттпжетсампле</span><span class="sxs-lookup"><span data-stu-id="2c644-108">HttpGetSample</span></span>

<span data-ttu-id="2c644-109">В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу HTTP.</span><span class="sxs-lookup"><span data-stu-id="2c644-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="2c644-110">Служба предоставляет метаданные по протоколу HTTP GET и WS-Metadata Exchange v 1.1.</span><span class="sxs-lookup"><span data-stu-id="2c644-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="2c644-111">В службе также показано, как реализовать обложку страницы для службы ВВСАПИ.</span><span class="sxs-lookup"><span data-stu-id="2c644-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="2c644-112">Хттпжетсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="2c644-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="2c644-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2c644-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2c644-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="2c644-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="2c644-115">Хттпжетсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="2c644-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2c644-116">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2c644-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2c644-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="2c644-117">Makefile</span></span>
