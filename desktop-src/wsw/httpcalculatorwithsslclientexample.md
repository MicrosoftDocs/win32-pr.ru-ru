...
---
# <a name="httpcalculatorwithsslclientexample"></a>хттпкалкулаторвиссслклиентексампле

В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора с защитой транспорта SSL.

-   [Хттпкалкулаторклиентвисссл. cpp](#httpcalculatorclientwithsslcpp)
-   [CalculatorService. WSDL](#calculatorservicewsdl)
-   [Makefile](#makefile)

## <a name="httpcalculatorclientwithsslcpp"></a>Хттпкалкулаторклиентвисссл. cpp
