...
---
# <a name="httpcalculatorwithsslpolicyserviceexample"></a>хттпкалкулаторвиссслполицисервицеексампле

В этом примере показано, как использовать узел службы для размещения службы калькулятора по протоколу HTTP с безопасностью транспорта SSL и обычной проверкой подлинности заголовка HTTP. В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера. Проверка подлинности клиента обеспечивается парой имен пользователей и паролей, указанной в заголовках HTTP, с использованием базовой схемы.

-   [Хттпкалкулаторвиссслполицисервице. cpp](#httpcalculatorwithsslpolicyservicecpp)
-   [Калкулаторсервицевисполици. WSDL](#calculatorservicewithpolicywsdl)
-   [Makefile](#makefile)

## <a name="httpcalculatorwithsslpolicyservicecpp"></a>Хттпкалкулаторвиссслполицисервице. cpp
...
## <a name="calculatorservicewithpolicywsdl"></a>Калкулаторсервицевисполици. WSDL
