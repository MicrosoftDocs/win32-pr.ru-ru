...
ms.locfileid: "119927084"
---
# <a name="requestreplytcpserverexample"></a>рекуестреплиткпсерверексампле

В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него.

-   [Рекуестреплиткпсервер. cpp](#requestreplytcpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplytcpservercpp"></a>Рекуестреплиткпсервер. cpp
