...
ms.locfileid: "118963153"
---
# <a name="httppurchaseorderwithsslclientexample"></a>хттппурчасеордервиссслклиентексампле

В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder с защитой транспорта SSL.

-   [Хттппурчасеордерклиентвисссл. cpp](#httppurchaseorderclientwithsslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a>Хттппурчасеордерклиентвисссл. cpp
