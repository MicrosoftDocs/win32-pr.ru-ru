---
title: хттппурчасеордервиссслклиентексампле
description: В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder с защитой транспорта SSL.
ms.assetid: afa73250-5f1c-4151-a2e0-4a5ccc91b63f
keywords:
- Хттппурчасеордервиссслклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105700608"
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="2b6db-106">хттппурчасеордервиссслклиентексампле</span><span class="sxs-lookup"><span data-stu-id="2b6db-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="2b6db-107">В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder с защитой транспорта SSL.</span><span class="sxs-lookup"><span data-stu-id="2b6db-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="2b6db-108">Хттппурчасеордерклиентвисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="2b6db-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="2b6db-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2b6db-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2b6db-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2b6db-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="2b6db-111">Хттппурчасеордерклиентвисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="2b6db-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2b6db-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2b6db-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2b6db-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2b6db-113">Makefile</span></span>
