---
title: реадксмлексампле
description: Этот пример считывает XML-узел по узлу.
ms.assetid: 938825f6-43dd-4e24-a04d-c46290509a64
keywords:
- Веб-службы Реадксмлексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104252732"
---
# <a name="readxmlexample"></a><span data-ttu-id="2cc1a-106">реадксмлексампле</span><span class="sxs-lookup"><span data-stu-id="2cc1a-106">ReadXmlExample</span></span>

<span data-ttu-id="2cc1a-107">Этот пример считывает XML-узел по узлу.</span><span class="sxs-lookup"><span data-stu-id="2cc1a-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="2cc1a-108">ReadXml. cpp</span><span class="sxs-lookup"><span data-stu-id="2cc1a-108">ReadXml.cpp</span></span>
