---
title: хттпкалкулаторвислайередчаннелклиентексампле
description: В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала. Пользовательский канал — это многоуровневый канал, который просто делегирует все функциональные возможности существующему каналу HTTP.
ms.assetid: 897673df-f3a3-4b38-8b79-c9f1119be6d5
keywords:
- Хттпкалкулаторвислайередчаннелклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105710097"
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="f021b-107">хттпкалкулаторвислайередчаннелклиентексампле</span><span class="sxs-lookup"><span data-stu-id="f021b-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="f021b-108">В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала.</span><span class="sxs-lookup"><span data-stu-id="f021b-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="f021b-109">Пользовательский канал — это многоуровневый канал, который просто делегирует все функциональные возможности существующему каналу HTTP.</span><span class="sxs-lookup"><span data-stu-id="f021b-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="f021b-110">Хттпкалкулаторвислайередчаннелклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="f021b-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="f021b-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="f021b-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="f021b-112">Лайередчаннел. h</span><span class="sxs-lookup"><span data-stu-id="f021b-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="f021b-113">Лайередчаннел. cpp</span><span class="sxs-lookup"><span data-stu-id="f021b-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="f021b-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="f021b-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="f021b-115">Хттпкалкулаторвислайередчаннелклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="f021b-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="f021b-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="f021b-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="f021b-117">Лайередчаннел. h</span><span class="sxs-lookup"><span data-stu-id="f021b-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="f021b-118">Лайередчаннел. cpp</span><span class="sxs-lookup"><span data-stu-id="f021b-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f021b-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="f021b-119">Makefile</span></span>
