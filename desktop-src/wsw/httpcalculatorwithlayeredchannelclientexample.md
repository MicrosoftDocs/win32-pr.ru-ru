...
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a>хттпкалкулаторвислайередчаннелклиентексампле

В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала. Пользовательский канал — это многоуровневый канал, который просто делегирует все функциональные возможности существующему каналу HTTP.

-   [Хттпкалкулаторвислайередчаннелклиент. cpp](#httpcalculatorwithlayeredchannelclientcpp)
-   [CalculatorService. WSDL](#calculatorservicewsdl)
-   [Лайередчаннел. h](#layeredchannelh)
-   [Лайередчаннел. cpp](#layeredchannelcpp)
-   [Makefile](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a>Хттпкалкулаторвислайередчаннелклиент. cpp
...
## <a name="layeredchannelh"></a>Лайередчаннел. h
...
## <a name="layeredchannelcpp"></a>Лайередчаннел. cpp
