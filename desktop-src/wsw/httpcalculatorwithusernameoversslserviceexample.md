---
title: хттпкалкулаторвисусернамеоверсслсервицеексампле
description: В этом примере показано, как использовать узел службы для размещения службы калькулятора по протоколу HTTP с именем пользователя в смешанном режиме защиты SSL.
ms.assetid: 92dfec48-2314-4e83-8fe9-9d25aa100043
keywords:
- Хттпкалкулаторвисусернамеоверсслсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067594"
---
# <a name="httpcalculatorwithusernameoversslserviceexample"></a><span data-ttu-id="75f21-106">хттпкалкулаторвисусернамеоверсслсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="75f21-106">HttpCalculatorWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="75f21-107">В этом примере показано, как использовать узел службы для размещения службы калькулятора по протоколу HTTP с именем пользователя в смешанном режиме защиты SSL.</span><span class="sxs-lookup"><span data-stu-id="75f21-107">This example shows how to use service host for hosting a calculator service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="75f21-108">В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера.</span><span class="sxs-lookup"><span data-stu-id="75f21-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="75f21-109">Проверка подлинности клиента обеспечивается парой имени пользователя и пароля в заголовке WS-Security сообщения.</span><span class="sxs-lookup"><span data-stu-id="75f21-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="75f21-110">Калкулаторсервицеусернамеоверссл. cpp</span><span class="sxs-lookup"><span data-stu-id="75f21-110">CalculatorServiceUserNameOverSsl.cpp</span></span>](#calculatorserviceusernameoversslcpp)
-   [<span data-ttu-id="75f21-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="75f21-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="75f21-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="75f21-112">Makefile</span></span>](#makefile)

## <a name="calculatorserviceusernameoversslcpp"></a><span data-ttu-id="75f21-113">Калкулаторсервицеусернамеоверссл. cpp</span><span class="sxs-lookup"><span data-stu-id="75f21-113">CalculatorServiceUserNameOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="75f21-114">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="75f21-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="75f21-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="75f21-115">Makefile</span></span>
