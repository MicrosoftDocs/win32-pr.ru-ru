...
В этом разделе описываются ошибки, которые могут быть вызваны функциями веб-служб Windows в результате сбоя выполнения команды.
...
Все коды возврата ошибок — HRESULTs. Этот API определяет набор значений HRESULT в \_ диапазоне служебных служб, но также возвращает ошибки, определенные в других окнах Windows API.
...
Этот API предоставляет канонический набор кодов ошибок (WS \_ E \_ \* ), которые позволяют использовать различные коммуникационные технологии без необходимости зависеть от конкретных кодов ошибок конкретной базовой реализации. Полный список этих кодов ошибок см. в разделе [возвращаемые значения веб-служб Windows](windows-web-services-return-values.md).
