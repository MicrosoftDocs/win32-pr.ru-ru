...
---
# <a name="untypedserviceexample"></a>унтипедсервицеексампле

В этом примере показано, как реализовать нетипизированную службу с моделью службы. В этом случае модель службы обеспечивает инфраструктуру стереотипногоной формы.

-   [Унтипедсервице. cpp](#untypedservicecpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="untypedservicecpp"></a>Унтипедсервице. cpp
