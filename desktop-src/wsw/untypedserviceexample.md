---
title: унтипедсервицеексампле
description: В этом примере показано, как реализовать нетипизированную службу с моделью службы. В этом случае модель службы обеспечивает инфраструктуру стереотипногоной формы.
ms.assetid: 4235554e-19a8-4df7-97a5-2f7544a3c830
keywords:
- Унтипедсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067649"
---
# <a name="untypedserviceexample"></a><span data-ttu-id="a8a9d-107">унтипедсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="a8a9d-107">UnTypedServiceExample</span></span>

<span data-ttu-id="a8a9d-108">В этом примере показано, как реализовать нетипизированную службу с моделью службы.</span><span class="sxs-lookup"><span data-stu-id="a8a9d-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="a8a9d-109">В этом случае модель службы обеспечивает инфраструктуру стереотипногоной формы.</span><span class="sxs-lookup"><span data-stu-id="a8a9d-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="a8a9d-110">Унтипедсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="a8a9d-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="a8a9d-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a8a9d-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a8a9d-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="a8a9d-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="a8a9d-113">Унтипедсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="a8a9d-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a8a9d-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a8a9d-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a8a9d-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="a8a9d-115">Makefile</span></span>
