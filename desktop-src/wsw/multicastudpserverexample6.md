...
ms.locfileid: "118963093"
---
# <a name="multicastudpserverexample6"></a>MulticastUdpServerExample6

В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес. В этом примере используется протокол IPv6.
