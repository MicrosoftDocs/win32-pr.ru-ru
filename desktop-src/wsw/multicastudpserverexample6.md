...
description: В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес. В этом примере используется протокол IPv6.
...
ms.locfileid: "105654217"
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="4e2fa-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="4e2fa-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="4e2fa-108">В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес.</span><span class="sxs-lookup"><span data-stu-id="4e2fa-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="4e2fa-109">В этом примере используется протокол IPv6.</span><span class="sxs-lookup"><span data-stu-id="4e2fa-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="4e2fa-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="4e2fa-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="4e2fa-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4e2fa-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4e2fa-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="4e2fa-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="4e2fa-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="4e2fa-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4e2fa-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4e2fa-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4e2fa-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="4e2fa-115">Makefile</span></span>
