...
ms.locfileid: "119026332"
---
# <a name="requestreplynamedpipesserverexample"></a>рекуестреплинамедпипессерверексампле

В этом примере показан сервер именованных каналов, принимающий канал и принимающий сообщения и отвечающий на него.

-   [Рекуестреплинамедпипессервер. cpp](#requestreplynamedpipesservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplynamedpipesservercpp"></a>Рекуестреплинамедпипессервер. cpp
