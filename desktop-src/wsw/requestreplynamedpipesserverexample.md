---
title: рекуестреплинамедпипессерверексампле
description: В этом примере показан сервер именованных каналов, принимающий канал и принимающий сообщения и отвечающий на него.
...
ms.locfileid: "103772776"
---
# <a name="requestreplynamedpipesserverexample"></a><span data-ttu-id="24636-103">рекуестреплинамедпипессерверексампле</span><span class="sxs-lookup"><span data-stu-id="24636-103">RequestReplyNamedPipesServerExample</span></span>

<span data-ttu-id="24636-104">В этом примере показан сервер именованных каналов, принимающий канал и принимающий сообщения и отвечающий на него.</span><span class="sxs-lookup"><span data-stu-id="24636-104">This example shows a named pipes server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="24636-105">Рекуестреплинамедпипессервер. cpp</span><span class="sxs-lookup"><span data-stu-id="24636-105">RequestReplyNamedPipesServer.cpp</span></span>](#requestreplynamedpipesservercpp)
-   [<span data-ttu-id="24636-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="24636-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="24636-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="24636-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesservercpp"></a><span data-ttu-id="24636-108">Рекуестреплинамедпипессервер. cpp</span><span class="sxs-lookup"><span data-stu-id="24636-108">RequestReplyNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="24636-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="24636-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="24636-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="24636-110">Makefile</span></span>
