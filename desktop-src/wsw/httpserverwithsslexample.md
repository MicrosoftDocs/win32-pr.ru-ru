...
ms.locfileid: "119927292"
---
# <a name="httpserverwithsslexample"></a>хттпсервервиссслексампле

В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с защитой транспорта SSL.

-   [Хттпсервервисссл. cpp](#httpserverwithsslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httpserverwithsslcpp"></a>Хттпсервервисссл. cpp
