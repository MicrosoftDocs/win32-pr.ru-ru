---
title: хттпсервервиссслексампле
description: В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с защитой транспорта SSL.
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- Хттпсервервиссслексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104332336"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="200cf-106">хттпсервервиссслексампле</span><span class="sxs-lookup"><span data-stu-id="200cf-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="200cf-107">В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с защитой транспорта SSL.</span><span class="sxs-lookup"><span data-stu-id="200cf-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="200cf-108">Хттпсервервисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="200cf-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="200cf-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="200cf-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="200cf-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="200cf-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="200cf-111">Хттпсервервисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="200cf-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="200cf-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="200cf-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="200cf-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="200cf-113">Makefile</span></span>
