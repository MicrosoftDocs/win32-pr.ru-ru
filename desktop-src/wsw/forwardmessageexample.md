...
---
# <a name="forwardmessageexample"></a>форвардмессажеексампле

В этом примере пересылается сообщение.

-   [Форвардмессаже. cpp](#forwardmessagecpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="forwardmessagecpp"></a>Форвардмессаже. cpp
