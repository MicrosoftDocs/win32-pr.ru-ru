---
title: форвардмессажеексампле
description: В этом примере пересылается сообщение.
ms.assetid: bedaa7f3-2a43-45f4-a623-c0e41b5113a4
keywords:
- Веб-службы Форвардмессажеексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068151"
---
# <a name="forwardmessageexample"></a><span data-ttu-id="312b6-106">форвардмессажеексампле</span><span class="sxs-lookup"><span data-stu-id="312b6-106">ForwardMessageExample</span></span>

<span data-ttu-id="312b6-107">В этом примере пересылается сообщение.</span><span class="sxs-lookup"><span data-stu-id="312b6-107">This example forwards a message.</span></span>

-   [<span data-ttu-id="312b6-108">Форвардмессаже. cpp</span><span class="sxs-lookup"><span data-stu-id="312b6-108">ForwardMessage.cpp</span></span>](#forwardmessagecpp)
-   [<span data-ttu-id="312b6-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="312b6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="312b6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="312b6-110">Makefile</span></span>](#makefile)

## <a name="forwardmessagecpp"></a><span data-ttu-id="312b6-111">Форвардмессаже. cpp</span><span class="sxs-lookup"><span data-stu-id="312b6-111">ForwardMessage.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="312b6-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="312b6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="312b6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="312b6-113">Makefile</span></span>
