...
---
# <a name="metadataimportwithx509oversslexample"></a><span data-ttu-id="552cf-106">MetadataImportWithX509OverSslExample</span><span class="sxs-lookup"><span data-stu-id="552cf-106">MetadataImportWithX509OverSslExample</span></span>

<span data-ttu-id="552cf-107">В этом примере показано, как импортировать метаданные из конечной точки, поддерживающей использование токена X509, используя [**\_ \_ \_ \_ \_ привязку безопасности сообщений токена WS-XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) с [**\_ \_ \_ \_ привязкой безопасности транспорта WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="552cf-107">This example illustrates importing metadata from an endpoint that supports using a X509 token using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithx509oversslexamplecpp"></a><span data-ttu-id="552cf-108">MetadataImportWithX509OverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="552cf-108">MetadataImportWithX509OverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="552cf-109">См. также</span><span class="sxs-lookup"><span data-stu-id="552cf-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="552cf-110">**\_ \_ \_ \_ Привязка безопасности сообщений для токена WS XML \_**</span><span class="sxs-lookup"><span data-stu-id="552cf-110">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="552cf-111">**\_ \_ \_ Привязка безопасности транспорта WS \_ SSL**</span><span class="sxs-lookup"><span data-stu-id="552cf-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
