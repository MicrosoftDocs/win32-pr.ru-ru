...
В этом примере показано, как импортировать метаданные из конечной точки, поддерживающей использование токена X509, используя [**\_ \_ \_ \_ \_ привязку безопасности сообщений токена WS-XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) с [**\_ \_ \_ \_ привязкой безопасности транспорта WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).
