...
В этом примере показан сервер именованных каналов, принимающий канал и принимающий сообщения и ответы на них с безопасностью, предоставляемой безопасностью транспорта Windows SSPI.
