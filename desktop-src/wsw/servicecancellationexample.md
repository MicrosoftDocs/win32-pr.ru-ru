---
title: сервицеканцеллатионексампле
description: Пример клиентского приложения, демонстрирующий отмену службы.
ms.assetid: c9e727c8-5fa7-47b9-8624-18fe4de79026
keywords:
- Сервицеканцеллатионексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103887412"
---
# <a name="servicecancellationexample"></a><span data-ttu-id="44c6d-106">сервицеканцеллатионексампле</span><span class="sxs-lookup"><span data-stu-id="44c6d-106">ServiceCancellationExample</span></span>

<span data-ttu-id="44c6d-107">Пример клиентского приложения, демонстрирующий отмену службы.</span><span class="sxs-lookup"><span data-stu-id="44c6d-107">Example client application demonstrating service cancellation.</span></span>

-   [<span data-ttu-id="44c6d-108">Сервицеканцел. cpp</span><span class="sxs-lookup"><span data-stu-id="44c6d-108">ServiceCancel.cpp</span></span>](#servicecancelcpp)
-   [<span data-ttu-id="44c6d-109">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="44c6d-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="44c6d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="44c6d-110">Makefile</span></span>](#makefile)

## <a name="servicecancelcpp"></a><span data-ttu-id="44c6d-111">Сервицеканцел. cpp</span><span class="sxs-lookup"><span data-stu-id="44c6d-111">ServiceCancel.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="44c6d-112">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="44c6d-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="44c6d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="44c6d-113">Makefile</span></span>
