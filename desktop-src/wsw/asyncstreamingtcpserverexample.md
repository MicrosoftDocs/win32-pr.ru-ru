...
---
# <a name="asyncstreamingtcpserverexample"></a>асинкстреамингткпсерверексампле

В этом примере показан TCP-сервер, принимающий односторонние сообщения в асинхронной потоковой передаче.

-   [Асинкстреамингткпсервер. cpp](#asyncstreamingtcpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="asyncstreamingtcpservercpp"></a>Асинкстреамингткпсервер. cpp
