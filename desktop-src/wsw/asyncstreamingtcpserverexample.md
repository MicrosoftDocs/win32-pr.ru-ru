---
title: асинкстреамингткпсерверексампле
description: В этом примере показан TCP-сервер, принимающий односторонние сообщения в асинхронной потоковой передаче.
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- Асинкстреамингткпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105661579"
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="d00a1-106">асинкстреамингткпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="d00a1-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="d00a1-107">В этом примере показан TCP-сервер, принимающий односторонние сообщения в асинхронной потоковой передаче.</span><span class="sxs-lookup"><span data-stu-id="d00a1-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="d00a1-108">Асинкстреамингткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="d00a1-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="d00a1-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d00a1-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d00a1-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="d00a1-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="d00a1-111">Асинкстреамингткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="d00a1-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d00a1-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="d00a1-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d00a1-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="d00a1-113">Makefile</span></span>
