---
title: рекуестреплиткпклиентвисвиндовстранспортсекуритексампле
description: В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI. Он также иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.
ms.assetid: 8419e861-dc7f-41ca-96a4-b7c6d380a210
keywords:
- Рекуестреплиткпклиентвисвиндовстранспортсекуритексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104328267"
---
# <a name="requestreplytcpclientwithwindowstransportsecurityexample"></a><span data-ttu-id="56333-107">рекуестреплиткпклиентвисвиндовстранспортсекуритексампле</span><span class="sxs-lookup"><span data-stu-id="56333-107">RequestReplyTcpClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="56333-108">В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI.</span><span class="sxs-lookup"><span data-stu-id="56333-108">This example shows a TCP client that sends request-reply messages, with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="56333-109">Он также иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.</span><span class="sxs-lookup"><span data-stu-id="56333-109">It also illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="56333-110">Рекуестреплиткпклиентвисвиндовстранспортсекурити. cpp</span><span class="sxs-lookup"><span data-stu-id="56333-110">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="56333-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="56333-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="56333-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="56333-112">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="56333-113">Рекуестреплиткпклиентвисвиндовстранспортсекурити. cpp</span><span class="sxs-lookup"><span data-stu-id="56333-113">RequestReplyTcpClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="56333-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="56333-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="56333-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="56333-115">Makefile</span></span>
