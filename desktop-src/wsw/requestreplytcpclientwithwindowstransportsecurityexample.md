...
в этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ" с безопасностью, предоставляемой Windows безопасностью транспорта SSPI. Он также иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.
