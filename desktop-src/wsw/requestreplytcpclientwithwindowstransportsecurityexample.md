...
---
# <a name="requestreplytcpclientwithwindowstransportsecurityexample"></a>рекуестреплиткпклиентвисвиндовстранспортсекуритексампле

В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI. Он также иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.

-   [Рекуестреплиткпклиентвисвиндовстранспортсекурити. cpp](#requestreplytcpclientwithwindowstransportsecuritycpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplytcpclientwithwindowstransportsecuritycpp"></a>Рекуестреплиткпклиентвисвиндовстранспортсекурити. cpp
