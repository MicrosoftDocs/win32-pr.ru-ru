...
ms.locfileid: "119805694"
---
# <a name="customheaderexample"></a>кустомхеадерексампле

В этом примере показано, как добавить и получить пользовательский заголовок.

-   [Кустомхеадер. cpp](#customheadercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="customheadercpp"></a>Кустомхеадер. cpp
