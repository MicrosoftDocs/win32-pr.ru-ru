---
title: кустомхеадерексампле
description: В этом примере показано, как добавить и получить пользовательский заголовок.
ms.assetid: 9c0cabee-4645-4b2d-a132-4494911f05b3
keywords:
- Веб-службы Кустомхеадерексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105719065"
---
# <a name="customheaderexample"></a><span data-ttu-id="43922-106">кустомхеадерексампле</span><span class="sxs-lookup"><span data-stu-id="43922-106">CustomHeaderExample</span></span>

<span data-ttu-id="43922-107">В этом примере показано, как добавить и получить пользовательский заголовок.</span><span class="sxs-lookup"><span data-stu-id="43922-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="43922-108">Кустомхеадер. cpp</span><span class="sxs-lookup"><span data-stu-id="43922-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="43922-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="43922-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="43922-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="43922-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="43922-111">Кустомхеадер. cpp</span><span class="sxs-lookup"><span data-stu-id="43922-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="43922-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="43922-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="43922-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="43922-113">Makefile</span></span>
