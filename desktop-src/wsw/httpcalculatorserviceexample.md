---
title: хттпкалкулаторсервицеексампле
description: В этом примере показано, как использовать узел службы для размещения службы калькулятора по протоколу HTTP.
ms.assetid: 898bc206-ad64-461c-a734-c8791b6b106d
keywords:
- Хттпкалкулаторсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068639"
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="b61fb-106">хттпкалкулаторсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="b61fb-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="b61fb-107">В этом примере показано, как использовать узел службы для размещения службы калькулятора по протоколу HTTP.</span><span class="sxs-lookup"><span data-stu-id="b61fb-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="b61fb-108">Хттпкалкулаторсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="b61fb-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="b61fb-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="b61fb-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="b61fb-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="b61fb-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="b61fb-111">Хттпкалкулаторсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="b61fb-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="b61fb-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="b61fb-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b61fb-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="b61fb-113">Makefile</span></span>
