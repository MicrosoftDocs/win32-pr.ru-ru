...
**WsUtil.exe \[ Параметры командной строки для \[ переключения параметров \] :\]<filename>**
...
-   /префикс: <string> начало указанной строки для всех созданных идентификаторов.
