...
---
# <a name="onewayudpclientexample"></a>оневайудпклиентексампле

В этом примере показан клиент UDP, который отправляет однонаправленные сообщения.

-   [Оневайудпклиент. cpp](#onewayudpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="onewayudpclientcpp"></a>Оневайудпклиент. cpp
