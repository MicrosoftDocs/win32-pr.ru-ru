---
title: оневайудпклиентексампле
description: В этом примере показан клиент UDP, который отправляет однонаправленные сообщения.
ms.assetid: 245876f7-dc79-4ecd-b510-cf5e60eaa9fc
keywords:
- Оневайудпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103986774"
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="09340-106">оневайудпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="09340-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="09340-107">В этом примере показан клиент UDP, который отправляет однонаправленные сообщения.</span><span class="sxs-lookup"><span data-stu-id="09340-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="09340-108">Оневайудпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="09340-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="09340-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="09340-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="09340-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="09340-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="09340-111">Оневайудпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="09340-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="09340-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="09340-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="09340-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="09340-113">Makefile</span></span>
