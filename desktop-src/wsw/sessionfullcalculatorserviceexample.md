---
title: сессионфуллкалкулаторсервицеексампле
description: Реализация службы калькулятора сеансов с помощью узла службы.
ms.assetid: 7501025b-5692-4f89-ad74-c60694c29163
keywords:
- Сессионфуллкалкулаторсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104332547"
---
# <a name="sessionfullcalculatorserviceexample"></a><span data-ttu-id="e143e-106">сессионфуллкалкулаторсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="e143e-106">SessionfullCalculatorServiceExample</span></span>

<span data-ttu-id="e143e-107">Реализация службы калькулятора сеансов с помощью узла службы.</span><span class="sxs-lookup"><span data-stu-id="e143e-107">An implementation of a sessionful calculator service using the Service Host.</span></span>

-   [<span data-ttu-id="e143e-108">Сессионфуллкалкулаторсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="e143e-108">SessionfullCalculatorService.cpp</span></span>](#sessionfullcalculatorservicecpp)
-   [<span data-ttu-id="e143e-109">Сессионбаседкалкулаторсервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="e143e-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="e143e-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="e143e-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorservicecpp"></a><span data-ttu-id="e143e-111">Сессионфуллкалкулаторсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="e143e-111">SessionfullCalculatorService.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="e143e-112">Сессионбаседкалкулаторсервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="e143e-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="e143e-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="e143e-113">Makefile</span></span>
