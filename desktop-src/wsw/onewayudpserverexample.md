---
title: оневайудпсерверексампле
description: В этом примере показан сервер UDP, принимающий канал и принимающий односторонние сообщения.
ms.assetid: 45317e45-03d5-4d17-89cd-9108f81490ff
keywords:
- Оневайудпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103779403"
---
# <a name="onewayudpserverexample"></a><span data-ttu-id="0446d-106">оневайудпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="0446d-106">OneWayUdpServerExample</span></span>

<span data-ttu-id="0446d-107">В этом примере показан сервер UDP, принимающий канал и принимающий односторонние сообщения.</span><span class="sxs-lookup"><span data-stu-id="0446d-107">This example shows a UDP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="0446d-108">Оневайудпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="0446d-108">OneWayUdpServer.cpp</span></span>](#onewayudpservercpp)
-   [<span data-ttu-id="0446d-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0446d-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0446d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0446d-110">Makefile</span></span>](#makefile)

## <a name="onewayudpservercpp"></a><span data-ttu-id="0446d-111">Оневайудпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="0446d-111">OneWayUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0446d-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0446d-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0446d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0446d-113">Makefile</span></span>
