...
---
# <a name="onewayudpserverexample"></a>оневайудпсерверексампле

В этом примере показан сервер UDP, принимающий канал и принимающий односторонние сообщения.

-   [Оневайудпсервер. cpp](#onewayudpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="onewayudpservercpp"></a>Оневайудпсервер. cpp
