...
description: В этом примере показан клиент UDP, который выполняет многоадресную отправку запроса, а затем ожидает ответные сообщения от серверов, используя IPv6.
...
ms.locfileid: "104328840"
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="a8ce5-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="a8ce5-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="a8ce5-107">В этом примере показан клиент UDP, который выполняет многоадресную отправку запроса, а затем ожидает ответные сообщения от серверов, используя IPv6.</span><span class="sxs-lookup"><span data-stu-id="a8ce5-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="a8ce5-108">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="a8ce5-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="a8ce5-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a8ce5-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a8ce5-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="a8ce5-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="a8ce5-111">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="a8ce5-111">MulticastUdpClient6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a8ce5-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="a8ce5-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a8ce5-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="a8ce5-113">Makefile</span></span>
