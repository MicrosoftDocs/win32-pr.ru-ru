...
description: В этом примере демонстрируется реализация сложной асинхронной функции без использования Всасинцексекуте.
ms.assetid: e60a4005-4849-4603-ae25-b88da8628f80
keywords:
- Веб-службы AsyncAdd3ExplicitExample для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104411036"
---
# <a name="asyncadd3explicitexample"></a><span data-ttu-id="9e84a-106">AsyncAdd3ExplicitExample</span><span class="sxs-lookup"><span data-stu-id="9e84a-106">AsyncAdd3ExplicitExample</span></span>

<span data-ttu-id="9e84a-107">В этом примере демонстрируется реализация сложной асинхронной функции без использования [**всасинцексекуте**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span><span class="sxs-lookup"><span data-stu-id="9e84a-107">This example illustrates implementing a complex asynchronous function without using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="9e84a-108">В примере реализуется асинхронная функция "Аддсри", которая складывает три целых числа, создавая на основе существующей функции Add, которая может добавлять два целых числа в асинхронном режиме.</span><span class="sxs-lookup"><span data-stu-id="9e84a-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3explicitcpp"></a><span data-ttu-id="9e84a-109">AsyncAdd3Explicit. cpp</span><span class="sxs-lookup"><span data-stu-id="9e84a-109">AsyncAdd3Explicit.cpp</span></span>
