...
В этом примере демонстрируется реализация сложной асинхронной функции без использования [**всасинцексекуте**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).

В примере реализуется асинхронная функция "Аддсри", которая складывает три целых числа, создавая на основе существующей функции Add, которая может добавлять два целых числа в асинхронном режиме.
