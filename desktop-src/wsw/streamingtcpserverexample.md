---
title: стреамингткпсерверексампле
description: В этом примере показан TCP-сервер, принимающий канал, и считывающий односторонние сообщения в потоковой манере.
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- Стреамингткпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104410843"
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="c38eb-106">стреамингткпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="c38eb-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="c38eb-107">В этом примере показан TCP-сервер, принимающий канал, и считывающий односторонние сообщения в потоковой манере.</span><span class="sxs-lookup"><span data-stu-id="c38eb-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="c38eb-108">Стреамингткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="c38eb-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="c38eb-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c38eb-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c38eb-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="c38eb-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="c38eb-111">Стреамингткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="c38eb-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c38eb-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="c38eb-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c38eb-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="c38eb-113">Makefile</span></span>
