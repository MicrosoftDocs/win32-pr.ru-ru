...
---
# <a name="streamingtcpserverexample"></a>стреамингткпсерверексампле

В этом примере показан TCP-сервер, принимающий канал, и считывающий односторонние сообщения в потоковой манере.

-   [Стреамингткпсервер. cpp](#streamingtcpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streamingtcpservercpp"></a>Стреамингткпсервер. cpp
