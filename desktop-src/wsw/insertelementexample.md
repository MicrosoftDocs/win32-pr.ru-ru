---
title: инсертелементексампле
description: В этом примере показано, как вставить элемент в XML-буфер.
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- Инсертелементексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104532285"
---
# <a name="insertelementexample"></a><span data-ttu-id="7faff-106">инсертелементексампле</span><span class="sxs-lookup"><span data-stu-id="7faff-106">InsertElementExample</span></span>

<span data-ttu-id="7faff-107">В этом примере показано, как вставить элемент в XML-буфер.</span><span class="sxs-lookup"><span data-stu-id="7faff-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="7faff-108">Инсертелемент. cpp</span><span class="sxs-lookup"><span data-stu-id="7faff-108">InsertElement.cpp</span></span>
