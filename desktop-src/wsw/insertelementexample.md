...
---
# <a name="insertelementexample"></a>инсертелементексампле

В этом примере показано, как вставить элемент в XML-буфер.

## <a name="insertelementcpp"></a>Инсертелемент. cpp
