...
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a>хттпкалкулаторвисенкодедчаннелклиентексампле

В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала. Канал использует пользовательский кодировщик.

-   [Хттпкалкулаторвисенкодедчаннелклиент. cpp](#httpcalculatorwithencodedchannelclientcpp)
-   [CalculatorService. WSDL](#calculatorservicewsdl)
-   [Енкодедчаннел. cpp](#encodedchannelcpp)
-   [Енкодедчаннел. h](#encodedchannelh)
-   [Makefile](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a>Хттпкалкулаторвисенкодедчаннелклиент. cpp
...
## <a name="encodedchannelcpp"></a>Енкодедчаннел. cpp
...
## <a name="encodedchannelh"></a>Енкодедчаннел. h
