---
title: хттпкалкулаторвисенкодедчаннелклиентексампле
description: В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала. Канал использует пользовательский кодировщик.
ms.assetid: cef3db1d-6362-4599-a4bf-f43079848691
keywords:
- Хттпкалкулаторвисенкодедчаннелклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103986841"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a><span data-ttu-id="3c35a-107">хттпкалкулаторвисенкодедчаннелклиентексампле</span><span class="sxs-lookup"><span data-stu-id="3c35a-107">HttpCalculatorWithEncodedChannelClientExample</span></span>

<span data-ttu-id="3c35a-108">В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP с помощью пользовательского канала.</span><span class="sxs-lookup"><span data-stu-id="3c35a-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="3c35a-109">Канал использует пользовательский кодировщик.</span><span class="sxs-lookup"><span data-stu-id="3c35a-109">The channel is uses a custom encoder.</span></span>

-   [<span data-ttu-id="3c35a-110">Хттпкалкулаторвисенкодедчаннелклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="3c35a-110">HttpCalculatorWithEncodedChannelClient.cpp</span></span>](#httpcalculatorwithencodedchannelclientcpp)
-   [<span data-ttu-id="3c35a-111">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="3c35a-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="3c35a-112">Енкодедчаннел. cpp</span><span class="sxs-lookup"><span data-stu-id="3c35a-112">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="3c35a-113">Енкодедчаннел. h</span><span class="sxs-lookup"><span data-stu-id="3c35a-113">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="3c35a-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="3c35a-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a><span data-ttu-id="3c35a-115">Хттпкалкулаторвисенкодедчаннелклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="3c35a-115">HttpCalculatorWithEncodedChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="3c35a-116">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="3c35a-116">CalculatorService.wsdl</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="3c35a-117">Енкодедчаннел. cpp</span><span class="sxs-lookup"><span data-stu-id="3c35a-117">EncodedChannel.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="3c35a-118">Енкодедчаннел. h</span><span class="sxs-lookup"><span data-stu-id="3c35a-118">EncodedChannel.h</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3c35a-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="3c35a-119">Makefile</span></span>
