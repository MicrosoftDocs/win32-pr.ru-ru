...
ms.locfileid: "119444764"
---
# <a name="asynchronous-function-example"></a>Пример асинхронной функции

Этот пример иллюстрирует реализацию и вызов асинхронных функций.

Пример состоит из следующих частей:

-   Функция Add, которая будет добавлять два числа синхронно или асинхронно. Он создает поток как сведения о реализации для асинхронного случая.
-   Функция Калладдсинк вызывает функцию добавления функций синхронно.
-   Функция Калладдасинк вызывает функции Add в асинхронном режиме.

## <a name="asyncmodelcpp"></a>Асинкмодел. cpp
