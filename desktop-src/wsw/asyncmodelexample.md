---
title: Пример асинхронной функции
description: Этот пример иллюстрирует реализацию и вызов асинхронных функций.
ms.assetid: e71bd231-c69c-409f-874c-a0798b844ee6
keywords:
- Веб-службы Асинкмоделексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104330504"
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="bffe1-106">Пример асинхронной функции</span><span class="sxs-lookup"><span data-stu-id="bffe1-106">Asynchronous Function Example</span></span>

<span data-ttu-id="bffe1-107">Этот пример иллюстрирует реализацию и вызов асинхронных функций.</span><span class="sxs-lookup"><span data-stu-id="bffe1-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="bffe1-108">Пример состоит из следующих частей:</span><span class="sxs-lookup"><span data-stu-id="bffe1-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="bffe1-109">Функция Add, которая будет добавлять два числа синхронно или асинхронно.</span><span class="sxs-lookup"><span data-stu-id="bffe1-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="bffe1-110">Он создает поток как сведения о реализации для асинхронного случая.</span><span class="sxs-lookup"><span data-stu-id="bffe1-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="bffe1-111">Функция Калладдсинк вызывает функцию добавления функций синхронно.</span><span class="sxs-lookup"><span data-stu-id="bffe1-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="bffe1-112">Функция Калладдасинк вызывает функции Add в асинхронном режиме.</span><span class="sxs-lookup"><span data-stu-id="bffe1-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="bffe1-113">Асинкмодел. cpp</span><span class="sxs-lookup"><span data-stu-id="bffe1-113">AsyncModel.cpp</span></span>
