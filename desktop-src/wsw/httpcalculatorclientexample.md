---
title: хттпкалкулаторклиентексампле
description: В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP.
ms.assetid: dd97613d-3bb7-427c-a292-220d1efed96c
keywords:
- Веб-службы Хттпкалкулаторклиентексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105710167"
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="131af-106">хттпкалкулаторклиентексампле</span><span class="sxs-lookup"><span data-stu-id="131af-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="131af-107">В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой калькулятора на основе HTTP.</span><span class="sxs-lookup"><span data-stu-id="131af-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="131af-108">Хттпкалкулаторклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="131af-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="131af-109">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="131af-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="131af-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="131af-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="131af-111">Хттпкалкулаторклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="131af-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="131af-112">CalculatorService. WSDL</span><span class="sxs-lookup"><span data-stu-id="131af-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="131af-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="131af-113">Makefile</span></span>
