...
ms.locfileid: "118963133"
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a>хттппурчасеордервисусернамеоверсслклиентексампле

В этом примере показан HTTP-клиент, использующий прокси-сервер службы для взаимодействия со службой PurchaseOrder, с именем пользователя в смешанном режиме защиты SSL. В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера. Проверка подлинности клиента обеспечивается парой имени пользователя и пароля в заголовке WS-Security сообщения.

-   [Пурчасеордерклиентусернамеоверссл. cpp](#purchaseorderclientusernameoversslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a>Пурчасеордерклиентусернамеоверссл. cpp
