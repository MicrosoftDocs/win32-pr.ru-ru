...
---
# <a name="requestreplynamedpipesclientexample"></a>рекуестреплинамедпипесклиентексампле

В этом примере показан клиент именованного канала, который отправляет сообщения типа "запрос-ответ".

-   [Рекуестреплинамедпипесклиент. cpp](#requestreplynamedpipesclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a>Рекуестреплинамедпипесклиент. cpp
