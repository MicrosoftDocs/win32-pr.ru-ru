---
title: рекуестреплинамедпипесклиентексампле
description: В этом примере показан клиент именованного канала, который отправляет сообщения типа "запрос-ответ".
...
ms.locfileid: "104252731"
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="7f492-103">рекуестреплинамедпипесклиентексампле</span><span class="sxs-lookup"><span data-stu-id="7f492-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="7f492-104">В этом примере показан клиент именованного канала, который отправляет сообщения типа "запрос-ответ".</span><span class="sxs-lookup"><span data-stu-id="7f492-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="7f492-105">Рекуестреплинамедпипесклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7f492-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="7f492-106">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f492-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7f492-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f492-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="7f492-108">Рекуестреплинамедпипесклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7f492-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7f492-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f492-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7f492-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f492-110">Makefile</span></span>
