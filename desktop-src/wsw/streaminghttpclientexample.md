---
title: стреамингхттпклиентексампле
description: В этом примере показан HTTP-клиент, который выполняет запрос-ответ с помощью API потоковой передачи.
ms.assetid: dd391506-6f14-4d3a-bd65-96a338b3f7cd
keywords:
- Стреамингхттпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105691394"
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="6ab38-106">стреамингхттпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="6ab38-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="6ab38-107">В этом примере показан HTTP-клиент, который выполняет запрос-ответ с помощью API потоковой передачи.</span><span class="sxs-lookup"><span data-stu-id="6ab38-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="6ab38-108">Стреамингхттпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="6ab38-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="6ab38-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6ab38-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="6ab38-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="6ab38-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="6ab38-111">Стреамингхттпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="6ab38-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="6ab38-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="6ab38-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="6ab38-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="6ab38-113">Makefile</span></span>
