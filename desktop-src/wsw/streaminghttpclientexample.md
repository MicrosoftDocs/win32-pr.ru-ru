...
ms.locfileid: "119026152"
---
# <a name="streaminghttpclientexample"></a>стреамингхттпклиентексампле

В этом примере показан HTTP-клиент, который выполняет запрос-ответ с помощью API потоковой передачи.

-   [Стреамингхттпклиент. cpp](#streaminghttpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streaminghttpclientcpp"></a>Стреамингхттпклиент. cpp
