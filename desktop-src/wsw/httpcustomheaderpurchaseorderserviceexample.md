...
description: ознакомьтесь с примером использования API веб-служб Windows (ввсапи) C++ в качестве службы заказа на покупку для пользовательских заголовков HTTP.
...
-   [Хттпкустомхеадерсервице. cpp](#httpcustomheaderservicecpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Ордерсессионхеадер. xsd](#ordersessionheaderxsd)
-   [Makefile](#makefile)

## <a name="httpcustomheaderservicecpp"></a>Хттпкустомхеадерсервице. cpp
