---
title: асинкстреамингткпклиентексампле
description: В этом примере показан клиент TCP, который отправляет односторонние сообщения в асинхронной потоковой передаче.
ms.assetid: b0040b3d-d830-421a-bbf1-afb0cac47599
keywords:
- Асинкстреамингткпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104330499"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="0c0fd-106">асинкстреамингткпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="0c0fd-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="0c0fd-107">В этом примере показан клиент TCP, который отправляет односторонние сообщения в асинхронной потоковой передаче.</span><span class="sxs-lookup"><span data-stu-id="0c0fd-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="0c0fd-108">Асинкстреамингткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="0c0fd-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="0c0fd-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0c0fd-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0c0fd-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0c0fd-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="0c0fd-111">Асинкстреамингткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="0c0fd-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0c0fd-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0c0fd-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0c0fd-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0c0fd-113">Makefile</span></span>
