...
ms.locfileid: "117841821"
---
# <a name="asyncstreamingtcpclientexample"></a>асинкстреамингткпклиентексампле

В этом примере показан клиент TCP, который отправляет односторонние сообщения в асинхронной потоковой передаче.

-   [Асинкстреамингткпклиент. cpp](#asyncstreamingtcpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a>Асинкстреамингткпклиент. cpp
