...
---
# <a name="navigatexmlexample"></a><span data-ttu-id="6e19d-107">навигатексмлексампле</span><span class="sxs-lookup"><span data-stu-id="6e19d-107">NavigateXmlExample</span></span>

<span data-ttu-id="6e19d-108">Этот пример записывает XML-код в XML-буфер, а затем считывает его обратно.</span><span class="sxs-lookup"><span data-stu-id="6e19d-108">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="6e19d-109">Навигатексмл. cpp</span><span class="sxs-lookup"><span data-stu-id="6e19d-109">NavigateXml.cpp</span></span>
