...
ms.locfileid: "103986776"
---
# <a name="navigatexmlexample"></a><span data-ttu-id="7eb24-106">навигатексмлексампле</span><span class="sxs-lookup"><span data-stu-id="7eb24-106">NavigateXmlExample</span></span>

<span data-ttu-id="7eb24-107">Этот пример записывает XML-код в XML-буфер, а затем считывает его обратно.</span><span class="sxs-lookup"><span data-stu-id="7eb24-107">This example writes XML to an XML buffer, and then reads it back out.</span></span>

## <a name="navigatexmlcpp"></a><span data-ttu-id="7eb24-108">Навигатексмл. cpp</span><span class="sxs-lookup"><span data-stu-id="7eb24-108">NavigateXml.cpp</span></span>
