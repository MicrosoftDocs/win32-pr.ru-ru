---
title: блоккингсервицеексампле
description: Пример приложения службы, демонстрирующий отмену вызова на стороне сервера.
ms.assetid: a0a862bc-521a-477a-854d-58642d497109
keywords:
- Блоккингсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068053"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="b25aa-106">блоккингсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="b25aa-106">BlockingServiceExample</span></span>

<span data-ttu-id="b25aa-107">Пример приложения службы, демонстрирующий отмену вызова на стороне сервера.</span><span class="sxs-lookup"><span data-stu-id="b25aa-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="b25aa-108">Канцеллингсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="b25aa-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="b25aa-109">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="b25aa-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="b25aa-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="b25aa-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="b25aa-111">Канцеллингсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="b25aa-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="b25aa-112">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="b25aa-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b25aa-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="b25aa-113">Makefile</span></span>
