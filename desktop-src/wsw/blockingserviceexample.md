...
ms.locfileid: "119805824"
---
# <a name="blockingserviceexample"></a>блоккингсервицеексампле

Пример приложения службы, демонстрирующий отмену вызова на стороне сервера.

-   [Канцеллингсервице. cpp](#cancellingservicecpp)
-   [Блоккунблокксервице. WSDL](#blockunblockservicewsdl)
-   [Makefile](#makefile)

## <a name="cancellingservicecpp"></a>Канцеллингсервице. cpp
...
## <a name="blockunblockservicewsdl"></a>Блоккунблокксервице. WSDL
