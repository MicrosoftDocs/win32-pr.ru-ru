...
ms.locfileid: "119545734"
---
# <a name="streamingnamedpipesclientexample"></a>стреамингнамедпипесклиентексампле

В этом примере показан клиент именованных каналов, который отправляет односторонние сообщения потоковой передаче образом.

-   [Стреамингнамедпипесклиент. cpp](#streamingnamedpipesclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streamingnamedpipesclientcpp"></a>Стреамингнамедпипесклиент. cpp
