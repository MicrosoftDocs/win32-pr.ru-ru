---
title: рекуестреплинамедпипесклиентвисвиндовстранспортсекуритексампле
description: В этом примере показан клиент именованных каналов, который отправляет сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI. Он иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.
...
ms.locfileid: "104531823"
---
# <a name="requestreplynamedpipesclientwithwindowstransportsecurityexample"></a><span data-ttu-id="50766-104">рекуестреплинамедпипесклиентвисвиндовстранспортсекуритексампле</span><span class="sxs-lookup"><span data-stu-id="50766-104">RequestReplyNamedPipesClientWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="50766-105">В этом примере показан клиент именованных каналов, который отправляет сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI.</span><span class="sxs-lookup"><span data-stu-id="50766-105">This example shows a named pipes client that sends request-reply messages with security provided by Windows SSPI transport security.</span></span> <span data-ttu-id="50766-106">Он иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.</span><span class="sxs-lookup"><span data-stu-id="50766-106">It illustrates the client using security token properties to modify the allowed impersonation level from the default.</span></span>

-   [<span data-ttu-id="50766-107">Рекуестреплинамедпипесклиентвисвиндовстранспортсекурити. cpp</span><span class="sxs-lookup"><span data-stu-id="50766-107">RequestReplyNamedPipesClientWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesclientwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="50766-108">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="50766-108">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="50766-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="50766-109">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientwithwindowstransportsecuritycpp"></a><span data-ttu-id="50766-110">Рекуестреплинамедпипесклиентвисвиндовстранспортсекурити. cpp</span><span class="sxs-lookup"><span data-stu-id="50766-110">RequestReplyNamedPipesClientWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="50766-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="50766-111">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="50766-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="50766-112">Makefile</span></span>
