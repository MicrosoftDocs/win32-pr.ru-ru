...
---
# <a name="requestreplynamedpipesclientwithwindowstransportsecurityexample"></a>рекуестреплинамедпипесклиентвисвиндовстранспортсекуритексампле

В этом примере показан клиент именованных каналов, который отправляет сообщения типа "запрос-ответ" с безопасностью, предоставляемой безопасностью транспорта Windows SSPI. Он иллюстрирует использование свойств токена безопасности клиентом для изменения разрешенного уровня олицетворения из значения по умолчанию.

-   [Рекуестреплинамедпипесклиентвисвиндовстранспортсекурити. cpp](#requestreplynamedpipesclientwithwindowstransportsecuritycpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplynamedpipesclientwithwindowstransportsecuritycpp"></a>Рекуестреплинамедпипесклиентвисвиндовстранспортсекурити. cpp
