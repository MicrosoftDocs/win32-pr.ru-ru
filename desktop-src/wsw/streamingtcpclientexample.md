...
ms.locfileid: "118192424"
---
# <a name="streamingtcpclientexample"></a>стреамингткпклиентексампле

В этом примере показан клиент TCP, который отправляет односторонние сообщения в потоковой манере.

-   [Стреамингткпклиент. cpp](#streamingtcpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streamingtcpclientcpp"></a>Стреамингткпклиент. cpp
