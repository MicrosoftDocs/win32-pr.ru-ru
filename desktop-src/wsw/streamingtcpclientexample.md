---
title: стреамингткпклиентексампле
description: В этом примере показан клиент TCP, который отправляет односторонние сообщения в потоковой манере.
ms.assetid: 29e9e08a-2cff-4467-b889-608a34d4b07e
keywords:
- Стреамингткпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068572"
---
# <a name="streamingtcpclientexample"></a><span data-ttu-id="85c11-106">стреамингткпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="85c11-106">StreamingTcpClientExample</span></span>

<span data-ttu-id="85c11-107">В этом примере показан клиент TCP, который отправляет односторонние сообщения в потоковой манере.</span><span class="sxs-lookup"><span data-stu-id="85c11-107">This example shows a TCP client that sends one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="85c11-108">Стреамингткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="85c11-108">StreamingTcpClient.cpp</span></span>](#streamingtcpclientcpp)
-   [<span data-ttu-id="85c11-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="85c11-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="85c11-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="85c11-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpclientcpp"></a><span data-ttu-id="85c11-111">Стреамингткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="85c11-111">StreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="85c11-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="85c11-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="85c11-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="85c11-113">Makefile</span></span>
