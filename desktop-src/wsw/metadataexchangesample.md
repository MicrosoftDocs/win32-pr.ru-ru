...
---
# <a name="metadataexchangesample"></a>метадатаексчанжесампле

В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу TCP. Служба также поддерживает WS-MetadataExchange.

-   [Мекссервице. cpp](#mexservicecpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="mexservicecpp"></a>Мекссервице. cpp
