---
title: метадатаексчанжесампле
description: В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу TCP. Служба также поддерживает WS-MetadataExchange.
ms.assetid: 8f14e6a8-ccb9-4556-b04f-df08c6c80adf
keywords:
- API веб-служб Windows Метадатаексчанжесампле
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067556"
---
# <a name="metadataexchangesample"></a><span data-ttu-id="0b4cc-107">метадатаексчанжесампле</span><span class="sxs-lookup"><span data-stu-id="0b4cc-107">MetadataExchangeSample</span></span>

<span data-ttu-id="0b4cc-108">В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу TCP.</span><span class="sxs-lookup"><span data-stu-id="0b4cc-108">This example shows how to use service host for hosting a PurchaseOrder service over TCP.</span></span> <span data-ttu-id="0b4cc-109">Служба также поддерживает WS-MetadataExchange.</span><span class="sxs-lookup"><span data-stu-id="0b4cc-109">The service also supports WS-MetadataExchange.</span></span>

-   [<span data-ttu-id="0b4cc-110">Мекссервице. cpp</span><span class="sxs-lookup"><span data-stu-id="0b4cc-110">MexService.cpp</span></span>](#mexservicecpp)
-   [<span data-ttu-id="0b4cc-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0b4cc-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0b4cc-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="0b4cc-112">Makefile</span></span>](#makefile)

## <a name="mexservicecpp"></a><span data-ttu-id="0b4cc-113">Мекссервице. cpp</span><span class="sxs-lookup"><span data-stu-id="0b4cc-113">MexService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0b4cc-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="0b4cc-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0b4cc-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="0b4cc-115">Makefile</span></span>
