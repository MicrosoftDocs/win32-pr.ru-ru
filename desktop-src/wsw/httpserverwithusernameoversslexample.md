...
---
# <a name="httpserverwithusernameoversslexample"></a>хттпсервервисусернамеоверсслексампле

В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с помощью имени пользователя в смешанном режиме защиты SSL. В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера. Проверка подлинности клиента обеспечивается парой имени пользователя и пароля в заголовке WS-Security сообщения.

-   [Хттпсервервисусернамеоверссл. cpp](#httpserverwithusernameoversslcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a>Хттпсервервисусернамеоверссл. cpp
