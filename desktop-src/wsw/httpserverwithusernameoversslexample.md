---
title: хттпсервервисусернамеоверсслексампле
description: В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с помощью имени пользователя в смешанном режиме защиты SSL.
ms.assetid: d70ae988-0d7c-4494-a54d-1cd73ab8a8ce
keywords:
- Хттпсервервисусернамеоверсслексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105661647"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="965e1-106">хттпсервервисусернамеоверсслексампле</span><span class="sxs-lookup"><span data-stu-id="965e1-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="965e1-107">В этом примере показан TCP-сервер, принимающий канал и принимающий сообщения и отвечающий на него, с помощью имени пользователя в смешанном режиме защиты SSL.</span><span class="sxs-lookup"><span data-stu-id="965e1-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="965e1-108">В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера.</span><span class="sxs-lookup"><span data-stu-id="965e1-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="965e1-109">Проверка подлинности клиента обеспечивается парой имени пользователя и пароля в заголовке WS-Security сообщения.</span><span class="sxs-lookup"><span data-stu-id="965e1-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="965e1-110">Хттпсервервисусернамеоверссл. cpp</span><span class="sxs-lookup"><span data-stu-id="965e1-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="965e1-111">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="965e1-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="965e1-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="965e1-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="965e1-113">Хттпсервервисусернамеоверссл. cpp</span><span class="sxs-lookup"><span data-stu-id="965e1-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="965e1-114">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="965e1-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="965e1-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="965e1-115">Makefile</span></span>
