...
---
# <a name="derivedtypeexample"></a>дериведтипиксампле

В этом примере производится запись и чтение производных типов с помощью созданных вспомогательных функций C++ Всутил. Дополнительные сведения об описаниях производных типов см. в разделе [**\_ \_ \_ \_ сопоставление полей атрибутов типа WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .

-   [Дериведтипе. cpp](#derivedtypecpp)
-   [Дериведтипе. xsd](#derivedtypexsd)
-   [См. также](#related-topics)

## <a name="derivedtypecpp"></a>Дериведтипе. cpp
...
## <a name="derivedtypexsd"></a>Дериведтипе. xsd
...
[**\_ \_ \_ сопоставление полей атрибутов типа \_ WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
