---
title: дериведтипиксампле
description: В этом примере производится запись и чтение производных типов с помощью созданных вспомогательных функций C++ Всутил. \_ \_ \_ \_ Дополнительные сведения об описаниях производных типов см. в разделе Сопоставление полей атрибутов типа WS.
ms.assetid: 279663c0-8797-4f87-aaec-8cb8d4046a05
keywords:
- Дериведтипиксампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105710061"
---
# <a name="derivedtypeexample"></a><span data-ttu-id="7d2c4-107">дериведтипиксампле</span><span class="sxs-lookup"><span data-stu-id="7d2c4-107">DerivedTypeExample</span></span>

<span data-ttu-id="7d2c4-108">В этом примере производится запись и чтение производных типов с помощью созданных вспомогательных функций C++ Всутил.</span><span class="sxs-lookup"><span data-stu-id="7d2c4-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="7d2c4-109">Дополнительные сведения об описаниях производных типов см. в разделе [**\_ \_ \_ \_ сопоставление полей атрибутов типа WS**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .</span><span class="sxs-lookup"><span data-stu-id="7d2c4-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="7d2c4-110">Дериведтипе. cpp</span><span class="sxs-lookup"><span data-stu-id="7d2c4-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="7d2c4-111">Дериведтипе. xsd</span><span class="sxs-lookup"><span data-stu-id="7d2c4-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="7d2c4-112">См. также</span><span class="sxs-lookup"><span data-stu-id="7d2c4-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="7d2c4-113">Дериведтипе. cpp</span><span class="sxs-lookup"><span data-stu-id="7d2c4-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="7d2c4-114">Дериведтипе. xsd</span><span class="sxs-lookup"><span data-stu-id="7d2c4-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="7d2c4-115">См. также</span><span class="sxs-lookup"><span data-stu-id="7d2c4-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="7d2c4-116">**\_ \_ \_ сопоставление полей атрибутов типа \_ WS**</span><span class="sxs-lookup"><span data-stu-id="7d2c4-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
