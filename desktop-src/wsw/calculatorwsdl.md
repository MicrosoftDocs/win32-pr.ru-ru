---
title: калкулаторвсдл
description: Это пример WSDL/Schema для образцов службы калькулятора.
ms.assetid: 6dbea7dc-2d5c-4e6d-9941-9a93943e1914
keywords:
- Веб-службы Калкулаторвсдл для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="calculatorwsdl"></a><span data-ttu-id="17a30-106">калкулаторвсдл</span><span class="sxs-lookup"><span data-stu-id="17a30-106">CalculatorWsdl</span></span>

<span data-ttu-id="17a30-107">Это пример WSDL/Schema для образцов службы калькулятора.</span><span class="sxs-lookup"><span data-stu-id="17a30-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="17a30-108">Калькулятор. WSDL</span><span class="sxs-lookup"><span data-stu-id="17a30-108">Calculator.wsdl</span></span>
