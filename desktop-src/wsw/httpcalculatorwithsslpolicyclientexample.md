---
title: хттпкалкулаторвиссслполициклиентексампле
description: В этом примере показано, как использовать создаваемые всутил вспомогательные подпрограммы политики для создания прокси-сервера службы для взаимодействия со службой калькулятора с защитой транспорта SSL.
ms.assetid: cf2455d4-0670-4ea2-8ee7-073698bfb765
keywords:
- Хттпкалкулаторвиссслполициклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103986545"
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a><span data-ttu-id="c0192-106">хттпкалкулаторвиссслполициклиентексампле</span><span class="sxs-lookup"><span data-stu-id="c0192-106">HttpCalculatorWithSslPolicyClientExample</span></span>

<span data-ttu-id="c0192-107">В этом примере показано, как использовать создаваемые всутил вспомогательные подпрограммы политики для создания прокси-сервера службы для взаимодействия со службой калькулятора с защитой транспорта SSL.</span><span class="sxs-lookup"><span data-stu-id="c0192-107">This example shows how to use the wsutil generated policy helper routines to create service proxy to talk to a calculator service, with SSL transport security.</span></span> <span data-ttu-id="c0192-108">В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера.</span><span class="sxs-lookup"><span data-stu-id="c0192-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span>

-   [<span data-ttu-id="c0192-109">Хттпкалкулаторвиссслполициклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="c0192-109">HttpCalculatorWithSslPolicyClient.cpp</span></span>](#httpcalculatorwithsslpolicyclientcpp)
-   [<span data-ttu-id="c0192-110">Калкулаторсервицевисполици. WSDL</span><span class="sxs-lookup"><span data-stu-id="c0192-110">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="c0192-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="c0192-111">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a><span data-ttu-id="c0192-112">Хттпкалкулаторвиссслполициклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="c0192-112">HttpCalculatorWithSslPolicyClient.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="c0192-113">Калкулаторсервицевисполици. WSDL</span><span class="sxs-lookup"><span data-stu-id="c0192-113">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c0192-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="c0192-114">Makefile</span></span>
