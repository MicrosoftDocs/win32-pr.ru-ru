...
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a>хттпкалкулаторвиссслполициклиентексампле

В этом примере показано, как использовать создаваемые всутил вспомогательные подпрограммы политики для создания прокси-сервера службы для взаимодействия со службой калькулятора с защитой транспорта SSL. В этой настройке транспортное соединение защищено (подписано, зашифровано) по протоколу SSL, которое также обеспечивает проверку подлинности сервера.

-   [Хттпкалкулаторвиссслполициклиент. cpp](#httpcalculatorwithsslpolicyclientcpp)
-   [Калкулаторсервицевисполици. WSDL](#calculatorservicewithpolicywsdl)
-   [Makefile](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a>Хттпкалкулаторвиссслполициклиент. cpp
