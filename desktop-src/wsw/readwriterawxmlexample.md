---
title: реадвритеравксмлексампле
description: В этом примере показано чтение и запись XML с помощью необработанного кодирования.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- API веб-служб Windows Реадвритеравксмлексампле
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067289"
---
# <a name="readwriterawxmlexample"></a><span data-ttu-id="0cde1-106">реадвритеравксмлексампле</span><span class="sxs-lookup"><span data-stu-id="0cde1-106">ReadWriteRawXmlExample</span></span>

<span data-ttu-id="0cde1-107">В этом примере показано чтение и запись XML с помощью необработанного кодирования.</span><span class="sxs-lookup"><span data-stu-id="0cde1-107">This example shows reading and writing of xml using the raw encoding.</span></span>

## <a name="readwriterawxmlcpp"></a><span data-ttu-id="0cde1-108">Реадвритеравксмл. cpp</span><span class="sxs-lookup"><span data-stu-id="0cde1-108">ReadWriteRawXml.cpp</span></span>
