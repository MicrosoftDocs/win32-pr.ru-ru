...
---
# <a name="readwriterawxmlexample"></a>реадвритеравксмлексампле

В этом примере показано чтение и запись XML с помощью необработанного кодирования.

## <a name="readwriterawxmlcpp"></a>Реадвритеравксмл. cpp
