...
В этом примере демонстрируется реализация сложной асинхронной функции с помощью [**всасинцексекуте**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).
