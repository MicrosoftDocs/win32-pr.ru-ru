...
description: В этом примере демонстрируется реализация сложной асинхронной функции с помощью Всасинцексекуте.
ms.assetid: f84de03f-ecfb-494e-9a1d-a96d399a41c0
keywords:
- Веб-службы AsyncAdd3ImplicitExample для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="asyncadd3implicitexample"></a><span data-ttu-id="f0a76-106">AsyncAdd3ImplicitExample</span><span class="sxs-lookup"><span data-stu-id="f0a76-106">AsyncAdd3ImplicitExample</span></span>

<span data-ttu-id="f0a76-107">В этом примере демонстрируется реализация сложной асинхронной функции с помощью [**всасинцексекуте**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span><span class="sxs-lookup"><span data-stu-id="f0a76-107">This example illustrates implementing a complex asynchronous function using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="f0a76-108">В примере реализуется асинхронная функция "Аддсри", которая складывает три целых числа, создавая на основе существующей функции Add, которая может добавлять два целых числа в асинхронном режиме.</span><span class="sxs-lookup"><span data-stu-id="f0a76-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3implicitcpp"></a><span data-ttu-id="f0a76-109">AsyncAdd3Implicit. cpp</span><span class="sxs-lookup"><span data-stu-id="f0a76-109">AsyncAdd3Implicit.cpp</span></span>
