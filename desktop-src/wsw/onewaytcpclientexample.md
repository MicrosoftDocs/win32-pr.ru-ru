...
---
# <a name="onewaytcpclientexample"></a>оневайткпклиентексампле

В этом примере показан TCP-клиент, отправляющий однонаправленные сообщения.

-   [Оневайткпклиент. cpp](#onewaytcpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="onewaytcpclientcpp"></a>Оневайткпклиент. cpp
