---
title: оневайткпклиентексампле
description: В этом примере показан TCP-клиент, отправляющий однонаправленные сообщения.
ms.assetid: c5e930b5-da13-459c-8a83-eeeb120a79ed
keywords:
- Оневайткпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105681508"
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="4b756-106">оневайткпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="4b756-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="4b756-107">В этом примере показан TCP-клиент, отправляющий однонаправленные сообщения.</span><span class="sxs-lookup"><span data-stu-id="4b756-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="4b756-108">Оневайткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="4b756-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="4b756-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4b756-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4b756-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4b756-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="4b756-111">Оневайткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="4b756-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4b756-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="4b756-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4b756-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4b756-113">Makefile</span></span>
