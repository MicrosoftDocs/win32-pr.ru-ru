...
---
# <a name="readwritearrayexample"></a>реадвритеаррайексампле

В этом примере считывается и записывается массив элементов.

## <a name="readwritearraycpp"></a>Реадвритеаррай. cpp
