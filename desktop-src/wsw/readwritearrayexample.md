---
title: реадвритеаррайексампле
description: В этом примере считывается и записывается массив элементов.
ms.assetid: 3c4851b5-1c31-4de7-929e-03a8199b273a
keywords:
- Веб-службы Реадвритеаррайексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105710025"
---
# <a name="readwritearrayexample"></a><span data-ttu-id="04aaf-106">реадвритеаррайексампле</span><span class="sxs-lookup"><span data-stu-id="04aaf-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="04aaf-107">В этом примере считывается и записывается массив элементов.</span><span class="sxs-lookup"><span data-stu-id="04aaf-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="04aaf-108">Реадвритеаррай. cpp</span><span class="sxs-lookup"><span data-stu-id="04aaf-108">ReadWriteArray.cpp</span></span>
