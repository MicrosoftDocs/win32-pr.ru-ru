---
title: оневайткпсерверексампле
description: В этом примере показан TCP-сервер, принимающий канал и принимающий односторонние сообщения.
ms.assetid: a43fc6a8-f1ee-4f6b-9737-bfe340bb67f0
keywords:
- Оневайткпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104259024"
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="daa22-106">оневайткпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="daa22-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="daa22-107">В этом примере показан TCP-сервер, принимающий канал и принимающий односторонние сообщения.</span><span class="sxs-lookup"><span data-stu-id="daa22-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="daa22-108">Оневайткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="daa22-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="daa22-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="daa22-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="daa22-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="daa22-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="daa22-111">Оневайткпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="daa22-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="daa22-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="daa22-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="daa22-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="daa22-113">Makefile</span></span>
