...
---
# <a name="onewaytcpserverexample"></a>оневайткпсерверексампле

В этом примере показан TCP-сервер, принимающий канал и принимающий односторонние сообщения.

-   [Оневайткпсервер. cpp](#onewaytcpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="onewaytcpservercpp"></a>Оневайткпсервер. cpp
