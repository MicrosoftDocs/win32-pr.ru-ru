---
title: реадаттрибутиксампле
description: В этом примере считывается атрибут.
ms.assetid: e37946f0-66e0-4fb1-aeee-db4447ed4030
keywords:
- Веб-службы Реадаттрибутиксампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067290"
---
# <a name="readattributeexample"></a><span data-ttu-id="72a7e-106">реадаттрибутиксампле</span><span class="sxs-lookup"><span data-stu-id="72a7e-106">ReadAttributeExample</span></span>

<span data-ttu-id="72a7e-107">В этом примере считывается атрибут.</span><span class="sxs-lookup"><span data-stu-id="72a7e-107">This example reads an attribute.</span></span>

## <a name="readattributecpp"></a><span data-ttu-id="72a7e-108">Реадаттрибуте. cpp</span><span class="sxs-lookup"><span data-stu-id="72a7e-108">ReadAttribute.cpp</span></span>
