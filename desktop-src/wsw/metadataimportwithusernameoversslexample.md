...
keywords:
- API веб-служб метадатаимпортвисусернамеоверсслексампле Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119026362"
---
# <a name="metadataimportwithusernameoversslexample"></a>метадатаимпортвисусернамеоверсслексампле

В этом примере показано, как импортировать метаданные из конечной точки, которая поддерживает [**\_ \_ \_ \_ привязку безопасности сообщений имени пользователя WS**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) с [**\_ \_ \_ \_ привязкой безопасности транспорта WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).

## <a name="metadataimportwithusernameoversslexamplecpp"></a>Метадатаимпортвисусернамеоверсслексампле. cpp
