---
title: метадатаимпортвисусернамеоверсслексампле
description: В этом примере показано, как импортировать метаданные из конечной точки, которая поддерживает \_ \_ привязку безопасности сообщений имени пользователя WS \_ \_ с \_ \_ \_ привязкой безопасности транспорта WS SSL \_ .
ms.assetid: 1bce97e2-a841-4c4b-af5e-f747c3fb6e8d
keywords:
- API веб-служб Windows Метадатаимпортвисусернамеоверсслексампле
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105691150"
---
# <a name="metadataimportwithusernameoversslexample"></a><span data-ttu-id="a90cf-106">метадатаимпортвисусернамеоверсслексампле</span><span class="sxs-lookup"><span data-stu-id="a90cf-106">MetadataImportWithUsernameOverSslExample</span></span>

<span data-ttu-id="a90cf-107">В этом примере показано, как импортировать метаданные из конечной точки, которая поддерживает [**\_ \_ \_ \_ привязку безопасности сообщений имени пользователя WS**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) с [**\_ \_ \_ \_ привязкой безопасности транспорта WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="a90cf-107">This example illustrates importing metadata from an endpoint that supports [**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span>

## <a name="metadataimportwithusernameoversslexamplecpp"></a><span data-ttu-id="a90cf-108">Метадатаимпортвисусернамеоверсслексампле. cpp</span><span class="sxs-lookup"><span data-stu-id="a90cf-108">MetadataImportWithUsernameOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="a90cf-109">См. также</span><span class="sxs-lookup"><span data-stu-id="a90cf-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="a90cf-110">**\_ \_ \_ Привязка безопасности сообщений имени пользователя WS \_**</span><span class="sxs-lookup"><span data-stu-id="a90cf-110">**WS\_USERNAME\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding)
</dt> <dt>

[<span data-ttu-id="a90cf-111">**\_ \_ \_ Привязка безопасности транспорта WS \_ SSL**</span><span class="sxs-lookup"><span data-stu-id="a90cf-111">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> </dl>
