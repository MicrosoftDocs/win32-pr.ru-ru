---
title: хттппурчасеордервиссслсервицеексампле
description: В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу HTTP с защитой транспорта SSL.
ms.assetid: 814660d7-98d7-4038-8243-d2f37929d516
keywords:
- Хттппурчасеордервиссслсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103888695"
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="3fa78-106">хттппурчасеордервиссслсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="3fa78-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="3fa78-107">В этом примере показано, как использовать узел службы для размещения службы PurchaseOrder по протоколу HTTP с защитой транспорта SSL.</span><span class="sxs-lookup"><span data-stu-id="3fa78-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="3fa78-108">Хттппурчасеордерсервицевисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="3fa78-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="3fa78-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3fa78-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3fa78-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3fa78-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="3fa78-111">Хттппурчасеордерсервицевисссл. cpp</span><span class="sxs-lookup"><span data-stu-id="3fa78-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3fa78-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="3fa78-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3fa78-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="3fa78-113">Makefile</span></span>
