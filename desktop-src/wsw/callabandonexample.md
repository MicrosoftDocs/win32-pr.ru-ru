---
title: каллабандонексампле
description: Пример клиентского приложения, демонстрирующий отмену вызова.
ms.assetid: 71253dd6-4f59-4acd-b244-c721834ca381
keywords:
- Каллабандонексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104410929"
---
# <a name="callabandonexample"></a><span data-ttu-id="8796a-106">каллабандонексампле</span><span class="sxs-lookup"><span data-stu-id="8796a-106">CallAbandonExample</span></span>

<span data-ttu-id="8796a-107">Пример клиентского приложения, демонстрирующий отмену вызова.</span><span class="sxs-lookup"><span data-stu-id="8796a-107">Example client application demonstrating abandoning a call.</span></span>

-   [<span data-ttu-id="8796a-108">Абандонкаллклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="8796a-108">AbandonCallClient.cpp</span></span>](#abandoncallclientcpp)
-   [<span data-ttu-id="8796a-109">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="8796a-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="8796a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8796a-110">Makefile</span></span>](#makefile)

## <a name="abandoncallclientcpp"></a><span data-ttu-id="8796a-111">Абандонкаллклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="8796a-111">AbandonCallClient.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="8796a-112">Блоккунблокксервице. WSDL</span><span class="sxs-lookup"><span data-stu-id="8796a-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8796a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="8796a-113">Makefile</span></span>
