...
---
# <a name="callabandonexample"></a>каллабандонексампле

Пример клиентского приложения, демонстрирующий отмену вызова.

-   [Абандонкаллклиент. cpp](#abandoncallclientcpp)
-   [Блоккунблокксервице. WSDL](#blockunblockservicewsdl)
-   [Makefile](#makefile)

## <a name="abandoncallclientcpp"></a>Абандонкаллклиент. cpp
