---
title: хттпкустомхеадерпурчасеордерклиентексампле
description: В этом примере показано, как использовать пользовательские заголовки с прокси-сервером службы.
ms.assetid: d56e68cd-c910-4f41-a672-c894ba134e3b
keywords:
- Хттпкустомхеадерпурчасеордерклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104411097"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="04dd4-106">хттпкустомхеадерпурчасеордерклиентексампле</span><span class="sxs-lookup"><span data-stu-id="04dd4-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="04dd4-107">В этом примере показано, как использовать пользовательские заголовки с прокси-сервером службы.</span><span class="sxs-lookup"><span data-stu-id="04dd4-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="04dd4-108">Хттпкустомхеадерклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="04dd4-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="04dd4-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="04dd4-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="04dd4-110">Ордерсессионхеадер. xsd</span><span class="sxs-lookup"><span data-stu-id="04dd4-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="04dd4-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="04dd4-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="04dd4-112">Хттпкустомхеадерклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="04dd4-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="04dd4-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="04dd4-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="04dd4-114">Ордерсессионхеадер. xsd</span><span class="sxs-lookup"><span data-stu-id="04dd4-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="04dd4-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="04dd4-115">Makefile</span></span>
