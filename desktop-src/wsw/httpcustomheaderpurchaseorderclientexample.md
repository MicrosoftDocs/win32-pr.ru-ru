...
ms.locfileid: "118963323"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a>хттпкустомхеадерпурчасеордерклиентексампле

В этом примере показано, как использовать пользовательские заголовки с прокси-сервером службы.

-   [Хттпкустомхеадерклиент. cpp](#httpcustomheaderclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Ордерсессионхеадер. xsd](#ordersessionheaderxsd)
-   [Makefile](#makefile)

## <a name="httpcustomheaderclientcpp"></a>Хттпкустомхеадерклиент. cpp
...
## <a name="ordersessionheaderxsd"></a>Ордерсессионхеадер. xsd
