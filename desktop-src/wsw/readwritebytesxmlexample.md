...
ms.locfileid: "118192880"
---
# <a name="readwritebytesxmlexample"></a>реадвритебитесксмлексампле

В этом примере двоичные данные записываются с помощью кодирования MTOM и считываются.

## <a name="readwritebytesxmlcpp"></a>Реадвритебитесксмл. cpp
