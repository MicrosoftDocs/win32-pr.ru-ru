---
title: реадвритебитесксмлексампле
description: В этом примере двоичные данные записываются с помощью кодирования MTOM и считываются.
ms.assetid: 6b80846e-6959-4c38-bf1b-17827ecb9d1a
keywords:
- Веб-службы Реадвритебитесксмлексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105719053"
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="af43e-106">реадвритебитесксмлексампле</span><span class="sxs-lookup"><span data-stu-id="af43e-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="af43e-107">В этом примере двоичные данные записываются с помощью кодирования MTOM и считываются.</span><span class="sxs-lookup"><span data-stu-id="af43e-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="af43e-108">Реадвритебитесксмл. cpp</span><span class="sxs-lookup"><span data-stu-id="af43e-108">ReadWriteBytesXml.cpp</span></span>
