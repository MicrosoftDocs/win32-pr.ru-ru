...
---
# <a name="streamingnamedpipesserverexample"></a>стреамингнамедпипессерверексампле

В этом примере показан клиент именованных каналов, который принимает канал и считывает односторонние сообщения в потоковой манере.

-   [Стреамингнамедпипессервер. cpp](#streamingnamedpipesservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="streamingnamedpipesservercpp"></a>Стреамингнамедпипессервер. cpp
