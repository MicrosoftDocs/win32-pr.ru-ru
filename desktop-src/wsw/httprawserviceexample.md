...
ms.locfileid: "117841531"
---
# <a name="httprawserviceexample"></a>хттправсервицеексампле

В этом примере показано, как использовать узел службы для обработки необработанных HTTP-запросов (не SOAP).

## <a name="httprawservicecpp"></a>Хттправсервице. cpp
