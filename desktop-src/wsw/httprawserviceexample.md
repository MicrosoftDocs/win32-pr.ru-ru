---
title: хттправсервицеексампле
description: В этом примере показано, как использовать узел службы для обработки необработанных HTTP-запросов (не SOAP).
ms.assetid: fbe5ad9c-f3f4-40c2-86e0-03b945aab89f
keywords:
- Хттправсервицеексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103777783"
---
# <a name="httprawserviceexample"></a><span data-ttu-id="67395-106">хттправсервицеексампле</span><span class="sxs-lookup"><span data-stu-id="67395-106">HttpRawServiceExample</span></span>

<span data-ttu-id="67395-107">В этом примере показано, как использовать узел службы для обработки необработанных HTTP-запросов (не SOAP).</span><span class="sxs-lookup"><span data-stu-id="67395-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="67395-108">Хттправсервице. cpp</span><span class="sxs-lookup"><span data-stu-id="67395-108">HttpRawService.cpp</span></span>
