---
title: хттправклиентексампле
description: Этот пример представляет собой клиентскую часть, которая отправляет необработанные HTTP-запросы.
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- Хттправклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103888692"
---
# <a name="httprawclientexample"></a><span data-ttu-id="dfc93-106">хттправклиентексампле</span><span class="sxs-lookup"><span data-stu-id="dfc93-106">HttpRawClientExample</span></span>

<span data-ttu-id="dfc93-107">Этот пример представляет собой клиентскую часть, которая отправляет необработанные HTTP-запросы.</span><span class="sxs-lookup"><span data-stu-id="dfc93-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="dfc93-108">Хттправклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="dfc93-108">HttpRawClient.cpp</span></span>
