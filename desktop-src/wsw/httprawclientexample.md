...
---
# <a name="httprawclientexample"></a>хттправклиентексампле

Этот пример представляет собой клиентскую часть, которая отправляет необработанные HTTP-запросы.

## <a name="httprawclientcpp"></a>Хттправклиент. cpp
