---
title: вкфпубликсервицесампле
description: В этом примере показано, как прокси-сервер службы обращается к HTTP//131.107.72.15/Example \_ HelloWorld \_ Service \_ Indigo/HelloWorld. svc WSDL.
ms.assetid: 755e645e-b39c-471c-9220-531dec4fc107
keywords:
- API веб-служб Windows Вкфпубликсервицесампле
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067648"
---
# <a name="wcfpublicservicesample"></a><span data-ttu-id="ff087-106">вкфпубликсервицесампле</span><span class="sxs-lookup"><span data-stu-id="ff087-106">WcfPublicServiceSample</span></span>

<span data-ttu-id="ff087-107">В этом примере демонстрируется взаимодействие с прокси-сервером службы http://131.107.72.15/Example\_HelloWorld\_Service\_Indigo/HelloWorld.svc?wsdl .</span><span class="sxs-lookup"><span data-stu-id="ff087-107">This examples shows service proxy talking to http://131.107.72.15/Example\_HelloWorld\_Service\_Indigo/HelloWorld.svc?wsdl.</span></span>

-   [<span data-ttu-id="ff087-108">Вкфпубликсервицеклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="ff087-108">WcfPublicServiceClient.cpp</span></span>](#wcfpublicserviceclientcpp)
-   [<span data-ttu-id="ff087-109">схемы. Microsoft. com. 2003.10. Serialization. xsd</span><span class="sxs-lookup"><span data-stu-id="ff087-109">schemas.microsoft.com.2003.10.Serialization.xsd</span></span>](#schemasmicrosoftcom200310serializationxsd)
-   [<span data-ttu-id="ff087-110">темпури. org. xsd</span><span class="sxs-lookup"><span data-stu-id="ff087-110">tempuri.org.xsd</span></span>](#tempuriorgxsd)
-   [<span data-ttu-id="ff087-111">темпури. org. WSDL</span><span class="sxs-lookup"><span data-stu-id="ff087-111">tempuri.org.wsdl</span></span>](#tempuriorgwsdl)
-   [<span data-ttu-id="ff087-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="ff087-112">Makefile</span></span>](#makefile)

## <a name="wcfpublicserviceclientcpp"></a><span data-ttu-id="ff087-113">Вкфпубликсервицеклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="ff087-113">WcfPublicServiceClient.cpp</span></span>
...
## <a name="schemasmicrosoftcom200310serializationxsd"></a><span data-ttu-id="ff087-114">схемы. Microsoft. com. 2003.10. Serialization. xsd</span><span class="sxs-lookup"><span data-stu-id="ff087-114">schemas.microsoft.com.2003.10.Serialization.xsd</span></span>
...
## <a name="tempuriorgxsd"></a><span data-ttu-id="ff087-115">темпури. org. xsd</span><span class="sxs-lookup"><span data-stu-id="ff087-115">tempuri.org.xsd</span></span>
...
## <a name="tempuriorgwsdl"></a><span data-ttu-id="ff087-116">темпури. org. WSDL</span><span class="sxs-lookup"><span data-stu-id="ff087-116">tempuri.org.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ff087-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="ff087-117">Makefile</span></span>
