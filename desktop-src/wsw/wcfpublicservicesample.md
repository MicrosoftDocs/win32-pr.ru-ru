...
keywords:
- API веб-служб вкфпубликсервицесампле Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119083068"
---
# <a name="wcfpublicservicesample"></a>вкфпубликсервицесампле

В этом примере демонстрируется взаимодействие с прокси-сервером службы http://131.107.72.15/Example\_HelloWorld\_Service\_Indigo/HelloWorld.svc?wsdl .

-   [Вкфпубликсервицеклиент. cpp](#wcfpublicserviceclientcpp)
-   [схемы. Microsoft. com. 2003.10. Serialization. xsd](#schemasmicrosoftcom200310serializationxsd)
-   [темпури. org. xsd](#tempuriorgxsd)
-   [темпури. org. WSDL](#tempuriorgwsdl)
-   [Makefile](#makefile)

## <a name="wcfpublicserviceclientcpp"></a>Вкфпубликсервицеклиент. cpp
...
## <a name="schemasmicrosoftcom200310serializationxsd"></a>схемы. Microsoft. com. 2003.10. Serialization. xsd
...
## <a name="tempuriorgxsd"></a>темпури. org. xsd
...
## <a name="tempuriorgwsdl"></a>темпури. org. WSDL
