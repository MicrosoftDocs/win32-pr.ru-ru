...
ms.locfileid: "118962713"
---
# <a name="xmldictionaryexample"></a>ксмлдиктионарексампле

В этом примере записывается документ, использующий \_ словарь WS XML \_ .

-   [Ксмлдиктионари. cpp](#xmldictionarycpp)
-   [Makefile](#makefile)

## <a name="xmldictionarycpp"></a>Ксмлдиктионари. cpp
