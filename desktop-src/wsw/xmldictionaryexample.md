---
title: ксмлдиктионарексампле
description: В этом примере записывается документ, использующий \_ словарь WS XML \_ .
ms.assetid: d8185577-3483-4005-84e5-0b10a6698e79
keywords:
- Ксмлдиктионарексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104331064"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="aada1-106">ксмлдиктионарексампле</span><span class="sxs-lookup"><span data-stu-id="aada1-106">XmlDictionaryExample</span></span>

<span data-ttu-id="aada1-107">В этом примере записывается документ, использующий \_ словарь WS XML \_ .</span><span class="sxs-lookup"><span data-stu-id="aada1-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="aada1-108">Ксмлдиктионари. cpp</span><span class="sxs-lookup"><span data-stu-id="aada1-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="aada1-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="aada1-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="aada1-110">Ксмлдиктионари. cpp</span><span class="sxs-lookup"><span data-stu-id="aada1-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="aada1-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="aada1-111">Makefile</span></span>
