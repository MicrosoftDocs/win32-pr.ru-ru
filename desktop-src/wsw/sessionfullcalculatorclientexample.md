...
ms.locfileid: "119880964"
---
# <a name="sessionfullcalculatorclientexample"></a>сессионфуллкалкулаторклиентексампле

Клиентское приложение для взаимодействия со службой калькулятора сеансов.

-   [Сессионфуллкалкулаторклиент. cpp](#sessionfullcalculatorclientcpp)
-   [Сессионбаседкалкулаторсервице. WSDL](#sessionbasedcalculatorservicewsdl)
-   [Makefile](#makefile)

## <a name="sessionfullcalculatorclientcpp"></a>Сессионфуллкалкулаторклиент. cpp
