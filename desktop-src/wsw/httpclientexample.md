---
title: хттпклиентексампле
description: Проверьте пример клиента HTTP, который использует API веб-служб Windows (ВВСАПИ). В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ".
ms.assetid: e32a35f7-df01-4d6d-966c-6cf079b1b3a7
keywords:
- Хттпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "112404137"
---
# <a name="httpclientexample"></a><span data-ttu-id="9b3d3-107">хттпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="9b3d3-107">HttpClientExample</span></span>

<span data-ttu-id="9b3d3-108">В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ".</span><span class="sxs-lookup"><span data-stu-id="9b3d3-108">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="9b3d3-109">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9b3d3-109">HttpClient.cpp</span></span>](#httpclientcpp)
-   [<span data-ttu-id="9b3d3-110">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9b3d3-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9b3d3-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="9b3d3-111">Makefile</span></span>](#makefile)

## <a name="httpclientcpp"></a><span data-ttu-id="9b3d3-112">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9b3d3-112">HttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9b3d3-113">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9b3d3-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9b3d3-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="9b3d3-114">Makefile</span></span>
