...
ms.locfileid: "104410734"
---
# <a name="httpclientexample"></a><span data-ttu-id="9e801-106">хттпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="9e801-106">HttpClientExample</span></span>

<span data-ttu-id="9e801-107">В этом примере показан HTTP-клиент, отправляющий сообщения типа "запрос-ответ".</span><span class="sxs-lookup"><span data-stu-id="9e801-107">This example shows a HTTP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="9e801-108">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9e801-108">HttpClient.cpp</span></span>](#httpclientcpp)
-   [<span data-ttu-id="9e801-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9e801-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9e801-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9e801-110">Makefile</span></span>](#makefile)

## <a name="httpclientcpp"></a><span data-ttu-id="9e801-111">HttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9e801-111">HttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9e801-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="9e801-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9e801-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9e801-113">Makefile</span></span>
