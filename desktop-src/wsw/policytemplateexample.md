...
ms.locfileid: "118963083"
---
# <a name="policytemplateexample"></a>полицитемплатиксампле

В этом примере показано, как вручную создать описание политики и использовать его для создания прокси-сервера службы.
