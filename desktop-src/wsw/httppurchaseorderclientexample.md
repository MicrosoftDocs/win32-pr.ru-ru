...
---
# <a name="httppurchaseorderclientexample"></a>хттппурчасеордерклиентексампле

В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder на основе HTTP.

-   [Хттппурчасеордерклиент. cpp](#httppurchaseorderclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="httppurchaseorderclientcpp"></a>Хттппурчасеордерклиент. cpp
