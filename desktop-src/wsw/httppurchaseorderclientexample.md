---
title: хттппурчасеордерклиентексампле
description: В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder на основе HTTP.
ms.assetid: e577b06c-28b1-4f8f-a6af-025b9672cf27
keywords:
- Хттппурчасеордерклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068164"
---
# <a name="httppurchaseorderclientexample"></a><span data-ttu-id="ba3fd-106">хттппурчасеордерклиентексампле</span><span class="sxs-lookup"><span data-stu-id="ba3fd-106">HttpPurchaseOrderClientExample</span></span>

<span data-ttu-id="ba3fd-107">В этом примере показано, как использовать прокси-сервер службы для взаимодействия со службой PurchaseOrder на основе HTTP.</span><span class="sxs-lookup"><span data-stu-id="ba3fd-107">This example show how to use the service proxy to talk to an HTTP based PurchaseOrder service.</span></span>

-   [<span data-ttu-id="ba3fd-108">Хттппурчасеордерклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="ba3fd-108">HttpPurchaseOrderClient.cpp</span></span>](#httppurchaseorderclientcpp)
-   [<span data-ttu-id="ba3fd-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ba3fd-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ba3fd-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="ba3fd-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientcpp"></a><span data-ttu-id="ba3fd-111">Хттппурчасеордерклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="ba3fd-111">HttpPurchaseOrderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ba3fd-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="ba3fd-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ba3fd-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="ba3fd-113">Makefile</span></span>
