...
---
# <a name="requestreplytcpclientexample"></a>рекуестреплиткпклиентексампле

В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ".

-   [Рекуестреплиткпклиент. cpp](#requestreplytcpclientcpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="requestreplytcpclientcpp"></a>Рекуестреплиткпклиент. cpp
