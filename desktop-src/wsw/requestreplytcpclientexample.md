---
title: рекуестреплиткпклиентексампле
description: В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ".
ms.assetid: 0d9b9581-3563-4fce-8790-af7ebb9e8175
keywords:
- Рекуестреплиткпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103772773"
---
# <a name="requestreplytcpclientexample"></a><span data-ttu-id="7f797-106">рекуестреплиткпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="7f797-106">RequestReplyTcpClientExample</span></span>

<span data-ttu-id="7f797-107">В этом примере показан клиент TCP, отправляющий сообщения типа "запрос-ответ".</span><span class="sxs-lookup"><span data-stu-id="7f797-107">This example shows a TCP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="7f797-108">Рекуестреплиткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7f797-108">RequestReplyTcpClient.cpp</span></span>](#requestreplytcpclientcpp)
-   [<span data-ttu-id="7f797-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f797-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7f797-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f797-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientcpp"></a><span data-ttu-id="7f797-111">Рекуестреплиткпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7f797-111">RequestReplyTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7f797-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7f797-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7f797-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="7f797-113">Makefile</span></span>
