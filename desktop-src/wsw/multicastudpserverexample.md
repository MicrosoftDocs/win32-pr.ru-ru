---
title: мултикастудпсерверексампле
description: В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес.
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- Мултикастудпсерверексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105654218"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="01108-106">мултикастудпсерверексампле</span><span class="sxs-lookup"><span data-stu-id="01108-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="01108-107">В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес.</span><span class="sxs-lookup"><span data-stu-id="01108-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="01108-108">Мултикастудпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="01108-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="01108-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="01108-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="01108-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="01108-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="01108-111">Мултикастудпсервер. cpp</span><span class="sxs-lookup"><span data-stu-id="01108-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="01108-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="01108-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="01108-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="01108-113">Makefile</span></span>
