...
---
# <a name="multicastudpserverexample"></a>мултикастудпсерверексампле

В этом примере показан сервер UDP, который прослушивает адрес многоадресной рассылки и отвечает на запросы, отправляемые на этот адрес.

-   [Мултикастудпсервер. cpp](#multicastudpservercpp)
-   [PurchaseOrder. WSDL](#purchaseorderwsdl)
-   [Makefile](#makefile)

## <a name="multicastudpservercpp"></a>Мултикастудпсервер. cpp
