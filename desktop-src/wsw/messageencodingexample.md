---
title: мессажеенкодинжексампле
description: В этом примере кодируется и декодируется сообщение.
ms.assetid: b1f0a1df-22be-4c86-9a7a-0a4d4f363206
keywords:
- Веб-службы Мессажеенкодинжексампле для Windows
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104068041"
---
# <a name="messageencodingexample"></a><span data-ttu-id="2d7f1-106">мессажеенкодинжексампле</span><span class="sxs-lookup"><span data-stu-id="2d7f1-106">MessageEncodingExample</span></span>

<span data-ttu-id="2d7f1-107">В этом примере кодируется и декодируется сообщение.</span><span class="sxs-lookup"><span data-stu-id="2d7f1-107">This example encodes and decodes a message.</span></span>

-   [<span data-ttu-id="2d7f1-108">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="2d7f1-108">MessageEncoding.cpp</span></span>](#messageencodingcpp)
-   [<span data-ttu-id="2d7f1-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2d7f1-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2d7f1-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d7f1-110">Makefile</span></span>](#makefile)

## <a name="messageencodingcpp"></a><span data-ttu-id="2d7f1-111">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="2d7f1-111">MessageEncoding.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2d7f1-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="2d7f1-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2d7f1-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2d7f1-113">Makefile</span></span>
