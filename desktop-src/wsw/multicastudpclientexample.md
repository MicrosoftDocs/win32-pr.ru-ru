---
title: мултикастудпклиентексампле
description: В этом примере показан клиент UDP, который выполняет многоадресную отправку запроса, а затем ожидает ответа от серверов.
ms.assetid: 61ca7e05-1a60-43b2-9ff7-cb355fae2f77
keywords:
- Мултикастудпклиентексампле Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104252950"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="7874a-106">мултикастудпклиентексампле</span><span class="sxs-lookup"><span data-stu-id="7874a-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="7874a-107">В этом примере показан клиент UDP, который выполняет многоадресную отправку запроса, а затем ожидает ответа от серверов.</span><span class="sxs-lookup"><span data-stu-id="7874a-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="7874a-108">Мултикастудпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7874a-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="7874a-109">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7874a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="7874a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="7874a-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="7874a-111">Мултикастудпклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="7874a-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="7874a-112">PurchaseOrder. WSDL</span><span class="sxs-lookup"><span data-stu-id="7874a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="7874a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="7874a-113">Makefile</span></span>
