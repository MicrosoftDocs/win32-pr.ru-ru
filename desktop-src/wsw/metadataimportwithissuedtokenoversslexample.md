---
title: метадатаимпортвисиссуедтокеноверсслексампле
description: В этом примере показано, как импортировать метаданные из конечной точки, поддерживающей использование выданного маркера, полученного из выдающей службы маркеров безопасности (STS), с помощью Всрекуестсекурититокен и предоставляемых службе с помощью \_ \_ привязки безопасности сообщений токена WS XML с привязкой безопасности \_ \_ \_ \_ транспорта WS SSL \_ \_ \_ . Дополнительные сведения см. в разделе Федерация.
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- API веб-служб Windows Метадатаимпортвисиссуедтокеноверсслексампле
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104410700"
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="d7e43-107">метадатаимпортвисиссуедтокеноверсслексампле</span><span class="sxs-lookup"><span data-stu-id="d7e43-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="d7e43-108">В этом примере показано, как импортировать метаданные из конечной точки, поддерживающей использование выданного маркера, полученного из выдающей службы маркеров безопасности (STS), с помощью [**всрекуестсекурититокен**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) и предоставляемых службе с помощью [**\_ \_ \_ \_ \_ привязки безопасности сообщений токена WS XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) с привязкой безопасности [**\_ транспорта WS SSL \_ \_ \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="d7e43-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="d7e43-109">Дополнительные сведения см. в разделе [Федерация](federation.md) .</span><span class="sxs-lookup"><span data-stu-id="d7e43-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="d7e43-110">Метадатаимпортвисиссуедтокеноверсслексампле. cpp</span><span class="sxs-lookup"><span data-stu-id="d7e43-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d7e43-111">См. также</span><span class="sxs-lookup"><span data-stu-id="d7e43-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d7e43-112">**всрекуестсекурититокен**</span><span class="sxs-lookup"><span data-stu-id="d7e43-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="d7e43-113">**\_ \_ \_ \_ Привязка безопасности сообщений для токена WS XML \_**</span><span class="sxs-lookup"><span data-stu-id="d7e43-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="d7e43-114">**\_ \_ \_ Привязка безопасности транспорта WS \_ SSL**</span><span class="sxs-lookup"><span data-stu-id="d7e43-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="d7e43-115">Федерация</span><span class="sxs-lookup"><span data-stu-id="d7e43-115">Federation</span></span>](federation.md)
</dt> </dl>
