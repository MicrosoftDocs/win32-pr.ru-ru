...
В этом примере показана учетная запись-посредник службы для службы ASMX TerraService, использующая свойство [**\_ \_ \_ \_ \_ настраиваемого канала HTTP-прокси WS Mode**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .
...
## <a name="terraserviceusacomwsdl"></a>террасервицеуса. com. WSDL
