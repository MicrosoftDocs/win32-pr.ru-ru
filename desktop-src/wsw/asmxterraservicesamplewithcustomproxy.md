---
title: асмкстеррасервицесамплевискустомпрокси
description: В этом примере показана учетная запись-посредник службы для службы ASMX TerraService, использующая \_ \_ \_ \_ свойство настраиваемого канала HTTP-прокси WS Mode \_ .
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- Асмкстеррасервицесамплевискустомпрокси Native-Web-Services
- ввсапи
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="383ee-106">асмкстеррасервицесамплевискустомпрокси</span><span class="sxs-lookup"><span data-stu-id="383ee-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="383ee-107">В этом примере показана учетная запись-посредник службы для службы ASMX TerraService, использующая свойство [**\_ \_ \_ \_ \_ настраиваемого канала HTTP-прокси WS Mode**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .</span><span class="sxs-lookup"><span data-stu-id="383ee-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="383ee-108">Асмкскустомпроксиклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="383ee-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="383ee-109">террасервицеуса. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="383ee-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="383ee-110">См. также</span><span class="sxs-lookup"><span data-stu-id="383ee-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="383ee-111">Асмкскустомпроксиклиент. cpp</span><span class="sxs-lookup"><span data-stu-id="383ee-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="383ee-112">террасервицеуса. com. WSDL</span><span class="sxs-lookup"><span data-stu-id="383ee-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="383ee-113">См. также</span><span class="sxs-lookup"><span data-stu-id="383ee-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="383ee-114">**\_ \_ \_ Настройка \_ режима прокси-сервера HTTP WS \_**</span><span class="sxs-lookup"><span data-stu-id="383ee-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
