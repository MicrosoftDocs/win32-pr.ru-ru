...
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v31"></a>Архив: требования сертификации для классических приложений Windows версии 3.1
...
-   Он не должен взаимодействовать с приложениями Магазина Windows через локальные механизмы, включая файлы и ключи реестра.
