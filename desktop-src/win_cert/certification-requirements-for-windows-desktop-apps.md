...
в этом документе содержатся технические требования и права, которым должно соответствовать настольное приложение, чтобы принять участие в программе сертификации для настольных приложений Windows 10.

## <a name="welcome"></a>Добро пожаловать!

платформа Windows поддерживает обширную экосистему продуктов и партнеров. отображение логотипа Windows на вашем продукте представляет собой отношение и общее обязательство по качеству корпорации майкрософт и вашей компании. клиенты доверяют Windows торговой марки на вашем продукте, так как гарантирует, что он соответствует стандартам совместимости и хорошо работает на Windowsной платформе. успешная передача Windows сертификации приложений позволяет отображать приложение в центре совместимости Windows, и на сайте может отображаться логотип сертификации.
...
комплект сертификации Windows приложений используется для проверки соответствия этим требованиям и заменяет предыдущие версии пакета, используемого для проверки на Windows 7, Windows 8 или Windows 8.1. комплект сертификации Windows App kit — это один из компонентов, включенных в пакет SDK для Windows для Windows 10.

## <a name="app-eligibility"></a>Допустимость приложения

чтобы приложение было указано для Windows 10 сертификации настольных приложений, оно должно удовлетворять следующим критериям и всем техническим требованиям, перечисленным в этом документе.

-   Это должно быть автономное приложение
-   он должен выполняться на локальном Windows 10 компьютере
...
-   он не должен обмениваться данными с приложениями Windows Store с помощью локальных механизмов, включая файлы и ключи реестра, за исключением поддерживаемых корпоративных сценариев.
...
обратите внимание, что тесты 2,1 2,6 применимы только для настольных приложений, протестированных на Windows 7, Windows 8 или Windows 8.1.<dl> 2,1. приложение должно использовать надежные и соответствующие [списки ACL](/windows/desktop/SecAuthZ/access-control-lists) для защиты исполняемых файлов  
...
| 18 марта 2014 г.  | 3.3     | Windows 8.1 с обновлением 1                   | [3.3](https://www.bing.com/search?q=3.3) |
| 29 июля 2015 г. | 10      | Windows 10 Обновляют                      | 10                                                                               |
...
<tr class="odd">
<td>придерживайтесь Безопасность Windows рекомендаций</td>
...
<tr class="even">
<td>поддержка функций Безопасность Windows</td>
...
<td>Windows пользователи должны иметь возможность выполнять параллельные сеансы без конфликтов или прерываний. Дополнительные сведения см. в <a href="/windows/desktop/TermServ/terminal-services-programming-guidelines">службы удаленных рабочих столов рекомендации по программированию</a>.</td>
</tr>
<tr class="odd">
