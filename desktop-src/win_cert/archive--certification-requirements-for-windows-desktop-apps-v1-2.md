---
title: архивирование требований к сертификации для приложений Windows Desktop v 1.2
description: документ версии 1.2. дата документа в 31 мая. документ 2012This содержит технические требования и квалификацию, необходимые для участия в программе сертификации для настольных приложений Windows 8.
...
ms.locfileid: "122882665"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v12"></a>архив: требования к сертификации для приложений Windows Desktop v 1.2
...
| тест режима Сейф                                                          | Успех или неудача               |
| поддержка теста x64 Windows                                                | Успех или неудача               |
| проверка изменений функций безопасности Windows (средство Attack Surface Analyzer) | Успех/неудача/предупреждение     |
| проверка изменений функций безопасности Windows (бинскопе Binary Analyzer) | Предупреждение                   |
