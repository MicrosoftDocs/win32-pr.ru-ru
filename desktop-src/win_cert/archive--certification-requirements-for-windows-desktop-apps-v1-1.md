---
title: архивирование требований к сертификации для приложений Windows Desktop v 1.1
description: документ версия 1.1. дата документа с 26 января, 2012This документ содержит технические требования и квалификацию, необходимые для того, чтобы участвовать в программе сертификации для настольных приложений Windows 8.
...
ms.locfileid: "119592384"
---
# <a name="archive-certification-requirements-for-windows-desktop-apps-v11"></a>архив: требования к сертификации для приложений Windows Desktop v 1.1
