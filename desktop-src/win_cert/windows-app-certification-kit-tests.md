...
-   Папки данных приложений для конкретного пользователя
    ...
    -   Все данные приложений, эксклюзивные для определенного пользователя и не предназначенные для совместного использования с другими пользователями компьютера, должны храниться в пользовательском \\ &lt; имени пользователя &gt; \\ APPDATA.
