...
| <span id="JOB_CONTROL_RETAIN"></span><span id="job_control_retain"></span><dl> <dt>**\_сохраняемый элемент управления задания \_**</dt> </dl>                                    | **Windows Vista и более поздних версий**: не задерживайте задание в очереди после печати.<br/> |
| <span id="JOB_CONTROL_RELEASE"></span><span id="job_control_release"></span><dl> <dt>**\_выпуск элемента управления задания \_**</dt> </dl>                                 | **Windows Vista и более поздних версий**: отпустите задание печати.<br/>                     |
