...
---
# <a name="jobprimarybannersheet"></a>жобпримарибаннершит

Этот раздел не является актуальным. Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Описывает лист заголовка для вывода задания. Лист заголовков должен быть выведен на экран по умолчанию Пажемедиасизе и использовать Пажемедиатипе по умолчанию. Лист заголовков должен быть изолирован от оставшейся части задания. Это означает, что любые параметры завершения или обработки (например, Жобдуплексаллдокументсконтигуаусли, Жобстаплеаллдокументс или Жоббиндаллдокументс) не должны включать лист заголовков. Лист заголовков должен быть первым листом задания.
