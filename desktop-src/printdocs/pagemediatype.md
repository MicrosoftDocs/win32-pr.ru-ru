---
description: Получение сведений о настраиваемом пользователем элементе Пажемедиатипе. Этот раздел не является актуальным. Самые актуальные сведения см. в спецификации печати схемы.
...
ms.locfileid: "119098848"
---
# <a name="pagemediatype"></a>пажемедиатипе

Этот раздел не является актуальным. Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Описывает параметры MediaType и характеристики каждого параметра.
...
| \_бакккоатингвалуе\_<br/>    | строка<br/>  | Недоступно<br/>                    | Глянцевая, Хигхглосс, Мэтт, None, глянец, Семиглосс.<br/>                                                                                                                          | Указывает Коатинг для задней стороны носителя.<br/>              |
| \_фронткоатингвалуе\_<br/>   | строка<br/>  | Недоступно<br/>                    | Глянцевая, Хигхглосс, Мэтт, None, глянец, Семиглосс.<br/>                                                                                                                          | Указывает Коатинг переднего плана носителя.<br/>             |
| \_материалвалуе\_<br/>       | строка<br/>  | Недоступно<br/>                    | Алюминиевая, дисплей, Дрифилм, бумага, Полестер, прозрачность, Ветфилм.<br/>                                                                                                       | Указывает материал, из которого создается носитель.<br/>                  |
| \_препринтедвалуе\_<br/>     | строка<br/>  | Недоступно<br/>                    | Нет, предварительная печать, шапка.<br/>                                                                                                                                              | Указывает характеристики предварительно печатаемых файлов мультимедиа.<br/>                       |
| \_препунчедвалуе\_<br/>     | строка<br/>  | Недоступно<br/>                    | Нет, с перфорацией.<br/>                                                                                                                                                          | Указывает характеристики носителя с предперфорацией.<br/>                       |
| \_рецикледвалуе\_<br/>       | строка<br/>  | Недоступно<br/>                    | Нет, Стандартный.<br/>                                                                                                                                                            | Указывает перезапущенные характеристики мультимедиа.<br/>                         |
| \_веигхтвалуе\_<br/>         | Целое число<br/> | датаграмм на квадратный метр<br/> | Больше 0.<br/>                                                                                                                                                            | Задает характеристики веса носителя.<br/>                           |
