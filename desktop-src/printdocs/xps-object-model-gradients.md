...
ms.locfileid: "119823614"
---
# <a name="xps-om-gradients"></a>Градиенты модели XPS

В этом разделе приведен пример использования градиентов в OM-модели XPS.

## <a name="add-a-new-stop-to-an-existing-gradient"></a>Добавление новой позиции к существующему градиенту

Следующий пример кода добавляет новую точку на градиент кисти линейного градиента.
...
[**Интерфейс Икспсомградиентстоп**](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop)
</dt> <dt>

[**Интерфейс Икспсомградиентстопколлектион**](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstopcollection)
</dt> </dl>
