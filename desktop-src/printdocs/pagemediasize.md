...
---
# <a name="pagemediasize"></a><span data-ttu-id="5f433-104">пажемедиасизе</span><span class="sxs-lookup"><span data-stu-id="5f433-104">PageMediaSize</span></span>

<span data-ttu-id="5f433-105">Этот раздел не является актуальным.</span><span class="sxs-lookup"><span data-stu-id="5f433-105">This topic is not current.</span></span> <span data-ttu-id="5f433-106">Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="5f433-106">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="5f433-107">Описывает размеры физических носителей, используемые для выходных данных.</span><span class="sxs-lookup"><span data-stu-id="5f433-107">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="5f433-108">На следующей схеме показано использование переменной Пажемедиасизе (в качестве примера используется параметр ISOA4).</span><span class="sxs-lookup"><span data-stu-id="5f433-108">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![Диаграмма, показывающая размеры страницы](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="5f433-110">Сведения об элементе</span><span class="sxs-lookup"><span data-stu-id="5f433-110">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="5f433-111">Структурное содержимое</span><span class="sxs-lookup"><span data-stu-id="5f433-111">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="5f433-112">Содержимое язык XML (XML)</span><span class="sxs-lookup"><span data-stu-id="5f433-112">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="5f433-113">Сведения об элементе</span><span class="sxs-lookup"><span data-stu-id="5f433-113">Element Information</span></span>



|                            |                    |
|----------------------------|--------------------|
| <span data-ttu-id="5f433-114">Имя</span><span class="sxs-lookup"><span data-stu-id="5f433-114">Name</span></span> | <span data-ttu-id="5f433-115">Значение</span><span class="sxs-lookup"><span data-stu-id="5f433-115">Value</span></span> |
| <span data-ttu-id="5f433-116">Тип элемента</span><span class="sxs-lookup"><span data-stu-id="5f433-116">Element Type</span></span> <br/>   | <span data-ttu-id="5f433-117">Компонент</span><span class="sxs-lookup"><span data-stu-id="5f433-117">Feature</span></span><br/> |
| <span data-ttu-id="5f433-118">Префикс области</span><span class="sxs-lookup"><span data-stu-id="5f433-118">Scoping Prefix</span></span> <br/> | <span data-ttu-id="5f433-119">Страница</span><span class="sxs-lookup"><span data-stu-id="5f433-119">Page</span></span><br/>    |
| <span data-ttu-id="5f433-120">Примечания</span><span class="sxs-lookup"><span data-stu-id="5f433-120">Notes</span></span> <br/>          | <span data-ttu-id="5f433-121">Нет</span><span class="sxs-lookup"><span data-stu-id="5f433-121">None</span></span><br/>    |



 

## <a name="structural-content"></a><span data-ttu-id="5f433-122">Структурное содержимое</span><span class="sxs-lookup"><span data-stu-id="5f433-122">Structural Content</span></span>

<span data-ttu-id="5f433-123">XML-структура этого элемента:</span><span class="sxs-lookup"><span data-stu-id="5f433-123">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="5f433-124">Переменные структуры</span><span class="sxs-lookup"><span data-stu-id="5f433-124">Structure Variables</span></span>

<span data-ttu-id="5f433-125">В следующей таблице описаны характеристики переменных, определенных в структуре XML.</span><span class="sxs-lookup"><span data-stu-id="5f433-125">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="5f433-126">Имя</span><span class="sxs-lookup"><span data-stu-id="5f433-126">Name</span></span>                                | <span data-ttu-id="5f433-127">Тип данных</span><span class="sxs-lookup"><span data-stu-id="5f433-127">Data type</span></span>          | <span data-ttu-id="5f433-128">Unit</span><span class="sxs-lookup"><span data-stu-id="5f433-128">Unit</span></span>                  | <span data-ttu-id="5f433-129">Поддерживаемые значения</span><span class="sxs-lookup"><span data-stu-id="5f433-129">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="5f433-130">Сводка</span><span class="sxs-lookup"><span data-stu-id="5f433-130">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="5f433-131">\_OptionName\_</span><span class="sxs-lookup"><span data-stu-id="5f433-131">\_OptionName\_</span></span><br/>           | <span data-ttu-id="5f433-132">строка</span><span class="sxs-lookup"><span data-stu-id="5f433-132">string</span></span><br/>  | <span data-ttu-id="5f433-133">characters</span><span class="sxs-lookup"><span data-stu-id="5f433-133">characters</span></span><br/> | <span data-ttu-id="5f433-134">Допустимое полное имя, определяемое [пространствами имен в XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="5f433-134">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="5f433-135">Если пространство имен не указано, предполагается использование пространства имен по умолчанию.</span><span class="sxs-lookup"><span data-stu-id="5f433-135">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="5f433-136">Указывает имя носителя.</span><span class="sxs-lookup"><span data-stu-id="5f433-136">Specifies the name of the media.</span></span> <span data-ttu-id="5f433-137">При именовании следует использовать следующее соглашение: " \_ оптионнаместандард \_ " " \_ оптионнамекоммоннаме \_ " " \_ оптионнамедескриптор \_ ".</span><span class="sxs-lookup"><span data-stu-id="5f433-137">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="5f433-138">\_идентитйоптионвалуе\_</span><span class="sxs-lookup"><span data-stu-id="5f433-138">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="5f433-139">строка</span><span class="sxs-lookup"><span data-stu-id="5f433-139">string</span></span><br/>  | <span data-ttu-id="5f433-140">Недоступно</span><span class="sxs-lookup"><span data-stu-id="5f433-140">n/a</span></span><br/>        | <span data-ttu-id="5f433-141">True, False.</span><span class="sxs-lookup"><span data-stu-id="5f433-141">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="5f433-142">Определяет параметр, который при выборе этого параметра отключит эту функцию.</span><span class="sxs-lookup"><span data-stu-id="5f433-142">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="5f433-143">\_оптионнаместандард\_</span><span class="sxs-lookup"><span data-stu-id="5f433-143">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="5f433-144">строка</span><span class="sxs-lookup"><span data-stu-id="5f433-144">string</span></span><br/>  | <span data-ttu-id="5f433-145">characters</span><span class="sxs-lookup"><span data-stu-id="5f433-145">characters</span></span><br/> | <span data-ttu-id="5f433-146">"ISO", "JIS", "Япония", "Норсамерика", "Осерметрик", "PRC", нет.</span><span class="sxs-lookup"><span data-stu-id="5f433-146">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="5f433-147">Указывает, определяется ли размер носителя определенным стандартом.</span><span class="sxs-lookup"><span data-stu-id="5f433-147">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="5f433-148">\_оптионнамекоммоннаме\_</span><span class="sxs-lookup"><span data-stu-id="5f433-148">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="5f433-149">строка</span><span class="sxs-lookup"><span data-stu-id="5f433-149">string</span></span><br/>  | <span data-ttu-id="5f433-150">characters</span><span class="sxs-lookup"><span data-stu-id="5f433-150">characters</span></span><br/> | <span data-ttu-id="5f433-151">Допустимое полное имя, определяемое [пространствами имен в XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="5f433-151">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="5f433-152">Если пространство имен не указано, предполагается использование пространства имен по умолчанию.</span><span class="sxs-lookup"><span data-stu-id="5f433-152">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="5f433-153">Общее имя для размера носителя.</span><span class="sxs-lookup"><span data-stu-id="5f433-153">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="5f433-154">\_оптионнамедескриптор\_</span><span class="sxs-lookup"><span data-stu-id="5f433-154">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="5f433-155">строка</span><span class="sxs-lookup"><span data-stu-id="5f433-155">string</span></span><br/>  | <span data-ttu-id="5f433-156">characters</span><span class="sxs-lookup"><span data-stu-id="5f433-156">characters</span></span><br/> | <span data-ttu-id="5f433-157">Крупный, конверт, дополнительный, плюс, почтовая открытка, поворот, лист, "нет".</span><span class="sxs-lookup"><span data-stu-id="5f433-157">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="5f433-158">Крупный, конверт, дополнительный, плюс, почтовая открытка, поворот, лист, "нет".</span><span class="sxs-lookup"><span data-stu-id="5f433-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="5f433-159">\_медиасизевидс\_</span><span class="sxs-lookup"><span data-stu-id="5f433-159">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="5f433-160">Целое число</span><span class="sxs-lookup"><span data-stu-id="5f433-160">integer</span></span><br/> | <span data-ttu-id="5f433-161">мкм</span><span class="sxs-lookup"><span data-stu-id="5f433-161">microns</span></span><br/>    | <span data-ttu-id="5f433-162">Больше 0, меньше, чем максимальный размер носителя поддержки для устройства.</span><span class="sxs-lookup"><span data-stu-id="5f433-162">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="5f433-163">Задает ширину физического носителя.</span><span class="sxs-lookup"><span data-stu-id="5f433-163">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="5f433-164">\_медиасизехеигхт\_</span><span class="sxs-lookup"><span data-stu-id="5f433-164">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="5f433-165">Целое число</span><span class="sxs-lookup"><span data-stu-id="5f433-165">integer</span></span><br/> | <span data-ttu-id="5f433-166">мкм</span><span class="sxs-lookup"><span data-stu-id="5f433-166">microns</span></span><br/>    | <span data-ttu-id="5f433-167">Больше 0, меньше, чем максимальный размер носителя поддержки для устройства.</span><span class="sxs-lookup"><span data-stu-id="5f433-167">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="5f433-168">Указывает высоту физического носителя.</span><span class="sxs-lookup"><span data-stu-id="5f433-168">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="5f433-169">Содержимое язык XML (XML)</span><span class="sxs-lookup"><span data-stu-id="5f433-169">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="5f433-170">Ключевые слова общедоступной схемы печати определены в `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` пространстве имен.</span><span class="sxs-lookup"><span data-stu-id="5f433-170">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="5f433-171">Содержимое общедоступного язык XML (XML) для этого ключевого слова определено ниже:</span><span class="sxs-lookup"><span data-stu-id="5f433-171">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="5f433-172">Связанные темы</span><span class="sxs-lookup"><span data-stu-id="5f433-172">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="5f433-173">Печать спецификации схемы</span><span class="sxs-lookup"><span data-stu-id="5f433-173">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
