...
ms.locfileid: "119600684"
---
# <a name="printcapabilities-document-example"></a>Пример документа PrintCapabilities

Этот раздел не является актуальным. Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Примечания. пространство имен по умолчанию не применяется к XML-атрибутам. Они должны быть явно уточнены префиксом. Имена экземпляров, используемые в следующем примере, предназначены только для иллюстрации, хотя обычно соответствуют именам экземпляров, определенным в ключевых словах «Печать схемы».
