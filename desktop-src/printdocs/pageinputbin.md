...
| \_енвелопеоптионвалуе\_<br/>     | строка<br/>  | Н/Д<br/>        | True, False.<br/>                                                                                                                                                               | Определяет параметр, который при выборе этого параметра отключит эту функцию.<br/>        |
| \_бинтипевалуе\_<br/>            | строка<br/>  | Н/Д<br/>        | Континуаусфид, Шитфид.<br/>                                                                                                                                                 | Указывает тип ячейки.<br/>                                           |
| \_фидтипевалуе\_<br/>           | строка<br/>  | Н/Д<br/>        | Автоматически, вручную.<br/>                                                                                                                                                         | Указывает механизм подачи для ячейки.<br/>                                 |
| \_медиакапаЦитивалуе\_<br/>      | строка<br/>  | Н/Д<br/>        | Высокий, Стандартный.<br/>                                                                                                                                                            | Указывает, является ли ячейка ячейкой высокой емкости (качественная).<br/>          |
| \_медиасизеаутосенсевалуе\_<br/> | строка<br/>  | Н/Д<br/>        | Поддерживается, нет.<br/>                                                                                                                                                           | Указывает функцию автоматического датчика размера носителя для устройства.<br/>                |
| \_медиатипеаутосенсевалуе\_<br/> | строка<br/>  | Н/Д<br/>        | Поддерживается, нет.<br/>                                                                                                                                                           | Указывает функцию автоматического датчика типа носителя для устройства.<br/>                |
...
| \_медиапасвалуе\_<br/>          | строка<br/>  | Н/Д<br/>        | Прямая, серпентине.<br/>                                                                                                                                                      | Задает характеристики пути к носителю.<br/>                         |
| \_фидфацевалуе\_<br/>           | строка<br/>  | Н/Д<br/>        | Фацеуп, Фацедовн<br/>                                                                                                                                                           | Указывает, следует ли печатать мультимедиа лицевой или лицевой стороны.<br/>           |
| \_фиддиректионвалуе\_<br/>      | строка<br/>  | Н/Д<br/>        | Лонжеджефирст, Шортеджефирст<br/>                                                                                                                                              | Указывает, будет ли мультимедиа сначала выдаваться длинная или короткая сторона.<br/>      |
