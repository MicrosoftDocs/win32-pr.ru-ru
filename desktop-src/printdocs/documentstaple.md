...
ms.locfileid: "118235031"
---
# <a name="documentstaple"></a>документстапле

Этот раздел не является актуальным. Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Описывает характеристики сшивания выходных данных. Каждый документ будет сшиты отдельно. Ключевые слова Жобстаплеаллдокументс и Документстапле являются взаимоисключающими. Драйвер определяет обработку ограничений между этими ключевыми словами.
...
| \_англевалуе\_<br/>          | Целое число<br/> | градусы<br/>         | Больше 0.<br/>                                                                                                                                                            | Задает угол сшивания относительно направления Пажеимажеаблесизе в оси X. Угол сшивания измеряется в направлении против часовой стрелки.<br/> |
| \_шиткапаЦитивалуе\_<br/>  | Целое число<br/> | листы мультимедиа<br/> | Больше 0.<br/>                                                                                                                                                            | Указывает число листов, поддерживаемое параметром сшивания для выбранного в данный момент носителя.<br/>                                                |
