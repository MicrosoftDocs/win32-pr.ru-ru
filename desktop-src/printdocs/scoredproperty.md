...
| Дочерние элементы<br/>  | Можно использовать<br/> *ParameterRef* (один)<br/> или диспетчер конфигурации служб<br/> *Значение* (одно)<br/> *Свойство* (ноль или более)<br/> *Скоредпроперти* (ноль или более)<br/> |
