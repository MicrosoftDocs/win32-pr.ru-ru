...
ms.locfileid: "119098867"
---
# <a name="pagecolormanagement"></a>пажеколорманажемент

Этот раздел не является актуальным. Самые актуальные сведения см. в [спецификации печати схемы](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Настраивает управление цветом для текущей страницы. Это считается автоматическим в оболочке совместимости — DM \_ Икммесод Add System. Описывает, какой компонент должен выполнять управление цветом (т. е. драйвер).
