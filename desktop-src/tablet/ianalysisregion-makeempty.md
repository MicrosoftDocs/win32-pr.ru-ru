---
description: Сокращает Ианалисисрегион для представления пустой области.
ms.assetid: 647a90ee-a5fe-4019-92bb-76b84207d86e
title: 'Метод Ианалисисрегион:: Макимпти (Иаком. h)'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "103810048"
---
# <a name="ianalysisregionmakeempty-method"></a>Метод Ианалисисрегион:: Макимпти

Сокращает [**ианалисисрегион**](ianalysisregion.md) для представления пустой области.
