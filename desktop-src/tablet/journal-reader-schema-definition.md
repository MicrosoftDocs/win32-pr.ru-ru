...
ms.locfileid: "118716370"
---
# <a name="journal-reader-schema-definition"></a>Определение схемы чтения журнала

В этом разделе содержится определение схемы чтения журнала.
