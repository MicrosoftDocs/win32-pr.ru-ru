---
description: В этом разделе содержится определение схемы чтения журнала.
ms.assetid: 2fa6a5d9-64d6-447f-bf2a-d3bf6ca7c093
title: Определение схемы чтения журнала
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105719720"
---
# <a name="journal-reader-schema-definition"></a><span data-ttu-id="6d4bf-103">Определение схемы чтения журнала</span><span class="sxs-lookup"><span data-stu-id="6d4bf-103">Journal Reader Schema Definition</span></span>

<span data-ttu-id="6d4bf-104">В этом разделе содержится определение схемы чтения журнала.</span><span class="sxs-lookup"><span data-stu-id="6d4bf-104">This topic contains the definition of the Journal Reader schema.</span></span>

## <a name="schema"></a><span data-ttu-id="6d4bf-105">схема</span><span class="sxs-lookup"><span data-stu-id="6d4bf-105">Schema</span></span>
