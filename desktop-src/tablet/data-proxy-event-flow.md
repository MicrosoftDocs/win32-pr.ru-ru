...
---
# <a name="data-proxy-event-flow"></a>Поток событий прокси-сервера данных
...
## <a name="data-proxy-event-flow-overview"></a>Общие сведения о потоке событий прокси-сервера данных
