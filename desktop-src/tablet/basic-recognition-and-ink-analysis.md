...
После запуска события **Paint** образец кода выводит прямоугольники вокруг каждого объекта:
