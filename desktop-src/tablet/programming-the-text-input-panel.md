...
ms.locfileid: "118716128"
---
# <a name="programming-the-text-input-panel"></a>Программирование панели ввода текста

начиная с Windows Vista [**текстинпутпанел**](/windows/desktop/api/peninputpanel/nn-peninputpanel-itextinputpanel) заменяет [**пенинпутпанел**](peninputpanel-class.md) для управления внешним видом и поведением панели ввода планшета.
