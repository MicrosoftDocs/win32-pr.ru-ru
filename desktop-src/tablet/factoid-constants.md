...
<td style="text-align: left;">Отключает все остальные фактоидс и словари.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Значение по умолчанию для фактоидс для западных языков включает системный словарь, Пользовательский словарь, различные знаки препинания, а также веб-фактоид и Number. Значение по умолчанию для фактоидс для восточно-азиатских языков включает все символы, поддерживаемые распознавателем. <br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю использовать только системный словарь.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю использовать программный список слов. Список слов определяется свойством <a href="/windows/desktop/api/msinkaut/nf-msinkaut-iinkrecognizercontext-get_wordlist"><strong>"список слов"</strong></a> объекта <a href="inkrecognizercontext-class.md"><strong>инкрекогнизерконтекст</strong></a> . <br/>
<blockquote>
[!Note]<br />
Если строка добавляется в список слов, ее заглавные версии также неявно добавляются. Например, добавление &quot; Hello &quot; неявно добавляет &quot; Hello &quot; и &quot; Hello &quot; .
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать адрес электронной почты.<br/>
<blockquote>
[!Note]<br />
&quot; someone@example.com &quot; Для этого фактоид необходимо использовать полный адрес электронной почты, например. Неизвестный псевдоним, такой как &quot; пользователь &quot; , не распознается.
</blockquote>
<br/>
...
<td style="text-align: left;">Указывает распознавателю искать веб-адрес.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать одиночный символ.<br/>
<blockquote>
[!Note]<br />
Этот фактоид ищет любой изолированный символ ANSI.
</blockquote>
<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать число.<br/>
<blockquote>
[!Note]<br />
К числовым значениям относятся разделители, десятичные числа, порядковые номера и другие часто используемые числовые символы.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать одну цифру от 0 до 9.<br/>
...
<td style="text-align: left;">Предоставляет распознаватель с простым числовым контекстом.<br/>
<blockquote>
[!Note]<br />
Эта фактоид не поддерживается в этой версии пакета SDK для планшетных ПК.
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать символы, обозначающие денежные значения.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать почтовые коды.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать проценты.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать символы, которые обозначают дату.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать символы, которые обозначают время.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать символы, которые обозначают номер телефона.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать символы, которые обозначают имя файла.<br/>
...
<td style="text-align: left;">Указывает распознавателю искать один символ в верхнем регистре: от A до Z.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать один символ в нижнем регистре: от A до Z.<br/>
<blockquote>
[!Note]<br />
Эта фактоид не поддерживается в этой версии пакета SDK для планшетных ПК.
</blockquote>
...
<td style="text-align: left;">Указывает распознавателю искать символы пунктуации.<br/>
<blockquote>
[!Note]<br />
Эта фактоид не поддерживается в этой версии пакета SDK для планшетных ПК.
</blockquote>
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые символы кандзи, катакана и хирагана.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые символы упрощенного китайского письма.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые символы традиционного китайского языка.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые корейские символы.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать только символы хирагана.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать только символы катакана.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые символы кандзи.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать редко используемые символы кандзи.<br/>
<blockquote>
[!Note]<br />
Эта фактоид не поддерживается в этой версии пакета SDK для планшетных ПК.
</blockquote>
...
<td style="text-align: left;">Указывает распознавателю искать бопомофо-символы.<br/></td>
</tr>
<tr class="even">
<td style="text-align: left;"><span id="FACTOID_JAMO"></span><span id="factoid_jamo"></span><dl> <dt><strong>FACTOID_JAMO</strong></dt> </dl></td>
<td style="text-align: left;">Указывает распознавателю искать символы азбуки хангыль-совместимости.<br/></td>
</tr>
<tr class="odd">
...
<td style="text-align: left;">Указывает распознавателю искать часто используемые символы хангыль.<br/></td>
</tr>
<tr class="even">
...
<td style="text-align: left;">Указывает распознавателю искать редко используемые символы хангыль.<br/>
<blockquote>
[!Note]<br />
Эта фактоид не поддерживается в этой версии пакета SDK для планшетных ПК.
</blockquote>
