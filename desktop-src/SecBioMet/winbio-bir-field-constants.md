...
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="WINBIO_BIR_FIELD_SUBHEAD_COUNT"></span><span id="winbio_bir_field_subhead_count"></span><dl> <dt>**Винбио \_ \_ \_ \_ Число подголовков полей Бир**</dt> <dt>0x0001</dt> </dl>                          | предоставлено для соответствия нистир 6529-A, общая биометрическая Exchange formats Framework (кбефф) патрон формат A, но не используется.<br/> |
