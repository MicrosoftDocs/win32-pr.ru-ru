...
ms.locfileid: "117721082"
---
# <a name="cdn_includeitem-notification-code"></a>CDN \_ Код уведомления ИНКЛУДЕИТЕМ
...
структура [**офнотифекс**](/windows/desktop/api/Commdlg/ns-commdlg-ofnotifyexa) содержит структуру [**NMHDR**](/windows/desktop/api/richedit/ns-richedit-nmhdr) , элемент **кода** которой указывает на сообщение уведомления о **CDN \_ инклудеитем** .
