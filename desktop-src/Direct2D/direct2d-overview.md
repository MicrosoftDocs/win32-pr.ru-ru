...
основные причины создания API-интерфейса двухмерной графики в Microsoft Windows включают следующее:

-   чтобы сократить скорость визуального отображения, Windows пользователей.
...
В последние годы конечные пользователи приступили к более высокой визуальной точности в цифровых впечатлениях. Эта тенденция отражена в бытовой электроники. Устройства GPS, устройства воспроизведения мультимедиа, мобильные телефоны и Цифровые камеры обеспечивают единообразный опыт работы в течение года. Эта тенденция также может быть видна в разнообразии графического содержимого на пленке, телевидении, видеоиграх и в Интернете. чтобы сократить эти изменения, разработчики постоянно получают запрос на получение существующих Windows приложений на следующий уровень визуального элемента.

графические процессоры в современных Windows пк также постоянно развивались, благодаря улучшениям в графиках видеоигр и частях Windowsного интерфейса, таких как Windows Media Center и Aero. некоторые Windows приложения могут использовать современные графические процессоры с помощью Microsoft Direct3D и Windows Presentation Foundation (WPF). несмотря на то, что Direct3D обслуживает высокопроизводительные трехмерные графические приложения и WPF решает потребности разработчиков .net, существуют пробелы для разработчиков, имеющих большие объемы кода отрисовки на основе GDI и GDI+ или желающих внедрить высококачественную двухмерной графику в свои приложения на основе Direct3D.
...
Интеграция отрисовки на основе Direct2D упрощается для разработчиков посредством взаимодействия на уровне поверхности с GDI и Direct3D. приложения, которые визуализируют содержимое в основном с GDI, GDI+ или Direct3D, могут начать с использования Direct2D для визуализации конкретных областей своего приложения и со временем перейти к модели, в которой отрисовка выполняется в основном через Direct2D, с использованием GDI в основном для подключаемых модулей или расширения прежних версий.

Direct2D также упрощает использование [DirectWrite](/windows/desktop/DirectWrite/direct-write-portal) для высококачественного текста и расширенных функций работы с образами [компонента Microsoft Windows imaging Component (WIC)](https://msdn.microsoft.com/library/ms737408.aspx).
