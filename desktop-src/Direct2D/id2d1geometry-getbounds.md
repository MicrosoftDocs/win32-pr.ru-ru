---
title: Методы ID2D1Geometry-границ (D2d1 \_ 1. h)
description: Извлекает границы геометрии.
...
ms.locfileid: "105675867"
---
# <a name="id2d1geometrygetbounds-methods"></a><span data-ttu-id="bba99-104">Методы ID2D1Geometry:: DataBound</span><span class="sxs-lookup"><span data-stu-id="bba99-104">ID2D1Geometry::GetBounds methods</span></span>

<span data-ttu-id="bba99-105">Извлекает границы геометрии.</span><span class="sxs-lookup"><span data-stu-id="bba99-105">Retrieves the bounds of the geometry.</span></span>

### <a name="overload-list"></a><span data-ttu-id="bba99-106">Список перегрузок</span><span class="sxs-lookup"><span data-stu-id="bba99-106">Overload list</span></span>



| <span data-ttu-id="bba99-107">Метод</span><span class="sxs-lookup"><span data-stu-id="bba99-107">Method</span></span>                                                                                                                   | <span data-ttu-id="bba99-108">Описание</span><span class="sxs-lookup"><span data-stu-id="bba99-108">Description</span></span>                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| <span data-ttu-id="bba99-109">[**Привязкой (D2D1 \_ Matrix \_ 3X2 \_ f&, D2D \_ -прямоугольник \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="bba99-109">[**GetBounds(D2D1\_MATRIX\_3X2\_F&,D2D\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span></span>   | <span data-ttu-id="bba99-110">Извлекает границы геометрии.</span><span class="sxs-lookup"><span data-stu-id="bba99-110">Retrieves the bounds of the geometry.</span></span><br/> |
| <span data-ttu-id="bba99-111">[**Привязкой (D2D1 \_ Matrix \_ 3X2 \_ f \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="bba99-111">[**GetBounds(D2D1\_MATRIX\_3X2\_F\*,D2D1\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span></span> | <span data-ttu-id="bba99-112">Извлекает границы геометрии.</span><span class="sxs-lookup"><span data-stu-id="bba99-112">Retrieves the bounds of the geometry.</span></span><br/> |



## <a name="examples"></a><span data-ttu-id="bba99-113">Примеры</span><span class="sxs-lookup"><span data-stu-id="bba99-113">Examples</span></span>

<span data-ttu-id="bba99-114">В следующем коде показано, как использовать методы " **DataBound** " для получения границ геометрии.</span><span class="sxs-lookup"><span data-stu-id="bba99-114">The following code shows how to use **GetBounds** to retrieve the bounds of the geometry.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="bba99-115">Требования</span><span class="sxs-lookup"><span data-stu-id="bba99-115">Requirements</span></span>



| <span data-ttu-id="bba99-116">Требование</span><span class="sxs-lookup"><span data-stu-id="bba99-116">Requirement</span></span> | <span data-ttu-id="bba99-117">Значение</span><span class="sxs-lookup"><span data-stu-id="bba99-117">Value</span></span> |
|--------------------|--------------------------------------------------------------------------------------|
| <span data-ttu-id="bba99-118">Header</span><span class="sxs-lookup"><span data-stu-id="bba99-118">Header</span></span><br/>  | <dl> <span data-ttu-id="bba99-119"><dt>D2d1 \_ 1. h</dt></span><span class="sxs-lookup"><span data-stu-id="bba99-119"><dt>D2d1\_1.h</dt></span></span> </dl> |
| <span data-ttu-id="bba99-120">Библиотека</span><span class="sxs-lookup"><span data-stu-id="bba99-120">Library</span></span><br/> | <dl> <span data-ttu-id="bba99-121"><dt>D2d1. lib</dt></span><span class="sxs-lookup"><span data-stu-id="bba99-121"><dt>D2d1.lib</dt></span></span> </dl>  |
| <span data-ttu-id="bba99-122">DLL</span><span class="sxs-lookup"><span data-stu-id="bba99-122">DLL</span></span><br/>     | <dl> <span data-ttu-id="bba99-123"><dt>D2d1.dll</dt></span><span class="sxs-lookup"><span data-stu-id="bba99-123"><dt>D2d1.dll</dt></span></span> </dl>  |



## <a name="see-also"></a><span data-ttu-id="bba99-124">См. также раздел</span><span class="sxs-lookup"><span data-stu-id="bba99-124">See also</span></span>

<dl> <dt>

[<span data-ttu-id="bba99-125">**ID2D1Geometry**</span><span class="sxs-lookup"><span data-stu-id="bba99-125">**ID2D1Geometry**</span></span>](/windows/win32/api/d2d1/nn-d2d1-id2d1geometry)
</dt> </dl>
