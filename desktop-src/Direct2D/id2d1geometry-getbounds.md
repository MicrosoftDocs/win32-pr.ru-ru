...
---
# <a name="id2d1geometrygetbounds-methods"></a>Методы ID2D1Geometry:: DataBound

Извлекает границы геометрии.
...
| Метод                                                                                                                   | Описание                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**Привязкой (D2D1 \_ Matrix \_ 3X2 \_ f&, D2D \_ -прямоугольник \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | Извлекает границы геометрии.<br/> |
| [**Привязкой (D2D1 \_ Matrix \_ 3X2 \_ f \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | Извлекает границы геометрии.<br/> |



## <a name="examples"></a>Примеры

В следующем коде показано, как использовать методы " **DataBound** " для получения границ геометрии.
