...
-   [Взаимодействие DirectWrite](#directwrite-interoperability)
-   [Взаимодействие компонента работы с образами Windows (WIC)](#windows-imaging-component-wic-interoperability)
...
## <a name="directwrite-interoperability"></a>Взаимодействие DirectWrite

Direct2D тесно интегрирован с DirectWrite. Direct2D упрощает визуализацию содержимого DirectWrite, предоставляя методы [**DrawText**](id2d1rendertarget-drawtext.md), [**дравтекстлайаут**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-drawtextlayout)и [**DrawGlyphRun**](/windows/win32/api/d2d1/nf-d2d1-id2d1rendertarget-drawglyphrun) .

## <a name="windows-imaging-component-wic-interoperability"></a>Взаимодействие компонента работы с образами Windows (WIC)
