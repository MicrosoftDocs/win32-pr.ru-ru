...
| Color<br/> \_Цвет D2D1 \_ shadow \_<br/>                                     | Цвет тени. Это свойство является D2D1 \_ вектором \_ 4F, определенным как: (R, G, B, a). Этот цвет необходимо указать в виде прямой альфа-составляющей.<br/> Тип — D2D1 \_ vector \_ 4F.<br/> Значение по умолчанию — {0.0 f, 0,0 f, 0,0 f, 1,0 f}.<br/>                                                                                                                                                                     |
