...
| Color<br/> \_Цвет D2D1 \_ спотдиффусе \_<br/>                             | D2D1 \_ vector \_ 3F<br/> {1.0 f, 1.0 f, 1.0 f}<br/>                                   | Цвет входящего освещения. Это свойство представлено в виде вектора 3 (R, G, B) и используется для вычислений L<sub>R</sub>, l<sub>G</sub>, l<sub>B</sub>. <br/>                                                                                                                                                                                                                                         |
