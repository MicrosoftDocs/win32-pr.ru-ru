...
---
# <a name="id2d1geometrygetwidenedbounds-methods"></a>Методы ID2D1Geometry:: Жетвиденедбаундс
...
| Метод                                                                                                                                                                                                 | Описание                                                                                                                                           |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Жетвиденедбаундс (FLOAT, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3X2 \_ F&, D2D1 \_ Rect \_ F \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | Возвращает границы геометрии после ее расширения с помощью указанной ширины и стиля штриха и преобразуется указанной матрицей.<br/> |
| [**Жетвиденедбаундс (FLOAT, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3X2 \_ F \* , D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | Возвращает границы геометрии после ее расширения с помощью указанной ширины и стиля штриха и преобразуется указанной матрицей.<br/> |
| [**Жетвиденедбаундс (FLOAT, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3X2 \_ F&, float, D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | Возвращает границы геометрии после ее расширения с помощью указанной ширины и стиля штриха и преобразуется указанной матрицей.<br/> |
| [**Жетвиденедбаундс (FLOAT, ID2D1StrokeStyle \* , D2D1 \_ Matrix \_ 3X2 \_ f \* , float, D2D1 \_ Rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | Возвращает границы геометрии после ее расширения с помощью указанной ширины и стиля штриха и преобразуется указанной матрицей.<br/> |



## <a name="examples"></a>Примеры

В следующем коде показано, как использовать **жетвиденедбаундс** для получения границ геометрии после того, как он был расширен с помощью указанной ширины и стиля штриха и преобразуется в указанную матрицу.
