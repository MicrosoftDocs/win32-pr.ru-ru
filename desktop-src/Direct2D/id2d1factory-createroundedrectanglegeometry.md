---
title: Методы Креатераундедректанглежеометри ID2D1Factory (D2d1. h)
description: Создает ID2D1RoundedRectangleGeometry.
ms.assetid: b0f7ccb0-5733-4f96-a532-8f665fbc257e
keywords:
- Методы Креатераундедректанглежеометри Direct2D
topic_type:
- apiref
api_location:
- D2d1.dll
...
Создает [**ID2D1RoundedRectangleGeometry**](/previous-versions/windows/desktop/legacy/dd371292(v=vs.85)).
