...
## <a name="part-1-create-the-demoapp-header"></a>Часть 1. Создание заголовка DemoApp
...
> [!Note]  
> Чтобы использовать Direct2D, убедитесь, что приложение содержит файл заголовка D2D1. h и компилируется в библиотеке D2D1. lib. В [пакете средств разработки программного обеспечения (SDK) для Windows 7](https://msdn.microsoft.com/windows/bb980924.aspx)можно найти D2D1. h и D2D1. lib.
