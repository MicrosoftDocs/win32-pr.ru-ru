...
---
# <a name="sample-time-provider"></a>Пример поставщика времени

В следующем примере показано, как структурировать поставщик времени. В этом примере библиотека DLL поддерживает два поставщика аппаратного времени.
