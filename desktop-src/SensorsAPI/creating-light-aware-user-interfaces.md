...
Компьютеры могут быть более полезными несколькими способами, когда система реагирует на условия освещения. к ним относятся: управление яркостью экрана компьютера (новая, полностью поддерживаемая функция в Windows 7), автоматическая настройка уровня освещения загорающих клавиатур и даже управление яркостью для других источников света (например, кнопка освещения, индикаторы активности и т. д.).
