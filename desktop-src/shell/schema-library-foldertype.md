---
description: '&lt;Элемент фолдертипе &gt; указывает идентификатор GUID для типа папки. Этот элемент необходим &lt; , если элемент темплатеинфо &gt; существует, в противном случае — необязательный. Этот элемент не имеет атрибутов и не содержит дочерних элементов.'
...
&lt;Элемент фолдертипе &gt; указывает идентификатор GUID для типа папки. Этот элемент необходим &lt; , если элемент темплатеинфо &gt; существует, в противном случае — необязательный. Этот элемент не имеет атрибутов и не содержит дочерних элементов.
