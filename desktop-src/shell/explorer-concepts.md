---
description: общие понятия можно расширить, если необходимо расширять Windows Explorer, который является одним из многих вариантов расширяемости в пользовательском интерфейсе оболочки Windows.
