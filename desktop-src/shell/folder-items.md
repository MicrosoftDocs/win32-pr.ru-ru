...
в следующем примере **элементы** используются для определения количества элементов в папке C: \\ Windows. правильное использование отображается для JScript, VBScript и Visual Basic.
