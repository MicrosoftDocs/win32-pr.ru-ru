...
Демонстрирует, как реализовать пользовательский браузер обозревателя управления для вашего приложения.
...
|---------------|------------------------------------------------------------------------------------------------------|
| GitHub  | [Пример Експлорербровсеркустомконтентс](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/winui/shell/appplatform/ExplorerBrowserCustomContents) |
