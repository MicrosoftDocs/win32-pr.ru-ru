...
Составной объект автозаполнения соответствует строкам из нескольких источников. Например, в адресной строке Windows Internet Explorer используется составной объект автозаполнения, так как пользователь может начать вводить имя файла или URL-адрес. Большинство действий, связанных с созданием составного объекта автозаполнения, аналогичны шагам в разделе "Создание простого автозаполнения объекта". Эти действия обозначены как таковые.
