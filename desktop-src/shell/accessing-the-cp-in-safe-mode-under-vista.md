---
description: по умолчанию при запуске Windows в защищенном режиме элементы панели управления Windows Vista не отображаются.
title: доступ к панели управления в режиме Сейф
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119710794"
---
# <a name="accessing-the-control-panel-in-safe-mode"></a>доступ к панели управления в режиме Сейф

по умолчанию при запуске Windows в защищенном режиме элементы панели управления Windows Vista не отображаются. Чтобы разрешить просмотр нового элемента панели управления в защищенном режиме, можно задать значения реестра, соответствующие типу элемента. Значения интерпретируется следующим образом:
...
В этом примере показаны записи, необходимые для элемента, реализованного в виде файла .exe. Он указывает, что элемент должен отображаться в любой форме безопасного режима.
