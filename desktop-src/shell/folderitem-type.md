...
---
# <a name="folderitemtype-property"></a>FolderItem. Type, свойство

Содержит строковое представление типа элемента.
...
Переменная типа [**BSTR**](/previous-versions/windows/desktop/automat/bstr) , которая получает тип элемента.

## <a name="examples"></a>Примеры

В следующем примере для получения типа элемента используется **тип** . Правильное использование показано в JScript, VBScript и Visual Basic.
