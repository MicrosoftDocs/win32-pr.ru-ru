...
в следующем примере используется **path** для получения пути к Windows папке. правильное использование отображается для JScript, VBScript и Visual Basic.
