...
Указывает, является ли элемент папкой.
...
**Логическое** значение, которое получает **значение true** , если элемент является папкой, или **значение false** в противном случае.
