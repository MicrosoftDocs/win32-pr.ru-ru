...
В приведенных ниже примерах используется **бровсефорфолдер** для вывода окна обзора под названием «Example», корнем которого является папка Windows. Сведения об использовании представлены для JScript, VBScript и Visual Basic.
