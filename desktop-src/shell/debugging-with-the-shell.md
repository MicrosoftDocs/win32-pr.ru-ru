...
вы можете запускать и тестировать расширения в отдельном процессе Windows Explorer, чтобы избежать остановки и перезапуска рабочего стола и панели задач. Рабочий стол и панель задач по-прежнему можно использовать при запуске и тестировании расширений.
