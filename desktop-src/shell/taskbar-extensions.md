...
В Windows Vista наведите указатель мыши на кнопку на панели задач приложения, чтобы отобразить эскиз, представляющий окно выполняется. Если панель задач свернута окна приложения, эскиз представляет это, показываемый в виде стека, но только активное окно отображается в самом эскизе.
