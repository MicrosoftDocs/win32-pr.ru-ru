...
В следующем примере используется **целевой объект** для получения цели ярлыка к Internet Explorer. Правильное использование показано в JScript, VBScript и Visual Basic.
