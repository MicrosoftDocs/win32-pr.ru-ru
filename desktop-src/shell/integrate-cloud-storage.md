...
title: интеграция поставщика облачных служба хранилища
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118458204"
---
# <a name="integrate-a-cloud-storage-provider"></a>интеграция поставщика облачных служба хранилища
...
-   *\[ идентификатор безопасности \] Windows*: уникальный идентификатор безопасности Windows, определяющий пользователя. Если приложение поддерживает несколько установок для нескольких пользователей на одном компьютере, этот элемент является обязательным.
...
Область навигации окна проводника — это часть окна, отображаемая в левой части экрана. На изображении ниже можно увидеть структуру пространства имен для этого пользователя. корневой уровень в области навигации включает объекты для **OneDrive**, **этот компьютер** и **сеть**. После выполнения этих действий расширение будет добавлено на тот же уровень.
...
**reg add HKCU \\ Software \\ Microsoft \\ Windows \\ CurrentVersion \\ проводник \\ Desktop \\ пространство имен \\ {0672A6D1-A6E0-40FE-AB16-F25BADC6D9E3}/ве/t REG \_ SZ/d миклаудсторажеапп/f**
