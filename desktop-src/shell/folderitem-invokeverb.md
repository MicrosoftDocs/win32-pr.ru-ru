...
В следующем примере используется **инвокеверб** для вызова глагола по умолчанию (в данном случае "Open") в папке Windows. Правильное использование показано в JScript, VBScript и Visual Basic.
