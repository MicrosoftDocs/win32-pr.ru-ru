...
Файлы описания библиотеки — это XML-файлы, определяющие библиотеки. Библиотеки объединяют элементы из локальных и удаленных мест хранения в единое представление в проводнике Windows. Файлы описания библиотеки соответствуют схеме описания библиотеки и сохраняются в \* файлах. Library-MS.
...
|                             |                                                                                                                                                            |
|-----------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Общие сведения о библиотеке | Сведения о библиотеке, такие как имя, владелец, версия, значок, который может использоваться проводником Windows при отображении библиотеки для пользователя.                   |
...
Файлы библиотек в Windows 7 хранятся в известной папке FOLDERID \_ Library. По умолчанию папка FOLDERID \_ Libraries находится в каталоге% UserProfile% \\ AppData \\ роуминга \\ \\ библиотеки Microsoft Windows \\ .

## <a name="namespace-versioning"></a>Управление версиями пространства имен

Версии формата файла описания библиотеки ( \* . Library-MS) отправляются путем изменения пространства имен. В Windows 7 формат файла имеет следующее пространство имен по умолчанию: https://schemas.microsoft.com/windows/2009/library .
