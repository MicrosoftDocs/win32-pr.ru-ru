...
Знак "минус" (-101) в ресурсе. dll в записи DisplayName существует по причинам, существующим в предыдущих версиях. В записи значка, с другой стороны, не требуется знак "минус".
...
> [!Note]  
> В Windows 7, если приложение установлено для всех пользователей компьютера, используйте HKEY \_ локальный \_ компьютер; если только для одного пользователя используйте hKey \_ текущий \_ пользователь.
