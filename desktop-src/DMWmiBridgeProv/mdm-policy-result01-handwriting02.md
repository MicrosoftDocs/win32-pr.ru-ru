...
ms.locfileid: "120104104"
---
# <a name="mdm_policy_result01_handwriting02-class"></a>\_Класс политики MDM \_ Result01 \_ Handwriting02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

\_Класс политики MDM \_ Result01 \_ Handwriting02 представляет режим по умолчанию для панели рукописного ввода.
...
Класс **\_ политики MDM \_ Result01 \_ Handwriting02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **\_ политики MDM \_ Result01 \_ Handwriting02** имеет следующие свойства.
