...
ms.locfileid: "118165405"
---
# <a name="mdm_policy_config01_bitlocker02-class"></a>\_Класс политики MDM \_ Config01 \_ BitLocker02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

Класс **\_ политики MDM \_ Config01 \_ Bitlocker02** представляет доступные политики BitLocker.
...
Класс **\_ политики MDM \_ Config01 \_ BitLocker02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **\_ политики MDM \_ Config01 \_ BitLocker02** имеет следующие свойства.
