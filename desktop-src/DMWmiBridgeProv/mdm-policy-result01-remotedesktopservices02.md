...
---
# <a name="mdm_policy_result01_remotedesktopservices02-class"></a>\_Класс политики MDM \_ Result01 \_ RemoteDesktopServices02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Майкрософт не дает никаких гарантий, явных или подразумеваемых, в отношении предоставленной здесь информации.\]

\_Класс политики MDM \_ Result01 \_ RemoteDesktopServices02 представляет политики служб удаленных рабочих столов.
...
Класс **\_ политики MDM \_ Result01 \_ RemoteDesktopServices02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **\_ политики MDM \_ Result01 \_ RemoteDesktopServices02** имеет следующие свойства.
