...
---
# <a name="mdm_policy_result01_windowsinkworkspace02-class"></a>\_Класс политики MDM \_ Result01 \_ WindowsInkWorkspace02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Майкрософт не дает никаких гарантий, явных или подразумеваемых, в отношении предоставленной здесь информации.\]

Класс [**\_ политики MDM \_ Result01 \_ WindowsInkWorkspace02**](mdm-policy-config01-windowsinkworkspace02.md) представляет доступные политики рукописного ввода.
...
Класс **\_ политики MDM \_ Result01 \_ WindowsInkWorkspace02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **\_ политики MDM \_ Result01 \_ WindowsInkWorkspace02** имеет следующие свойства.
