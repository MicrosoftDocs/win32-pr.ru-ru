...
ms.locfileid: "119694634"
---
# <a name="mdm_policy_result01_system02-class"></a>\_Класс политики MDM \_ Result01 \_ System02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

Класс **\_ политики MDM \_ Result01 \_ System02** представляет доступные системные политики. Эти политики определяют разрешенные конфигурации системы.
...
Класс **\_ политики MDM \_ Result01 \_ System02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **\_ политики MDM \_ Result01 \_ System02** имеет следующие свойства.
