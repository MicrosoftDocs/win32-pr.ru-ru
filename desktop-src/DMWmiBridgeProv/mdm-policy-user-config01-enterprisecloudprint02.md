...
ms.locfileid: "119815744"
---
# <a name="mdm_policy_user_config01_enterprisecloudprint02-class"></a>\_Класс политики MDM \_ user \_ Config01 \_ EnterpriseCloudPrint02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

\_Класс политики MDM \_ user \_ Config01 \_ EnterpriseCloudPrint02 представляет доступные политики печати в облаке.
...
Класс **\_ \_ user \_ Config01 \_ EnterpriseCloudPrint02 политики MDM** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **\_ \_ user \_ Config01 \_ EnterpriseCloudPrint02 политики MDM** имеет эти свойства.
