...
ms.locfileid: "120084934"
---
# <a name="mdm_passportforwork_biometrics01-class"></a>\_Класс MDM пасспортфорворк \_ Biometrics01

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

Класс **MDM \_ пасспортфорворк \_ Biometrics01** определяет параметры биометрических параметров.
...
Класс **MDM \_ пасспортфорворк \_ Biometrics01** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **MDM \_ пасспортфорворк \_ Biometrics01** имеет следующие свойства.

<dl> <dt>

[фаЦиалфеатуресусинханцедантиспуфинг](/windows/client-management/mdm/passportforwork-csp)
</dt> <dd> <dl> <dt>
