...
ms.locfileid: "119588074"
---
# <a name="mdm_policy_config01_storage02-class"></a>\_Класс политики MDM \_ Config01 \_ Storage02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Корпорация Майкрософт не предоставляет никаких гарантий, явных или подразумеваемых, относительно предоставленной здесь информации.\]

\_Класс политики MDM \_ Config01 \_ Storage02 настраивает политики хранения.
...
Класс **\_ политики MDM \_ Config01 \_ Storage02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **\_ политики MDM \_ Config01 \_ Storage02** имеет следующие свойства.

<dl> <dt>

[алловдискхеалсмоделупдатес](/windows/client-management/mdm/policy-csp-storage#storage-allowdiskhealthmodelupdates)
</dt> <dd> <dl> <dt>
...
[енханцедсторажедевицес](/windows/client-management/mdm/policy-csp-storage#storage-enhancedstoragedevices)
</dt> <dd> <dl> <dt>
