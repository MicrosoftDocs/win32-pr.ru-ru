...
---
# <a name="mdm_policy_user_config01_education02-class"></a>\_Класс политики MDM \_ user \_ Config01 \_ Education02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Майкрософт не дает никаких гарантий, явных или подразумеваемых, в отношении предоставленной здесь информации.\]

\_Класс политики MDM \_ user \_ Config01 \_ Education02 настраивает политики образования.
...
Класс **\_ \_ user \_ Config01 \_ Education02 политики MDM** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **\_ \_ user \_ Config01 \_ Education02 политики MDM** имеет эти свойства.
