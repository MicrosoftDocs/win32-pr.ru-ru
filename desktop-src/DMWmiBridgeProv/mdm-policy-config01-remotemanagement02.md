...
---
# <a name="mdm_policy_config01_remotemanagement02-class"></a>\_Класс политики MDM \_ Config01 \_ RemoteManagement02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Майкрософт не дает никаких гарантий, явных или подразумеваемых, в отношении предоставленной здесь информации.\]

Политики \_ \_ \_ удаленного управления MDM Config01 RemoteManagement02.
...
Класс **\_ политики MDM \_ Config01 \_ RemoteManagement02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **\_ политики MDM \_ Config01 \_ RemoteManagement02** имеет следующие свойства.
