...
---
# <a name="mdm_policy_config01_update02-class"></a>\_Класс политики MDM \_ Config01 \_ Update02

\[Некоторые сведения относятся к предварительно выпущенному продукту, который может быть значительно изменен перед коммерческой выпуском. Майкрософт не дает никаких гарантий, явных или подразумеваемых, в отношении предоставленной здесь информации.\]

Класс **\_ политики MDM \_ Config01 \_ Update02** представляет доступные политики обновления.
...
Класс **\_ политики MDM \_ Config01 \_ Update02** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **\_ политики MDM \_ Config01 \_ Update02** имеет следующие свойства.
...
[алловаутаупдате](/windows/client-management/mdm/policy-csp-update#update-allowautoupdate)
</dt> <dd> <dl> <dt>
...
[деферфеатуреупдатеспериодиндайс](/windows/client-management/mdm/policy-csp-update#update-deferfeatureupdatesperiodindays)
</dt> <dd> <dl> <dt>
...
[деферкуалитюпдатеспериодиндайс](/windows/client-management/mdm/policy-csp-update#update-deferqualityupdatesperiodindays)
</dt> <dd> <dl> <dt>
...
[ексклудевудриверсинкуалитюпдате](/windows/client-management/mdm/policy-csp-update#update-excludewudriversinqualityupdate)
</dt> <dd> <dl> <dt>
...
[игноремоаппдовнлоадлимит](/windows/client-management/mdm/policy-csp-update#update-ignoremoappdownloadlimit)
</dt> <dd> <dl> <dt>
...
[игноремаупдатедовнлоадлимит](/windows/client-management/mdm/policy-csp-update#update-ignoremoupdatedownloadlimit)
</dt> <dd> <dl> <dt>
...
[упдатесервицеурл](/windows/client-management/mdm/policy-csp-update#update-updateserviceurl)
</dt> <dd> <dl> <dt>
