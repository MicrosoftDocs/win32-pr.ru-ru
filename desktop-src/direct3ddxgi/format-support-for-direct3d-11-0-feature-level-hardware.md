---
description: В этом разделе указываются форматы ([**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) значения), которые поддерживаются в оборудовании уровня функции Direct3D 11,0.
...
В этом разделе указываются форматы ([**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) значения), которые поддерживаются в оборудовании уровня функции Direct3D 11,0.
