...
## <a name="dxgi_format_r32g8x24_typeless-19"></a>\_Нетипизированный DXGI_FORMAT_R32G8X24 (19)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 64 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
...
## <a name="dxgi_format_r32_float_x8x24_typeless-21"></a>DXGI_FORMAT_R32 \_ с \_ типом float X8X24 \_ (21)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 64 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
...
## <a name="dxgi_format_x32_typeless_g8x24_uint-22"></a>DXGI_FORMAT_X32 без \_ типа \_ G8X24 \_ uint (22)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 64 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24g8_typeless-44"></a>\_Нетипизированный DXGI_FORMAT_R24G8 (44)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 32 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
...
## <a name="dxgi_format_r24_unorm_x8_typeless-46"></a>\_Тип DXGI_FORMAT_R24 UNORM \_ X8 \_ (46)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 32 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
...
## <a name="dxgi_format_x24_typeless_g8_uint-47"></a>DXGI_FORMAT_X24 без \_ типа \_ G8 \_ uint (47)
| Целевой объект | Поддержка |
| - | - |
| Бит на элемент (BPE) | 32 |
| Поддержка формата | ![обязательно](images/letter-r.jpg) |
