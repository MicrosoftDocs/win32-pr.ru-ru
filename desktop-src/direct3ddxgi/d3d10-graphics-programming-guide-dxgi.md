...
<li><p>В DXGI доступны эффекты переключения DXGI_SWAP_EFFECT_DISCARD и DXGI_SWAP_EFFECT_SEQUENTIAL. начиная с Windows 8 также доступен DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL. В следующей таблице показано сопоставление Direct3D 9 и эффектов переключения DXGI. </p>
<table>
<thead>
<tr class="header">
