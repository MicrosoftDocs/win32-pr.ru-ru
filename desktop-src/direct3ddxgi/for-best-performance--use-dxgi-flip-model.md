...
В этом разделе содержатся рекомендации для разработчиков по повышению производительности и эффективности в стеке презентации на современных версиях Windows. Он выбирает, где [перелистывание DXGI](dxgi-flip-model.md), [DirectX 12: режимы представления в Windows 10 (видео)](https://www.youtube.com/watch?v=E3wTajGZOsA)и [улучшения презентации в Windows 10: ранний взгляд (видео)](https://www.youtube.com/watch?v=nUZVV_mssWQ) остался слева.
...
Такая оптимизация возможна благодаря DWM (диспетчер окон рабочего стола), который является компоновщиком, который управляет рабочим столом Windows.
...
-   Уменьшение задержки с помощью **\_ \_ \_ \_ \_ \_ ожидающего \_ объекта блокировки цепочки ожидания в кадре**. При переходе в независимый режим перелистывания можно получить до 1 кадра задержки в последних версиях Windows с возможностью корректного перехода на минимально возможный объем при составлении.
    -   Предостережение. возникла ошибка, которая подавала как минимум два кадра задержки в юбилейном обновлении Windows 10 и более ранних версиях. Дополнительные сведения см. в [этом разделе форума](https://www.gamedev.net/forums/topic/686507-windows-10-dx12-low-latency-tearing-free-rendering/) . Это исправлено в обновлении создателя отправителя.
