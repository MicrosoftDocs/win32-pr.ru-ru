...
Задает максимальный размер каждого документа описания в байтах. Этот параметр нельзя настроить в версиях Windows, предшествующих Windows XP с пакетом обновления 2 (SP2). В предыдущих версиях этот параметр жестко закодирован как 102400.
...
Указывает допустимый максимальный размер (в байтах) ответа SOAP. Этот параметр нельзя настроить в версиях Windows, предшествующих Windows XP с пакетом обновления 2 (SP2). В предыдущих версиях этот параметр жестко закодирован как 102400.
