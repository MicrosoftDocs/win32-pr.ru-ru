...
> [!Note]  
> Этот пример кода работает только для браузеров, работающих под управлением Windows; Он не работает в браузерах, работающих под управлением других операционных систем.
