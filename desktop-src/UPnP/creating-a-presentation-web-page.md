...
ms.locfileid: "119655972"
---
# <a name="creating-a-presentation-web-page"></a>Создание веб-страницы презентации

В примере кода в этом разделе используется API контрольной точки с технологией UPnP для создания простой веб-страницы для управления вымышленными устройствами проигрывателя на основе UPnP. Веб-страница показана на следующем рисунке.

> [!Note]  
> Этот пример кода работает только для браузеров, работающих под Windows; Он не работает в браузерах, работающих под управлением других операционных систем.
