---
description: Ниже приведен полный исходный код для вспомогательного приложения IP. В исходный код добавлена дополнительная проверка ошибок.
ms.assetid: c0290660-8a18-4d5c-8f0a-df15da1a9167
title: Полный исходный код приложения модуля поддержки IP-адресов
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105651198"
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="3fdbc-104">Полный исходный код приложения модуля поддержки IP-адресов</span><span class="sxs-lookup"><span data-stu-id="3fdbc-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="3fdbc-105">Ниже приведен полный исходный код для вспомогательного приложения IP.</span><span class="sxs-lookup"><span data-stu-id="3fdbc-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="3fdbc-106">В исходный код добавлена дополнительная проверка ошибок.</span><span class="sxs-lookup"><span data-stu-id="3fdbc-106">Additional error checking has been added to source code.</span></span>
