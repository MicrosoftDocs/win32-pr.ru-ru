...
---
# <a name="complete-ip-helper-application-source-code"></a>Полный исходный код приложения модуля поддержки IP-адресов

Ниже приведен полный исходный код для вспомогательного приложения IP. В исходный код добавлена дополнительная проверка ошибок.
