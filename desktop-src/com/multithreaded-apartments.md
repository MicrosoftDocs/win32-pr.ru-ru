...
Потоки, инициализированные с моделью в свободной потоковой модели, должны реализовывать собственную синхронизацию. как упоминалось ранее в этом разделе, Windows позволяет реализовать эту реализацию с помощью следующих примитивов синхронизации:
