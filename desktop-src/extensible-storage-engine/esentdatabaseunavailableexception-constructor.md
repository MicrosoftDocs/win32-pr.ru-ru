---
description: 'Дополнительные сведения о: конструктор Есентдатабасеунаваилабликсцептион'
title: Конструктор Есентдатабасеунаваилабликсцептион
...
ms.locfileid: "104544626"
---
# <a name="esentdatabaseunavailableexception-constructor"></a>Конструктор Есентдатабасеунаваилабликсцептион

Инициализирует новый экземпляр класса Есентдатабасеунаваилабликсцептион.
...
[Элементы Есентдатабасеунаваилабликсцептион](./esentdatabaseunavailableexception-members.md)
