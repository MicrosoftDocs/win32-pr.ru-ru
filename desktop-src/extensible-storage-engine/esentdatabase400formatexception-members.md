...
ms.locfileid: "117714173"
---
# <a name="esentdatabase400formatexception-members"></a>Элементы EsentDatabase400FormatException

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Database400Format.

Тип [EsentDatabase400FormatException](./esentdatabase400formatexception-class.md) предоставляет следующие члены.
...
<td>Инициализирует новый экземпляр класса EsentDatabase400FormatException.</td>
</tr>
</tbody>
</table>
...
[Класс EsentDatabase400FormatException](./esentdatabase400formatexception-class.md)
