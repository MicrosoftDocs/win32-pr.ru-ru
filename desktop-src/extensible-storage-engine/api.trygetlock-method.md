...
---
# <a name="apitrygetlock-method"></a>API. Трижетлокк, метод
...
Значение true, если блокировка получена; в противном случае — значение false. Если обнаружена непредвиденная ошибка, возникает исключение.  
