...
ms.locfileid: "119732944"
---
# <a name="esentreadlostflushverifyfailureexception-members"></a>Элементы Есентреадлостфлушверифифаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Реадлостфлушверифифаилуре.

Тип [есентреадлостфлушверифифаилуриксцептион](./esentreadlostflushverifyfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319821(v=exchg.10).md">есентреадлостфлушверифифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентреадлостфлушверифифаилуриксцептион.</td>
</tr>
</tbody>
</table>
