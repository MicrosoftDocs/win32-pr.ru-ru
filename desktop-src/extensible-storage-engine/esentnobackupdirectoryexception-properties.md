---
description: 'Дополнительные сведения о: Есентнобаккупдиректорексцептион свойства'
title: Свойства Есентнобаккупдиректорексцептион
...
ms.locfileid: "104155718"
---
# <a name="esentnobackupdirectoryexception-properties"></a>Свойства Есентнобаккупдиректорексцептион
