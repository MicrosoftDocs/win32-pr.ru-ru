---
description: 'Дополнительные сведения: методы Есентканнотиндексексцептион'
title: 'Методы EsentCannotIndexException '
...
ms.locfileid: "118783246"
---
# <a name="esentcannotindexexception-methods"></a>Методы EsentCannotIndexException 
