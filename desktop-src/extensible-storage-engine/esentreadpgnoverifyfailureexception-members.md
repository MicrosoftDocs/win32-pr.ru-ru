...
ms.locfileid: "119274152"
---
# <a name="esentreadpgnoverifyfailureexception-members"></a>Элементы Есентреадпгноверифифаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Реадпгноверифифаилуре.

Тип [есентреадпгноверифифаилуриксцептион](./esentreadpgnoverifyfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319834(v=exchg.10).md">есентреадпгноверифифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентреадпгноверифифаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентреадпгноверифифаилуриксцептион](./esentreadpgnoverifyfailureexception-class.md)
