---
description: 'Дополнительные сведения о: Есенттуманиоексцептион Members'
title: Элементы Есенттуманиоексцептион
...
ms.locfileid: "104272876"
---
# <a name="esenttoomanyioexception-members"></a>Элементы Есенттуманиоексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманио.

Тип [есенттуманиоексцептион](./esenttoomanyioexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335004(v=exchg.10).md">есенттуманиоексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманиоексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманиоексцептион](./esenttoomanyioexception-class.md)
