---
description: 'Дополнительные сведения: методы Есентреадлостфлушверифифаилуриксцептион'
title: 'Методы EsentReadLostFlushVerifyFailureException '
...
ms.locfileid: "104080517"
---
# <a name="esentreadlostflushverifyfailureexception-methods"></a>Методы EsentReadLostFlushVerifyFailureException 
