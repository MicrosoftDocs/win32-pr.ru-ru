...
---
# <a name="esentdbtimetoooldexception-members"></a>Элементы Есентдбтиметуолдексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дбтиметуолд.

Тип [есентдбтиметуолдексцептион](./esentdbtimetoooldexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274246(v=exchg.10).md">есентдбтиметуолдексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдбтиметуолдексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдбтиметуолдексцептион](./esentdbtimetoooldexception-class.md)
