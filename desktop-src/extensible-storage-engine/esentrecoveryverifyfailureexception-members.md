...
---
# <a name="esentrecoveryverifyfailureexception-members"></a>Элементы Есентрековериверифифаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рековериверифифаилуре.

Тип [есентрековериверифифаилуриксцептион](./esentrecoveryverifyfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350509(v=exchg.10).md">есентрековериверифифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрековериверифифаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрековериверифифаилуриксцептион](./esentrecoveryverifyfailureexception-class.md)
