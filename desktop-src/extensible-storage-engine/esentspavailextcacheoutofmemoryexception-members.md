...
ms.locfileid: "118078780"
---
# <a name="esentspavailextcacheoutofmemoryexception-members"></a>Элементы Есентспаваилексткачеаутофмеморексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Спаваилексткачеаутофмемори.

Тип [есентспаваилексткачеаутофмеморексцептион](./esentspavailextcacheoutofmemoryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334806(v=exchg.10).md">есентспаваилексткачеаутофмеморексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентспаваилексткачеаутофмеморексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентспаваилексткачеаутофмеморексцептион](./esentspavailextcacheoutofmemoryexception-class.md)
