...
---
# <a name="esentinvalidlogdirectoryexception-members"></a>Элементы Есентинвалидлогдиректорексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидлогдиректори.

Тип [есентинвалидлогдиректорексцептион](./esentinvalidlogdirectoryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319550(v=exchg.10).md">есентинвалидлогдиректорексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидлогдиректорексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидлогдиректорексцептион](./esentinvalidlogdirectoryexception-class.md)
