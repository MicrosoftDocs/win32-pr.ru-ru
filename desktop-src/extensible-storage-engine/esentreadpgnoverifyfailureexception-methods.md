---
description: 'Дополнительные сведения: методы Есентреадпгноверифифаилуриксцептион'
title: 'Методы EsentReadPgnoVerifyFailureException '
...
ms.locfileid: "104570382"
---
# <a name="esentreadpgnoverifyfailureexception-methods"></a>Методы EsentReadPgnoVerifyFailureException 
