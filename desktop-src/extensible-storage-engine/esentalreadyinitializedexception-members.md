...
ms.locfileid: "119042322"
---
# <a name="esentalreadyinitializedexception-members"></a>Элементы Есенталреадинитиализедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Алреадинитиализед.

Тип [есенталреадинитиализедексцептион](./esentalreadyinitializedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273991(v=exchg.10).md">есенталреадинитиализедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенталреадинитиализедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенталреадинитиализедексцептион](./esentalreadyinitializedexception-class.md)
