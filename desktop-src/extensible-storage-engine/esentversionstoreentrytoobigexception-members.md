...
ms.locfileid: "119112803"
---
# <a name="esentversionstoreentrytoobigexception-members"></a>Элементы Есентверсионсторинтритубижексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Версионсторинтритубиг.

Тип [есентверсионсторинтритубижексцептион](./esentversionstoreentrytoobigexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350866(v=exchg.10).md">есентверсионсторинтритубижексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентверсионсторинтритубижексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентверсионсторинтритубижексцептион](./esentversionstoreentrytoobigexception-class.md)
