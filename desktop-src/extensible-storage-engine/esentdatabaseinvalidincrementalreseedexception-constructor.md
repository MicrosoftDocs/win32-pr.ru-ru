---
description: 'Дополнительные сведения о: конструктор Есентдатабасеинвалидинкременталресидексцептион'
title: Конструктор Есентдатабасеинвалидинкременталресидексцептион
...
ms.locfileid: "119041502"
---
# <a name="esentdatabaseinvalidincrementalreseedexception-constructor"></a>Конструктор Есентдатабасеинвалидинкременталресидексцептион

Инициализирует новый экземпляр класса Есентдатабасеинвалидинкременталресидексцептион.
...
[Элементы Есентдатабасеинвалидинкременталресидексцептион](./esentdatabaseinvalidincrementalreseedexception-members.md)
