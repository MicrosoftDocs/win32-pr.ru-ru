...
ms.locfileid: "119038532"
---
# <a name="windows8apijetcreatetablecolumnindex4-method"></a>Windows8Api. JetCreateTableColumnIndex4, метод

Создает таблицу, добавляет столбцы и индексы для этой таблицы. [JetCreateTableColumnIndex3 (JET_SESID, JET_DBID, JET_TABLECREATE)](./api.jetcreatetablecolumnindex3-method.md)
