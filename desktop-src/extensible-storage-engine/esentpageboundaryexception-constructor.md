---
description: 'Дополнительные сведения о: конструктор Есентпажебаундарексцептион'
title: Конструктор Есентпажебаундарексцептион
...
ms.locfileid: "105647713"
---
# <a name="esentpageboundaryexception-constructor"></a>Конструктор Есентпажебаундарексцептион

Инициализирует новый экземпляр класса Есентпажебаундарексцептион.
...
[Элементы Есентпажебаундарексцептион](./esentpageboundaryexception-members.md)
