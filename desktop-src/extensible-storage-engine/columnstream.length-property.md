---
description: Дополнительные сведения о свойстве Колумнстреам. length
title: Колумнстреам. length, свойство
...
ms.locfileid: "118982654"
---
# <a name="columnstreamlength-property"></a>Колумнстреам. length, свойство

Возвращает текущую длину потока.
