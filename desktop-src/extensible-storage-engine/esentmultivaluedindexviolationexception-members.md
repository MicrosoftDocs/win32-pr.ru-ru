---
description: 'Дополнительные сведения о: Есентмултивалуединдексвиолатионексцептион Members'
title: Элементы Есентмултивалуединдексвиолатионексцептион
...
ms.locfileid: "118775784"
---
# <a name="esentmultivaluedindexviolationexception-members"></a>Элементы Есентмултивалуединдексвиолатионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Мултивалуединдексвиолатион.

Тип [есентмултивалуединдексвиолатионексцептион](./esentmultivaluedindexviolationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334708(v=exchg.10).md">есентмултивалуединдексвиолатионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмултивалуединдексвиолатионексцептион.</td>
</tr>
</tbody>
</table>
