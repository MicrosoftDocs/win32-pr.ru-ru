---
description: 'Дополнительные сведения: методы Есентдатабаселогсетмисматчексцептион'
title: 'Методы EsentDatabaseLogSetMismatchException '
...
ms.locfileid: "104263774"
---
# <a name="esentdatabaselogsetmismatchexception-methods"></a>Методы EsentDatabaseLogSetMismatchException 
