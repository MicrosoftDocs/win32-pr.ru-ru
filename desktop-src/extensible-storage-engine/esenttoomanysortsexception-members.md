...
---
# <a name="esenttoomanysortsexception-members"></a>Элементы Есенттуманисортсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманисортс.

Тип [есенттуманисортсексцептион](./esenttoomanysortsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350792(v=exchg.10).md">есенттуманисортсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманисортсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманисортсексцептион](./esenttoomanysortsexception-class.md)
