---
description: 'Дополнительные сведения: методы Есентлвкорруптедексцептион'
title: 'Методы EsentLVCorruptedException '
...
ms.locfileid: "119605024"
---
# <a name="esentlvcorruptedexception-methods"></a>Методы EsentLVCorruptedException 
