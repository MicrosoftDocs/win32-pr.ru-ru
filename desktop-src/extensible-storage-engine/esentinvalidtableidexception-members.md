---
description: 'Дополнительные сведения о: Есентинвалидтаблеидексцептион Members'
title: Элементы Есентинвалидтаблеидексцептион
...
ms.locfileid: "104557579"
---
# <a name="esentinvalidtableidexception-members"></a>Элементы Есентинвалидтаблеидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидтаблеид.

Тип [есентинвалидтаблеидексцептион](./esentinvalidtableidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334529(v=exchg.10).md">есентинвалидтаблеидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидтаблеидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидтаблеидексцептион](./esentinvalidtableidexception-class.md)
