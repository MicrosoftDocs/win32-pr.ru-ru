---
description: 'Дополнительные сведения: методы UInt64ColumnValue'
title: Методы UInt64ColumnValue
...
ms.locfileid: "104265703"
---
# <a name="uint64columnvalue-methods"></a>Методы UInt64ColumnValue
