...
---
# <a name="esentpartiallyattacheddbexception-members"></a>Элементы Есентпартиалляттачеддбексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Партиалляттачеддб.

Тип [есентпартиалляттачеддбексцептион](./esentpartiallyattacheddbexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319840(v=exchg.10).md">есентпартиалляттачеддбексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентпартиалляттачеддбексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентпартиалляттачеддбексцептион](./esentpartiallyattacheddbexception-class.md)
