...
---
# <a name="esentinitinprogressexception-members"></a>Элементы Есентинитинпрогрессексцептион
...
Тип [есентинитинпрогрессексцептион](./esentinitinprogressexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350506(v=exchg.10).md">есентинитинпрогрессексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинитинпрогрессексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинитинпрогрессексцептион](./esentinitinprogressexception-class.md)
