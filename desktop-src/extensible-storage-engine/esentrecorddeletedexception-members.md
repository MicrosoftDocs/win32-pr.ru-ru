...
ms.locfileid: "118079715"
---
# <a name="esentrecorddeletedexception-members"></a>Элементы Есентрекордделетедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рекордделетед.

Тип [есентрекордделетедексцептион](./esentrecorddeletedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319823(v=exchg.10).md">есентрекордделетедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрекордделетедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрекордделетедексцептион](./esentrecorddeletedexception-class.md)
