...
---
# <a name="esentinvalidcountryexception-members"></a>Элементы Есентинвалидкаунтрексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидкаунтри.

Тип [есентинвалидкаунтрексцептион](./esentinvalidcountryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319466(v=exchg.10).md">есентинвалидкаунтрексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидкаунтрексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидкаунтрексцептион](./esentinvalidcountryexception-class.md)
