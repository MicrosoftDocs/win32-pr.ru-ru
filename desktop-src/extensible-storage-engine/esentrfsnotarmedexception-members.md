---
description: 'Дополнительные сведения о: Есентрфснотармедексцептион Members'
title: Элементы Есентрфснотармедексцептион
...
Базовый класс для JET_err. Исключения Рфснотармед.

Тип [есентрфснотармедексцептион](./esentrfsnotarmedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350568(v=exchg.10).md">есентрфснотармедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрфснотармедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрфснотармедексцептион](./esentrfsnotarmedexception-class.md)
