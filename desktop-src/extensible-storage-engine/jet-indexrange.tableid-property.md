---
description: 'Дополнительные сведения о свойстве: JET_INDEXRANGE. TableID'
title: JET_INDEXRANGE. TableID, свойство
...
Возвращает или задает курсор, содержащий диапазон индекса. Для курсора должен быть задан диапазон индексов с Жетсетиндексранже.
