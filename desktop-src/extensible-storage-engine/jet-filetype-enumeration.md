...
---
# <a name="jet_filetype-enumeration"></a>Перечисление JET_filetype
...
<td></td>
<td>Неизвестно</td>
<td>Неизвестный файл.</td>
</tr>
<tr class="even">
<td></td>
<td>База данных</td>
<td>Файл базы данных.</td>
</tr>
<tr class="odd">
<td></td>
<td>Журнал</td>
<td>Журнал транзакций.</td>
</tr>
<tr class="even">
<td></td>
<td>Контрольная точка</td>
<td>Файл контрольных точек.</td>
</tr>
<tr class="odd">
<td></td>
<td>темпдатабасе</td>
<td>Временная база данных.</td>
</tr>
</tbody>
</table>
