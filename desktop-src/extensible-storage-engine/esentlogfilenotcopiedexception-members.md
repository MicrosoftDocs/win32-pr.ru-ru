...
ms.locfileid: "119734784"
---
# <a name="esentlogfilenotcopiedexception-members"></a>Элементы Есентлогфиленоткопиедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логфиленоткопиед.

Тип [есентлогфиленоткопиедексцептион](./esentlogfilenotcopiedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334543(v=exchg.10).md">есентлогфиленоткопиедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогфиленоткопиедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогфиленоткопиедексцептион](./esentlogfilenotcopiedexception-class.md)
