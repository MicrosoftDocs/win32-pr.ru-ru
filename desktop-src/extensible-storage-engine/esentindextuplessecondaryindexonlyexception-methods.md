---
description: 'Дополнительные сведения: методы Есентиндекступлессекондариндексонлексцептион'
title: 'Методы EsentIndexTuplesSecondaryIndexOnlyException '
...
ms.locfileid: "104555692"
---
# <a name="esentindextuplessecondaryindexonlyexception-methods"></a>Методы EsentIndexTuplesSecondaryIndexOnlyException 
