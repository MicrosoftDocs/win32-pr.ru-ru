...
---
# <a name="esentfilecompressedexception-members"></a>Элементы Есентфилекомпресседексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Филекомпрессед.

Тип [есентфилекомпресседексцептион](./esentfilecompressedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274345(v=exchg.10).md">есентфилекомпресседексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфилекомпресседексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфилекомпресседексцептион](./esentfilecompressedexception-class.md)
