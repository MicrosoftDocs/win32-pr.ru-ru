...
---
# <a name="esentwriteconflictprimaryindexexception-members"></a>Элементы Есентвритеконфликтпримариндексексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Вритеконфликтпримариндекс.

Тип [есентвритеконфликтпримариндексексцептион](./esentwriteconflictprimaryindexexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350895(v=exchg.10).md">есентвритеконфликтпримариндексексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентвритеконфликтпримариндексексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентвритеконфликтпримариндексексцептион](./esentwriteconflictprimaryindexexception-class.md)
