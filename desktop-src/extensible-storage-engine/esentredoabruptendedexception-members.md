...
ms.locfileid: "118982062"
---
# <a name="esentredoabruptendedexception-members"></a>Элементы Есентредоабруптендедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Редоабруптендед.

Тип [есентредоабруптендедексцептион](./esentredoabruptendedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350515(v=exchg.10).md">есентредоабруптендедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентредоабруптендедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентредоабруптендедексцептион](./esentredoabruptendedexception-class.md)
