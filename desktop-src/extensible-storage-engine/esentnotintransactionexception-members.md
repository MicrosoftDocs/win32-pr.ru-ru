...
---
# <a name="esentnotintransactionexception-members"></a>Элементы Есентнотинтрансактионексцептион
...
Тип [есентнотинтрансактионексцептион](./esentnotintransactionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319688(v=exchg.10).md">есентнотинтрансактионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнотинтрансактионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнотинтрансактионексцептион](./esentnotintransactionexception-class.md)
