---
description: 'Дополнительные сведения о: Есенттранстудипексцептион Members'
title: Элементы Есенттранстудипексцептион
...
ms.locfileid: "104558215"
---
# <a name="esenttranstoodeepexception-members"></a>Элементы Есенттранстудипексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Транстудип.

Тип [есенттранстудипексцептион](./esenttranstoodeepexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350811(v=exchg.10).md">есенттранстудипексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттранстудипексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттранстудипексцептион](./esenttranstoodeepexception-class.md)
