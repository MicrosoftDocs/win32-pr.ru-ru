---
description: 'Дополнительные сведения о свойстве: JET_SPACEHINTS. Кбмаксекстент'
title: Свойство JET_SPACEHINTS. Кбмаксекстент
...
ms.locfileid: "118979254"
---
# <a name="jet_spacehintscbmaxextent-property"></a>Свойство JET_SPACEHINTS. Кбмаксекстент

Возвращает или задает значение, устанавливающее Улгровс. Это значение указано в байтах.
