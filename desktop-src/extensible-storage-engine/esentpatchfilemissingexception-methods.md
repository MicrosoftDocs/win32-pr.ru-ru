---
description: 'Дополнительные сведения: методы Есентпатчфилемиссинжексцептион'
title: 'Методы EsentPatchFileMissingException '
...
ms.locfileid: "119732974"
---
# <a name="esentpatchfilemissingexception-methods"></a>Методы EsentPatchFileMissingException 
