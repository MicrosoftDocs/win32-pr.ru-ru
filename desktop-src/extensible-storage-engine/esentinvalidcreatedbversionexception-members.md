...
ms.locfileid: "119041232"
---
# <a name="esentinvalidcreatedbversionexception-members"></a>Элементы Есентинвалидкреатедбверсионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидкреатедбверсион.

Тип [есентинвалидкреатедбверсионексцептион](./esentinvalidcreatedbversionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319469(v=exchg.10).md">есентинвалидкреатедбверсионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидкреатедбверсионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидкреатедбверсионексцептион](./esentinvalidcreatedbversionexception-class.md)
