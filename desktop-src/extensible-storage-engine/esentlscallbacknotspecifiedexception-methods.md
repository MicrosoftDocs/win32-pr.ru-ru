---
description: 'Дополнительные сведения: методы ЕсентлскаллбаккнотспеЦифиедексцептион'
title: 'Методы EsentLSCallbackNotSpecifiedException '
...
ms.locfileid: "104564820"
---
# <a name="esentlscallbacknotspecifiedexception-methods"></a>Методы EsentLSCallbackNotSpecifiedException 
