---
description: 'Дополнительные сведения: методы Есентбадресторетаржетинстанцеексцептион'
title: 'Методы EsentBadRestoreTargetInstanceException '
...
ms.locfileid: "118082722"
---
# <a name="esentbadrestoretargetinstanceexception-methods"></a>Методы EsentBadRestoreTargetInstanceException 
