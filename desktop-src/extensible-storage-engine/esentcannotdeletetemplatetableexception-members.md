...
ms.locfileid: "118499039"
---
# <a name="esentcannotdeletetemplatetableexception-members"></a>Элементы Есентканнотделететемплатетабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотделететемплатетабле.

Тип [есентканнотделететемплатетабликсцептион](./esentcannotdeletetemplatetableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274148(v=exchg.10).md">есентканнотделететемплатетабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотделететемплатетабликсцептион.</td>
</tr>
</tbody>
</table>
