---
description: 'Дополнительные сведения: методы Есентлогсекуенцеенддатабасесконсистентексцептион'
title: 'Методы EsentLogSequenceEndDatabasesConsistentException '
...
ms.locfileid: "118080478"
---
# <a name="esentlogsequenceenddatabasesconsistentexception-methods"></a>Методы EsentLogSequenceEndDatabasesConsistentException 
