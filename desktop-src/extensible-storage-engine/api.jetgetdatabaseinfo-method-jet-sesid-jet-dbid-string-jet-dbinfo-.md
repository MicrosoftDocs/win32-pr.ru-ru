...
ms.locfileid: "118784200"
---
# <a name="apijetgetdatabaseinfo-method-jet_sesid-jet_dbid-string-jet_dbinfo"></a>Метод API. Жетжетдатабасеинфо (JET_SESID, JET_DBID, String, JET_DbInfo)
