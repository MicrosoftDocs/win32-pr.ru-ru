---
description: 'Дополнительные сведения о: JET_LOGTIME Members'
title: Элементы JET_LOGTIME
...
ms.locfileid: "118766082"
---
# <a name="jet_logtime-members"></a>Элементы JET_LOGTIME
...
Тип [JET_LOGTIME](./jet-logtime-structure2.md) предоставляет следующие члены.
...
<td>Возвращает значение, указывающее, имеет ли JET_LOGTIME значение null.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="hh578730(v=exchg.10).md">исутк</a></td>
<td>Возвращает значение, указывающее, находится ли JET_LOGTIME в формате UTC.</td>
</tr>
</tbody>
</table>
...
<td>Создайте представление DateTime этого JET_LOGTIME.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
...
<td><a href="hh579323(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_LOGTIME.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh577958(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_LOGTIME неравными.</td>
</tr>
</tbody>
</table>
