...
ms.locfileid: "120094014"
---
# <a name="esentversionstoreoutofmemoryexception-members"></a>Элементы Есентверсионстореаутофмеморексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Версионстореаутофмемори.

Тип [есентверсионстореаутофмеморексцептион](./esentversionstoreoutofmemoryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350875(v=exchg.10).md">есентверсионстореаутофмеморексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентверсионстореаутофмеморексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентверсионстореаутофмеморексцептион](./esentversionstoreoutofmemoryexception-class.md)
