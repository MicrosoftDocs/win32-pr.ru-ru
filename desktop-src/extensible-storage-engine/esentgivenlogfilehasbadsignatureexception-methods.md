---
description: 'Дополнительные сведения: методы Есентгивенлогфилехасбадсигнатуриксцептион'
title: 'Методы EsentGivenLogFileHasBadSignatureException '
...
ms.locfileid: "104565577"
---
# <a name="esentgivenlogfilehasbadsignatureexception-methods"></a>Методы EsentGivenLogFileHasBadSignatureException 
