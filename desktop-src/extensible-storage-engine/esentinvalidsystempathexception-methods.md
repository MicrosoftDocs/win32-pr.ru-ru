---
description: 'Дополнительные сведения: методы Есентинвалидсистемпасексцептион'
title: 'Методы EsentInvalidSystemPathException '
...
ms.locfileid: "104555026"
---
# <a name="esentinvalidsystempathexception-methods"></a>Методы EsentInvalidSystemPathException 
