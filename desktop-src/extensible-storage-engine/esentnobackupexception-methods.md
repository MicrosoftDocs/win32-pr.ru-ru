---
description: 'Дополнительные сведения: методы Есентнобаккупексцептион'
title: 'Методы EsentNoBackupException '
...
ms.locfileid: "118775476"
---
# <a name="esentnobackupexception-methods"></a>Методы EsentNoBackupException 
