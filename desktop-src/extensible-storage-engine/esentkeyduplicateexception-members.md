---
description: 'Дополнительные сведения о: Есенткэйдупликатиксцептион Members'
title: Элементы Есенткэйдупликатиксцептион
...
ms.locfileid: "104349502"
---
# <a name="esentkeyduplicateexception-members"></a>Элементы Есенткэйдупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения KeyDuplicate.

Тип [есенткэйдупликатиксцептион](./esentkeyduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319617(v=exchg.10).md">есенткэйдупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенткэйдупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенткэйдупликатиксцептион](./esentkeyduplicateexception-class.md)
