...
ms.locfileid: "118982224"
---
# <a name="esentloggingdisabledexception-members"></a>Элементы Есентлоггингдисабледексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логгингдисаблед.

Тип [есентлоггингдисабледексцептион](./esentloggingdisabledexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334575(v=exchg.10).md">есентлоггингдисабледексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлоггингдисабледексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлоггингдисабледексцептион](./esentloggingdisabledexception-class.md)
