---
description: 'Дополнительные сведения о: Флоатколумнвалуе свойства'
title: Свойства Флоатколумнвалуе
...
ms.locfileid: "117896426"
---
# <a name="floatcolumnvalue-properties"></a>Свойства Флоатколумнвалуе

Включить защищенные члены  
Включить унаследованные члены  

Тип [флоатколумнвалуе](./floatcolumnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn350901(v=exchg.10).md">Размер</a></td>
