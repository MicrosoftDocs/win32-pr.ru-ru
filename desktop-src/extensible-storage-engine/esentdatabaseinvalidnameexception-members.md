---
description: 'Дополнительные сведения о: Есентдатабасеинвалиднамиксцептион Members'
title: Элементы Есентдатабасеинвалиднамиксцептион
...
ms.locfileid: "119852174"
---
# <a name="esentdatabaseinvalidnameexception-members"></a>Элементы Есентдатабасеинвалиднамиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеинвалиднаме.

Тип [есентдатабасеинвалиднамиксцептион](./esentdatabaseinvalidnameexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334335(v=exchg.10).md">есентдатабасеинвалиднамиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеинвалиднамиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеинвалиднамиксцептион](./esentdatabaseinvalidnameexception-class.md)
