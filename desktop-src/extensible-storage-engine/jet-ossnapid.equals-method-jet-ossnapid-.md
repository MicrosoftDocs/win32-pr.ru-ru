---
description: 'Дополнительные сведения о: JET_OSSNAPID. Метод Equals (JET_OSSNAPID)'
title: JET_OSSNAPID. Метод Equals (JET_OSSNAPID)
...
ms.locfileid: "119107691"
---
# <a name="jet_ossnapidequals-method-jet_ossnapid"></a>JET_OSSNAPID. Метод Equals (JET_OSSNAPID)
...
[Перегрузка Equals](./jet-ossnapid.equals-method.md)
