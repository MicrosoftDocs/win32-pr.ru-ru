---
description: 'Дополнительные сведения о: Есенткэйтубижексцептион Members'
title: Элементы Есенткэйтубижексцептион
...
ms.locfileid: "104350485"
---
# <a name="esentkeytoobigexception-members"></a>Элементы Есенткэйтубижексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Кэйтубиг.

Тип [есенткэйтубижексцептион](./esentkeytoobigexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319614(v=exchg.10).md">есенткэйтубижексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенткэйтубижексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенткэйтубижексцептион](./esentkeytoobigexception-class.md)
