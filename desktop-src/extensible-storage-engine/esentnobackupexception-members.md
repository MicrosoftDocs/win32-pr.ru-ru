---
description: 'Дополнительные сведения о: Есентнобаккупексцептион Members'
title: Элементы Есентнобаккупексцептион
...
ms.locfileid: "118263669"
---
# <a name="esentnobackupexception-members"></a>Элементы Есентнобаккупексцептион
...
Тип [есентнобаккупексцептион](./esentnobackupexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319685(v=exchg.10).md">есентнобаккупексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнобаккупексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнобаккупексцептион](./esentnobackupexception-class.md)
