---
description: 'Дополнительные сведения о: Есентнотиндистрибутедтрансактионексцептион свойства'
title: Свойства Есентнотиндистрибутедтрансактионексцептион
...
ms.locfileid: "118263192"
---
# <a name="esentnotindistributedtransactionexception-properties"></a>Свойства Есентнотиндистрибутедтрансактионексцептион
