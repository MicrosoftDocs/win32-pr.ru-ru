...
---
# <a name="esentdensityinvalidexception-members"></a>Элементы Есентденситинвалидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Денситинвалид.

Тип [есентденситинвалидексцептион](./esentdensityinvalidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334435(v=exchg.10).md">есентденситинвалидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентденситинвалидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентденситинвалидексцептион](./esentdensityinvalidexception-class.md)
