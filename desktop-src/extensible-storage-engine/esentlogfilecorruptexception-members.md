...
ms.locfileid: "120064694"
---
# <a name="esentlogfilecorruptexception-members"></a>Элементы Есентлогфилекорруптексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логфилекоррупт.

Тип [есентлогфилекорруптексцептион](./esentlogfilecorruptexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334616(v=exchg.10).md">есентлогфилекорруптексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогфилекорруптексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогфилекорруптексцептион](./esentlogfilecorruptexception-class.md)
