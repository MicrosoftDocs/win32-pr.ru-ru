---
description: 'Дополнительные сведения о: Есентдатабаселоккедексцептион Members'
title: Элементы Есентдатабаселоккедексцептион
...
ms.locfileid: "103898513"
---
# <a name="esentdatabaselockedexception-members"></a>Элементы Есентдатабаселоккедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабаселоккед.

Тип [есентдатабаселоккедексцептион](./esentdatabaselockedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334475(v=exchg.10).md">есентдатабаселоккедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабаселоккедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабаселоккедексцептион](./esentdatabaselockedexception-class.md)
