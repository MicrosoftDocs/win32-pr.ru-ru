---
description: 'Дополнительные сведения о: Есентакцессдениедексцептион Members'
title: Элементы Есентакцессдениедексцептион
...
ms.locfileid: "104555173"
---
# <a name="esentaccessdeniedexception-members"></a>Элементы Есентакцессдениедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения AccessDenied.

Тип [есентакцессдениедексцептион](./esentaccessdeniedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273981(v=exchg.10).md">есентакцессдениедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентакцессдениедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентакцессдениедексцептион](./esentaccessdeniedexception-class.md)
