---
description: 'Дополнительные сведения: JET_THREADSTATS методы'
title: Методы JET_THREADSTATS (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "104272119"
---
# <a name="jet_threadstats-methods"></a>Методы JET_THREADSTATS
