...
ms.locfileid: "119837154"
---
# <a name="esentkeyismadeexception-members"></a>Элементы Есенткэйисмадиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Кэйисмаде.

Тип [есенткэйисмадиксцептион](./esentkeyismadeexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334551(v=exchg.10).md">есенткэйисмадиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенткэйисмадиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенткэйисмадиксцептион](./esentkeyismadeexception-class.md)
