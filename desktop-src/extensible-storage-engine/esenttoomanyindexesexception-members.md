...
ms.locfileid: "119850604"
---
# <a name="esenttoomanyindexesexception-members"></a>Элементы Есенттуманиндексесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманиндексес.

Тип [есенттуманиндексесексцептион](./esenttoomanyindexesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334993(v=exchg.10).md">есенттуманиндексесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманиндексесексцептион.</td>
</tr>
</tbody>
</table>
