---
description: 'Дополнительные сведения о методе: Есентресаурце. Релеасересаурце'
title: Есентресаурце. Релеасересаурце, метод
...
ms.locfileid: "119970769"
---
# <a name="esentresourcereleaseresource-method"></a>Есентресаурце. Релеасересаурце, метод

Реализуется подклассом для освобождения ресурса.
