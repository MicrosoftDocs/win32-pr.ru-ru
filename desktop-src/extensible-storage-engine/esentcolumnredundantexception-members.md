---
description: 'Дополнительные сведения о: Есентколумнредундантексцептион Members'
title: Элементы Есентколумнредундантексцептион
...
ms.locfileid: "119041732"
---
# <a name="esentcolumnredundantexception-members"></a>Элементы Есентколумнредундантексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнредундант.

Тип [есентколумнредундантексцептион](./esentcolumnredundantexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274203(v=exchg.10).md">есентколумнредундантексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнредундантексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнредундантексцептион](./esentcolumnredundantexception-class.md)
