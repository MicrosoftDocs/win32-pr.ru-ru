---
description: 'Дополнительные сведения о: Есентинвалиднамиксцептион Members'
title: Элементы Есентинвалиднамиксцептион
...
ms.locfileid: "104080998"
---
# <a name="esentinvalidnameexception-members"></a>Элементы Есентинвалиднамиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалиднаме.

Тип [есентинвалиднамиксцептион](./esentinvalidnameexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319565(v=exchg.10).md">есентинвалиднамиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалиднамиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалиднамиксцептион](./esentinvalidnameexception-class.md)
