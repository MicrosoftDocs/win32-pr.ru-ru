...
---
# <a name="esentpartiallyattacheddbexception-constructor"></a>Конструктор Есентпартиалляттачеддбексцептион

Инициализирует новый экземпляр класса Есентпартиалляттачеддбексцептион.
...
[Элементы Есентпартиалляттачеддбексцептион](./esentpartiallyattacheddbexception-members.md)
