...
Базовый класс для JET_err. Исключения Туманйопендатабасес.

Тип [есенттуманйопендатабасесексцептион](./esenttoomanyopendatabasesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335015(v=exchg.10).md">есенттуманйопендатабасесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманйопендатабасесексцептион.</td>
</tr>
</tbody>
</table>
