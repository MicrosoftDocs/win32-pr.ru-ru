---
description: 'Дополнительные сведения: методы Есентиллегалоператионексцептион'
title: Методы EsentIllegalOperationException
...
ms.locfileid: "104154719"
---
# <a name="esentillegaloperationexception-methods"></a>Методы EsentIllegalOperationException
