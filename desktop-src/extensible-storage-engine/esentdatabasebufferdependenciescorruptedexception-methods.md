---
description: 'Дополнительные сведения: методы ЕсентдатабасебуффердепенденЦиескорруптедексцептион'
title: 'Методы EsentDatabaseBufferDependenciesCorruptedException '
...
ms.locfileid: "104555290"
---
# <a name="esentdatabasebufferdependenciescorruptedexception-methods"></a>Методы EsentDatabaseBufferDependenciesCorruptedException 
