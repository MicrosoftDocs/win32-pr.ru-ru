---
description: 'Дополнительные сведения о: Есентрекорднотделетедексцептион Members'
title: Элементы Есентрекорднотделетедексцептион
...
ms.locfileid: "103810565"
---
# <a name="esentrecordnotdeletedexception-members"></a>Элементы Есентрекорднотделетедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рекорднотделетед.

Тип [есентрекорднотделетедексцептион](./esentrecordnotdeletedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350513(v=exchg.10).md">есентрекорднотделетедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрекорднотделетедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрекорднотделетедексцептион](./esentrecordnotdeletedexception-class.md)
