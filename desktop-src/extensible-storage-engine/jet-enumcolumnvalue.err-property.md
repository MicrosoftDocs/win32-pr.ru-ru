...
---
# <a name="jet_enumcolumnvalueerr-property"></a>Свойство JET_ENUMCOLUMNVALUE. ERR

Возвращает код состояния столбца, полученный в результате перечисления значения столбца.
...
[колумннулл](./jet-wrn-enumeration.md)

[колумнскиппед](./jet-wrn-enumeration.md)

[колумнтрункатед](./jet-wrn-enumeration.md)
