---
description: 'Дополнительные сведения о свойстве: JET_INDEXCREATE. Кбварсегмак'
title: Свойство JET_INDEXCREATE. Кбварсегмак
...
Возвращает или задает максимальную длину (в байтах) каждого столбца для хранения в индексе.
