---
description: 'Дополнительные сведения о свойстве: JET_OBJECTLIST. Колумнидкрекорд'
title: Свойство JET_OBJECTLIST. Колумнидкрекорд
...
ms.locfileid: "105703348"
---
# <a name="jet_objectlistcolumnidcrecord-property"></a>Свойство JET_OBJECTLIST. Колумнидкрекорд

Возвращает значение columnid столбца во временной таблице, в котором хранится количество записей в таблице.
