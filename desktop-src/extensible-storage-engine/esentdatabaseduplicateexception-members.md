---
description: 'Дополнительные сведения о: Есентдатабаседупликатиксцептион Members'
title: Элементы Есентдатабаседупликатиксцептион
...
ms.locfileid: "104565995"
---
# <a name="esentdatabaseduplicateexception-members"></a>Элементы Есентдатабаседупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабаседупликате.

Тип [есентдатабаседупликатиксцептион](./esentdatabaseduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334300(v=exchg.10).md">есентдатабаседупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабаседупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабаседупликатиксцептион](./esentdatabaseduplicateexception-class.md)
