...
ms.locfileid: "118982364"
---
# <a name="esentinvaliddatabaseversionexception-members"></a>Элементы Есентинвалиддатабасеверсионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалиддатабасеверсион.

Тип [есентинвалиддатабасеверсионексцептион](./esentinvaliddatabaseversionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319482(v=exchg.10).md">есентинвалиддатабасеверсионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалиддатабасеверсионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалиддатабасеверсионексцептион](./esentinvaliddatabaseversionexception-class.md)
