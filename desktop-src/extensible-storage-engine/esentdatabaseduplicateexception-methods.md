---
description: 'Дополнительные сведения: методы Есентдатабаседупликатиксцептион'
title: 'Методы EsentDatabaseDuplicateException '
...
ms.locfileid: "119974839"
---
# <a name="esentdatabaseduplicateexception-methods"></a>Методы EsentDatabaseDuplicateException 
