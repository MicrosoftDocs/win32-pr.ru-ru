---
description: 'Дополнительные сведения о свойстве: JET_RECSIZE. Кмултивалуес'
title: Свойство JET_RECSIZE. Кмултивалуес (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "118763687"
---
# <a name="jet_recsizecmultivalues-property"></a>Свойство JET_RECSIZE. Кмултивалуес

Возвращает совокупное число значений, находящихся за первым для всех столбцов в записи.
