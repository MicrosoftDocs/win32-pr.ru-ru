---
description: 'Дополнительные сведения о: конструктор Есентбадбукмаркексцептион'
title: Конструктор Есентбадбукмаркексцептион
...
ms.locfileid: "105693746"
---
# <a name="esentbadbookmarkexception-constructor"></a>Конструктор Есентбадбукмаркексцептион

Инициализирует новый экземпляр класса Есентбадбукмаркексцептион.
...
[Элементы Есентбадбукмаркексцептион](./esentbadbookmarkexception-members.md)
