---
description: 'Дополнительные сведения: методы Есентлогдисабледдуеторековерифаилуриксцептион'
title: 'Методы EsentLogDisabledDueToRecoveryFailureException '
...
ms.locfileid: "104349482"
---
# <a name="esentlogdisabledduetorecoveryfailureexception-methods"></a>Методы EsentLogDisabledDueToRecoveryFailureException 
