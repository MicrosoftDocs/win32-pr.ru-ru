...
---
# <a name="jet_dbinfomisc3-structure"></a>Структура JET_DBINFOMISC3
...
Структура **JET_DBINFOMISC3** содержит различные сведения о базе данных. Это сведения, содержащиеся в заголовке базы данных.
...
Представляет минимальное поколение журналов, необходимое для воспроизведения журналов. Обычно это аналогично созданию контрольной точки.
...
Текущее создание журнала. Это значение может быть меньше Женмаксрекуиред, если JET_paramWaypointLatency не равно нулю.
