---
description: 'Дополнительные сведения о: EsentMustCommitDistributedTransactionToLevel0Exception Members'
title: Элементы EsentMustCommitDistributedTransactionToLevel0Exception
...
ms.locfileid: "119734172"
---
# <a name="esentmustcommitdistributedtransactiontolevel0exception-members"></a>Элементы EsentMustCommitDistributedTransactionToLevel0Exception

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения MustCommitDistributedTransactionToLevel0.

Тип [EsentMustCommitDistributedTransactionToLevel0Exception](./esentmustcommitdistributedtransactiontolevel0exception-class.md) предоставляет следующие члены.
...
<td>Инициализирует новый экземпляр класса EsentMustCommitDistributedTransactionToLevel0Exception.</td>
</tr>
</tbody>
</table>
...
[Класс EsentMustCommitDistributedTransactionToLevel0Exception](./esentmustcommitdistributedtransactiontolevel0exception-class.md)
