---
description: 'Дополнительные сведения о: конструктор Есентинвалидбуфферсизиксцептион'
title: Конструктор Есентинвалидбуфферсизиксцептион
...
ms.locfileid: "119972683"
---
# <a name="esentinvalidbuffersizeexception-constructor"></a>Конструктор Есентинвалидбуфферсизиксцептион

Инициализирует новый экземпляр класса Есентинвалидбуфферсизиксцептион.
...
[Элементы Есентинвалидбуфферсизиксцептион](./esentinvalidbuffersizeexception-members.md)
