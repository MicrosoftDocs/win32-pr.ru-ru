---
description: 'Дополнительные сведения: методы Есентсуррогатебаккупинпрогрессексцептион'
title: 'Методы EsentSurrogateBackupInProgressException '
...
ms.locfileid: "104564783"
---
# <a name="esentsurrogatebackupinprogressexception-methods"></a>Методы EsentSurrogateBackupInProgressException 
