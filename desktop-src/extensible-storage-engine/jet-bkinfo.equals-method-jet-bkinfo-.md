---
description: 'Дополнительные сведения о: JET_BKINFO. Метод Equals (JET_BKINFO)'
title: JET_BKINFO. Метод Equals (JET_BKINFO)
...
ms.locfileid: "119617894"
---
# <a name="jet_bkinfoequals-method-jet_bkinfo"></a>JET_BKINFO. Метод Equals (JET_BKINFO)
...
[Перегрузка Equals](./jet-bkinfo.equals-method.md)
