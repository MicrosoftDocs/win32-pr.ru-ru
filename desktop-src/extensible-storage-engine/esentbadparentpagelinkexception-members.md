---
description: 'Дополнительные сведения о: Есентбадпарентпажелинкексцептион Members'
title: Элементы Есентбадпарентпажелинкексцептион
...
ms.locfileid: "103999364"
---
# <a name="esentbadparentpagelinkexception-members"></a>Элементы Есентбадпарентпажелинкексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Бадпарентпажелинк.
...
<td><a href="dn274036(v=exchg.10).md">есентбадпарентпажелинкексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадпарентпажелинкексцептион.</td>
</tr>
</tbody>
</table>
