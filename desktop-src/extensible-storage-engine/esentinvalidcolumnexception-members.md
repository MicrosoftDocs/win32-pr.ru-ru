---
description: 'Дополнительные сведения о: Есентинвалидколумнексцептион Members'
title: Элементы Есентинвалидколумнексцептион
...
Исключение, возникающее при сбое преобразования столбца.

Тип [есентинвалидколумнексцептион](./esentinvalidcolumnexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319451(v=exchg.10).md">Есентинвалидколумнексцептион ()</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидколумнексцептион.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn350430(v=exchg.10).md">Есентинвалидколумнексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидколумнексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
</tbody>
</table>
...
<td>Возвращает текстовое сообщение с описанием исключения. (Переопределяет <a href="/dotnet/api/system.exception.message#System_Exception_Message">исключение. Message</a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
