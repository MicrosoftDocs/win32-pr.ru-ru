...
ms.locfileid: "117716133"
---
# <a name="esentapiexception-constructor-string-jet_err"></a>Конструктор Есентапиексцептион (String, JET_err)

Инициализирует новый экземпляр класса Есентапиексцептион.
