---
description: 'Дополнительные сведения о: Есентрековередвисаутундодатабасесконсистентексцептион Members'
title: Элементы Есентрековередвисаутундодатабасесконсистентексцептион
...
ms.locfileid: "118774919"
---
# <a name="esentrecoveredwithoutundodatabasesconsistentexception-members"></a>Элементы Есентрековередвисаутундодатабасесконсистентексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рековередвисаутундодатабасесконсистент.

Тип [есентрековередвисаутундодатабасесконсистентексцептион](./esentrecoveredwithoutundodatabasesconsistentexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350534(v=exchg.10).md">есентрековередвисаутундодатабасесконсистентексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрековередвисаутундодатабасесконсистентексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрековередвисаутундодатабасесконсистентексцептион](./esentrecoveredwithoutundodatabasesconsistentexception-class.md)
