---
description: 'Дополнительные сведения о: Есентинвалидлогдатасекуенцеексцептион Members'
title: Элементы Есентинвалидлогдатасекуенцеексцептион
...
ms.locfileid: "104553569"
---
# <a name="esentinvalidlogdatasequenceexception-members"></a>Элементы Есентинвалидлогдатасекуенцеексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидлогдатасекуенце.

Тип [есентинвалидлогдатасекуенцеексцептион](./esentinvalidlogdatasequenceexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319537(v=exchg.10).md">есентинвалидлогдатасекуенцеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидлогдатасекуенцеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидлогдатасекуенцеексцептион](./esentinvalidlogdatasequenceexception-class.md)
