---
description: 'Дополнительные сведения о: Есентинвалидоператионексцептион Members'
title: Элементы Есентинвалидоператионексцептион
...
ms.locfileid: "104558436"
---
# <a name="esentinvalidoperationexception-members"></a>Элементы Есентинвалидоператионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения InvalidOperation.

Тип [есентинвалидоператионексцептион](./esentinvalidoperationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319573(v=exchg.10).md">есентинвалидоператионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидоператионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидоператионексцептион](./esentinvalidoperationexception-class.md)
