...
ms.locfileid: "119724734"
---
# <a name="esentfixedinheritedddlexception-members"></a>Элементы Есентфиксединхеритедддлексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Фиксединхеритедддл.

Тип [есентфиксединхеритедддлексцептион](./esentfixedinheritedddlexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350414(v=exchg.10).md">есентфиксединхеритедддлексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфиксединхеритедддлексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфиксединхеритедддлексцептион](./esentfixedinheritedddlexception-class.md)
