...
ms.locfileid: "119783724"
---
# <a name="esentinvalidindexidexception-members"></a>Элементы Есентинвалидиндексидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидиндексид.

Тип [есентинвалидиндексидексцептион](./esentinvalidindexidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319524(v=exchg.10).md">есентинвалидиндексидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидиндексидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидиндексидексцептион](./esentinvalidindexidexception-class.md)
