...
---
# <a name="esentfilecloseexception-members"></a>Элементы Есентфилеклосиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения FileClose.

Тип [есентфилеклосиксцептион](./esentfilecloseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274334(v=exchg.10).md">есентфилеклосиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфилеклосиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфилеклосиксцептион](./esentfilecloseexception-class.md)
