---
description: 'Дополнительные сведения о: конструктор JET_UNICODEINDEX'
title: Конструктор JET_UNICODEINDEX
...
ms.locfileid: "119832444"
---
# <a name="jet_unicodeindex-constructor"></a>Конструктор JET_UNICODEINDEX
