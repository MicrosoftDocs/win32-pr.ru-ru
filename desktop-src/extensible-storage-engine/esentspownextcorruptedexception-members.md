---
description: 'Дополнительные сведения о: Есентсповнексткорруптедексцептион Members'
title: Элементы Есентсповнексткорруптедексцептион
...
ms.locfileid: "104569578"
---
# <a name="esentspownextcorruptedexception-members"></a>Элементы Есентсповнексткорруптедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Сповнексткорруптед.

Тип [есентсповнексткорруптедексцептион](./esentspownextcorruptedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334848(v=exchg.10).md">есентсповнексткорруптедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсповнексткорруптедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсповнексткорруптедексцептион](./esentspownextcorruptedexception-class.md)
