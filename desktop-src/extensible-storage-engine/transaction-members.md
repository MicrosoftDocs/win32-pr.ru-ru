...
---
# <a name="transaction-members"></a>Участники транзакции 

Включить защищенные члены  
Включить унаследованные члены  

Класс, инкапсулирующий транзакцию на JET_SESID.
...
<td><a href="dn351177(v=exchg.10).md">Транзакция</a></td>
<td>Инициализирует новый экземпляр класса Transaction. Это автоматически начнет транзакцию. Если не зафиксировано явно, будет выполнен откат транзакции.</td>
</tr>
</tbody>
</table>
...
<td><a href="dn351180(v=exchg.10).md">исинтрансактион</a></td>
<td>Возвращает значение, указывающее, находится ли данный объект в данный момент в транзакции.</td>
</tr>
</tbody>
</table>
