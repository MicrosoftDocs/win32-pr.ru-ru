---
description: 'Дополнительные сведения о: Есентстатиксцептион свойства'
title: Свойства Есентстатиксцептион
...
ms.locfileid: "104570877"
---
# <a name="esentstateexception-properties"></a>Свойства Есентстатиксцептион
