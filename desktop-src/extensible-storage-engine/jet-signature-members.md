---
description: 'Дополнительные сведения о: JET_SIGNATURE Members'
title: Элементы JET_SIGNATURE
...
Тип [JET_SIGNATURE](./jet-signature-structure2.md) предоставляет следующие члены.
...
<td><a href="hh565133(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_SIGNATURE.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh596753(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_SIGNATURE неравными.</td>
</tr>
</tbody>
</table>
