---
description: 'Дополнительные сведения: обновление членов'
title: 'Участники обновления '
...
ms.locfileid: "104550446"
---
# <a name="update-members"></a>Участники обновления 

Включить защищенные члены  
Включить унаследованные члены  

Класс, инкапсулирующий обновление на JET_TABLEID.

Тип [обновления](./update-class.md) предоставляет следующие члены.
...
<td><a href="dn351261(v=exchg.10).md">Обновление</a></td>
<td>Инициализирует новый экземпляр класса Update. Это автоматически начнет обновление. Обновление будет отменено, если не было явно сохранено.</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn351266(v=exchg.10).md">Отмена</a></td>
<td>Отмените обновление.</td>
</tr>
<tr class="even">
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351268(v=exchg.10).md">релеасересаурце</a></td>
...
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn351272(v=exchg.10).md">савеандготобукмарк</a></td>
<td>Обновите TableID и разместите TableID на записи, которая была изменена. Это может быть полезно при вставке записи, так как по умолчанию TableID остается в старом расположении.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn351192(v=exchg.10).md">ToString</a></td>
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущее <a href="dn351191(v=exchg.10).md">Обновление</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
