---
description: 'Дополнительные сведения: методы Есентроллбаккрекуиредексцептион'
title: 'Методы EsentRollbackRequiredException '
...
ms.locfileid: "104558041"
---
# <a name="esentrollbackrequiredexception-methods"></a>Методы EsentRollbackRequiredException 
