---
description: Дополнительные сведения о методе Transaction. Dispose
title: Transaction. Dispose, метод
...
ms.locfileid: "104563834"
---
# <a name="transactiondispose-method"></a>Transaction. Dispose, метод
