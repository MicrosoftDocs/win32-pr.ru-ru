...
---
# <a name="apiretrievecolumns-method"></a>API. Ретриевеколумнс, метод

Извлекает столбцы в объекты Колумнвалуе.
...
<!-- end list -->
  ...
  - TableID  
    ...
    Курсор получает данные из. Курсор должен быть размещен в записи.
