...
---
# <a name="esentinvalidgrbitexception-members"></a>Элементы Есентинвалидгрбитексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидгрбит.

Тип [есентинвалидгрбитексцептион](./esentinvalidgrbitexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319492(v=exchg.10).md">есентинвалидгрбитексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидгрбитексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидгрбитексцептион](./esentinvalidgrbitexception-class.md)
