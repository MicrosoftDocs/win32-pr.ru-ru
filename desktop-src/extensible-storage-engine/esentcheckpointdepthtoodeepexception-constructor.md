---
description: 'Дополнительные сведения о: конструктор Есентчеккпоинтдепстудипексцептион'
title: Конструктор Есентчеккпоинтдепстудипексцептион
...
Инициализирует новый экземпляр класса Есентчеккпоинтдепстудипексцептион.
...
[Элементы Есентчеккпоинтдепстудипексцептион](./esentcheckpointdepthtoodeepexception-members.md)
