---
description: 'Дополнительные сведения о: Есентбадлогверсионексцептион Members'
title: Элементы Есентбадлогверсионексцептион
...
ms.locfileid: "103999365"
---
# <a name="esentbadlogversionexception-members"></a>Элементы Есентбадлогверсионексцептион
...
Тип [есентбадлогверсионексцептион](./esentbadlogversionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274027(v=exchg.10).md">есентбадлогверсионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадлогверсионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадлогверсионексцептион](./esentbadlogversionexception-class.md)
