...
ms.locfileid: "119039662"
---
# <a name="esentterminprogressexception-members"></a>Элементы Есенттерминпрогрессексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Терминпрогресс.

Тип [есенттерминпрогрессексцептион](./esentterminprogressexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334976(v=exchg.10).md">есенттерминпрогрессексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттерминпрогрессексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттерминпрогрессексцептион](./esentterminprogressexception-class.md)
