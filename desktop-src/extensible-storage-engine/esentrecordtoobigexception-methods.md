---
description: 'Дополнительные сведения: методы Есентрекордтубижексцептион'
title: 'Методы EsentRecordTooBigException '
...
ms.locfileid: "104569213"
---
# <a name="esentrecordtoobigexception-methods"></a>Методы EsentRecordTooBigException 
