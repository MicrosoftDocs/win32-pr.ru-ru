---
description: 'Дополнительные сведения о: Есенталреадипрепаредексцептион Members'
title: Элементы Есенталреадипрепаредексцептион
...
ms.locfileid: "120021514"
---
# <a name="esentalreadypreparedexception-members"></a>Элементы Есенталреадипрепаредексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Алреадипрепаред.

Тип [есенталреадипрепаредексцептион](./esentalreadypreparedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334227(v=exchg.10).md">есенталреадипрепаредексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенталреадипрепаредексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенталреадипрепаредексцептион](./esentalreadypreparedexception-class.md)
