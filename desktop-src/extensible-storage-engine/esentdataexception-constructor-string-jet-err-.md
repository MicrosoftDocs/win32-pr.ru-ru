...
ms.locfileid: "119735564"
---
# <a name="esentdataexception-constructor-string-jet_err"></a>Конструктор Есентдатаексцептион (String, JET_err)

Инициализирует новый экземпляр класса Есентдатаексцептион.
