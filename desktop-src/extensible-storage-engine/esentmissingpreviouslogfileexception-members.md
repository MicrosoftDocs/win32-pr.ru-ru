...
---
# <a name="esentmissingpreviouslogfileexception-members"></a>Элементы Есентмиссингпревиауслогфиликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Миссингпревиауслогфиле.

Тип [есентмиссингпревиауслогфиликсцептион](./esentmissingpreviouslogfileexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334756(v=exchg.10).md">есентмиссингпревиауслогфиликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмиссингпревиауслогфиликсцептион.</td>
</tr>
</tbody>
</table>
