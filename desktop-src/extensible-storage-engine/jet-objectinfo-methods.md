---
description: 'Дополнительные сведения: JET_OBJECTINFO методы'
title: Методы JET_OBJECTINFO
...
ms.locfileid: "103815568"
---
# <a name="jet_objectinfo-methods"></a>Методы JET_OBJECTINFO

Включить защищенные члены  
Включить унаследованные члены  

Тип [JET_OBJECTINFO](./jet-objectinfo-class.md) предоставляет следующие члены.
...
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущий <a href="dn335219(v=exchg.10).md">JET_OBJECTINFO</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
...
[Класс JET_OBJECTINFO](./jet-objectinfo-class.md)
