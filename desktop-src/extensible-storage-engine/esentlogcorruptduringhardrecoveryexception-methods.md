---
description: 'Дополнительные сведения: методы Есентлогкорруптдурингхардрековерексцептион'
title: 'Методы EsentLogCorruptDuringHardRecoveryException '
...
ms.locfileid: "104558242"
---
# <a name="esentlogcorruptduringhardrecoveryexception-methods"></a>Методы EsentLogCorruptDuringHardRecoveryException 
