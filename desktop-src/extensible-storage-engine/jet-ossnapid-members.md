---
description: 'Дополнительные сведения о: JET_OSSNAPID Members'
title: Элементы JET_OSSNAPID
...
ms.locfileid: "118979684"
---
# <a name="jet_ossnapid-members"></a>Элементы JET_OSSNAPID

Включить защищенные члены  
Включить унаследованные члены  

JET_OSSNAPID содержит маркер моментального снимка базы данных.

Тип [JET_OSSNAPID](./jet-ossnapid-structure.md) предоставляет следующие члены.
...
<td><a href="hh566820(v=exchg.10).md">Указатель</a></td>
<td>Возвращает JET_OSSNAPID null.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh579206(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_OSSNAPID.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh557443(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_OSSNAPID неравными.</td>
</tr>
</tbody>
</table>
