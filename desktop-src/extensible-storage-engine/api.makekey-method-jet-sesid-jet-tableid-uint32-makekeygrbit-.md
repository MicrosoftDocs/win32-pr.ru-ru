...
ms.locfileid: "119840624"
---
# <a name="apimakekey-method-jet_sesid-jet_tableid-uint32-makekeygrbit"></a>Метод API. Макекэй (JET_SESID, JET_TABLEID, UInt32, Макекэйгрбит)
