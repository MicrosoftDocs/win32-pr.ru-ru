---
description: 'Дополнительные сведения о: Есентколумннотупдатабликсцептион Members'
title: Элементы Есентколумннотупдатабликсцептион
...
ms.locfileid: "103913183"
---
# <a name="esentcolumnnotupdatableexception-members"></a>Элементы Есентколумннотупдатабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумннотупдатабле.

Тип [есентколумннотупдатабликсцептион](./esentcolumnnotupdatableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334293(v=exchg.10).md">есентколумннотупдатабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумннотупдатабликсцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумннотупдатабликсцептион](./esentcolumnnotupdatableexception-class.md)
