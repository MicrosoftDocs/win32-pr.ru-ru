---
description: 'Дополнительные сведения: методы Есентинвалидсеттингсексцептион'
title: 'Методы EsentInvalidSettingsException '
...
ms.locfileid: "104080997"
---
# <a name="esentinvalidsettingsexception-methods"></a>Методы EsentInvalidSettingsException 
