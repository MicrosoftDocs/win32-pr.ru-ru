...
ms.locfileid: "119733964"
---
# <a name="esentnotinitializedexception-members"></a>Элементы Есентнотинитиализедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Нотинитиализед.

Тип [есентнотинитиализедексцептион](./esentnotinitializedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319844(v=exchg.10).md">есентнотинитиализедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнотинитиализедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнотинитиализедексцептион](./esentnotinitializedexception-class.md)
