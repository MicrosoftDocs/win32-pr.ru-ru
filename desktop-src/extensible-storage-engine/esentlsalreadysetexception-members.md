---
description: 'Дополнительные сведения о: Есентлсалреадисетексцептион Members'
title: Элементы Есентлсалреадисетексцептион
...
ms.locfileid: "120019894"
---
# <a name="esentlsalreadysetexception-members"></a>Элементы Есентлсалреадисетексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Лсалреадисет.

Тип [есентлсалреадисетексцептион](./esentlsalreadysetexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334615(v=exchg.10).md">есентлсалреадисетексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлсалреадисетексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлсалреадисетексцептион](./esentlsalreadysetexception-class.md)
