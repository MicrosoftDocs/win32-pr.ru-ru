---
description: 'Дополнительные сведения о свойстве: JET_OBJECTINFO. обжтип'
title: Свойство JET_OBJECTINFO. обжтип
...
ms.locfileid: "118979794"
---
# <a name="jet_objectinfoobjtyp-property"></a>Свойство JET_OBJECTINFO. обжтип

Возвращает JET_OBJTYP таблицы. В настоящее время возвращаются только таблицы (т. е. [Таблица](./jet-objtyp-enumeration.md)).
...
Тип: [Microsoft.ISAM.ESENT.Interop.JET_objtyp](./jet-objtyp-enumeration.md)  
...
[Элементы JET_OBJECTINFO](./jet-objectinfo-members.md)
