...
ms.locfileid: "119364061"
---
# <a name="esentinvalidparameterexception-members"></a>Элементы Есентинвалидпараметерексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидпараметер.

Тип [есентинвалидпараметерексцептион](./esentinvalidparameterexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319613(v=exchg.10).md">есентинвалидпараметерексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидпараметерексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидпараметерексцептион](./esentinvalidparameterexception-class.md)
