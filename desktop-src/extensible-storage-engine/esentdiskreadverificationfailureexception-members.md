---
description: 'Дополнительные сведения о: Есентдискреадверификатионфаилуриксцептион Members'
title: Элементы Есентдискреадверификатионфаилуриксцептион
...
ms.locfileid: "104081384"
---
# <a name="esentdiskreadverificationfailureexception-members"></a>Элементы Есентдискреадверификатионфаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дискреадверификатионфаилуре.

Тип [есентдискреадверификатионфаилуриксцептион](./esentdiskreadverificationfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274292(v=exchg.10).md">есентдискреадверификатионфаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдискреадверификатионфаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдискреадверификатионфаилуриксцептион](./esentdiskreadverificationfailureexception-class.md)
