---
description: 'Дополнительные сведения о: JET_TABLEID Members'
title: Элементы JET_TABLEID
...
ms.locfileid: "104562280"
---
# <a name="jet_tableid-members"></a>Элементы JET_TABLEID
...
Тип [JET_TABLEID](./jet-tableid-structure.md) предоставляет следующие члены.
...
<td><a href="hh558295(v=exchg.10).md">Указатель</a></td>
<td>Возвращает JET_TABLEID null.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh596595(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_TABLEID.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh577464(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_TABLEID неравными.</td>
</tr>
</tbody>
</table>
