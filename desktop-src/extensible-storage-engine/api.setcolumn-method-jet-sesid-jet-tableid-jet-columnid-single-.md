...
ms.locfileid: "118982924"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-single"></a>Метод API. Сетколумн (JET_SESID, JET_TABLEID, JET_COLUMNID, Single)
