---
description: 'Дополнительные сведения: JET_BKINFO методы'
title: Методы JET_BKINFO
...
ms.locfileid: "104272135"
---
# <a name="jet_bkinfo-methods"></a>Методы JET_BKINFO

Включить защищенные члены  
Включить унаследованные члены  

Тип [JET_BKINFO](./jet-bkinfo-structure2.md) предоставляет следующие члены.
