---
description: 'Дополнительные сведения о: Есентконтаинернотемптексцептион Class'
title: Класс Есентконтаинернотемптексцептион
      ...
      [Microsoft. ISAM. ESENT. Interop. Есентеррорексцептион](./esenterrorexception-class.md)  
        [Microsoft. ISAM. ESENT. Interop. Есентапиексцептион](./esentapiexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентобсолетиксцептион](./esentobsoleteexception-class.md)  
            Microsoft. ISAM. ESENT. Interop. Есентконтаинернотемптексцептион  
...
[Элементы Есентконтаинернотемптексцептион](./esentcontainernotemptyexception-members.md)
