---
description: 'Дополнительные сведения: методы Есентдатабасесигнинусиксцептион'
title: 'Методы EsentDatabaseSignInUseException '
...
ms.locfileid: "103898497"
---
# <a name="esentdatabasesigninuseexception-methods"></a>Методы EsentDatabaseSignInUseException 
