---
description: 'Дополнительные сведения о: Есентдатаексцептион свойства'
title: Свойства Есентдатаексцептион
...
ms.locfileid: "104544618"
---
# <a name="esentdataexception-properties"></a>Свойства Есентдатаексцептион
