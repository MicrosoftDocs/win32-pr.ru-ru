...
---
# <a name="esenttaskdroppedexception-class"></a>Класс Есенттаскдроппедексцептион
      ...
      [Microsoft. ISAM. ESENT. Interop. Есентеррорексцептион](./esenterrorexception-class.md)  
        [Microsoft. ISAM. ESENT. Interop. Есентоператионексцептион](./esentoperationexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентресаурцеексцептион](./esentresourceexception-class.md)  
            Microsoft. ISAM. ESENT. Interop. Есенттаскдроппедексцептион  
...
[Элементы Есенттаскдроппедексцептион](./esenttaskdroppedexception-members.md)
