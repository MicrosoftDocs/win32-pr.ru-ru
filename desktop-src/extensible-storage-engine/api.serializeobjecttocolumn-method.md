...
---
# <a name="apiserializeobjecttocolumn-method"></a>API. Сериализеобжекттоколумн, метод

Запись сериализованной формы объекта в столбец.
...
<!-- end list -->
  ...
  - TableID  
    ...
    Таблица для записи. Необходимо подготовить обновление.
...
<!-- end list -->
  ...
  - columnid  
    ...
    Столбец, в который производится запись.
...
<!-- end list -->
  ...
  - значение  
    ...
    Записываемый объект. Объект должен быть сериализуемым.
