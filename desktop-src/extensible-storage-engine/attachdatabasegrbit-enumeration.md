...
---
# <a name="attachdatabasegrbit-enumeration"></a>Перечисление Аттачдатабасегрбит

Параметры для Жетаттачдатабасе.
...
<tr class="odd">
<td></td>
<td>делетекорруптиндексес</td>
<td>Если параметр JET_paramEnableIndexChecking установлен, все индексы данных в Юникоде будут удалены.</td>
</tr>
</tbody>
</table>
