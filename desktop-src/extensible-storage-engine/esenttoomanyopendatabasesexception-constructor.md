...
---
# <a name="esenttoomanyopendatabasesexception-constructor"></a>Конструктор Есенттуманйопендатабасесексцептион

Инициализирует новый экземпляр класса Есенттуманйопендатабасесексцептион.
...
[Элементы Есенттуманйопендатабасесексцептион](./esenttoomanyopendatabasesexception-members.md)
