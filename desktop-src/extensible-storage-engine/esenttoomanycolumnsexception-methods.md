---
description: 'Дополнительные сведения: методы Есенттуманиколумнсексцептион'
title: 'Методы EsentTooManyColumnsException '
...
ms.locfileid: "103912192"
---
# <a name="esenttoomanycolumnsexception-methods"></a>Методы EsentTooManyColumnsException 
