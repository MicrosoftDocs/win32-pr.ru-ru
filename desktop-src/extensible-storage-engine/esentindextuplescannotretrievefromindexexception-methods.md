---
description: 'Дополнительные сведения: методы Есентиндекступлесканнотретриевефроминдексексцептион'
title: 'Методы EsentIndexTuplesCannotRetrieveFromIndexException '
...
ms.locfileid: "104080831"
---
# <a name="esentindextuplescannotretrievefromindexexception-methods"></a>Методы EsentIndexTuplesCannotRetrieveFromIndexException 
