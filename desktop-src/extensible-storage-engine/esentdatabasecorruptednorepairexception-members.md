---
description: 'Дополнительные сведения о: Есентдатабасекорруптеднорепаирексцептион Members'
title: Элементы Есентдатабасекорруптеднорепаирексцептион
...
ms.locfileid: "119116472"
---
# <a name="esentdatabasecorruptednorepairexception-members"></a>Элементы Есентдатабасекорруптеднорепаирексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасекорруптеднорепаир.

Тип [есентдатабасекорруптеднорепаирексцептион](./esentdatabasecorruptednorepairexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334381(v=exchg.10).md">есентдатабасекорруптеднорепаирексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасекорруптеднорепаирексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасекорруптеднорепаирексцептион](./esentdatabasecorruptednorepairexception-class.md)
