...
ms.locfileid: "120066624"
---
# <a name="esentbuffertoosmallexception-members"></a>Элементы Есентбуффертусмаллексцептион
...
Тип [есентбуффертусмаллексцептион](./esentbuffertoosmallexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274075(v=exchg.10).md">есентбуффертусмаллексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбуффертусмаллексцептион.</td>
</tr>
</tbody>
</table>
