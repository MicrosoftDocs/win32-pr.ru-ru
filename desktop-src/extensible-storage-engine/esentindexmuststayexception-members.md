...
ms.locfileid: "117710267"
---
# <a name="esentindexmuststayexception-members"></a>Элементы Есентиндексмустстайексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Индексмустстай.

Тип [есентиндексмустстайексцептион](./esentindexmuststayexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319394(v=exchg.10).md">есентиндексмустстайексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентиндексмустстайексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентиндексмустстайексцептион](./esentindexmuststayexception-class.md)
