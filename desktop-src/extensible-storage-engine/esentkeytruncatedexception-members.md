---
description: 'Дополнительные сведения о: Есенткэйтрункатедексцептион Members'
title: Элементы Есенткэйтрункатедексцептион
...
ms.locfileid: "104570989"
---
# <a name="esentkeytruncatedexception-members"></a>Элементы Есенткэйтрункатедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Кэйтрункатед.

Тип [есенткэйтрункатедексцептион](./esentkeytruncatedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319619(v=exchg.10).md">есенткэйтрункатедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенткэйтрункатедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенткэйтрункатедексцептион](./esentkeytruncatedexception-class.md)
