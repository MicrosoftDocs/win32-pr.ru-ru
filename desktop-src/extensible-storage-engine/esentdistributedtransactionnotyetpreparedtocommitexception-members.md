...
---
# <a name="esentdistributedtransactionnotyetpreparedtocommitexception-members"></a>Элементы Есентдистрибутедтрансактионнотетпрепаредтокоммитексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дистрибутедтрансактионнотетпрепаредтокоммит.

Тип [есентдистрибутедтрансактионнотетпрепаредтокоммитексцептион](./esentdistributedtransactionnotyetpreparedtocommitexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274298(v=exchg.10).md">есентдистрибутедтрансактионнотетпрепаредтокоммитексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдистрибутедтрансактионнотетпрепаредтокоммитексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдистрибутедтрансактионнотетпрепаредтокоммитексцептион](./esentdistributedtransactionnotyetpreparedtocommitexception-class.md)
