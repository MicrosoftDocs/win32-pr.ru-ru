...
ms.locfileid: "118783290"
---
# <a name="esentcolumnnochunkexception-members"></a>Элементы Есентколумнночункексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнночунк.

Тип [есентколумнночункексцептион](./esentcolumnnochunkexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334283(v=exchg.10).md">есентколумнночункексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнночункексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнночункексцептион](./esentcolumnnochunkexception-class.md)
