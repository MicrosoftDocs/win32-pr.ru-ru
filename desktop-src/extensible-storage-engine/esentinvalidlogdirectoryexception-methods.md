---
description: 'Дополнительные сведения: методы Есентинвалидлогдиректорексцептион'
title: 'Методы EsentInvalidLogDirectoryException '
...
ms.locfileid: "119480944"
---
# <a name="esentinvalidlogdirectoryexception-methods"></a>Методы EsentInvalidLogDirectoryException 
