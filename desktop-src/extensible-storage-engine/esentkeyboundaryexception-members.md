...
---
# <a name="esentkeyboundaryexception-members"></a>Элементы Есенткэйбаундарексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Кэйбаундари.

Тип [есенткэйбаундарексцептион](./esentkeyboundaryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334535(v=exchg.10).md">есенткэйбаундарексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенткэйбаундарексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенткэйбаундарексцептион](./esentkeyboundaryexception-class.md)
