---
description: 'Дополнительные сведения о: конструктор Есентинвалиддатабасеидексцептион'
title: Конструктор Есентинвалиддатабасеидексцептион
...
ms.locfileid: "105713184"
---
# <a name="esentinvaliddatabaseidexception-constructor"></a>Конструктор Есентинвалиддатабасеидексцептион

Инициализирует новый экземпляр класса Есентинвалиддатабасеидексцептион.
...
[Элементы Есентинвалиддатабасеидексцептион](./esentinvaliddatabaseidexception-members.md)
