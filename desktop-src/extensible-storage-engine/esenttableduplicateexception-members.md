...
ms.locfileid: "120064194"
---
# <a name="esenttableduplicateexception-members"></a>Элементы Есенттабледупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Табледупликате.

Тип [есенттабледупликатиксцептион](./esenttableduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334949(v=exchg.10).md">есенттабледупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттабледупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттабледупликатиксцептион](./esenttableduplicateexception-class.md)
