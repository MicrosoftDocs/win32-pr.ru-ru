...
ms.locfileid: "118254687"
---
# <a name="jet_enumcolumntostring-method"></a>JET_ENUMCOLUMN. Метод ToString

Возвращает [строку](/dotnet/api/system.string) , представляющую текущий [JET_ENUMCOLUMN](./jet-enumcolumn-class.md).
...
[Строка](/dotnet/api/system.string) , представляющая текущий [JET_ENUMCOLUMN](./jet-enumcolumn-class.md).  
