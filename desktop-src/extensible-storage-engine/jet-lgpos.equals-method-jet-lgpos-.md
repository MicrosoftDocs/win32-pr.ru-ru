---
description: 'Дополнительные сведения о: JET_LGPOS. Метод Equals (JET_LGPOS)'
title: JET_LGPOS. Метод Equals (JET_LGPOS)
...
[Перегрузка Equals](./jet-lgpos.equals-method.md)
