---
description: 'Дополнительные сведения о: конструктор Есентслвпажесноткоммиттедексцептион'
title: Конструктор Есентслвпажесноткоммиттедексцептион
...
ms.locfileid: "104264955"
---
# <a name="esentslvpagesnotcommittedexception-constructor"></a>Конструктор Есентслвпажесноткоммиттедексцептион
