...
ms.locfileid: "118080505"
---
# <a name="esentlogtornwriteduringhardrecoveryexception-members"></a>Элементы Есентлогторнвритедурингхардрековерексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логторнвритедурингхардрековери.

Тип [есентлогторнвритедурингхардрековерексцептион](./esentlogtornwriteduringhardrecoveryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334659(v=exchg.10).md">есентлогторнвритедурингхардрековерексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогторнвритедурингхардрековерексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогторнвритедурингхардрековерексцептион](./esentlogtornwriteduringhardrecoveryexception-class.md)
