---
description: 'Дополнительные сведения: методы Есентиндексдупликатиксцептион'
title: 'Методы EsentIndexDuplicateException '
...
ms.locfileid: "104569079"
---
# <a name="esentindexduplicateexception-methods"></a>Методы EsentIndexDuplicateException 
