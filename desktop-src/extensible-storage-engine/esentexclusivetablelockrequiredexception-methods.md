---
description: 'Дополнительные сведения: методы Есентексклусиветаблелоккрекуиредексцептион'
title: 'Методы EsentExclusiveTableLockRequiredException '
...
ms.locfileid: "104424030"
---
# <a name="esentexclusivetablelockrequiredexception-methods"></a>Методы EsentExclusiveTableLockRequiredException 
