...
---
# <a name="esenttoomanysplitsexception-members"></a>Элементы Есенттуманисплитсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманисплитс.

Тип [есенттуманисплитсексцептион](./esenttoomanysplitsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350797(v=exchg.10).md">есенттуманисплитсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманисплитсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманисплитсексцептион](./esenttoomanysplitsexception-class.md)
