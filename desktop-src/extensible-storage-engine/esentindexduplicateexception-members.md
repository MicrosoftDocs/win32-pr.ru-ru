...
---
# <a name="esentindexduplicateexception-members"></a>Элементы Есентиндексдупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Индексдупликате.

Тип [есентиндексдупликатиксцептион](./esentindexduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350504(v=exchg.10).md">есентиндексдупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентиндексдупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентиндексдупликатиксцептион](./esentindexduplicateexception-class.md)
