---
description: 'Дополнительные сведения о: Есентбаккупабортбисерверексцептион Members'
title: Элементы Есентбаккупабортбисерверексцептион
...
ms.locfileid: "119117444"
---
# <a name="esentbackupabortbyserverexception-members"></a>Элементы Есентбаккупабортбисерверексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Баккупабортбисервер.

Тип [есентбаккупабортбисерверексцептион](./esentbackupabortbyserverexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274016(v=exchg.10).md">есентбаккупабортбисерверексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбаккупабортбисерверексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбаккупабортбисерверексцептион](./esentbackupabortbyserverexception-class.md)
