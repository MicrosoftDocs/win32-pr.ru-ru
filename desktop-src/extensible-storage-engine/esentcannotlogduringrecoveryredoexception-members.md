...
---
# <a name="esentcannotlogduringrecoveryredoexception-members"></a>Элементы Есентканнотлогдурингрековериредоексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотлогдурингрековериредо.

Тип [есентканнотлогдурингрековериредоексцептион](./esentcannotlogduringrecoveryredoexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274168(v=exchg.10).md">есентканнотлогдурингрековериредоексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотлогдурингрековериредоексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотлогдурингрековериредоексцептион](./esentcannotlogduringrecoveryredoexception-class.md)
