...
ms.locfileid: "119234190"
---
# <a name="esenttablelockedexception-members"></a>Элементы Есенттаблелоккедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Таблелоккед.

Тип [есенттаблелоккедексцептион](./esenttablelockedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334910(v=exchg.10).md">есенттаблелоккедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттаблелоккедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттаблелоккедексцептион](./esenttablelockedexception-class.md)
