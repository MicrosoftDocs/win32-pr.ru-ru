...
---
# <a name="esenttoomanykeysexception-members"></a>Элементы Есенттуманикэйсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманикэйс.

Тип [есенттуманикэйсексцептион](./esenttoomanykeysexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335002(v=exchg.10).md">есенттуманикэйсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманикэйсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманикэйсексцептион](./esenttoomanykeysexception-class.md)
