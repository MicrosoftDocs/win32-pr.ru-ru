---
description: 'Дополнительные сведения о: Есентсофтрековерйонснапшотексцептион Members'
title: Элементы Есентсофтрековерйонснапшотексцептион
...
ms.locfileid: "118259503"
---
# <a name="esentsoftrecoveryonsnapshotexception-members"></a>Элементы Есентсофтрековерйонснапшотексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Софтрековерйонснапшот.

Тип [есентсофтрековерйонснапшотексцептион](./esentsoftrecoveryonsnapshotexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334795(v=exchg.10).md">есентсофтрековерйонснапшотексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсофтрековерйонснапшотексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсофтрековерйонснапшотексцептион](./esentsoftrecoveryonsnapshotexception-class.md)
