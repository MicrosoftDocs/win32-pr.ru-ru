---
description: 'Дополнительные сведения о: Есентмултивалуеддупликатеафтертрункатионексцептион Members'
title: Элементы Есентмултивалуеддупликатеафтертрункатионексцептион
...
ms.locfileid: "119479254"
---
# <a name="esentmultivaluedduplicateaftertruncationexception-members"></a>Элементы Есентмултивалуеддупликатеафтертрункатионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Мултивалуеддупликатеафтертрункатион.

Тип [есентмултивалуеддупликатеафтертрункатионексцептион](./esentmultivaluedduplicateaftertruncationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334702(v=exchg.10).md">есентмултивалуеддупликатеафтертрункатионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмултивалуеддупликатеафтертрункатионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентмултивалуеддупликатеафтертрункатионексцептион](./esentmultivaluedduplicateaftertruncationexception-class.md)
