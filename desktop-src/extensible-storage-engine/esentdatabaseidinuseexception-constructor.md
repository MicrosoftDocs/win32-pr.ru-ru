---
description: 'Дополнительные сведения о: конструктор Есентдатабасеидинусиксцептион'
title: Конструктор Есентдатабасеидинусиксцептион
...
ms.locfileid: "120117334"
---
# <a name="esentdatabaseidinuseexception-constructor"></a>Конструктор Есентдатабасеидинусиксцептион

Инициализирует новый экземпляр класса Есентдатабасеидинусиксцептион.
...
[Элементы Есентдатабасеидинусиксцептион](./esentdatabaseidinuseexception-members.md)
