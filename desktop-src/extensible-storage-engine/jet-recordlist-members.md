---
description: 'Дополнительные сведения о: JET_RECORDLIST Members'
title: Элементы JET_RECORDLIST
...
ms.locfileid: "119107623"
---
# <a name="jet_recordlist-members"></a>Элементы JET_RECORDLIST

Включить защищенные члены  
Включить унаследованные члены  

Сведения о временной таблице, содержащей сведения обо всех индексах для данной таблицы.

Тип [JET_RECORDLIST](./jet-recordlist-class.md) предоставляет следующие члены.
...
<td><a href="dn335244(v=exchg.10).md">колумнидбукмарк</a></td>
<td>Возвращает значение columnid столбца во временной таблице, в котором хранится закладка записи. Столбец имеет тип JET_coltyp. Полнотекстовым.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335252(v=exchg.10).md">крекордс</a></td>
...
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущий <a href="dn335123(v=exchg.10).md">JET_INDEXLIST</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
