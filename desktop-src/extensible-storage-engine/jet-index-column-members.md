---
description: 'Дополнительные сведения о: JET_INDEX_COLUMN Members'
title: Элементы JET_INDEX_COLUMN (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "104554619"
---
# <a name="jet_index_column-members"></a>Элементы JET_INDEX_COLUMN

Включить защищенные члены  
Включить унаследованные члены  

Содержит определение фильтра для [жетпререадиндексранжес (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , пререадиндексранжесгрбит)](./windows8api.jetprereadindexranges-method.md) и [жетсеткурсорфилтер (JET_SESID, JET_TABLEID, \[ \] , курсорфилтергрбит)](./windows8api.jetsetcursorfilter-method.md).

Тип [JET_INDEX_COLUMN](./jet-index-column-class.md) предоставляет следующие члены.
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335357(v=exchg.10).md">грбит</a></td>
<td>Возвращает или задает параметр для этого сравнения столбцов.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335479(v=exchg.10).md">пвдата</a></td>
<td>Возвращает или задает значение, компарте столбец.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335358(v=exchg.10).md">RelOp</a></td>
<td>Возвращает или задает операцию сравнения фильтра.</td>
</tr>
</tbody>
</table>
...
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущий <a href="dn335349(v=exchg.10).md">JET_INDEX_COLUMN</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
...
[Класс JET_INDEX_COLUMN](./jet-index-column-class.md)
