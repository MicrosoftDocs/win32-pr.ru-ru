...
ms.locfileid: "118260475"
---
# <a name="esentsesidtableidmismatchexception-members"></a>Элементы Есентсесидтаблеидмисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Сесидтаблеидмисматч.

Тип [есентсесидтаблеидмисматчексцептион](./esentsesidtableidmismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350623(v=exchg.10).md">есентсесидтаблеидмисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсесидтаблеидмисматчексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсесидтаблеидмисматчексцептион](./esentsesidtableidmismatchexception-class.md)
