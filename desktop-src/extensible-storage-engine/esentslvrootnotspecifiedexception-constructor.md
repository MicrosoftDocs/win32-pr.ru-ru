---
description: 'Дополнительные сведения о: конструктор ЕсентслврутнотспеЦифиедексцептион'
title: Конструктор ЕсентслврутнотспеЦифиедексцептион
...
ms.locfileid: "103913327"
---
# <a name="esentslvrootnotspecifiedexception-constructor"></a>Конструктор ЕсентслврутнотспеЦифиедексцептион
...
[Элементы ЕсентслврутнотспеЦифиедексцептион](./esentslvrootnotspecifiedexception-members.md)
