...
---
# <a name="esentfileioabortexception-members"></a>Элементы Есентфилеиоабортексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Филеиоаборт.

Тип [есентфилеиоабортексцептион](./esentfileioabortexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274351(v=exchg.10).md">есентфилеиоабортексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфилеиоабортексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфилеиоабортексцептион](./esentfileioabortexception-class.md)
