...
ms.locfileid: "119836704"
---
# <a name="esentlogfilenotcopiedexception-constructor"></a>Конструктор Есентлогфиленоткопиедексцептион

Инициализирует новый экземпляр класса Есентлогфиленоткопиедексцептион.
...
[Элементы Есентлогфиленоткопиедексцептион](./esentlogfilenotcopiedexception-members.md)
