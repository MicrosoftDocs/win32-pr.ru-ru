---
description: 'Дополнительные сведения: методы Есентиндекступлеснонуникуеонлексцептион'
title: 'Методы EsentIndexTuplesNonUniqueOnlyException '
...
ms.locfileid: "118495177"
---
# <a name="esentindextuplesnonuniqueonlyexception-methods"></a>Методы EsentIndexTuplesNonUniqueOnlyException 
