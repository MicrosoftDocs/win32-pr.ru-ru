---
description: 'Дополнительные сведения о: Есентддлнотинхеритабликсцептион Members'
title: Элементы Есентддлнотинхеритабликсцептион
...
ms.locfileid: "104263749"
---
# <a name="esentddlnotinheritableexception-members"></a>Элементы Есентддлнотинхеритабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Ддлнотинхеритабле.

Тип [есентддлнотинхеритабликсцептион](./esentddlnotinheritableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334422(v=exchg.10).md">есентддлнотинхеритабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентддлнотинхеритабликсцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентддлнотинхеритабликсцептион](./esentddlnotinheritableexception-class.md)
