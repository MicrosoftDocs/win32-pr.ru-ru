---
description: 'Дополнительные сведения: методы Есенткоммиттедлогфилекорруптексцептион'
title: 'Методы EsentCommittedLogFileCorruptException '
...
ms.locfileid: "104562863"
---
# <a name="esentcommittedlogfilecorruptexception-methods"></a>Методы EsentCommittedLogFileCorruptException 
