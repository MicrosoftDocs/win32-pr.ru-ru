...
---
# <a name="esentcannotmaterializeforwardonlysortexception-members"></a>Элементы Есентканнотматериализефорвардонлисортексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотматериализефорвардонлисорт.

Тип [есентканнотматериализефорвардонлисортексцептион](./esentcannotmaterializeforwardonlysortexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274108(v=exchg.10).md">есентканнотматериализефорвардонлисортексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотматериализефорвардонлисортексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотматериализефорвардонлисортексцептион](./esentcannotmaterializeforwardonlysortexception-class.md)
