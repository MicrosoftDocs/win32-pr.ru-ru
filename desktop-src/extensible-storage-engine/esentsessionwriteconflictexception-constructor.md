...
ms.locfileid: "119039952"
---
# <a name="esentsessionwriteconflictexception-constructor"></a>Конструктор Есентсессионвритеконфликтексцептион

Инициализирует новый экземпляр класса Есентсессионвритеконфликтексцептион.
