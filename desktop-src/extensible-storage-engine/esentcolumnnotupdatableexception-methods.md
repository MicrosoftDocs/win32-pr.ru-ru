---
description: 'Дополнительные сведения: методы Есентколумннотупдатабликсцептион'
title: 'Методы EsentColumnNotUpdatableException '
...
ms.locfileid: "104072619"
---
# <a name="esentcolumnnotupdatableexception-methods"></a>Методы EsentColumnNotUpdatableException 
