---
description: 'Дополнительные сведения о: Есентпартиалляттачеддбексцептион свойства'
title: Свойства Есентпартиалляттачеддбексцептион
...
ms.locfileid: "103913340"
---
# <a name="esentpartiallyattacheddbexception-properties"></a>Свойства Есентпартиалляттачеддбексцептион
