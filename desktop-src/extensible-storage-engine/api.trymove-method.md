...
---
# <a name="apitrymove-method"></a>API. Тримове, метод

Попробуйте выполнить навигацию по индексу. Если переход выполнен, этот метод возвращает значение true. Если нет записи для перехода к этому методу, возвращает значение false; исключение будет создано для других ошибок.
