---
description: 'Дополнительные сведения: методы Даублеколумнвалуе'
title: Методы Даублеколумнвалуе
...
ms.locfileid: "104543423"
---
# <a name="doublecolumnvalue-methods"></a>Методы Даублеколумнвалуе
