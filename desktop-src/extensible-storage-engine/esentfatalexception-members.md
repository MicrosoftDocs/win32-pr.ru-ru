---
description: 'Дополнительные сведения о: Есентфаталексцептион Members'
title: Элементы Есентфаталексцептион
...
ms.locfileid: "118269763"
---
# <a name="esentfatalexception-members"></a>Элементы Есентфаталексцептион
...
Тип [есентфаталексцептион](./esentfatalexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334502(v=exchg.10).md">Есентфаталексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентфаталексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn274274(v=exchg.10).md">Есентфаталексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентфаталексцептион.</td>
</tr>
</tbody>
</table>
