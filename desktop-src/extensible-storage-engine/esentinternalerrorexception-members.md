...
ms.locfileid: "119838004"
---
# <a name="esentinternalerrorexception-members"></a>Элементы Есентинтерналеррорексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Интерналеррор.

Тип [есентинтерналеррорексцептион](./esentinternalerrorexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319455(v=exchg.10).md">есентинтерналеррорексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинтерналеррорексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинтерналеррорексцептион](./esentinternalerrorexception-class.md)
