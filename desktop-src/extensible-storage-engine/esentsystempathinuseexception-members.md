---
description: 'Дополнительные сведения о: Есентсистемпасинусиксцептион Members'
title: Элементы Есентсистемпасинусиксцептион
...
ms.locfileid: "119604724"
---
# <a name="esentsystempathinuseexception-members"></a>Элементы Есентсистемпасинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err.Sysисключений Темпасинусе.

Тип [есентсистемпасинусиксцептион](./esentsystempathinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334894(v=exchg.10).md">есентсистемпасинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсистемпасинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсистемпасинусиксцептион](./esentsystempathinuseexception-class.md)
