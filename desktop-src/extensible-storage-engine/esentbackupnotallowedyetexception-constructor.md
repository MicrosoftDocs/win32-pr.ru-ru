---
description: 'Дополнительные сведения о: конструктор Есентбаккупноталловедетексцептион'
title: Конструктор Есентбаккупноталловедетексцептион
...
ms.locfileid: "104081426"
---
# <a name="esentbackupnotallowedyetexception-constructor"></a>Конструктор Есентбаккупноталловедетексцептион

Инициализирует новый экземпляр класса Есентбаккупноталловедетексцептион.
...
[Элементы Есентбаккупноталловедетексцептион](./esentbackupnotallowedyetexception-members.md)
