...
ms.locfileid: "118982357"
---
# <a name="esentinvalidfilenameexception-members"></a>Элементы Есентинвалидфиленамиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидфиленаме.

Тип [есентинвалидфиленамиксцептион](./esentinvalidfilenameexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319519(v=exchg.10).md">есентинвалидфиленамиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидфиленамиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидфиленамиксцептион](./esentinvalidfilenameexception-class.md)
