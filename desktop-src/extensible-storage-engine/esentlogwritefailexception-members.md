---
description: 'Дополнительные сведения о: Есентлогвритефаилексцептион Members'
title: Элементы Есентлогвритефаилексцептион
...
ms.locfileid: "104554193"
---
# <a name="esentlogwritefailexception-members"></a>Элементы Есентлогвритефаилексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логвритефаил.

Тип [есентлогвритефаилексцептион](./esentlogwritefailexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334667(v=exchg.10).md">есентлогвритефаилексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогвритефаилексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогвритефаилексцептион](./esentlogwritefailexception-class.md)
