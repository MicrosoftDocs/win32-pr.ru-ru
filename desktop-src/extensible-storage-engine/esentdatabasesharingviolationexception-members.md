...
---
# <a name="esentdatabasesharingviolationexception-members"></a>Элементы Есентдатабасешарингвиолатионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасешарингвиолатион.

Тип [есентдатабасешарингвиолатионексцептион](./esentdatabasesharingviolationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334373(v=exchg.10).md">есентдатабасешарингвиолатионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасешарингвиолатионексцептион.</td>
</tr>
</tbody>
</table>
