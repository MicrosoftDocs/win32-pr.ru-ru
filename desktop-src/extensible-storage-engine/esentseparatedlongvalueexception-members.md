...
ms.locfileid: "119947030"
---
# <a name="esentseparatedlongvalueexception-members"></a>Элементы Есентсепаратедлонгвалуиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Сепаратедлонгвалуе.
...
<td><a href="dn350617(v=exchg.10).md">есентсепаратедлонгвалуиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсепаратедлонгвалуиксцептион.</td>
</tr>
</tbody>
</table>
