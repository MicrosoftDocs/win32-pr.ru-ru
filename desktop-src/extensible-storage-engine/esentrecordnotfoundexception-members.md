---
description: 'Дополнительные сведения о: Есентрекорднотфаундексцептион Members'
title: Элементы Есентрекорднотфаундексцептион
...
Тип [есентрекорднотфаундексцептион](./esentrecordnotfoundexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319849(v=exchg.10).md">есентрекорднотфаундексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрекорднотфаундексцептион.</td>
</tr>
</tbody>
</table>
