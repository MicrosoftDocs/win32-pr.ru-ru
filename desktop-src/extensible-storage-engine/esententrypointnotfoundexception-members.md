---
description: 'Дополнительные сведения о: Есентентрипоинтнотфаундексцептион Members'
title: Элементы Есентентрипоинтнотфаундексцептион
...
ms.locfileid: "118498329"
---
# <a name="esententrypointnotfoundexception-members"></a>Элементы Есентентрипоинтнотфаундексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Ентрипоинтнотфаунд.

Тип [есентентрипоинтнотфаундексцептион](./esententrypointnotfoundexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274311(v=exchg.10).md">есентентрипоинтнотфаундексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентентрипоинтнотфаундексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентентрипоинтнотфаундексцептион](./esententrypointnotfoundexception-class.md)
