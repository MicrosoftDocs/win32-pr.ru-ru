...
ms.locfileid: "119971234"
---
# <a name="esentrecordnocopyexception-members"></a>Элементы Есентрекорднокопексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рекорднокопи.

Тип [есентрекорднокопексцептион](./esentrecordnocopyexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319836(v=exchg.10).md">есентрекорднокопексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрекорднокопексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрекорднокопексцептион](./esentrecordnocopyexception-class.md)
