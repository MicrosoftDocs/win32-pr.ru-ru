...
Базовый класс для JET_err. Исключения Бадчеккпоинтсигнатуре.

Тип [есентбадчеккпоинтсигнатуриксцептион](./esentbadcheckpointsignatureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273998(v=exchg.10).md">есентбадчеккпоинтсигнатуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадчеккпоинтсигнатуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадчеккпоинтсигнатуриксцептион](./esentbadcheckpointsignatureexception-class.md)
