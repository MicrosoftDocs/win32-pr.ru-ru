...
ms.locfileid: "117900510"
---
# <a name="esentlogfilepathinuseexception-members"></a>Элементы Есентлогфилепасинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логфилепасинусе.

Тип [есентлогфилепасинусиксцептион](./esentlogfilepathinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334628(v=exchg.10).md">есентлогфилепасинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогфилепасинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогфилепасинусиксцептион](./esentlogfilepathinuseexception-class.md)
