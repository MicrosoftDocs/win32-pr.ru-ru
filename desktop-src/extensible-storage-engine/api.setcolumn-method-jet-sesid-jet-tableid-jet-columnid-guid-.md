...
ms.locfileid: "117717595"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-guid"></a>Метод API. Сетколумн (JET_SESID, JET_TABLEID, JET_COLUMNID, GUID)
