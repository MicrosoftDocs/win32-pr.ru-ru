---
description: 'Дополнительные сведения: методы Есентлогкорруптдурингхардресториксцептион'
title: 'Методы EsentLogCorruptDuringHardRestoreException '
...
ms.locfileid: "104557313"
---
# <a name="esentlogcorruptduringhardrestoreexception-methods"></a>Методы EsentLogCorruptDuringHardRestoreException 
