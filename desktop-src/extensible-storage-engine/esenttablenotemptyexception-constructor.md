---
description: 'Дополнительные сведения о: конструктор Есенттабленотемптексцептион'
title: Конструктор Есенттабленотемптексцептион
...
ms.locfileid: "104264590"
---
# <a name="esenttablenotemptyexception-constructor"></a>Конструктор Есенттабленотемптексцептион

Инициализирует новый экземпляр класса Есенттабленотемптексцептион.
...
[Элементы Есенттабленотемптексцептион](./esenttablenotemptyexception-members.md)
