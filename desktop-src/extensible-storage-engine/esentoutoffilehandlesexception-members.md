---
description: 'Дополнительные сведения о: Есентаутоффилехандлесексцептион Members'
title: Элементы Есентаутоффилехандлесексцептион
...
ms.locfileid: "118492733"
---
# <a name="esentoutoffilehandlesexception-members"></a>Элементы Есентаутоффилехандлесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аутоффилехандлес.

Тип [есентаутоффилехандлесексцептион](./esentoutoffilehandlesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319735(v=exchg.10).md">есентаутоффилехандлесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутоффилехандлесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутоффилехандлесексцептион](./esentoutoffilehandlesexception-class.md)
