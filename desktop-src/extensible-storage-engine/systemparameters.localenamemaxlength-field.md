---
description: 'Дополнительные сведения о: SystemParameters. Локаленамемаксленгс поле'
title: SystemParameters. Локаленамемаксленгс, поле
...
ms.locfileid: "119107027"
---
# <a name="systemparameterslocalenamemaxlength-field"></a>SystemParameters. Локаленамемаксленгс, поле

Максимальная длина имени локали (LOCALE_NAME_MAX_LENGTH из Winnt. h).
