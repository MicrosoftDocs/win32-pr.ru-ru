---
description: 'Дополнительные сведения о: Есентаутофсреадсексцептион Members'
title: Элементы Есентаутофсреадсексцептион
...
ms.locfileid: "119782944"
---
# <a name="esentoutofthreadsexception-members"></a>Элементы Есентаутофсреадсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аутофсреадс.

Тип [есентаутофсреадсексцептион](./esentoutofthreadsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319813(v=exchg.10).md">есентаутофсреадсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутофсреадсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутофсреадсексцептион](./esentoutofthreadsexception-class.md)
