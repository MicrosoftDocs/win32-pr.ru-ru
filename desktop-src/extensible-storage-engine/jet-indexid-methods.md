---
description: 'Дополнительные сведения: JET_INDEXID методы'
title: Методы JET_INDEXID
...
ms.locfileid: "104350455"
---
# <a name="jet_indexid-methods"></a>Методы JET_INDEXID

Включить защищенные члены  
Включить унаследованные члены  

Тип [JET_INDEXID](./jet-indexid-structure2.md) предоставляет следующие члены.
