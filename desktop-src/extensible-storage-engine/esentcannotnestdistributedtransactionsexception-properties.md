---
description: 'Дополнительные сведения о: Есентканнотнестдистрибутедтрансактионсексцептион свойства'
title: Свойства Есентканнотнестдистрибутедтрансактионсексцептион
...
ms.locfileid: "118782991"
---
# <a name="esentcannotnestdistributedtransactionsexception-properties"></a>Свойства Есентканнотнестдистрибутедтрансактионсексцептион
