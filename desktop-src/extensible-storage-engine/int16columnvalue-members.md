---
description: 'Дополнительные сведения о: Int16ColumnValue Members'
title: Элементы Int16ColumnValue
...
ms.locfileid: "104553084"
---
# <a name="int16columnvalue-members"></a>Элементы Int16ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [Int16](/dotnet/api/system.int16) .

Тип [Int16ColumnValue](./int16columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn351012(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351015(v=exchg.10).md">жетвалуефромбитес</a></td>
