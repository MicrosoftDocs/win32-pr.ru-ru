---
description: 'Дополнительные сведения о: конструктор Есентроллбаккрекуиредексцептион'
title: Конструктор Есентроллбаккрекуиредексцептион
...
ms.locfileid: "120116994"
---
# <a name="esentrollbackrequiredexception-constructor"></a>Конструктор Есентроллбаккрекуиредексцептион

Инициализирует новый экземпляр класса Есентроллбаккрекуиредексцептион.
...
[Элементы Есентроллбаккрекуиредексцептион](./esentrollbackrequiredexception-members.md)
