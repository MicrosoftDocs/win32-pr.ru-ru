---
description: 'Дополнительные сведения о: Есентскллинкнотсуппортедексцептион Members'
title: Элементы Есентскллинкнотсуппортедексцептион
...
ms.locfileid: "120018604"
---
# <a name="esentsqllinknotsupportedexception-members"></a>Элементы Есентскллинкнотсуппортедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Скллинкнотсуппортед.

Тип [есентскллинкнотсуппортедексцептион](./esentsqllinknotsupportedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334856(v=exchg.10).md">есентскллинкнотсуппортедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентскллинкнотсуппортедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентскллинкнотсуппортедексцептион](./esentsqllinknotsupportedexception-class.md)
