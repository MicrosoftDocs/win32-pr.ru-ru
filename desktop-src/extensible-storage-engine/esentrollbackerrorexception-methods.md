---
description: 'Дополнительные сведения: методы Есентроллбаккеррорексцептион'
title: 'Методы EsentRollbackErrorException '
...
ms.locfileid: "120018504"
---
# <a name="esentrollbackerrorexception-methods"></a>Методы EsentRollbackErrorException 
