---
description: 'Дополнительные сведения: JET_RSTINFO методы'
title: Методы JET_RSTINFO
...
ms.locfileid: "103990988"
---
# <a name="jet_rstinfo-methods"></a>Методы JET_RSTINFO

Включить защищенные члены  
Включить унаследованные члены  

Тип [JET_RSTINFO](./jet-rstinfo-class.md) предоставляет следующие члены.
...
<td><a href="dn351041(v=exchg.10).md">контентекуалс</a></td>
<td>Возвращает значение, указывающее, равен ли данный экземпляр другому экземпляру.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn351042(v=exchg.10).md">дипклоне</a></td>
...
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущий <a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
