...
---
# <a name="esentrecordprimarychangedexception-members"></a>Элементы Есентрекордпримаричанжедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рекордпримаричанжед.

Тип [есентрекордпримаричанжедексцептион](./esentrecordprimarychangedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350516(v=exchg.10).md">есентрекордпримаричанжедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрекордпримаричанжедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрекордпримаричанжедексцептион](./esentrecordprimarychangedexception-class.md)
