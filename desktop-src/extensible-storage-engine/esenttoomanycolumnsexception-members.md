---
description: 'Дополнительные сведения о: Есенттуманиколумнсексцептион Members'
title: Элементы Есенттуманиколумнсексцептион
...
ms.locfileid: "119363204"
---
# <a name="esenttoomanycolumnsexception-members"></a>Элементы Есенттуманиколумнсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманиколумнс.

Тип [есенттуманиколумнсексцептион](./esenttoomanycolumnsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334982(v=exchg.10).md">есенттуманиколумнсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманиколумнсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманиколумнсексцептион](./esenttoomanycolumnsexception-class.md)
