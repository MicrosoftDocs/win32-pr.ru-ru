...
ms.locfileid: "119837634"
---
# <a name="esentinvalidcodepageexception-members"></a>Элементы Есентинвалидкодепажеексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидкодепаже.

Тип [есентинвалидкодепажеексцептион](./esentinvalidcodepageexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319447(v=exchg.10).md">есентинвалидкодепажеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидкодепажеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидкодепажеексцептион](./esentinvalidcodepageexception-class.md)
