---
description: 'Дополнительные сведения о: Есентиоексцептион Members'
title: Элементы Есентиоексцептион
...
ms.locfileid: "103912715"
---
# <a name="esentioexception-members"></a>Элементы Есентиоексцептион
...
Тип [есентиоексцептион](./esentioexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319598(v=exchg.10).md">Есентиоексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентиоексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn319596(v=exchg.10).md">Есентиоексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентиоексцептион.</td>
</tr>
</tbody>
</table>
