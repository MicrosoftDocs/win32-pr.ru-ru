...
---
# <a name="esentdatabaseinvalidpathexception-members"></a>Элементы Есентдатабасеинвалидпасексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеинвалидпас.

Тип [есентдатабасеинвалидпасексцептион](./esentdatabaseinvalidpathexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334459(v=exchg.10).md">есентдатабасеинвалидпасексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеинвалидпасексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеинвалидпасексцептион](./esentdatabaseinvalidpathexception-class.md)
