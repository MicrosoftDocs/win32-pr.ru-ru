---
description: 'Дополнительные сведения о: Есенттагжеднотнуллексцептион Members'
title: Элементы Есенттагжеднотнуллексцептион
...
ms.locfileid: "104565916"
---
# <a name="esenttaggednotnullexception-members"></a>Элементы Есенттагжеднотнуллексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Тагжеднотнулл.

Тип [есенттагжеднотнуллексцептион](./esenttaggednotnullexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334956(v=exchg.10).md">есенттагжеднотнуллексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттагжеднотнуллексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттагжеднотнуллексцептион](./esenttaggednotnullexception-class.md)
