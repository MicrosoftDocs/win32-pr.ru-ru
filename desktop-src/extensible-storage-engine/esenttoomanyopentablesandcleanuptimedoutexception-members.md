---
description: 'Дополнительные сведения о: Есенттуманйопентаблесандклеануптимедаутексцептион Members'
title: Элементы Есенттуманйопентаблесандклеануптимедаутексцептион
...
ms.locfileid: "104265873"
---
# <a name="esenttoomanyopentablesandcleanuptimedoutexception-members"></a>Элементы Есенттуманйопентаблесандклеануптимедаутексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманйопентаблесандклеануптимедаут.

Тип [есенттуманйопентаблесандклеануптимедаутексцептион](./esenttoomanyopentablesandcleanuptimedoutexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350788(v=exchg.10).md">есенттуманйопентаблесандклеануптимедаутексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманйопентаблесандклеануптимедаутексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманйопентаблесандклеануптимедаутексцептион](./esenttoomanyopentablesandcleanuptimedoutexception-class.md)
