---
description: 'Дополнительные сведения о свойстве: JET_INDEX_COLUMN. columnid'
title: Свойство JET_INDEX_COLUMN. columnid (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119039132"
---
# <a name="jet_index_columncolumnid-property"></a>Свойство JET_INDEX_COLUMN. columnid

Возвращает или задает идентификатор столбца для извлекаемого столбца.
