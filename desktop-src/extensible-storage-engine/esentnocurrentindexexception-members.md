...
---
# <a name="esentnocurrentindexexception-members"></a>Элементы Есентнокуррентиндексексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Нокуррентиндекс.

Тип [есентнокуррентиндексексцептион](./esentnocurrentindexexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334727(v=exchg.10).md">есентнокуррентиндексексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнокуррентиндексексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнокуррентиндексексцептион](./esentnocurrentindexexception-class.md)
