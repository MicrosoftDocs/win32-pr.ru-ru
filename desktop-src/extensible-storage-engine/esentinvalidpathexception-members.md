...
---
# <a name="esentinvalidpathexception-members"></a>Элементы Есентинвалидпасексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидпас.

Тип [есентинвалидпасексцептион](./esentinvalidpathexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319620(v=exchg.10).md">есентинвалидпасексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидпасексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидпасексцептион](./esentinvalidpathexception-class.md)
