...
---
# <a name="apijetdupsession-method"></a>API. Жетдупсессион, метод

Инициализируйте новый сеанс ESE в том же экземпляре, что и заданный сесид.
