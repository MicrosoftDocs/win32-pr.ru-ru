...
---
# <a name="esentbadlogsignatureexception-members"></a>Элементы Есентбадлогсигнатуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Бадлогсигнатуре.

Тип [есентбадлогсигнатуриксцептион](./esentbadlogsignatureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274073(v=exchg.10).md">есентбадлогсигнатуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадлогсигнатуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадлогсигнатуриксцептион](./esentbadlogsignatureexception-class.md)
