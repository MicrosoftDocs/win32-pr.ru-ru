...
Возвращает или задает относительный или абсолютный путь к файловой системе папки, в которой восстановление после сбоя или операция восстановления могут найти базы данных, на которые имеются ссылки в журнале транзакций в указанной папке.
