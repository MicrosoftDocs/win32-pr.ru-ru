---
description: 'Дополнительные сведения о: конструктор Есентдатабаседиртишутдовнексцептион'
title: Конструктор Есентдатабаседиртишутдовнексцептион
...
ms.locfileid: "105701623"
---
# <a name="esentdatabasedirtyshutdownexception-constructor"></a>Конструктор Есентдатабаседиртишутдовнексцептион

Инициализирует новый экземпляр класса Есентдатабаседиртишутдовнексцептион.
...
[Элементы Есентдатабаседиртишутдовнексцептион](./esentdatabasedirtyshutdownexception-members.md)
