---
description: 'Дополнительные сведения: JET_SPACEHINTS методы'
title: Методы JET_SPACEHINTS
...
ms.locfileid: "119729534"
---
# <a name="jet_spacehints-methods"></a>Методы JET_SPACEHINTS

Включить защищенные члены  
Включить унаследованные члены  

Тип [JET_SPACEHINTS](./jet-spacehints-class.md) предоставляет следующие члены.
...
<td><a href="dn351097(v=exchg.10).md">контентекуалс</a></td>
<td>Возвращает значение, указывающее, равен ли данный экземпляр другому экземпляру.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn351100(v=exchg.10).md">дипклоне</a></td>
