---
description: 'Дополнительные сведения о свойстве: JET_TABLECREATE. Улпажес'
title: Свойство JET_TABLECREATE. Улпажес
...
ms.locfileid: "103808458"
---
# <a name="jet_tablecreateulpages-property"></a>Свойство JET_TABLECREATE. Улпажес

Возвращает или задает начальные страницы, выделяемые для таблицы.
