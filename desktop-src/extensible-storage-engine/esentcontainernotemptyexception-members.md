---
description: 'Дополнительные сведения о: Есентконтаинернотемптексцептион Members'
title: Элементы Есентконтаинернотемптексцептион
...
ms.locfileid: "120117664"
---
# <a name="esentcontainernotemptyexception-members"></a>Элементы Есентконтаинернотемптексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Контаинернотемпти.

Тип [есентконтаинернотемптексцептион](./esentcontainernotemptyexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334324(v=exchg.10).md">есентконтаинернотемптексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентконтаинернотемптексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентконтаинернотемптексцептион](./esentcontainernotemptyexception-class.md)
