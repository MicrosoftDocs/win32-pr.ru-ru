...
Тип операции, для которой сообщается ход выполнения.
...
<td></td>
<td>Восстановить</td>
<td>Обратный вызов для параметра восстановления.</td>
</tr>
<tr class="even">
<td></td>
<td>Компактный</td>
<td>Обратный вызов для дефрагментации базы данных.</td>
</tr>
<tr class="odd">
<td></td>
<td>Восстановить</td>
<td>Обратный вызов для параметров восстановления.</td>
</tr>
<tr class="even">
<td></td>
<td>Резервное копирование</td>
<td>Обратный вызов для параметров резервного копирования.</td>
</tr>
<tr class="odd">
<td></td>
<td>Ведите</td>
<td>Обратный вызов для обнуления базы данных.</td>
</tr>
<tr class="even">
<td></td>
<td>упградерекордформат</td>
<td>Обратный вызов для процесса обновления формата записи всех страниц базы данных.</td>
</tr>
</tbody>
</table>
