...
ms.locfileid: "119481834"
---
# <a name="esentdatahaschangedexception-members"></a>Элементы Есентдатахасчанжедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датахасчанжед.

Тип [есентдатахасчанжедексцептион](./esentdatahaschangedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334394(v=exchg.10).md">есентдатахасчанжедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатахасчанжедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатахасчанжедексцептион](./esentdatahaschangedexception-class.md)
