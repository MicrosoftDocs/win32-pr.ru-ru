...
<td><p>Этот параметр используется для дефрагментации сбалансированного дерева, указанного параметром Сзтабленаме.</p></td>
</tr>
<tr class="odd">
<td><p>JET_bitDefragmentBTreeBatch</p></td>
<td><p>Этот параметр используется для вызова OLD2 для всей базы данных.</p></td>
</tr>
</tbody>
</table>
