...
ms.locfileid: "118268788"
---
# <a name="esentindexinvaliddefexception-members"></a>Элементы Есентиндексинвалиддефексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Индексинвалиддеф.

Тип [есентиндексинвалиддефексцептион](./esentindexinvaliddefexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350450(v=exchg.10).md">есентиндексинвалиддефексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентиндексинвалиддефексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентиндексинвалиддефексцептион](./esentindexinvaliddefexception-class.md)
