---
description: 'Дополнительные сведения о: JET_ERRINFOBASIC Members'
title: Элементы JET_ERRINFOBASIC (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "104559479"
---
# <a name="jet_errinfobasic-members"></a>Элементы JET_ERRINFOBASIC
...
Тип [JET_ERRINFOBASIC](./jet-errinfobasic-class.md) предоставляет следующие члены.
...
<td>Инициализирует новый экземпляр класса JET_ERRINFOBASIC.</td>
</tr>
</tbody>
</table>
...
<td><a href="dn335340(v=exchg.10).md">ерркат</a></td>
<td>Возвращает или задает категорию ошибки.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335344(v=exchg.10).md">еррвалуе</a></td>
<td>Возвращает или задает значение ошибки для запрошенного уровня info.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335472(v=exchg.10).md">лсаурцелине</a></td>
<td>Возвращает или задает строку исходного файла для запрошенного уровня info.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335345(v=exchg.10).md">ргкатегорикалхиерарчи</a></td>
<td>Возвращает или задает иерархию ошибок. Расположение 0 является самым высоким уровнем в иерархии, а остальные — JET_errcatUnknown.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335474(v=exchg.10).md">ргсзсаурцефиле</a></td>
<td>Возвращает или задает имя исходного файла для запрошенного уровня info.</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn335338(v=exchg.10).md">контентекуалс</a></td>
<td>Возвращает значение, указывающее, равен ли данный экземпляр другому экземпляру.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
<td><a href="dn335471(v=exchg.10).md">дипклоне</a></td>
