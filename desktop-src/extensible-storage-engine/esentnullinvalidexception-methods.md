---
description: 'Дополнительные сведения: методы Есентнуллинвалидексцептион'
title: 'Методы EsentNullInvalidException '
...
ms.locfileid: "119040262"
---
# <a name="esentnullinvalidexception-methods"></a>Методы EsentNullInvalidException 
