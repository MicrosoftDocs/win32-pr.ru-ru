---
description: 'Дополнительные сведения о: конструктор Есентинвалиднамиксцептион'
title: Конструктор Есентинвалиднамиксцептион
...
ms.locfileid: "105713180"
---
# <a name="esentinvalidnameexception-constructor"></a>Конструктор Есентинвалиднамиксцептион

Инициализирует новый экземпляр класса Есентинвалиднамиксцептион.
...
[Элементы Есентинвалиднамиксцептион](./esentinvalidnameexception-members.md)
