---
description: 'Дополнительные сведения о: конструктор Есентинвалидиндексидексцептион'
title: Конструктор Есентинвалидиндексидексцептион
...
ms.locfileid: "120064669"
---
# <a name="esentinvalidindexidexception-constructor"></a>Конструктор Есентинвалидиндексидексцептион

Инициализирует новый экземпляр класса Есентинвалидиндексидексцептион.
...
[Элементы Есентинвалидиндексидексцептион](./esentinvalidindexidexception-members.md)
