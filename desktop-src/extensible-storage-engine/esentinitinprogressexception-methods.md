---
description: 'Дополнительные сведения: методы Есентинитинпрогрессексцептион'
title: 'Методы EsentInitInProgressException '
...
ms.locfileid: "104264164"
---
# <a name="esentinitinprogressexception-methods"></a>Методы EsentInitInProgressException 
