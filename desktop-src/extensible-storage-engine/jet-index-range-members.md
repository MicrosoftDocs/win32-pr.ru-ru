---
description: 'Дополнительные сведения о: JET_INDEX_RANGE Members'
title: Элементы JET_INDEX_RANGE (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119039162"
---
# <a name="jet_index_range-members"></a>Элементы JET_INDEX_RANGE

Включить защищенные члены  
Включить унаследованные члены  

Содержит определение для [жетпререадиндексранжес (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , пререадиндексранжесгрбит)](./windows8api.jetprereadindexranges-method.md).

Тип [JET_INDEX_RANGE](./jet-index-range-class.md) предоставляет следующие члены.
...
<td><a href="dn335362(v=exchg.10).md">ендколумнс</a></td>
<td>Возвращает или задает значения столбцов для конца индекса.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn335485(v=exchg.10).md">стартколумнс</a></td>
<td>Возвращает или задает значения столбцов для начала индекса.</td>
</tr>
</tbody>
</table>
...
<td>Возвращает <a href="/dotnet/api/system.string">строку</a> , представляющую текущий <a href="dn335481(v=exchg.10).md">JET_INDEX_RANGE</a>. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
