...
ms.locfileid: "119116844"
---
# <a name="esentcolumninrelationshipexception-members"></a>Элементы Есентколумнинрелатионшипексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнинрелатионшип.

Тип [есентколумнинрелатионшипексцептион](./esentcolumninrelationshipexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334263(v=exchg.10).md">есентколумнинрелатионшипексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнинрелатионшипексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнинрелатионшипексцептион](./esentcolumninrelationshipexception-class.md)
