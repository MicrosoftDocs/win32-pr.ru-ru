---
description: 'Дополнительные сведения о: Есенттуманйопениндексесексцептион Members'
title: Элементы Есенттуманйопениндексесексцептион
...
ms.locfileid: "103911960"
---
# <a name="esenttoomanyopenindexesexception-members"></a>Элементы Есенттуманйопениндексесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманйопениндексес.

Тип [есенттуманйопениндексесексцептион](./esenttoomanyopenindexesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350768(v=exchg.10).md">есенттуманйопениндексесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманйопениндексесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманйопениндексесексцептион](./esenttoomanyopenindexesexception-class.md)
