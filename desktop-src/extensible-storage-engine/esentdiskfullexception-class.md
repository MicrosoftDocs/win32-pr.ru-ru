...
---
# <a name="esentdiskfullexception-class"></a>Класс Есентдискфуллексцептион
        ...
        [Microsoft. ISAM. ESENT. Interop. Есентоператионексцептион](./esentoperationexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентресаурцеексцептион](./esentresourceexception-class.md)  
            [Microsoft. ISAM. ESENT. Interop. Есентдискексцептион](./esentdiskexception-class.md)  
              Microsoft. ISAM. ESENT. Interop. Есентдискфуллексцептион  
...
[Элементы Есентдискфуллексцептион](./esentdiskfullexception-members.md)
