---
description: 'Дополнительные сведения о: Есентбадбукмаркексцептион Members'
title: Элементы Есентбадбукмаркексцептион
...
ms.locfileid: "118083080"
---
# <a name="esentbadbookmarkexception-members"></a>Элементы Есентбадбукмаркексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Бадбукмарк.

Тип [есентбадбукмаркексцептион](./esentbadbookmarkexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274045(v=exchg.10).md">есентбадбукмаркексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадбукмаркексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадбукмаркексцептион](./esentbadbookmarkexception-class.md)
