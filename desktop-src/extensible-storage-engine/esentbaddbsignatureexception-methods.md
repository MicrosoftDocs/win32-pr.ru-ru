---
description: 'Дополнительные сведения: методы Есентбаддбсигнатуриксцептион'
title: 'Методы EsentBadDbSignatureException '
...
ms.locfileid: "103817969"
---
# <a name="esentbaddbsignatureexception-methods"></a>Методы EsentBadDbSignatureException 
