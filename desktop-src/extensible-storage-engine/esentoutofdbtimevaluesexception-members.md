...
---
# <a name="esentoutofdbtimevaluesexception-members"></a>Элементы Есентаутофдбтимевалуесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аутофдбтимевалуес.

Тип [есентаутофдбтимевалуесексцептион](./esentoutofdbtimevaluesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319776(v=exchg.10).md">есентаутофдбтимевалуесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутофдбтимевалуесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутофдбтимевалуесексцептион](./esentoutofdbtimevaluesexception-class.md)
