---
description: 'Дополнительные сведения: методы Есентдатахасчанжедексцептион'
title: 'Методы EsentDataHasChangedException '
...
ms.locfileid: "104567779"
---
# <a name="esentdatahaschangedexception-methods"></a>Методы EsentDataHasChangedException 
