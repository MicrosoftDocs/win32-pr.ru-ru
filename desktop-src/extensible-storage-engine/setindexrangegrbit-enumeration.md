...
ms.locfileid: "118978554"
---
# <a name="setindexrangegrbit-enumeration"></a>Перечисление Сетиндексранжегрбит

Параметры для Жетсетиндексранже.
...
<tr class="even">
<td></td>
<td>ранжеинклусиве</td>
<td>Этот параметр указывает, что предел диапазона индекса является инклюзивным.</td>
</tr>
<tr class="odd">
<td></td>
<td>ранжеупперлимит</td>
<td>Ключ поиска в курсоре представляет критерий поиска для элемента индекса, ближайшего к концу индекса, который будет соответствовать диапазону индексов.</td>
</tr>
<tr class="even">
<td></td>
<td>ранжеинстантдуратион</td>
<td>Диапазон индексов должен быть удален сразу после его установки. Это полезно для проверки существования записей индекса, соответствующих условиям поиска.</td>
</tr>
<tr class="odd">
<td></td>
<td>ранжеремове</td>
<td>Отмена и существующий диапазон индекса.</td>
</tr>
</tbody>
</table>
