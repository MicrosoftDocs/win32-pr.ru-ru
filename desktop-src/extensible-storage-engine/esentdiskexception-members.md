---
description: 'Дополнительные сведения о: Есентдискексцептион Members'
title: Элементы Есентдискексцептион
...
ms.locfileid: "119947944"
---
# <a name="esentdiskexception-members"></a>Элементы Есентдискексцептион
...
Тип [есентдискексцептион](./esentdiskexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274189(v=exchg.10).md">Есентдискексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентдискексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn274282(v=exchg.10).md">Есентдискексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентдискексцептион.</td>
</tr>
</tbody>
</table>
