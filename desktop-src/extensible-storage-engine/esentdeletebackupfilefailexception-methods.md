---
description: 'Дополнительные сведения: методы Есентделетебаккупфилефаилексцептион'
title: 'Методы EsentDeleteBackupFileFailException '
...
ms.locfileid: "119840035"
---
# <a name="esentdeletebackupfilefailexception-methods"></a>Методы EsentDeleteBackupFileFailException 
