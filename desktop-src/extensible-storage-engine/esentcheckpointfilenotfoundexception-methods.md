---
description: 'Дополнительные сведения: методы Есентчеккпоинтфиленотфаундексцептион'
title: 'Методы EsentCheckpointFileNotFoundException '
...
ms.locfileid: "104544951"
---
# <a name="esentcheckpointfilenotfoundexception-methods"></a>Методы EsentCheckpointFileNotFoundException 
