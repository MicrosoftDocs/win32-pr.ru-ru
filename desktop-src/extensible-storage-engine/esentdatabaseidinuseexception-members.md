...
ms.locfileid: "119116264"
---
# <a name="esentdatabaseidinuseexception-members"></a>Элементы Есентдатабасеидинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеидинусе.

Тип [есентдатабасеидинусиксцептион](./esentdatabaseidinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334312(v=exchg.10).md">есентдатабасеидинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеидинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеидинусиксцептион](./esentdatabaseidinuseexception-class.md)
