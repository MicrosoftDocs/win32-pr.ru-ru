...
---
# <a name="esentillegaloperationexception-members"></a>Элементы Есентиллегалоператионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Иллегалоператион.

Тип [есентиллегалоператионексцептион](./esentillegaloperationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350483(v=exchg.10).md">есентиллегалоператионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентиллегалоператионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентиллегалоператионексцептион](./esentillegaloperationexception-class.md)
