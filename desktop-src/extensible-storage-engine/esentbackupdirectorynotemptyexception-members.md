...
ms.locfileid: "119786374"
---
# <a name="esentbackupdirectorynotemptyexception-members"></a>Элементы Есентбаккупдиректоринотемптексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Баккупдиректоринотемпти.

Тип [есентбаккупдиректоринотемптексцептион](./esentbackupdirectorynotemptyexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273971(v=exchg.10).md">есентбаккупдиректоринотемптексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбаккупдиректоринотемптексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбаккупдиректоринотемптексцептион](./esentbackupdirectorynotemptyexception-class.md)
