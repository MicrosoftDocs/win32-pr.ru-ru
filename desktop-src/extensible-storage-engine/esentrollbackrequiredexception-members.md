---
description: 'Дополнительные сведения о: Есентроллбаккрекуиредексцептион Members'
title: Элементы Есентроллбаккрекуиредексцептион
...
ms.locfileid: "118981964"
---
# <a name="esentrollbackrequiredexception-members"></a>Элементы Есентроллбаккрекуиредексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Роллбаккрекуиред.

Тип [есентроллбаккрекуиредексцептион](./esentrollbackrequiredexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350594(v=exchg.10).md">есентроллбаккрекуиредексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентроллбаккрекуиредексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентроллбаккрекуиредексцептион](./esentrollbackrequiredexception-class.md)
