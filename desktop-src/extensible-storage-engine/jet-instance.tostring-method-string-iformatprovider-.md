...
ms.locfileid: "118765585"
---
# <a name="jet_instancetostring-method-string-iformatprovider"></a>JET_INSTANCE. Метод ToString (String, IFormatProvider)
...
[Перегрузка ToString](./jet-instance.tostring-method2.md)
