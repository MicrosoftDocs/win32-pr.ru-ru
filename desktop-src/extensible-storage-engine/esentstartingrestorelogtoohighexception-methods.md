---
description: 'Дополнительные сведения: методы Есентстартингресторелогтухигхексцептион'
title: 'Методы EsentStartingRestoreLogTooHighException '
...
ms.locfileid: "118258533"
---
# <a name="esentstartingrestorelogtoohighexception-methods"></a>Методы EsentStartingRestoreLogTooHighException 
