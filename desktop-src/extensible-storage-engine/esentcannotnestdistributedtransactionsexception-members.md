...
ms.locfileid: "119975606"
---
# <a name="esentcannotnestdistributedtransactionsexception-members"></a>Элементы Есентканнотнестдистрибутедтрансактионсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотнестдистрибутедтрансактионс.

Тип [есентканнотнестдистрибутедтрансактионсексцептион](./esentcannotnestdistributedtransactionsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274118(v=exchg.10).md">есентканнотнестдистрибутедтрансактионсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотнестдистрибутедтрансактионсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотнестдистрибутедтрансактионсексцептион](./esentcannotnestdistributedtransactionsexception-class.md)
