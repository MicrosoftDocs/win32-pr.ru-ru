...
ms.locfileid: "119977814"
---
# <a name="apijetretrievecolumn-method-jet_sesid-jet_tableid-jet_columnid-byte--int32-int32-retrievecolumngrbit-jet_retinfo"></a>Метод API. Жетретриевеколумн (JET_SESID, JET_TABLEID, JET_COLUMNID, Byte, Int32, Int32, Ретриевеколумнгрбит, JET_RETINFO)
...
Функции Ретриевеколумнас предоставляют функции извлечения, относящиеся к типу данных.
