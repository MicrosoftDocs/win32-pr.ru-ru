...
---
# <a name="esentdbtimetoonewexception-members"></a>Элементы Есентдбтиметуневексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дбтиметунев.

Тип [есентдбтиметуневексцептион](./esentdbtimetoonewexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334401(v=exchg.10).md">есентдбтиметуневексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдбтиметуневексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдбтиметуневексцептион](./esentdbtimetoonewexception-class.md)
