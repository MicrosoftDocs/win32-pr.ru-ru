---
description: 'Дополнительные сведения о: конструктор Есентбадлогверсионексцептион'
title: Конструктор Есентбадлогверсионексцептион
...
ms.locfileid: "119042002"
---
# <a name="esentbadlogversionexception-constructor"></a>Конструктор Есентбадлогверсионексцептион

Инициализирует новый экземпляр класса Есентбадлогверсионексцептион.
