---
description: 'Дополнительные сведения: методы Есентексцептион'
title: Методы Есентексцептион (Microsoft. ISAM. ESENT)
...
ms.locfileid: "118778951"
---
# <a name="esentexception-methods"></a>Методы Есентексцептион
