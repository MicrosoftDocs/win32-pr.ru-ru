---
description: 'Дополнительные сведения: методы Есентдткмиссингкаллбакконрековерексцептион'
title: 'Методы EsentDTCMissingCallbackOnRecoveryException '
...
ms.locfileid: "118270270"
---
# <a name="esentdtcmissingcallbackonrecoveryexception-methods"></a>Методы EsentDTCMissingCallbackOnRecoveryException 
