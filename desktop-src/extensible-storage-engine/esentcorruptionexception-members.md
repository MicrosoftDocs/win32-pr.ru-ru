---
description: 'Дополнительные сведения о: Есенткорруптионексцептион Members'
title: Элементы Есенткорруптионексцептион
...
ms.locfileid: "103808584"
---
# <a name="esentcorruptionexception-members"></a>Элементы Есенткорруптионексцептион
...
Тип [есенткорруптионексцептион](./esentcorruptionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273980(v=exchg.10).md">Есенткорруптионексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есенткорруптионексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn334330(v=exchg.10).md">Есенткорруптионексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есенткорруптионексцептион.</td>
</tr>
</tbody>
</table>
