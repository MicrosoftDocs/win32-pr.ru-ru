...
---
# <a name="esentrecoveredwitherrorsexception-members"></a>Элементы Есентрековередвисеррорсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рековередвисеррорс.

Тип [есентрековередвисеррорсексцептион](./esentrecoveredwitherrorsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319878(v=exchg.10).md">есентрековередвисеррорсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрековередвисеррорсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрековередвисеррорсексцептион](./esentrecoveredwitherrorsexception-class.md)
