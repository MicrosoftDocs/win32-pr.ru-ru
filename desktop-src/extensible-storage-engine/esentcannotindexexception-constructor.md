---
description: 'Дополнительные сведения о: конструктор Есентканнотиндексексцептион'
title: Конструктор Есентканнотиндексексцептион
...
ms.locfileid: "119737124"
---
# <a name="esentcannotindexexception-constructor"></a>Конструктор Есентканнотиндексексцептион

Инициализирует новый экземпляр класса Есентканнотиндексексцептион.
...
[Элементы Есентканнотиндексексцептион](./esentcannotindexexception-members.md)
