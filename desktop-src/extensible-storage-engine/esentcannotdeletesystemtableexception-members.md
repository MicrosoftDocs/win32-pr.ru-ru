...
---
# <a name="esentcannotdeletesystemtableexception-members"></a>Элементы Есентканнотделетесистемтабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотделетесистемтабле.

Тип [есентканнотделетесистемтабликсцептион](./esentcannotdeletesystemtableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274143(v=exchg.10).md">есентканнотделетесистемтабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотделетесистемтабликсцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотделетесистемтабликсцептион](./esentcannotdeletesystemtableexception-class.md)
