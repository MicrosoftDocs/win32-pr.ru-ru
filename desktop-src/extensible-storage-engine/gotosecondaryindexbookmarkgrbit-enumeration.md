...
ms.locfileid: "118487984"
---
# <a name="gotosecondaryindexbookmarkgrbit-enumeration"></a>Перечисление Готосекондариндексбукмаркгрбит

Параметры для [жетготосекондариндексбукмарк (JET_SESID, JET_TABLEID, \[ \] , Int32, \[ \] , Int32, готосекондариндексбукмаркгрбит)](./api.jetgotosecondaryindexbookmark-method.md).
...
<tr class="even">
<td></td>
<td>букмаркпермитвиртуалкурренци</td>
<td>В случае, если запись индекса больше не может быть найдена, курсор будет расположен слева, где была найдена Эта запись индекса. Операция по-прежнему завершится ошибкой с JET_errRecordDeleted; Тем не менее, можно перейти к следующей или предыдущей записи индекса относительно записи индекса, которая сейчас отсутствует.</td>
</tr>
</tbody>
</table>
