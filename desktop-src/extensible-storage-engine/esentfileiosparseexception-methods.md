---
description: 'Дополнительные сведения: методы Есентфилеиоспарсиксцептион'
title: 'Методы EsentFileIOSparseException '
...
ms.locfileid: "118269121"
---
# <a name="esentfileiosparseexception-methods"></a>Методы EsentFileIOSparseException 
