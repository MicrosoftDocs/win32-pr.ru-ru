---
description: 'Дополнительные сведения о: Есентсессионвритеконфликтексцептион Members'
title: Элементы Есентсессионвритеконфликтексцептион
...
ms.locfileid: "104347582"
---
# <a name="esentsessionwriteconflictexception-members"></a>Элементы Есентсессионвритеконфликтексцептион
...
Тип [есентсессионвритеконфликтексцептион](./esentsessionwriteconflictexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350648(v=exchg.10).md">есентсессионвритеконфликтексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсессионвритеконфликтексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсессионвритеконфликтексцептион](./esentsessionwriteconflictexception-class.md)
