...
---
# <a name="uint64columnvalue-members"></a>Элементы UInt64ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [UInt64](/dotnet/api/system.uint64) .

Тип [UInt64ColumnValue](./uint64columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn351260(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351189(v=exchg.10).md">жетвалуефромбитес</a></td>
