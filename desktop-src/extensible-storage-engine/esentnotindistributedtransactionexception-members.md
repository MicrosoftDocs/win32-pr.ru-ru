---
description: 'Дополнительные сведения о: Есентнотиндистрибутедтрансактионексцептион Members'
title: Элементы Есентнотиндистрибутедтрансактионексцептион
...
ms.locfileid: "104553365"
---
# <a name="esentnotindistributedtransactionexception-members"></a>Элементы Есентнотиндистрибутедтрансактионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Нотиндистрибутедтрансактион.

Тип [есентнотиндистрибутедтрансактионексцептион](./esentnotindistributedtransactionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334736(v=exchg.10).md">есентнотиндистрибутедтрансактионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнотиндистрибутедтрансактионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнотиндистрибутедтрансактионексцептион](./esentnotindistributedtransactionexception-class.md)
