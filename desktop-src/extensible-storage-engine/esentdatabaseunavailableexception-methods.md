---
description: 'Дополнительные сведения: методы Есентдатабасеунаваилабликсцептион'
title: 'Методы EsentDatabaseUnavailableException '
...
ms.locfileid: "118982474"
---
# <a name="esentdatabaseunavailableexception-methods"></a>Методы EsentDatabaseUnavailableException 
