---
description: 'Дополнительные сведения о: Есентинвалидсистемпасексцептион Members'
title: Элементы Есентинвалидсистемпасексцептион
...
ms.locfileid: "104569306"
---
# <a name="esentinvalidsystempathexception-members"></a>Элементы Есентинвалидсистемпасексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидсистемпас.

Тип [есентинвалидсистемпасексцептион](./esentinvalidsystempathexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319589(v=exchg.10).md">есентинвалидсистемпасексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидсистемпасексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидсистемпасексцептион](./esentinvalidsystempathexception-class.md)
