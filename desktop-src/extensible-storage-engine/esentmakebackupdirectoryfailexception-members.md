...
---
# <a name="esentmakebackupdirectoryfailexception-members"></a>Элементы Есентмакебаккупдиректорифаилексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Макебаккупдиректорифаил.

Тип [есентмакебаккупдиректорифаилексцептион](./esentmakebackupdirectoryfailexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334689(v=exchg.10).md">есентмакебаккупдиректорифаилексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмакебаккупдиректорифаилексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентмакебаккупдиректорифаилексцептион](./esentmakebackupdirectoryfailexception-class.md)
