---
description: 'Дополнительные сведения: методы Есентлогреадверифифаилуриксцептион'
title: 'Методы EsentLogReadVerifyFailureException '
...
ms.locfileid: "119734724"
---
# <a name="esentlogreadverifyfailureexception-methods"></a>Методы EsentLogReadVerifyFailureException 
