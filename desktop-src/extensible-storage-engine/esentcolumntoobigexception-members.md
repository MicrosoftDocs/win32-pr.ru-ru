---
description: 'Дополнительные сведения о: Есентколумнтубижексцептион Members'
title: Элементы Есентколумнтубижексцептион
...
ms.locfileid: "104563931"
---
# <a name="esentcolumntoobigexception-members"></a>Элементы Есентколумнтубижексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнтубиг.

Тип [есентколумнтубижексцептион](./esentcolumntoobigexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334303(v=exchg.10).md">есентколумнтубижексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнтубижексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнтубижексцептион](./esentcolumntoobigexception-class.md)
