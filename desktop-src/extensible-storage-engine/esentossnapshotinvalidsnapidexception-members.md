---
description: 'Дополнительные сведения о: Есентосснапшотинвалидснапидексцептион Members'
title: Элементы Есентосснапшотинвалидснапидексцептион
...
ms.locfileid: "118493593"
---
# <a name="esentossnapshotinvalidsnapidexception-members"></a>Элементы Есентосснапшотинвалидснапидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Осснапшотинвалидснапид.

Тип [есентосснапшотинвалидснапидексцептион](./esentossnapshotinvalidsnapidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319696(v=exchg.10).md">есентосснапшотинвалидснапидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентосснапшотинвалидснапидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентосснапшотинвалидснапидексцептион](./esentossnapshotinvalidsnapidexception-class.md)
