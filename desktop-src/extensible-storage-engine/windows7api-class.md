---
description: 'Дополнительные сведения о: Windows7Api Class'
title: Класс Windows7Api (Microsoft. ISAM. ESENT. Interop. Windows7)
...
ms.locfileid: "119106652"
---
# <a name="windows7api-class"></a>Класс Windows7Api

api ESENT, которые впервые поддерживались в Windows 7 (Windows Server 2008 R2).
