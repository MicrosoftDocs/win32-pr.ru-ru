---
description: 'Дополнительные сведения о: Есентдатабасеалреадюпградедексцептион Members'
title: Элементы Есентдатабасеалреадюпградедексцептион
...
ms.locfileid: "104564049"
---
# <a name="esentdatabasealreadyupgradedexception-members"></a>Элементы Есентдатабасеалреадюпградедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеалреадюпградед.

Тип [есентдатабасеалреадюпградедексцептион](./esentdatabasealreadyupgradedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334273(v=exchg.10).md">есентдатабасеалреадюпградедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеалреадюпградедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеалреадюпградедексцептион](./esentdatabasealreadyupgradedexception-class.md)
