...
---
# <a name="esentcheckpointcorruptexception-members"></a>Элементы Есентчеккпоинткорруптексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Чеккпоинткоррупт.

Тип [есентчеккпоинткорруптексцептион](./esentcheckpointcorruptexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274192(v=exchg.10).md">есентчеккпоинткорруптексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентчеккпоинткорруптексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентчеккпоинткорруптексцептион](./esentcheckpointcorruptexception-class.md)
