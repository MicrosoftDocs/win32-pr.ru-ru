...
---
# <a name="apijetopendatabase-method"></a>API. Жетопендатабасе, метод

Открывает базу данных, ранее присоединенную с помощью [жетаттачдатабасе (JET_SESID, String, аттачдатабасегрбит)](./api.jetattachdatabase-method.md), для использования с сеансом базы данных. Эту функцию можно вызывать несколько раз для одной и той же базы данных.
...
#### <a name="parameters"></a>Параметры
  ...
  - сесид  
    ...
    Сеанс, в котором открывается база данных.
...
<!-- end list -->
  ...
  - dbid  
    ...
    Возвращает DBID присоединенной базы данных.

<!-- end list -->

  - грбит  
    Тип: [Microsoft. ISAM. ESENT. Interop. опендатабасегрбит](./opendatabasegrbit-enumeration.md)  
    
    Откройте параметры базы данных.
