...
---
# <a name="esentinvalidsesidexception-members"></a>Элементы Есентинвалидсесидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидсесид.

Тип [есентинвалидсесидексцептион](./esentinvalidsesidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334523(v=exchg.10).md">есентинвалидсесидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидсесидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидсесидексцептион](./esentinvalidsesidexception-class.md)
