...
ms.locfileid: "120066994"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-int16"></a>Метод API. Сетколумн (JET_SESID, JET_TABLEID, JET_COLUMNID, Int16)
