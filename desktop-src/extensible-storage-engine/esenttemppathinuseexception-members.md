---
description: 'Дополнительные сведения о: Есенттемппасинусиксцептион Members'
title: Элементы Есенттемппасинусиксцептион
...
ms.locfileid: "104559997"
---
# <a name="esenttemppathinuseexception-members"></a>Элементы Есенттемппасинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Темппасинусе.

Тип [есенттемппасинусиксцептион](./esenttemppathinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334970(v=exchg.10).md">есенттемппасинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттемппасинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттемппасинусиксцептион](./esenttemppathinuseexception-class.md)
