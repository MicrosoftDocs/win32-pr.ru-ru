---
description: 'Дополнительные сведения: методы Есентслврутстиллопенексцептион'
title: 'Методы EsentSLVRootStillOpenException '
...
ms.locfileid: "118079111"
---
# <a name="esentslvrootstillopenexception-methods"></a>Методы EsentSLVRootStillOpenException 
