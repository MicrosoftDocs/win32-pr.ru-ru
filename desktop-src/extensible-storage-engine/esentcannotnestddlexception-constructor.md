---
description: 'Дополнительные сведения о: конструктор Есентканнотнестддлексцептион'
title: Конструктор Есентканнотнестддлексцептион
...
Инициализирует новый экземпляр класса Есентканнотнестддлексцептион.
...
[Элементы Есентканнотнестддлексцептион](./esentcannotnestddlexception-members.md)
