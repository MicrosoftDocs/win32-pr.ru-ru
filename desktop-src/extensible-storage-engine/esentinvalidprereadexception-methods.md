---
description: 'Дополнительные сведения: методы Есентинвалидпререадексцептион'
title: 'Методы EsentInvalidPrereadException '
...
ms.locfileid: "104272180"
---
# <a name="esentinvalidprereadexception-methods"></a>Методы EsentInvalidPrereadException 
