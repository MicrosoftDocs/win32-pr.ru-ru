---
description: 'Дополнительные сведения: JET_COLUMNCREATE методы'
title: Методы JET_COLUMNCREATE
...
ms.locfileid: "104557923"
---
# <a name="jet_columncreate-methods"></a>Методы JET_COLUMNCREATE
