---
description: 'Дополнительные сведения: методы Есентскллинкнотсуппортедексцептион'
title: 'Методы EsentSQLLinkNotSupportedException '
...
ms.locfileid: "104562536"
---
# <a name="esentsqllinknotsupportedexception-methods"></a>Методы EsentSQLLinkNotSupportedException 
