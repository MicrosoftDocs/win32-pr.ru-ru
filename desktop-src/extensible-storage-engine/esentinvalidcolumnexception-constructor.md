---
description: 'Дополнительные сведения о: конструктор Есентинвалидколумнексцептион'
...
ms.locfileid: "118266558"
---
# <a name="esentinvalidcolumnexception-constructor"></a>Конструктор Есентинвалидколумнексцептион

Инициализирует новый экземпляр класса Есентинвалидколумнексцептион.
