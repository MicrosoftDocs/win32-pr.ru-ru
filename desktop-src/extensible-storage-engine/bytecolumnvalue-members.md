---
description: 'Дополнительные сведения о: Битеколумнвалуе Members'
title: Элементы Битеколумнвалуе
...
ms.locfileid: "104569572"
---
# <a name="bytecolumnvalue-members"></a>Элементы Битеколумнвалуе

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [байтов](/dotnet/api/system.byte) .

Тип [битеколумнвалуе](./bytecolumnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn334112(v=exchg.10).md">битеколумнвалуе</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td><a href="dn334116(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn334114(v=exchg.10).md">жетвалуефромбитес</a></td>
