---
description: 'Дополнительные сведения о: Есентбаккупабортбисерверексцептион свойства'
title: Свойства Есентбаккупабортбисерверексцептион
...
ms.locfileid: "120066704"
---
# <a name="esentbackupabortbyserverexception-properties"></a>Свойства Есентбаккупабортбисерверексцептион
