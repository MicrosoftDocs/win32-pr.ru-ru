---
description: 'Дополнительные сведения: методы Есентслвреадверифифаилуриксцептион'
title: 'Методы EsentSLVReadVerifyFailureException '
...
ms.locfileid: "119113707"
---
# <a name="esentslvreadverifyfailureexception-methods"></a>Методы EsentSLVReadVerifyFailureException 
