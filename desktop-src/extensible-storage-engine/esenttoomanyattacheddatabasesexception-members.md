---
description: 'Дополнительные сведения о: Есенттуманяттачеддатабасесексцептион Members'
title: Элементы Есенттуманяттачеддатабасесексцептион
...
ms.locfileid: "104559602"
---
# <a name="esenttoomanyattacheddatabasesexception-members"></a>Элементы Есенттуманяттачеддатабасесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманяттачеддатабасес.

Тип [есенттуманяттачеддатабасесексцептион](./esenttoomanyattacheddatabasesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335012(v=exchg.10).md">есенттуманяттачеддатабасесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманяттачеддатабасесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманяттачеддатабасесексцептион](./esenttoomanyattacheddatabasesexception-class.md)
