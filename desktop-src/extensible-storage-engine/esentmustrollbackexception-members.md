...
---
# <a name="esentmustrollbackexception-members"></a>Элементы Есентмустроллбаккексцептион
...
Тип [есентмустроллбаккексцептион](./esentmustrollbackexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319649(v=exchg.10).md">есентмустроллбаккексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмустроллбаккексцептион.</td>
</tr>
</tbody>
</table>
