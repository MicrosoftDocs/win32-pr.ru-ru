---
description: 'Дополнительные сведения: методы Есенттемпфилеопенеррорексцептион'
title: 'Методы EsentTempFileOpenErrorException '
...
ms.locfileid: "120063954"
---
# <a name="esenttempfileopenerrorexception-methods"></a>Методы EsentTempFileOpenErrorException 
