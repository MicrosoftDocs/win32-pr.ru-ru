...
ms.locfileid: "120117224"
---
# <a name="esentdbtimecorruptedexception-members"></a>Элементы Есентдбтимекорруптедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дбтимекорруптед.

Тип [есентдбтимекорруптедексцептион](./esentdbtimecorruptedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274240(v=exchg.10).md">есентдбтимекорруптедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдбтимекорруптедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдбтимекорруптедексцептион](./esentdbtimecorruptedexception-class.md)
