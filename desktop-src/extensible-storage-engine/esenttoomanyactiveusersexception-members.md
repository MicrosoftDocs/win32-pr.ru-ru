...
ms.locfileid: "118768964"
---
# <a name="esenttoomanyactiveusersexception-members"></a>Элементы Есенттуманяктивеусерсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманяктивеусерс.

Тип [есенттуманяктивеусерсексцептион](./esenttoomanyactiveusersexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335009(v=exchg.10).md">есенттуманяктивеусерсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманяктивеусерсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманяктивеусерсексцептион](./esenttoomanyactiveusersexception-class.md)
