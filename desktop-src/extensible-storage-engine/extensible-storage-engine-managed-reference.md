---
description: 'дополнительные сведения: расширяемый справочник по управляемому модулю служба хранилища'
title: расширяемый справочник по управляемому модулю служба хранилища
...
ms.locfileid: "120093684"
---
# <a name="extensible-storage-engine-managed-reference"></a>расширяемый справочник по управляемому модулю служба хранилища
