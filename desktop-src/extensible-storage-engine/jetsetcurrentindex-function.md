...
<td><p>Содержимое идентификатора индекса недопустимо или устарело, и его необходимо обновить. Это может произойти для <strong>жетсеткуррентиндекс</strong> в следующих случаях:</p>
<ul>
...
<td><p>Реализуется как <strong>жетсеткуррентиндексв</strong> (Юникод) и <strong>жетсеткуррентиндекса</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
