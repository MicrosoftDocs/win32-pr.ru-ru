...
ms.locfileid: "119481414"
---
# <a name="esentderivedcolumncorruptionexception-members"></a>Элементы Есентдериведколумнкорруптионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дериведколумнкорруптион.

Тип [есентдериведколумнкорруптионексцептион](./esentderivedcolumncorruptionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274272(v=exchg.10).md">есентдериведколумнкорруптионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдериведколумнкорруптионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдериведколумнкорруптионексцептион](./esentderivedcolumncorruptionexception-class.md)
