---
description: 'Дополнительные сведения о: Есентинвалиддатабасиксцептион Members'
title: Элементы Есентинвалиддатабасиксцептион
...
ms.locfileid: "119364264"
---
# <a name="esentinvaliddatabaseexception-members"></a>Элементы Есентинвалиддатабасиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалиддатабасе.

Тип [есентинвалиддатабасиксцептион](./esentinvaliddatabaseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319476(v=exchg.10).md">есентинвалиддатабасиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалиддатабасиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалиддатабасиксцептион](./esentinvaliddatabaseexception-class.md)
