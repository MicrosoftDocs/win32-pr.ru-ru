---
description: 'Дополнительные сведения: методы UInt16ColumnValue'
title: Методы UInt16ColumnValue
...
ms.locfileid: "120093114"
---
# <a name="uint16columnvalue-methods"></a>Методы UInt16ColumnValue
