...
---
# <a name="esentntsystemcallfailedexception-constructor"></a>Конструктор Есентнтсистемкаллфаиледексцептион

Инициализирует новый экземпляр класса Есентнтсистемкаллфаиледексцептион.
...
[Элементы Есентнтсистемкаллфаиледексцептион](./esentntsystemcallfailedexception-members.md)
