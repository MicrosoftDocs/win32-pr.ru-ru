---
description: 'Дополнительные сведения о: Есенттуманинстанцесексцептион Members'
title: Элементы Есенттуманинстанцесексцептион
...
ms.locfileid: "118768838"
---
# <a name="esenttoomanyinstancesexception-members"></a>Элементы Есенттуманинстанцесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманинстанцес.

Тип [есенттуманинстанцесексцептион](./esenttoomanyinstancesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350765(v=exchg.10).md">есенттуманинстанцесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманинстанцесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманинстанцесексцептион](./esenttoomanyinstancesexception-class.md)
