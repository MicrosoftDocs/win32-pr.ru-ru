---
description: 'Дополнительные сведения: методы Есентбадпатчпажеексцептион'
title: 'Методы EsentBadPatchPageException '
...
ms.locfileid: "104272188"
---
# <a name="esentbadpatchpageexception-methods"></a>Методы EsentBadPatchPageException 
