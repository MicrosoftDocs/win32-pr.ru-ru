...
ms.locfileid: "119115809"
---
# <a name="esentlogdisabledduetorecoveryfailureexception-members"></a>Элементы Есентлогдисабледдуеторековерифаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логдисабледдуеторековерифаилуре.

Тип [есентлогдисабледдуеторековерифаилуриксцептион](./esentlogdisabledduetorecoveryfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334590(v=exchg.10).md">есентлогдисабледдуеторековерифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогдисабледдуеторековерифаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогдисабледдуеторековерифаилуриксцептион](./esentlogdisabledduetorecoveryfailureexception-class.md)
