---
description: 'Дополнительные сведения о: Есентстатиксцептион Members'
title: Элементы Есентстатиксцептион
...
ms.locfileid: "104553763"
---
# <a name="esentstateexception-members"></a>Элементы Есентстатиксцептион
...
Тип [есентстатиксцептион](./esentstateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350639(v=exchg.10).md">Есентстатиксцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентстатиксцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn334929(v=exchg.10).md">Есентстатиксцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентстатиксцептион.</td>
</tr>
</tbody>
</table>
