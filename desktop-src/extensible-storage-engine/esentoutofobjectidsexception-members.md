...
ms.locfileid: "119478494"
---
# <a name="esentoutofobjectidsexception-members"></a>Элементы Есентаутофобжектидсексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аутофобжектидс.

Тип [есентаутофобжектидсексцептион](./esentoutofobjectidsexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319750(v=exchg.10).md">есентаутофобжектидсексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутофобжектидсексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутофобжектидсексцептион](./esentoutofobjectidsexception-class.md)
