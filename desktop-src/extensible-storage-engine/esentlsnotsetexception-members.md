...
ms.locfileid: "120019819"
---
# <a name="esentlsnotsetexception-members"></a>Элементы Есентлснотсетексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Лснотсет.

Тип [есентлснотсетексцептион](./esentlsnotsetexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334678(v=exchg.10).md">есентлснотсетексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлснотсетексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлснотсетексцептион](./esentlsnotsetexception-class.md)
