...
---
# <a name="jet_objectlistcolumnidcpage-property"></a>Свойство JET_OBJECTLIST. Колумнидкпаже

Возвращает значение columnid столбца во временной таблице, в котором хранится количество страниц, используемых таблицей.
