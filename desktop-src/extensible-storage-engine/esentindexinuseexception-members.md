...
---
# <a name="esentindexinuseexception-members"></a>Элементы Есентиндексинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Индексинусе.

Тип [есентиндексинусиксцептион](./esentindexinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319405(v=exchg.10).md">есентиндексинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентиндексинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентиндексинусиксцептион](./esentindexinuseexception-class.md)
