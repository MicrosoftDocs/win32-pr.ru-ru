---
description: 'Дополнительные сведения о: конструктор JET_COLUMNLIST'
title: Конструктор JET_COLUMNLIST
...
ms.locfileid: "104543311"
---
# <a name="jet_columnlist-constructor"></a>Конструктор JET_COLUMNLIST
