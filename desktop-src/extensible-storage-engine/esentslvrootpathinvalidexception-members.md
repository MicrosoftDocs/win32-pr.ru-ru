---
description: 'Дополнительные сведения о: Есентслврутпасинвалидексцептион Members'
title: Элементы Есентслврутпасинвалидексцептион
...
ms.locfileid: "104264952"
---
# <a name="esentslvrootpathinvalidexception-members"></a>Элементы Есентслврутпасинвалидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслврутпасинвалидексцептион](./esentslvrootpathinvalidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334838(v=exchg.10).md">есентслврутпасинвалидексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[Класс Есентслврутпасинвалидексцептион](./esentslvrootpathinvalidexception-class.md)
