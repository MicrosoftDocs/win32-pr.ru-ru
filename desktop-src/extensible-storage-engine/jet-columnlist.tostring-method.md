...
Возвращает [строку](/dotnet/api/system.string) , представляющую текущий [JET_COLUMNLIST](./jet-columnlist-class.md).
...
[Строка](/dotnet/api/system.string) , представляющая текущий [JET_COLUMNLIST](./jet-columnlist-class.md).  
