...
---
# <a name="esentoutofautoincrementvaluesexception-members"></a>Элементы Есентаутофаутоинкрементвалуесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аутофаутоинкрементвалуес.

Тип [есентаутофаутоинкрементвалуесексцептион](./esentoutofautoincrementvaluesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319716(v=exchg.10).md">есентаутофаутоинкрементвалуесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутофаутоинкрементвалуесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутофаутоинкрементвалуесексцептион](./esentoutofautoincrementvaluesexception-class.md)
