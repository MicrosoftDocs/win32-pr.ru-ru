---
description: 'Дополнительные сведения о свойстве: SystemParameters. Легацифиленамес'
title: SystemParameters. Легацифиленамес, свойство
...
ms.locfileid: "104272512"
---
# <a name="systemparameterslegacyfilenames-property"></a>SystemParameters. Легацифиленамес, свойство

Возвращает или задает обратную совместимость с соглашениями об именовании файлов более ранних выпусков ядра СУБД.
