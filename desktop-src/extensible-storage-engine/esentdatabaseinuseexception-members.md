---
description: 'Дополнительные сведения о: Есентдатабасеинусиксцептион Members'
title: Элементы Есентдатабасеинусиксцептион
...
ms.locfileid: "104564206"
---
# <a name="esentdatabaseinuseexception-members"></a>Элементы Есентдатабасеинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеинусе.

Тип [есентдатабасеинусиксцептион](./esentdatabaseinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334325(v=exchg.10).md">есентдатабасеинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеинусиксцептион](./esentdatabaseinuseexception-class.md)
