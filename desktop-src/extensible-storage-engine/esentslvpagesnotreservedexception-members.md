---
description: 'Дополнительные сведения о: Есентслвпажеснотресерведексцептион Members'
title: Элементы Есентслвпажеснотресерведексцептион
...
ms.locfileid: "104551071"
---
# <a name="esentslvpagesnotreservedexception-members"></a>Элементы Есентслвпажеснотресерведексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслвпажеснотресерведексцептион](./esentslvpagesnotreservedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350736(v=exchg.10).md">есентслвпажеснотресерведексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[Класс Есентслвпажеснотресерведексцептион](./esentslvpagesnotreservedexception-class.md)
