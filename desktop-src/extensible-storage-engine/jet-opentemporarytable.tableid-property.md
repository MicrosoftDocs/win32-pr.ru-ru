---
description: 'Дополнительные сведения о свойстве: JET_OPENTEMPORARYTABLE. TableID'
title: Свойство JET_OPENTEMPORARYTABLE. TableID (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "118765052"
---
# <a name="jet_opentemporarytabletableid-property"></a>JET_OPENTEMPORARYTABLE. TableID, свойство

Возвращает маркер таблицы для временной таблицы, созданной в результате успешного вызова Жетопентемпораритабле.
