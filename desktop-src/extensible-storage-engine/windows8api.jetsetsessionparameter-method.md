...
---
# <a name="windows8apijetsetsessionparameter-method"></a>Windows8Api. Жетсетсессионпараметер, метод

Задает параметр для указанного состояния сеанса, используемый в течение времени существования этого сеанса или до сброса.
...
#### <a name="parameters"></a>Параметры
  ...
  - сесид  
    ...
    Сеанс, для которого задается параметр.

<!-- end list -->

  - сеспарамид  
    Тип: [Microsoft.ISAM.ESENT.Interop.Windows8.JET_sesparam](./jet-sesparam-enumeration.md)  
