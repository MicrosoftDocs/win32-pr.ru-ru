...
---
# <a name="guidcolumnvalue-members"></a>Элементы Гуидколумнвалуе
...
Тип [гуидколумнвалуе](./guidcolumnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn350904(v=exchg.10).md">гуидколумнвалуе</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td><a href="dn350894(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn350906(v=exchg.10).md">жетвалуефромбитес</a></td>
