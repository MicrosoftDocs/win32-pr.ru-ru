---
description: 'Дополнительные сведения о: JET_LS Members'
title: Элементы JET_LS
...
ms.locfileid: "120017024"
---
# <a name="jet_ls-members"></a>Элементы JET_LS
...
Тип [JET_LS](./jet-ls-structure.md) предоставляет следующие члены.
...
<td><a href="hh557240(v=exchg.10).md">Значение</a></td>
<td>Возвращает или задает значение маркера.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh566276(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_LS.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh578707(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_LS неравными.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh578259(v=exchg.10).md">Указатель</a></td>
<td>Маркер null.</td>
</tr>
</tbody>
</table>
