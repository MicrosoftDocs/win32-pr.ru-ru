...
---
# <a name="jet_ossnapidtostring-method-string-iformatprovider"></a>JET_OSSNAPID. Метод ToString (String, IFormatProvider)
...
[Перегрузка ToString](./jet-ossnapid.tostring-method.md)
