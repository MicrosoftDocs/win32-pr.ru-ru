---
description: 'Дополнительные сведения: методы Есентинвалидбуфферсизиксцептион'
title: 'Методы EsentInvalidBufferSizeException '
...
ms.locfileid: "104272897"
---
# <a name="esentinvalidbuffersizeexception-methods"></a>Методы EsentInvalidBufferSizeException 
