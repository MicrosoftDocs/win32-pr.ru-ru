---
description: 'Дополнительные сведения: методы Есентлинкнотсуппортедексцептион'
title: 'Методы EsentLinkNotSupportedException '
...
ms.locfileid: "119275024"
---
# <a name="esentlinknotsupportedexception-methods"></a>Методы EsentLinkNotSupportedException 
