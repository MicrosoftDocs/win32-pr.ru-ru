---
description: 'Дополнительные сведения о: Есентобсолетиксцептион Members'
title: Элементы Есентобсолетиксцептион
...
ms.locfileid: "103813139"
---
# <a name="esentobsoleteexception-members"></a>Элементы Есентобсолетиксцептион
...
Тип [есентобсолетиксцептион](./esentobsoleteexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334606(v=exchg.10).md">Есентобсолетиксцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентобсолетиксцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn319673(v=exchg.10).md">Есентобсолетиксцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентобсолетиксцептион.</td>
</tr>
</tbody>
</table>
