...
ms.locfileid: "118271210"
---
# <a name="esentdataexception-members"></a>Элементы Есентдатаексцептион
...
Тип [есентдатаексцептион](./esentdataexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274149(v=exchg.10).md">Есентдатаексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентдатаексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn274233(v=exchg.10).md">Есентдатаексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентдатаексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатаексцептион](./esentdataexception-class.md)
