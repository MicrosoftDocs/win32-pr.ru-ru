...
ms.locfileid: "119734782"
---
# <a name="esentlogreadverifyfailureexception-members"></a>Элементы Есентлогреадверифифаилуриксцептион
...
Тип [есентлогреадверифифаилуриксцептион](./esentlogreadverifyfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334644(v=exchg.10).md">есентлогреадверифифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогреадверифифаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогреадверифифаилуриксцептион](./esentlogreadverifyfailureexception-class.md)
