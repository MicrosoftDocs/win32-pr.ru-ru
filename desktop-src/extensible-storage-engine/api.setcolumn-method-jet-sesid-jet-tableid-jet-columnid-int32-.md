...
ms.locfileid: "117717585"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-int32"></a>Метод API. Сетколумн (JET_SESID, JET_TABLEID, JET_COLUMNID, Int32)
