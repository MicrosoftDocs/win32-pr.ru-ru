...
---
# <a name="esentbaddbsignatureexception-members"></a>Элементы Есентбаддбсигнатуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Баддбсигнатуре.

Тип [есентбаддбсигнатуриксцептион](./esentbaddbsignatureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274011(v=exchg.10).md">есентбаддбсигнатуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбаддбсигнатуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбаддбсигнатуриксцептион](./esentbaddbsignatureexception-class.md)
