---
description: 'Дополнительные сведения: JET_SETCOLUMN методы'
title: Методы JET_SETCOLUMN
...
ms.locfileid: "118253703"
---
# <a name="jet_setcolumn-methods"></a>Методы JET_SETCOLUMN
