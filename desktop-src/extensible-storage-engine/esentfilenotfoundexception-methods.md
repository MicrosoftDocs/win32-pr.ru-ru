---
description: 'Дополнительные сведения: методы Есентфиленотфаундексцептион'
title: 'Методы EsentFileNotFoundException '
...
ms.locfileid: "118081818"
---
# <a name="esentfilenotfoundexception-methods"></a>Методы EsentFileNotFoundException 
