---
description: 'Дополнительные сведения о свойстве: JET_DBINFOMISC. Кбпажесизе'
title: Свойство JET_DBINFOMISC. Кбпажесизе
...
ms.locfileid: "105692260"
---
# <a name="jet_dbinfomisccbpagesize-property"></a>Свойство JET_DBINFOMISC. Кбпажесизе

Возвращает размер страницы базы данных. Значение 0 означает 4 КБ страницы.
