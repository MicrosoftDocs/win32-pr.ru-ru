---
description: 'Дополнительные сведения о: конструктор Есентнуллинвалидексцептион'
title: Конструктор Есентнуллинвалидексцептион
...
ms.locfileid: "105703363"
---
# <a name="esentnullinvalidexception-constructor"></a>Конструктор Есентнуллинвалидексцептион

Инициализирует новый экземпляр класса Есентнуллинвалидексцептион.
...
[Элементы Есентнуллинвалидексцептион](./esentnullinvalidexception-members.md)
