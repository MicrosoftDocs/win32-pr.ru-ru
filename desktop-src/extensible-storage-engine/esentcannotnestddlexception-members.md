...
---
# <a name="esentcannotnestddlexception-members"></a>Элементы Есентканнотнестддлексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотнестддл.

Тип [есентканнотнестддлексцептион](./esentcannotnestddlexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274173(v=exchg.10).md">есентканнотнестддлексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотнестддлексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотнестддлексцептион](./esentcannotnestddlexception-class.md)
