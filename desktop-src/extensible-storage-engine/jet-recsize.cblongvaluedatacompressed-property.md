...
Возвращает сжатый размер пользовательских данных в дереве длинных значений. Это то же самое, что и [кблонгвалуедата](./jet-recsize.cblongvaluedata-property.md) , если не сжаты отдельные длинные значения.
