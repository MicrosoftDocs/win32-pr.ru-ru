---
description: 'Дополнительные сведения: методы Есентакцессдениедексцептион'
title: 'Методы EsentAccessDeniedException '
...
ms.locfileid: "104555272"
---
# <a name="esentaccessdeniedexception-methods"></a>Методы EsentAccessDeniedException 
