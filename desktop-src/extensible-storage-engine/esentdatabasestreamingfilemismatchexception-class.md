---
description: 'Дополнительные сведения о: Есентдатабасестреамингфилемисматчексцептион Class'
title: Класс Есентдатабасестреамингфилемисматчексцептион
...
ms.locfileid: "118780048"
---
# <a name="esentdatabasestreamingfilemismatchexception-class"></a>Класс Есентдатабасестреамингфилемисматчексцептион
      ...
      [Microsoft. ISAM. ESENT. Interop. Есентеррорексцептион](./esenterrorexception-class.md)  
        [Microsoft. ISAM. ESENT. Interop. Есентапиексцептион](./esentapiexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентобсолетиксцептион](./esentobsoleteexception-class.md)  
            Microsoft. ISAM. ESENT. Interop. Есентдатабасестреамингфилемисматчексцептион  
...
[Элементы Есентдатабасестреамингфилемисматчексцептион](./esentdatabasestreamingfilemismatchexception-members.md)
