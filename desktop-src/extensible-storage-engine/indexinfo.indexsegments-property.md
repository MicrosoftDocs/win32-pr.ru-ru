...
---
# <a name="indexinfoindexsegments-property"></a>Индексинфо. Индекссегментс, свойство

Возвращает сегменты индекса.
...
Тип: [System. Collections. Generic. IList](/dotnet/api/system.collections.generic.ilist-1)\<[IndexSegment](./indexsegment-class.md)\>  
