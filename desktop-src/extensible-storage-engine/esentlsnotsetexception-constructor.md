---
description: 'Дополнительные сведения о: конструктор Есентлснотсетексцептион'
title: Конструктор Есентлснотсетексцептион
...
ms.locfileid: "118079958"
---
# <a name="esentlsnotsetexception-constructor"></a>Конструктор Есентлснотсетексцептион

Инициализирует новый экземпляр класса Есентлснотсетексцептион.
...
[Элементы Есентлснотсетексцептион](./esentlsnotsetexception-members.md)
