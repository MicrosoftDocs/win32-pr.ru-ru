---
description: 'Дополнительные сведения о: JET_INSTANCE_INFO. Метод ToString'
title: JET_INSTANCE_INFO. Метод ToString
...
ms.locfileid: "119109333"
---
# <a name="jet_instance_infotostring-method"></a>JET_INSTANCE_INFO. Метод ToString

Создает строковое представление экземпляра.
