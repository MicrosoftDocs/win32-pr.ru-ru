---
description: 'Дополнительные сведения о: Есентскллинкнотсуппортедексцептион Class'
title: Класс Есентскллинкнотсуппортедексцептион
...
ms.locfileid: "118078328"
---
# <a name="esentsqllinknotsupportedexception-class"></a>Класс Есентскллинкнотсуппортедексцептион
      ...
      [Microsoft. ISAM. ESENT. Interop. Есентеррорексцептион](./esenterrorexception-class.md)  
        [Microsoft. ISAM. ESENT. Interop. Есентапиексцептион](./esentapiexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентобсолетиксцептион](./esentobsoleteexception-class.md)  
            Microsoft. ISAM. ESENT. Interop. Есентскллинкнотсуппортедексцептион  
...
[Элементы Есентскллинкнотсуппортедексцептион](./esentsqllinknotsupportedexception-members.md)
