...
---
# <a name="esentcolumnduplicateexception-members"></a>Элементы Есентколумндупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумндупликате.

Тип [есентколумндупликатиксцептион](./esentcolumnduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334256(v=exchg.10).md">есентколумндупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумндупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумндупликатиксцептион](./esentcolumnduplicateexception-class.md)
