...
ms.locfileid: "119471584"
---
# <a name="uint16columnvalue-members"></a>Элементы UInt16ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [UInt16](/dotnet/api/system.uint16) .

Тип [UInt16ColumnValue](./uint16columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn351182(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351263(v=exchg.10).md">жетвалуефромбитес</a></td>
