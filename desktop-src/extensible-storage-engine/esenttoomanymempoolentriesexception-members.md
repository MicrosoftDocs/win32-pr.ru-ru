...
ms.locfileid: "120116708"
---
# <a name="esenttoomanymempoolentriesexception-members"></a>Элементы Есенттуманимемпулентриесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманимемпулентриес.

Тип [есенттуманимемпулентриесексцептион](./esenttoomanymempoolentriesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn335010(v=exchg.10).md">есенттуманимемпулентриесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманимемпулентриесексцептион.</td>
</tr>
</tbody>
</table>
