---
description: 'Дополнительные сведения о: Есентафтеринитиализатионексцептион Members'
title: Элементы Есентафтеринитиализатионексцептион
...
ms.locfileid: "104143327"
---
# <a name="esentafterinitializationexception-members"></a>Элементы Есентафтеринитиализатионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Афтеринитиализатион.

Тип [есентафтеринитиализатионексцептион](./esentafterinitializationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334216(v=exchg.10).md">есентафтеринитиализатионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентафтеринитиализатионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентафтеринитиализатионексцептион](./esentafterinitializationexception-class.md)
