...
---
# <a name="esenttablenotemptyexception-members"></a>Элементы Есенттабленотемптексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Табленотемпти.

Тип [есенттабленотемптексцептион](./esenttablenotemptyexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334946(v=exchg.10).md">есенттабленотемптексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттабленотемптексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттабленотемптексцептион](./esenttablenotemptyexception-class.md)
