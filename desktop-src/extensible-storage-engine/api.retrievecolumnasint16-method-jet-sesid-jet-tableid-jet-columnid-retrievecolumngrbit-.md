...
ms.locfileid: "118271524"
---
# <a name="apiretrievecolumnasint16-method-jet_sesid-jet_tableid-jet_columnid-retrievecolumngrbit"></a>Метод API. RetrieveColumnAsInt16 (JET_SESID, JET_TABLEID, JET_COLUMNID, Ретриевеколумнгрбит)

Извлекает значение столбца Int16 из текущей записи. Запись — это запись, связанная с записью индекса в текущем положении курсора.
...
Тип: [System. Nullable](/dotnet/api/system.nullable-1)\<[Int16](/dotnet/api/system.int16)\>  
Данные, полученные из столбца в виде короткого. Значение null, если столбец имеет значение null.  
...
[Перегрузка RetrieveColumnAsInt16](./api.retrievecolumnasint16-method.md)
