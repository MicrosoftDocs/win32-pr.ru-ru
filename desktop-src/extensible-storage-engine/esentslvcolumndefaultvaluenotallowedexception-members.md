...
---
# <a name="esentslvcolumndefaultvaluenotallowedexception-members"></a>Элементы Есентслвколумндефаултвалуеноталловедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслвколумндефаултвалуеноталловедексцептион](./esentslvcolumndefaultvaluenotallowedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350671(v=exchg.10).md">есентслвколумндефаултвалуеноталловедексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[Класс Есентслвколумндефаултвалуеноталловедексцептион](./esentslvcolumndefaultvaluenotallowedexception-class.md)
