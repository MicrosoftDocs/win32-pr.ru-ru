---
description: 'Дополнительные сведения о свойстве: JET_ERRINFOBASIC. ерркат'
title: Свойство JET_ERRINFOBASIC. ерркат (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119401685"
---
# <a name="jet_errinfobasicerrcat-property"></a>Свойство JET_ERRINFOBASIC. ерркат

Возвращает или задает категорию ошибки.
...
Тип: [Microsoft.ISAM.ESENT.Interop.Windows8.JET_ERRCAT](./jet-errcat-enumeration.md)  
