...
---
# <a name="windows7apijetprereadkeys-method-jet_sesid-jet_tableid-byte-int32--int32-int32-int32-prereadkeysgrbit"></a>Метод Windows7Api. жетпререадкэйс (JET_SESID, JET_TABLEID, Byte \[ \] \[ \] , Int32, Int32, Int32, Int32, пререадкэйсгрбит)

Если записи с указанными ключами отсутствуют в буферном кэше, запустите асинхронные операции чтения, чтобы перенести записи в буферный кэш базы данных.
...
<!-- end list -->
  ...
  - ключи  
    ...
    Ключи для чтения. Ключи должны быть отсортированы.
...
<!-- end list -->
  ...
  - keyIndex  
    ...
    Индекс первого ключа в массиве ключей для чтения.
...
<!-- end list -->
  ...
  - кэйкаунт  
    ...
    Максимальное число ключей для чтения.
...
<!-- end list -->
  ...
  - кэйспререад  
    ...
    Возвращает число ключей для фактического чтения.

<!-- end list -->

  - грбит  
    Тип: [Microsoft. ISAM. ESENT. Interop. Windows7. пререадкэйсгрбит](./prereadkeysgrbit-enumeration.md)  
...
[Элементы Windows7Api](./windows7api-members.md)

[Перегрузка Жетпререадкэйс](./windows7api.jetprereadkeys-method.md)
