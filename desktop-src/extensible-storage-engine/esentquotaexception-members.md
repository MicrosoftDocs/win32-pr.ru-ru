---
description: 'Дополнительные сведения о: Есенткуотаексцептион Members'
title: Элементы Есенткуотаексцептион
...
ms.locfileid: "104563344"
---
# <a name="esentquotaexception-members"></a>Элементы Есенткуотаексцептион
...
Тип [есенткуотаексцептион](./esentquotaexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319648(v=exchg.10).md">Есенткуотаексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есенткуотаексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn319867(v=exchg.10).md">Есенткуотаексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есенткуотаексцептион.</td>
</tr>
</tbody>
</table>
