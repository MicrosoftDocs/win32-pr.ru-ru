---
description: 'Дополнительные сведения: методы Есентслвхеадербадчекксумексцептион'
title: 'Методы EsentSLVHeaderBadChecksumException '
...
ms.locfileid: "104540810"
---
# <a name="esentslvheaderbadchecksumexception-methods"></a>Методы EsentSLVHeaderBadChecksumException 
