---
description: Дополнительные сведения о перечислении Пререадиндексранжесгрбит
title: Перечисление Пререадиндексранжесгрбит (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "105683592"
---
# <a name="prereadindexrangesgrbit-enumeration"></a>Перечисление Пререадиндексранжесгрбит

Параметры для [жетпререадиндексранжес (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , пререадиндексранжесгрбит)](./windows8api.jetprereadindexranges-method.md).
...
<td></td>
<td>Назад</td>
<td>Прочтите обратно.</td>
</tr>
<tr class="odd">
<td></td>
<td>фирстпажеонли</td>
<td>Предварительное чтение только первой страницы любого столбца Long.</td>
</tr>
<tr class="even">
<td></td>
<td>нормализедкэй</td>
<td>Нормализованное значение ключа или закладки вместо значения столбца.</td>
</tr>
</tbody>
</table>
