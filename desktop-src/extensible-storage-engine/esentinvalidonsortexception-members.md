...
ms.locfileid: "119783668"
---
# <a name="esentinvalidonsortexception-members"></a>Элементы Есентинвалидонсортексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидонсорт.

Тип [есентинвалидонсортексцептион](./esentinvalidonsortexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319594(v=exchg.10).md">есентинвалидонсортексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидонсортексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидонсортексцептион](./esentinvalidonsortexception-class.md)
