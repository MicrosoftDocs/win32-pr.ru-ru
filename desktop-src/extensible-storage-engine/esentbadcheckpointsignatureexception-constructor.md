---
description: 'Дополнительные сведения о: конструктор Есентбадчеккпоинтсигнатуриксцептион'
title: Конструктор Есентбадчеккпоинтсигнатуриксцептион
...
ms.locfileid: "104272200"
---
# <a name="esentbadcheckpointsignatureexception-constructor"></a>Конструктор Есентбадчеккпоинтсигнатуриксцептион

Инициализирует новый экземпляр класса Есентбадчеккпоинтсигнатуриксцептион.
...
[Элементы Есентбадчеккпоинтсигнатуриксцептион](./esentbadcheckpointsignatureexception-members.md)
