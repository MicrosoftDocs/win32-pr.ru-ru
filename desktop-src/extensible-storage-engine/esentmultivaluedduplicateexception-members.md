---
description: 'Дополнительные сведения о: Есентмултивалуеддупликатиксцептион Members'
title: Элементы Есентмултивалуеддупликатиксцептион
...
ms.locfileid: "119851944"
---
# <a name="esentmultivaluedduplicateexception-members"></a>Элементы Есентмултивалуеддупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Мултивалуеддупликате.

Тип [есентмултивалуеддупликатиксцептион](./esentmultivaluedduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319637(v=exchg.10).md">есентмултивалуеддупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмултивалуеддупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентмултивалуеддупликатиксцептион](./esentmultivaluedduplicateexception-class.md)
