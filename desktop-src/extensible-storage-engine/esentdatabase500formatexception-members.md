...
---
# <a name="esentdatabase500formatexception-members"></a>Элементы EsentDatabase500FormatException

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Database500Format.

Тип [EsentDatabase500FormatException](./esentdatabase500formatexception-class.md) предоставляет следующие члены.
...
<td>Инициализирует новый экземпляр класса EsentDatabase500FormatException.</td>
</tr>
</tbody>
</table>
...
[Класс EsentDatabase500FormatException](./esentdatabase500formatexception-class.md)
