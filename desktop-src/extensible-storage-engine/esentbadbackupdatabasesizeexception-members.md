...
ms.locfileid: "119976184"
---
# <a name="esentbadbackupdatabasesizeexception-members"></a>Элементы Есентбадбаккупдатабасесизиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Бадбаккупдатабасесизе.

Тип [есентбадбаккупдатабасесизиксцептион](./esentbadbackupdatabasesizeexception-class.md) предоставляет следующие члены.
...
<td><a href="dn273986(v=exchg.10).md">есентбадбаккупдатабасесизиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадбаккупдатабасесизиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадбаккупдатабасесизиксцептион](./esentbadbackupdatabasesizeexception-class.md)
