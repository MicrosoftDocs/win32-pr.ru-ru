---
description: 'Дополнительные сведения о: конструктор UInt64ColumnValue'
title: Конструктор UInt64ColumnValue
...
ms.locfileid: "118070572"
---
# <a name="uint64columnvalue-constructor"></a>Конструктор UInt64ColumnValue
