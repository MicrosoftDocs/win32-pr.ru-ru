---
description: 'Дополнительные сведения о: Есенттуманисортсексцептион Class'
title: Класс Есенттуманисортсексцептион
...
ms.locfileid: "104344442"
---
# <a name="esenttoomanysortsexception-class"></a>Класс Есенттуманисортсексцептион
        ...
        [Microsoft. ISAM. ESENT. Interop. Есентоператионексцептион](./esentoperationexception-class.md)  
          [Microsoft. ISAM. ESENT. Interop. Есентресаурцеексцептион](./esentresourceexception-class.md)  
            [Microsoft. ISAM. ESENT. Interop. Есентмеморексцептион](./esentmemoryexception-class.md)  
              Microsoft. ISAM. ESENT. Interop. Есенттуманисортсексцептион  
...
[Элементы Есенттуманисортсексцептион](./esenttoomanysortsexception-members.md)
