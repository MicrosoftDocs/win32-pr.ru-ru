---
description: Дополнительные сведения о методе Transaction. ToString
title: Transaction. ToString, метод
...
ms.locfileid: "117890345"
---
# <a name="transactiontostring-method"></a>Transaction. ToString, метод

Возвращает [строку](/dotnet/api/system.string) , представляющую текущую [транзакцию](./transaction-class.md).
...
[Строка](/dotnet/api/system.string) , представляющая текущую [транзакцию](./transaction-class.md).  
