---
description: 'Дополнительные сведения: методы Есентиндекскантбуилдексцептион'
title: 'Методы EsentIndexCantBuildException '
...
ms.locfileid: "118081085"
---
# <a name="esentindexcantbuildexception-methods"></a>Методы EsentIndexCantBuildException 
