...
---
# <a name="jet_dbinfomisc2-structure"></a>Структура JET_DBINFOMISC2
...
Структура **JET_DBINFOMISC2** содержит различные сведения о базе данных. Это сведения, содержащиеся в заголовке базы данных.
