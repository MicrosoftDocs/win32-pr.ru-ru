---
description: 'Дополнительные сведения о: Есентдатабасеунаваилабликсцептион Members'
title: Элементы Есентдатабасеунаваилабликсцептион
...
ms.locfileid: "104155767"
---
# <a name="esentdatabaseunavailableexception-members"></a>Элементы Есентдатабасеунаваилабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеунаваилабле.

Тип [есентдатабасеунаваилабликсцептион](./esentdatabaseunavailableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334504(v=exchg.10).md">есентдатабасеунаваилабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеунаваилабликсцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеунаваилабликсцептион](./esentdatabaseunavailableexception-class.md)
