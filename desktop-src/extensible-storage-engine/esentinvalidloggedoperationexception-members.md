...
---
# <a name="esentinvalidloggedoperationexception-members"></a>Элементы Есентинвалидлогжедоператионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидлогжедоператион.

Тип [есентинвалидлогжедоператионексцептион](./esentinvalidloggedoperationexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319549(v=exchg.10).md">есентинвалидлогжедоператионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидлогжедоператионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидлогжедоператионексцептион](./esentinvalidloggedoperationexception-class.md)
