---
description: 'Дополнительные сведения о: ЕсентслврутнотспеЦифиедексцептион Members'
title: Элементы ЕсентслврутнотспеЦифиедексцептион
...
ms.locfileid: "119970134"
---
# <a name="esentslvrootnotspecifiedexception-members"></a>Элементы ЕсентслврутнотспеЦифиедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслврутнотспеЦифиедексцептион](./esentslvrootnotspecifiedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334836(v=exchg.10).md">есентслврутнотспеЦифиедексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[Класс ЕсентслврутнотспеЦифиедексцептион](./esentslvrootnotspecifiedexception-class.md)
