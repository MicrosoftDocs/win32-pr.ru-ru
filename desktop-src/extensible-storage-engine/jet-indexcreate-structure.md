...
Структура **JET_INDEXCREATE** содержит сведения, необходимые для создания индекса данных в базе данных подсистемы расширенного хранилища (ESE). Структура используется такими функциями, как [JetCreateIndex2](./jetcreateindex2-function.md), и в таких структурах, как [JET_TABLECREATE](./jet-tablecreate-structure.md) и [JET_TABLECREATE2](./jet-tablecreate2-structure.md).
...
<td><p>Дублирующиеся записи индекса (ключи) не допускаются. Это применяется при вызове <a href="gg269288(v=exchg.10).md">жетупдате</a> , а не при вызове <a href="gg294137(v=exchg.10).md">жетсетколумн</a> .</p></td>
</tr>
<tr class="even">
...
<td><p>Ни один из столбцов, по которым создается индекс, не может содержать значение <strong>null</strong> .</p></td>
</tr>
<tr class="even">
...
<td><p>Операции с индексами будут протоколироваться неактивно.</p>
...
<td><p>Указание этого флага влияет на интерпретацию поля объединения LCID/пидксуникде в структуре. Установка бита означает, что поле <strong>пидксуникоде</strong> фактически указывает на структуру <a href="gg294097(v=exchg.10).md">JET_UNICODEINDEX</a> . JET_bitIndexUnicode не требуется для индексирования данных в Юникоде. Он используется только для настройки нормализации данных в Юникоде.</p></td>
</tr>
<tr class="even">
...
<p>JET_bitIndexTuples была введена в операционной системе Windows XP.</p></td>
</tr>
<tr class="odd">
...
<p>JET_bitIndexTupleLimits была введена в операционную систему Windows Server 2003.</p></td>
</tr>
<tr class="even">
...
<p>Например, если вы указали этот флаг для индекса по столбцу A, который имеет значения &quot; Red &quot; и &quot; Blue, &quot; а столбец B имеет значения &quot; 1 и 2, то будут &quot; &quot; &quot; созданы следующие записи индекса: &quot; Red &quot; , &quot; 1 &quot; ; &quot; красный &quot; , &quot; 2 &quot; ; &quot; синий &quot; , &quot; 1 &quot; ; &quot; синий &quot; , &quot; 2 &quot; . В противном случае будут созданы следующие записи индекса: &quot; Red &quot; , &quot; 1 &quot; ; &quot; синий &quot; , &quot; 1 &quot; .</p>
<p>JET_bitIndexCrossProduct была введена в операционной системе Windows Vista.</p></td>
</tr>
<tr class="odd">
...
<p>JET_bitIndexKeyMost была введена в Windows Vista.</p></td>
</tr>
<tr class="even">
<td><p>JET_bitIndexDisallowTruncation 0x00010000</p></td>
<td><p>При указании этого флага любое обновление индекса приведет к сбою усечения ключа с JET_errKeyTruncated. В противном случае ключи будут обрезаны без уведомления. Дополнительные сведения об усечении ключа см. в описании функции <a href="gg269329(v=exchg.10).md">жетмакекэй</a> .</p>
<p><strong>Windows Vista: JET_bitIndexDisallowTruncation</strong> впервые появился в Windows Vista.</p></td>
</tr>
<tr class="odd">
<td><p>JET_bitIndexNestedTable 0x00020000</p></td>
<td><p>Задание этого флага приведет к обновлению индекса по нескольким многозначным столбцам, но только со значениями одного <strong>итагсекуенце</strong>.</p>
<p>JET_bitIndexNestedTable была введена в Windows Vista.</p></td>
</tr>
</tbody>
</table>
...
<td><p>Реализуется как <strong>JET_ INDEXCREATE_W</strong> (Юникод) и <strong>JET_ INDEXCREATE_A</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
