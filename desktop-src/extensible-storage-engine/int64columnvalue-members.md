...
---
# <a name="int64columnvalue-members"></a>Элементы Int64ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [Int64](/dotnet/api/system.int64) .

Тип [Int64ColumnValue](./int64columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn335027(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351018(v=exchg.10).md">жетвалуефромбитес</a></td>
