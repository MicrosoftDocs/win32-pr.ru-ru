---
description: 'Дополнительные сведения о: Есентинвалидобжектексцептион Members'
title: Элементы Есентинвалидобжектексцептион
...
ms.locfileid: "104558002"
---
# <a name="esentinvalidobjectexception-members"></a>Элементы Есентинвалидобжектексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидобжект.

Тип [есентинвалидобжектексцептион](./esentinvalidobjectexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319567(v=exchg.10).md">есентинвалидобжектексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидобжектексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидобжектексцептион](./esentinvalidobjectexception-class.md)
