...
---
# <a name="esentinvalidinstanceexception-members"></a>Элементы Есентинвалидинстанцеексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидинстанце.

Тип [есентинвалидинстанцеексцептион](./esentinvalidinstanceexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319525(v=exchg.10).md">есентинвалидинстанцеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидинстанцеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидинстанцеексцептион](./esentinvalidinstanceexception-class.md)
