---
description: 'Дополнительные сведения о свойстве: SystemParameters. Качесиземин'
title: SystemParameters. Качесиземин, свойство
...
ms.locfileid: "104547151"
---
# <a name="systemparameterscachesizemin-property"></a>SystemParameters. Качесиземин, свойство

Возвращает или задает минимальный размер кэша страниц базы данных в страницах базы данных.
