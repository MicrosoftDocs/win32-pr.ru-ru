...
ms.locfileid: "119724384"
---
# <a name="esentinvalidcolumntypeexception-members"></a>Элементы Есентинвалидколумнтипиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидколумнтипе.

Тип [есентинвалидколумнтипиксцептион](./esentinvalidcolumntypeexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319462(v=exchg.10).md">есентинвалидколумнтипиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидколумнтипиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидколумнтипиксцептион](./esentinvalidcolumntypeexception-class.md)
