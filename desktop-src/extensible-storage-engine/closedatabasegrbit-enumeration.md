...
---
# <a name="closedatabasegrbit-enumeration"></a>Перечисление Клоседатабасегрбит

Параметры для [жетклоседатабасе (JET_SESID, JET_DBID, клоседатабасегрбит)](./api.jetclosedatabase-method.md).
