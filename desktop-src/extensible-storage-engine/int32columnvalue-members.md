...
---
# <a name="int32columnvalue-members"></a>Элементы Int32ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [Int32](/dotnet/api/system.int32) .

Тип [Int32ColumnValue](./int32columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn350998(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn350996(v=exchg.10).md">жетвалуефромбитес</a></td>
