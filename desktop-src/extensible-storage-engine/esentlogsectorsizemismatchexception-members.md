...
ms.locfileid: "119782884"
---
# <a name="esentlogsectorsizemismatchexception-members"></a>Элементы Есентлогсекторсиземисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логсекторсиземисматч.

Тип [есентлогсекторсиземисматчексцептион](./esentlogsectorsizemismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334649(v=exchg.10).md">есентлогсекторсиземисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогсекторсиземисматчексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогсекторсиземисматчексцептион](./esentlogsectorsizemismatchexception-class.md)
