---
description: 'Дополнительные сведения о: Есентдатабасекорруптеднорепаирексцептион свойства'
title: Свойства Есентдатабасекорруптеднорепаирексцептион
...
ms.locfileid: "104567709"
---
# <a name="esentdatabasecorruptednorepairexception-properties"></a>Свойства Есентдатабасекорруптеднорепаирексцептион
