---
description: 'Дополнительные сведения: методы Есентдискреадверификатионфаилуриксцептион'
title: 'Методы EsentDiskReadVerificationFailureException '
...
ms.locfileid: "104081514"
---
# <a name="esentdiskreadverificationfailureexception-methods"></a>Методы EsentDiskReadVerificationFailureException 
