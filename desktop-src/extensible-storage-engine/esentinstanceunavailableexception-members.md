---
description: 'Дополнительные сведения о: Есентинстанцеунаваилабликсцептион Members'
title: Элементы Есентинстанцеунаваилабликсцептион
...
ms.locfileid: "104550192"
---
# <a name="esentinstanceunavailableexception-members"></a>Элементы Есентинстанцеунаваилабликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инстанцеунаваилабле.

Тип [есентинстанцеунаваилабликсцептион](./esentinstanceunavailableexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319393(v=exchg.10).md">есентинстанцеунаваилабликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинстанцеунаваилабликсцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинстанцеунаваилабликсцептион](./esentinstanceunavailableexception-class.md)
