...
ms.locfileid: "118259855"
---
# <a name="esentslvdatabasemissingexception-members"></a>Элементы Есентслвдатабасемиссинжексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслвдатабасемиссинжексцептион](./esentslvdatabasemissingexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350675(v=exchg.10).md">есентслвдатабасемиссинжексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
