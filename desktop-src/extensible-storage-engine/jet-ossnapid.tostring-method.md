---
description: 'Дополнительные сведения о: JET_OSSNAPID. Метод ToString, список перегрузок'
...
ms.locfileid: "104570858"
---
# <a name="jet_ossnapidtostring-method-overload-list"></a>JET_OSSNAPID. Метод ToString, список перегрузок
