...
ms.locfileid: "119040392"
---
# <a name="esentntsystemcallfailedexception-members"></a>Элементы Есентнтсистемкаллфаиледексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Нтсистемкаллфаилед.

Тип [есентнтсистемкаллфаиледексцептион](./esentntsystemcallfailedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319693(v=exchg.10).md">есентнтсистемкаллфаиледексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнтсистемкаллфаиледексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнтсистемкаллфаиледексцептион](./esentntsystemcallfailedexception-class.md)
