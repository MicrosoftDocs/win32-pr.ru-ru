---
description: 'Дополнительные сведения: методы Есентдискексцептион'
title: 'Методы EsentDiskException '
...
ms.locfileid: "104566217"
---
# <a name="esentdiskexception-methods"></a>Методы EsentDiskException 
