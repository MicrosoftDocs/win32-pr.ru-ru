---
description: 'Дополнительные сведения о: EsentDatabase200FormatException Members'
title: Элементы EsentDatabase200FormatException
...
ms.locfileid: "120094494"
---
# <a name="esentdatabase200formatexception-members"></a>Элементы EsentDatabase200FormatException

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Database200Format.

Тип [EsentDatabase200FormatException](./esentdatabase200formatexception-class.md) предоставляет следующие члены.
...
<td>Инициализирует новый экземпляр класса EsentDatabase200FormatException.</td>
</tr>
</tbody>
</table>
...
[Класс EsentDatabase200FormatException](./esentdatabase200formatexception-class.md)
