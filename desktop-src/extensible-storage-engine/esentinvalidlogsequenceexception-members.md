---
description: 'Дополнительные сведения о: Есентинвалидлогсекуенцеексцептион Members'
title: Элементы Есентинвалидлогсекуенцеексцептион
...
ms.locfileid: "104265151"
---
# <a name="esentinvalidlogsequenceexception-members"></a>Элементы Есентинвалидлогсекуенцеексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидлогсекуенце.

Тип [есентинвалидлогсекуенцеексцептион](./esentinvalidlogsequenceexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319556(v=exchg.10).md">есентинвалидлогсекуенцеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидлогсекуенцеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидлогсекуенцеексцептион](./esentinvalidlogsequenceexception-class.md)
