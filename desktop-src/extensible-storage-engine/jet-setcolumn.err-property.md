---
description: 'Дополнительные сведения о свойстве: JET_SETCOLUMN. ERR'
title: Свойство JET_SETCOLUMN. ERR
...
ms.locfileid: "103990984"
---
# <a name="jet_setcolumnerr-property"></a>Свойство JET_SETCOLUMN. ERR

Возвращает код ошибки или предупреждение, возвращенное операцией задания столбца.
