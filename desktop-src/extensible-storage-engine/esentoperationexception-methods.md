---
description: 'Дополнительные сведения: методы Есентоператионексцептион'
title: 'Методы EsentOperationException '
...
ms.locfileid: "104264146"
---
# <a name="esentoperationexception-methods"></a>Методы EsentOperationException 
