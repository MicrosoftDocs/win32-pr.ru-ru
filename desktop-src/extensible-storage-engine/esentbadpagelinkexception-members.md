---
description: 'Дополнительные сведения о: Есентбадпажелинкексцептион Members'
title: Элементы Есентбадпажелинкексцептион
...
ms.locfileid: "119725204"
---
# <a name="esentbadpagelinkexception-members"></a>Элементы Есентбадпажелинкексцептион
...
Тип [есентбадпажелинкексцептион](./esentbadpagelinkexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274085(v=exchg.10).md">есентбадпажелинкексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадпажелинкексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадпажелинкексцептион](./esentbadpagelinkexception-class.md)
