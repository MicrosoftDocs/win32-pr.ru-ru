...
ms.locfileid: "118983304"
---
# <a name="apijetgetobjectinfo-method-jet_sesid-jet_dbid-jet_objectlist"></a>Метод API. Жетжетобжектинфо (JET_SESID, JET_DBID, JET_OBJECTLIST)

Извлекает сведения об объектах базы данных.
...
<!-- end list -->
  ...
  - ObjectList  
    Тип: [Microsoft.ISAM.ESENT.Interop.JET_OBJECTLIST](./jet-objectlist-class.md)  
...
[Перегрузка Жетжетобжектинфо](./api.jetgetobjectinfo-method.md)
