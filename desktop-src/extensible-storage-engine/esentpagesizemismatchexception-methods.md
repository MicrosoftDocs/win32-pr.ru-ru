---
description: 'Дополнительные сведения: методы Есентпажесиземисматчексцептион'
title: 'Методы EsentPageSizeMismatchException '
...
ms.locfileid: "118492211"
---
# <a name="esentpagesizemismatchexception-methods"></a>Методы EsentPageSizeMismatchException 
