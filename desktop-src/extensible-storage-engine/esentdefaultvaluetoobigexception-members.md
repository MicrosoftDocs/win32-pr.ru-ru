---
description: 'Дополнительные сведения о: Есентдефаултвалуетубижексцептион Members'
title: Элементы Есентдефаултвалуетубижексцептион
...
ms.locfileid: "104080663"
---
# <a name="esentdefaultvaluetoobigexception-members"></a>Элементы Есентдефаултвалуетубижексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дефаултвалуетубиг.

Тип [есентдефаултвалуетубижексцептион](./esentdefaultvaluetoobigexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334426(v=exchg.10).md">есентдефаултвалуетубижексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдефаултвалуетубижексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдефаултвалуетубижексцептион](./esentdefaultvaluetoobigexception-class.md)
