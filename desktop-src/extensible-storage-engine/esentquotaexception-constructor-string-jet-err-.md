...
---
# <a name="esentquotaexception-constructor-string-jet_err"></a>Конструктор Есенткуотаексцептион (String, JET_err)

Инициализирует новый экземпляр класса Есенткуотаексцептион.
