...
Базовый класс для JET_err. Исключения Дискфулл.

Тип [есентдискфуллексцептион](./esentdiskfullexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334468(v=exchg.10).md">есентдискфуллексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдискфуллексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдискфуллексцептион](./esentdiskfullexception-class.md)
