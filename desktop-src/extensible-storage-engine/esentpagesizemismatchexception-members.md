...
---
# <a name="esentpagesizemismatchexception-members"></a>Элементы Есентпажесиземисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Пажесиземисматч.

Тип [есентпажесиземисматчексцептион](./esentpagesizemismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319779(v=exchg.10).md">есентпажесиземисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентпажесиземисматчексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентпажесиземисматчексцептион](./esentpagesizemismatchexception-class.md)
