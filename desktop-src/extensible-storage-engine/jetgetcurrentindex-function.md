...
| <p><strong>Юникод</strong></p> | <p>Реализуется как <strong>жетжеткуррентиндексв</strong> (Юникод) и <strong>жетжеткуррентиндекса</strong> (ANSI).</p> | 
