---
description: 'Дополнительные сведения о: Есентдатабасекорруптедексцептион Members'
title: Элементы Есентдатабасекорруптедексцептион
...
ms.locfileid: "119116474"
---
# <a name="esentdatabasecorruptedexception-members"></a>Элементы Есентдатабасекорруптедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасекорруптед.

Тип [есентдатабасекорруптедексцептион](./esentdatabasecorruptedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334282(v=exchg.10).md">есентдатабасекорруптедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасекорруптедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасекорруптедексцептион](./esentdatabasecorruptedexception-class.md)
