---
description: 'Дополнительные сведения: методы Есентверсионсторинтритубижексцептион'
title: 'Методы EsentVersionStoreEntryTooBigException '
...
ms.locfileid: "103998597"
---
# <a name="esentversionstoreentrytoobigexception-methods"></a>Методы EsentVersionStoreEntryTooBigException 
