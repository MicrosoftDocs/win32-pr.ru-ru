---
description: 'Дополнительные сведения о: Есентколумнлонжексцептион Members'
title: Элементы Есентколумнлонжексцептион
...
ms.locfileid: "119622109"
---
# <a name="esentcolumnlongexception-members"></a>Элементы Есентколумнлонжексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнлонг.

Тип [есентколумнлонжексцептион](./esentcolumnlongexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274186(v=exchg.10).md">есентколумнлонжексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнлонжексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнлонжексцептион](./esentcolumnlongexception-class.md)
