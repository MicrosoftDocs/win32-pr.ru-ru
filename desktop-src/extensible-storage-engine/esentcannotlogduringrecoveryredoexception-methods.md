---
description: 'Дополнительные сведения: методы Есентканнотлогдурингрековериредоексцептион'
title: 'Методы EsentCannotLogDuringRecoveryRedoException '
...
ms.locfileid: "104556990"
---
# <a name="esentcannotlogduringrecoveryredoexception-methods"></a>Методы EsentCannotLogDuringRecoveryRedoException 
