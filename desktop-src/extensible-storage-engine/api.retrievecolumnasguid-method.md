---
description: Дополнительные сведения о методе API. Ретриевеколумнасгуид
title: API. Ретриевеколумнасгуид, метод
...
ms.locfileid: "119977414"
---
# <a name="apiretrievecolumnasguid-method"></a>API. Ретриевеколумнасгуид, метод
