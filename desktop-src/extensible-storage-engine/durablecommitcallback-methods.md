---
description: 'Дополнительные сведения: методы Дураблекоммиткаллбакк'
title: Методы Дураблекоммиткаллбакк (Microsoft. ISAM. ESENT. Interop. Windows8)
...
ms.locfileid: "119623444"
---
# <a name="durablecommitcallback-methods"></a>Методы Дураблекоммиткаллбакк

Включить защищенные члены  
Включить унаследованные члены  

Тип [дураблекоммиткаллбакк](./durablecommitcallback-class.md) предоставляет следующие члены.
...
<td>Завершает сеанс долговременной фиксации.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn335327(v=exchg.10).md">релеасересаурце</a></td>
<td>Освобождает сеанс долговременной фиксации. (Переопределяет <a href="dn350545(v=exchg.10).md">есентресаурце. релеасересаурце ()</a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
...
<td>Формирует строковое представление структуры. (Переопределяет <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
