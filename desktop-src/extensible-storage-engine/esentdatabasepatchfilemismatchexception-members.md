...
ms.locfileid: "118780823"
---
# <a name="esentdatabasepatchfilemismatchexception-members"></a>Элементы Есентдатабасепатчфилемисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасепатчфилемисматч.

Тип [есентдатабасепатчфилемисматчексцептион](./esentdatabasepatchfilemismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334480(v=exchg.10).md">есентдатабасепатчфилемисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасепатчфилемисматчексцептион.</td>
</tr>
</tbody>
</table>
