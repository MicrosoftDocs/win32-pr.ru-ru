---
description: 'Дополнительные сведения: методы Есенттестинжектионнотсуппортедексцептион'
title: 'Методы EsentTestInjectionNotSupportedException '
...
ms.locfileid: "119721524"
---
# <a name="esenttestinjectionnotsupportedexception-methods"></a>Методы EsentTestInjectionNotSupportedException 
