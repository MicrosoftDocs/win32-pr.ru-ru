...
---
# <a name="esentlogtornwriteduringhardrestoreexception-members"></a>Элементы Есентлогторнвритедурингхардресториксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логторнвритедурингхардресторе.

Тип [есентлогторнвритедурингхардресториксцептион](./esentlogtornwriteduringhardrestoreexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334610(v=exchg.10).md">есентлогторнвритедурингхардресториксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогторнвритедурингхардресториксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогторнвритедурингхардресториксцептион](./esentlogtornwriteduringhardrestoreexception-class.md)
