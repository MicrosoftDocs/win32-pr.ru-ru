---
description: 'Подробнее о: Есентстопватч. Elapsed Property'
title: Есентстопватч. Elapsed, свойство
...
ms.locfileid: "118490501"
---
# <a name="esentstopwatchelapsed-property"></a>Есентстопватч. Elapsed, свойство
