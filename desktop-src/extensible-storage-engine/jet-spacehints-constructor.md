---
description: 'Дополнительные сведения о: конструктор JET_SPACEHINTS'
title: Конструктор JET_SPACEHINTS
...
ms.locfileid: "104143561"
---
# <a name="jet_spacehints-constructor"></a>Конструктор JET_SPACEHINTS
