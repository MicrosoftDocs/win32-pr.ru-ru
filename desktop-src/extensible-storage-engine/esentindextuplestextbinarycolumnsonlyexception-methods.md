---
description: 'Дополнительные сведения: методы Есентиндекступлестекстбинариколумнсонлексцептион'
title: 'Методы EsentIndexTuplesTextBinaryColumnsOnlyException '
...
ms.locfileid: "103813241"
---
# <a name="esentindextuplestextbinarycolumnsonlyexception-methods"></a>Методы EsentIndexTuplesTextBinaryColumnsOnlyException 
