---
description: 'Дополнительные сведения: операторы JET_TABLEID'
title: Операторы JET_TABLEID
...
ms.locfileid: "119729034"
---
# <a name="jet_tableid-operators"></a>Операторы JET_TABLEID
