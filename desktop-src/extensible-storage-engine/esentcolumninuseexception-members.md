...
ms.locfileid: "117713977"
---
# <a name="esentcolumninuseexception-members"></a>Элементы Есентколумнинусиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнинусе.

Тип [есентколумнинусиксцептион](./esentcolumninuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274178(v=exchg.10).md">есентколумнинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумнинусиксцептион](./esentcolumninuseexception-class.md)
