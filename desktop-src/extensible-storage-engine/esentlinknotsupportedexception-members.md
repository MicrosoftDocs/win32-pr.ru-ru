---
description: 'Дополнительные сведения о: Есентлинкнотсуппортедексцептион Members'
title: Элементы Есентлинкнотсуппортедексцептион
...
ms.locfileid: "119115824"
---
# <a name="esentlinknotsupportedexception-members"></a>Элементы Есентлинкнотсуппортедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Линкнотсуппортед.

Тип [есентлинкнотсуппортедексцептион](./esentlinknotsupportedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334576(v=exchg.10).md">есентлинкнотсуппортедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлинкнотсуппортедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлинкнотсуппортедексцептион](./esentlinknotsupportedexception-class.md)
