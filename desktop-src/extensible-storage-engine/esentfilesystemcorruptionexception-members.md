...
---
# <a name="esentfilesystemcorruptionexception-members"></a>Элементы Есентфилесистемкорруптионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Филесистемкорруптион.

Тип [есентфилесистемкорруптионексцептион](./esentfilesystemcorruptionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274382(v=exchg.10).md">есентфилесистемкорруптионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфилесистемкорруптионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфилесистемкорруптионексцептион](./esentfilesystemcorruptionexception-class.md)
