...
ms.locfileid: "118259498"
---
# <a name="esentspavailextcorruptedexception-members"></a>Элементы Есентспаваилексткорруптедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Спаваилексткорруптед.

Тип [есентспаваилексткорруптедексцептион](./esentspavailextcorruptedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334915(v=exchg.10).md">есентспаваилексткорруптедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентспаваилексткорруптедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентспаваилексткорруптедексцептион](./esentspavailextcorruptedexception-class.md)
