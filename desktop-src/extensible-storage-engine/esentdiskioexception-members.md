...
ms.locfileid: "119481354"
---
# <a name="esentdiskioexception-members"></a>Элементы Есентдискиоексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Дискио.

Тип [есентдискиоексцептион](./esentdiskioexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334471(v=exchg.10).md">есентдискиоексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдискиоексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдискиоексцептион](./esentdiskioexception-class.md)
