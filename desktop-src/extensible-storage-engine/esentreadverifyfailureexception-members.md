---
description: 'Дополнительные сведения о: Есентреадверифифаилуриксцептион Members'
title: Элементы Есентреадверифифаилуриксцептион
...
ms.locfileid: "119947051"
---
# <a name="esentreadverifyfailureexception-members"></a>Элементы Есентреадверифифаилуриксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Реадверифифаилуре.

Тип [есентреадверифифаилуриксцептион](./esentreadverifyfailureexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319873(v=exchg.10).md">есентреадверифифаилуриксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентреадверифифаилуриксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентреадверифифаилуриксцептион](./esentreadverifyfailureexception-class.md)
