...
---
# <a name="datetimecolumnvalue-members"></a>Элементы Датетимеколумнвалуе

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [GUID](/dotnet/api/system.guid) .

Тип [датетимеколумнвалуе](./datetimecolumnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn334240(v=exchg.10).md">датетимеколумнвалуе</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn334225(v=exchg.10).md">Длина</a></td>
<td>Возвращает длину в байтах значения столбца, равного нулю, если столбец имеет значение null, в противном случае соответствует размеру для этого столбца фиксированного размера. (Наследуется от <a href="dn334171(v=exchg.10).md">колумнвалуеофструкт &lt; T &gt; </a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
...
<td><a href="dn334243(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn334180(v=exchg.10).md">Значение</a></td>
<td>Возвращает или задает значение в структуре. (Наследуется от <a href="dn334171(v=exchg.10).md">колумнвалуеофструкт &lt; T &gt; </a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Открытое свойство" alt="Public property" /></td>
<td><a href="dn334226(v=exchg.10).md">валуеасобжект</a></td>
<td>Возвращает последнее набор или полученное значение столбца. Значение возвращается в виде универсального объекта. (Наследуется от <a href="dn334171(v=exchg.10).md">колумнвалуеофструкт &lt; T &gt; </a>.)</td>
</tr>
</tbody>
</table>
...
<td>Убедитесь, что полученные данные точно соответствуют размеру, требуемому для структуры. При несовпадении возникает исключение. (Наследуется от <a href="dn334171(v=exchg.10).md">колумнвалуеофструкт &lt; T &gt; </a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn334242(v=exchg.10).md">жетвалуефромбитес</a></td>
...
<td>Возвращает строковое представление этого объекта. (Наследуется от <a href="dn334171(v=exchg.10).md">колумнвалуеофструкт &lt; T &gt; </a>.)</td>
</tr>
</tbody>
</table>
