...
---
# <a name="esenttoomanyopentablesexception-members"></a>Элементы Есенттуманйопентаблесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Туманйопентаблес.

Тип [есенттуманйопентаблесексцептион](./esenttoomanyopentablesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350790(v=exchg.10).md">есенттуманйопентаблесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттуманйопентаблесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттуманйопентаблесексцептион](./esenttoomanyopentablesexception-class.md)
