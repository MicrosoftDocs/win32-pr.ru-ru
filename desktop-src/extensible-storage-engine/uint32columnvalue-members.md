...
ms.locfileid: "118071136"
---
# <a name="uint32columnvalue-members"></a>Элементы UInt32ColumnValue

Включить защищенные члены  
Включить унаследованные члены  

Значение столбца [UInt32](/dotnet/api/system.uint32) .

Тип [UInt32ColumnValue](./uint32columnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn351253(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn351252(v=exchg.10).md">жетвалуефромбитес</a></td>
