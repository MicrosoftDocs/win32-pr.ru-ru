...
---
# <a name="windows8apijetstopserviceinstance2-method"></a>Windows8Api. JetStopServiceInstance2, метод

Подготавливает экземпляр к завершению. Также можно использовать для возобновления предыдущего замораживания.
...
#### <a name="parameters"></a>Параметры
  ...
  - экземпляр  
    ...
    Используемый экземпляр (выполняющийся).

<!-- end list -->

  - грбит  
    Тип: [Microsoft. ISAM. ESENT. Interop. Windows8. стопсервицегрбит](./stopservicegrbit-enumeration.md)  
    
    Параметры для завершения или возобновления работы экземпляра.
