---
description: 'Дополнительные сведения о свойстве: JET_OBJECTLIST. колумнидгрбит'
title: Свойство JET_OBJECTLIST. колумнидгрбит
...
ms.locfileid: "118254173"
---
# <a name="jet_objectlistcolumnidgrbit-property"></a>Свойство JET_OBJECTLIST. колумнидгрбит

Возвращает значение columnid столбца во временной таблице, в котором хранится грбитс, используемый при создании таблицы.
