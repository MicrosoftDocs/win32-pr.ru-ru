...
ms.locfileid: "119738384"
---
# <a name="apitrymovenext-method"></a>API. Тримовенекст, метод

Попробуйте перейти к следующей записи в таблице. Если следующая запись не возвращает значение false, то в случае возникновения другой ошибки возникает исключение.
