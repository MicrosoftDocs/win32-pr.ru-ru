...
ms.locfileid: "117713103"
---
# <a name="esentdatabaseleakinspaceexception-members"></a>Элементы Есентдатабаселеакинспацеексцептион
...
Тип [есентдатабаселеакинспацеексцептион](./esentdatabaseleakinspaceexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334351(v=exchg.10).md">есентдатабаселеакинспацеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабаселеакинспацеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабаселеакинспацеексцептион](./esentdatabaseleakinspaceexception-class.md)
