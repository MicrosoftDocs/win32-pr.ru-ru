---
description: 'Дополнительные сведения: методы Есентстреамингдатанотлогжедексцептион'
title: 'Методы EsentStreamingDataNotLoggedException '
...
ms.locfileid: "118769546"
---
# <a name="esentstreamingdatanotloggedexception-methods"></a>Методы EsentStreamingDataNotLoggedException 
