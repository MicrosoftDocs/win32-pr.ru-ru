---
description: 'Дополнительные сведения: методы EsentMustCommitDistributedTransactionToLevel0Exception'
title: 'Методы EsentMustCommitDistributedTransactionToLevel0Exception '
...
ms.locfileid: "104544578"
---
# <a name="esentmustcommitdistributedtransactiontolevel0exception-methods"></a>Методы EsentMustCommitDistributedTransactionToLevel0Exception 
