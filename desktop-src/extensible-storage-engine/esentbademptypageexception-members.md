...
ms.locfileid: "118083009"
---
# <a name="esentbademptypageexception-members"></a>Элементы Есентбадемптипажеексцептион
...
Тип [есентбадемптипажеексцептион](./esentbademptypageexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274064(v=exchg.10).md">есентбадемптипажеексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадемптипажеексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадемптипажеексцептион](./esentbademptypageexception-class.md)
