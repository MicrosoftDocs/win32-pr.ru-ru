...
---
# <a name="esentoutofmemoryexception-members"></a>Элементы Есентаутофмеморексцептион
...
Тип [есентаутофмеморексцептион](./esentoutofmemoryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319744(v=exchg.10).md">есентаутофмеморексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаутофмеморексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаутофмеморексцептион](./esentoutofmemoryexception-class.md)
