...
ms.locfileid: "119041962"
---
# <a name="esentcolumndoesnotfitexception-members"></a>Элементы Есентколумндоеснотфитексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумндоеснотфит.

Тип [есентколумндоеснотфитексцептион](./esentcolumndoesnotfitexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274153(v=exchg.10).md">есентколумндоеснотфитексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумндоеснотфитексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентколумндоеснотфитексцептион](./esentcolumndoesnotfitexception-class.md)
