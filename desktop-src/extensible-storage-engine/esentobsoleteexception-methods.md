---
description: 'Дополнительные сведения: методы Есентобсолетиксцептион'
title: 'Методы EsentObsoleteException '
...
ms.locfileid: "104080658"
---
# <a name="esentobsoleteexception-methods"></a>Методы EsentObsoleteException 
