...
---
# <a name="esentcolumncannotbecompressedexception-members"></a>Элементы Есентколумнканнотбекомпресседексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Колумнканнотбекомпрессед.

Тип [есентколумнканнотбекомпресседексцептион](./esentcolumncannotbecompressedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274221(v=exchg.10).md">есентколумнканнотбекомпресседексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентколумнканнотбекомпресседексцептион.</td>
</tr>
</tbody>
</table>
