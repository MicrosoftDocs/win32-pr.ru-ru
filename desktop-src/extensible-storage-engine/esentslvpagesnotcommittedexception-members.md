...
ms.locfileid: "118772419"
---
# <a name="esentslvpagesnotcommittedexception-members"></a>Элементы Есентслвпажесноткоммиттедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентслвпажесноткоммиттедексцептион](./esentslvpagesnotcommittedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350721(v=exchg.10).md">есентслвпажесноткоммиттедексцептион</a></td>
<td></td>
</tr>
</tbody>
</table>
...
[Класс Есентслвпажесноткоммиттедексцептион](./esentslvpagesnotcommittedexception-class.md)
