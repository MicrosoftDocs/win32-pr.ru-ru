...
Параметры для [жетресизедатабасе (JET_SESID, JET_DBID, Int32, Int32, ресизедатабасегрбит)](./windows8api.jetresizedatabase-method.md).
...
<td></td>
<td>онлигров</td>
<td>Увеличивать только базу данных. Если при вызове изменения размера база данных будет сжата, ничего делать не нужно.</td>
</tr>
</tbody>
</table>
