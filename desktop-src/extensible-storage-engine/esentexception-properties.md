---
description: 'Дополнительные сведения о: Есентексцептион свойства'
title: Свойства Есентексцептион (Microsoft. ISAM. ESENT)
...
ms.locfileid: "118496970"
---
# <a name="esentexception-properties"></a>Свойства Есентексцептион

Включить защищенные члены  
Включить унаследованные члены  

Тип [есентексцептион](./esentexception-class.md) предоставляет следующие члены.
