...
ms.locfileid: "118270748"
---
# <a name="esentdecompressionfailedexception-constructor"></a>Конструктор Есентдекомпрессионфаиледексцептион

Инициализирует новый экземпляр класса Есентдекомпрессионфаиледексцептион.
