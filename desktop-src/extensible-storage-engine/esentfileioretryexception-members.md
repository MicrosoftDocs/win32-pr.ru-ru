---
description: 'Дополнительные сведения о: Есентфилеиоретрексцептион Members'
title: Элементы Есентфилеиоретрексцептион
...
ms.locfileid: "104566214"
---
# <a name="esentfileioretryexception-members"></a>Элементы Есентфилеиоретрексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Филеиоретри.

Тип [есентфилеиоретрексцептион](./esentfileioretryexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274366(v=exchg.10).md">есентфилеиоретрексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфилеиоретрексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфилеиоретрексцептион](./esentfileioretryexception-class.md)
