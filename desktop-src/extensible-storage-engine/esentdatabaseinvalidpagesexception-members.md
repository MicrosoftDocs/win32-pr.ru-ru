---
description: 'Дополнительные сведения о: Есентдатабасеинвалидпажесексцептион Members'
title: Элементы Есентдатабасеинвалидпажесексцептион
...
ms.locfileid: "119785164"
---
# <a name="esentdatabaseinvalidpagesexception-members"></a>Элементы Есентдатабасеинвалидпажесексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Датабасеинвалидпажес.

Тип [есентдатабасеинвалидпажесексцептион](./esentdatabaseinvalidpagesexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334340(v=exchg.10).md">есентдатабасеинвалидпажесексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдатабасеинвалидпажесексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдатабасеинвалидпажесексцептион](./esentdatabaseinvalidpagesexception-class.md)
