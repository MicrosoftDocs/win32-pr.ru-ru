---
description: 'Дополнительные сведения: методы Есентдатабасекорруптеднорепаирексцептион'
title: 'Методы EsentDatabaseCorruptedNoRepairException '
...
ms.locfileid: "104553880"
---
# <a name="esentdatabasecorruptednorepairexception-methods"></a>Методы EsentDatabaseCorruptedNoRepairException 
