...
ms.locfileid: "119478474"
---
# <a name="esentoutofbuffersexception-constructor"></a>Конструктор Есентаутофбуфферсексцептион

Инициализирует новый экземпляр класса Есентаутофбуфферсексцептион.
...
[Элементы Есентаутофбуфферсексцептион](./esentoutofbuffersexception-members.md)
