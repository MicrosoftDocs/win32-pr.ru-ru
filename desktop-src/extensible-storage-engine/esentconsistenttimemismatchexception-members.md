...
---
# <a name="esentconsistenttimemismatchexception-members"></a>Элементы Есентконсистенттимемисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Консистенттимемисматч.

Тип [есентконсистенттимемисматчексцептион](./esentconsistenttimemismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274214(v=exchg.10).md">есентконсистенттимемисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентконсистенттимемисматчексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентконсистенттимемисматчексцептион](./esentconsistenttimemismatchexception-class.md)
