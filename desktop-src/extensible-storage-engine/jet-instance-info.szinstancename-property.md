...
---
# <a name="jet_instance_infoszinstancename-property"></a>Свойство JET_INSTANCE_INFO. Сзинстанценаме

Возвращает имя экземпляра базы данных. Это значение может быть равно null, если у экземпляра нет имени.
