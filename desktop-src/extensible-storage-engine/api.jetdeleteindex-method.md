...
ms.locfileid: "119605674"
---
# <a name="apijetdeleteindex-method"></a>API. Жетделетеиндекс, метод

Удаляет индекс из таблицы базы данных.
...
<!-- end list -->
  ...
  - TableID  
    ...
    Курсор в таблице, из которого удаляется индекс.
