---
description: Дополнительные сведения о методе API. Ретриевеколумнасдаубле
title: API. Ретриевеколумнасдаубле, метод
...
ms.locfileid: "104564570"
---
# <a name="apiretrievecolumnasdouble-method"></a>API. Ретриевеколумнасдаубле, метод
