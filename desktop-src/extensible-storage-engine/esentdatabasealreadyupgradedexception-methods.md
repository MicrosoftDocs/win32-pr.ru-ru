---
description: 'Дополнительные сведения: методы Есентдатабасеалреадюпградедексцептион'
title: 'Методы EsentDatabaseAlreadyUpgradedException '
...
ms.locfileid: "104562075"
---
# <a name="esentdatabasealreadyupgradedexception-methods"></a>Методы EsentDatabaseAlreadyUpgradedException 
