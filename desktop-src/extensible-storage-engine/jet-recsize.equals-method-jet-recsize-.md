---
description: 'Дополнительные сведения о: JET_RECSIZE. Метод Equals (JET_RECSIZE)'
title: JET_RECSIZE. Метод Equals (JET_RECSIZE) (Microsoft. ISAM. ESENT. Interop. Vista)
...
ms.locfileid: "105710883"
---
# <a name="jet_recsizeequals-method-jet_recsize"></a>JET_RECSIZE. Метод Equals (JET_RECSIZE)
...
[Перегрузка Equals](./jet-recsize.equals-method.md)
