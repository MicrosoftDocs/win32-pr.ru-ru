...
ms.locfileid: "119117344"
---
# <a name="esentbadcolumnidexception-members"></a>Элементы Есентбадколумнидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Бадколумнид.

Тип [есентбадколумнидексцептион](./esentbadcolumnidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274056(v=exchg.10).md">есентбадколумнидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентбадколумнидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентбадколумнидексцептион](./esentbadcolumnidexception-class.md)
