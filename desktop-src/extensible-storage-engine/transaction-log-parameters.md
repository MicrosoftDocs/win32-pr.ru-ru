...
<tr class="even">
<td><p>Тип:</p></td>
<td><p>JET_GRBIT (целое число)</p></td>
</tr>
<tr class="odd">
<td><p>Допустимый диапазон:</p></td>
<td><p>Допустимый параметр для Жеткоммиттрансактион</p></td>
</tr>
<tr class="even">
<td><p>Область.</p></td>
<td><p>Экземпляр или сеанс</p></td>
</tr>
<tr class="odd">
<td><p>Задать после <a href="gg269354(v=exchg.10).md">жеткреатеинстанце</a>:</p></td>
<td><p>Да</p></td>
...
**Windows 2000:**  При обновлении базы данных с Windows NT до Windows 2000 следует соблюдать осторожность. Если база данных находится в нестабильном состоянии и старые файлы журнала удалены, содержимое базы данных будет потеряно.
...
<tr class="odd">
<td><p>Значение по умолчанию:</p></td>
<td><p><strong>Windows 2000:</strong>  IsFalse</p>
<p><strong>Windows XP:</strong>  Условия</p></td>
</tr>
<tr class="even">
<td><p>Тип:</p></td>
<td><p>Логическое</p></td>
...
<tr class="odd">
<td><p>Значение по умолчанию:</p></td>
<td><p><strong>Windows 2000, Windows XP и Windows Server 2003:</strong>  80</p>
...
<tr class="odd">
<td><p>Допустимый диапазон:</p></td>
<td><p><strong>Windows 2000, Windows XP и Windows Server 2003:</strong>  80 – 2147483647</p>
...
<tr class="odd">
<td><p>Допустимый диапазон:</p></td>
<td><p><strong>Windows 2000, Windows XP и Windows Server 2003:</strong>  128 – 32768</p>
...
Этот параметр используется для указания функций совместимости имен файлов, которые должны поддерживаться в Windows Server 2003 и предыдущей схеме именования файлов. Дополнительные сведения о различных файлах и их именовании см. в разделе [расширяемые файлы подсистемы хранилища](./extensible-storage-engine-files.md).
