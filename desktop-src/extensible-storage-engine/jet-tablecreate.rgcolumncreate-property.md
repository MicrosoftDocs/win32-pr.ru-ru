---
description: 'Дополнительные сведения о свойстве: JET_TABLECREATE. ргколумнкреате'
title: Свойство JET_TABLECREATE. ргколумнкреате
...
ms.locfileid: "119472864"
---
# <a name="jet_tablecreatergcolumncreate-property"></a>Свойство JET_TABLECREATE. ргколумнкреате

Возвращает или задает массив сведений о создании столбца типа [JET_COLUMNCREATE](./jet-columncreate-class.md).
