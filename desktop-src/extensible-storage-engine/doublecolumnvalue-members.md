...
---
# <a name="doublecolumnvalue-members"></a>Элементы Даублеколумнвалуе

Включить защищенные члены  
Включить унаследованные члены  

Значение [типа Double](/dotnet/api/system.double) в столбце.

Тип [даублеколумнвалуе](./doublecolumnvalue-class.md) предоставляет следующие члены.
...
<td><a href="dn273974(v=exchg.10).md">даублеколумнвалуе</a></td>
<td></td>
</tr>
</tbody>
</table>
...
<td><a href="dn273977(v=exchg.10).md">Размер</a></td>
...
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn334203(v=exchg.10).md">жетвалуефромбитес</a></td>
