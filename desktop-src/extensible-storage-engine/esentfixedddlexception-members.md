...
---
# <a name="esentfixedddlexception-members"></a>Элементы Есентфикседддлексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Фикседддл.

Тип [есентфикседддлексцептион](./esentfixedddlexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350451(v=exchg.10).md">есентфикседддлексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентфикседддлексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентфикседддлексцептион](./esentfixedddlexception-class.md)
