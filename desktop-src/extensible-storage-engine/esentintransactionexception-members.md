---
description: 'Дополнительные сведения о: Есентинтрансактионексцептион Members'
title: Элементы Есентинтрансактионексцептион
...
ms.locfileid: "118494911"
---
# <a name="esentintransactionexception-members"></a>Элементы Есентинтрансактионексцептион
...
Тип [есентинтрансактионексцептион](./esentintransactionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319459(v=exchg.10).md">есентинтрансактионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинтрансактионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинтрансактионексцептион](./esentintransactionexception-class.md)
