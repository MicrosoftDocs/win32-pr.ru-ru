...
---
# <a name="esentnullinvalidexception-members"></a>Элементы Есентнуллинвалидексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Нуллинвалид.

Тип [есентнуллинвалидексцептион](./esentnullinvalidexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319645(v=exchg.10).md">есентнуллинвалидексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентнуллинвалидексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентнуллинвалидексцептион](./esentnullinvalidexception-class.md)
