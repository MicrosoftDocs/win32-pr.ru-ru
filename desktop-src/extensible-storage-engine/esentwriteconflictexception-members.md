...
---
# <a name="esentwriteconflictexception-members"></a>Элементы Есентвритеконфликтексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Вритеконфликт.

Тип [есентвритеконфликтексцептион](./esentwriteconflictexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350878(v=exchg.10).md">есентвритеконфликтексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентвритеконфликтексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентвритеконфликтексцептион](./esentwriteconflictexception-class.md)
