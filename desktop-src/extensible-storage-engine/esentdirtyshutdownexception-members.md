...
ms.locfileid: "119974034"
---
# <a name="esentdirtyshutdownexception-members"></a>Элементы Есентдиртишутдовнексцептион
...
Тип [есентдиртишутдовнексцептион](./esentdirtyshutdownexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334456(v=exchg.10).md">есентдиртишутдовнексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентдиртишутдовнексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентдиртишутдовнексцептион](./esentdirtyshutdownexception-class.md)
