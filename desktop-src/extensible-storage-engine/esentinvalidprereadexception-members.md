...
---
# <a name="esentinvalidprereadexception-members"></a>Элементы Есентинвалидпререадексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Инвалидпререад.

Тип [есентинвалидпререадексцептион](./esentinvalidprereadexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319583(v=exchg.10).md">есентинвалидпререадексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидпререадексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидпререадексцептион](./esentinvalidprereadexception-class.md)
