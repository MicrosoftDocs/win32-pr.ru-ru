...
ms.locfileid: "120019083"
---
# <a name="esentsectorsizenotsupportedexception-members"></a>Элементы Есентсекторсизенотсуппортедексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Секторсизенотсуппортед.

Тип [есентсекторсизенотсуппортедексцептион](./esentsectorsizenotsupportedexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350612(v=exchg.10).md">есентсекторсизенотсуппортедексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентсекторсизенотсуппортедексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентсекторсизенотсуппортедексцептион](./esentsectorsizenotsupportedexception-class.md)
