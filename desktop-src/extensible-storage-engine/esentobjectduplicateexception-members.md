...
ms.locfileid: "119947864"
---
# <a name="esentobjectduplicateexception-members"></a>Элементы Есентобжектдупликатиксцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Обжектдупликате.

Тип [есентобжектдупликатиксцептион](./esentobjectduplicateexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319657(v=exchg.10).md">есентобжектдупликатиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентобжектдупликатиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентобжектдупликатиксцептион](./esentobjectduplicateexception-class.md)
