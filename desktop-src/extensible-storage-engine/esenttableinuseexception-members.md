---
description: 'Дополнительные сведения о: Есенттаблеинусиксцептион Members'
title: Элементы Есенттаблеинусиксцептион
...
ms.locfileid: "104264595"
---
# <a name="esenttableinuseexception-members"></a>Элементы Есенттаблеинусиксцептион
...
Тип [есенттаблеинусиксцептион](./esenttableinuseexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334908(v=exchg.10).md">есенттаблеинусиксцептион</a></td>
<td>Инициализирует новый экземпляр класса Есенттаблеинусиксцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есенттаблеинусиксцептион](./esenttableinuseexception-class.md)
