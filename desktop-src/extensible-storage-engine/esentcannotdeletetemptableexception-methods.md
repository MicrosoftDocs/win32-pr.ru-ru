---
description: 'Дополнительные сведения: методы Есентканнотделететемптабликсцептион'
title: 'Методы EsentCannotDeleteTempTableException '
...
ms.locfileid: "104568105"
---
# <a name="esentcannotdeletetemptableexception-methods"></a>Методы EsentCannotDeleteTempTableException 
