...
---
# <a name="esentupdatemustversionexception-members"></a>Элементы Есентупдатемустверсионексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Упдатемустверсион.

Тип [есентупдатемустверсионексцептион](./esentupdatemustversionexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350840(v=exchg.10).md">есентупдатемустверсионексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентупдатемустверсионексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентупдатемустверсионексцептион](./esentupdatemustversionexception-class.md)
