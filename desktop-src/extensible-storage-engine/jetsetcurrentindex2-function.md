...
| <p><strong>Юникод</strong></p> | <p>Реализуется как <strong>JetSetCurrentIndex2W</strong> (Юникод) и <strong>JetSetCurrentIndex2A</strong> (ANSI).</p> | 
