...
<td><p>Вторичный индекс выбирается с параметром JET_bitNoMove и для первого многозначного ключевого столбца в новом определении индекса, соответствующего указанному порядковому номеру, отсутствует значение.</p></td>
</tr>
<tr class="odd">
...
<td><p>Содержимое идентификатора индекса недопустимо или устарело, и его необходимо обновить. Это может произойти для <strong>JetSetCurrentIndex2</strong> в следующих случаях:</p>
<ul>
...
<li><p>Все курсоры, ссылающиеся на таблицу, содержащую индекс, соответствующий ИДЕНТИФИКАТОРу индекса, были закрыты и подсистема удалила определение индекса из кэша схемы.</p></li>
...
<td><p>Реализуется как <strong>JetSetCurrentIndex2W</strong> (Юникод) и <strong>JetSetCurrentIndex2A</strong> (ANSI).</p></td>
</tr>
</tbody>
</table>
