---
description: 'Дополнительные сведения: методы Есентрекордтубигфорбакквардкомпатибилитексцептион'
title: 'Методы EsentRecordTooBigForBackwardCompatibilityException '
...
ms.locfileid: "103810559"
---
# <a name="esentrecordtoobigforbackwardcompatibilityexception-methods"></a>Методы EsentRecordTooBigForBackwardCompatibilityException 
