...
ms.locfileid: "118253866"
---
# <a name="jet_sesidtostring-method-string-iformatprovider"></a>JET_SESID. Метод ToString (String, IFormatProvider)
...
[Перегрузка ToString](./jet-sesid.tostring-method2.md)
