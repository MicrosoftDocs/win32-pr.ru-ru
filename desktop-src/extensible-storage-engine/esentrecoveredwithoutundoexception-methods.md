---
description: 'Дополнительные сведения: методы Есентрековередвисаутундоексцептион'
title: 'Методы EsentRecoveredWithoutUndoException '
...
ms.locfileid: "103897742"
---
# <a name="esentrecoveredwithoutundoexception-methods"></a>Методы EsentRecoveredWithoutUndoException 
