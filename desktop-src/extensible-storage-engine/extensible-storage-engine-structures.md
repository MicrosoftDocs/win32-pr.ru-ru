...
---
# <a name="extensible-storage-engine-structures"></a>Расширяемые структуры подсистемы хранилища
...
API-интерфейс расширенного подсистемы хранилища имеет следующие структуры:
