---
description: 'дополнительные сведения: расширяемые структуры подсистемы служба хранилища'
title: расширяемые структуры подсистемы служба хранилища
...
ms.locfileid: "117706236"
---
# <a name="extensible-storage-engine-structures"></a>расширяемые структуры подсистемы служба хранилища
...
расширяемый API-интерфейс обработчика служба хранилища имеет следующие структуры:
