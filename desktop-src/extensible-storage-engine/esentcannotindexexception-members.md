---
description: 'Дополнительные сведения о: Есентканнотиндексексцептион Members'
title: Элементы Есентканнотиндексексцептион
...
ms.locfileid: "104263779"
---
# <a name="esentcannotindexexception-members"></a>Элементы Есентканнотиндексексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Каннотиндекс.

Тип [есентканнотиндексексцептион](./esentcannotindexexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274115(v=exchg.10).md">есентканнотиндексексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентканнотиндексексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентканнотиндексексцептион](./esentcannotindexexception-class.md)
