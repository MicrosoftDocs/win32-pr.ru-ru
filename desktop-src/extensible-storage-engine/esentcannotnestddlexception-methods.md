---
description: 'Дополнительные сведения: методы Есентканнотнестддлексцептион'
title: 'Методы EsentCannotNestDDLException '
...
ms.locfileid: "104567734"
---
# <a name="esentcannotnestddlexception-methods"></a>Методы EsentCannotNestDDLException 
