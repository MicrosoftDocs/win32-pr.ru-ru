---
description: 'Дополнительные сведения о: Есентлогдискфуллексцептион Members'
title: Элементы Есентлогдискфуллексцептион
...
ms.locfileid: "104550484"
---
# <a name="esentlogdiskfullexception-members"></a>Элементы Есентлогдискфуллексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Логдискфулл.

Тип [есентлогдискфуллексцептион](./esentlogdiskfullexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334536(v=exchg.10).md">есентлогдискфуллексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентлогдискфуллексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентлогдискфуллексцептион](./esentlogdiskfullexception-class.md)
