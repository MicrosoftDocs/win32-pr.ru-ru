---
description: 'Дополнительные сведения о: Есентинконсистентексцептион Members'
title: Элементы Есентинконсистентексцептион
...
ms.locfileid: "118496141"
---
# <a name="esentinconsistentexception-members"></a>Элементы Есентинконсистентексцептион
...
Тип [есентинконсистентексцептион](./esentinconsistentexception-class.md) предоставляет следующие члены.
...
<td><a href="dn274374(v=exchg.10).md">Есентинконсистентексцептион (SerializationInfo, StreamingContext)</a></td>
<td>Инициализирует новый экземпляр класса Есентинконсистентексцептион. Этот конструктор используется для десериализации сериализованного исключения.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Защищенный метод" alt="Protected method" /></td>
<td><a href="dn350429(v=exchg.10).md">Есентинконсистентексцептион (строка, JET_err)</a></td>
<td>Инициализирует новый экземпляр класса Есентинконсистентексцептион.</td>
</tr>
</tbody>
</table>
