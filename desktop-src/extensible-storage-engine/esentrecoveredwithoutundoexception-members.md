---
description: 'Дополнительные сведения о: Есентрековередвисаутундоексцептион Members'
title: Элементы Есентрековередвисаутундоексцептион
...
ms.locfileid: "103912208"
---
# <a name="esentrecoveredwithoutundoexception-members"></a>Элементы Есентрековередвисаутундоексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Рековередвисаутундо.

Тип [есентрековередвисаутундоексцептион](./esentrecoveredwithoutundoexception-class.md) предоставляет следующие члены.
...
<td><a href="dn350539(v=exchg.10).md">есентрековередвисаутундоексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентрековередвисаутундоексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентрековередвисаутундоексцептион](./esentrecoveredwithoutundoexception-class.md)
