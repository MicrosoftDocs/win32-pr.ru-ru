---
description: 'Дополнительные сведения о: JET_COLUMNID Members'
title: Элементы JET_COLUMNID
...
ms.locfileid: "103897966"
---
# <a name="jet_columnid-members"></a>Элементы JET_COLUMNID

Включить защищенные члены  
Включить унаследованные члены  

JET_COLUMNID определяет столбец в таблице.

Тип [JET_COLUMNID](./jet-columnid-structure.md) предоставляет следующие члены.
...
<td><a href="hh578195(v=exchg.10).md">Указатель</a></td>
<td>Возвращает JET_COLUMNID null.</td>
</tr>
</tbody>
</table>
...
<td>Сравнивает это значение columnid с другим columnid и определяет, является ли данный экземпляр предшествующим, таким же, как и после другого экземпляра.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Открытый метод" alt="Public method" /></td>
...
<td>Форматирует значение текущего экземпляра, используя указанный формат.</td>
</tr>
</tbody>
</table>
...
<td><a href="hh565924(v=exchg.10).md">Равенство</a></td>
<td>Определяет, равны ли два указанных экземпляра JET_COLUMNID.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh579053(v=exchg.10).md">GreaterThan</a></td>
<td>Определите, является ли одно переcolumnid после другого columnid.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh556917(v=exchg.10).md">GreaterThanOrEqual;</a></td>
<td>Определить, является ли одно значение columnid более переданного или равным другому columnid.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh596817(v=exchg.10).md">Неравенство</a></td>
<td>Определяет, являются ли два указанных экземпляра JET_COLUMNID неравными.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh578892(v=exchg.10).md">LessThan;</a></td>
<td>Определите, является ли один columnid перед другим columnid.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Открытый оператор" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Статический член" alt="Static member" /></td>
<td><a href="hh558154(v=exchg.10).md">LessThanOrEqual;</a></td>
<td>Определите, предшествует ли одно значение columnid или равно другому columnid.</td>
</tr>
</tbody>
</table>
