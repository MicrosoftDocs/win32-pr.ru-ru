...
ms.locfileid: "119040702"
---
# <a name="esentmissinglogfileexception-members"></a>Элементы Есентмиссинглогфиликсцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Миссинглогфиле.

Тип [есентмиссинглогфиликсцептион](./esentmissinglogfileexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334675(v=exchg.10).md">есентмиссинглогфиликсцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентмиссинглогфиликсцептион.</td>
</tr>
</tbody>
</table>
