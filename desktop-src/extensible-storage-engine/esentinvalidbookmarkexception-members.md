...
ms.locfileid: "119041422"
---
# <a name="esentinvalidbookmarkexception-members"></a>Элементы Есентинвалидбукмаркексцептион
...
Тип [есентинвалидбукмаркексцептион](./esentinvalidbookmarkexception-class.md) предоставляет следующие члены.
...
<td><a href="dn319439(v=exchg.10).md">есентинвалидбукмаркексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентинвалидбукмаркексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентинвалидбукмаркексцептион](./esentinvalidbookmarkexception-class.md)
