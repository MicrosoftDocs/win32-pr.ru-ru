---
description: 'Дополнительные сведения: методы Есентунлоадаблеосфунктионалитексцептион'
title: 'Методы EsentUnloadableOSFunctionalityException '
...
ms.locfileid: "119039592"
---
# <a name="esentunloadableosfunctionalityexception-methods"></a>Методы EsentUnloadableOSFunctionalityException 
