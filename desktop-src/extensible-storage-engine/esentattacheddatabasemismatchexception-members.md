...
---
# <a name="esentattacheddatabasemismatchexception-members"></a>Элементы Есентаттачеддатабасемисматчексцептион

Включить защищенные члены  
Включить унаследованные члены  

Базовый класс для JET_err. Исключения Аттачеддатабасемисматч.

Тип [есентаттачеддатабасемисматчексцептион](./esentattacheddatabasemismatchexception-class.md) предоставляет следующие члены.
...
<td><a href="dn334237(v=exchg.10).md">есентаттачеддатабасемисматчексцептион</a></td>
<td>Инициализирует новый экземпляр класса Есентаттачеддатабасемисматчексцептион.</td>
</tr>
</tbody>
</table>
...
[Класс Есентаттачеддатабасемисматчексцептион](./esentattacheddatabasemismatchexception-class.md)
