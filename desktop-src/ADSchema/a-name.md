...
ms.locfileid: "119326174"
---
# <a name="rdn-attribute"></a>Атрибут RDN

Относительное различающееся имя (RDN) объекта. RDN — это относительная часть различающегося имени (DN), однозначно определяющая объект LDAP.
