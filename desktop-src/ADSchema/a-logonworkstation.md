...
---
# <a name="logon-workstation-attribute"></a>Атрибут Logon-Workstation

Этот атрибут не используется. См. атрибут [**User-Workstations**](a-userworkstations.md) .
...
| LDAP-отображаемое имя | логонворкстатион                                      |
| Размер              | \-                                                    |
