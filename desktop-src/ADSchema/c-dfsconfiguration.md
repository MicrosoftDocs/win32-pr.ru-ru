...
ms.locfileid: "119324934"
---
# <a name="dfs-configuration-class"></a>Класс Dfs-Configuration

Содержит все отказоустойчивые конфигурации DFS.
...
| LDAP-отображаемое имя | дфсконфигуратион                     |
...
| Возможные старшие          | [**Домен — DNS-**](c-domaindns.md)[**контейнер**](c-container.md)                            |
