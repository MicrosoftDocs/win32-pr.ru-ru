...
ms.locfileid: "120066324"
---
# <a name="mssfu-30-search-attributes-attribute"></a>атрибут Мссфу-30-Search-Attributes

Содержит имена атрибутов, необходимых NIS-серверу при поиске на карте.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Мссфу-30-Поиск-атрибуты                  |
| LDAP-отображаемое имя | msSFU30SearchAttributes                     |
| Размер              | \-                                          |
