...
---
# <a name="ms-sql-olapcube-class"></a>Класс MS-SQL-Олапкубе

Класс для хранения свойств SQL Server куба OLAP.
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-Олапкубе                      |
| LDAP-отображаемое имя | mS-SQL-Олапкубе                      |
...
| Возможные старшие          | [**MS-SQL-Олапдатабасе**](c-ms-sql-olapdatabase.md)                                         |
...
| [**Контакт MS-SQL**](a-ms-sql-contact.md)                                | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL — описание**](a-ms-sql-description.md)                        | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL-Информатионурл**](a-ms-sql-informationurl.md)                  | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL — ключевые слова**](a-ms-sql-keywords.md)                              | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL-Ластупдатеддате**](a-ms-sql-lastupdateddate.md)                | Неверно     | **MS-SQL-Олапкубе**             |
| [**Имя MS-SQL**](a-ms-sql-name.md)                                      | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL-Публикатионурл**](a-ms-sql-publicationurl.md)                  | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL-Размер**](a-ms-sql-size.md)                                      | Неверно     | **MS-SQL-Олапкубе**             |
| [**MS-SQL-состояние**](a-ms-sql-status.md)                                  | Неверно     | **MS-SQL-Олапкубе**             |
