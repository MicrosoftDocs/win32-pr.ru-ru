...
ms.locfileid: "118959893"
---
# <a name="ms-dfsr-subscriber-class"></a>класс MS-DFSR-Subscriber

Содержит сведения о членстве локального компьютера в группе репликации.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Подписчик MS-DFSR                   |
| LDAP-отображаемое имя | Мсдфср — подписчик                    |
...
| Возможные старшие          | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
...
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **Подписчик MS-DFSR**          |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **Подписчик MS-DFSR**          |
| [**MS-DFSR-Мемберреференце**](a-msdfsr-memberreference.md)                 | Верно      | **Подписчик MS-DFSR**          |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **Подписчик MS-DFSR**          |
| [**MS-DFSR-Репликатионграупгуид**](a-msdfsr-replicationgroupguid.md)       | Верно      | **Подписчик MS-DFSR**          |
...
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                    | Неверно     | **Подписчик MS-DFSR**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Неверно     | **Подписчик MS-DFSR**          |
| [**MS-DFSR-Репликатионграупгуид**](a-msdfsr-replicationgroupguid.md)          | Верно      | **Подписчик MS-DFSR**          |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)    | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-Subscriber** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
