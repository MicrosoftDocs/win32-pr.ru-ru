...
| [**MS-DFSR-Мемберреференце**](a-msdfsr-memberreference.md)                 | True      | **Подписчик MS-DFSR**          |
...
| [**MS-DFSR-Репликатионграупгуид**](a-msdfsr-replicationgroupguid.md)       | True      | **Подписчик MS-DFSR**          |
