...
---
# <a name="acs-subnet-class"></a>Класс ACS-Subnet

Содержит параметры конфигурации для сервера ACS (служба управления распределением пропускной способности).
...
|-------------------|--------------------------------------|
| CN                | ACS-Subnet                           |
| LDAP-отображаемое имя | акссубнет                            |
...
|-----------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS — с поддержкой-RSVP — пропускная способность**](a-acsallocablersvpbandwidth.md)         | Неверно     | **ACS — подсеть**                  |
| [**ACS — Кэш — время ожидания**](a-acscachetimeout.md)                              | Неверно     | **ACS — подсеть**                  |
| [**ACS-ДСБМ-Деадтиме**](a-acsdsbmdeadtime.md)                              | Неверно     | **ACS — подсеть**                  |
| [**ACS — ДСБМ — приоритет**](a-acsdsbmpriority.md)                              | Неверно     | **ACS — подсеть**                  |
| [**ACS-ДСБМ — обновление**](a-acsdsbmrefresh.md)                                | Неверно     | **ACS — подсеть**                  |
| [**ACS-Enable-ACS-Service**](a-acsenableacsservice.md)                     | Неверно     | **ACS — подсеть**                  |
| [**ACS-Enable-RSVP-Accounting**](a-acsenablersvpaccounting.md)             | Неверно     | **ACS — подсеть**                  |
| [**ACS-Enable-RSVP-сообщение — ведение журнала**](a-acsenablersvpmessagelogging.md)    | Неверно     | **ACS — подсеть**                  |
| [**ACS-Event-уровень журнала**](a-acseventloglevel.md)                           | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-Duration-on-Flow**](a-acsmaxdurationperflow.md)                | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-без учета--файлов**](a-acsmaxnoofaccountfiles.md)             | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-No-of-log-files**](a-acsmaxnooflogfiles.md)                     | Неверно     | **ACS — подсеть**                  |
| [**ACS-max-Пиковая пропускная способность**](a-acsmaxpeakbandwidth.md)                     | Неверно     | **ACS — подсеть**                  |
| [**ACS-max-Пиковая пропускная способность (на поток)**](a-acsmaxpeakbandwidthperflow.md)     | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-size-of-RSVP-файл учетной записи**](a-acsmaxsizeofrsvpaccountfile.md)  | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-size-of-файл RSVP-Log-File**](a-acsmaxsizeofrsvplogfile.md)          | Неверно     | **ACS — подсеть**                  |
| [**ACS-Max-Token-Rate-для потока**](a-acsmaxtokenrateperflow.md)             | Неверно     | **ACS — подсеть**                  |
| [**ACS-не зарезервированный-Max-СДУ-size**](a-acsnonreservedmaxsdusize.md)         | Неверно     | **ACS — подсеть**                  |
| [**ACS-не зарезервировано-min-with-size**](a-acsnonreservedminpolicedsize.md) | Неверно     | **ACS — подсеть**                  |
| [**ACS — не зарезервировано — Пиковая ставка**](a-acsnonreservedpeakrate.md)              | Неверно     | **ACS — подсеть**                  |
| [**ACS — не зарезервировано — размер токена**](a-acsnonreservedtokensize.md)            | Неверно     | **ACS — подсеть**                  |
| [**ACS-не зарезервировано-TX-Limit**](a-acsnonreservedtxlimit.md)                | Неверно     | **ACS — подсеть**                  |
| [**ACS — не зарезервировано — размер TX**](a-acsnonreservedtxsize.md)                  | Неверно     | **ACS — подсеть**                  |
| [**ACS-RSVP-Account-Files-Location**](a-acsrsvpaccountfileslocation.md)    | Неверно     | **ACS — подсеть**                  |
| [**ACS-RSVP-Log-Files-Location**](a-acsrsvplogfileslocation.md)            | Неверно     | **ACS — подсеть**                  |
| [**ACS-Server-список**](a-acsserverlist.md)                                  | Неверно     | **ACS — подсеть**                  |
