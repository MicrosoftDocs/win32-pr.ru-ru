...
---
# <a name="poss-superiors-attribute"></a>Атрибут Poss-Superiors

Список объектов, которые могут содержать этот класс.
...
|-------------------|-----------------------------------------------------------------|
| CN                | Poss-Superiors                                                  |
| LDAP-отображаемое имя | possSuperiors                                                   |
| Размер              | \-                                                              |
| Привилегия обновления  | Администратор домена                                            |
| Частота обновления  | При определении класса.                                      |
