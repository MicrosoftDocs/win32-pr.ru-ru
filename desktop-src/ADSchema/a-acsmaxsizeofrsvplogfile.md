...
ms.locfileid: "119262044"
---
# <a name="acs-max-size-of-rsvp-log-file-attribute"></a>Файловый атрибут ACS-Max-size-of-RSVP-File

Максимальный размер файла журнала RSVP (в байтах).



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | ACS-Max-size-of-файл RSVP-Log-File        |
| LDAP-отображаемое имя | аксмакссизеофрсвплогфиле              |
| Размер              | 4 байта                              |
