...
ms.locfileid: "119323714"
---
# <a name="ms-authz-central-access-rule-class"></a>класс правил MS-authz-Central-Access

Класс, определяющий правила централизованного доступа, используемые для создания централизованной политики доступа.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-authz-центральный-доступ — правило         |
| LDAP-отображаемое имя | Мсаусз — Централакцессруле            |
...
| Возможные старшие          | [**MS-authz-центральный-доступ — правила**](c-msauthz-centralaccessrules.md)                        |
...
| [**Включен**](a-enabled.md)                                                                 | Неверно     | **MS-authz-центральный-доступ — правило** |
...
| [**MS-authz-эффективные-безопасность — политика**](a-msauthz-effectivesecuritypolicy.md)              | Неверно     | **MS-authz-центральный-доступ — правило** |
| [**MS-authz-Last-эффективные-Security-Policy**](a-msauthz-lasteffectivesecuritypolicy.md)     | Неверно     | **MS-authz-центральный-доступ — правило** |
| [**MS-authz-предложил-Security-Policy**](a-msauthz-proposedsecuritypolicy.md)                | Неверно     | **MS-authz-центральный-доступ — правило** |
| [**MS-authz-Resource-условие**](a-msauthz-resourcecondition.md)                           | Неверно     | **MS-authz-центральный-доступ — правило** |
