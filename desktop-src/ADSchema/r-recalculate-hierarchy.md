...
ms.locfileid: "119531464"
---
# <a name="recalculate-hierarchy-extended-right"></a>Recalculate-Hierarchy расширенное право

Расширенное право на принудительное повторное вычисление иерархии в DS.
...
| Display-Name | Повторно вычислить иерархию                |
| Rights-GUID  | 0bc1554e-0a99-11d1-adbb-00c04fd8d5cd |
...
| Локализация — идентификатор экрана | 32                                       |
