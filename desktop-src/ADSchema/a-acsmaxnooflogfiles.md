...
---
# <a name="acs-max-no-of-log-files-attribute"></a>Атрибут ACS-Max-No-of-log-files

Максимальное число файлов журнала RSVP.
...
| LDAP-отображаемое имя | аксмакснуфлогфилес                   |
| Размер              | 4 байта                              |
