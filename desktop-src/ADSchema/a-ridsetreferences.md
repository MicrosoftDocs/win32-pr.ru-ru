...
ms.locfileid: "119646644"
---
# <a name="rid-set-references-attribute"></a>Атрибут RID-Set-References

Список ссылок на RID-Set объекты, которые управляют выделением относительных идентификаторов (RID).
...
| LDAP-отображаемое имя | ридсетреференцес                        |
| Размер              | \-                                      |
