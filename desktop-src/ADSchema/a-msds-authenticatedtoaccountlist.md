...
Обратная ссылка для [**MS-DS-аусентикатедат-DC**](a-msds-authenticatedatdc.md). Определяет, какие пользователи прошли проверку подлинности на этом компьютере.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | MS-DS-Аусентикатедто-Аккаунтлист       |
| LDAP-отображаемое имя | msDS-Аусентикатедтоаккаунтлист         |
| Размер              | \-                                      |
