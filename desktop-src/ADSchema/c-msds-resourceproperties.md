...
ms.locfileid: "119879904"
---
# <a name="ms-ds-resource-properties-class"></a>класс MS-DS-Resource-Properties

Контейнер этого класса может содержать свойства ресурсов.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Свойства ms-DS-Resource-            |
| LDAP-отображаемое имя | msDS-Ресаурцепропертиес              |
