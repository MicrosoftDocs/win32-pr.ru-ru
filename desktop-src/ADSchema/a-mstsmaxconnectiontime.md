...
---
# <a name="ms-ts-max-connection-time-attribute"></a>атрибут MS-TS-Max-Connection-Time

Максимальное время подключения к сеансу служб терминалов — это максимальное количество времени в минутах для сеанса служб терминалов.
...
| LDAP-отображаемое имя | мстсмаксконнектионтиме                |
| Размер              | \-                                   |
