...
ms.locfileid: "118688858"
---
# <a name="address-entry-display-table-attribute"></a>Атрибут address-Entry-вывести-Table

Отображаемая таблица для записи адреса.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | Адрес-ввод-отображение-таблица                           |
| LDAP-отображаемое имя | аддрессентридисплайтабле                              |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Отображение шаблона**](c-displaytemplate.md)<br/> |
