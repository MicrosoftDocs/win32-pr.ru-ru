...
Содержит идентификатор GUID набора содержимого репликации распределенная файловая система (DFS).



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | MS-DFSR-Контентсетгуид                                |
| LDAP-отображаемое имя | Мсдфср — Контентсетгуид                                 |
| Размер              | \-                                                    |
