...
---
# <a name="msmq-queue-class"></a>Класс MSMQ-Queue

Пользователи MSMQ создают очереди (MMC или API MSMQ) в соответствии с их требованиями. Очередь связана с конкретным компьютером и помещается в MSMQ-Configuration этого компьютера. Количество очередей на один компьютер не ограничено.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Queue                           |
| LDAP-отображаемое имя | Вызове MSMQQueue                            |
...
| Возможные старшие          | [**Конфигурация MSMQ**](c-msmqconfiguration.md)                                            |
...
| [**MSMQ — проверка подлинности**](a-msmqauthenticate.md)                           | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ — базовый приоритет**](a-msmqbasepriority.md)                          | Неверно     | **Очередь MSMQ**                  |
| [**Журнал MSMQ**](a-msmqjournal.md)                                     | Неверно     | **Очередь MSMQ**                  |
| [**Метка MSMQ**](a-msmqlabel.md)                                         | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Label-ex**](a-msmqlabelex.md)                                    | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-уровень конфиденциальности**](a-msmqprivacylevel.md)                          | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — журнал — квота**](a-msmqqueuejournalquota.md)               | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Queue-Name-ext**](a-msmqqueuenameext.md)                         | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — квота**](a-msmqqueuequota.md)                              | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — тип**](a-msmqqueuetype.md)                                | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ — транзакционная**](a-msmqtransactional.md)                         | Неверно     | **Очередь MSMQ**                  |
...
| [**Метка MSMQ**](a-msmqlabel.md)                                           | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Label-ex**](a-msmqlabelex.md)                                      | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ — адрес многоадресной рассылки**](a-msmq-multicastaddress.md)                   | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                      | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-уровень конфиденциальности**](a-msmqprivacylevel.md)                            | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — журнал — квота**](a-msmqqueuejournalquota.md)                 | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ-Queue-Name-ext**](a-msmqqueuenameext.md)                           | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — квота**](a-msmqqueuequota.md)                                | Неверно     | **Очередь MSMQ**                  |
| [**Очередь MSMQ — тип**](a-msmqqueuetype.md)                                  | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ — защищенный источник**](a-msmq-securedsource.md)                         | Неверно     | **Очередь MSMQ**                  |
| [**MSMQ — транзакционная**](a-msmqtransactional.md)                           | Неверно     | **Очередь MSMQ**                  |
| [**нетбут-SCP-BL**](a-netbootscpbl.md)                                    | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Не-Security-Member-BL**](a-nonsecuritymemberbl.md)                     | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**NT-Security-дескриптор**](a-ntsecuritydescriptor.md)                    | True      | [**Вверх**](c-top.md)<br/> |
