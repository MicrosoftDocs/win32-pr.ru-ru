...
Определяет подписчика на набор реплик.
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Subscriber                     |
| LDAP-отображаемое имя | нтфрссубскрибер                      |
...
| Возможные старшие          | [**NTFRS-Subscriptions**](c-ntfrssubscriptions.md)                                                                              |
...
| [**Расширения FRS**](a-frsextensions.md)                                 | Неверно     | **NTFRS — подписчик**            |
| [**FRS-Fault-условие**](a-frsfaultcondition.md)                        | Неверно     | **NTFRS — подписчик**            |
...
| [**Расписание**](a-schedule.md)                                            | Неверно     | **NTFRS — подписчик**            |
