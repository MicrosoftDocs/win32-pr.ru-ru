...
ms.locfileid: "119703764"
---
# <a name="file-link-tracking-entry-class"></a>Класс ввода файла с отслеживанием ссылок

Содержит идентификатор GUID и сведения о текущем компьютере для файла, отслеживающего связь.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Запись File-Link-Tracking             |
| LDAP-отображаемое имя | филелинктраккинжентри                |
