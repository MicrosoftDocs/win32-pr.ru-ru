...
---
# <a name="pki-key-usage-attribute"></a>PKI — атрибут использования ключа

Расширение использования ключа для шаблона сертификата.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | PKI — использование ключа                                         |
| LDAP-отображаемое имя | пкикэйусаже                                           |
| Размер              | \-                                                    |
