...
ms.locfileid: "119835034"
---
# <a name="ipsec-negotiation-policy-class"></a>Класс политики согласования IPSec

Класс **политики согласования IPSec** предназначен только для внутреннего использования.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Политика согласования IPSec             |
| LDAP-отображаемое имя | ипсекнеготиатионполици               |
...
| Подкласс                 | [**IPSec-Base**](c-ipsecbase.md)<br/>                                                                      |
...
| [**Данные IPSec**](a-ipsecdata.md)                                         | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
| [**IPSec-Data-Type**](a-ipsecdatatype.md)                                | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
| [**Идентификатор IPSec**](a-ipsecid.md)                                             | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
| [**Имя IPSec**](a-ipsecname.md)                                         | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
| [**IPSEC-согласование — политика — действие**](a-ipsecnegotiationpolicyaction.md) | Неверно     | **Политика согласования IPSec**                 |
| [**IPSEC-согласование — тип политики**](a-ipsecnegotiationpolicytype.md)     | Неверно     | **Политика согласования IPSec**                 |
| [**Справочник по IPsec-владельцам**](a-ipsecownersreference.md)                  | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
...
| Вспомогательные классы           | \-                                                                                                                |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                      |
| Дескриптор безопасности по умолчанию | Г.                                                                                                                |
| System-Flags                | 0x00000010                                                                                                        |
