...
| [**Привязки RPC-NS**](a-rpcnsbindings.md)                                | Верно      | **RPC-Server-Element**                                                                   |
| [**RPC-NS-Interface-ID**](a-rpcnsinterfaceid.md)                         | Верно      | **RPC-Server-Element**                                                                   |
| [**RPC-NS-передает-синтаксис**](a-rpcnstransfersyntax.md)                   | Верно      | **RPC-Server-Element**                                                                   |
