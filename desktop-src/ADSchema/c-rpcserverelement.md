...
---
# <a name="rpc-server-element-class"></a>класс элементов RPC-Server

Представляет отдельный интерфейс в заданном RPC-сервере.
...
| LDAP-отображаемое имя | рпксерверелемент                     |
...
| Возможные старшие          | [**RPC-Server**](c-rpcserver.md)                                                            |
...
| [**Привязки RPC-NS**](a-rpcnsbindings.md)                                | True      | **RPC-Server-Element**                                                                   |
| [**RPC-NS-Interface-ID**](a-rpcnsinterfaceid.md)                         | True      | **RPC-Server-Element**                                                                   |
| [**RPC-NS-передает-синтаксис**](a-rpcnstransfersyntax.md)                   | True      | **RPC-Server-Element**                                                                   |
