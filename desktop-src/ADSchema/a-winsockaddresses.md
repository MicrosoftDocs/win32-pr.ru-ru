...
---
# <a name="winsock-addresses-attribute"></a>Атрибут Winsock-Addresses

Адрес службы Winsock.
...
| LDAP-отображаемое имя | винсоккаддрессес                                      |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Экземпляр службы**](c-serviceinstance.md)<br/> |
