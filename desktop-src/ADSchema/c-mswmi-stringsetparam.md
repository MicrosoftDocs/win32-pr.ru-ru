...
---
# <a name="ms-wmi-stringsetparam-class"></a>класс MS-WMI-Стрингсетпарам

Объект параметра строкового набора.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Стрингсетпарам                |
| LDAP-отображаемое имя | Мсвми — Стрингсетпарам                 |
...
| [**MS-WMI-Стрингдефаулт**](a-mswmi-stringdefault.md)                       | True      | **MS-WMI-Стрингсетпарам**                                  |
| [**MS-WMI-Стрингвалидвалуес**](a-mswmi-stringvalidvalues.md)               | Неверно     | **MS-WMI-Стрингсетпарам**                                  |
