...
ms.locfileid: "119021742"
---
# <a name="subschema-class"></a>Класс подсхемы
...
|-------------------|--------------------------------------|
| CN                | Подсхема                            |
| LDAP-отображаемое имя | подсхема                            |
...
| [**Типы атрибутов**](a-attributetypes.md)                               | Неверно     | **Подсхема**                                 |
...
| [**DIT-Content-правила**](a-ditcontentrules.md)                            | Неверно     | **Подсхема**                                 |
...
| [**Расширенный атрибут-сведения**](a-extendedattributeinfo.md)                | Неверно     | **Подсхема**                                 |
| [**Расширенные сведения о классе**](a-extendedclassinfo.md)                        | Неверно     | **Подсхема**                                 |
...
| [**Метка времени изменения**](a-modifytimestamp.md)                            | Неверно     |  [ **Верхняя** схема, вверху](c-top.md)<br/> |
...
| [**Классы объектов**](a-objectclasses.md)                                 | Неверно     | **Подсхема**                                 |
