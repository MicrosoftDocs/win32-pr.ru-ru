...
ms.locfileid: "119580634"
---
# <a name="foreign-security-principal-class"></a>Внешний-Security — основной класс

Субъект безопасности из внешнего источника.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Внешний-Security-Principal           |
| LDAP-отображаемое имя | фореигнсекуритипринЦипал             |
...
| [**Внешний идентификатор**](a-foreignidentifier.md)                         | Неверно     | **Внешний-Security-Principal**  |
...
| [**Идентификатор безопасности объекта**](a-objectsid.md)                                         | Верно      | **Внешний-Security-Principal**  |
