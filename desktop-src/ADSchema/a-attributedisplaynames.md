...
ms.locfileid: "119443114"
---
# <a name="attribute-display-names-attribute"></a>Атрибут-отображаемое имя

Имя, отображаемое для этого объекта.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Атрибуты-отображаемые имена                     |
| LDAP-отображаемое имя | attributeDisplayNames                       |
| Размер              | \-                                          |
