...
ms.locfileid: "117837746"
---
# <a name="ms-wmi-intflags1-attribute"></a>атрибут MS-WMI-intFlags1

Атрибут **MS-WMI-intFlags1** зарезервирован для внутреннего использования.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-intFlags1                     |
| LDAP-отображаемое имя | Мсвми — intFlags1                      |
| Размер              | 4 байта                              |
