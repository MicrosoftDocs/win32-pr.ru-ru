...
---
# <a name="msnpsavedcallingstationid-attribute"></a>атрибут Мснпсаведкаллингстатионид

Атрибут **мснпсаведкаллингстатионид** используется внутренним образом. Не изменяйте это значение напрямую.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | мснпсаведкаллингстатионид            |
| LDAP-отображаемое имя | мснпсаведкаллингстатионид            |
| Размер              | \-                                   |
...
[Функции администрирования RAS](/windows/desktop/RRAS/ras-administration-functions)
</dt> </dl>
