...
ms.locfileid: "118688316"
---
# <a name="allowed-attributes-attribute"></a>Атрибут Allowed-Attributes

Атрибуты, которые будут разрешены для назначения классу.
...
| LDAP-отображаемое имя | алловедаттрибутес                                               |
| Размер              | \-                                                              |
