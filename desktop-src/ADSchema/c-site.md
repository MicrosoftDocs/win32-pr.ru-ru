...
---
# <a name="site-class"></a>Класс сайта

Контейнер для хранения объектов сервера. Представляет физическое расположение, содержащее компьютеры. Используются для управления репликацией.
...
|-------------------|--------------------------------------|
| CN                | Сайт                                 |
| LDAP-отображаемое имя | site                                 |
| Привилегия обновления  | Администратор домена                 |
| Частота обновления  | Каждый раз, когда требуется новый сайт.       |
...
| Возможные старшие          | [**Сайты — контейнеры**](c-sitescontainer.md)              |
| Вспомогательные классы           | \-                                                       |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                             |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; СЛУЖБЫ |
...
| [**GP — ссылка**](a-gplink.md)                                               | Неверно     | **Сайт**                        |
| [**GP — параметры**](a-gpoptions.md)                                         | Неверно     | **Сайт**                        |
...
| [**Расположение**](a-location.md)                                            | Неверно     | **Сайт**                        |
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Сайт**                        |
...
| [**MSMQ — Interval1**](a-msmqinterval1.md)                                 | Неверно     | **Сайт**                        |
| [**MSMQ — Interval2**](a-msmqinterval2.md)                                 | Неверно     | **Сайт**                        |
| [**MSMQ-Nt4-заглушка**](a-msmqnt4stub.md)                                    | Неверно     | **Сайт**                        |
| [**MSMQ-site-инородный**](a-msmqsiteforeign.md)                            | Неверно     | **Сайт**                        |
| [**MSMQ-site-ID**](a-msmqsiteid.md)                                      | Неверно     | **Сайт**                        |
...
| [**Список уведомлений**](a-notificationlist.md)                           | Неверно     | **Сайт**                        |
...
| Вспомогательные классы           | \-                                                                         |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                               |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; AU) (A;; ЛКРПЛОРК;;; ED |
| System-Flags                | 0x00000010                                                                 |
...
| [**MS-DS-плацдарм-серверы — используется**](a-msds-bridgeheadserversused.md)          | Неверно     | **Сайт**                        |
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)         | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                      | Неверно     | [**Вверх**](c-top.md)<br/> |
