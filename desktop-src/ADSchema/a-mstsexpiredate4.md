...
ms.locfileid: "119924404"
---
# <a name="ms-ts-expiredate4-attribute"></a>Атрибут MS-TS-ExpireDate4

Дата окончания срока действия четвертой клиентской лицензии служб терминалов "на пользователя".
...
| LDAP-отображаемое имя | msTSExpireDate4                                               |
| Размер              | \-                                                            |
