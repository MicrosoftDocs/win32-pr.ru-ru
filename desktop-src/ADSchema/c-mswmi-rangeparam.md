...
---
# <a name="ms-wmi-rangeparam-class"></a>класс MS-WMI-Ранжепарам

Класс параметра Range, являющийся основанием для PolicyTemplate. В нем описывается одно из объединяемых свойств целевого объекта. Каждый подкласс реализует конкретный тип. Реализует метод Merge для поддержки слияния. Реализует метод Resolve для создания конечного свойства цели.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Ранжепарам                    |
| LDAP-отображаемое имя | Мсвми — Ранжепарам                     |
...
| Возможные старшие          | [**MS-WMI-Мержеаблеполицитемплате**](c-mswmi-mergeablepolicytemplate.md)                          |
...
| [**MS-WMI-PropertyName**](a-mswmi-propertyname.md)                         | True      | **MS-WMI-Ранжепарам**           |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | True      | **MS-WMI-Ранжепарам**           |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | True      | **MS-WMI-Ранжепарам**           |
