...
---
# <a name="prior-set-time-attribute"></a>Атрибут до времени установки

Предыдущее время, заданное для секрета.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Ранее установленное время                       |
| LDAP-отображаемое имя | приорсеттиме                         |
| Размер              | 8 байт                              |
