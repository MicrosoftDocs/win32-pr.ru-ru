...
ms.locfileid: "119879984"
---
# <a name="ms-ds-optional-feature-class"></a>MS-DS-необязательный класс функции

Настройка необязательной функции DS.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-DS-необязательный компонент               |
| LDAP-отображаемое имя | msDS-Оптионалфеатуре                 |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПЛКЛОРК;;; AU) (A;; РПВПКРЛКЛОККДКРКВДВОСДДТСВ;;; EA) (A;; РПВПКРЛКЛОККДКРКВДВОСДДТСВ;;; CO) (A;; РПВПКРЛКЛОККДКРКВДВОСДДТСВ;;; SY |
...
| [**MS-DS-необязательный параметр-Feature-flags**](a-msds-optionalfeatureflags.md)                    | Верно      | **MS-DS-необязательный компонент**      |
| [**MS-DS-Optional-Feature-GUID**](a-msds-optionalfeatureguid.md)                      | Верно      | **MS-DS-необязательный компонент**      |
...
| [**MS-DS-Required — поведение домена — версия**](a-msds-requireddomainbehaviorversion.md) | Неверно     | **MS-DS-необязательный компонент**      |
| [**MS-DS-Required — поведение леса — версия**](a-msds-requiredforestbehaviorversion.md) | Неверно     | **MS-DS-необязательный компонент**      |
