...
ms.locfileid: "119879714"
---
# <a name="ms-print-connectionpolicy-class"></a>класс MS-Print-ConnectionPolicy

Содержит политику подключения принтера.
...
| LDAP-отображаемое имя | Мспринт — ConnectionPolicy             |
...
| [**Common-Name**](a-cn.md)                                                 | Верно      | **MS-Print-ConnectionPolicy** [ **сверху**](c-top.md)<br/> |
...
| [**Print-атрибуты**](a-printattributes.md)                               | Неверно     | **MS-Print-ConnectionPolicy**                                 |
| [**Имя принтера**](a-printername.md)                                       | Неверно     | **MS-Print-ConnectionPolicy**                                 |
...
| [**Имя сервера**](a-servername.md)                                         | Неверно     | **MS-Print-ConnectionPolicy**                                 |
...
| [**UNC-имя**](a-uncname.md)                                               | Неверно     | **MS-Print-ConnectionPolicy**                                 |
