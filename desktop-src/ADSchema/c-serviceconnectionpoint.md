...
---
# <a name="service-connection-point-class"></a>Класс точки подключения службы

Этот объект предназначен для публикации информации, которую клиентские приложения могут использовать для привязки к службе.



| Ввод | Значение |
|-------------------|------------------------------------------------------------|
| CN                | Служба — точка подключения                                   |
| LDAP-отображаемое имя | Особый                                     |
| Привилегия обновления  | Администратор или любой пользователь, которому требуется установить службу. |
| Частота обновления  | При установке новой службы.                           |
...
| Возможные старшие          | [](c-computer.md)[](c-container.md)[**Организационное подразделение**](c-organizationalunit.md) контейнера компьютера                |
| Вспомогательные классы           | \-                                                                                                                               |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                     |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; CO) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; СЛУЖБЫ |
...
| [**Привязка службы — сведения**](a-servicebindinginformation.md)        | Неверно     | **Служба — точка подключения**                                                             |
| [**Имя-класса службы**](a-serviceclassname.md)                          | Неверно     | **Служба — точка подключения**                                                             |
| [**Service-DNS-имя**](a-servicednsname.md)                              | Неверно     | **Служба — точка подключения**                                                             |
| [**Service-DNS-Name-Type**](a-servicednsnametype.md)                     | Неверно     | **Служба — точка подключения**                                                             |
...
| [**Allowed-Child-classes**](a-allowedchildclasses.md)                      | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Allowed-Child-classes-эффективен**](a-allowedchildclasseseffective.md)   | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Версия App-Schema-Version**](a-appschemaversion.md)                            | Неверно     | **Служба — точка подключения**                                                             |
| [**Плацдарм-Server-List-BL**](a-bridgeheadserverlistbl.md)               | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Каноническое имя**](a-canonicalname.md)                                   | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Common-Name**](a-cn.md)                                                 | True      | [**Точка соединения**](c-connectionpoint.md)<br/> [**Вверх**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
...
| [**USN-Last-obj-REM**](a-usnlastobjrem.md)                                 | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Источник USN**](a-usnsource.md)                                           | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Vendor**](a-vendor.md)                                                  | Неверно     | **Служба — точка подключения**                                                             |
| [**Номер версии**](a-versionnumber.md)                                   | Неверно     | **Служба — точка подключения**                                                             |
| [**Номер версии — Hi**](a-versionnumberhi.md)                              | Неверно     | **Служба — точка подключения**                                                             |
| [**Версия-номер**](a-versionnumberlo.md)                              | Неверно     | **Служба — точка подключения**                                                             |
| [**WBEM — путь**](a-wbempath.md)                                             | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Хорошо известные объекты**](a-wellknownobjects.md)                            | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**При изменении**](a-whenchanged.md)                                       | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**При создании**](a-whencreated.md)                                       | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
