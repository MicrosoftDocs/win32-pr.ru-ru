...
---
# <a name="msmq-group-class"></a>Класс MSMQ-Group

Используется для определения группы очередей MSMQ (также известной как список рассылки).
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| LDAP-отображаемое имя | Группа msMQ                                              |
| Привилегия обновления  | Владелец очереди.                                        |
| Частота обновления  | Каждый раз, когда элемент добавляется в группу или удаляется из нее. |
...
| [**Член**](a-member.md)                                                  | True      | **Группа MSMQ**                  |
