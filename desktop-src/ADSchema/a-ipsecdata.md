...
ms.locfileid: "119322614"
---
# <a name="ipsec-data-attribute"></a>Атрибут Ipsec-Data

Атрибут **IPSec-Data** предназначен только для внутреннего использования.
...
|-------------------|-------------------------------------------------------|
| CN                | Ipsec-Data                                            |
| LDAP-отображаемое имя | ипсекдата                                             |
| Размер              | \-                                                    |
