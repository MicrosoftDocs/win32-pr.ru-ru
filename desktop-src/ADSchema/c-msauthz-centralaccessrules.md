...
ms.locfileid: "119801784"
---
# <a name="ms-authz-central-access-rules-class"></a>класс MS-authz-Central-Access-Rules

Контейнер этого класса может содержать объекты записи политики централизованного доступа.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-authz-центральный-доступ — правила        |
| LDAP-отображаемое имя | Мсаусз — Централакцессрулес           |
