...
---
# <a name="ipsec-nfa-reference-attribute"></a>Атрибут IPSec-NFA-Reference

Атрибут **IPSec-NFA-Reference** предназначен только для внутреннего использования.
...
| LDAP-отображаемое имя | ипсекнфареференце                       |
| Размер              | \-                                      |
