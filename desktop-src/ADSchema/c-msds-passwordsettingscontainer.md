...
ms.locfileid: "119879944"
---
# <a name="ms-ds-password-settings-container-class"></a>ms-DS-Password-Параметры — класс контейнера

Контейнер для объектов параметров пароля.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Параметры — контейнер    |
| LDAP-отображаемое имя | msDS-Пассвордсеттингсконтаинер       |
