...
ms.locfileid: "118175218"
---
# <a name="msmq-migrated-user-class"></a>MSMQ — перенесенный класс пользователя

В MSMQ 1,0 у нас есть наша служба DS, в которой мы сохранили информацию для каждого пользователя. в рамках интеграции msmq с Windows 2000 DS служба msmq предоставляет средство миграции. во время миграции для каждого пользователя, который не входит в домен Windows 2000, создается переносимый пользователь.



| Ввод | Значение |
|-------------------|--------------------------------------------------------------------------------------------------|
| CN                | MSMQ — перенесено — пользователь                                                                               |
| LDAP-отображаемое имя | мсмкмигратедусер                                                                                 |
| Привилегия обновления  | Владелец очереди.                                                                                 |
| Частота обновления  | Этот объект создается мастером обновления очереди сообщений в среде домена в смешанном режиме. |
...
| Возможные старшие          | [**Встроенное**](c-builtindomain.md)доменное [**подразделение**](c-organizationalunit.md) [**domain-DNS**](c-domaindns.md) |
...
| [**MSMQ — дайджесты**](a-msmqdigests.md)                                     | Неверно     | **MSMQ — перенесено — пользователь**          |
| [**MSMQ — дайджесты — MIG**](a-msmqdigestsmig.md)                              | Неверно     | **MSMQ — перенесено — пользователь**          |
| [**MSMQ-Sign-Certificates**](a-msmqsigncertificates.md)                  | Неверно     | **MSMQ — перенесено — пользователь**          |
| [**MSMQ-Sign-Certificates-MIG**](a-msmqsigncertificatesmig.md)           | Неверно     | **MSMQ — перенесено — пользователь**          |
| [**MSMQ-User-SID**](a-msmqusersid.md)                                    | Неверно     | **MSMQ — перенесено — пользователь**          |
...
| [**Идентификатор безопасности объекта**](a-objectsid.md)                                         | Неверно     | **MSMQ — перенесено — пользователь**          |
