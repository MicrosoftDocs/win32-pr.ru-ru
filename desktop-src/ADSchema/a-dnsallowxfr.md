...
ms.locfileid: "120085984"
---
# <a name="dns-allow-xfr-attribute"></a>Атрибут DNS-Allow-КСФР

Атрибут **DNS-Allow-ксфр** в настоящее время не используется.
...
|-------------------|--------------------------------------|
| CN                | DNS-Allow-КСФР                        |
| LDAP-отображаемое имя | днсалловксфр                          |
| Размер              | \-                                   |
