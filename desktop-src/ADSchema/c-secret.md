...
ms.locfileid: "119533974"
---
# <a name="secret-class"></a>Класс секрета

Секрет локального центра безопасности. Используется для отношений доверия и сохранения паролей служб.
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY |
...
| [**Текущее значение**](a-currentvalue.md)                                   | Нет     | **Секрет**                      |
...
| [**Время последнего набора**](a-lastsettime.md)                                    | Нет     | **Секрет**                      |
...
| [**Ранее установленное время**](a-priorsettime.md)                                  | Нет     | **Секрет**                      |
| [**Прежнее значение**](a-priorvalue.md)                                       | Нет     | **Секрет**                      |
