...
---
# <a name="msmq-settings-class"></a>Класс MSMQ-Settings

Цель этих объектов — включить быстрый запрос серверов MSMQ на определенном сайте. Этот объект содержит такие сведения, как службы очереди сообщений, предоставляемые сервером.
...
|-------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MSMQ-Settings                                                                                                                                                           |
| LDAP-отображаемое имя | мсмксеттингс                                                                                                                                                            |
| Привилегия обновления  | Владелец очереди.                                                                                                                                                        |
| Частота обновления  | Этот объект создается для каждого сервера очереди сообщений, установленного на контроллере домена Windows 2000, и для каждого сервера очереди сообщений со службами маршрутизации. |
...
| [**MSMQ-Dependent-Client-Service**](a-msmqdependentclientservice.md)     | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-DS-Service**](a-msmqdsservice.md)                                | Неверно     | **MSMQ — параметры**               |
| [**Перенесено из MSMQ**](a-msmqmigrated.md)                                   | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-Nt4-флаги**](a-msmqnt4flags.md)                                  | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-Routing-Service**](a-msmqroutingservice.md)                      | Неверно     | **MSMQ — параметры**               |
| [**MSMQ — службы**](a-msmqservices.md)                                   | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-Site-Name**](a-msmqsitename.md)                                  | Неверно     | **MSMQ — параметры**               |
| [**MSMQ-Site-Name-ex**](a-msmqsitenameex.md)                             | Неверно     | **MSMQ — параметры**               |
