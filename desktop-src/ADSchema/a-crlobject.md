...
ms.locfileid: "119926004"
---
# <a name="crl-object-attribute"></a>Атрибут CRL-Object

Ссылка на объект списка отзыва сертификатов, связанный с центром сертификации.
...
|-------------------|-----------------------------------------|
| CN                | CRL-Object                              |
| LDAP-отображаемое имя | крлобжект                               |
| Размер              | \-                                      |
