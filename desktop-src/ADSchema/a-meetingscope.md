...
ms.locfileid: "119300614"
---
# <a name="meetingscope-attribute"></a>атрибут Митингскопе

Может быть глобальным, локальным или другим значением. Его интерпретация зависит от приложения.
...
|-------------------|---------------------------------------------|
| CN                | митингскопе                                |
| LDAP-отображаемое имя | митингскопе                                |
| Размер              | \-                                          |
