...
ms.locfileid: "119508844"
---
# <a name="mssfu-30-posix-member-of-attribute"></a>Мссфу-30-POSIX-член-of, атрибут

Содержит отображаемые имена групп, к которым принадлежит этот пользователь.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Мссфу-30-POSIX-член-of                |
| LDAP-отображаемое имя | msSFU30PosixMemberOf                    |
| Размер              | \-                                      |
