...
ms.locfileid: "117837557"
---
# <a name="ms-wmi-intmax-attribute"></a>атрибут MS-WMI-Интмакс

Максимальное значение для объекта целочисленного параметра WMI 32-bit.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-Интмакс                        |
| LDAP-отображаемое имя | Мсвми — Интмакс                         |
| Размер              | 4 байта                              |
