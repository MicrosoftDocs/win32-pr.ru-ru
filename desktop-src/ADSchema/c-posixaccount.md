...
ms.locfileid: "118959733"
---
# <a name="posixaccount-class"></a>класс Посиксаккаунт

Представляет абстракцию учетной записи с атрибутами (POSIX) интерфейса операционной системы.
...
|-------------------|--------------------------------------|
| CN                | посиксаккаунт                         |
| LDAP-отображаемое имя | посиксаккаунт                         |
...
| [**Common-Name**](a-cn.md)                                                 | Неверно     | **посиксаккаунт** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                  |
| [**Описание**](a-description.md)                                        | Неверно     | **посиксаккаунт** [ **сверху**](c-top.md)<br/> |
...
| [**жекос**](a-gecos.md)                                                    | Неверно     | **посиксаккаунт**                                 |
| [**gidNumber**](a-gidnumber.md)                                            | Неверно     | **посиксаккаунт**                                 |
| [**Домашняя папка**](a-homedirectory.md)                                   | Неверно     | **посиксаккаунт**                                 |
...
| [**логиншелл**](a-loginshell.md)                                          | Неверно     | **посиксаккаунт**                                 |
...
| [**такой**](a-uid.md)                                                        | Неверно     | **посиксаккаунт**                                 |
| [**уиднумбер**](a-uidnumber.md)                                            | Неверно     | **посиксаккаунт**                                 |
| [**униксхомедиректори**](a-unixhomedirectory.md)                            | Неверно     | **посиксаккаунт**                                 |
| [**униксусерпассворд**](a-unixuserpassword.md)                              | Неверно     | **посиксаккаунт**                                 |
| [**Пароль пользователя**](a-userpassword.md)                                     | Неверно     | **посиксаккаунт**                                 |
