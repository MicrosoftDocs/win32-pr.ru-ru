...
---
# <a name="ms-tsls-property02-attribute"></a>Атрибут MS-ТСЛС-Property02

Заполнитель свойства сервера терминалов 02.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-ТСЛС-Property02                          |
| LDAP-отображаемое имя | msTSLSProperty02                            |
| Размер              | \-                                          |
