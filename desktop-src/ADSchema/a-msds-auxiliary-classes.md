...
ms.locfileid: "118685689"
---
# <a name="ms-ds-auxiliary-classes-attribute"></a>Атрибут ms-DS-вспомогательных классов

Этот атрибут перечисляет вспомогательные классы, которые были динамически присоединены к объекту. Этот атрибут не связан с классом. Он заполняется системой автоматически.



| Ввод | Значение |
|-------------------|-----------------------------------------------------------------|
| CN                | MS-DS-вспомогательные классы                                         |
| LDAP-отображаемое имя | msDS-вспомогательные классы                                          |
| Размер              | \-                                                              |
