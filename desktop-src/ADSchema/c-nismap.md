...
---
# <a name="nismap-class"></a>класс nisMap

Содержит обобщенную абстракцию NIS-сопоставлений.
...
| [**Common-Name**](a-cn.md)                                                 | True      |  [ **десять лучших**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>            |
| [**Описание**](a-description.md)                                        | Неверно     |  [ **десять лучших**](c-top.md)<br/> |
...
| [**нисмапнаме**](a-nismapname.md)                                          | True      | **nisMap**                                 |
