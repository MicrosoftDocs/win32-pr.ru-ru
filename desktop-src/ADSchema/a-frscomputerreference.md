...
ms.locfileid: "119925764"
---
# <a name="frs-computer-reference-attribute"></a>Атрибут FRS-Computer-Reference

Ссылка на объект-компьютер члена набора реплик.
...
| LDAP-отображаемое имя | фрскомпутерреференце                    |
| Размер              | \-                                      |
...
| Классы, используемые в        | [**NTFRS-Member**](c-ntfrsmember.md)<br/> |
