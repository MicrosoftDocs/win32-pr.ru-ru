...
| [**Common-Name**](a-cn.md)                                                 | Неверно     | **документ** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>              |
| [**Описание**](a-description.md)                                        | Неверно     | **документ** [ **сверху**](c-top.md)<br/> |
...
| [**документаусор**](a-documentauthor.md)                                  | Неверно     | **document**                                 |
| [**документидентифиер**](a-documentidentifier.md)                          | Неверно     | **document**                                 |
| [**документлокатион**](a-documentlocation.md)                              | Неверно     | **document**                                 |
| [**документпублишер**](a-documentpublisher.md)                            | Неверно     | **document**                                 |
| [**документтитле**](a-documenttitle.md)                                    | Неверно     | **document**                                 |
| [**документверсион**](a-documentversion.md)                                | Неверно     | **document**                                 |
...
| [**Локальное имя**](a-l.md)                                                | Неверно     | **document**                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                    | Неверно     | **document**                                 |
| [**Название организации**](a-o.md)                                            | Неверно     | **document**                                 |
...
| [**См. также**](a-seealso.md)                                               | Неверно     | **document**                                 |
