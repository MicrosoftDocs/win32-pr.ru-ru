...
ms.locfileid: "119752784"
---
# <a name="remote-mail-recipient-class"></a>Класс Remote-mail-получател

Внешний получатель почты. Этот атрибут устарел.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Удаленный адрес электронной почты — получатель                |
| LDAP-отображаемое имя | ремотемаилреЦипиент                  |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; AU) (OA;; CR; ab721a55-1e2f-11D0-9819-00aa0040529b;; СЛУЖБЫ |
...
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Удаленный адрес электронной почты — получатель**                                                            |
...
| [**Удаленный источник**](a-remotesource.md)                                   | Неверно     | **Удаленный адрес электронной почты — получатель**                                                            |
| [**Удаленный источник-тип**](a-remotesourcetype.md)                          | Неверно     | **Удаленный адрес электронной почты — получатель**                                                            |
