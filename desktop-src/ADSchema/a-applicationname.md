...
ms.locfileid: "118178033"
---
# <a name="application-name-attribute"></a>Атрибут Application-Name
...
|-------------------|---------------------------------------------|
| CN                | Application-Name                            |
| LDAP-отображаемое имя | applicationName                             |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**Параметры приложения**](c-applicationsettings.md)<br/> [**приложение — сайт — Параметры**](c-applicationsitesettings.md)<br/> |
