...
---
# <a name="assoc-nt-account-attribute"></a>Атрибут учетной записи Assoc-NT

Учетная запись Windows NT, которая применяется к этому объекту.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | ASSOC-NT — учетная запись                                      |
| LDAP-отображаемое имя | ассокнтаккаунт                                        |
| Размер              | \-                                                    |
