...
ms.locfileid: "119324774"
---
# <a name="dns-zone-class"></a>Класс Dns-Zone

Контейнер для DNS-узлов. Содержит метаданные зоны.
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; ED) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; CC;;; AU) (A;; РПЛКЛОРК;;; WD |
...
| [**DNS — разрешить — динамический**](a-dnsallowdynamic.md)                            | Неверно     | **DNS — зона**                    |
| [**DNS-Allow-КСФР**](a-dnsallowxfr.md)                                    | Неверно     | **DNS — зона**                    |
| [**DNS-Notify-получатели**](a-dnsnotifysecondaries.md)                  | Неверно     | **DNS — зона**                    |
| [**DNS-свойство**](a-dnsproperty.md)                                     | Неверно     | **DNS — зона**                    |
| [**DNS-Secure-вторичные службы**](a-dnssecuresecondaries.md)                  | Неверно     | **DNS — зона**                    |
| [**Компонент домена**](a-dc.md)                                          | Верно      | **DNS — зона**                    |
...
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **DNS — зона**                    |
...
| Вспомогательные классы           | \-                                                                                                                                                                               |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                                                                     |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; ED) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; CC;;; AU) (A;; РПЛКЛОРК;;; WD) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; СОСТАВ |
| System-Flags                | 0x00000010                                                                                                                                                                       |
...
| [**MS-DFSR-Компутерреференцебл**](a-msdfsr-computerreferencebl.md)                          | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                              | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Записи MS-DNS-DNSKEY-**](a-msdns-dnskeyrecords.md)                                       | Неверно     | **DNS — зона**                    |
| [**MS-DNS-DNSKEY-Record-Set-TTL**](a-msdns-dnskeyrecordsetttl.md)                           | Неверно     | **DNS — зона**                    |
| [**Алгоритмы записи MS-DNS-DS-Record**](a-msdns-dsrecordalgorithms.md)                            | Неверно     | **DNS — зона**                    |
| [**MS-DNS-DS-Record-Set-TTL**](a-msdns-dsrecordsetttl.md)                                   | Неверно     | **DNS — зона**                    |
| [**MS-DNS-является подписанным**](a-msdns-issigned.md)                                                 | Неверно     | **DNS — зона**                    |
| [**MS-DNS-поддержание-Trust — Anchor**](a-msdns-maintaintrustanchor.md)                          | Неверно     | **DNS — зона**                    |
| [**MS-DNS-NSEC3-Current-соли**](a-msdns-nsec3currentsalt.md)                                | Неверно     | **DNS — зона**                    |
| [**Алгоритм MS-DNS-NSEC3-Hash-Algorithm**](a-msdns-nsec3hashalgorithm.md)                            | Неверно     | **DNS — зона**                    |
| [**MS-DNS-NSEC3-итерации**](a-msdns-nsec3iterations.md)                                   | Неверно     | **DNS — зона**                    |
| [**MS-DNS-NSEC3-OptOut**](a-msdns-nsec3optout.md)                                           | Неверно     | **DNS — зона**                    |
| [**MS-DNS-NSEC3-Random-соль-length**](a-msdns-nsec3randomsaltlength.md)                     | Неверно     | **DNS — зона**                    |
| [**MS-DNS-NSEC3-User-Salt**](a-msdns-nsec3usersalt.md)                                      | Неверно     | **DNS — зона**                    |
| [**MS-DNS-Parent-with-Secure-делегирование**](a-msdns-parenthassecuredelegation.md)             | Неверно     | **DNS — зона**                    |
| [**MS-DNS-распространение-время**](a-msdns-propagationtime.md)                                   | Неверно     | **DNS — зона**                    |
| [**MS-DNS-RFC5011-Key-смена ключей**](a-msdns-rfc5011keyrollovers.md)                          | Неверно     | **DNS — зона**                    |
| [**MS-DNS-Secure-делегирование-опрос — период**](a-msdns-securedelegationpollingperiod.md)     | Неверно     | **DNS — зона**                    |
| [**MS-DNS-"начало подписи"-смещение**](a-msdns-signatureinceptionoffset.md)                | Неверно     | **DNS — зона**                    |
| [**дескрипторы MS-DNS-Sign-Key-**](a-msdns-signingkeydescriptors.md)                      | Неверно     | **DNS — зона**                    |
| [**Ключи для подписывания MS-DNS**](a-msdns-signingkeys.md)                                           | Неверно     | **DNS — зона**                    |
| [**MS-DNS-Sign-with-NSEC3**](a-msdns-signwithnsec3.md)                                      | Неверно     | **DNS — зона**                    |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)                  | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Аусентикатедто-Аккаунтлист**](a-msds-authenticatedtoaccountlist.md)               | Неверно     | [**Вверх**](c-top.md)<br/> |
