...
ms.locfileid: "118688453"
---
# <a name="admin-description-attribute"></a>Атрибут Admin-Description

Описание, отображаемое на экранах администрирования.
...
| LDAP-отображаемое имя | adminDescription                            |
| Размер              | \-                                          |
