...
---
# <a name="ms-ds-tasks-for-az-role-attribute"></a>MS-DS-Tasks-for-az-атрибут Role

Список задач для AZ-Role.
...
| LDAP-отображаемое имя | msDS-Тасксфоразроле                     |
| Размер              | \-                                      |
