...
---
# <a name="pki-enrollment-service-class"></a>PKI — класс службы регистрации

Сервер сертификатов, который может обрабатывать запросы сертификатов и выдавать сертификаты.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | PKI — регистрация — служба               |
| LDAP-отображаемое имя | пкиенроллментсервице                 |
...
| [**CA — сертификат**](a-cacertificate.md)                                 | Неверно     | **PKI — регистрация — служба**      |
| [**CA — certificate-DN**](a-cacertificatedn.md)                            | Неверно     | **PKI — регистрация — служба**      |
| [**Каноническое имя**](a-canonicalname.md)                                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Шаблоны сертификатов**](a-certificatetemplates.md)                   | Неверно     | **PKI — регистрация — служба**      |
...
| [**DNS-Host-Name**](a-dnshostname.md)                                    | Неверно     | **PKI — регистрация — служба**      |
...
| [**Поставщики регистрации**](a-enrollmentproviders.md)                     | Неверно     | **PKI — регистрация — служба**      |
...
| [**Алгоритмы подписи**](a-signaturealgorithms.md)                     | Неверно     | **PKI — регистрация — служба**      |
...
| [**MS-DS-Tasks-for-AZ-Task-BL**](a-msds-tasksforaztaskbl.md)                    | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-дов-Owner-BL**](a-ownerbl.md)                                            | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-PKI-регистрация — серверы**](a-mspki-enrollment-servers.md)                  | Неверно     | **PKI — регистрация — служба**      |
| [**MS-PKI-Site-Name**](a-mspki-site-name.md)                                    | Неверно     | **PKI — регистрация — служба**      |
| [**Мссфу-30-POSIX-член-of**](a-mssfu30posixmemberof.md)                       | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**нетбут-SCP-BL**](a-netbootscpbl.md)                                         | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Не-Security-Member-BL**](a-nonsecuritymemberbl.md)                          | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**NT-Security-дескриптор**](a-ntsecuritydescriptor.md)                         | True      | [**Вверх**](c-top.md)<br/> |
