...
ms.locfileid: "119803234"
---
# <a name="msmq-nt4-flags-attribute"></a>Атрибут "MSMQ-Nt4-Flags"

Атрибут **MSMQ-Nt4-flags** содержит сведения о смешанном режиме MSMQ.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Nt4-флаги                       |
| LDAP-отображаемое имя | mSMQNt4Flags                         |
| Размер              | \-                                   |
