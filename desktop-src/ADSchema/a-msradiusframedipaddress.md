...
---
# <a name="msradiusframedipaddress-attribute"></a>атрибут Мсрадиусфрамедипаддресс

Атрибут **мсрадиусфрамедипаддресс** используется внутренним образом. Не изменяйте это значение напрямую.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | мсрадиусфрамедипаддресс              |
| LDAP-отображаемое имя | мсрадиусфрамедипаддресс              |
| Размер              | 4 байта                              |
