...
ms.locfileid: "119706744"
---
# <a name="crl-partitioned-revocation-list-attribute"></a>Список CRL-секционированный--атрибут списка отзыва

Списки отзыва инфраструктуры открытого ключа.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | Список отзыва сертификатов-секционированный-отзыва                       |
| LDAP-отображаемое имя | крлпартитионедревокатионлист                          |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Список CRL-точка распространения**](c-crldistributionpoint.md)<br/> |
