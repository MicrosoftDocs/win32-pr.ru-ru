...
---
# <a name="is-privilege-holder-attribute"></a>Атрибут имеет права владельца

Обратная ссылка на привилегии, удерживаемые данным участником.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Имеет права владельца                     |
| LDAP-отображаемое имя | испривилежехолдер                       |
| Размер              | \-                                      |
