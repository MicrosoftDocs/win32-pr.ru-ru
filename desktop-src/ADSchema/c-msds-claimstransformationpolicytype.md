...
ms.locfileid: "119880224"
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>класс MS-DS-Claims-преобразование — тип политики

Объект этого класса содержит один набор политик преобразования утверждений для преобразования заявок между лесами.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | MS-DS-Claims-преобразование — политика-тип |
| LDAP-отображаемое имя | msDS-Клаимстрансформатионполицитипе     |
...
| Возможные старшие          | [**MS-DS-Claims-преобразование — политики**](c-msds-claimstransformationpolicies.md) |
| Вспомогательные классы           | \-                                                                                  |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                        |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; EA) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY          |
...
| [**MS-DS-преобразование — правила**](a-msds-transformationrules.md)                             | Неверно     | **MS-DS-Claims-преобразование — политика-тип** |
| [**MS-DS-преобразование — правила-скомпилированные**](a-msds-transformationrulescompiled.md)            | Неверно     | **MS-DS-Claims-преобразование — политика-тип** |
