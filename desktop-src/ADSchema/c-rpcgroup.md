...
---
# <a name="rpc-group-class"></a>класс группы RPC

Представляет группу RPC.
...
|-------------------|--------------------------------------|
| CN                | RPC — группа                            |
| LDAP-отображаемое имя | рпкграуп                             |
...
| [**RPC-NS-Group**](a-rpcnsgroup.md)                                      | Неверно     | **RPC — группа**                                                                            |
| [**RPC-NS-Object-ID**](a-rpcnsobjectid.md)                               | Неверно     | **RPC — группа**                                                                            |
