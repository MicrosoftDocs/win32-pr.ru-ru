...
ms.locfileid: "119704954"
---
# <a name="ms-dfsr-priority-attribute"></a>атрибут MS-DFSR-Priority
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-Priority                     |
| LDAP-отображаемое имя | Мсдфср — приоритет                      |
| Размер              | \-                                   |
...
| Классы, используемые в        | [**MS-DFSR-Contenting**](c-msdfsr-contentset.md)<br/> [**MS-DFSR-подключение**](c-msdfsr-connection.md)<br/> |
