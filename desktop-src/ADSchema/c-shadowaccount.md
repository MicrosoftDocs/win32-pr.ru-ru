...
ms.locfileid: "119021782"
---
# <a name="shadowaccount-class"></a>класс Шадоваккаунт

Содержит дополнительные атрибуты для теневых паролей.
...
|-------------------|--------------------------------------|
| CN                | шадоваккаунт                        |
| LDAP-отображаемое имя | шадоваккаунт                        |
...
| [**Описание**](a-description.md)                                        | Неверно     | **шадоваккаунт** [ **сверху**](c-top.md)<br/> |
...
| [**шадовекспире**](a-shadowexpire.md)                                      | Неверно     | **шадоваккаунт**                                 |
| [**шадовфлаг**](a-shadowflag.md)                                          | Неверно     | **шадоваккаунт**                                 |
| [**шадовинактиве**](a-shadowinactive.md)                                  | Неверно     | **шадоваккаунт**                                 |
| [**шадовластчанже**](a-shadowlastchange.md)                              | Неверно     | **шадоваккаунт**                                 |
| [**шадовмакс**](a-shadowmax.md)                                            | Неверно     | **шадоваккаунт**                                 |
| [**шадовмин**](a-shadowmin.md)                                            | Неверно     | **шадоваккаунт**                                 |
| [**шадовварнинг**](a-shadowwarning.md)                                    | Неверно     | **шадоваккаунт**                                 |
...
| [**такой**](a-uid.md)                                                        | Неверно     | **шадоваккаунт**                                 |
| [**Пароль пользователя**](a-userpassword.md)                                     | Неверно     | **шадоваккаунт**                                 |
