...
ms.locfileid: "119021752"
---
# <a name="simplesecurityobject-class"></a>класс Симплесекуритйобжект

Позволяет элементу иметь атрибут userPassword, если классы объектов Principal записи не разрешают userPassword в качестве типа атрибута.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | симплесекуритйобжект                 |
| LDAP-отображаемое имя | симплесекуритйобжект                 |
...
| [**Пароль пользователя**](a-userpassword.md)                                     | Неверно     | **симплесекуритйобжект**        |
