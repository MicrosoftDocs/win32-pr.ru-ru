...
---
# <a name="documentauthor-attribute"></a>атрибут Документаусор

Тип атрибута Документаусор указывает различающееся имя автора документа.
...
|-------------------|-----------------------------------------|
| CN                | документаусор                          |
| LDAP-отображаемое имя | документаусор                          |
| Размер              | \-                                      |
