...
---
# <a name="acs-max-token-rate-per-flow-attribute"></a>Атрибут ACS-Max-Token-Rate-on-Flow

Максимальная частота маркеров для конкретного пользователя.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | ACS-Max-Token-Rate-для потока          |
| LDAP-отображаемое имя | аксмакстокенратеперфлов               |
| Размер              | 8 байт                              |
