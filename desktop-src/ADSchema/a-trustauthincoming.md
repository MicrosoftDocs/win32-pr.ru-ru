...
ms.locfileid: "119835666"
---
# <a name="trust-auth-incoming-attribute"></a>Trust-auth-входящий атрибут

Сведения о проверке подлинности для входящей части доверия.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | Trust-auth-входящий                                   |
| LDAP-отображаемое имя | трустаусинкоминг                                     |
| Размер              | \-                                                    |
