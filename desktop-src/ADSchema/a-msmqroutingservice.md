...
ms.locfileid: "119081788"
---
# <a name="msmq-routing-service-attribute"></a>Атрибут MSMQ-Routing-Service

Указывает, предоставляет ли этот сервер службы маршрутизации.
...
| LDAP-отображаемое имя | мсмкраутингсервице                   |
| Размер              | \-                                   |
