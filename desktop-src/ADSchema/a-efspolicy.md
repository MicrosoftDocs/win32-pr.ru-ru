...
ms.locfileid: "120054174"
---
# <a name="efspolicy-attribute"></a>Атрибут Ефсполици

Политика шифрованная файловая система (EFS).
...
|-------------------|-------------------------------------------------------|
| CN                | ефсполици                                             |
| LDAP-отображаемое имя | ефсполици                                             |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Политика домена**](c-domainpolicy.md)<br/> [**SAM-домен**](c-samdomain.md)<br/> |
