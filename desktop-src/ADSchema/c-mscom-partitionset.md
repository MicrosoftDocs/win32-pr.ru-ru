...
---
# <a name="ms-com-partitionset-class"></a>класс MS-COM-Partitioning

Концептуальная коллекция разделов COM+.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Блок MS-COM-Partition                  |
| LDAP-отображаемое имя | Мском-Partition                   |
...
| [**MS-COM-Дефаултпартитионлинк**](a-mscom-defaultpartitionlink.md)         | Неверно     | **Блок MS-COM-Partition**         |
| [**MS-COM-ObjectId**](a-mscom-objectid.md)                                 | Неверно     | **Блок MS-COM-Partition**         |
| [**MS-COM-Партитионлинк**](a-mscom-partitionlink.md)                       | Неверно     | **Блок MS-COM-Partition**         |
