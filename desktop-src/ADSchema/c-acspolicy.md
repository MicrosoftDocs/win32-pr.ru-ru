...
Политика распределения пропускной способности службы управления допуском для пользователя или профиля.
...
|-------------------|--------------------------------------|
| CN                | ACS-Policy                           |
| LDAP-отображаемое имя | аксполици                            |
...
|----------------------------------------------------------------------------------|-----------|---------------------------------|
| [**ACS-агрегирование-частота маркеров на пользователя**](a-acsaggregatetokenrateperuser.md)      | Неверно     | **ACS — политика**                  |
...
| [**ACS-разрешения — биты**](a-acspermissionbits.md)                               | Неверно     | **ACS — политика**                  |
| [**ACS — приоритет**](a-acspriority.md)                                            | Неверно     | **ACS — политика**                  |
| [**ACS-Service-Type**](a-acsservicetype.md)                                     | Неверно     | **ACS — политика**                  |
| [**ACS — время суток**](a-acstimeofday.md)                                        | Неверно     | **ACS — политика**                  |
| [**ACS-Total — нет потоков**](a-acstotalnoofflows.md)                             | Неверно     | **ACS — политика**                  |
