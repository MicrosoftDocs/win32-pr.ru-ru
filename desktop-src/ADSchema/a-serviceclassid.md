...
ms.locfileid: "119836654"
---
# <a name="service-class-id-attribute"></a>Атрибут Service-Class-ID

Идентификатор GUID для класса службы.
...
|-------------------|-------------------------------------------------------|
| CN                | Service-Class-ID                                      |
| LDAP-отображаемое имя | сервицеклассид                                        |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**Класс службы**](c-serviceclass.md)<br/> [**Экземпляр службы**](c-serviceinstance.md)<br/> |
