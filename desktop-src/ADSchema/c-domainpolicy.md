...
---
# <a name="domain-policy-class"></a>Класс Domain-Policy

Определяет политику локального центра безопасности для одного или нескольких доменов.
...
|-------------------|--------------------------------------|
| CN                | Domain-Policy                        |
| LDAP-отображаемое имя | домаинполици                         |
...
| Возможные старшие          | [](c-container.md)[**Домен контейнера —**](c-domaindns.md)[**организационное подразделение**](c-organizationalunit.md) DNS |
...
| [**Параметры проверки подлинности**](a-authenticationoptions.md)                 | Неверно     | **Политика домена**               |
...
| [**По умолчанию — локальная политика — объект**](a-defaultlocalpolicyobject.md)         | Неверно     | **Политика домена**               |
...
| [**Домен — центры сертификации**](a-domaincas.md)                     | Неверно     | **Политика домена**               |
| [**Справочник по политикам домена**](a-domainpolicyreference.md)                | Неверно     | **Политика домена**               |
| [**Политика на уровне домена**](a-domainwidepolicy.md)                          | Неверно     | **Политика домена**               |
...
| [**ефсполици**](a-efspolicy.md)                                          | Неверно     | **Политика домена**               |
| [**Имя расширения**](a-extensionname.md)                                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Метки**](a-flags.md)                                                  | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Принудительное завершение работы**](a-forcelogoff.md)                                     | Неверно     | **Политика домена**               |
...
| [**Справочник по IPsec-политикам**](a-ipsecpolicyreference.md)                  | Неверно     | **Политика домена**               |
...
| [**Продолжительность блокировки**](a-lockoutduration.md)                             | Неверно     | **Политика домена**               |
| [**Блокировка — наблюдение — окно**](a-lockoutobservationwindow.md)         | Неверно     | **Политика домена**               |
| [**Порог блокировки**](a-lockoutthreshold.md)                           | Неверно     | **Политика домена**               |
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Политика домена**               |
| [**Управляемые объекты**](a-managedobjects.md)                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**В основном**](a-masteredby.md)                                       | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Max-PWD-Age**](a-maxpwdage.md)                                        | Неверно     | **Политика домена**               |
| [**Max-продление — возраст**](a-maxrenewage.md)                                    | Неверно     | **Политика домена**               |
| [**Max-Ticket-Age**](a-maxticketage.md)                                  | Неверно     | **Политика домена**               |
| [**Min-PWD-Age**](a-minpwdage.md)                                        | Неверно     | **Политика домена**               |
| [**Min-PWD-length**](a-minpwdlength.md)                                  | Неверно     | **Политика домена**               |
| [**Min-Ticket-Age**](a-minticketage.md)                                  | Неверно     | **Политика домена**               |
...
| [**Прокси-время существования**](a-proxylifetime.md)                                 | Неверно     | **Политика домена**               |
| [**Открытая-Key — политика**](a-publickeypolicy.md)                            | Неверно     | **Политика домена**               |
| [**PWD-History-длина**](a-pwdhistorylength.md)                          | Неверно     | **Политика домена**               |
| [**PWD — свойства**](a-pwdproperties.md)                                 | Неверно     | **Политика домена**               |
| [**Качество обслуживания**](a-qualityofservice.md)                          | Неверно     | **Политика домена**               |
