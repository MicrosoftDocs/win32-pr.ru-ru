...
ms.locfileid: "119324494"
---
# <a name="infrastructure-update-class"></a>Класс Infrastructure-Update

Этот объект представляет хозяин инфраструктуры для домена.
...
| LDAP-отображаемое имя | инфраструктуреупдате                           |
...
| Возможные старшие          | Инфраструктура [**домена**](c-domain.md)**— Обновление** |
...
| [**DN — ссылка — обновление**](a-dnreferenceupdate.md)                        | Неверно     | **Инфраструктура — обновление**       |
