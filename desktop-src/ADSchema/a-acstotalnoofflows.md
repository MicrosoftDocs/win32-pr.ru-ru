...
ms.locfileid: "118689190"
---
# <a name="acs-total-no-of-flows-attribute"></a>ACS — Total — без потоков — атрибут

Общее число потоков, которые может иметь данный пользователь.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | ACS-Total — нет потоков                |
| LDAP-отображаемое имя | акстоталнуффловс                    |
| Размер              | 4 байта                              |
