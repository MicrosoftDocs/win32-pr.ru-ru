...
---
# <a name="rpc-server-class"></a>класс RPC-Server

Представляет определенный сервер, содержащий один или несколько интерфейсов RPC.
...
|-------------------|--------------------------------------|
| CN                | RPC-Server                           |
| LDAP-отображаемое имя | рпксервер                            |
...
| [**RPC-NS-Code**](a-rpcnscodeset.md)                                  | Неверно     | **RPC-Server**                                                                           |
| [**RPC-NS-Entry-flags**](a-rpcnsentryflags.md)                           | Неверно     | **RPC-Server**                                                                           |
| [**RPC-NS-Object-ID**](a-rpcnsobjectid.md)                               | Неверно     | **RPC-Server**                                                                           |
