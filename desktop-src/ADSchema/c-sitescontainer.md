...
---
# <a name="sites-container-class"></a>Класс Sites-Container

Контейнер для хранения объектов сайта. Находится в контексте именования конфигурации.
...
|-------------------|------------------------------------------|
| CN                | Sites-Container                          |
| LDAP-отображаемое имя | ситесконтаинер                           |
| Привилегия обновления  | Этот объект поддерживается системой. |
| Частота обновления  | При создании службы каталогов.   |
