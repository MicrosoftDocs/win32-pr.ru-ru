...
---
# <a name="domain-wide-policy-attribute"></a>Атрибут политики на уровне домена

Это предназначено для репликации пользовательской политики на клиентах.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | Политика на уровне домена                                    |
| LDAP-отображаемое имя | домаинвидеполици                                      |
| Размер              | \-                                                    |
