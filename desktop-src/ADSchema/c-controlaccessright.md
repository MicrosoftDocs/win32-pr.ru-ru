...
ms.locfileid: "118423204"
---
# <a name="control-access-right-class"></a>Класс с правом доступа Control

Определяет расширенное право, которое может быть предоставлено или отменено с помощью ACL.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Доступ с правом Control                 |
| LDAP-отображаемое имя | контролакцессригхт                   |
...
| [**Применяется к**](a-appliesto.md)                                         | Нет     | **Доступ с правом Control**        |
...
| [**Локализация — идентификатор экрана**](a-localizationdisplayid.md)                | Нет     | **Доступ с правом Control**        |
...
| [**Rights-GUID**](a-rightsguid.md)                                       | Нет     | **Доступ с правом Control**        |
...
| [**Допустимые — доступ**](a-validaccesses.md)                                 | Нет     | **Доступ с правом Control**        |
