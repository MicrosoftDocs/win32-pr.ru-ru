...
| [**Применяется к**](a-appliesto.md)                                         | Неверно     | **Доступ с правом Control**        |
...
| [**Локализация — идентификатор экрана**](a-localizationdisplayid.md)                | Неверно     | **Доступ с правом Control**        |
...
| [**Rights-GUID**](a-rightsguid.md)                                       | Неверно     | **Доступ с правом Control**        |
...
| [**Допустимые — доступ**](a-validaccesses.md)                                 | Неверно     | **Доступ с правом Control**        |
