...
ms.locfileid: "119646954"
---
# <a name="query-policy-bl-attribute"></a>Атрибут запроса — политика BL

Список всех объектов, содержащих ссылки на заданную политику запросов.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Запрос — политика — BL                         |
| LDAP-отображаемое имя | куериполицибл                           |
| Размер              | \-                                      |
