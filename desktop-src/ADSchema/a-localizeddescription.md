...
ИДЕНТИФИКАТОР локализации и отображаемое имя объекта.
...
| LDAP-отображаемое имя | локализеддескриптион                        |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**Регистрация категории**](c-categoryregistration.md)<br/> |
