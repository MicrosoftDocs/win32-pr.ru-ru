...
ms.locfileid: "119081508"
---
# <a name="package-type-attribute"></a>Атрибут Package-Type

Этот атрибут описывает тип установки, необходимый для пакета приложения, например MSI, EXE, CAB.
...
|-------------------|--------------------------------------|
| CN                | Package-Type                         |
| LDAP-отображаемое имя | packageType                          |
| Размер              | \-                                   |
