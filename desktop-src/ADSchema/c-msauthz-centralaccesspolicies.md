...
ms.locfileid: "118959903"
---
# <a name="ms-authz-central-access-policies-class"></a>класс MS-authz-Central-Access-Policies

Контейнер этого класса может содержать объекты политики централизованного доступа.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-authz-центральный доступ — политики     |
| LDAP-отображаемое имя | Мсаусз — ЦентралакцессполиЦиес        |
