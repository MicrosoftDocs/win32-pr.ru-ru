...
---
# <a name="netboot-current-client-count-attribute"></a>атрибут нетбут-Current-Client-Count

Атрибут **нетбут-Current-Client-Count** зарезервирован для внутреннего использования.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | нетбут-Current-Client-Счетчик         |
| LDAP-отображаемое имя | нетбуткуррентклиенткаунт            |
| Размер              | \-                                   |
