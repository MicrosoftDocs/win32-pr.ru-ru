...
---
# <a name="address-template-class"></a>Класс Address-Template

Задает сведения для шаблона вывода.
...
|-------------------|--------------------------------------|
| CN                | Address-Template                     |
| LDAP-отображаемое имя | аддресстемплате                      |
...
| Подкласс                 | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                     |
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------------------------------------------|
| [**Адрес-ввод-отображение-таблица**](a-addressentrydisplaytable.md)            | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
| [**Адрес-ввод-отображение-таблица-MSDOS**](a-addressentrydisplaytablemsdos.md) | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
| [**Синтаксис адреса**](a-addresssyntax.md)                                    | Неверно     | **Адрес — шаблон**                                                                     |
| [**Тип адреса**](a-addresstype.md)                                        | Неверно     | **Адрес — шаблон**                                                                     |
...
| [**Common-Name**](a-cn.md)                                                  | True      | [**Отображение шаблона**](c-displaytemplate.md)<br/> [**Вверх**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                               | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Описание**](a-description.md)                                         | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**Отображаемое имя**](a-displayname.md)                                        | True      | **Адрес — шаблон** [ **сверху**](c-top.md)<br/>                                     |
...
| [**Help-Data16**](a-helpdata16.md)                                          | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
| [**Help-Data32**](a-helpdata32.md)                                          | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
| [**Help-File-Name**](a-helpfilename.md)                                     | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
...
| [**Исходный-вывод-таблица**](a-originaldisplaytable.md)                     | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
| [**Исходный-отобразить-таблица-MSDOS**](a-originaldisplaytablemsdos.md)          | Неверно     | [**Отображение шаблона**](c-displaytemplate.md)<br/>                                 |
...
| [**Диалоговое окно "на сообщение"-"вывод-таблица"**](a-permsgdialogdisplaytable.md)           | Неверно     | **Адрес — шаблон**                                                                     |
| [**На РеЦип-Dialog-отобразить-таблица**](a-perrecipdialogdisplaytable.md)       | Неверно     | **Адрес — шаблон**                                                                     |
...
| [**Создание прокси-сервера с поддержкой создания**](a-proxygenerationenabled.md)                 | Неверно     | **Адрес — шаблон**                                                                     |
