...
ms.locfileid: "118686060"
---
# <a name="ms-dfsr-cachepolicy-attribute"></a>атрибут MS-DFSR-CachePolicy

Параметры политики кэша по запросу.
...
| LDAP-отображаемое имя | Мсдфср — CachePolicy                   |
| Размер              | \-                                   |
