...
---
# <a name="ms-kds-prov-rootkey-class"></a>класс MS-KDS-Prov-Руткэй

Корневые ключи для службы распространения ключей группы.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-KDS-Prov-Руткэй                  |
| LDAP-отображаемое имя | Мскдс — Провруткэй                    |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; EA) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D Конкретного |
...
| [**Common-Name**](a-cn.md)                                                                  | True      | **MS-KDS-Prov-руткэй** [ **Top**](c-top.md)<br/> |
...
| [**MS-KDS-Креатетиме**](a-mskds-createtime.md)                                              | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Домаинид**](a-mskds-domainid.md)                                                  | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-ПОДПРОГРАММ-Алгорисмид**](a-mskds-kdfalgorithmid.md)                                     | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-ПОДПРОГРАММ-param**](a-mskds-kdfparam.md)                                                 | Неверно     | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-PrivateKey-length**](a-mskds-privatekeylength.md)                                 | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-PublicKey-length**](a-mskds-publickeylength.md)                                   | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Руткэйдата**](a-mskds-rootkeydata.md)                                            | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Секретагримент-Алгорисмид**](a-mskds-secretagreementalgorithmid.md)             | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Секретагримент-param**](a-mskds-secretagreementparam.md)                         | Неверно     | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Усестарттиме**](a-mskds-usestarttime.md)                                          | True      | **MS-KDS-Prov-Руткэй**                                 |
| [**MS-KDS-Version**](a-mskds-version.md)                                                    | True      | **MS-KDS-Prov-Руткэй**                                 |
