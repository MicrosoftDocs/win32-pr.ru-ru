...
ms.locfileid: "119762054"
---
# <a name="msmq-site-id-attribute"></a>Атрибут MSMQ-site-ID

Атрибут **MSMQ-site-ID** содержит сведения о смешанном режиме MSMQ.
...
|-------------------|-------------------------------------------------------|
| CN                | MSMQ-site-ID                                          |
| LDAP-отображаемое имя | мсмкситеид                                            |
| Размер              | \-                                                    |
