...
ms.locfileid: "118685250"
---
# <a name="ms-ds-az-last-imported-biz-rule-path-attribute"></a>Атрибут ms-DS-AZ-Last-Imported-BizTalk-Rule-Path

Путь к последнему импортированному бизнес-правилу.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DS-AZ-Last-Imported-BizTalk-Rule-Path        |
| LDAP-отображаемое имя | msDS-Азластимпортедбизрулепас              |
| Размер              | 128 символов                              |
...
| Классы, используемые в        | [**MS-DS-AZ-Task**](c-msds-aztask.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                            |
| System-Flags           | 0x00000010                                                                            |
| Классы, используемые в        | [**Группа**](c-group.md)<br/> [**MS-DS-AZ-Task**](c-msds-aztask.md)<br/> |
