...
ms.locfileid: "119703914"
---
# <a name="application-site-settings-class"></a>класс приложения-Site-Параметры

Содержит все параметры, относящиеся к конкретному сайту.



| Ввод | Значение |
|-------------------|------------------------------------------------------|
| CN                | приложение — сайт — Параметры                            |
| LDAP-отображаемое имя | аппликатионситесеттингс                              |
| Привилегия обновления  | Это значение задается системой.                          |
| Частота обновления  | Каждый раз, когда это расширенное право применяется к новому классу. |
...
| [**Имя приложения**](a-applicationname.md)                             | Нет     | **приложение — сайт — Параметры**   |
...
| [**Список уведомлений**](a-notificationlist.md)                           | Нет     | **приложение — сайт — Параметры**   |
