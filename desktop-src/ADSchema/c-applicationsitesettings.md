...
---
# <a name="application-site-settings-class"></a>Класс параметров приложения и сайта
...
| [**Имя приложения**](a-applicationname.md)                             | Неверно     | **Приложение-сайт — параметры**   |
...
| [**Список уведомлений**](a-notificationlist.md)                           | Неверно     | **Приложение-сайт — параметры**   |
