...
Объект активации, используемый при активации на основе Active Directory



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-SPP-Activation — объект             |
| LDAP-отображаемое имя | МССПП — Активатионобжект               |
...
| Возможные старшие          | [**MS-SPP-Activation-Objects-Container**](c-msspp-activationobjectscontainer.md) |
