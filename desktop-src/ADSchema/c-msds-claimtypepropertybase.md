...
| [**Активировано**](a-enabled.md)                                                                 | Неверно     | **MS-DS-заявка-тип — свойство-Base** |
...
| [**MS-DS-ClaimSet-возможные значения**](a-msds-claimpossiblevalues.md)                            | Неверно     | **MS-DS-заявка-тип — свойство-Base** |
| [**MS-DS-ClaimSet-shares-возможные значения — с**](a-msds-claimsharespossiblevalueswith.md)      | Неверно     | **MS-DS-заявка-тип — свойство-Base** |
