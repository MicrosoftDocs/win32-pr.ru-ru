...
ms.locfileid: "118422789"
---
# <a name="ms-ds-claim-type-property-base-class"></a>MS-DS-заявка-тип-свойство-базовый класс

Абстрактный класс, определяющий базовый класс для типов утверждения или классов свойств ресурсов.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-DS-заявка-тип — свойство-Base       |
| LDAP-отображаемое имя | msDS-Клаимтипепропертибасе           |
...
| [**Активировано**](a-enabled.md)                                                                 | Нет     | **MS-DS-заявка-тип — свойство-Base** |
...
| [**MS-DS-ClaimSet-возможные значения**](a-msds-claimpossiblevalues.md)                            | Нет     | **MS-DS-заявка-тип — свойство-Base** |
| [**MS-DS-ClaimSet-shares-возможные значения — с**](a-msds-claimsharespossiblevalueswith.md)      | Нет     | **MS-DS-заявка-тип — свойство-Base** |
