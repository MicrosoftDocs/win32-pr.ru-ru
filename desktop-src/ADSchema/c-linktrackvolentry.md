...
ms.locfileid: "119834934"
---
# <a name="link-track-vol-entry-class"></a>Класс записи Link-Track-Vol

Запись для ссылки на файл в томе.



| Ввод | Значение |
|-------------------|---------------------------------------|
| CN                | Link-Track-Vol-запись                  |
| LDAP-отображаемое имя | линктраккволентри                     |
| Привилегия обновления  | Это значение задается системой.      |
| Частота обновления  | При создании ссылки на файл. |
...
| Возможные старшие          | [**Link-Tracking-Volume-Table**](c-linktrackvolumetable.md)                  |
...
| [**Идентификатор компьютера**](a-currmachineid.md)                                | Неверно     | **Link-Track-Vol-запись**        |
...
| [**Направление связи — секрет**](a-linktracksecret.md)                            | Неверно     | **Link-Track-Vol-запись**        |
...
| [**Число объектов**](a-objectcount.md)                                     | Неверно     | **Link-Track-Vol-запись**        |
...
| [**Seq — уведомление**](a-seqnotification.md)                             | Неверно     | **Link-Track-Vol-запись**        |
...
| [**Время — обновление**](a-timerefresh.md)                                     | Неверно     | **Link-Track-Vol-запись**        |
| [**Изменение времени и громкости**](a-timevolchange.md)                                | Неверно     | **Link-Track-Vol-запись**        |
...
| [**Vol-Таблица-GUID**](a-voltableguid.md)                                  | Неверно     | **Link-Track-Vol-запись**        |
| [**Vol-Table-idx-GUID**](a-voltableidxguid.md)                           | Неверно     | **Link-Track-Vol-запись**        |
