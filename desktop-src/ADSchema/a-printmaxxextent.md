...
---
# <a name="print-max-x-extent-attribute"></a>Print-Max-X-экстент, атрибут

Максимальная горизонтальная область печати.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Print-Max-X-экстент                   |
| LDAP-отображаемое имя | printMaxXExtent                      |
| Размер              | 4 байта                              |
