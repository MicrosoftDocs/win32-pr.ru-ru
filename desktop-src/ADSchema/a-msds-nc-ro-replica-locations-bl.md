...
---
# <a name="ms-ds-nc-ro-replica-locations-bl-attribute"></a>Атрибут ms-DS-NC-RO-Replica-Locations-BL

Атрибут обратной ссылки для [**MS-DS-NC-ro-Replica-Locations**](a-msds-nc-ro-replica-locations.md).
...
| LDAP-отображаемое имя | msDS-NC-RO-Replica-Locations-BL         |
| Размер              | \-                                      |
