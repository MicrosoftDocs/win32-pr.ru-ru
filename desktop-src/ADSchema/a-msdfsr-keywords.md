...
ms.locfileid: "118960943"
---
# <a name="ms-dfsr-keywords-attribute"></a>атрибут MS-DFSR-keywords

Содержит определяемые пользователем ключевые слова.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DFSR-ключевые слова                            |
| LDAP-отображаемое имя | Мсдфср — ключевые слова                             |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**MS-DFSR-Member**](c-msdfsr-member.md)<br/> [**MS-DFSR-подключение**](c-msdfsr-connection.md)<br/> |
...
Атрибут **MS-DFSR-keywords** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
