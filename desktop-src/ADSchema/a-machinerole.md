...
ms.locfileid: "119301334"
---
# <a name="machine-role-attribute"></a>Атрибут Machine-Role

Роль для компьютера: контроллер домена, сервер или рабочая станция.
...
|-------------------|--------------------------------------|
| CN                | Machine-Role                         |
| LDAP-отображаемое имя | мачинероле                          |
| Размер              | \-                                   |
