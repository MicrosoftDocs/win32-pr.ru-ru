...
---
# <a name="ms-imaging-postscanprocess-class"></a>MS-Imaging-Постсканпроцесс, класс

Объект процесса проверки после сканирования Enterprise Scan.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-Imaging-Постсканпроцесс           |
| LDAP-отображаемое имя | Мсимагинг — Постсканпроцесс            |
...
| Возможные старшие          | [**MS-Imaging-ПСПС**](c-msimaging-psps.md)                                                      |
...
| [**Отображаемое имя**](a-displayname.md)                                            | True      | **MS-Imaging — постсканпроцесс (** [ **вверху** )](c-top.md)<br/> |
...
| [**MS-Imaging-PSP-идентификатор**](a-msimaging-pspidentifier.md)                   | True      | **MS-Imaging-Постсканпроцесс**                                 |
| [**MS-Imaging-PSP-строка**](a-msimaging-pspstring.md)                           | Неверно     | **MS-Imaging-Постсканпроцесс**                                 |
...
| [**Имя сервера**](a-servername.md)                                              | Неверно     | **MS-Imaging-Постсканпроцесс**                                 |
