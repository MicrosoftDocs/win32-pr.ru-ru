...
---
# <a name="vol-table-idx-guid-attribute"></a>Атрибут Vol-Table-idx-GUID

Идентификатор индекса для записи таблицы Link-Track-Volume.
...
| LDAP-отображаемое имя | волтаблеидксгуид                                       |
| Размер              | 16 байт                                              |
| Привилегия обновления  | Это значение задается системой.                      |
| Частота обновления  | При создании новой ссылки на файл.             |
