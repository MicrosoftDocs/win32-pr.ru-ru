...
ms.locfileid: "118011034"
---
# <a name="ms-dfsr-member-class"></a>класс MS-DFSR-Member

Представляет член группы репликации.
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-Member                       |
| LDAP-отображаемое имя | Мсдфср — участник                        |
...
| Возможные старшие          | [**Топология MS-DFSR-Topology**](c-msdfsr-topology.md)                                                                                    |
...
| [**MS-DFSR-Компутерреференце**](a-msdfsr-computerreference.md)             | Верно      | **MS-DFSR-Member**              |
| [**MS-DFSR-Компутерреференцебл**](a-msdfsr-computerreferencebl.md)         | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **MS-DFSR-Member**              |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **MS-DFSR-Member**              |
| [**MS-DFSR-ключевые слова**](a-msdfsr-keywords.md)                               | Неверно     | **MS-DFSR-Member**              |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **MS-DFSR-Member**              |
...
| [**Справочник по серверу**](a-serverreference.md)                               | Неверно     | **MS-DFSR-Member**              |
...
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                    | Неверно     | **MS-DFSR-Member**              |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Неверно     | **MS-DFSR-Member**              |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)    | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-Member** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
