...
ms.locfileid: "119922554"
---
# <a name="ipsec-nfa-class"></a>Класс IPSec-NFA

Класс **IPSec-NFA** предназначен только для внутреннего использования.
...
|-------------------|--------------------------------------|
| CN                | IPSec-NFA                            |
| LDAP-отображаемое имя | ипсекнфа                             |
...
| Возможные старшие          | [**Контейнер**](c-container.md) [**организационного**](c-organizationalunit.md)[**компьютера**](c-computer.md) |
...
| [**Справочник по IPsec-Filtering**](a-ipsecfilterreference.md)                        | Неверно     | **IPSec-NFA**                                |
...
| [**IPSec-согласование — политика-Справочник**](a-ipsecnegotiationpolicyreference.md) | Неверно     | **IPSec-NFA**                                |
