...
ms.locfileid: "117836227"
---
# <a name="ms-dfsr-connection-class"></a>класс MS-DFSR-Connection

Представляет направление соединения между двумя членами.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-подключение                   |
| LDAP-отображаемое имя | Мсдфср — подключение                    |
...
| Возможные старшие          | [**MS-DFSR-Member**](c-msdfsr-member.md)                                                                                        |
...
| [**From-Server**](a-fromserver.md)                                         | Верно      | **MS-DFSR-подключение**          |
...
| [**Поддержка MS-DFSR**](a-msdfsr-enabled.md)                                 | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **MS-DFSR-подключение**          |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-ключевые слова**](a-msdfsr-keywords.md)                               | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Рдценаблед**](a-msdfsr-rdcenabled.md)                           | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Рдкминфилесизеинкб**](a-msdfsr-rdcminfilesizeinkb.md)           | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Schedule**](a-msdfsr-schedule.md)                               | Неверно     | **MS-DFSR-подключение**          |
...
| [**MS-COM-Усерлинк**](a-mscom-userlink.md)                                    | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Компутерреференцебл**](a-msdfsr-computerreferencebl.md)            | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Дисаблепаккетприваци**](a-msdfsr-disablepacketprivacy.md)          | Неверно     | **MS-DFSR-подключение**          |
| [**Поддержка MS-DFSR**](a-msdfsr-enabled.md)                                    | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                                | Неверно     | **MS-DFSR-подключение**          |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                        | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-ключевые слова**](a-msdfsr-keywords.md)                                  | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                    | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Priority**](a-msdfsr-priority.md)                                  | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Рдценаблед**](a-msdfsr-rdcenabled.md)                              | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Рдкминфилесизеинкб**](a-msdfsr-rdcminfilesizeinkb.md)              | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DFSR-Schedule**](a-msdfsr-schedule.md)                                  | Неверно     | **MS-DFSR-подключение**          |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)    | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-Connection** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
