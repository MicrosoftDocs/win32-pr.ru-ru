...
ms.locfileid: "119805154"
---
# <a name="dhcp-flags-attribute"></a>атрибут DHCP-flags

Атрибут **DHCP-flags** в настоящее время не используется.
...
|-------------------|--------------------------------------|
| CN                | DHCP-флаги                           |
| LDAP-отображаемое имя | дхкпфлагс                            |
| Размер              | \-                                   |
