...
ms.locfileid: "119801874"
---
# <a name="dsa-class"></a>Класс DSA

Служба каталогов использует только подкласс MSFT-DSA.
...
|-------------------|--------------------------------------|
| CN                | DSA                                  |
| LDAP-отображаемое имя | Nисходный                                  |
...
| Подкласс                 | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
| Возможные старшие          | [](c-computer.md)[**Сервер** компьютера](c-server.md)                                     |
...
| [**Common-Name**](a-cn.md)                                               | Верно      | [**Сущность приложения**](c-applicationentity.md)<br/> [**Вверх**](c-top.md)<br/> |
...
| [**Сведения о базе знаний**](a-knowledgeinformation.md)                   | Нет     | **DSA**                                                                                      |
| [**Последний-известный-родительский**](a-lastknownparent.md)                            | Нет     | [**Вверх**](c-top.md)<br/>                                                              |
| [**Локальное имя**](a-l.md)                                              | Нет     | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                  | Нет     | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
| [**Название организации**](a-o.md)                                          | Нет     | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
...
| [**Представление — адрес**](a-presentationaddress.md)                     | Верно      | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
...
| [**См. также**](a-seealso.md)                                             | Нет     | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
...
| [**Поддерживается — контекст приложения**](a-supportedapplicationcontext.md)    | Нет     | [**Сущность приложения**](c-applicationentity.md)<br/>                                 |
