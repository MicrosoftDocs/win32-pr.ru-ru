...
ms.locfileid: "119923644"
---
# <a name="print-form-name-attribute"></a>Print — атрибут Name-Form

Имя загруженной в данный момент формы.
...
|-------------------|---------------------------------------------|
| CN                | Print-Form-Name                             |
| LDAP-отображаемое имя | принтформнаме                               |
| Размер              | \-                                          |
