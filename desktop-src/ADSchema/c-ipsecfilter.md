...
ms.locfileid: "119835054"
---
# <a name="ipsec-filter-class"></a>Класс Ipsec-Filter

Представляет фильтр IPSec, который используется для создания политик безопасности, например тех, которые блокируют порты и протоколы.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Filter                         |
| LDAP-отображаемое имя | ипсекфилтер                          |
