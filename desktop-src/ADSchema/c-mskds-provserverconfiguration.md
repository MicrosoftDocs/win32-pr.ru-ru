...
---
# <a name="ms-kds-prov-serverconfiguration-class"></a>класс MS-KDS-Prov-Серверконфигуратион

Настройка службы распространения ключей группы.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-KDS-Prov-Серверконфигуратион      |
| LDAP-отображаемое имя | Мскдс — Провсерверконфигуратион        |
...
| [**MS-KDS-ПОДПРОГРАММ-Алгорисмид**](a-mskds-kdfalgorithmid.md)                                     | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-ПОДПРОГРАММ-param**](a-mskds-kdfparam.md)                                                 | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-PrivateKey-length**](a-mskds-privatekeylength.md)                                 | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-PublicKey-length**](a-mskds-publickeylength.md)                                   | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-Секретагримент-Алгорисмид**](a-mskds-secretagreementalgorithmid.md)             | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-Секретагримент-param**](a-mskds-secretagreementparam.md)                         | Неверно     | **MS-KDS-Prov-Серверконфигуратион** |
| [**MS-KDS-Version**](a-mskds-version.md)                                                    | True      | **MS-KDS-Prov-Серверконфигуратион** |
