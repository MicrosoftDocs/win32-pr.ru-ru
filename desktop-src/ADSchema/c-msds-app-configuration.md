...
Используется для хранения сведений о параметрах приложения. Для хранения фактических значений следует использовать атрибут [**MS-DS-Settings**](a-msds-settings.md) .
...
| [**Keywords**](a-keywords.md)                                              | Неверно     | **MS-DS-App-Configuration**                                      |
