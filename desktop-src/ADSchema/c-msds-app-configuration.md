...
description: Используется для хранения сведений о параметрах приложения. для хранения фактических значений следует использовать атрибут ms-DS-Параметры.
...
ms.locfileid: "119880604"
---
# <a name="ms-ds-app-configuration-class"></a>класс конфигурации MS-DS-App-Configuration

Используется для хранения сведений о параметрах приложения. для хранения фактических значений следует использовать атрибут [**ms-DS-Параметры**](a-msds-settings.md) .
...
| LDAP-отображаемое имя | msDS-Конфигурация приложения                         |
...
| [**Словами**](a-keywords.md)                                              | Неверно     | **MS-DS-App-Configuration**                                      |
| [**Последний-известный-родительский**](a-lastknownparent.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                                  |
| [**Под управлением**](a-managedby.md)                                           | Неверно     | **MS-DS-App-Configuration**                                      |
...
| [**MS-DS-Byte-массив**](a-msds-bytearray.md)                                | Неверно     | **MS-DS-App-Configuration**                                      |
...
| [**MS-DS-Дата-время**](a-msds-datetime.md)                                  | Неверно     | **MS-DS-App-Configuration**                                      |
| [**MS-DS-целое число**](a-msds-integer.md)                                     | Неверно     | **MS-DS-App-Configuration**                                      |
...
| [**Справочник по MS-DS-Object-**](a-msds-objectreference.md)                    | Неверно     | **MS-DS-App-Configuration**                                      |
...
| [**Владелец**](a-owner.md)                                                    | Неверно     | **MS-DS-App-Configuration**                                      |
