...
ms.locfileid: "119022832"
---
# <a name="allowed-attributes-effective-attribute"></a>Allowed-Attributes-действующий атрибут

Список атрибутов, которые могут быть изменены для объекта.



| Ввод | Значение |
|-------------------|-----------------------------------------------------------------|
| CN                | Allowed-Attributes-эффективен                                    |
| LDAP-отображаемое имя | алловедаттрибутесеффективе                                      |
| Размер              | \-                                                              |
