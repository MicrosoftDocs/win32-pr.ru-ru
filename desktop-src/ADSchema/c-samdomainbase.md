...
| [**Время создания**](a-creationtime.md)                                   | Нет     | **SAM-домен-база**                                 |
...
| [**Домен — реплика**](a-domainreplica.md)                                 | Нет     | **SAM-домен-база**                                 |
...
| [**Принудительное завершение работы**](a-forcelogoff.md)                                     | Нет     | **SAM-домен-база**                                 |
...
| [**Продолжительность блокировки**](a-lockoutduration.md)                             | Нет     | **SAM-домен-база**                                 |
| [**Блокировка — наблюдение — окно**](a-lockoutobservationwindow.md)         | Нет     | **SAM-домен-база**                                 |
| [**Порог блокировки**](a-lockoutthreshold.md)                           | Нет     | **SAM-домен-база**                                 |
| [**Управляемые объекты**](a-managedobjects.md)                               | Нет     | [**Вверх**](c-top.md)<br/>                     |
| [**В основном**](a-masteredby.md)                                       | Нет     | [**Вверх**](c-top.md)<br/>                     |
| [**Max-PWD-Age**](a-maxpwdage.md)                                        | Нет     | **SAM-домен-база**                                 |
| [**Min-PWD-Age**](a-minpwdage.md)                                        | Нет     | **SAM-домен-база**                                 |
| [**Min-PWD-length**](a-minpwdlength.md)                                  | Нет     | **SAM-домен-база**                                 |
| [**Изменено — количество**](a-modifiedcount.md)                                 | Нет     | **SAM-домен-база**                                 |
| [**Изменено — количество-за последние — Пром**](a-modifiedcountatlastprom.md)          | Нет     | **SAM-домен-база**                                 |
...
| [**Next-RID**](a-nextrid.md)                                             | Нет     | **SAM-домен-база**                                 |
| [**Не-Security-Member-BL**](a-nonsecuritymemberbl.md)                   | Нет     | [**Вверх**](c-top.md)<br/>                     |
| [**NT-Security-дескриптор**](a-ntsecuritydescriptor.md)                  | Верно      | **SAM-домен-база** [ **сверху**](c-top.md)<br/> |
...
| [**Идентификатор безопасности объекта**](a-objectsid.md)                                         | Нет     | **SAM-домен-база**                                 |
| [**Версия объекта**](a-objectversion.md)                                 | Нет     | [**Вверх**](c-top.md)<br/>                     |
| [**OEM-информация**](a-oeminformation.md)                               | Нет     | **SAM-домен-база**                                 |
...
| [**PWD-History-длина**](a-pwdhistorylength.md)                          | Нет     | **SAM-домен-база**                                 |
| [**PWD — свойства**](a-pwdproperties.md)                                 | Нет     | **SAM-домен-база**                                 |
...
| [**Редакции**](a-revision.md)                                            | Нет     | **SAM-домен-база** [ **сверху**](c-top.md)<br/> |
...
| [**Роль сервера**](a-serverrole.md)                                       | Нет     | **SAM-домен-база**                                 |
| [**Состояние сервера**](a-serverstate.md)                                     | Нет     | **SAM-домен-база**                                 |
...
| [**UAS — совместимость**](a-uascompat.md)                                         | Нет     | **SAM-домен-база**                                 |
