...
ms.locfileid: "117837594"
---
# <a name="ms-wmi-intflags4-attribute"></a>атрибут MS-WMI-intFlags4

Атрибут **MS-WMI-intFlags4** зарезервирован для внутреннего использования.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-intFlags4                     |
| LDAP-отображаемое имя | Мсвми — intFlags4                      |
| Размер              | 4 байта                              |
...
| Классы, используемые в        | [**MS-WMI-Обжектенкодинг**](c-mswmi-objectencoding.md)<br/> [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> [**MS-WMI-PolicyType**](c-mswmi-policytype.md)<br/> [**MS-WMI-SOM**](c-mswmi-som.md)<br/> [**MS-WMI-ВМИГПО**](c-mswmi-wmigpo.md)<br/> |
