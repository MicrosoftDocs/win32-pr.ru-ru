...
---
# <a name="certificate-templates-attribute"></a>Атрибут Certificate-Templates

Содержит сведения о сертификате, выданном сервером сертификатов.
...
| LDAP-отображаемое имя | цертификатетемплатес                        |
| Размер              | \-                                          |
