...
ms.locfileid: "118961553"
---
# <a name="enabled-attribute"></a>Включенный атрибут

Этот атрибут используется для обозначения того, включен ли данный режим crossRef.
...
|-------------------|--------------------------------------|
| CN                | Активировано                              |
| LDAP-отображаемое имя | Активировано                              |
| Размер              | \-                                   |
...
| Search-Flags           | 0x00000000                                                                                                                                                          |
| System-Flags           | 0x00000010                                                                                                                                                          |
| Классы, используемые в        | [**Перекрестная ссылка**](c-crossref.md)<br/> [**MS-DS-Service-Connection-Point-publication-Service**](c-msds-serviceconnectionpointpublicationservice.md)<br/> |
