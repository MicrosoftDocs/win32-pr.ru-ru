...
ms.locfileid: "119022632"
---
# <a name="mssfu-30-max-gid-number-attribute"></a>атрибут Мссфу-30-Max-GID-Number

Содержит максимальное число групп, перенесенных в домен NIS.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Мссфу-30-Max-GID-Number              |
| LDAP-отображаемое имя | msSFU30MaxGidNumber                  |
| Размер              | \-                                   |
