...
ms.locfileid: "119022012"
---
# <a name="transport-dll-name-attribute"></a>Атрибут имени транспорта-DLL

Имя библиотеки DLL, которая будет управлять транспортом.
...
| LDAP-отображаемое имя | транспортдллнаме                            |
| Размер              | \-                                          |
