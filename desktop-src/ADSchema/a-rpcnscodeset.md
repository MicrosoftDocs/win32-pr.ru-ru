...
---
# <a name="rpc-ns-codeset-attribute"></a>атрибут RPC-NS-Code

Список наборов символов, поддерживаемых сервером.
...
|-------------------|---------------------------------------------|
| CN                | RPC-NS-Code                              |
| LDAP-отображаемое имя | рпкнскодесет                                |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**RPC-Server**](c-rpcserver.md)<br/> |
