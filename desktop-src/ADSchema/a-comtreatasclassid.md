...
---
# <a name="com-treat-as-class-id-attribute"></a>Атрибут COM-Treat-As-Class-ID

Treat-As строковый идентификатор CLSID для класса узла.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | COM-интерпретировать-As-Class-ID                       |
| LDAP-отображаемое имя | комтреатасклассид                           |
| Размер              | \-                                          |
