...
ms.locfileid: "118959863"
---
# <a name="ms-dfsr-topology-class"></a>класс топологии MS-DFSR-Topology

Содержит объекты, которые формируют топологию репликации.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Топология MS-DFSR-Topology                     |
| LDAP-отображаемое имя | Мсдфср — топология                      |
...
| Возможные старшие          | [**MS-DFSR-группы репликации**](c-msdfsr-replicationgroup.md)                                                                    |
...
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **Топология MS-DFSR-Topology**            |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **Топология MS-DFSR-Topology**            |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **Топология MS-DFSR-Topology**            |
...
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                    | Неверно     | **Топология MS-DFSR-Topology**            |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Неверно     | **Топология MS-DFSR-Topology**            |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)    | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-Topology** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
