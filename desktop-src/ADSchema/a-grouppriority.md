...
ms.locfileid: "118961323"
---
# <a name="group-priority-attribute"></a>Атрибут Group-Priority

Атрибут **Group-Priority** в настоящее время не используется.
...
|-------------------|---------------------------------------------|
| CN                | Group-Priority                              |
| LDAP-отображаемое имя | граупприорити                               |
| Размер              | \-                                          |
