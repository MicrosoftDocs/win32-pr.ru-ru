...
ms.locfileid: "118175179"
---
# <a name="ms-wmi-shadowobject-class"></a>класс MS-WMI-Шадовобжект

Содержит экземпляр скомпилированного объекта WMI.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Шадовобжект                  |
| LDAP-отображаемое имя | Мсвми — Шадовобжект                   |
...
| Возможные старшие          | [**MS-WMI-PolicyType**](c-mswmi-policytype.md)                                              |
...
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Верно      | **MS-WMI-Шадовобжект**         |
