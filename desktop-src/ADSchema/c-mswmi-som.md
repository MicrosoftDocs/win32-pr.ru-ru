...
---
# <a name="ms-wmi-som-class"></a>класс MS-WMI-SOM

Уточнение области управления групповая политика объекта. Добавляет список правил, выраженных в виде WQL-запросов, выполняемых на конечном компьютере. Все запросы должны возвращать результаты для этого SOM, чтобы быть применимыми к целевому объекту.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-SOM                           |
| LDAP-отображаемое имя | Мсвми-SOM                            |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПЛКЛОРК;;; AU) (A;; РПВПКРЛКЛОККДКРКВДВОСВ;;;D А) (A;; CC;;; PA) (A;; РПВПКРЛКЛОККДКРКВДВОСДДТСВ;;; SY |
...
| [**MS-WMI-Author**](a-mswmi-author.md)                                     | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-ChangeDate**](a-mswmi-changedate.md)                             | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-ID**](a-mswmi-id.md)                                             | True      | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-Name**](a-mswmi-name.md)                                         | True      | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Неверно     | **MS-WMI-SOM**                  |
| [**MS-WMI-Саурцеорганизатион**](a-mswmi-sourceorganization.md)             | Неверно     | **MS-WMI-SOM**                  |
