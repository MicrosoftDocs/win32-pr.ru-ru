...
| [**Расположение**](a-location.md)                                            | Неверно     | **Подсеть**                      |
...
| [**Физическое расположение — объект**](a-physicallocationobject.md)              | Неверно     | **Подсеть**                      |
...
| [**Сайт-объект**](a-siteobject.md)                                       | Неверно     | **Подсеть**                      |
