...
ms.locfileid: "119548854"
---
# <a name="subnet-class"></a>Класс подсети

Представляет определенную подсеть в сети, к которой подключены серверы и рабочие станции.
...
| Возможные старшие          | [**Подсеть — контейнер**](c-subnetcontainer.md)                                                |
...
| [**Расположение**](a-location.md)                                            | Нет     | **Подсеть**                      |
...
| [**Физическое расположение — объект**](a-physicallocationobject.md)              | Нет     | **Подсеть**                      |
...
| [**Сайт-объект**](a-siteobject.md)                                       | Нет     | **Подсеть**                      |
