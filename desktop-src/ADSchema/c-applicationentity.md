...
| [**Common-Name**](a-cn.md)                                               | True      | **Приложение —** [ **Начало** сущности](c-top.md)<br/> |
...
| [**Локальное имя**](a-l.md)                                              | Неверно     | **Сущность приложения**                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                  | Неверно     | **Сущность приложения**                                 |
| [**Название организации**](a-o.md)                                          | Неверно     | **Сущность приложения**                                 |
...
| [**Представление — адрес**](a-presentationaddress.md)                     | True      | **Сущность приложения**                                 |
...
| [**См. также**](a-seealso.md)                                             | Неверно     | **Сущность приложения**                                 |
...
| [**Поддерживается — контекст приложения**](a-supportedapplicationcontext.md)    | Неверно     | **Сущность приложения**                                 |
