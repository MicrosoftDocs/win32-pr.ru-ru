...
UUID синтаксиса перемещения, поддерживаемого текущей записью.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | RPC-NS-передает-синтаксис                      |
| LDAP-отображаемое имя | рпкнстрансферсинтакс                         |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**RPC-Server-Element**](c-rpcserverelement.md)<br/> |
