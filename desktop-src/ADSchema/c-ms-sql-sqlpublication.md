...
---
# <a name="ms-sql-sqlpublication-class"></a>Класс MS-SQL-Склпубликатион

Класс для хранения свойств публикации SQL Server. Разрешает пользователю просматривать публикации, доступные для подписки.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-SQL-Склпубликатион                |
| LDAP-отображаемое имя | mS-SQL-Склпубликатион                |
...
| Возможные старшие          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
...
| [**MS-SQL-Аллованонимауссубскриптион**](a-ms-sql-allowanonymoussubscription.md)                 | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-Алловиммедиатеупдатингсубскриптион**](a-ms-sql-allowimmediateupdatingsubscription.md) | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-Алловкновнпуллсубскриптион**](a-ms-sql-allowknownpullsubscription.md)                 | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-Алловкуеуедупдатингсубскриптион**](a-ms-sql-allowqueuedupdatingsubscription.md)       | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-Алловснапшотфилесфтпдовнлоадинг**](a-ms-sql-allowsnapshotfilesftpdownloading.md)     | Неверно     | **MS-SQL-Склпубликатион**       |
| [**База данных MS-SQL**](a-ms-sql-database.md)                                                     | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL — описание**](a-ms-sql-description.md)                                               | Неверно     | **MS-SQL-Склпубликатион**       |
| [**Имя MS-SQL**](a-ms-sql-name.md)                                                             | Неверно     | **MS-SQL-Склпубликатион**       |
| [**Издатель MS-SQL-Publisher**](a-ms-sql-publisher.md)                                                   | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-состояние**](a-ms-sql-status.md)                                                         | Неверно     | **MS-SQL-Склпубликатион**       |
| [**MS-SQL-сторонних**](a-ms-sql-thirdparty.md)                                                 | Неверно     | **MS-SQL-Склпубликатион**       |
| [**Тип MS-SQL**](a-ms-sql-type.md)                                                             | Неверно     | **MS-SQL-Склпубликатион**       |
