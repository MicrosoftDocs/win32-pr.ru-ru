...
ms.locfileid: "119549144"
---
# <a name="security-object-class"></a>Класс Security-Object

Это вспомогательный класс, который используется для обнаружения субъектов безопасности.
...
|-------------------|--------------------------------------|
| CN                | Security-Object                      |
| LDAP-отображаемое имя | секуритйобжект                       |
...
| [**Common-Name**](a-cn.md)                                               | Верно      | **Безопасность-** [ **Начало** объекта](c-top.md)<br/> |
