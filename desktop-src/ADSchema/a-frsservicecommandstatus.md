...
ms.locfileid: "119323494"
---
# <a name="frs-service-command-status-attribute"></a>Атрибут FRS-Service-Command-Status

Ответ последней команды, выданной члену.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Служба FRS-Service-Command-Status                  |
| LDAP-отображаемое имя | фрссервицекоммандстатус                     |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**NTFRS — подписчик**](c-ntfrssubscriber.md)<br/> |
