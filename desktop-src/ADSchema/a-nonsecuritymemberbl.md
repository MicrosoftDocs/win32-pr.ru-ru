...
---
# <a name="non-security-member-bl-attribute"></a>Атрибут не-Security-Member-BL

Список незащищенных членов для списка рассылки Exchange.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Не-Security-Member-BL                  |
| LDAP-отображаемое имя | нонсекуритимембербл                     |
| Размер              | \-                                      |
| Привилегия обновления  | Это значение задается системой.        |
| Частота обновления  | \-                                      |
| Attribute-Id      | 1.2.840.113556.1.4.531                  |
| System-ID — GUID    | 52458019-ca6a-11D0-аффф-0000f80367c1    |
