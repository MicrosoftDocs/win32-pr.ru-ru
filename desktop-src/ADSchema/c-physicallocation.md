...
ms.locfileid: "119753054"
---
# <a name="physical-location-class"></a>Класс Physical-Location

Хранит сведения о физическом адресе.
...
| LDAP-отображаемое имя | фисикаллокатион                       |
...
| Подкласс                 | [**Расположение**](c-locality.md)<br/>                                                    |
| Возможные старшие          | [](c-configuration.md)**Физическое расположение** конфигурации                                |
...
| [**Локальное имя**](a-l.md)                                              | Верно      | [**Расположение**](c-locality.md)<br/> |
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Физическое расположение**                     |
...
| [**Поиск — Обзор**](a-searchguide.md)                                     | Неверно     | [**Расположение**](c-locality.md)<br/> |
| [**См. также**](a-seealso.md)                                             | Неверно     | [**Расположение**](c-locality.md)<br/> |
...
| [**State-или-провинция-Name**](a-st.md)                                    | Неверно     | [**Расположение**](c-locality.md)<br/> |
| [**Улица-адрес**](a-street.md)                                        | Неверно     | [**Расположение**](c-locality.md)<br/> |
