...
Содержит сведения о участии локального компьютера в наборе содержимого.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Подписка MS-DFSR-Subscription                 |
| LDAP-отображаемое имя | Мсдфср — подписка                  |
...
| Возможные старшие          | [**Подписчик MS-DFSR**](c-msdfsr-subscriber.md)                                                                                |
...
| [**MS-DFSR-Стагингпас**](a-msdfsr-stagingpath.md)                         | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Стагингсизеинмб**](a-msdfsr-stagingsizeinmb.md)                 | Неверно     | **Подписка MS-DFSR-Subscription**        |
...
| [**MS-COM-Партитионсетлинк**](a-mscom-partitionsetlink.md)                                   | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-COM-Усерлинк**](a-mscom-userlink.md)                                                   | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-CachePolicy**](a-msdfsr-cachepolicy.md)                                           | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Компутерреференцебл**](a-msdfsr-computerreferencebl.md)                           | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Конфликтпас**](a-msdfsr-conflictpath.md)                                         | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Конфликтсизеинмб**](a-msdfsr-conflictsizeinmb.md)                                 | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Контентсетгуид**](a-msdfsr-contentsetguid.md)                                     | True      | **Подписка MS-DFSR-Subscription**        |
...
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                                               | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                                       | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Максажеинкачеинмин**](a-msdfsr-maxageincacheinmin.md)                             | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Миндуратионкачеинмин**](a-msdfsr-mindurationcacheinmin.md)                       | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Ондемандексклусиондиректорифилтер**](a-msdfsr-ondemandexclusiondirectoryfilter.md) | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Ондемандексклусионфилефилтер**](a-msdfsr-ondemandexclusionfilefilter.md)           | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                                   | Неверно     | **Подписка MS-DFSR-Subscription**        |
...
| [**MS-DFSR-RootPath**](a-msdfsr-rootpath.md)                                                 | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Рутсизеинмб**](a-msdfsr-rootsizeinmb.md)                                         | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Стагингклеануптригжеринперцент**](a-msdfsr-stagingcleanuptriggerinpercent.md)     | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Стагингпас**](a-msdfsr-stagingpath.md)                                           | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DFSR-Стагингсизеинмб**](a-msdfsr-stagingsizeinmb.md)                                   | Неверно     | **Подписка MS-DFSR-Subscription**        |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)                   | Неверно     | [**Вверх**](c-top.md)<br/> |
