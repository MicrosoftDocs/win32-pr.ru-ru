...
ms.locfileid: "118680950"
---
# <a name="ieee802device-class"></a>класс ieee802Device

Представляет устройство с MAC-адресом.
...
|-------------------|--------------------------------------|
| CN                | ieee802Device                        |
| LDAP-отображаемое имя | ieee802Device                        |
...
| [**Common-Name**](a-cn.md)                                                 | Неверно     | **ieee802Device** [ **сверху**](c-top.md)<br/> |
...
| [**macAddress**](a-macaddress.md)                                          | Неверно     | **ieee802Device**                                 |
