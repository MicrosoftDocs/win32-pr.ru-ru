...
---
# <a name="display-specifier-class"></a>Класс Display-Specifier

Описывает контекстные меню и страницы свойств для использования с объектом в каталоге.
...
| LDAP-отображаемое имя | дисплайспеЦифиер                     |
...
|---------------------------------------------------------------------------|-----------|---------------------------------|
| [**Контекстное меню администратора**](a-admincontextmenu.md)                          | Неверно     | **Описатель вывода**           |
...
| [**Свойства администрирования — страницы**](a-adminpropertypages.md)                      | Неверно     | **Описатель вывода**           |
...
| [**Атрибуты-отображаемые имена**](a-attributedisplaynames.md)                | Неверно     | **Описатель вывода**           |
...
| [**Класс-отображаемое имя**](a-classdisplayname.md)                          | Неверно     | **Описатель вывода**           |
| [**Common-Name**](a-cn.md)                                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Контекстное меню**](a-contextmenu.md)                                     | Неверно     | **Описатель вывода**           |
| [**Диалоговое окно создания**](a-createdialog.md)                                   | Неверно     | **Описатель вывода**           |
| [**Метка времени создания**](a-createtimestamp.md)                            | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Create-Wizard-ext**](a-createwizardext.md)                            | Неверно     | **Описатель вывода**           |
| [**Мастер создания**](a-creationwizard.md)                               | Неверно     | **Описатель вывода**           |
...
| [**Icon-путь**](a-iconpath.md)                                           | Неверно     | **Описатель вывода**           |
...
| [**Фильтр запроса**](a-queryfilter.md)                                     | Неверно     | **Описатель вывода**           |
...
| [**Флаги области**](a-scopeflags.md)                                       | Неверно     | **Описатель вывода**           |
...
| [**Контекстное меню оболочки**](a-shellcontextmenu.md)                          | Неверно     | **Описатель вывода**           |
| [**Свойства оболочки — страницы**](a-shellpropertypages.md)                      | Неверно     | **Описатель вывода**           |
...
| [**Обрабатывать как конечный**](a-treatasleaf.md)                                    | Неверно     | **Описатель вывода**           |
...
| [**Описание администратора**](a-admindescription.md)                             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Имя администратора-отображение**](a-admindisplayname.md)                            | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Администрирование — Многовыборочные страницы свойств**](a-adminmultiselectpropertypages.md) | Неверно     | **Описатель вывода**           |
| [**Свойства администрирования — страницы**](a-adminpropertypages.md)                        | Неверно     | **Описатель вывода**           |
| [**Allowed-Attributes**](a-allowedattributes.md)                           | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Allowed-Attributes-эффективен**](a-allowedattributeseffective.md)        | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Allowed-Child-classes**](a-allowedchildclasses.md)                      | Неверно     | [**Вверх**](c-top.md)<br/> |
...
| [**DS-Core-распространение-данные**](a-dscorepropagationdata.md)                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Имя расширения**](a-extensionname.md)                                   | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Дополнительные столбцы**](a-extracolumns.md)                                     | Неверно     | **Описатель вывода**           |
| [**Метки**](a-flags.md)                                                    | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Из записи**](a-fromentry.md)                                           | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**FRS-Computer-Reference-BL**](a-frscomputerreferencebl.md)               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                   | Неверно     | [**Вверх**](c-top.md)<br/> |
