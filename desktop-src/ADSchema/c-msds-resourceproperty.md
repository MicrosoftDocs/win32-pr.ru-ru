...
| [**Включен**](a-enabled.md)                                                                     | Неверно     | [**MS-DS-заявка-тип — свойство-Base**](c-msds-claimtypepropertybase.md)<br/> |
...
| [**MS-DS-применяется к типам ресурсов**](a-msds-appliestoresourcetypes.md)                         | Неверно     | **MS-DS-Resource-свойство**                                                       |
...
| [**MS-DS-используется в качестве-Resource-Security-Attribute**](a-msds-isusedasresourcesecurityattribute.md) | Неверно     | **MS-DS-Resource-свойство**                                                       |
...
| [**Справочник по MS-DS-value-type-**](a-msds-valuetypereference.md)                                  | Верно      | **MS-DS-Resource-свойство**                                                       |
