...
---
# <a name="rpc-entry-class"></a>класс входа RPC

Абстрактный класс, подклассы которого используются службой имен RPC (NS), доступ к которым осуществляется с помощью \* функций рпкнс в API Win32.
...
|-------------------|--------------------------------------|
| CN                | Запись RPC                            |
| LDAP-отображаемое имя | рпцентри                             |
