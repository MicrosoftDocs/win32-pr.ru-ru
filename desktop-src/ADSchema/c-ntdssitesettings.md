---
title: класс NTDS-Site-Параметры
...
keywords:
- схема AD для класса NTDS-Site-Параметры
...
ms.locfileid: "119753414"
---
# <a name="ntds-site-settings-class"></a>класс NTDS-Site-Параметры

Контейнер для хранения всех Active Directory параметров конкретного сайта.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | NTDS-Site-Параметры                   |
| LDAP-отображаемое имя | нтдсситесеттингс                     |
...
| [**Топология между сайтами — отработка отказа**](a-intersitetopologyfailover.md)       | Неверно     | **NTDS-Site-Параметры**                                                    |
| [**Генератор межсайтовых топологий**](a-intersitetopologygenerator.md)     | Неверно     | **NTDS-Site-Параметры**                                                    |
| [**Топология между сайтами — продление**](a-intersitetopologyrenew.md)             | Неверно     | **NTDS-Site-Параметры**                                                    |
...
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **NTDS-Site-Параметры**                                                    |
...
| [**Параметры**](a-options.md)                                              | Неверно     | **NTDS-Site-Параметры**                                                    |
...
| [**Запрос — политика — объект**](a-querypolicyobject.md)                        | Неверно     | **NTDS-Site-Параметры**                                                    |
...
| [**Расписание**](a-schedule.md)                                            | Неверно     | **NTDS-Site-Параметры**                                                    |
...
| [**Имя приложения**](a-applicationname.md)                               | Нет     | [**приложение — сайт — Параметры**](c-applicationsitesettings.md)<br/> |
...
| [**Тип экземпляра**](a-instancetype.md)                                     | Верно      | [**Вверх**](c-top.md)<br/>                                           |
| [**Топология между сайтами — отработка отказа**](a-intersitetopologyfailover.md)         | Нет     | **NTDS-Site-Параметры**                                                    |
| [**Генератор межсайтовых топологий**](a-intersitetopologygenerator.md)       | Нет     | **NTDS-Site-Параметры**                                                    |
| [**Топология между сайтами — продление**](a-intersitetopologyrenew.md)               | Нет     | **NTDS-Site-Параметры**                                                    |
...
| [**Под управлением**](a-managedby.md)                                           | Нет     | **NTDS-Site-Параметры**                                                    |
...
| [**MS-DS-предпочтительный — GC-site**](a-msds-preferred-gc-site.md)                 | Нет     | **NTDS-Site-Параметры**                                                    |
...
| [**Параметры**](a-options.md)                                                | Нет     | **NTDS-Site-Параметры**          |
...
| [**Запрос — политика — объект**](a-querypolicyobject.md)                          | Нет     | **NTDS-Site-Параметры**          |
...
| [**Расписание**](a-schedule.md)                                              | Нет     | **NTDS-Site-Параметры**          |
...
| [**MS-DS-предпочтительный — GC-site**](a-msds-preferred-gc-site.md)                 | Неверно     | **NTDS-Site-Параметры**                                                    |
