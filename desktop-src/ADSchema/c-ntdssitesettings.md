...
---
# <a name="ntds-site-settings-class"></a>NTDS-Site-Settings, класс
...
| [**Топология между сайтами — отработка отказа**](a-intersitetopologyfailover.md)       | Неверно     | **NTDS-Site-Settings**                                                    |
| [**Генератор межсайтовых топологий**](a-intersitetopologygenerator.md)     | Неверно     | **NTDS-Site-Settings**                                                    |
| [**Топология между сайтами — продление**](a-intersitetopologyrenew.md)             | Неверно     | **NTDS-Site-Settings**                                                    |
...
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **NTDS-Site-Settings**                                                    |
...
| [**Параметры**](a-options.md)                                              | Неверно     | **NTDS-Site-Settings**                                                    |
...
| [**Запрос — политика — объект**](a-querypolicyobject.md)                        | Неверно     | **NTDS-Site-Settings**                                                    |
...
| [**Расписание**](a-schedule.md)                                            | Неверно     | **NTDS-Site-Settings**                                                    |
...
| [**MS-DS-предпочтительный — GC-site**](a-msds-preferred-gc-site.md)                 | Неверно     | **NTDS-Site-Settings**                                                    |
