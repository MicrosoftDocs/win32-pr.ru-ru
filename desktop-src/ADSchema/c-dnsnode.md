...
---
# <a name="dns-node-class"></a>Класс Dns-Node

Содержит записи ресурсов DNS для одного узла.
...
| Возможные старшие          | [**DNS — зона**](c-dnszone.md)                                                                                                                                        |
| Вспомогательные классы           | \-                                                                                                                                                                   |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                                                         |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; ED) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; CO) (A;; РПЛКЛОРК;;; WD |
...
| [**DNS-свойство**](a-dnsproperty.md)                                     | Неверно     | **DNS-узел**                    |
| [**Запись DNS**](a-dnsrecord.md)                                         | Неверно     | **DNS-узел**                    |
| [**DNS-захороненные**](a-dnstombstoned.md)                                 | Неверно     | **DNS-узел**                    |
| [**Компонент домена**](a-dc.md)                                          | True      | **DNS-узел**                    |
