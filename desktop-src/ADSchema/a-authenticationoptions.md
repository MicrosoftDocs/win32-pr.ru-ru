...
---
# <a name="authentication-options-attribute"></a>Атрибут Authentication-Options

Параметры проверки подлинности, используемые в ADSI для привязки к объектам служб каталогов.
