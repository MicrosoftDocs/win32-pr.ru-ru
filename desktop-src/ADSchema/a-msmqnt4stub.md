...
---
# <a name="msmq-nt4-stub-attribute"></a>Атрибут заглушки MSMQ-Nt4

Атрибут " **MSMQ-Nt4-заглушек** " содержит сведения о смешанном режиме MSMQ.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MSMQ-Nt4-заглушка                        |
| LDAP-отображаемое имя | mSMQNt4Stub                          |
| Размер              | \-                                   |
