...
ms.locfileid: "118423095"
---
# <a name="link-track-omt-entry-class"></a>Класс Link-Track-ОМТ-Entry

Отслеживает ссылку для перемещенных объектов.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Link-Track-ОМТ-Entry                 |
| LDAP-отображаемое имя | линктраккомтентри                    |
| Привилегия обновления  | Это значение задается системой.     |
| Частота обновления  | При каждом изменении ссылки на файл.   |
...
| Возможные старшие          | [**Link-Track-Object-Move-Table**](c-linktrackobjectmovetable.md)                           |
...
| [**Место рождения — расположение**](a-birthlocation.md)                                 | Нет     | **Link-Track-ОМТ-Entry**        |
...
| [**Текущее расположение**](a-currentlocation.md)                             | Нет     | **Link-Track-ОМТ-Entry**        |
...
| [**ОМТ — GUID**](a-omtguid.md)                                             | Нет     | **Link-Track-ОМТ-Entry**        |
| [**ОМТ-Индкс-GUID**](a-omtindxguid.md)                                    | Нет     | **Link-Track-ОМТ-Entry**        |
...
| [**Время — обновление**](a-timerefresh.md)                                     | Нет     | **Link-Track-ОМТ-Entry**        |
