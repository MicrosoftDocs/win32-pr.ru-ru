...
Расширенное право, необходимое для репликации изменений из заданного NC.



| Ввод | Значение |
|--------------|--------------------------------------|
| CN           | DS-Replication-получение изменений           |
| Display-Name | Репликация изменений каталога        |
...
| Локализация — идентификатор экрана | 25                                                                                                                               |
