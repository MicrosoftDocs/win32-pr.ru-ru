...
ms.locfileid: "119706714"
---
# <a name="current-parent-ca-attribute"></a>Атрибут Current-Parent-CA

Ссылка на центры сертификации, которые выдавали текущие сертификаты для центра сертификации.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Текущий-родительский ЦС                       |
| LDAP-отображаемое имя | куррентпарентка                         |
| Размер              | \-                                      |
