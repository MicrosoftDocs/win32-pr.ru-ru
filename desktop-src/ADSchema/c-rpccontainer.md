...
ms.locfileid: "118959563"
---
# <a name="rpc-container-class"></a>Класс Rpc-Container

Контейнер по умолчанию для конечных точек RPC.
...
|-------------------|--------------------------------------|
| CN                | Rpc-Container                        |
| LDAP-отображаемое имя | рпкконтаинер                         |
...
| [**Name-Service-flags**](a-nameserviceflags.md)                          | Неверно     | **RPC-Container**                                                           |
