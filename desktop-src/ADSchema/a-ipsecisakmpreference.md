...
---
# <a name="ipsec-isakmp-reference-attribute"></a>Атрибут IPSec-ISAKMP-Reference

Атрибут **IPSec-ISAKMP-Reference** предназначен только для внутреннего использования.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Справочник по IPsec-ISAKMP-Reference                  |
| LDAP-отображаемое имя | ипсеЦисакмпреференце                    |
| Размер              | \-                                      |
...
| Классы, используемые в        | [**Политики IPSec**](c-ipsecpolicy.md)<br/> |
