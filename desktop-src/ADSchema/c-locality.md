...
ms.locfileid: "119834924"
---
# <a name="locality-class"></a>Класс локализации

Содержит локализацию, например улица, город и штат.
...
|-------------------|--------------------------------------------------------------------------|
| CN                | Расположение                                                                 |
| LDAP-отображаемое имя | местоположение                                                                 |
| Привилегия обновления  | Это значение задается администратором домена или владельцем учетной записи.          |
| Частота обновления  | При создании записи пользователя и при необходимости изменить ее локальность. |
...
| RDN-Атри-ID                  | [**Локальное имя**](a-l.md)<br/>                                                                                           |
| Подкласс                 | [**Вверх**](c-top.md)<br/>                                                                                                   |
| Возможные старшие          | [](c-organizationalunit.md)[**Страна**](c-country.md) [**Организации**](c-organization.md)по **локализации** |
...
| [**Локальное имя**](a-l.md)                                              | Верно      | **Расположение**                    |
...
| [**Поиск — Обзор**](a-searchguide.md)                                     | Неверно     | **Расположение**                    |
| [**См. также**](a-seealso.md)                                             | Неверно     | **Расположение**                    |
...
| [**State-или-провинция-Name**](a-st.md)                                    | Неверно     | **Расположение**                    |
| [**Улица-адрес**](a-street.md)                                        | Неверно     | **Расположение**                    |
...
| RDN-Атри-ID                  | [**Локальное имя**](a-l.md)<br/>                                                                                                                            |
| Подкласс                 | [**Вверх**](c-top.md)<br/>                                                                                                                                    |
| Возможные старшие          | **Организация локальной**[**Организации**](c-organization.md)[](c-organizationalunit.md)[](c-country.md)[**домен страна — DNS**](c-domaindns.md) |
| Вспомогательные классы           | \-                                                                                                                                                                 |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                                                       |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; СЛУЖБЫ                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
