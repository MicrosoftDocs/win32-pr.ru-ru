...
ms.locfileid: "118422205"
---
# <a name="ms-wmi-realrangeparam-class"></a>класс MS-WMI-Реалранжепарам

Объект параметра вещественного диапазона чисел.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Реалранжепарам                |
| LDAP-отображаемое имя | Мсвми — Реалранжепарам                 |
...
| [**MS-WMI-int8Default**](a-mswmi-int8default.md)                           | Верно      | **MS-WMI-Реалранжепарам**                                  |
| [**MS-WMI-int8Max**](a-mswmi-int8max.md)                                   | Нет     | **MS-WMI-Реалранжепарам**                                  |
| [**MS-WMI-int8Min**](a-mswmi-int8min.md)                                   | Нет     | **MS-WMI-Реалранжепарам**                                  |
