...
---
# <a name="next-level-store-attribute"></a>Атрибут Store следующего уровня

Этот атрибут указывает на следующее хранилище классов для поиска.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Хранилище следующего уровня                        |
| LDAP-отображаемое имя | некстлевелсторе                          |
| Размер              | \-                                      |
