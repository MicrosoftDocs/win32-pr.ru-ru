...
ms.locfileid: "119324234"
---
# <a name="ipsec-isakmp-policy-class"></a>Класс политики IPSec-ISAKMP

Класс **IPSec-ISAKMP-Policy** предназначен только для внутреннего использования.
...
| LDAP-отображаемое имя | ипсеЦисакмпполици                    |
