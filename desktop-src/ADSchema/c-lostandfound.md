...
ms.locfileid: "119324114"
---
# <a name="lost-and-found-class"></a>Потерянный и найденный класс

Контейнер для потерянных объектов.



| Ввод | Значение |
|-------------------|-----------------------------------------------------------|
| CN                | Потерянные и найденные                                            |
| LDAP-отображаемое имя | lostAndFound                                              |
| Привилегия обновления  | Этот контейнер управляется системой.                  |
| Частота обновления  | Каждый раз, когда расположение объекта не может быть выверено. |
...
| Возможные старшие          | [**ДМД**](c-dmd.md)[**домен —**](c-domaindns.md)[**Конфигурация**](c-configuration.md) DNS |
...
| [**Перемещение-дерево-состояние**](a-movetreestate.md)                                | Неверно     | **Потерянные и найденные**              |
