...
---
# <a name="superior-dns-root-attribute"></a>Атрибут «старший-DNS-Root»

Это системный атрибут, используемый для создания ссылок.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Старший DNS-корневой узел                           |
| LDAP-отображаемое имя | супериорднсрут                             |
| Размер              | \-                                          |
