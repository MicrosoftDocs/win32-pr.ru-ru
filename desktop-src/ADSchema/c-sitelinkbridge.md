...
ms.locfileid: "119548904"
---
# <a name="site-link-bridge-class"></a>Класс Site-Link-Bridge

Объект для отслеживания связей сайтов, которые подключены к сети с транзитным подключением.
...
|-------------------|--------------------------------------------------------------------|
| CN                | Site-Link-Bridge                                                   |
| LDAP-отображаемое имя | сителинкбридже                                                     |
| Привилегия обновления  | Администратор домена                                               |
| Частота обновления  | При необходимости добавления или удаления связи сайтов из моста. |
...
| [**Site-Link-List**](a-sitelinklist.md)                                  | Верно      | **Site-Link-Bridge**            |
