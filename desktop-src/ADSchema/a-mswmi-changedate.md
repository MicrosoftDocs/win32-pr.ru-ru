...
ms.locfileid: "119760874"
---
# <a name="ms-wmi-changedate-attribute"></a>атрибут MS-WMI-ChangeDate

Последняя Дата изменения этого объекта.
...
| LDAP-отображаемое имя | Мсвми — ChangeDate                                  |
| Размер              | Представление типа данных DateTime WMI — 26 символов. |
...
| Классы, используемые в        | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> [**MS-WMI-PolicyType**](c-mswmi-policytype.md)<br/> [**MS-WMI-SOM**](c-mswmi-som.md)<br/> |
