...
---
# <a name="friendlycountry-class"></a>класс Фриендликаунтри

Класс объектов Фриендликаунтри используется для определения записей о стране или регионе в DIT.
...
|-------------------|--------------------------------------|
| CN                | фриендликаунтри                      |
| LDAP-отображаемое имя | фриендликаунтри                      |
...
| Подкласс                 | [**Страна или регион**](c-country.md)<br/>                                                          |
| Возможные старшие          | \-                                                                                               |
...
| [**Название страны**](a-c.md)                                                 | True      | [**Страна или регион**](c-country.md)<br/>                     |
...
| [**Поиск — Обзор**](a-searchguide.md)                                       | Неверно     | [**Страна или регион**](c-country.md)<br/>                     |
...
| [**Текст — страна**](a-co.md)                                                | True      |  [ **страна** фриендликаунтри](c-country.md)<br/> |
