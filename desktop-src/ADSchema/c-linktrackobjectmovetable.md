...
---
# <a name="link-track-object-move-table-class"></a>Класс Link-Track-Object-Move-Table

Контейнер для объектов Link-Track-ОМТ-Entry.
...
| LDAP-отображаемое имя | линктраккобжектмоветабле             |
