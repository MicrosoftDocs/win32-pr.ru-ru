...
ms.locfileid: "119022882"
---
# <a name="acs-enable-acs-service-attribute"></a>Атрибут ACS-Enable-ACS-Service

Значение true, если служба ACS должна быть включена.
...
| LDAP-отображаемое имя | аксенаблеакссервице                  |
| Размер              | 4 байта                              |
