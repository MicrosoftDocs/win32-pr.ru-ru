...
ms.locfileid: "119880694"
---
# <a name="ms-dfsr-content-class"></a>класс MS-DFSR-Content

Представляет контейнер для объектов с набором [**содержимого MS-DFSR**](c-msdfsr-contentset.md) .



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-содержимое                      |
| LDAP-отображаемое имя | Мсдфср — содержимое                       |
...
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **MS-DFSR-содержимое**             |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **MS-DFSR-содержимое**             |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **MS-DFSR-содержимое**             |
...
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                    | Неверно     | **MS-DFSR-содержимое**             |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Неверно     | **MS-DFSR-содержимое**             |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)    | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-Content** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
