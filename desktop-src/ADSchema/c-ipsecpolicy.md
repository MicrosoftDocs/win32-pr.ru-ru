...
ms.locfileid: "119835024"
---
# <a name="ipsec-policy-class"></a>Класс Ipsec-Policy

Класс **политики IPSec** предназначен только для внутреннего использования.
...
|-------------------|--------------------------------------|
| CN                | Политики IPSec                         |
| LDAP-отображаемое имя | ипсекполици                          |
...
| [**Справочник по IPsec-ISAKMP-Reference**](a-ipsecisakmpreference.md)                  | Неверно     | **Политики IPSec**                             |
| [**Имя IPSec**](a-ipsecname.md)                                         | Неверно     | [**IPSec-Base**](c-ipsecbase.md)<br/> |
| [**IPSec-NFA-Reference**](a-ipsecnfareference.md)                        | Неверно     | **Политики IPSec**                             |
