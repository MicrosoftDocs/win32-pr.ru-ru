...
| [**Параметры**](a-options.md)                                              | Неверно     | **Межсайтовый транспорт**        |
...
| [**REPL-интервал**](a-replinterval.md)                                   | Неверно     | **Межсайтовый транспорт**        |
...
| [**Адрес-атрибут транспорта**](a-transportaddressattribute.md)        | True      | **Межсайтовый транспорт**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | True      | **Межсайтовый транспорт**        |
