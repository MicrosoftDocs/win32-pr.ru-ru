...
ms.locfileid: "119703684"
---
# <a name="inter-site-transport-class"></a>Класс транспорта между сайтами

Необязательный атрибут объектов Нтдсконнектион. Если оно имеется, содержит DN объекта Интерситетранспорт в контейнере CN = межсайтовых транспортов, CN = Sites, CN = Configuration,... контейнера.



| Ввод | Значение |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Межсайтовый транспорт                                                                                                               |
| LDAP-отображаемое имя | интерситетранспорт                                                                                                                 |
| Привилегия обновления  | Это значение задается администратором KCC или Enterprise.                                                                          |
| Частота обновления  | Создается или управляется средством проверки согласованности знаний в ответ на изменения топологии сети (включая временные простои). |
...
| Возможные старшие          | [**Межсайтовый транспорт — контейнер**](c-intersitetransportcontainer.md)                      |
...
| [**Параметры**](a-options.md)                                              | Нет     | **Межсайтовый транспорт**        |
...
| [**REPL-интервал**](a-replinterval.md)                                   | Нет     | **Межсайтовый транспорт**        |
...
| [**Адрес-атрибут транспорта**](a-transportaddressattribute.md)        | Верно      | **Межсайтовый транспорт**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | Верно      | **Межсайтовый транспорт**        |
