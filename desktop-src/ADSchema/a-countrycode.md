...
description: Указывает код страны или региона для выбранного языка пользователя. это значение не используется Windows 2000.
...
ms.locfileid: "118961783"
---
# <a name="country-code-attribute"></a>Атрибут Country-Code

Указывает код страны или региона для выбранного языка пользователя. это значение не используется Windows 2000.
