...
ms.locfileid: "119548934"
---
# <a name="service-class-class"></a>Класс Service-Class

Используется для хранения свойств службы Winsock.
...
|-------------------|--------------------------------------|
| CN                | Service-Class                        |
| LDAP-отображаемое имя | сервицекласс                         |
...
| [**Отображаемое имя**](a-displayname.md)                                     | Верно      | **Класс-** [ **Начало** службы](c-top.md)<br/> |
...
| [**Service-Class-ID**](a-serviceclassid.md)                              | Верно      | **Класс службы**                                 |
| [**Служба-класс-сведения**](a-serviceclassinfo.md)                          | Нет     | **Класс службы**                                 |
