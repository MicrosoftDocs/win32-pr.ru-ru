...
ms.locfileid: "119533794"
---
# <a name="servers-container-class"></a>Класс Servers-Container

Хранит серверные объекты на сайте.
...
| LDAP-отображаемое имя | серверсконтаинер                     |
| Привилегия обновления  | Администратор домена                 |
| Частота обновления  | При создании сайта.              |
...
| Дескриптор безопасности по умолчанию | D: (A;; CC;;; BA) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; СЛУЖБЫ |
