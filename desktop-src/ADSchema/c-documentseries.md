...
ms.locfileid: "119324734"
---
# <a name="documentseries-class"></a>класс Документсериес

Класс объектов Документсериес используется для определения записи, представляющей ряд документов.
...
|-------------------|--------------------------------------|
| CN                | документсериес                       |
| LDAP-отображаемое имя | документсериес                       |
...
| [**Common-Name**](a-cn.md)                                                 | Верно      | **документсериес** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                    |
| [**Описание**](a-description.md)                                        | Неверно     | **документсериес** [ **сверху**](c-top.md)<br/> |
...
| [**Локальное имя**](a-l.md)                                                | Неверно     | **документсериес**                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                    | Неверно     | **документсериес**                                 |
| [**Название организации**](a-o.md)                                            | Неверно     | **документсериес**                                 |
...
| [**См. также**](a-seealso.md)                                               | Неверно     | **документсериес**                                 |
...
| [**Номер телефона**](a-telephonenumber.md)                               | Неверно     | **документсериес**                                 |
