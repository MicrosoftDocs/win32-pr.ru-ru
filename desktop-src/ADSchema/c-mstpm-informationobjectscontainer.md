...
---
# <a name="ms-tpm-information-objects-container-class"></a>класс MS-TPM-Information-Objects-Container

Контейнер для объектов доверенного платформенного модуля.
...
| LDAP-отображаемое имя | Мстпм — Информатионобжектсконтаинер    |
...
| Возможные старшие          | [**Домен домена**](c-domain.md)[**— DNS**](c-domaindns.md)                                  |
| Вспомогательные классы           | \-                                                                                           |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                 |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; ЛОЛКККРП;;;D Ц |
...
| [**Common-Name**](a-cn.md)                                                                  | True      | **MS-TPM-Information-Objects — контейнер** [ **сверху**](c-top.md)<br/> |
