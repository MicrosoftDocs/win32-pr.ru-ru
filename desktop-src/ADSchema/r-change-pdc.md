...
ms.locfileid: "119532654"
---
# <a name="change-pdc-extended-right"></a>Изменение — основной контроллер домена, расширенный правый

Расширенное право, необходимое для изменения владельца роли FSMO основного контроллера домена (PDC).
...
|--------------|--------------------------------------|
| CN           | Изменение — PDC                           |
| Display-Name | Изменение основного контроллера домена                           |
...
| Локализация — идентификатор экрана | 34                                           |
