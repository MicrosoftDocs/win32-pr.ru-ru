...
description: содержит имена NetBIOS или DNS компьютеров, на которых работает Windows NT Workstation или Windows 2000 Professional, с которых пользователь может войти в систему.
...
ms.locfileid: "119702894"
---
# <a name="user-workstations-attribute"></a>Атрибут User-Workstations

содержит имена NetBIOS или DNS компьютеров, на которых работает Windows NT Workstation или Windows 2000 Professional, с которых пользователь может войти в систему. Каждое NetBIOS-имя разделяются запятыми. Несколько имен следует разделять запятыми.
