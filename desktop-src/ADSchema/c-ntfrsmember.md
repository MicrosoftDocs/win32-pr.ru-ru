...
ms.locfileid: "119753234"
---
# <a name="ntfrs-member-class"></a>Класс NTFRS-Member

Определяет член набора реплик FRS.
...
|-------------------|--------------------------------------|
| CN                | NTFRS-Member                         |
| LDAP-отображаемое имя | нтфрсмембер                          |
...
| Возможные старшие          | [**NTFRS-Set-реплика**](c-ntfrsreplicaset.md)                                                                                   |
...
| [**FRS-Computer-Reference**](a-frscomputerreference.md)                  | Неверно     | **NTFRS-Member**                |
| [**FRS-Computer-Reference-BL**](a-frscomputerreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**FRS-Control-создание данных**](a-frscontroldatacreation.md)             | Неверно     | **NTFRS-Member**                |
| [**Служба FRS-Control-Inbound-невыполненная работа**](a-frscontrolinboundbacklog.md)         | Неверно     | **NTFRS-Member**                |
| [**FRS-Control-Outbound-невыполненная работа**](a-frscontroloutboundbacklog.md)       | Неверно     | **NTFRS-Member**                |
| [**Расширения FRS**](a-frsextensions.md)                                 | Неверно     | **NTFRS-Member**                |
| [**Флаги FRS**](a-frsflags.md)                                           | Неверно     | **NTFRS-Member**                |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**FRS-Partner-auth — уровень**](a-frspartnerauthlevel.md)                   | Неверно     | **NTFRS-Member**                |
| [**FRS-root-Security**](a-frsrootsecurity.md)                            | Неверно     | **NTFRS-Member**                |
| [**Служба FRS-Service-Command**](a-frsservicecommand.md)                        | Неверно     | **NTFRS-Member**                |
| [**FRS-Update — время ожидания**](a-frsupdatetimeout.md)                          | Неверно     | **NTFRS-Member**                |
...
| [**Справочник по серверу**](a-serverreference.md)                             | Неверно     | **NTFRS-Member**                |
