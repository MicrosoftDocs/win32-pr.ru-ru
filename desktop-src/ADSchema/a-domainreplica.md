...
---
# <a name="domain-replica-attribute"></a>Атрибут Domain-Replica

Строковый атрибут Юникода предоставляет список контроллеров домена репликации Windows NT 4,0.
...
|-------------------|---------------------------------------------|
| CN                | Domain-Replica                              |
| LDAP-отображаемое имя | домаинреплика                               |
| Размер              | \-                                          |
