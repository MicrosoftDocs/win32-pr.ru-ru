...
ms.locfileid: "118426727"
---
# <a name="ms-ds-byte-array-attribute"></a>Атрибут ms-DS-Byte-Array

Атрибут для хранения двоичных данных.



| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | MS-DS-Byte-массив                                      |
| LDAP-отображаемое имя | msDS-Битеаррай                                        |
| Размер              | \-                                                    |
