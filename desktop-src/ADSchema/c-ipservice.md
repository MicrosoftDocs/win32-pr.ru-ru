...
ms.locfileid: "119324134"
---
# <a name="ipservice-class"></a>класс Ипсервице

Представляет абстракцию службы протокола Интернета.
...
|-------------------|--------------------------------------|
| CN                | ипсервице                            |
| LDAP-отображаемое имя | ипсервице                            |
...
| [**Common-Name**](a-cn.md)                                                 | Верно      | **ипсервице** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Описание**](a-description.md)                                        | Неверно     | **ипсервице** [ **сверху**](c-top.md)<br/> |
...
| [**ипсервицепорт**](a-ipserviceport.md)                                    | Неверно     | **ипсервице**                                 |
| [**ипсервицепротокол**](a-ipserviceprotocol.md)                            | Неверно     | **ипсервице**                                 |
...
| [**Мссфу-30 — псевдонимы**](a-mssfu30aliases.md)                                | Неверно     | **ипсервице**                                 |
| [**Мссфу-30 — имя**](a-mssfu30name.md)                                      | Неверно     | **ипсервице**                                 |
| [**Мссфу-30-NIS-домен**](a-mssfu30nisdomain.md)                           | Неверно     | **ипсервице**                                 |
...
| [**нисмапнаме**](a-nismapname.md)                                          | Неверно     | **ипсервице**                                 |
...
| [**FSMO-Role-Owner**](a-fsmoroleowner.md)                                     | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Тип экземпляра**](a-instancetype.md)                                        | Верно      | [**Вверх**](c-top.md)<br/>               |
| [**ипсервицепорт**](a-ipserviceport.md)                                       | Верно      | **ипсервице**                                 |
| [**ипсервицепротокол**](a-ipserviceprotocol.md)                               | Верно      | **ипсервице**                                 |
| [**Является критически важным — системный объект**](a-iscriticalsystemobject.md)                  | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Удалено**](a-isdeleted.md)                                              | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Входит в состав списка рассылки**](a-memberof.md)                                          | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Имеет права владельца**](a-isprivilegeholder.md)                             | Неверно     | [**Вверх**](c-top.md)<br/>               |
