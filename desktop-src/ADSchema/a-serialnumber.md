...
---
# <a name="serial-number-attribute"></a>Атрибут Serial-Number

Часть спецификации X. 500. Не используется Active Directory.
...
|-------------------|--------------------------------------|
| CN                | Serial-Number                        |
| LDAP-отображаемое имя | серийный номер                         |
| Размер              | \-                                   |
...
| Классы, используемые в        | [**Устройство**](c-device.md)<br/> [**Сервером**](c-server.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                                                        |
| System-Flags           | 0x00000010                                                                                                        |
| Классы, используемые в        | [**Устройство**](c-device.md)<br/> [**Человек**](c-person.md)<br/> [**Сервером**](c-server.md)<br/> |
