...
ms.locfileid: "119440334"
---
# <a name="ms-wmi-intsetparam-class"></a>класс MS-WMI-Интсетпарам

Объект параметра набора целых чисел со знаком.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Интсетпарам                   |
| LDAP-отображаемое имя | Мсвми — Интсетпарам                    |
...
| [**MS-WMI-Интдефаулт**](a-mswmi-intdefault.md)                             | True      | **MS-WMI-Интсетпарам**                                     |
| [**MS-WMI-Интвалидвалуес**](a-mswmi-intvalidvalues.md)                     | Неверно     | **MS-WMI-Интсетпарам**                                     |
