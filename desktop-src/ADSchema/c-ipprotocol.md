...
ms.locfileid: "119835064"
---
# <a name="ipprotocol-class"></a>класс Иппротокол

Представляет абстракцию IP-протокола.
...
|-------------------|--------------------------------------|
| CN                | иппротокол                           |
| LDAP-отображаемое имя | иппротокол                           |
...
| [**Common-Name**](a-cn.md)                                                 | Верно      | **иппротокол** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                |
| [**Описание**](a-description.md)                                        | Неверно     | **иппротокол** [ **сверху**](c-top.md)<br/> |
...
| [**иппротоколнумбер**](a-ipprotocolnumber.md)                              | Верно      | **иппротокол**                                 |
...
| [**Мссфу-30 — псевдонимы**](a-mssfu30aliases.md)                                | Неверно     | **иппротокол**                                 |
| [**Мссфу-30 — имя**](a-mssfu30name.md)                                      | Неверно     | **иппротокол**                                 |
| [**Мссфу-30-NIS-домен**](a-mssfu30nisdomain.md)                           | Неверно     | **иппротокол**                                 |
...
| [**нисмапнаме**](a-nismapname.md)                                          | Неверно     | **иппротокол**                                 |
