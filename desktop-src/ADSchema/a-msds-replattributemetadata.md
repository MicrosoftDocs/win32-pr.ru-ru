...
---
# <a name="ms-ds-repl-attribute-meta-data-attribute"></a>Атрибут ms-DS-REPL-Attribute-Meta-Data

Список метаданных для каждого реплицированного атрибута. Метаданные показывают, кто изменил атрибут в последний раз.
...
| LDAP-отображаемое имя | msDS-Реплаттрибутеметадата                  |
| Размер              | \-                                          |
