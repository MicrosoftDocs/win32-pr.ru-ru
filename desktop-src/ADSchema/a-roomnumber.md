...
---
# <a name="roomnumber-attribute"></a>атрибут Румнумбер
...
|-------------------|---------------------------------------------|
| CN                | roomNumber                                  |
| LDAP-отображаемое имя | roomNumber                                  |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**inetOrgPerson**](c-inetorgperson.md)<br/> [**залах**](c-room.md)<br/> [**Нажат**](c-user.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                                                              |
| System-Flags           | 0x00000000                                                                                                              |
| Классы, используемые в        | [**inetOrgPerson**](c-inetorgperson.md)<br/> [**залах**](c-room.md)<br/> [**Пользователь**](c-user.md)<br/> |
