...
ms.locfileid: "119644525"
---
# <a name="userpkcs12-attribute"></a>атрибут userPKCS12

\#PDU PKCS 12 PFX для обмена идентификационными данными личного удостоверения.
...
|-------------------|-------------------------------------------------------|
| CN                | userPKCS12                                            |
| LDAP-отображаемое имя | userPKCS12                                            |
| Размер              | \-                                                    |
