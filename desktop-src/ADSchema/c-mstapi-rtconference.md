...
ms.locfileid: "119879414"
---
# <a name="ms-tapi-rt-conference-class"></a>класс MS-TAPI-RT-Conference

Используется для публикации многоадресной конференции TAPI в режиме реального времени.



| Ввод | Значение |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MS-TAPI-RT-Конференция                                                                                                                                                                                    |
| LDAP-отображаемое имя | Мстапи — Ртконференце                                                                                                                                                                                      |
| Привилегия обновления  | Специальные привилегии не требуются.                                                                                                                                                                          |
| Частота обновления  | Частота создания определяется по усмотрению пользователя каждый раз, когда необходимо опубликовать конференцию TAPI. После создания объект конференции TAPI обычно может находиться в диапазоне от 30 минут до 1 года. |
...
| RDN-Атри-ID                  | [**MS-TAPI-unique-identifier**](a-mstapi-uid.md)<br/>                                 |
| Подкласс                 | [**Вверх**](c-top.md)<br/>                                                              |
| Возможные старшие          | [**Организационная единица**](c-organizationalunit.md)                                          |
...
| [**MS-TAPI-Conference-BLOB**](a-mstapi-conferenceblob.md)                  | Неверно     | **MS-TAPI-RT-Конференция**       |
| [**MS-TAPI-Protocol-ID**](a-mstapi-protocolid.md)                          | Неверно     | **MS-TAPI-RT-Конференция**       |
| [**MS-TAPI-unique-identifier**](a-mstapi-uid.md)                           | Верно      | **MS-TAPI-RT-Конференция**       |
