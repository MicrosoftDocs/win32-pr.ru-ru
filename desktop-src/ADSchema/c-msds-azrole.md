...
ms.locfileid: "119880324"
---
# <a name="ms-ds-az-role-class"></a>класс MS-DS-AZ-Role

Определяет набор операций, которые могут выполняться определенным набором пользователей в определенной области.
...
|-------------------|-----------------------------------------|
| CN                | MS-DS-AZ-Role                           |
| LDAP-отображаемое имя | msDS-Азроле                             |
...
| [**Описание**](a-description.md)                                        | Неверно     | **MS-DS-AZ-роль —** [ **Начало**](c-top.md)<br/> |
...
| [**MS-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Неверно     | **MS-DS-AZ-Role**                                 |
...
| [**MS-DS-Members-for-AZ-Role**](a-msds-membersforazrole.md)                | Неверно     | **MS-DS-AZ-Role**                                 |
...
| [**MS-DS-Operations-для-AZ-Role**](a-msds-operationsforazrole.md)          | Неверно     | **MS-DS-AZ-Role**                                 |
...
| [**MS-DS-Tasks-for-AZ-Role**](a-msds-tasksforazrole.md)                    | Неверно     | **MS-DS-AZ-Role**                                 |
...
| [**MS-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)                  | Неверно     | **MS-DS-AZ-Role**                                 |
| [**MS-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Неверно     | **MS-DS-AZ-Role**                                 |
| [**MS-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Неверно     | **MS-DS-AZ-Role**                                 |
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)         | Неверно     | [**Вверх**](c-top.md)<br/>                   |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                      | Неверно     | [**Вверх**](c-top.md)<br/>                   |
