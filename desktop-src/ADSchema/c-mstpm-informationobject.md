...
ms.locfileid: "119879314"
---
# <a name="ms-tpm-information-object-class"></a>класс объектов MS-TPM-Information-

Этот класс содержит сведения о восстановлении доверенный платформенный модуль (TPM)ного устройства (TPM).



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-TPM-Information — объект            |
| LDAP-отображаемое имя | Мстпм — Информатионобжект              |
...
| Возможные старшие          | [**MS-TPM-Information-Objects-Container**](c-mstpm-informationobjectscontainer.md)                  |
| Вспомогательные классы           | \-                                                                                                   |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                         |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛО;;;D C) (A;; WP;;; СОСТАВ |
...
| [**MS-TPM-Овнеринформатион**](a-mstpm-ownerinformation.md)                                  | Верно      | **MS-TPM-Information — объект**   |
| [**MS-TPM-владелец-сведения — Temp**](a-mstpm-ownerinformationtemp.md)                        | Неверно     | **MS-TPM-Information — объект**   |
| [**MS-TPM-SRK-Pub-Thumbprint**](a-mstpm-srkpubthumbprint.md)                                | Неверно     | **MS-TPM-Information — объект**   |
