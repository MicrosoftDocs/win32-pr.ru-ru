...
ms.locfileid: "119880334"
---
# <a name="ms-ds-az-scope-class"></a>класс MS-DS-AZ-Scope

Описывает набор объектов, управляемых приложением.
...
|-------------------|-----------------------------------------|
| CN                | MS-DS-AZ-Scope                          |
| LDAP-отображаемое имя | msDS-Азскопе                            |
...
| Возможные старшие          | [**MS-DS-AZ-Application**](c-msds-azapplication.md)                                                                             |
...
| [**Описание**](a-description.md)                                        | Неверно     | **MS-DS-AZ-область —** [ **Начало**](c-top.md)<br/> |
...
| [**MS-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Неверно     | **MS-DS-AZ-Scope**                                 |
| [**MS-DS-AZ-Scope-Name**](a-msds-azscopename.md)                           | Верно      | **MS-DS-AZ-Scope**                                 |
...
| [**MS-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)                  | Неверно     | **MS-DS-AZ-Scope**                                 |
| [**MS-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Неверно     | **MS-DS-AZ-Scope**                                 |
| [**MS-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Неверно     | **MS-DS-AZ-Scope**                                 |
| [**MS-DS-AZ-Scope-Name**](a-msds-azscopename.md)                              | Верно      | **MS-DS-AZ-Scope**                                 |
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)         | Неверно     | [**Вверх**](c-top.md)<br/>                    |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                      | Неверно     | [**Вверх**](c-top.md)<br/>                    |
