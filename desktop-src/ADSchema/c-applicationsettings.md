...
ms.locfileid: "119643914"
---
# <a name="application-settings-class"></a>Класс Application-Settings

Базовый класс для параметров приложения для конкретного сервера.
...
| LDAP-отображаемое имя | applicationSettings                  |
...
| [**Имя приложения**](a-applicationname.md)                             | Нет     | **Параметры приложения**        |
...
| [**Список уведомлений**](a-notificationlist.md)                           | Нет     | **Параметры приложения**        |
...
| [**ms-DS-Параметры**](a-msds-settings.md)                                   | Нет     | **Параметры приложения**        |
