...
| [**Имя приложения**](a-applicationname.md)                             | Неверно     | **Параметры приложения**        |
...
| [**Список уведомлений**](a-notificationlist.md)                           | Неверно     | **Параметры приложения**        |
...
| [**MS-DS-параметры**](a-msds-settings.md)                                   | Неверно     | **Параметры приложения**        |
