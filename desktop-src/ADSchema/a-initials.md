...
description: Содержит инициалы для частей полного имени пользователя. он может использоваться в качестве отчества в адресной книге Windows.
...
ms.locfileid: "119322914"
---
# <a name="initials-attribute"></a>Атрибут инициалов

Содержит инициалы для частей полного имени пользователя. он может использоваться в качестве отчества в адресной книге Windows.
