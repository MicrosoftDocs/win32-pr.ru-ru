...
Размер общего промежуточного каталога в мегабайтах.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-Коммонстагингсизеинмб        |
| LDAP-отображаемое имя | Мсдфср — Коммонстагингсизеинмб         |
| Размер              | \-                                   |
...
| Классы, используемые в        | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)<br/> |
