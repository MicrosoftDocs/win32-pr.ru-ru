...
ms.locfileid: "118959753"
---
# <a name="oncrpc-class"></a>класс Онкрпк

Представляет абстракцию привязки удаленного вызова процедур (RPC) Open Network Computing (ОНК).
...
| [**Common-Name**](a-cn.md)                                                 | Верно      | **онкрпк** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>            |
| [**Описание**](a-description.md)                                        | Неверно     | **онкрпк** [ **сверху**](c-top.md)<br/> |
...
| [**Мссфу-30 — псевдонимы**](a-mssfu30aliases.md)                                | Неверно     | **онкрпк**                                 |
| [**Мссфу-30 — имя**](a-mssfu30name.md)                                      | Неверно     | **онкрпк**                                 |
| [**Мссфу-30-NIS-домен**](a-mssfu30nisdomain.md)                           | Неверно     | **онкрпк**                                 |
...
| [**нисмапнаме**](a-nismapname.md)                                          | Неверно     | **онкрпк**                                 |
...
| [**онкрпкнумбер**](a-oncrpcnumber.md)                                      | Верно      | **онкрпк**                                 |
