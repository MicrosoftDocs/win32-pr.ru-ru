...
| [**Список отзыва центров сертификации**](a-authorityrevocationlist.md)            | Неверно     | **Список CRL-точка распространения**                                 |
...
| [**Certificate-Authority-объект**](a-certificateauthorityobject.md)      | Неверно     | **Список CRL-точка распространения**                                 |
| [**Список отзыва сертификатов**](a-certificaterevocationlist.md)        | Неверно     | **Список CRL-точка распространения**                                 |
| [**Common-Name**](a-cn.md)                                               | True      | **Список отзыва сертификатов — точка распространения** [](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                            | Неверно     | [**Вверх**](c-top.md)<br/>                            |
| [**Список отзыва сертификатов-секционированный-отзыва**](a-crlpartitionedrevocationlist.md) | Неверно     | **Список CRL-точка распространения**                                 |
| [**Список отзыва изменений**](a-deltarevocationlist.md)                    | Неверно     | **Список CRL-точка распространения**                                 |
