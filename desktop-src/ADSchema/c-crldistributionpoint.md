...
ms.locfileid: "119701954"
---
# <a name="crl-distribution-point-class"></a>Класс-точка распространения списка отзыва сертификатов

Объект, содержащий списки отзыва сертификатов, полномочий и разностных изменений.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Список CRL-точка распространения               |
| LDAP-отображаемое имя | крлдистрибутионпоинт                 |
...
| [**Список отзыва центров сертификации**](a-authorityrevocationlist.md)            | Нет     | **Список CRL-точка распространения**                                 |
...
| [**Certificate-Authority-объект**](a-certificateauthorityobject.md)      | Нет     | **Список CRL-точка распространения**                                 |
| [**Список отзыва сертификатов**](a-certificaterevocationlist.md)        | Нет     | **Список CRL-точка распространения**                                 |
| [**Common-Name**](a-cn.md)                                               | Верно      | **Список отзыва сертификатов — точка распространения** [](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                            | Нет     | [**Вверх**](c-top.md)<br/>                            |
| [**Список отзыва сертификатов-секционированный-отзыва**](a-crlpartitionedrevocationlist.md) | Нет     | **Список CRL-точка распространения**                                 |
| [**Список отзыва изменений**](a-deltarevocationlist.md)                    | Нет     | **Список CRL-точка распространения**                                 |
