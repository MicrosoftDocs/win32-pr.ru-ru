...
---
# <a name="rras-administration-connection-point-class"></a>Класс-администрирование-точка подключения (RRAS)

Этот объект содержит точку подключения для службы RRAS.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | RRAS-администрирование-точка подключения |
| LDAP-отображаемое имя | ррасадминистратионконнектионпоинт    |
...
| [**MS-RRAS-атрибут**](a-msrrasattribute.md)                            | Неверно     | **RRAS-администрирование-точка подключения**                                                 |
