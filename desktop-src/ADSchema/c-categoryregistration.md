...
ms.locfileid: "119643844"
---
# <a name="category-registration-class"></a>Класс Category-Registration

Сведения о регистрации для категории компонента.
...
| LDAP-отображаемое имя | категорирегистратион                 |
...
| [**Идентификатор категории**](a-categoryid.md)                                       | Нет     | **Регистрация категории**       |
...
| [**Идентификатор локали**](a-localeid.md)                                           | Нет     | **Регистрация категории**       |
| [**Локализованное описание**](a-localizeddescription.md)                   | Нет     | **Регистрация категории**       |
| [**Под управлением**](a-managedby.md)                                         | Нет     | **Регистрация категории**       |
