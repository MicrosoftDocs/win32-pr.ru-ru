...
ms.locfileid: "119880394"
---
# <a name="ms-ds-az-application-class"></a>класс MS-DS-AZ-Application

Определяет установленный экземпляр приложения, привязанный к определенному хранилищу политик.
...
| LDAP-отображаемое имя | msDS-Азаппликатион                      |
...
| Возможные старшие          | [**MS-DS-AZ-Admin-Manager**](c-msds-azadminmanager.md)                                                                          |
...
| [**Описание**](a-description.md)                                        | Неверно     | **MS-DS-AZ-приложение (** [ **вверху** )](c-top.md)<br/> |
...
| [**MS-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-имя приложения**](a-msds-azapplicationname.md)               | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-версия приложения**](a-msds-azapplicationversion.md)         | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-Class-ID**](a-msds-azclassid.md)                               | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-Generate-аудиты**](a-msds-azgenerateaudits.md)                 | Неверно     | **MS-DS-AZ-Application**                                 |
...
| [**MS-DS-AZ-Class-ID**](a-msds-azclassid.md)                                  | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-Generate-аудиты**](a-msds-azgenerateaudits.md)                    | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Неверно     | **MS-DS-AZ-Application**                                 |
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)         | Неверно     | [**Вверх**](c-top.md)<br/>                          |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                      | Неверно     | [**Вверх**](c-top.md)<br/>                          |
