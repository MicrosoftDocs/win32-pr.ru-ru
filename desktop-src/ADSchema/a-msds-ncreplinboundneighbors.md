...
---
# <a name="ms-ds-nc-repl-inbound-neighbors-attribute"></a>Атрибут ms-DS-NC-REPL-Inbound-соседи

Партнеры репликации для этой секции. Этот сервер получает данные репликации с этих серверов, которые действуют как источники.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DS-NC-REPL-Inbound-соседи             |
| LDAP-отображаемое имя | msDS-Нкреплинбаунднеигхборс                 |
| Размер              | \-                                          |
