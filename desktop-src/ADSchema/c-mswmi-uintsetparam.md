...
ms.locfileid: "119801564"
---
# <a name="ms-wmi-uintsetparam-class"></a>класс MS-WMI-Уинтсетпарам

Объект параметра целочисленного набора без знака.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Уинтсетпарам                  |
| LDAP-отображаемое имя | Мсвми — Уинтсетпарам                   |
...
| Подкласс                 | [**MS-WMI-Ранжепарам**](c-mswmi-rangeparam.md)<br/>                                         |
...
| [**MS-WMI-Интдефаулт**](a-mswmi-intdefault.md)                             | Верно      | **MS-WMI-Уинтсетпарам**                                    |
| [**MS-WMI-Интвалидвалуес**](a-mswmi-intvalidvalues.md)                     | Нет     | **MS-WMI-Уинтсетпарам**                                    |
