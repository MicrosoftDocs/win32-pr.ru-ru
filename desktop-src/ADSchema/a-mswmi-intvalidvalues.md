...
ms.locfileid: "117837351"
---
# <a name="ms-wmi-intvalidvalues-attribute"></a>атрибут MS-WMI-Интвалидвалуес

Допустимые значения для объекта целочисленного параметра WMI 32-bit.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Интвалидвалуес                |
| LDAP-отображаемое имя | Мсвми — Интвалидвалуес                 |
| Размер              | \-                                   |
