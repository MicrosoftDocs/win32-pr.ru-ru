...
---
# <a name="ms-ieee-80211-policy-class"></a>MS-IEEE-80211-класс политики

Класс для хранения объекта политики беспроводной сети.



| Ввод | Значение |
|-------------------|----------------------------------------------------------------------------------|
| CN                | MS-IEEE-80211 — политика                                                             |
| LDAP-отображаемое имя | msieee80211 — политика                                                               |
...
| [**MS-IEEE-80211-Data**](a-msieee80211-data.md)                            | Неверно     | **MS-IEEE-80211 — политика**        |
| [**MS-IEEE-80211-тип данных**](a-msieee80211-datatype.md)                   | Неверно     | **MS-IEEE-80211 — политика**        |
| [**MS-IEEE-80211-ID**](a-msieee80211-id.md)                                | Неверно     | **MS-IEEE-80211 — политика**        |
