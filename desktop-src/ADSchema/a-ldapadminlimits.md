...
---
# <a name="ldap-admin-limits-attribute"></a>Атрибут LDAP-Admin-limits

Содержит набор пар «атрибут-значение», определяющих административные ограничения сервера LDAP.
...
| LDAP-отображаемое имя | лдападминлимитс                             |
| Размер              | \-                                          |
