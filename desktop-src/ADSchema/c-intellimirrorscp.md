...
---
# <a name="intellimirror-scp-class"></a>Класс IntelliMirror-SCP

Этот объект содержит сведения о конфигурации службы, которая отвечает на клиенты удаленной загрузки, которые запрашивают внимание от сервера удаленной установки.
...
| LDAP-отображаемое имя | интеллимиррорскп                               |
...
| Подкласс                 | [**Служба — Администрирование — точка**](c-serviceadministrationpoint.md)<br/>              |
| Возможные старшие          | [**Компьютер группы IntelliMirror**](c-intellimirrorgroup.md)[](c-computer.md)            |
...
| [**нетбут-Allow-New-Clients**](a-netbootallownewclients.md)                | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут — только для ответов — допустимые — клиенты**](a-netbootansweronlyvalidclients.md) | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут — ответы — запросы**](a-netbootanswerrequests.md)                   | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-Current-Client-Счетчик**](a-netbootcurrentclientcount.md)          | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-IntelliMirror-ОС**](a-netbootintellimirroroses.md)             | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-Limit-клиенты**](a-netbootlimitclients.md)                       | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут — локально установленные — ОС**](a-netbootlocallyinstalledoses.md)      | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**Нетбут-Machine-File-Path**](a-netbootmachinefilepath.md)                | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-Max-клиенты**](a-netbootmaxclients.md)                           | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут — создание политики именования компьютеров**](a-netbootnewmachinenamingpolicy.md) | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-New-Machine-OU**](a-netbootnewmachineou.md)                      | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут-SCP-BL**](a-netbootscpbl.md)                                     | Неверно     | [**Вверх**](c-top.md)<br/>                                                          |
| [**нетбут — сервер**](a-netbootserver.md)                                    | Неверно     | **IntelliMirror — SCP**                                                                    |
| [**нетбут — средства**](a-netboottools.md)                                      | Неверно     | **IntelliMirror — SCP**                                                                    |
