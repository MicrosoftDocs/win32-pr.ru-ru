...
ms.locfileid: "119300775"
---
# <a name="meetingisencrypted-attribute"></a>атрибут Митингисенкриптед

Это **справедливо** , если собрание должно быть зашифровано.



| Ввод | Значение |
|-------------------|----------------------------------------------------------------------------------|
| CN                | митингисенкриптед                                                               |
| LDAP-отображаемое имя | митингисенкриптед                                                               |
| Размер              | \-                                                                               |
