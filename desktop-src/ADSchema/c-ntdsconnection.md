...
---
# <a name="ntds-connection-class"></a>Класс NTDS-Connection

Подключение с удаленного контроллера домена.
...
|-------------------|--------------------------------------|
| CN                | NTDS-Connection                      |
| LDAP-отображаемое имя | нтдсконнектион                       |
...
| Возможные старшие          | [**NTDS-DSA**](c-ntdsdsa.md)[**NTFRS-реплика-Set**](c-ntfrsreplicaset.md)[**NTFRS-Member**](c-ntfrsmember.md) |
...
| [**Включено — подключение**](a-enabledconnection.md)                         | True      | **NTDS — подключение**             |
...
| [**From-Server**](a-fromserver.md)                                       | True      | **NTDS — подключение**             |
...
| [**Создано — подключение**](a-generatedconnection.md)                     | Неверно     | **NTDS — подключение**             |
...
| [**MS-DS-replicate-NC-причина**](a-ms-ds-replicatesncreason.md)          | Неверно     | **NTDS — подключение**             |
...
| [**Параметры**](a-options.md)                                              | True      | **NTDS — подключение**             |
...
| [**Расписание**](a-schedule.md)                                            | Неверно     | **NTDS — подключение**             |
...
| [**Тип транспорта**](a-transporttype.md)                                 | Неверно     | **NTDS — подключение**             |
...
| RDN-Атри-ID                  | [**Common-Name**](a-cn.md)<br/> |
| Подкласс                 | [**Leaf**](c-leaf.md)<br/>      |
| Возможные старшие          | [**NTDS-DSA**](c-ntdsdsa.md)          |
| Вспомогательные классы           | \-                                     |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                           |
