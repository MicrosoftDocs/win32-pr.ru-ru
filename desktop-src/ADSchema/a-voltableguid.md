...
---
# <a name="vol-table-guid-attribute"></a>Атрибут Vol-Table-GUID

Уникальный идентификатор для записи таблицы Link-Track-Volume.
...
|-------------------|-------------------------------------------------------|
| CN                | Vol-Таблица-GUID                                        |
| LDAP-отображаемое имя | волтаблегуид                                          |
| Размер              | 16 байт                                              |
