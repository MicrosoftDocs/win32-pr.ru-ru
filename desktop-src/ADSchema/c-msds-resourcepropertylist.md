...
ms.locfileid: "118422368"
---
# <a name="ms-ds-resource-property-list-class"></a>класс списка MS-DS-Resource-Property-List

Объект этого класса содержит список свойств ресурсов.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Список свойств MS-DS-Resource-Property-         |
| LDAP-отображаемое имя | msDS-Ресаурцепропертилист            |
...
| [**Список свойств MS-DS-Members-of-Resource-a**](a-msds-membersofresourcepropertylist.md)      | Неверно     | **Список свойств MS-DS-Resource-Property-** |
