...
ms.locfileid: "118683370"
---
# <a name="ms-ds-principal-name-attribute"></a>Атрибут ms-DS-Principal-Name

Имя учетной записи для субъекта безопасности (созданного).
...
| LDAP-отображаемое имя | msDS-PrincipalName                          |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**MS-DS-BIND-proxy**](c-msds-bindproxy.md)<br/> |
