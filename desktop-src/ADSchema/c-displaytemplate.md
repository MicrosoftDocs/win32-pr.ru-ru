...
---
# <a name="display-template-class"></a>Класс Display-Template

Указывает сведения для шаблона адреса.
...
|-------------------|--------------------------------------|
| CN                | Display-Template                     |
| LDAP-отображаемое имя | дисплайтемплате                      |
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Адрес-ввод-отображение-таблица**](a-addressentrydisplaytable.md)            | Неверно     | **Отображение шаблона**                                 |
| [**Адрес-ввод-отображение-таблица-MSDOS**](a-addressentrydisplaytablemsdos.md) | Неверно     | **Отображение шаблона**                                 |
...
| [**Common-Name**](a-cn.md)                                                  | True      | **Отображение — шаблон** [ **сверху**](c-top.md)<br/> |
...
| [**Help-Data16**](a-helpdata16.md)                                          | Неверно     | **Отображение шаблона**                                 |
| [**Help-Data32**](a-helpdata32.md)                                          | Неверно     | **Отображение шаблона**                                 |
| [**Help-File-Name**](a-helpfilename.md)                                     | Неверно     | **Отображение шаблона**                                 |
...
| [**Исходный-вывод-таблица**](a-originaldisplaytable.md)                     | Неверно     | **Отображение шаблона**                                 |
| [**Исходный-отобразить-таблица-MSDOS**](a-originaldisplaytablemsdos.md)          | Неверно     | **Отображение шаблона**                                 |
