...
---
# <a name="shell-context-menu-attribute"></a>Контекстное меню оболочки

Порядковый номер и идентификатор GUID контекстного меню для этого объекта.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Контекстное меню оболочки                          |
| LDAP-отображаемое имя | шеллконтекстмену                            |
| Размер              | \-                                          |
