...
Универсальный объект для публикации UNC файла.
...
|-------------------|--------------------------------------|
| CN                | Память                              |
| LDAP-отображаемое имя | носителей.                              |
...
| [**Icon-путь**](a-iconpath.md)                                           | Неверно     | **Память**                                                                              |
...
| [**Помощи**](a-moniker.md)                                              | Неверно     | **Память**                                                                              |
| [**Моникер — отображаемое имя**](a-monikerdisplayname.md)                      | Неверно     | **Память**                                                                              |
