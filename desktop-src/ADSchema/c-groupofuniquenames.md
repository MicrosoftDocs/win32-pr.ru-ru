...
ms.locfileid: "119021812"
---
# <a name="groupofuniquenames-class"></a>класс Граупофуникуенамес

Определяет записи для группы уникальных имен. Обычно используется для хранения объектов Account.



| Ввод | Значение |
|-------------------|------------------------------------------------|
| CN                | граупофуникуенамес                             |
| LDAP-отображаемое имя | граупофуникуенамес                             |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; AU) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; AO) (A;; РПЛКЛОРК;;; PS |
...
| [**Бизнес — Категория**](a-businesscategory.md)                             | Неверно     | **граупофуникуенамес**                                 |
| [**Каноническое имя**](a-canonicalname.md)                                   | Неверно     | [**Вверх**](c-top.md)<br/>                        |
| [**Common-Name**](a-cn.md)                                                 | Верно      | **граупофуникуенамес** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                        |
| [**Описание**](a-description.md)                                        | Неверно     | **граупофуникуенамес** [ **сверху**](c-top.md)<br/> |
...
| [**Организация — имя подразделения**](a-ou.md)                                    | Неверно     | **граупофуникуенамес**                                 |
| [**Название организации**](a-o.md)                                            | Неверно     | **граупофуникуенамес**                                 |
| [**Другие хорошо известные объекты**](a-otherwellknownobjects.md)                 | Неверно     | [**Вверх**](c-top.md)<br/>                        |
| [**Владелец**](a-owner.md)                                                    | Неверно     | **граупофуникуенамес**                                 |
...
| [**См. также**](a-seealso.md)                                               | Неверно     | **граупофуникуенамес**                                 |
...
| [**уникуемембер**](a-uniquemember.md)                                      | Верно      | **граупофуникуенамес**                                 |
