...
---
# <a name="class-registration-class"></a>Класс Class-Registration

Сведения о регистрации для COM-объекта.
...
| LDAP-отображаемое имя | classRegistration                    |
...
| [**CLSID COM**](a-comclsid.md)                                           | Неверно     | **Регистрация класса**          |
| [**COM — InterfaceID**](a-cominterfaceid.md)                               | Неверно     | **Регистрация класса**          |
| [**Common-Name**](a-cn.md)                                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**COM-other-Prog-ID**](a-comotherprogid.md)                             | Неверно     | **Регистрация класса**          |
| [**COM — ProgID**](a-comprogid.md)                                         | Неверно     | **Регистрация класса**          |
| [**COM-интерпретировать-As-Class-ID**](a-comtreatasclassid.md)                      | Неверно     | **Регистрация класса**          |
...
| [**Реализованные — категории**](a-implementedcategories.md)                 | Неверно     | **Регистрация класса**          |
...
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Регистрация класса**          |
...
| [**Обязательные — категории**](a-requiredcategories.md)                       | Неверно     | **Регистрация класса**          |
