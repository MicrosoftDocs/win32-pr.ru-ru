...
| [**CLSID COM**](a-comclsid.md)                                           | Нет     | **Регистрация класса**          |
| [**COM — InterfaceID**](a-cominterfaceid.md)                               | Нет     | **Регистрация класса**          |
| [**Common-Name**](a-cn.md)                                               | Нет     | [**Вверх**](c-top.md)<br/> |
| [**COM-other-Prog-ID**](a-comotherprogid.md)                             | Нет     | **Регистрация класса**          |
| [**COM — ProgID**](a-comprogid.md)                                         | Нет     | **Регистрация класса**          |
| [**COM-интерпретировать-As-Class-ID**](a-comtreatasclassid.md)                      | Нет     | **Регистрация класса**          |
...
| [**Реализованные — категории**](a-implementedcategories.md)                 | Нет     | **Регистрация класса**          |
...
| [**Под управлением**](a-managedby.md)                                         | Нет     | **Регистрация класса**          |
...
| [**Обязательные — категории**](a-requiredcategories.md)                       | Нет     | **Регистрация класса**          |
