...
---
# <a name="context-menu-attribute"></a>Атрибут Context-Menu

Порядковый номер и идентификатор GUID контекстного меню, используемого для объекта.
