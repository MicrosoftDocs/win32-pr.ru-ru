...
---
# <a name="privilege-holder-attribute"></a>Атрибут Privilege-Holder

Список различающихся имен участников, которым предоставлена эта привилегия.
...
|-------------------|-----------------------------------------|
| CN                | Privilege-Holder                        |
| LDAP-отображаемое имя | привилежехолдер                         |
| Размер              | \-                                      |
