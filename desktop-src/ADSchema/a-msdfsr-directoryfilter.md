...
Содержит строку фильтра, применяемую к каталогам.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DFSR-Директорифилтер                     |
| LDAP-отображаемое имя | Мсдфср — Директорифилтер                      |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**MS-DFSR-Contenting**](c-msdfsr-contentset.md)<br/> |
...
| Search-Flags           | 0x00000000                                                                                                                            |
| System-Flags           | 0x00000000                                                                                                                            |
| Классы, используемые в        | [**MS-DFSR-группы репликации**](c-msdfsr-replicationgroup.md)<br/> [**MS-DFSR-Contenting**](c-msdfsr-contentset.md)<br/> |
