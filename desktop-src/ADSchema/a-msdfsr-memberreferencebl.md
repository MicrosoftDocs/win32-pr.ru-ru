...
ms.locfileid: "119298764"
---
# <a name="ms-dfsr-memberreferencebl-attribute"></a>атрибут MS-DFSR-Мемберреференцебл

Содержит обратную ссылку для атрибута [**MS-DFSR-мемберреференце**](a-msdfsr-memberreference.md) .



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | MS-DFSR-Мемберреференцебл               |
| LDAP-отображаемое имя | Мсдфср — Мемберреференцебл                |
| Размер              | \-                                      |
...
Атрибут **MS-DFSR-мемберреференцебл** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
