...
ms.locfileid: "119801474"
---
# <a name="rras-administration-dictionary-class"></a>RRAS-Administration — класс Dictionary

Объект Dictionary для преобразования атрибутов маршрутизации, зависящих от поставщика, к именам.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | RRAS-Admin-Dictionary       |
| LDAP-отображаемое имя | ррасадминистратиондиктионари         |
...
| [**MS-RRAS-Vendor-Attribute-Entry**](a-msrrasvendorattributeentry.md)    | Нет.     | **RRAS-Admin-Dictionary** |
