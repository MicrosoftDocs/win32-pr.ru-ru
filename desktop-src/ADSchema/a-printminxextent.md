...
---
# <a name="print-min-x-extent-attribute"></a>Атрибут "Print-min-X-экстент"

Минимальная горизонтальная область печати.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Print-min-X-экстент                   |
| LDAP-отображаемое имя | принтминксекстент                      |
| Размер              | 4 байта                              |
