...
ms.locfileid: "119643734"
---
# <a name="container-class"></a>Класс контейнера
...
|-------------------|------------------------------------------------|
| CN                | Контейнер                                      |
| LDAP-отображаемое имя | контейнер                                      |
...
| Возможные старшие          | [**Организация**](c-organization.md) [**—**](c-organizationalunit.md)[**Конфигурация**](c-configuration.md)контейнера подразделения [**домен — DNS**](c-domaindns.md)[**NTDS-Service**](c-ntdsservice.md)[**MSMQ —**](c-msmqqueue.md)[](c-server.md)[**подсеть**](c-subnet.md) сервера очереди |
...
| [**Common-Name**](a-cn.md)                                               | Верно      | **Контейнер** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                            | Нет     | [**Вверх**](c-top.md)<br/>               |
| [**Хранилище классов по умолчанию**](a-defaultclassstore.md)                        | Нет     | **Контейнер**                                 |
...
| [**Версия схемы**](a-schemaversion.md)                                 | Нет     | **Контейнер**                                 |
...
| [**Справочник по MS-DS-Object-**](a-msds-objectreference.md)                    | Нет     | **Контейнер**                                 |
...
| RDN-Атри-ID                  | [**Common-Name**](a-cn.md)<br/>                                                                                                                                                                                                                                   |
| Подкласс                 | [**Вверх**](c-top.md)<br/>                                                                                                                                                                                                                                          |
| Возможные старшие          | [**Организация**](c-organization.md) [**—**](c-organizationalunit.md)[**Конфигурация**](c-configuration.md)контейнера подразделения [**домен — DNS**](c-domaindns.md)-сервер [**NTDS —**](c-ntdsservice.md)[](c-server.md)[**подсеть**](c-subnet.md) сервера службы |
| Вспомогательные классы           | \-                                                                                                                                                                                                                                                                       |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                                                                                                                                                             |
