...
ms.locfileid: "119324714"
---
# <a name="domainrelatedobject-class"></a>класс Домаинрелатедобжект

Класс объектов Домаинрелатедобжект используется для определения записи, представляющей ряд документов.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | домаинрелатедобжект                  |
| LDAP-отображаемое имя | домаинрелатедобжект                  |
...
| [**ассоЦиатеддомаин**](a-associateddomain.md)                              | Неверно     | **домаинрелатедобжект**         |
