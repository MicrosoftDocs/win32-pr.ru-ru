...
ms.locfileid: "118426715"
---
# <a name="ms-ds-date-time-attribute"></a>Атрибут ms-DS-Дата-время

Атрибут для хранения значения даты и времени.
...
|-------------------|---------------------------------------------------------------|
| CN                | MS-DS-Дата-время                                               |
| LDAP-отображаемое имя | msDS-DateTime                                                 |
| Размер              | \-                                                            |
...
| Классы, используемые в        | [**MS-DS-App-Configuration**](c-msds-app-configuration.md)<br/> [**MS-DS-App-Data**](c-msds-appdata.md)<br/> |
