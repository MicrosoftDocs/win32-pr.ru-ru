...
---
# <a name="mssfu-30-network-user-class"></a>класс Мссфу-30-Network-User

Представляет данные сетевого файла.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Мссфу-30 — сеть — пользователь                |
| LDAP-отображаемое имя | msSFU30NetworkUser                   |
...
| [**Мссфу-30 — значения ключа**](a-mssfu30keyvalues.md)                           | Неверно     | **Мссфу-30 — сеть — пользователь**       |
| [**Мссфу-30 — имя**](a-mssfu30name.md)                                      | Неверно     | **Мссфу-30 — сеть — пользователь**       |
| [**Мссфу-30-NIS-домен**](a-mssfu30nisdomain.md)                           | Неверно     | **Мссфу-30 — сеть — пользователь**       |
...
| [**нисмапнаме**](a-nismapname.md)                                          | Неверно     | **Мссфу-30 — сеть — пользователь**       |
