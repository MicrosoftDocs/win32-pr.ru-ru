...
ms.locfileid: "119022082"
---
# <a name="sync-membership-attribute"></a>Атрибут Sync-Membership

Список элементов, содержащихся в встроенной группе SAM для синхронизации.
...
|-------------------|-----------------------------------------|
| CN                | Sync-Membership                         |
| LDAP-отображаемое имя | синкмембершип                          |
| Размер              | \-                                      |
