...
---
# <a name="msmq-enterprise-settings-class"></a>MSMQ — Корпоративный класс параметров

Объект с общими сведениями MSMQ. Он размещается в разделе \\ \\ службы конфигурации. В лесу может быть только один из них. Этот объект содержит сведения о конфигурации, относящиеся к Организации, для очереди сообщений.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MSMQ-Enterprise-параметры             |
| LDAP-отображаемое имя | мсмкентерприсесеттингс               |
...
| [**MSMQ-CSP-имя**](a-msmqcspname.md)                                    | Неверно     | **MSMQ-Enterprise-параметры**    |
| [**MSMQ — Interval1**](a-msmqinterval1.md)                                 | Неверно     | **MSMQ-Enterprise-параметры**    |
| [**MSMQ — Interval2**](a-msmqinterval2.md)                                 | Неверно     | **MSMQ-Enterprise-параметры**    |
| [**MSMQ — долгосрочные**](a-msmqlonglived.md)                                | Неверно     | **MSMQ-Enterprise-параметры**    |
| [**MSMQ-Name-Style**](a-msmqnamestyle.md)                                | Неверно     | **MSMQ-Enterprise-параметры**    |
| [**Версия MSMQ**](a-msmqversion.md)                                     | Неверно     | **MSMQ-Enterprise-параметры**    |
