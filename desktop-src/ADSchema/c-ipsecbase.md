...
Базовый класс IPSEC, из которого производятся все классы IPSEC.
...
|-------------------|--------------------------------------|
| CN                | Ipsec-Base                           |
| LDAP-отображаемое имя | ипсекбасе                            |
...
| [**Имя IPSec**](a-ipsecname.md)                                         | Неверно     | **IPSec-Base**                  |
| [**Справочник по IPsec-владельцам**](a-ipsecownersreference.md)                  | Неверно     | **IPSec-Base**                  |
