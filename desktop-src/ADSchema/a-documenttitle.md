...
ms.locfileid: "119804874"
---
# <a name="documenttitle-attribute"></a>атрибут Документтитле

Тип атрибута Документтитле задает заголовок документа.
...
|-------------------|---------------------------------------------|
| CN                | документтитле                               |
| LDAP-отображаемое имя | документтитле                               |
| Размер              | \-                                          |
