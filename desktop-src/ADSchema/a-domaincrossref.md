...
ms.locfileid: "120077734"
---
# <a name="domain-cross-ref-attribute"></a>Домен-атрибут перекрестной ссылки

Это ссылка из объекта доверенного домена на объект перекрестной ссылки доверенного домена.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | Домен-перекрестная ссылка                        |
| LDAP-отображаемое имя | домаинкроссреф                          |
| Размер              | \-                                      |
