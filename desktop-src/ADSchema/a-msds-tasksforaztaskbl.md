...
ms.locfileid: "119544214"
---
# <a name="ms-ds-tasks-for-az-task-bl-attribute"></a>Атрибут ms-DS-Tasks-for-AZ-Task-BL

Обратная ссылка с Az-Task на объекты Az-Task, которые связываются с ним.
...
| LDAP-отображаемое имя | msDS-Тасксфоразтаскбл                   |
| Размер              | \-                                      |
