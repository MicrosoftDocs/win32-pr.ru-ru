...
ms.locfileid: "118959551"
---
# <a name="type-library-class"></a>Класс Type-Library

Этот класс содержит сведения о библиотеке типов.
...
|-------------------|--------------------------------------|
| CN                | Type-Library                         |
| LDAP-отображаемое имя | Библиотеку типов                          |
...
| [**COM-ClassID**](a-comclassid.md)                                       | Неверно     | **Библиотека типов**                |
| [**COM — InterfaceID**](a-cominterfaceid.md)                               | Неверно     | **Библиотека типов**                |
| [**Common-Name**](a-cn.md)                                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**COM-Unique-LIBID**](a-comuniquelibid.md)                              | Неверно     | **Библиотека типов**                |
