...
ms.locfileid: "119803303"
---
# <a name="msmq-interval2-attribute"></a>Атрибут MSMQ-Interval2

В смешанном режиме MSMQ время репликации по умолчанию между сайтами.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Interval2                       |
| LDAP-отображаемое имя | mSMQInterval2                        |
| Размер              | \-                                   |
...
| Классы, используемые в        | [**MSMQ-Enterprise — Параметры**](c-msmqenterprisesettings.md)<br/> [**Сайт**](c-site.md)<br/> |
