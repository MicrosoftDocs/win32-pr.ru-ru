...
ms.locfileid: "119580614"
---
# <a name="subnet-container-class"></a>Класс Subnet-Container

Контейнер для хранения всех объектов подсети.
...
|-------------------|--------------------------------------|
| CN                | Subnet-Container                     |
| LDAP-отображаемое имя | субнетконтаинер                      |
