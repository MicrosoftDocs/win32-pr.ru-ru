...
ms.locfileid: "119803654"
---
# <a name="ms-ds-pso-applies-to-attribute"></a>Атрибут ms-DS-PSO-Примен.

Ссылки на объекты, к которым применяется этот объект параметров пароля.



| Ввод | Значение |
|-------------------|-----------------------------------------|
| CN                | MS-DS-PSO — применяется к                    |
| LDAP-отображаемое имя | msDS-PSOAppliesTo                       |
| Размер              | \-                                      |
