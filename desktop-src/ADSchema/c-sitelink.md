...
ms.locfileid: "119548914"
---
# <a name="site-link-class"></a>Класс Site-Link

Этот объект представляет соединение между двумя сайтами.
...
|-------------------|----------------------------------------------------|
| CN                | Site-Link                                          |
| LDAP-отображаемое имя | siteLink                                           |
| Привилегия обновления  | Администратор домена                               |
| Частота обновления  | При каждом изменении сайтов, подключенных к этой ссылке. |
...
| Возможные старшие          | [**Межсайтовый транспорт**](c-intersitetransport.md)                                         |
...
| [**Стоимость**](a-cost.md)                                                    | Нет     | **Ссылка на сайт**                   |
...
| [**Параметры**](a-options.md)                                              | Нет     | **Ссылка на сайт**                   |
...
| [**REPL-интервал**](a-replinterval.md)                                   | Нет     | **Ссылка на сайт**                   |
...
| [**Расписание**](a-schedule.md)                                            | Нет     | **Ссылка на сайт**                   |
...
| [**Список сайтов**](a-sitelist.md)                                           | Верно      | **Ссылка на сайт**                   |
