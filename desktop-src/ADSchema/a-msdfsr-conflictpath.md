...
---
# <a name="ms-dfsr-conflictpath-attribute"></a>атрибут MS-DFSR-Конфликтпас

Содержит полный путь к каталогу конфликтов.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DFSR-Конфликтпас                        |
| LDAP-отображаемое имя | Мсдфср — Конфликтпас                         |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**Подписка MS-DFSR-Subscription**](c-msdfsr-subscription.md)<br/> |
...
Атрибут **MS-DFSR-конфликтпас** является частью поддержки службы репликации распределенная ФАЙЛОВАЯ система (DFS).
