...
ms.locfileid: "118175640"
---
# <a name="msmq-custom-recipient-class"></a>Класс "MSMQ-Custom-получател"

Используется для определения настраиваемого получателя MSMQ (также называемого очередью псевдонимов). Определяет псевдоним для очереди вне Организации. Содержит имя формата этой очереди.



| Ввод | Значение |
|-------------------|------------------------------------------|
| CN                | MSMQ-Custom-получател                    |
| LDAP-отображаемое имя | msMQ-Custom-получател                    |
| Привилегия обновления  | Владелец очереди.                         |
| Частота обновления  | Только после перемещения внешней очереди. |
...
| [**MSMQ-Recipient-FormatName**](a-msmq-recipient-formatname.md)            | Неверно     | **MSMQ-Custom-получател**       |
