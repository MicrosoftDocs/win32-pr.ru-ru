...
Идентификатор GUID необязательного компонента.
...
| LDAP-отображаемое имя | msDS-Оптионалфеатурегуид                              |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**MS-DS-необязательный компонент**](c-msds-optionalfeature.md)<br/> |
