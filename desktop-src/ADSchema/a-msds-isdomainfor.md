...
Обратная ссылка для [**MS-DS-with-Domain-NC**](a-msds-hasdomainncs.md). Определяет, какие контроллеры домена содержат этот раздел в качестве основного домена.
...
|-------------------|-----------------------------------------|
| CN                | MS-DS--домен — для                     |
| LDAP-отображаемое имя | msDS-Исдомаинфор                        |
| Размер              | \-                                      |
