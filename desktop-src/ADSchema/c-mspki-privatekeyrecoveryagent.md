...
ms.locfileid: "119879804"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>класс MS-PKI-Private-Key-Recovery-Agent

Используется для публикации сертификата агента восстановления ключей в контейнере KRA.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-PKI-частный-Key-Recovery-Agent    |
| LDAP-отображаемое имя | Мспки — Приватекэйрековеряжент        |
...
| [**X509 — CERT**](a-usercertificate.md)                                      | Верно      | **MS-PKI-частный-Key-Recovery-Agent** |
