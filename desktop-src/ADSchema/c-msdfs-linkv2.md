...
---
# <a name="ms-dfs-link-v2-class"></a>класс MS-DFS-Link-v2

Ссылка DFS в пространстве имен DFS.
...
|-------------------|--------------------------------------|
| CN                | MS-DFS-Link-v2                       |
| LDAP-отображаемое имя | Мсдфс — Linkv2                         |
...
| Возможные старшие          | [**MS-DFS-Namespace-v2**](c-msdfs-namespacev2.md)                                           |
...
| [**MS-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | Неверно     | **MS-DFS-Link-v2**              |
| [**MS-DFS-Generation-GUID-v2**](a-msdfs-generationguidv2.md)                  | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-Last-Modified-v2**](a-msdfs-lastmodifiedv2.md)                      | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-Link-Path-v2**](a-msdfs-linkpathv2.md)                              | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-Link-Security-дескриптор v2**](a-msdfs-linksecuritydescriptorv2.md) | Неверно     | **MS-DFS-Link-v2**              |
| [**MS-DFS-Namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-Properties-v2**](a-msdfs-propertiesv2.md)                           | True      | **MS-DFS-Link-v2**              |
...
| [**MS-DFS-Short-Name-Link-Path-v2**](a-msdfs-shortnamelinkpathv2.md)          | Неверно     | **MS-DFS-Link-v2**              |
| [**MS-DFS-Target-List-v2**](a-msdfs-targetlistv2.md)                          | True      | **MS-DFS-Link-v2**              |
| [**MS-DFS-TTL-v2**](a-msdfs-ttlv2.md)                                         | True      | **MS-DFS-Link-v2**              |
