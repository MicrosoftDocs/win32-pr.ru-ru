...
ms.locfileid: "119643094"
---
# <a name="ms-wmi-intrangeparam-class"></a>класс MS-WMI-Интранжепарам

Объект параметра диапазона целых чисел со знаком.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Интранжепарам                 |
| LDAP-отображаемое имя | Мсвми — Интранжепарам                  |
...
| [**MS-WMI-Интдефаулт**](a-mswmi-intdefault.md)                             | Верно      | **MS-WMI-Интранжепарам**                                   |
| [**MS-WMI-Интмакс**](a-mswmi-intmax.md)                                     | Нет     | **MS-WMI-Интранжепарам**                                   |
| [**MS-WMI-Интмин**](a-mswmi-intmin.md)                                     | Нет     | **MS-WMI-Интранжепарам**                                   |
