...
ms.locfileid: "119081758"
---
# <a name="msmq-services-attribute"></a>Атрибут MSMQ-Services

Тип службы, предоставляемой MSMQ, установленной на этом сервере.
...
|-------------------|--------------------------------------|
| CN                | MSMQ-Services                        |
| LDAP-отображаемое имя | MsmqServices недопустима                         |
| Размер              | \-                                   |
