...
ms.locfileid: "118682435"
---
# <a name="mssfu-30-search-container-attribute"></a>Мссфу-30-Поиск-атрибут контейнера

Содержит идентификатор объекта, который указывает, где начнется каждый поиск.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | Мссфу-30-Поиск-контейнер                   |
| LDAP-отображаемое имя | msSFU30SearchContainer                      |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**Мссфу-30 — сведения о домене**](c-mssfu30domaininfo.md)<br/> |
