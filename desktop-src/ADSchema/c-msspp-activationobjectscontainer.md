...
ms.locfileid: "119879404"
---
# <a name="ms-spp-activation-objects-container-class"></a>Класс контейнеров MS-SPP-Activation-Objects-Container

Контейнер для объектов активации, используемых при активации на основе Active Directory
...
| LDAP-отображаемое имя | МССПП — Активатионобжектсконтаинер     |
...
| Дескриптор безопасности по умолчанию | О:БАГ: ОШИБКА: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПЛКЛОРК;;; СЛУЖБЫ |
