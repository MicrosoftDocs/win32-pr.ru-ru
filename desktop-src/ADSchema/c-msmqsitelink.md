...
---
# <a name="msmq-site-link-class"></a>Класс MSMQ-site-Link

Содержит сведения о подключении MSMQ между сайтами. Этот объект создается для каждой создаваемой маршрутной ссылки и содержит сведения о подключении. Эти объекты содержатся в объектах служб MSMQ.



| Ввод | Значение |
|-------------------|-------------------------------------------------------------------|
| CN                | Очередь MSMQ-site-Link                                                    |
| LDAP-отображаемое имя | мсмксителинк                                                      |
| Привилегия обновления  | Владелец очереди.                                                  |
| Частота обновления  | Экземпляр создается для каждой пары подключенных сайтов. |
...
| Возможные старшие          | [**MSMQ-Enterprise-параметры**](c-msmqenterprisesettings.md)                                 |
...
| [**MSMQ — стоимость**](a-msmqcost.md)                                           | True      | **Очередь MSMQ-site-Link**              |
| [**MSMQ-Site-1**](a-msmqsite1.md)                                        | True      | **Очередь MSMQ-site-Link**              |
| [**MSMQ-Site-2**](a-msmqsite2.md)                                        | True      | **Очередь MSMQ-site-Link**              |
| [**MSMQ-site-Gates**](a-msmqsitegates.md)                                | Неверно     | **Очередь MSMQ-site-Link**              |
| [**MSMQ-site-Gates-MIG**](a-msmqsitegatesmig.md)                         | Неверно     | **Очередь MSMQ-site-Link**              |
