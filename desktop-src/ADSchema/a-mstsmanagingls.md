...
ms.locfileid: "118424122"
---
# <a name="ms-ts-managingls-attribute"></a>Атрибут MS-TS-Манагинглс

Службы терминалов, управляющие сервером лицензий.
...
|-------------------|---------------------------------------------|
| CN                | MS-TS-Манагинглс                            |
| LDAP-отображаемое имя | мстсманагинглс                              |
| Размер              | \-                                          |
