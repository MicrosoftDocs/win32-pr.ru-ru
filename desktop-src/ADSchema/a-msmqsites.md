...
ms.locfileid: "118960393"
---
# <a name="msmq-sites-attribute"></a>Атрибут MSMQ-Sites

Список сайтов, к которым принадлежит компьютер (массив узлов Обжектгуидс, обычно не более одного GUID).
...
|-------------------|-------------------------------------------------------|
| CN                | MSMQ-Sites                                            |
| LDAP-отображаемое имя | мсмкситес                                             |
| Размер              | \-                                                    |
