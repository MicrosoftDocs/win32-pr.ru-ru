...
Атрибут, определяющий текущую строку соли NSEC3, используемую для подписи зоны DNS.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-DNS-NSEC3-Current-соли                   |
| LDAP-отображаемое имя | msDN — NSEC3CurrentSalt                      |
| Размер              | \-                                          |
