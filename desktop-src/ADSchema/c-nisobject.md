...
---
# <a name="nisobject-class"></a>класс Нисобжект

Содержит запись в сопоставлении NIS.
...
|-------------------|--------------------------------------|
| CN                | нисобжект                            |
| LDAP-отображаемое имя | нисобжект                            |
...
| [**Common-Name**](a-cn.md)                                                 | True      | **нисобжект** [ **сверху**](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>               |
| [**Описание**](a-description.md)                                        | Неверно     | **нисобжект** [ **сверху**](c-top.md)<br/> |
...
| [**Мссфу-30 — имя**](a-mssfu30name.md)                                      | Неверно     | **нисобжект**                                 |
| [**Мссфу-30-NIS-домен**](a-mssfu30nisdomain.md)                           | Неверно     | **нисобжект**                                 |
...
| [**нисмапентри**](a-nismapentry.md)                                        | True      | **нисобжект**                                 |
| [**нисмапнаме**](a-nismapname.md)                                          | True      | **нисобжект**                                 |
