...
---
# <a name="package-registration-class"></a>Класс Package-Registration
...
| LDAP-отображаемое имя | паккажерегистратион                  |
...
| Возможные старшие          | [**Хранилище классов**](c-classstore.md)                                                          |
...
| [**Can-Upgrade-Скрипт**](a-canupgradescript.md)                          | Неверно     | **Регистрация пакета**        |
| [**Категории**](a-categories.md)                                        | Неверно     | **Регистрация пакета**        |
| [**COM-ClassID**](a-comclassid.md)                                       | Неверно     | **Регистрация пакета**        |
| [**COM — InterfaceID**](a-cominterfaceid.md)                               | Неверно     | **Регистрация пакета**        |
| [**Common-Name**](a-cn.md)                                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**COM — ProgID**](a-comprogid.md)                                         | Неверно     | **Регистрация пакета**        |
| [**Модель COM-typelib-ID**](a-comtypelibid.md)                                  | Неверно     | **Регистрация пакета**        |
...
| [**File-ext-Priority**](a-fileextpriority.md)                            | Неверно     | **Регистрация пакета**        |
...
| [**Icon-путь**](a-iconpath.md)                                           | Неверно     | **Регистрация пакета**        |
| [**Install — уровень пользовательского интерфейса**](a-installuilevel.md)                              | Неверно     | **Регистрация пакета**        |
...
| [**Последняя-обновление — последовательность**](a-lastupdatesequence.md)                      | Неверно     | **Регистрация пакета**        |
| [**Идентификатор локали**](a-localeid.md)                                           | Неверно     | **Регистрация пакета**        |
| [**Архитектура машинного по**](a-machinearchitecture.md)                     | Неверно     | **Регистрация пакета**        |
| [**Под управлением**](a-managedby.md)                                         | Неверно     | **Регистрация пакета**        |
...
| [**MSI-файл-список**](a-msifilelist.md)                                    | Неверно     | **Регистрация пакета**        |
| [**Скрипт MSI**](a-msiscript.md)                                         | Неверно     | **Регистрация пакета**        |
| [**Имя MSI-Script-Name**](a-msiscriptname.md)                                | Неверно     | **Регистрация пакета**        |
| [**MSI-Script-путь**](a-msiscriptpath.md)                                | Неверно     | **Регистрация пакета**        |
| [**Размер MSI-скрипта**](a-msiscriptsize.md)                                | Неверно     | **Регистрация пакета**        |
...
| [**Флаги пакета**](a-packageflags.md)                                   | Неверно     | **Регистрация пакета**        |
| [**Имя пакета**](a-packagename.md)                                     | Неверно     | **Регистрация пакета**        |
| [**Тип пакета**](a-packagetype.md)                                     | Неверно     | **Регистрация пакета**        |
...
| [**Продукт — код**](a-productcode.md)                                     | Неверно     | **Регистрация пакета**        |
...
| [**Команда Setup**](a-setupcommand.md)                                   | Неверно     | **Регистрация пакета**        |
...
| [**Обновление — код продукта**](a-upgradeproductcode.md)                      | Неверно     | **Регистрация пакета**        |
...
| [**Vendor**](a-vendor.md)                                                | Неверно     | **Регистрация пакета**        |
| [**Номер версии — Hi**](a-versionnumberhi.md)                            | Неверно     | **Регистрация пакета**        |
| [**Версия-номер**](a-versionnumberlo.md)                            | Неверно     | **Регистрация пакета**        |
