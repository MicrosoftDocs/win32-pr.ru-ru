...
| [**Can-Upgrade-Скрипт**](a-canupgradescript.md)                          | Нет     | **Регистрация пакета**        |
| [**Категории**](a-categories.md)                                        | Нет     | **Регистрация пакета**        |
| [**COM-ClassID**](a-comclassid.md)                                       | Нет     | **Регистрация пакета**        |
| [**COM — InterfaceID**](a-cominterfaceid.md)                               | Нет     | **Регистрация пакета**        |
| [**Common-Name**](a-cn.md)                                               | Нет     | [**Вверх**](c-top.md)<br/> |
| [**COM — ProgID**](a-comprogid.md)                                         | Нет     | **Регистрация пакета**        |
| [**Модель COM-typelib-ID**](a-comtypelibid.md)                                  | Нет     | **Регистрация пакета**        |
...
| [**File-ext-Priority**](a-fileextpriority.md)                            | Нет     | **Регистрация пакета**        |
...
| [**Icon-путь**](a-iconpath.md)                                           | Нет     | **Регистрация пакета**        |
| [**Install — уровень пользовательского интерфейса**](a-installuilevel.md)                              | Нет     | **Регистрация пакета**        |
...
| [**Последняя-обновление — последовательность**](a-lastupdatesequence.md)                      | Нет     | **Регистрация пакета**        |
| [**Идентификатор локали**](a-localeid.md)                                           | Нет     | **Регистрация пакета**        |
| [**Архитектура машинного по**](a-machinearchitecture.md)                     | Нет     | **Регистрация пакета**        |
| [**Под управлением**](a-managedby.md)                                         | Нет     | **Регистрация пакета**        |
...
| [**MSI-файл-список**](a-msifilelist.md)                                    | Нет     | **Регистрация пакета**        |
| [**Скрипт MSI**](a-msiscript.md)                                         | Нет     | **Регистрация пакета**        |
| [**Имя MSI-Script-Name**](a-msiscriptname.md)                                | Нет     | **Регистрация пакета**        |
| [**MSI-Script-путь**](a-msiscriptpath.md)                                | Нет     | **Регистрация пакета**        |
| [**Размер MSI-скрипта**](a-msiscriptsize.md)                                | Нет     | **Регистрация пакета**        |
...
| [**Флаги пакета**](a-packageflags.md)                                   | Нет     | **Регистрация пакета**        |
| [**Имя пакета**](a-packagename.md)                                     | Нет     | **Регистрация пакета**        |
| [**Тип пакета**](a-packagetype.md)                                     | Нет     | **Регистрация пакета**        |
...
| [**Продукт — код**](a-productcode.md)                                     | Нет     | **Регистрация пакета**        |
...
| [**Команда Setup**](a-setupcommand.md)                                   | Нет     | **Регистрация пакета**        |
...
| [**Обновление — код продукта**](a-upgradeproductcode.md)                      | Нет     | **Регистрация пакета**        |
...
| [**поставщик**](a-vendor.md)                                                | Нет     | **Регистрация пакета**        |
| [**Номер версии — Hi**](a-versionnumberhi.md)                            | Нет     | **Регистрация пакета**        |
| [**Версия-номер**](a-versionnumberlo.md)                            | Нет     | **Регистрация пакета**        |
