...
---
# <a name="rpc-ns-priority-attribute"></a>атрибут RPC-NS-Priority

Приоритет данной записи профиля RPC.
...
|-------------------|--------------------------------------|
| CN                | RPC-NS-Priority                      |
| LDAP-отображаемое имя | рпкнсприорити                        |
| Размер              | 4 байта                              |
...
| Классы, используемые в        | [**RPC-Profile-элемент**](c-rpcprofileelement.md)<br/> |
