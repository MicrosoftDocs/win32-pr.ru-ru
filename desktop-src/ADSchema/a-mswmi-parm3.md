...
---
# <a name="ms-wmi-parm3-attribute"></a>атрибут MS-WMI-Parm3

Атрибут **MS-WMI-Parm3** зарезервирован для внутреннего использования.
...
|-------------------|---------------------------------------------|
| CN                | MS-WMI-Parm3                                |
| LDAP-отображаемое имя | Мсвми — Parm3                                 |
| Размер              | \-                                          |
