...
ms.locfileid: "119880564"
---
# <a name="ms-ds-app-data-class"></a>класс MS-DS-App-Data

Хранит данные, которые будут использоваться объектом. Например, сведения о профиле для объекта пользователя.
...
|-------------------|--------------------------------------|
| CN                | MS-DS-App-Data                       |
| LDAP-отображаемое имя | msDS-AppData                         |
...
| [**Словами**](a-keywords.md)                                              | Неверно     | **MS-DS-App-Data**                                               |
| [**Последний-известный-родительский**](a-lastknownparent.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>                                  |
| [**Под управлением**](a-managedby.md)                                           | Неверно     | **MS-DS-App-Data**                                               |
...
| [**MS-DS-Byte-массив**](a-msds-bytearray.md)                                | Неверно     | **MS-DS-App-Data**                                               |
...
| [**MS-DS-Дата-время**](a-msds-datetime.md)                                  | Неверно     | **MS-DS-App-Data**                                               |
| [**MS-DS-целое число**](a-msds-integer.md)                                     | Неверно     | **MS-DS-App-Data**                                               |
...
| [**Справочник по MS-DS-Object-**](a-msds-objectreference.md)                    | Неверно     | **MS-DS-App-Data**                                               |
...
| [**Владелец**](a-owner.md)                                                    | Неверно     | **MS-DS-App-Data**                                               |
