...
ms.locfileid: "118959703"
---
# <a name="organizational-role-class"></a>Класс Organizational-Role

Этот класс используется для объектов, содержащих сведения, относящиеся к положению или роли в Организации, например системному администратору, менеджеру и т. д. Его также можно использовать для нечеловеческих удостоверений в Организации.
...
| LDAP-отображаемое имя | организатионалроле                   |
...
| [**Common-Name**](a-cn.md)                                               | Верно      | **Верхняя роль Организации** [](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                            | Неверно     | [**Вверх**](c-top.md)<br/>                         |
| [**Описание**](a-description.md)                                      | Неверно     | [**Вверх**](c-top.md)<br/>                         |
| [**Целевой индикатор**](a-destinationindicator.md)                   | Неверно     | **Организация — роль**                                 |
...
| [**Факс-телефон — номер**](a-facsimiletelephonenumber.md)          | Неверно     | **Организация — роль**                                 |
...
| [**Международный-ISDN-номер**](a-internationalisdnnumber.md)            | Неверно     | **Организация — роль**                                 |
...
| [**Локальное имя**](a-l.md)                                              | Неверно     | **Организация — роль**                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                  | Неверно     | **Организация — роль**                                 |
...
| [**физическая доставка — Office-имя**](a-physicaldeliveryofficename.md)     | Неверно     | **Организация — роль**                                 |
| [**Возможно — подстрочные**](a-possibleinferiors.md)                         | Неверно     | [**Вверх**](c-top.md)<br/>                         |
| [**Почтовый адрес**](a-postaladdress.md)                                 | Неверно     | **Организация — роль**                                 |
| [**Почтовый код**](a-postalcode.md)                                       | Неверно     | **Организация — роль**                                 |
| [**флажок после Office**](a-postofficebox.md)                                | Неверно     | **Организация — роль**                                 |
| [**Предпочтительный метод доставки**](a-preferreddeliverymethod.md)            | Неверно     | **Организация — роль**                                 |
...
| [**Зарегистрированный адрес**](a-registeredaddress.md)                         | Неверно     | **Организация — роль**                                 |
...
| [**Role-оккупант**](a-roleoccupant.md)                                   | Неверно     | **Организация — роль**                                 |
| [**SD-Rights-эффективен**](a-sdrightseffective.md)                        | Неверно     | [**Вверх**](c-top.md)<br/>                         |
| [**См. также**](a-seealso.md)                                             | Неверно     | **Организация — роль**                                 |
...
| [**State-или-провинция-Name**](a-st.md)                                    | Неверно     | **Организация — роль**                                 |
| [**Улица-адрес**](a-street.md)                                        | Неверно     | **Организация — роль**                                 |
...
| [**Номер телефона**](a-telephonenumber.md)                             | Неверно     | **Организация — роль**                                 |
| [**Teletex — идентификатор терминала**](a-teletexterminalidentifier.md)        | Неверно     | **Организация — роль**                                 |
| [**Номер телекса**](a-telexnumber.md)                                     | Неверно     | **Организация — роль**                                 |
...
| [**X121 — адрес**](a-x121address.md)                                     | Неверно     | **Организация — роль**                                 |
