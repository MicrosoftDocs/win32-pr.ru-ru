...
| [**Common-Name**](a-cn.md)                                               | True      | **Верхняя роль Организации** [](c-top.md)<br/> |
...
| [**Физическая доставка — офис — имя**](a-physicaldeliveryofficename.md)     | Неверно     | **Организация — роль**                                 |
...
| [**Пост-Office-Box**](a-postofficebox.md)                                | Неверно     | **Организация — роль**                                 |
