...
Идентификаторы OID расширенного использования ключа для шаблона сертификата.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | PKI — использование расширенного ключа                      |
| LDAP-отображаемое имя | пкиекстендедкэйусаже                         |
| Размер              | \-                                          |
