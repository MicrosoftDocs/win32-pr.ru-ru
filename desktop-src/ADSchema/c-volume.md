...
| [**Индексация содержимого — разрешено**](a-contentindexingallowed.md)              | Нет     | **Громкость**                                                                               |
...
| [**Последний — индексируемый по содержимому**](a-lastcontentindexed.md)                      | Нет     | **Громкость**                                                                               |
...
| [**UNC-имя**](a-uncname.md)                                             | Верно      | **Громкость**                                                                               |
