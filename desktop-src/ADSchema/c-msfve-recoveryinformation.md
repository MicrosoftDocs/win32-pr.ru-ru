...
ms.locfileid: "118175812"
---
# <a name="ms-fve-recoveryinformation-class"></a>класс MS-ФВЕ-Рековеринформатион

Этот класс содержит полный пароль восстановления шифрования тома со связанным идентификатором GUID.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-ФВЕ-Рековеринформатион           |
| LDAP-отображаемое имя | Мсфве — Рековеринформатион            |
...
| [**MS-ФВЕ-Кэйпаккаже**](a-msfve-keypackage.md)                                | Неверно     | **MS-ФВЕ-Рековеринформатион**  |
| [**MS-ФВЕ-Рековеригуид**](a-msfve-recoveryguid.md)                            | True      | **MS-ФВЕ-Рековеринформатион**  |
| [**MS-ФВЕ-Рековерипассворд**](a-msfve-recoverypassword.md)                    | True      | **MS-ФВЕ-Рековеринформатион**  |
| [**MS-ФВЕ-VolumeGuid**](a-msfve-volumeguid.md)                                | Неверно     | **MS-ФВЕ-Рековеринформатион**  |
