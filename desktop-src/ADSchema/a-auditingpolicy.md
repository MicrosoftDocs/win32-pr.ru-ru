...
ms.locfileid: "119022812"
---
# <a name="auditing-policy-attribute"></a>Атрибут Auditing-Policy

Политика аудита для локальной политики.
...
|-------------------|-------------------------------------------------------|
| CN                | Auditing-Policy                                       |
| LDAP-отображаемое имя | аудитингполици                                        |
| Размер              | \-                                                    |
