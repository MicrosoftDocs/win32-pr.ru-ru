...
---
# <a name="ms-sql-sqlrepository-class"></a>Класс MS-SQL-Склрепоситори

Класс для хранения свойств репозитория SQL Server.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-SQL-Склрепоситори                 |
| LDAP-отображаемое имя | mS-SQL-Склрепоситори                 |
...
| [**MS-SQL-Build**](a-ms-sql-build.md)                                    | Неверно     | **MS-SQL-Склрепоситори**        |
| [**Контакт MS-SQL**](a-ms-sql-contact.md)                                | Неверно     | **MS-SQL-Склрепоситори**        |
| [**MS-SQL — описание**](a-ms-sql-description.md)                        | Неверно     | **MS-SQL-Склрепоситори**        |
| [**MS-SQL-Информатиондиректори**](a-ms-sql-informationdirectory.md)      | Неверно     | **MS-SQL-Склрепоситори**        |
| [**Имя MS-SQL**](a-ms-sql-name.md)                                      | Неверно     | **MS-SQL-Склрепоситори**        |
| [**MS-SQL-состояние**](a-ms-sql-status.md)                                  | Неверно     | **MS-SQL-Склрепоситори**        |
| [**MS-SQL-версия**](a-ms-sql-version.md)                                | Неверно     | **MS-SQL-Склрепоситори**        |
