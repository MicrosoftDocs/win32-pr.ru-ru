...
ms.locfileid: "120065692"
---
# <a name="print-mac-address-attribute"></a>Атрибут print-MAC-Address

Указанный пользователем MAC-адрес.
...
| LDAP-отображаемое имя | printMACAddress                             |
| Размер              | \-                                          |
