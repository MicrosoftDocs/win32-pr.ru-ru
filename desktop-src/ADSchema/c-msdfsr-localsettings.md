...
ms.locfileid: "120065364"
---
# <a name="ms-dfsr-localsettings-class"></a>класс MS-DFSR-LocalSettings

Содержит параметры службы репликации распределенная файловая система (DFS), применимые к локальному компьютеру.
...
| LDAP-отображаемое имя | Мсдфср — LocalSettings                 |
...
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                             | Неверно     | **MS-DFSR-LocalSettings**       |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                     | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)             | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                 | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Version**](a-msdfsr-version.md)                                 | Неверно     | **MS-DFSR-LocalSettings**       |
...
| [**MS-COM-Партитионсетлинк**](a-mscom-partitionsetlink.md)                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-COM-Усерлинк**](a-mscom-userlink.md)                                               | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Коммонстагингпас**](a-msdfsr-commonstagingpath.md)                           | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Коммонстагингсизеинмб**](a-msdfsr-commonstagingsizeinmb.md)                   | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Компутерреференцебл**](a-msdfsr-computerreferencebl.md)                       | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-Extension**](a-msdfsr-extension.md)                                           | Неверно     | **MS-DFSR-LocalSettings**       |
| [**Флаги MS-DFSR-**](a-msdfsr-flags.md)                                                   | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Мемберреференцебл**](a-msdfsr-memberreferencebl.md)                           | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DFSR-параметры**](a-msdfsr-options.md)                                               | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                             | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Стагингклеануптригжеринперцент**](a-msdfsr-stagingcleanuptriggerinpercent.md) | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DFSR-Version**](a-msdfsr-version.md)                                               | Неверно     | **MS-DFSR-LocalSettings**       |
| [**MS-DS-примерно-Иммед-подчиненные**](a-msds-approx-immed-subordinates.md)               | Неверно     | [**Вверх**](c-top.md)<br/> |
...
Класс **MS-DFSR-LocalSettings** является частью поддержки службы репликация DFS.
