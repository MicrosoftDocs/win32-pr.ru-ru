...
---
# <a name="ms-ds-tasks-for-az-task-attribute"></a>Атрибут ms-DS-Tasks-for-AZ-Task

Список задач, связанных с AZ-Task.
...
| LDAP-отображаемое имя | msDS-Тасксфоразтаск                     |
| Размер              | \-                                      |
