...
ms.locfileid: "119922744"
---
# <a name="file-link-tracking-class"></a>Класс отслеживания файловых ссылок

Контейнер для объектов-записей отслеживания ссылок на файлы.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Отслеживание ссылок на файлы                   |
| LDAP-отображаемое имя | филелинктраккинг                     |
