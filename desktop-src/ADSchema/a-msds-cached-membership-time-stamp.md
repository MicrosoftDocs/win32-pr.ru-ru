...
Атрибут " **MS-DS-Cache-Time-меткой** " используется диспетчером учетных записей безопасности для расширения группы во время оценки маркера.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Метка времени членства MS-DS-Cache-Membership   |
| LDAP-отображаемое имя | msDS — метка времени членства в кэше    |
| Размер              | 8 байт                              |
