...
ms.locfileid: "119301854"
---
# <a name="local-policy-flags-attribute"></a>Атрибут локальной политики — флаги

Флаги, определяющие, где компьютер получает политику. Локальная политика — ссылка.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Локальные-политика — флаги                   |
| LDAP-отображаемое имя | локалполицифлагс                     |
| Размер              | \-                                   |
