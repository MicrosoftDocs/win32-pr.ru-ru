...
ms.locfileid: "118960523"
---
# <a name="msmq-journal-quota-attribute"></a>Атрибут квоты MSMQ-Journal

Квота сообщений журнала MSMQ для компьютера.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Очередь MSMQ — журнал — квота                   |
| LDAP-отображаемое имя | мсмкжаурналкуота                     |
| Размер              | \-                                   |
