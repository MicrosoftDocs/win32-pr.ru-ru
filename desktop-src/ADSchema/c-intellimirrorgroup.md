...
ms.locfileid: "118680913"
---
# <a name="intellimirror-group-class"></a>Класс Intellimirror-Group

Удаленная загрузочная версия для управления группами серверных компьютеров. В настоящий момент не используется.
...
| LDAP-отображаемое имя | интеллимиррорграуп                   |
...
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; ККДК;;; CO) (A;; РПЛКЛОРК;;; СЛУЖБЫ           |
