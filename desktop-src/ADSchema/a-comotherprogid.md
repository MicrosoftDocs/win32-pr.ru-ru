...
ms.locfileid: "119509594"
---
# <a name="com-other-prog-id-attribute"></a>Атрибут COM-other-Prog-ID

Список других строк идентификатора программы для класса Host.
...
| LDAP-отображаемое имя | комосерпрогид                              |
| Размер              | \-                                          |
