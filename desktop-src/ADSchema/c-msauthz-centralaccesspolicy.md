...
| [**MS-authz-Центральный-Access — Policy-ID**](a-msauthz-centralaccesspolicyid.md)                         | Нет     | **MS-authz-Центральная-Access — политика** |
| [**MS-authz-член-правила — в-центральном доступе — политика**](a-msauthz-memberrulesincentralaccesspolicy.md) | Нет     | **MS-authz-Центральная-Access — политика** |
