...
---
# <a name="inter-site-transport-container-class"></a>Межсайтовый транспорт-класс контейнера

Содержит объекты транспорта между сайтами.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Межсайтовый транспорт — контейнер       |
| LDAP-отображаемое имя | интерситетранспортконтаинер          |
