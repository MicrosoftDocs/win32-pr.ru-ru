...
| [**Отображаемое имя**](a-displayname.md)                                     | True      | **Адресная книга — контейнер** [ **сверху**](c-top.md)<br/> |
...
| [**В процессе поиска**](a-purportedsearch.md)                             | Неверно     | **Адресная книга-контейнер**                                 |
