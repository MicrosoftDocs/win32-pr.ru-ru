...
---
# <a name="ms-net-ieee-8023-gp-policyreserved-attribute"></a>атрибут MS-NET-IEEE-8023-GP-Полициресервед
...
| Ввод | Значение |
|-------------------|-------------------------------------------------------|
| CN                | MS-NET-IEEE-8023-GP-Полициресервед                    |
| LDAP-отображаемое имя | MS-NET-IEEE-8023-GP-Полициресервед                    |
| Размер              | \-                                                    |
...
| Классы, используемые в        | [**MS-NET-IEEE-8023-GroupPolicy**](c-ms-net-ieee-8023-grouppolicy.md)<br/> |
