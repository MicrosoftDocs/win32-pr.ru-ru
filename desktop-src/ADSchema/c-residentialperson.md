...
Используется для определения записей, представляющих человека в среде в жилых помещениях.
...
| LDAP-отображаемое имя | ресидентиалперсон                    |
...
| [**Факс-телефон — номер**](a-facsimiletelephonenumber.md)          | Неверно     | **Частный пользователь**                                                |
...
| [**Локальное имя**](a-l.md)                                              | Неверно     | **Частный пользователь**                                                |
...
| [**Зарегистрированный адрес**](a-registeredaddress.md)                         | Неверно     | **Частный пользователь**                                                |
...
| [**State-или-провинция-Name**](a-st.md)                                    | Неверно     | **Частный пользователь**                                                |
| [**Улица-адрес**](a-street.md)                                        | Неверно     | **Частный пользователь**                                                |
...
| [**X121 — адрес**](a-x121address.md)                                     | Неверно     | **Частный пользователь**                                                |
...
| RDN-Атри-ID                  | [**Common-Name**](a-cn.md)<br/>                                                       |
| Подкласс                 | [**Человек**](c-person.md)<br/>                                                        |
| Возможные старшие          | [](c-container.md)[**Локальность** контейнера](c-locality.md)                               |
| Вспомогательные классы           | \-                                                                                           |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                 |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПЛКЛОРК;;; СЛУЖБЫ |
| System-Flags                | 0x00000010                                                                                   |
