...
---
# <a name="netboot-sif-file-attribute"></a>Нетбут-SIF-атрибут файла

Атрибут **нетбут-SIF-File** зарезервирован для внутреннего использования.
...
|-------------------|---------------------------------------------|
| CN                | Нетбут-SIF-файл                            |
| LDAP-отображаемое имя | нетбутсиффиле                              |
| Размер              | \-                                          |
