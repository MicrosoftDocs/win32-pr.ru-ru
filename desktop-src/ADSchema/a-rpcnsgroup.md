...
ms.locfileid: "119646554"
---
# <a name="rpc-ns-group-attribute"></a>атрибут RPC-NS-Group

Ссылка на запись сервера RPC или другую группу RPC.
...
|-------------------|---------------------------------------------|
| CN                | RPC-NS-Group                                |
| LDAP-отображаемое имя | рпкнсграуп                                  |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**RPC — группа**](c-rpcgroup.md)<br/> |
