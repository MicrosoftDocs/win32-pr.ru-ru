...
---
# <a name="rpc-profile-element-class"></a>RPC-Profile-элемент класса

Содержит запись в профиле RPC.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | RPC-Profile-элемент                  |
| LDAP-отображаемое имя | рпкпрофилилемент                    |
...
| Подкласс                 | [**Запись RPC**](c-rpcentry.md)<br/>                                                   |
| Возможные старшие          | [**RPC — профиль**](c-rpcprofile.md)                                                          |
...
| [**RPC-NS-Аннотация**](a-rpcnsannotation.md)                            | Неверно     | **RPC-Profile-элемент**                                                                  |
| [**RPC-NS-Interface-ID**](a-rpcnsinterfaceid.md)                         | True      | **RPC-Profile-элемент**                                                                  |
| [**RPC-NS-Priority**](a-rpcnspriority.md)                                | True      | **RPC-Profile-элемент**                                                                  |
| [**RPC-NS-Profile-запись**](a-rpcnsprofileentry.md)                       | Неверно     | **RPC-Profile-элемент**                                                                  |
