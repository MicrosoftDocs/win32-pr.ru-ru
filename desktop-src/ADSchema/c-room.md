...
ms.locfileid: "119752794"
---
# <a name="room-class"></a>класс комнаты

Класс объекта Room используется для определения записей, представляющих комнаты.
...
| [**Common-Name**](a-cn.md)                                                 | Верно      |  в [ **Начало** комнаты](c-top.md)<br/> |
| [**Метка времени создания**](a-createtimestamp.md)                              | Неверно     | [**Вверх**](c-top.md)<br/>          |
| [**Описание**](a-description.md)                                        | Неверно     |  в [ **Начало** комнаты](c-top.md)<br/> |
...
| [**Расположение**](a-location.md)                                              | Неверно     | **комната**                                 |
...
| [**roomNumber**](a-roomnumber.md)                                          | Неверно     | **комната**                                 |
| [**SD-Rights-эффективен**](a-sdrightseffective.md)                          | Неверно     | [**Вверх**](c-top.md)<br/>          |
| [**См. также**](a-seealso.md)                                               | Неверно     | **комната**                                 |
...
| [**Номер телефона**](a-telephonenumber.md)                               | Неверно     | **комната**                                 |
