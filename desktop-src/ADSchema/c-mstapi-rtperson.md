...
ms.locfileid: "119879384"
---
# <a name="ms-tapi-rt-person-class"></a>класс MS-TAPI-RT-Person

Используется для отображения пользователя с IP-адресом компьютера, на который пользователь выполнил вход для многоадресных конференций TAPI.
...
| LDAP-отображаемое имя | Мстапи — Ртперсон                                                                   |
| Привилегия обновления  | Специальные привилегии не требуются.                                                   |
| Частота обновления  | Каждый раз при запуске клиента TAPI после регистрации в каталоге TAPI. |
...
| Возможные старшие          | [](c-organizationalunit.md)[**Организация** подразделения](c-organization.md)    |
...
| [**MS-TAPI-IP-Address**](a-mstapi-ipaddress.md)                            | Неверно     | **MS-TAPI-RT-Person**           |
| [**MS-TAPI-unique-identifier**](a-mstapi-uid.md)                           | Неверно     | **MS-TAPI-RT-Person**           |
