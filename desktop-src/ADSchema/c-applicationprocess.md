...
| [**Common-Name**](a-cn.md)                                               | True      | **Приложение — процесс** [ **сверху**](c-top.md)<br/> |
...
| [**Локальное имя**](a-l.md)                                              | Неверно     | **Процесс приложения**                                 |
...
| [**Организация — имя подразделения**](a-ou.md)                                  | Неверно     | **Процесс приложения**                                 |
...
| [**См. также**](a-seealso.md)                                             | Неверно     | **Процесс приложения**                                 |
