...
---
# <a name="ms-sql-olapdatabase-class"></a>Класс MS-SQL-Олапдатабасе

Контейнер для хранения объектов [**MS-SQL-олапкубе**](c-ms-sql-olapcube.md) .



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-SQL-Олапдатабасе                  |
| LDAP-отображаемое имя | mS-SQL-Олапдатабасе                  |
...
| Возможные старшие          | [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)                                             |
...
| [**MS-SQL — приложения**](a-ms-sql-applications.md)                      | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-ConnectionURL**](a-ms-sql-connectionurl.md)                    | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**Контакт MS-SQL**](a-ms-sql-contact.md)                                | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL — описание**](a-ms-sql-description.md)                        | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-Информатионурл**](a-ms-sql-informationurl.md)                  | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL — ключевые слова**](a-ms-sql-keywords.md)                              | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-Ластбаккупдате**](a-ms-sql-lastbackupdate.md)                  | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-Ластупдатеддате**](a-ms-sql-lastupdateddate.md)                | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**Имя MS-SQL**](a-ms-sql-name.md)                                      | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-Публикатионурл**](a-ms-sql-publicationurl.md)                  | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-Размер**](a-ms-sql-size.md)                                      | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**MS-SQL-состояние**](a-ms-sql-status.md)                                  | Неверно     | **MS-SQL-Олапдатабасе**         |
| [**Тип MS-SQL**](a-ms-sql-type.md)                                      | Неверно     | **MS-SQL-Олапдатабасе**         |
