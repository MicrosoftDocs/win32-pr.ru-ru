...
---
# <a name="ms-sql-gpslongitude-attribute"></a>Атрибут MS-SQL-Гпслонгитуде

Атрибут **MS-SQL-гпслонгитуде** в настоящее время не используется.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-SQL-Гпслонгитуде                         |
| LDAP-отображаемое имя | mS-SQL-Гпслонгитуде                         |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)<br/> |
