...
ms.locfileid: "119022672"
---
# <a name="ca-certificate-dn-attribute"></a>CA — атрибут Certificate-DN

Полное различающееся имя из сертификата ЦС.
...
| LDAP-отображаемое имя | кацертификатедн                             |
| Размер              | \-                                          |
