...
ms.locfileid: "120050044"
---
# <a name="dhcp-properties-attribute"></a>атрибут свойств DHCP

Атрибут **DHCP-Properties** в настоящее время не используется.
...
|-------------------|-------------------------------------------------------|
| CN                | Свойства DHCP                                       |
| LDAP-отображаемое имя | дхкппропертиес                                        |
| Размер              | \-                                                    |
