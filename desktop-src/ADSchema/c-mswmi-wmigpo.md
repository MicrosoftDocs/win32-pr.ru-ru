...
ms.locfileid: "119753634"
---
# <a name="ms-wmi-wmigpo-class"></a>класс MS-WMI-ВМИГПО

Это значение записывается в Active Directory пути, на который указывает соответствующий объект групповая политика. Он предназначен для объединения различных объектов, используемых для выражения расширений WMI, в инфраструктуру групповая политика.
...
|-------------------|--------------------------------------|
| CN                | MS-WMI-ВМИГПО                        |
| LDAP-отображаемое имя | Мсвми — ВМИГПО                         |
...
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Неверно     | **MS-WMI-ВМИГПО**               |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Верно      | **MS-WMI-ВМИГПО**               |
