...
---
# <a name="link-track-volume-table-class"></a>Link-Track-класс тома-таблица

Контейнер для объектов с ссылками на объект Vol.



| Ввод | Значение |
|-------------------|---------------------------------------|
| CN                | Link-Tracking-Volume-Table               |
| LDAP-отображаемое имя | линктраккволуметабле                  |
...
| Подкласс                 | [**Отслеживание ссылок на файлы**](c-filelinktracking.md)<br/>                                  |
| Возможные старшие          | [**Отслеживание ссылок на файлы**](c-filelinktracking.md)                                             |
