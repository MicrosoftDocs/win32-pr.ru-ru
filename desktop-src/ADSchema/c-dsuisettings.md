...
---
# <a name="ds-ui-settings-class"></a>Класс параметров DS-UI

Используется для хранения параметров конфигурации, используемых оснасткой «Active Directory пользователи и компьютеры».
...
|-------------------|--------------------------------------|
| CN                | DS-UI-параметры                       |
| LDAP-отображаемое имя | дсуисеттингс                         |
...
| [**DS-UI-Admin — максимум**](a-dsuiadminmaximum.md)                         | Неверно     | **DS-UI-параметры**              |
| [**DS-UI-Admin — уведомление**](a-dsuiadminnotification.md)               | Неверно     | **DS-UI-параметры**              |
| [**DS-UI-Shell-максимум**](a-dsuishellmaximum.md)                         | Неверно     | **DS-UI-параметры**              |
...
| [**MS-DS-целостность-дочерняя — количество**](a-ms-ds-consistencychildcount.md)                    | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Consistencу-Guid**](a-ms-ds-consistencyguid.md)                                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**MS-DS-Filter-Containers**](a-msds-filtercontainers.md)                                | Неверно     | **DS-UI-параметры**              |
...
| [**MS-DS-non-Security-Group-classes — классы**](a-msds-non-security-group-extra-classes.md) | Неверно     | **DS-UI-параметры**              |
...
| [**MS-DS-Security-Group-дополнительные классы**](a-msds-security-group-extra-classes.md)         | Неверно     | **DS-UI-параметры**              |
