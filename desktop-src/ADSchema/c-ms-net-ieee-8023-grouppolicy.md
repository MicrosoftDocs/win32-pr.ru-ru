...
ms.locfileid: "118680892"
---
# <a name="ms-net-ieee-8023-grouppolicy-class"></a>класс MS-NET-IEEE-8023-GroupPolicy

Этот класс представляет объект групповая политика проводной сети 802,3. Этот класс содержит идентификаторы и данные конфигурации, относящиеся к проводной сети 802,3.
...
| LDAP-отображаемое имя | MS-NET-IEEE-8023-GroupPolicy         |
...
| [**MS-NET-IEEE-8023-GP-Полицидата**](a-ms-net-ieee-8023-gp-policydata.md)         | Неверно     | **MS-NET-IEEE-8023-GroupPolicy** |
| [**MS-NET-IEEE-8023-GP-Полицигуид**](a-ms-net-ieee-8023-gp-policyguid.md)         | Неверно     | **MS-NET-IEEE-8023-GroupPolicy** |
| [**MS-NET-IEEE-8023-GP-Полициресервед**](a-ms-net-ieee-8023-gp-policyreserved.md) | Неверно     | **MS-NET-IEEE-8023-GroupPolicy** |
