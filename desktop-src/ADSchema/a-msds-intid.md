...
ms.locfileid: "119804063"
---
# <a name="ms-ds-intid-attribute"></a>Атрибут ms-DS-Интид

Атрибут **MS-DS-интид** предназначен только для внутреннего использования.
...
|-------------------|--------------------------------------|
| CN                | MS-DS-Интид                          |
| LDAP-отображаемое имя | msDS-Интид                           |
| Размер              | \-                                   |
...
| Классы, используемые в        | [**Attribute-Schema**](c-attributeschema.md)<br/> [**Class-schema**](c-classschema.md)<br/> [**дмд**](c-dmd.md)<br/> |
