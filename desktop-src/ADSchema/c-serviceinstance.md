...
Объект точки подключения, используемый службой имен регистрации и разрешения Windows Sockets (РНР), доступ к которому осуществляется через API-интерфейсы Windows Sockets WSA \* .
...
| [**Отображаемое имя**](a-displayname.md)                                     | True      | **Служба-экземпляр —** [ **Начало**](c-top.md)<br/>                                     |
...
| [**Service-Class-ID**](a-serviceclassid.md)                              | True      | **Экземпляр службы**                                                                     |
