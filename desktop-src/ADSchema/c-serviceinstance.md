...
description: объект точки подключения, используемый службой имен регистрации и разрешения Windows сокетов (рнр), доступ к которой осуществляется с помощью Windows сокетов WSA \ api.
...
ms.locfileid: "118959533"
---
# <a name="service-instance-class"></a>Класс Service-Instance

объект точки подключения, используемый службой имен регистрации и разрешения Windows сокетов (рнр), доступ к которым можно получить с помощью api-интерфейсов Windows сокетов WSA \* .
...
|-------------------|--------------------------------------|
| CN                | Service-Instance                     |
| LDAP-отображаемое имя | serviceInstance                      |
...
| [**Отображаемое имя**](a-displayname.md)                                     | Верно      | **Служба-экземпляр —** [ **Начало**](c-top.md)<br/>                                     |
...
| [**Service-Class-ID**](a-serviceclassid.md)                              | Верно      | **Экземпляр службы**                                                                     |
| [**Версия-экземпляра службы**](a-serviceinstanceversion.md)              | Неверно     | **Экземпляр службы**                                                                     |
...
| [**Winsock — адреса**](a-winsockaddresses.md)                           | Неверно     | **Экземпляр службы**                                                                     |
