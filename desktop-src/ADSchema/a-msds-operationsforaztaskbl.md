...
Обратная ссылка с Az-Operation на Az-Task объекты, которые связываются с ним.
...
| LDAP-отображаемое имя | msDS-Оператионсфоразтаскбл              |
| Size              | \-                                      |
...
| Классы, используемые в        | [**Начало**](c-top.md)<br/> |
