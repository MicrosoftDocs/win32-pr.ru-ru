...
---
# <a name="ms-sql-thirdparty-attribute"></a>Атрибут MS-SQL-сторонних

Этот атрибут указывает, относится ли данные публикации к источнику данных, отличному от SQL Server. Если это из другого источника, то ему присваивается значение **true**.
...
|-------------------|--------------------------------------|
| CN                | MS-SQL-сторонних                    |
| LDAP-отображаемое имя | mS-SQL-сторонних                    |
| Размер              | 4 байта                              |
