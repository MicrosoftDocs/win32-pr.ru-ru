...
---
# <a name="service-administration-point-class"></a>Класс точки администрирования службы

Содержит сведения о привязке для подключения к службе для ее администрирования.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Служба — Администрирование — точка         |
| LDAP-отображаемое имя | сервицеадминистратионпоинт           |
