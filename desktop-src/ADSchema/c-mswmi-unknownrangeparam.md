...
ms.locfileid: "119753623"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>класс MS-WMI-Ункновнранжепарам

Поддерживает типы параметров, о которых ничего не знает, поэтому они передаются как скомпилированные объекты WMI.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Ункновнранжепарам             |
| LDAP-отображаемое имя | Мсвми — Ункновнранжепарам              |
...
| [**MS-WMI-Нормализедкласс**](a-mswmi-normalizedclass.md)                   | Верно      | **MS-WMI-Ункновнранжепарам**                               |
...
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Верно      | **MS-WMI-Ункновнранжепарам**                               |
