...
ms.locfileid: "119837074"
---
# <a name="rpc-ns-interface-id-attribute"></a>атрибут RPC-NS-Interface-ID

Идентификатор интерфейса, поддерживаемый данным сервером.
...
| LDAP-отображаемое имя | рпкнсинтерфацеид                            |
| Размер              | \-                                          |
...
| Классы, используемые в        | [**RPC-Profile-элемент**](c-rpcprofileelement.md)<br/> [**RPC-Server-Element**](c-rpcserverelement.md)<br/> |
