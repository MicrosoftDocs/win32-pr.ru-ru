...
---
# <a name="auxiliary-class-attribute"></a>Атрибут Auxiliary-Class

Список вспомогательных классов, которые будут связаны с этим классом.
...
|-------------------|-----------------------------------------------------------------|
| CN                | Auxiliary-Class                                                 |
| LDAP-отображаемое имя | auxiliaryClass                                                  |
| Размер              | \-                                                              |
