...
---
# <a name="meetingmaxparticipants-attribute"></a>атрибут МитингмакспартиЦипантс

Максимальное количество участников собрания.



| Ввод | Значение |
|-------------------|----------------------------------------------------------------------------------|
| CN                | митингмакспартиЦипантс                                                           |
| LDAP-отображаемое имя | митингмакспартиЦипантс                                                           |
| Размер              | \-                                                                               |
