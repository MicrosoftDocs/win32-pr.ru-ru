...
---
# <a name="msmq-configuration-class"></a>Класс MSMQ-Configuration

Этот объект содержит параметры конфигурации MSMQ для определенного компьютера. Атрибуты этого класса относятся к MSMQ и используются для принятия решений о маршрутизации MSMQ.
...
| LDAP-отображаемое имя | мсмкконфигуратион                                                                                     |
| Привилегия обновления  | Владелец очереди.                                                                                      |
| Частота обновления  | Экземпляр этого класса создается на каждом компьютере, который устанавливает MSMQ, в объекте Computer. |
...
| [**MSMQ-Computer-Type**](a-msmqcomputertype.md)                          | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Computer-Type-ex**](a-msmqcomputertypeex.md)                     | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Dependent-Client-Services**](a-msmqdependentclientservices.md)   | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-DS-Services**](a-msmqdsservices.md)                              | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Encrypt-Key**](a-msmqencryptkey.md)                              | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ — инородный**](a-msmqforeign.md)                                     | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-in-Routing-серверы**](a-msmqinroutingservers.md)                 | Неверно     | **Конфигурация MSMQ**          |
| [**Очередь MSMQ — журнал — квота**](a-msmqjournalquota.md)                          | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-OS — тип**](a-msmqostype.md)                                      | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-out-Routing-Servers**](a-msmqoutroutingservers.md)               | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Owner-ID**](a-msmqownerid.md)                                    | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ — квота**](a-msmqquota.md)                                         | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Routing-Services**](a-msmqroutingservices.md)                    | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Service-Type**](a-msmqservicetype.md)                            | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ-Sign-ключ**](a-msmqsignkey.md)                                    | Неверно     | **Конфигурация MSMQ**          |
| [**MSMQ — сайты**](a-msmqsites.md)                                         | Неверно     | **Конфигурация MSMQ**          |
