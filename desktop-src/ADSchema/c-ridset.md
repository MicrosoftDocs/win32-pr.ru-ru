...
| [**RID-распределение — пул**](a-ridallocationpool.md)                        | True      | **RID-Set**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                      | True      | **RID-Set**                     |
| [**RID — предыдущий пул выделения ресурсов**](a-ridpreviousallocationpool.md)       | True      | **RID-Set**                     |
| [**RID — используется для пула**](a-ridusedpool.md)                                    | True      | **RID-Set**                     |
