...
ms.locfileid: "118959552"
---
# <a name="rid-set-class"></a>Класс RID-Set

Для каждого контроллера домена существует один из них. Он содержит пулы RID, выделенные контроллером домена.
...
| Возможные старшие          | [](c-computer.md)[](c-container.md)[**Пользователь**](c-user.md) контейнера компьютера         |
...
| [**RID-распределение — пул**](a-ridallocationpool.md)                        | Верно      | **RID-Set**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                      | Верно      | **RID-Set**                     |
| [**RID — предыдущий пул выделения ресурсов**](a-ridpreviousallocationpool.md)       | Верно      | **RID-Set**                     |
| [**RID — используется для пула**](a-ridusedpool.md)                                    | Верно      | **RID-Set**                     |
