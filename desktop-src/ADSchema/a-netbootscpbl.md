...
---
# <a name="netboot-scp-bl-attribute"></a>атрибут нетбут-SCP-BL

Список точек подключения службы, которые ссылаются на этот сервер Нетбут.
...
|-------------------|-----------------------------------------|
| CN                | нетбут-SCP-BL                          |
| LDAP-отображаемое имя | нетбутскпбл                            |
| Размер              | \-                                      |
