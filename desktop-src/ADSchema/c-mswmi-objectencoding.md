...
ms.locfileid: "119440294"
---
# <a name="ms-wmi-objectencoding-class"></a>класс MS-WMI-Обжектенкодинг

Содержит данные кодировки для класса или объекта экземпляра WMI, а также дополнительные сведения об объекте.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Обжектенкодинг                |
| LDAP-отображаемое имя | Мсвми — Обжектенкодинг                 |
...
| [**Класс MS-WMI-**](a-mswmi-class.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Женус**](a-mswmi-genus.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-ID**](a-mswmi-id.md)                                             | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-Скопегуид**](a-mswmi-scopeguid.md)                               | True      | **MS-WMI-Обжектенкодинг**       |
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | True      | **MS-WMI-Обжектенкодинг**       |
