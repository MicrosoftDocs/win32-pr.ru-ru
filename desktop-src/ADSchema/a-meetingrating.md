...
ms.locfileid: "119300654"
---
# <a name="meetingrating-attribute"></a>атрибут Митингратинг

Платформа для оценки выбора содержимого Интернета для собрания.
...
|-------------------|---------------------------------------------|
| CN                | митингратинг                               |
| LDAP-отображаемое имя | митингратинг                               |
| Размер              | \-                                          |
