...
ms.locfileid: "119753621"
---
# <a name="ms-wmi-simplepolicytemplate-class"></a>класс MS-WMI-Симплеполицитемплате

Предоставляет тип шаблона, который не может быть объединен. Используется в случаях, когда целевой объект не предназначен для объединения (слияния).



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | MS-WMI-Симплеполицитемплате          |
| LDAP-отображаемое имя | Мсвми — Симплеполицитемплате           |
...
| Подкласс                 | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/>                                 |
| Возможные старшие          | [**Контейнер**](c-container.md)                                                                   |
| Вспомогательные классы           | \-                                                                                                 |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                       |
| Дескриптор безопасности по умолчанию | D: (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПККДКЛКЛОДТРК;;; СЛУЖБЫ |
...
| [**MS-WMI-Author**](a-mswmi-author.md)                                     | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-ChangeDate**](a-mswmi-changedate.md)                             | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-ID**](a-mswmi-id.md)                                             | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Name**](a-mswmi-name.md)                                         | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Нормализедкласс**](a-mswmi-normalizedclass.md)                   | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Parm1**](a-mswmi-parm1.md)                                       | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-Саурцеорганизатион**](a-mswmi-sourceorganization.md)             | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-TargetNameSpace**](a-mswmi-targetnamespace.md)                   | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Верно      | **MS-WMI-Симплеполицитемплате**                                    |
| [**MS-WMI-TargetPath**](a-mswmi-targetpath.md)                             | Верно      | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | Неверно     | [**MS-WMI-PolicyTemplate**](c-mswmi-policytemplate.md)<br/> |
