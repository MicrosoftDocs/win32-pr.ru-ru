...
ms.locfileid: "118959763"
---
# <a name="ntfrs-subscriptions-class"></a>Класс NTFRS-Subscriptions

Содержит набор подписок на набор реплик.
...
| LDAP-отображаемое имя | нтфрссубскриптионс                   |
...
| Возможные старшие          | **NTFRS —**[](c-computer.md)[**пользователь**](c-user.md) компьютера с подписками                                                      |
| Вспомогательные классы           | \-                                                                                                                               |
| NT-Security-дескриптор      | О:БАГ: BAD: S:                                                                                                                     |
| Дескриптор безопасности по умолчанию | D: (A;; РПЛКЛОРК;;; AU) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;;D А) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; SY) (A;; РПВПКРККДКЛКЛОРКВОВДСДДТСВ;;; СОСТАВ |
...
| [**Расширения FRS**](a-frsextensions.md)                                 | Неверно     | **NTFRS-Subscriptions**         |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                 | Неверно     | [**Вверх**](c-top.md)<br/> |
| [**Версия FRS**](a-frsversion.md)                                       | Неверно     | **NTFRS-Subscriptions**         |
| [**FRS-Working-Path**](a-frsworkingpath.md)                              | Неверно     | **NTFRS-Subscriptions**         |
