...
ms.locfileid: "117837240"
---
# <a name="ms-wmi-parm2-attribute"></a>атрибут MS-WMI-Parm2

Атрибут **MS-WMI-Parm2** зарезервирован для внутреннего использования.
...
|-------------------|---------------------------------------------|
| CN                | MS-WMI-Parm2                                |
| LDAP-отображаемое имя | Мсвми — Parm2                                 |
| Размер              | \-                                          |
