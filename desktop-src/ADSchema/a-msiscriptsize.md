...
---
# <a name="msi-script-size-attribute"></a>Атрибут размера MSI-скрипта

Размер файла скрипта установщика Microsoft для этого приложения.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Размер MSI-скрипта                      |
| LDAP-отображаемое имя | мсискриптсизе                        |
| Размер              | \-                                   |
