...
---
# <a name="ms-dfs-namespace-v2-class"></a>класс MS-DFS-Namespace-v2
...
| LDAP-отображаемое имя | Мсдфс — Namespacev2                    |
...
| Возможные старшие          | [**закрепление MS-DFS-Namespace**](c-msdfs-namespaceanchor.md)                                   |
...
| [**MS-DFS-Comment-v2**](a-msdfs-commentv2.md)                                 | Неверно     | **MS-DFS-Namespace-v2**         |
...
| [**MS-DFS-Schema-Minor — версия**](a-msdfs-schemaminorversion.md)              | True      | **MS-DFS-Namespace-v2**         |
