...
| [**Список уведомлений**](a-notificationlist.md)                           | Нет     | [**приложение — сайт — Параметры**](c-applicationsitesettings.md)<br/> |
...
| [**Сайт-сервер**](a-siteserver.md)                                       | Нет     | **лицензирование — сайт — Параметры**                                               |
