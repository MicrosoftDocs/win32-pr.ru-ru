...
ms.locfileid: "119021872"
---
# <a name="com-connection-point-class"></a>Класс точки подключения COM

Привязка для запуска службы COM/DCOM.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Точка подключения COM                 |
| LDAP-отображаемое имя | комконнектионпоинт                   |
...
| [**Common-Name**](a-cn.md)                                               | Верно      |  [ **Точка подключения** com-точки подключения](c-connectionpoint.md)<br/> [**Вверх**](c-top.md)<br/> |
...
| [**Упакованный интерфейс**](a-marshalledinterface.md)                     | Неверно     | **Точка подключения COM**                                                                                          |
...
| [**Помощи**](a-moniker.md)                                              | Неверно     | **Точка подключения COM**                                                                                          |
| [**Моникер — отображаемое имя**](a-monikerdisplayname.md)                      | Неверно     | **Точка подключения COM**                                                                                          |
