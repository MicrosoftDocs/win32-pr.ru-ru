...
ms.locfileid: "119643194"
---
# <a name="ms-com-partition-class"></a>класс MS-COM-Partition

Пространство имен, используемое COM+ для разрешения существования нескольких версий одного и того же приложения COM+ на одном физическом компьютере.



| Ввод | Значение |
|-------------------|--------------------------------------|
| CN                | Раздел MS-COM-Partition                     |
...
| [**MS-COM-ObjectId**](a-mscom-objectid.md)                                 | Нет     | **Раздел MS-COM-Partition**            |
