...
ms.locfileid: "118960193"
---
# <a name="ms-ts-endpoint-data-attribute"></a>MS-TS-Endpoint-атрибут данных

Этот атрибут представляет имя виртуальной машины для компьютера в развертывании TSV.



| Ввод | Значение |
|-------------------|---------------------------------------------|
| CN                | MS-TS-Endpoint-данные                         |
| LDAP-отображаемое имя | мстсендпоинтдата                            |
| Размер              | \-                                          |
