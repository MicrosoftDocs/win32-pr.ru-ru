---
title: Создание политики запросов на подключение
description: Создание политики запросов на подключение
...
ms.locfileid: "104134519"
---
# <a name="creating-a-connection-request-policy"></a><span data-ttu-id="c6045-103">Создание политики запросов на подключение</span><span class="sxs-lookup"><span data-stu-id="c6045-103">Creating a Connection Request Policy</span></span>

<span data-ttu-id="c6045-104">Следующий Visual Basic код создает политику запросов на подключение.</span><span class="sxs-lookup"><span data-stu-id="c6045-104">The following Visual Basic code creates a connection request policy.</span></span> <span data-ttu-id="c6045-105">Он добавляет условие в политику, соответствующее имени пользователя, запросившего доступ.</span><span class="sxs-lookup"><span data-stu-id="c6045-105">It adds a condition to the policy that matches on the name of the user requesting access.</span></span> <span data-ttu-id="c6045-106">Она связывает политику с профилем.</span><span class="sxs-lookup"><span data-stu-id="c6045-106">It links the policy to a profile.</span></span> <span data-ttu-id="c6045-107">Он настраивает этот профиль для использования RADIUS как для проверки подлинности, так и для учета, а также для указания групп серверов, которые профиль должен использовать для проверки подлинности и учета.</span><span class="sxs-lookup"><span data-stu-id="c6045-107">It configures that profile to use RADIUS for both authentication and accounting, and specifies the server groups that the profile should use for authentication and accounting.</span></span>

> [!Note]  
> <span data-ttu-id="c6045-108">Этот пример встроенного кода основан на управляемых Visual Basic.</span><span class="sxs-lookup"><span data-stu-id="c6045-108">This in-line code sample has been built on managed Visual Basic.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="c6045-109">См. также</span><span class="sxs-lookup"><span data-stu-id="c6045-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="c6045-110">Порядок использования API SDO</span><span class="sxs-lookup"><span data-stu-id="c6045-110">Order in Which to Use the SDO API</span></span>](/windows/desktop/Nps/sdo-order-in-which-to-use-the-sdo-api)
</dt> <dt>

[<span data-ttu-id="c6045-111">Поддерживаемые в SDO атрибуты</span><span class="sxs-lookup"><span data-stu-id="c6045-111">SDO Supported Attributes</span></span>](/windows/desktop/Nps/sdo-sdo-supported-attributes)
</dt> <dt>

[<span data-ttu-id="c6045-112">**исдо**</span><span class="sxs-lookup"><span data-stu-id="c6045-112">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="c6045-113">**исдоколлектион**</span><span class="sxs-lookup"><span data-stu-id="c6045-113">**ISdoCollection**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdocollection)
</dt> <dt>

[<span data-ttu-id="c6045-114">**исдодиктионарйолд**</span><span class="sxs-lookup"><span data-stu-id="c6045-114">**ISdoDictionaryOld**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdodictionaryold)
</dt> <dt>

[<span data-ttu-id="c6045-115">**иаспропертиес**</span><span class="sxs-lookup"><span data-stu-id="c6045-115">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="c6045-116">**полиципропертиес**</span><span class="sxs-lookup"><span data-stu-id="c6045-116">**POLICYPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-policyproperties)
</dt> <dt>

[<span data-ttu-id="c6045-117">**профилепропертиес**</span><span class="sxs-lookup"><span data-stu-id="c6045-117">**PROFILEPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-profileproperties)
</dt> </dl>
