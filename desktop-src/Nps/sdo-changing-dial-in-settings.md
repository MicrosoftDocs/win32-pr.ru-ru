...
---
# <a name="changing-dial-in-settings"></a><span data-ttu-id="cc1a8-103">Изменение параметров коммутируемого подключения</span><span class="sxs-lookup"><span data-stu-id="cc1a8-103">Changing Dial-In Settings</span></span>

<span data-ttu-id="cc1a8-104">Следующий код VBScript задает бит и номер обратного вызова для пользователя.</span><span class="sxs-lookup"><span data-stu-id="cc1a8-104">The following VBScript code sets the dial-in bit and callback number for a user.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="cc1a8-105">См. также</span><span class="sxs-lookup"><span data-stu-id="cc1a8-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="cc1a8-106">**СВОЙСТВА клиентов**</span><span class="sxs-lookup"><span data-stu-id="cc1a8-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="cc1a8-107">Перечисление объектов в коллекции</span><span class="sxs-lookup"><span data-stu-id="cc1a8-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="cc1a8-108">**иаспропертиес**</span><span class="sxs-lookup"><span data-stu-id="cc1a8-108">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="cc1a8-109">**исдо**</span><span class="sxs-lookup"><span data-stu-id="cc1a8-109">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="cc1a8-110">**исдомачине**</span><span class="sxs-lookup"><span data-stu-id="cc1a8-110">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="cc1a8-111">**радиуспропертиес**</span><span class="sxs-lookup"><span data-stu-id="cc1a8-111">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
