...
ms.locfileid: "103987635"
---
# <a name="listing-profiles-policies-and-clients"></a><span data-ttu-id="99bd5-103">Список профилей, политик и клиентов</span><span class="sxs-lookup"><span data-stu-id="99bd5-103">Listing Profiles, Policies, and Clients</span></span>

<span data-ttu-id="99bd5-104">Следующий код VBScript перечисляет профили, политики и клиенты на локальном компьютере.</span><span class="sxs-lookup"><span data-stu-id="99bd5-104">The following VBScript code enumerates the profiles, policies, and clients on the local computer.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="99bd5-105">См. также</span><span class="sxs-lookup"><span data-stu-id="99bd5-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="99bd5-106">**СВОЙСТВА клиентов**</span><span class="sxs-lookup"><span data-stu-id="99bd5-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="99bd5-107">Перечисление объектов в коллекции</span><span class="sxs-lookup"><span data-stu-id="99bd5-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="99bd5-108">**иаскоммонпропертиес**</span><span class="sxs-lookup"><span data-stu-id="99bd5-108">**IASCOMMONPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iascommonproperties)
</dt> <dt>

[<span data-ttu-id="99bd5-109">**иаспропертиес**</span><span class="sxs-lookup"><span data-stu-id="99bd5-109">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="99bd5-110">**исдо**</span><span class="sxs-lookup"><span data-stu-id="99bd5-110">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="99bd5-111">**исдомачине**</span><span class="sxs-lookup"><span data-stu-id="99bd5-111">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="99bd5-112">**радиуспропертиес**</span><span class="sxs-lookup"><span data-stu-id="99bd5-112">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
