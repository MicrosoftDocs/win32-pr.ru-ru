...
Чтобы сохранить задачу на компьютере Windows, сохраните приведенный выше XML как текстовый файл и используйте следующую командную строку:
