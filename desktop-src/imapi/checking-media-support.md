---
title: Проверка поддержки мультимедиа
description: Следующий сценарий проверяет характеристики носителя, загруженного на устройство.
...
ms.locfileid: "104253114"
---
# <a name="checking-media-support"></a><span data-ttu-id="e7bb1-103">Проверка поддержки мультимедиа</span><span class="sxs-lookup"><span data-stu-id="e7bb1-103">Checking Media Support</span></span>

<span data-ttu-id="e7bb1-104">Следующий сценарий проверяет характеристики носителя, загруженного на устройство.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-104">The following script examines characteristics of the media loaded in the disc device.</span></span> <span data-ttu-id="e7bb1-105">В частности, он проверяет тип носителя и текущее состояние носителя, а также совместимость средства записи и мультимедиа.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-105">More specifically, it checks the media type and the current state of the media, as well as recorder and media compatibility.</span></span> <span data-ttu-id="e7bb1-106">Этот скрипт можно адаптировать для проверки совместимости и проблем с состоянием перед использованием носителя.</span><span class="sxs-lookup"><span data-stu-id="e7bb1-106">This script can be adapted to verify compatibility and state issues before using the media.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e7bb1-107">См. также</span><span class="sxs-lookup"><span data-stu-id="e7bb1-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e7bb1-108">Использование IMAPI</span><span class="sxs-lookup"><span data-stu-id="e7bb1-108">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="e7bb1-109">**\_ \_ физический тип носителя \_ IMAPI**</span><span class="sxs-lookup"><span data-stu-id="e7bb1-109">**IMAPI\_MEDIA\_PHYSICAL\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_media_physical_type)
</dt> <dt>

[<span data-ttu-id="e7bb1-110">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="e7bb1-110">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="e7bb1-111">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="e7bb1-111">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="e7bb1-112">**IDiscFormat2Data**</span><span class="sxs-lookup"><span data-stu-id="e7bb1-112">**IDiscFormat2Data**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscformat2data)
</dt> </dl>
