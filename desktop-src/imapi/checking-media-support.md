...
---
# <a name="checking-media-support"></a>Проверка поддержки мультимедиа

Следующий сценарий проверяет характеристики носителя, загруженного на устройство. В частности, он проверяет тип носителя и текущее состояние носителя, а также совместимость средства записи и мультимедиа. Этот скрипт можно адаптировать для проверки совместимости и проблем с состоянием перед использованием носителя.
