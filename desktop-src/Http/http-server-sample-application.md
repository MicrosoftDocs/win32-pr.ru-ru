---
title: Пример приложения HTTP-сервера
description: В этом разделе содержится пример приложения, которое показывает, как использовать API сервера HTTP для выполнения задач на стороне сервера.
...
ms.locfileid: "103776544"
---
# <a name="http-server-sample-application"></a><span data-ttu-id="e7f0e-103">Пример приложения HTTP-сервера</span><span class="sxs-lookup"><span data-stu-id="e7f0e-103">HTTP Server Sample Application</span></span>

<span data-ttu-id="e7f0e-104">В следующем примере приложения показано, как использовать API сервера HTTP для выполнения задач на стороне сервера.</span><span class="sxs-lookup"><span data-stu-id="e7f0e-104">The following sample application shows how to use the HTTP Server API to perform server-side tasks.</span></span> <span data-ttu-id="e7f0e-105">Файл «. h», включенный в первый пример, включает все заголовки, необходимые для выполнения примеров, например:</span><span class="sxs-lookup"><span data-stu-id="e7f0e-105">The "precomp.h" file included in the first example includes all the headers necessary to run the samples, for example:</span></span>
...
## <a name="main-and-preliminaries"></a><span data-ttu-id="e7f0e-106">Main и предварительные действия</span><span class="sxs-lookup"><span data-stu-id="e7f0e-106">Main and Preliminaries</span></span>
...
## <a name="initialize-the-http-service"></a><span data-ttu-id="e7f0e-107">Инициализация службы HTTP</span><span class="sxs-lookup"><span data-stu-id="e7f0e-107">Initialize the HTTP Service</span></span>
...
## <a name="register-the-urls-to-listen-on"></a><span data-ttu-id="e7f0e-108">Зарегистрируйте URL-адреса для прослушивания</span><span class="sxs-lookup"><span data-stu-id="e7f0e-108">Register the URLs to Listen On</span></span>
...
## <a name="call-the-routine-to-receive-a-request"></a><span data-ttu-id="e7f0e-109">Вызов подпрограммы для получения запроса</span><span class="sxs-lookup"><span data-stu-id="e7f0e-109">Call the Routine to Receive a Request</span></span>
...
## <a name="cleanup-the-http-server-api"></a><span data-ttu-id="e7f0e-110">Очистка API HTTP-сервера</span><span class="sxs-lookup"><span data-stu-id="e7f0e-110">Cleanup the HTTP Server API</span></span>
...
## <a name="receive-a-request"></a><span data-ttu-id="e7f0e-111">Получение запроса</span><span class="sxs-lookup"><span data-stu-id="e7f0e-111">Receive a Request</span></span>
...
## <a name="handle-the-http-request"></a><span data-ttu-id="e7f0e-112">Обработку HTTP-запроса</span><span class="sxs-lookup"><span data-stu-id="e7f0e-112">Handle the HTTP Request</span></span>
...
## <a name="send-an-http-response"></a><span data-ttu-id="e7f0e-113">Отправка HTTP-ответа</span><span class="sxs-lookup"><span data-stu-id="e7f0e-113">Send an HTTP Response</span></span>
...
## <a name="send-an-http-post-response"></a><span data-ttu-id="e7f0e-114">Отправка ответа HTTP POST</span><span class="sxs-lookup"><span data-stu-id="e7f0e-114">Send an HTTP POST Response</span></span>
