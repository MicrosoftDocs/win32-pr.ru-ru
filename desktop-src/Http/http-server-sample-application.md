...
ms.locfileid: "119682914"
---
# <a name="http-server-sample-application"></a>Пример приложения HTTP-сервера

В следующем примере приложения показано, как использовать API сервера HTTP для выполнения задач на стороне сервера. Файл «. h», включенный в первый пример, включает все заголовки, необходимые для выполнения примеров, например:
...
## <a name="main-and-preliminaries"></a>Main и предварительные действия
...
## <a name="cleanup-the-http-server-api"></a>Очистка API HTTP-сервера
...
## <a name="receive-a-request"></a>Получение запроса
...
## <a name="send-an-http-response"></a>Отправка HTTP-ответа
...
## <a name="send-an-http-post-response"></a>Отправка ответа HTTP POST
