...
ms.locfileid: "117966777"
---
# <a name="svccontrolcpp"></a>Свкконтрол. cpp

Ниже приведен пример [программы управления службами](service-control-programs.md).

При построении примера обязательно свяжите с kernel32. lib и advapi32. lib.
