...
Ниже приведен полный пример службы. При использовании этого кода в качестве шаблона просто добавьте код в разделы, которые предшествуют `TO_DO` .

При построении примера обязательно свяжите с kernel32. lib и advapi32. lib. Файл Sample. h создается при создании библиотеки DLL только для ресурсов, Sample.dll. Дополнительные сведения см. в разделе [Sample.MC](sample-mc.md).
