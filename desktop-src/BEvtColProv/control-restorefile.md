...
ms.locfileid: "119589114"
---
# <a name="restorefile-method-of-the-control-class"></a>Метод RestoreFile класса Control

Восстановите активную конфигурацию сборщика из файла резервной копии.
...
Имя восстанавливаемого файла резервной копии из списка, возвращенного Листбаккупс ().
