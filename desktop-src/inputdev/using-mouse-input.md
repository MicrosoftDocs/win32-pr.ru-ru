...
В этом примере предполагается наличие документа Microsoft Word с различными внедренными объектами:
...
| Внедренная электронная таблица Excel | Word отправляет сообщение в Excel. Необходимо решить, должно ли встроенное приложение реагировать на сообщение или нет.                                                                                                                                                                                                                                                                                                                                                            |
