...
---
# <a name="d3dx10createasynceffectpoolcreateprocessor-function"></a>Функция D3DX10CreateAsyncEffectPoolCreateProcessor

Создайте обработчик асинхронных данных для пула памяти.
