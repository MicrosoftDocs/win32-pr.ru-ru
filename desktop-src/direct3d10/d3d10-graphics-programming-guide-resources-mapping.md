...
Больше не нужно думать о ресурсах, создаваемых в видеопамяти или системной памяти. А также вне зависимости от того, должна ли среда выполнения управлять памятью. Благодаря архитектуре новой модели WDDM (модель Windows для видеодрайверов) приложения теперь создают ресурсы Direct3D 10 с различными флагами [**использования**](/windows/desktop/api/D3D10/ne-d3d10-d3d10_usage) для указания того, как приложение планирует использовать данные ресурсов. Новая модель драйвера используется для виртуализации памяти, используемой ресурсами. Затем она отвечает за использование операционной системы, драйвера или диспетчера памяти для размещения ресурсов в наиболее производительной области памяти с учетом ожидаемого использования.
...
<tr class="header">
<th>Frame</th>
<th>Состояние графического процессора/ЦП</th>
</tr>
</thead>
<tbody>
<tr class="odd">
