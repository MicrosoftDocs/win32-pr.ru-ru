...
| [**Исключить**](id3dx10mesh-discard.md)                                                   | Удаляет данные сетки с устройства, которое было зафиксировано на устройстве (с помощью [**ID3DX10Mesh:: коммиттодевице**](id3dx10mesh-committodevice.md)).<br/>                                                                                                                                                                         |
...
| [**Оптимизация**](id3dx10mesh-optimize.md)                                                 | Создает новую сетку с переупорядоченными лицами и вершинами для оптимизации производительности рисования.<br/>                                                                                                                                                                                                                                   |
