...
ms.locfileid: "119989204"
---
# <a name="d3dx10createeffectpoolfromresource-function"></a>Функция D3DX10CreateEffectPoolFromResource

Создание пула эффектов на основе ресурса.
...
Маркер модуля ресурсов, который содержит результат. ХМОДУЛЕ можно получить с помощью [функции ошибка GetModuleHandle](/windows/win32/api/libloaderapi/nf-libloaderapi-getmodulehandlea).
...
Имя ресурса в Хмодуле. Если для параметров компилятора требуется Юникод, тип данных LPCTSTR разрешается в ЛПКВСТР. В противном случае тип данных разрешается в LPCSTR.
