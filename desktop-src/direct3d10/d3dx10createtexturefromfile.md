...
ms.locfileid: "118100529"
---
# <a name="d3dx10createtexturefromfile-function"></a>Функция D3DX10CreateTextureFromFile
...
Имя файла, содержащего ресурс. Если для параметров компилятора требуется Юникод, тип данных LPCTSTR разрешается в ЛПКВСТР. В противном случае тип данных разрешается в LPCSTR. Список поддерживаемых форматов файлов изображений см. в разделе Перечисление [**\_ \_ \_ формата файлов изображений D3DX10**](d3dx10-image-file-format.md) .
...
Адрес указателя на ресурс текстуры (см. [**интерфейс ID3D10Resource**](/windows/desktop/api/D3D10/nn-d3d10-id3d10resource)).
