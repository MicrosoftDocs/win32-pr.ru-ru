...
Windows Формат фотографии мультимедиа (WMP). Этот формат также известен как Фото HD и JPEG XR. Расширения файлов для этого формата:. hdp,. жкср и. формате WDP.
...
D3DX10 использует компонент создания образов Windows для реализации большинства поддерживаемых типов файлов точечных рисунков. дополнительные сведения см. в статье [обзор компонента Windows imaging](https://msdn.microsoft.com/library/ms737408.aspx) .
