...
Зарегистрированный MSXML не поддерживает проверку.
...
Свойство издателя %1! s! содержит недопустимое значение. Значение имеет недопустимый тип, находится вне допустимого диапазона, не может быть обновлено или не поддерживается издателем этого типа.
...
Для установки этого приложения требуется либо лицензия разработчика Windows, либо система, поддерживающая загрузку неопубликованных приложений.
