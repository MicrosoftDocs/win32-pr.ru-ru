...
Windows обнаружила повреждение в файле, и этот файл был восстановлен. Возможно, произошла потери данных.
...
Windows не удается подключиться к сеансу из-за проблемы в подсистеме Windows. Повторите попытку подключения позже или обратитесь за помощью к администратору сервера.
