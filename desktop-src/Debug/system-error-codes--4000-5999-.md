...
один экземпляр служба хранилища недоступен на этом томе.
...
один или несколько узлов в кластере используют версию Windows, которая не поддерживает эту операцию.
...
сеть кластера недопустима для ресурса Tunnel IPv6. проверьте конфигурацию ресурса IP-адреса, от которого зависит ресурс Tunnel IPv6.
...
ресурс кворума не может находиться в доступной группе служба хранилища.
...
для выполнения этого действия ресурс должен входить в группу доступных служба хранилища.
