...
-   Третьим элементом является элемент «лонгнамес». Этот элемент состоит из ряда строк ASCII, завершающихся нулем, в которых каждая строка является именем другого элемента архива.
...
| // <br/>         | Элемент Archive является членом лонгнамес, который состоит из ряда строк ASCII, завершающихся нулем. Элемент лонгнамес является третьим элементом архива и всегда должен присутствовать, даже если содержимое пустое. <br/>                                                                     |
