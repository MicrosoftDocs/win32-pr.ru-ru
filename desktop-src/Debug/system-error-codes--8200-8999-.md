...
Только DSA, настроенные на серверы глобального каталога, должны иметь роль хозяина именования доменов. (Применяется только к серверам Windows 2000.)
...
Не удалось инициализировать диспетчер учетных записей безопасности из-за следующей ошибки: %1. Состояние ошибки: 0x %2. Нажмите кнопку ОК, чтобы завершить работу системы и перезагрузить компьютер в защищенном режиме. Подробные сведения см. в журнале событий.
