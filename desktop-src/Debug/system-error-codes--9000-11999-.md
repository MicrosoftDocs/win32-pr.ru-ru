...
Не удалось выполнить операцию, так как не удалось связаться с ролью FSMO хозяина именования доменов. Контроллер домена, на котором находится роль FSMO хозяина именования доменов, не работает или не может обслуживать запрос либо не работает под Windows Server 2003 или более поздней версии.
