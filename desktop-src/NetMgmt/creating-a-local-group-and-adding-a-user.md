...
Чтобы создать новую локальную группу, вызовите функцию [**нетлокалграупадд**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) . Чтобы добавить пользователя в эту группу, вызовите функцию [**нетлокалграупаддмемберс**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) .

Следующая программа позволяет создать пользователя и локальную группу и добавить пользователя в локальную группу.
