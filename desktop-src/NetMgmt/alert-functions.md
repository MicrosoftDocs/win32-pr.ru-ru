...
ms.locfileid: "119912464"
---
# <a name="alert-functions"></a>Функции предупреждений

\[функции оповещений не поддерживаются в Windows Vista, так как служба оповещений и службы сообщений не поддерживаются.\]
...
**Windows Server 2003:** службы оповещений и сообщений по умолчанию отключены на Windows Server 2003. Необходимо повторно включить службы перед вызовом функций предупреждений управления сетью или [функций сообщений](message-functions.md)управления сетью.
