...
keywords:
- обложки проигрыватель Windows Media, элемент списка воспроизведения
...
| [columnCount](playlist-columncount.md)                                                   | Возвращает число отображаемых столбцов.                                                                                                     |
...
| [списком](playlist-playlist.md)                                                         | Указывает или получает объект **списка воспроизведения** , в котором элемент **списка воспроизведения** предоставляет интерфейс.                                    |
