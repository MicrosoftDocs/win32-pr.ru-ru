...
- проигрыватель Windows Media метода жетбяусор, интерфейс ивмпмедиаколлектион
- проигрыватель Windows Media интерфейса ивмпмедиаколлектион, метод жетбяусор
topic_type:
- apiref
api_name:
