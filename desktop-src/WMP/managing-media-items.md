...
> [!Note]  
> \)Для представления одного действительного символа обратной косой черты в строке необходимо указать две обратные косые черты (или символ @ в C#). Это происходит потому, что C# использует один символ обратной косой черты для определения escape-последовательности.
