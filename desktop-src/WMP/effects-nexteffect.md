...
Метод **некстеффект** отображает первую предустановку следующего представления, пропуская промежуточные предустановки.
...
[**EFFECTs. Превиаусеффект**](effects-previouseffect.md)
</dt> </dl>
