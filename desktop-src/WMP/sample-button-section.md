...
keywords:
- проигрыватель Windows Media Обложки мобильных устройств, раздел "Кнопка"
...
> [!Note]  
> типы кнопок являются устаревшими в обложках для проигрыватель Windows Media 10 Mobile или более поздней версии. Вместо типа кнопки, объявленного в файле обложки, введите НД для каждого типа.
