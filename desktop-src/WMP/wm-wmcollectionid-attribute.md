...
---
# <a name="wmwmcollectionid-attribute"></a>Атрибут WM/Вмколлектионид

Атрибут **WM/вмколлектионид** — это идентификатор GUID, определяющий коллекцию, которой принадлежит элемент.
...
**Вмколлектионид** является псевдонимом для этого атрибута.

Константа Windows Media Format SDK для этого атрибута — g \_ всзвмколлектионид.
