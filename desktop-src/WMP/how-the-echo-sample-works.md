...
после того как буфер задержки существует и проигрыватель Windows Media выделил входной буфер для передачи звуковых данных и выходной буфер для получения обработанных звуковых данных, обработка эха продолжается следующим образом:
