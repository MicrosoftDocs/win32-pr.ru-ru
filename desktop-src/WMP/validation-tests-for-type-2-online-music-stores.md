...
11. убедитесь, что содержимое воспроизводится в Microsoft проигрыватель Windows Media.
...
-   Определите следующие сведения о тестовой среде.
    ...
    -   убедитесь, что неактивное хранилище для проверки отображается во всех версиях операционной системы и на всех версиях платформы проигрыватель Windows Media.
...
-   Microsoft проигрыватель Windows Media 11 в Windows XP с пакетом обновления 3 (SP3) 32-разрядные и 64-разрядные операционные системы
-   проигрыватель Windows Media 11 в операционных системах Windows Vista 32 и 64 (32-bit проигрыватель Windows Media)
-   Microsoft проигрыватель Windows Media 12 в Windows 7 32-разрядных и 64-разрядных операционных системах (32-bit проигрыватель Windows Media)

несмотря на то, что необходимо выполнить тестирование на всех указанных версиях операционной системы и платформах, 32-разрядные версии Windows Vista и Windows 7 являются целевыми версиями операционной системы. Необходимо протестировать установку любого программного обеспечения на всех платформах.
...
3.  отключите представление информационного центра магазина, установив для проигрыватель Windows Media воспроизведение визуализации. основное различие между платформами состоит в том, что в проигрыватель Windows Media 11 вы начинаете с выбора пункта **воспроизведение**, а в проигрыватель Windows Media 12 — щелкнув правой кнопкой мыши главное окно.

    на следующем снимке экрана показана последовательность параметров меню, воспроизводящих визуализацию в проигрыватель Windows Media 11:

    ![снимок экрана, показывающий, как воспроизвести визуализацию в проигрывателе Windows Media 11](images/wmp11-visual.png)

    на следующем снимке экрана показана последовательность параметров меню, воспроизводящих визуализацию в проигрыватель Windows Media 12.
...
2.  для Windows XP и Windows Vista для выбора интернет-магазина сначала перейдите на вкладку, которая разбивается между представлением "путеводитель мультимедиа" и "интернет-магазины". Затем в меню выберите пункт **Обзор всех интернет-магазинов** и выберите магазин, щелкнув его значок в списке магазинов. в Windows 7 нажмите кнопку в области навигации библиотеки, которая разделяется между кнопками " **путеводитель" мультимедиа** "и" **интернет-магазины** ". Затем в меню выберите пункт **Обзор всех интернет-магазинов** и выберите магазин, щелкнув его значок в списке магазинов.

    на следующем снимке экрана показано, как выбрать интернет-магазин в проигрыватель Windows Media 11:

    ![снимок экрана, показывающий, как выбрать Интернет-магазин в проигрывателе Windows Media 11](images/wmp11-set-store.png)

    на следующем снимке экрана показано, как выбрать интернет-магазин в проигрыватель Windows Media 12.
...
3.  Убедитесь, что программное обеспечение не выполняется в области уведомлений.
    ...
    В основном хранилище не должно требовать установки дополнительного программного обеспечения. Должен быть доступен базовый интерфейс мультимедиа, например потоковая передача мультимедиа. В некоторых магазинах устанавливается дополнительное программное обеспечение, например диспетчеры загрузки, для работы с мультимедийными файлами уровня Premier. эти магазины могут иметь значки в области уведомлений, если значки представляют приложения, которые отделены от проигрыватель Windows Media.

4.  Убедитесь, что вкладка хранилище работает.

    Убедитесь, что вкладка магазин изменилась, чтобы показать выбранное хранилище.

    для Windows XP и Windows Vista с проигрыватель Windows Media 11 убедитесь, что имя и значок магазина видны на фоне темного проигрыватель Windows Media 11.

    для Windows 7 с проигрыватель Windows Media 12 убедитесь, что имя и значок магазина отображаются в области навигации "библиотека" в контекстном меню "сервис-selector".
    ...
    на следующем снимке экрана показано меню, отображаемое при щелчке вкладки в правом верхнем углу проигрыватель Windows Media 11:

    ![снимок экрана, отображающий вкладку "магазин" в проигрывателе Windows Media 11](images/wmp11-verify-store.png)

    на следующем снимке экрана показано меню, которое появляется при нажатии кнопки разделить в левом нижнем углу проигрыватель Windows Media 12:
...
1.  Убедитесь, что в магазине есть возможность создать новую учетную запись, а затем следуйте инструкциям по хранению, чтобы создать новую учетную запись.
    ...
    на следующем снимке экрана показана кнопка **создать новую учетную запись** , так как она может появиться в проигрыватель Windows Media 11:
    ...
    на следующем снимке экрана показана кнопка **создать новую учетную запись** , так как она может появиться в проигрыватель Windows Media 12:
...
2.  убедитесь, что содержимое воспроизводится в проигрыватель Windows Media, а не на другом проигрывателе или элементе управления.
...
2.  Убедитесь, что приобретенное содержимое загружается в библиотеку.
    ...
    после завершения скачивания перейдите к загруженному содержимому в библиотеке проигрыватель Windows Media. Загруженное содержимое находится в библиотеке текущего пользователя.

    -   для Windows XP и Windows Vista с проигрыватель Windows Media 11 загруженное содержимое отображается в области навигации библиотеки в разделе **библиотека** сведения, а затем в разделе **песни**.
    -   для Windows 7 с проигрыватель Windows Media 12 содержимое, которое загружается в библиотеку проигрыватель Windows Media, отображается в области навигации проигрыватель Windows Media в разделе **музыка**.
...
5.  Убедитесь, что приобретенное содержимое будет воспроизводиться.
    ...
    убедитесь, что загруженное содержимое воспроизводится в проигрыватель Windows Media.
    ...
    чтобы приобрести содержимое в Windows XP и Windows Vista с проигрыватель Windows Media 11, выполните следующие действия:
    ...
    на следующем снимке экрана показано расположение ссылки на **покупку** в проигрыватель Windows Media 11:

    ![снимок экрана, показывающий, как купить содержимое в проигрывателе Windows Media 11](images/wmp11-verify-buy-play.png)

    чтобы приобрести содержимое в Windows 7 с проигрыватель Windows Media 12, выполните следующие действия:

    1.  В режиме библиотеки перейдите на вкладку **Воспроизведение** .
    2.  В списке воспроизведения на обложке альбома щелкните **магазин** .

    на следующем снимке экрана показано, как купить содержимое в проигрыватель Windows Media 12.
...
6.  Убедитесь, что в магазине щелкнуть **купить** **или купить** коммутаторы.
    ...
    проигрыватель Windows Media следует переключиться на магазин в представлении библиотеки и загрузить магазин магазина.
...
на следующем снимке экрана показан **список записи** в правой части экрана и кнопка **начать запись** под **списком записи** в проигрыватель Windows Media 11:

![снимок экрана, показывающий, как записать содержимое в проигрывателе Windows Media 11](images/wmp11-verify-burn.png)

на следующем снимке экрана показано, как список записи отображается в проигрыватель Windows Media 12 после перетаскивания дорожки в список записи и отображается кнопка **начать запись** в верхней части вкладки **запись** .
...
1.  Подключение устройства с безопасными часами. к примерам относятся устройства, использующие Windows Media DRM для портативных устройств, например, портативный мультимедиа-центр, такой как иривер H10, Creative Zen и т. д.
2.  в проигрыватель Windows Media перейдите на вкладку **синхронизация** .
...
на следующем снимке экрана показана запись 1 в области **списка синхронизация** и отображается кнопка **начать синхронизацию** в проигрыватель Windows Media 11:

![снимок экрана, показывающий, как передавать содержимое в проигрывателе Windows Media 11](images/wmp11-verify-transfer.png)

на следующем снимке экрана показана запись 1 в области **списка синхронизация** и отображается кнопка **начать синхронизацию** в проигрыватель Windows Media 12.
...
2.  Переключитесь в режим "сейчас воспроизведения". в Windows XP или Windows Vista с проигрыватель Windows Media 11 перейдите на вкладку **воспроизведение** . в Windows 7 с проигрыватель Windows Media 12 нажмите кнопку **переключиться в** режим "сейчас" в правом нижнем углу.
...
в Windows XP или Windows Vista с проигрыватель Windows Media 11 щелкните правой кнопкой мыши воспроизводимое окно, а затем в контекстном меню выберите **представление информационного центра**.

на следующем снимке экрана показано контекстное меню в проигрыватель Windows Media 11:
...
в Windows 7 с проигрыватель Windows Media 12 щелкните правой кнопкой мыши воспроизводимое окно, в контекстном меню выберите **визуализации**, а затем — **представление центра сведений**.

на следующем снимке экрана показано контекстное меню в проигрыватель Windows Media 12:
...
-   Убедитесь, что в ссылках отображается хранилище.
    ...
    проигрыватель Windows Media следует переключиться на хранилище в своей библиотеке.
...
3.  нажмите кнопку "назад" в проигрыватель Windows Media и убедитесь, что вы не видите предыдущую информацию об учетной записи пользователя.
