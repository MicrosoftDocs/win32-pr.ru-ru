---
title: Windows Удаленное управление и инструментарий WMI
description: Windows удаленное управление можно использовать для получения данных, предоставляемых инструментарий управления Windows (WMI).
