...
-   Корпорация Майкрософт не будет предлагать новые лицензии или обновления
-   Корпорация Майкрософт не будет обновлять компоненты Microsoft Agent, в том числе:
    -   Среда выполнения "msagent.exe" и библиотеки
...
-   [Робби символьный файл](https://www.microsoft.com/downloads/details.aspx?FamilyID=fa36d1d5-d828-494a-ad0a-7b571db5bd2e)

## <a name="links-to-other-resources"></a>Ссылки на другие ресурсы

<dl>

[Ресурсы Microsoft Agent](https://support.microsoft.com/kb/969168)  
</dl>
