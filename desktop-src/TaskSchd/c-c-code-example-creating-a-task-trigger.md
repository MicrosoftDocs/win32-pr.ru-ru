...
ms.locfileid: "119959644"
---
# <a name="cc-code-example-creating-a-task-trigger"></a>Пример кода C/C++: Создание триггера задачи

В этом примере создается новый триггер для существующей задачи с именем Test Task.
