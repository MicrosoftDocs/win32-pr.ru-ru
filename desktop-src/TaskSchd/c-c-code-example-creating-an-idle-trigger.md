...
---
# <a name="cc-code-example-creating-an-idle-trigger"></a>Пример кода C/C++. Создание триггера Idle

В этом примере создается триггер Idle для существующей задачи. Сведения об условиях простоя см. в разделе [условия простоя задачи](task-idle-conditions.md).
