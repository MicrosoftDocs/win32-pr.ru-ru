...
description: в этом примере сценария показано, как создать задачу, выполняемую Блокнот в 8 00 утра в понедельник каждой недели.
...
ms.locfileid: "119001772"
---
# <a name="weekly-trigger-example-scripting"></a>Пример еженедельного триггера (скрипт)

в этом примере сценария показано, как создать задачу, выполняемую Блокнот в 8:00 утра в понедельник каждой недели. задача содержит ежедневный триггер, указывающий время выполнения задачи и исполняемое действие, выполняемое Блокнот.
...
**планирование Блокнот для запуска в 8:00 утра в понедельник каждой недели**
...
6.  Зарегистрируйте задачу с помощью метода [**таскфолдер. регистертаскдефинитион**](taskfolder-registertaskdefinition.md) . в этом примере задача начнется Блокнот в 8:00 утра в понедельник каждой недели.
