...
description: в этом примере C++ показано, как создать задачу, запланированную на ежедневное выполнение Блокнот.
...
ms.locfileid: "119139557"
---
# <a name="daily-trigger-example-c"></a>Пример ежедневного триггера (C++)

в этом примере C++ показано, как создать задачу, запланированную на ежедневное выполнение Блокнот. Задача содержит ежедневный триггер, указывающий начальную границу и интервал дня для запуска задачи. В примере также показано, как задать шаблон повторения для триггера, чтобы повторить задачу. задача также содержит действие, указывающее задачу, выполняемую Блокнот.

Следующая процедура описывает, как запланировать задачу запуска исполняемого файла на ежедневной основе.

**планирование Блокнот ежедневного запуска**
...
в следующем примере C++ показано, как запланировать задачу для ежедневного выполнения Блокнот.
