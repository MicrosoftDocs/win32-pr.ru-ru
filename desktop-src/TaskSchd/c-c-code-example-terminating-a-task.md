...
ms.locfileid: "120100494"
---
# <a name="cc-code-example-terminating-a-task"></a>Пример кода C/C++: завершение задачи

Этот пример проверяет состояние известной задачи и завершает задачу, если она запущена.
