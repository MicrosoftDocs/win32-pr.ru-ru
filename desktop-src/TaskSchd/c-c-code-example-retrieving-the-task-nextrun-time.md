...
ms.locfileid: "119738504"
---
# <a name="cc-code-example-retrieving-the-task-nextrun-time"></a>Пример кода C/C++: получение времени Некструн задачи

Этот пример извлекается при следующем запланированном запуске задачи и отображает это время на экране. В этом примере предполагается, что задача и тестовая задача уже существуют на локальном компьютере.
