...
В этом примере C++ показано, как создать задачу, запланированную на регулярное выполнение блокнота. Задача содержит еженедельный триггер, указывающий начальную границу, интервал недели и день недели для запуска задачи. Задача также содержит действие, указывающее задачу для выполнения в блокноте.

Следующая процедура описывает, как запланировать задачу запуска исполняемого файла еженедельно.

**Планирование запуска программы «Блокнот» еженедельно**
...
В следующем примере кода C++ показано, как запланировать выполнение задачи на еженедельном уровне.
