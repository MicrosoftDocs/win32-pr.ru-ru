...
ms.locfileid: "119139637"
---
# <a name="cc-code-example-retrieving-the-task-application-name"></a>Пример кода C/C++: получение имени приложения задачи

В этом примере извлекается имя приложения, связанного с заданной задачей, и отображается это имя на экране. В этом примере предполагается, что задача и тестовая задача уже существуют на локальном компьютере.
