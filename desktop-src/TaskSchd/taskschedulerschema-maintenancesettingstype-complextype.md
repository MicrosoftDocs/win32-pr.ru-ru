...
| [**Периода**](taskschedulerschema-daysinterval-dailyscheduletype-element.md)   |         | Указывает, как часто задача должна запускаться во время автоматического обслуживания.<br/>                                                                                                      |
