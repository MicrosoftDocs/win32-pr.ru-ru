...
---
# <a name="task-scheduler-schema"></a>Схема планировщик задач

Схема планировщик задач определяет допустимый XML-код, используемый для регистрации задач в службе планировщик задач. Разработчики могут создать собственный XML-код, проверить его по схеме и зарегистрировать задачи с помощью метода [**ITaskFolder:: регистертаск**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .

Типы и элементы схемы планировщик задач описаны отдельно в следующих разделах.

-   [планировщик задач элементы схемы](task-scheduler-schema-elements.md)
-   [Простые типы схемы планировщик задач](task-scheduler-schema-simple-types.md)
-   [планировщик задач сложные типы схемы](task-scheduler-schema-complex-types.md)
-   [планировщик задач группы схем](task-scheduler-schema-groups.md)

Вся схема планировщик задач определяется следующим XSD-файлом.
