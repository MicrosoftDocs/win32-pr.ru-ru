---
title: Схема планировщик задач
description: Схема планировщик задач определяет допустимый XML-код, используемый для регистрации задач в службе планировщик задач. Разработчики могут создавать собственные XML-код, проверять их по схеме и регистрировать задачи с помощью метода Регистертаск ITaskFolder.
ms.assetid: 9b1b8e34-c635-413a-a230-79a58017cf21
keywords:
- Планировщик задач планировщик задач, ссылка, схема XML
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104133414"
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="f944a-105">Схема планировщик задач</span><span class="sxs-lookup"><span data-stu-id="f944a-105">Task Scheduler Schema</span></span>

<span data-ttu-id="f944a-106">Схема планировщик задач определяет допустимый XML-код, используемый для регистрации задач в службе планировщик задач.</span><span class="sxs-lookup"><span data-stu-id="f944a-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="f944a-107">Разработчики могут создать собственный XML-код, проверить его по схеме и зарегистрировать задачи с помощью метода [**ITaskFolder:: регистертаск**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .</span><span class="sxs-lookup"><span data-stu-id="f944a-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="f944a-108">Типы и элементы схемы планировщик задач описаны отдельно в следующих разделах.</span><span class="sxs-lookup"><span data-stu-id="f944a-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="f944a-109">планировщик задач элементы схемы</span><span class="sxs-lookup"><span data-stu-id="f944a-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="f944a-110">Простые типы схемы планировщик задач</span><span class="sxs-lookup"><span data-stu-id="f944a-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="f944a-111">планировщик задач сложные типы схемы</span><span class="sxs-lookup"><span data-stu-id="f944a-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="f944a-112">планировщик задач группы схем</span><span class="sxs-lookup"><span data-stu-id="f944a-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="f944a-113">Вся схема планировщик задач определяется следующим XSD-файлом.</span><span class="sxs-lookup"><span data-stu-id="f944a-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
