...
ms.locfileid: "119738904"
---
# <a name="cc-code-example-enumerating-tasks"></a>Пример кода C/C++. Перечисление задач

В этом примере перечисляются все задачи в папке "запланированные задания" на локальном компьютере и выводится имя каждой задачи на экране.
