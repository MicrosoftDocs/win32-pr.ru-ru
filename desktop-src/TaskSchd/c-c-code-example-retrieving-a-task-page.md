...
ms.locfileid: "119139677"
---
# <a name="cc-code-example-retrieving-a-task-page"></a>Пример кода C/C++: получение страницы задачи

В этом примере извлекается и отображается страница задачи известной задачи. Обратите внимание, что в этом примере все интерфейсы освобождаются, когда они больше не нужны.
