...
Ниже приведен краткий пример PRJ_CANCEL_COMMAND_CB, который работает с предыдущим образцом кода.
