...
Указатель на функцию точки входа шейдера, где начинается выполнение.
...
Если функция выполнена успешно, возвращается значение D3D \_ ОК. Если функция завершается ошибкой, возвращаемое значение может быть одним из следующих: D3DERR \_ инвалидкалл, D3DXERR \_ INVALIDDATA, E \_ нотимпл, e \_ OUTOFMEMORY.
