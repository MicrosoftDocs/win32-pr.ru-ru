...
---
# <a name="direct3d-structures"></a>Структуры Direct3D

В этом разделе содержатся сведения о структурах, используемых с Direct3D.
...
-   
    ...
    |                                                                                                                                                                          |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Различия между Direct3D 9 и Direct3D 9Ex:<br/> Эта структура доступна только в Direct3D 9Ex.<br/>[**D3DCOMPOSERECTDESC**](d3dcomposerectdesc.md) |
...
-   
    ...
    |                                                                                                                                                                                        |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Различия между Direct3D 9 и Direct3D 9Ex:<br/> Эта структура доступна только в Direct3D 9Ex.<br/>[**D3DCOMPOSERECTDESTINATION**](d3dcomposerectdestination.md) |
...
-   [**D3DDEVINFO \_ вкаче**](d3ddevinfo-vcache.md)
-   [**D3DDISPLAYMODE**](d3ddisplaymode.md)
-   

    |                                                                                                                                                                      |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Различия между Direct3D 9 и Direct3D 9Ex:<br/> Эта структура доступна только в Direct3D 9Ex.<br/>[**D3DDISPLAYMODEEX**](d3ddisplaymodeex.md) |
...
-   
    ...
    |                                                                                                                                                                              |
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Различия между Direct3D 9 и Direct3D 9Ex:<br/> Эта структура доступна только в Direct3D 9Ex.<br/>[**D3DDISPLAYMODEFILTER**](d3ddisplaymodefilter.md) |
...
-   [**\_Поле D3DLOCKED**](d3dlocked-box.md)
...
-   
    ...
    |                                                                                                                                                                    |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Различия между Direct3D 9 и Direct3D 9Ex:<br/> Эта структура доступна только в Direct3D 9Ex.<br/>[**D3DPRESENTSTATS**](d3dpresentstats.md) |
...
-   [**\_Состояние D3DRASTER**](d3draster-status.md)
-   [**D3DRECT**](d3drect.md)
...
-   [**D3DXF \_ филелоадмемори**](d3dxf-fileloadmemory.md)
-   [**палеттинтри**](/windows/win32/api/wingdi/ns-wingdi-paletteentry)
