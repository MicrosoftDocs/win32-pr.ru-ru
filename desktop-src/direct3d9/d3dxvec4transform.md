...
---
# <a name="d3dxvec4transform-function-d3dx9mathh"></a>Функция D3DXVec4Transform (D3dx9math. h)
...
Указатель на структуру [**D3DXVECTOR4**](d3dxvector4.md) , которая является преобразованным вектором 4d.
