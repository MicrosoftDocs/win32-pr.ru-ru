...
<span data-ttu-id="f21a0-137">Один член перечисляемого типа [**D3DBLEND**](./d3dblend.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-137">One member of the [**D3DBLEND**](./d3dblend.md) enumerated type.</span></span> <span data-ttu-id="f21a0-138">Значение по умолчанию — D3DBLEND \_ 1.</span><span class="sxs-lookup"><span data-stu-id="f21a0-138">The default value is D3DBLEND\_ONE.</span></span>
...
<span data-ttu-id="f21a0-152">Значение глубины записывается в буфер глубины только в том случае, если состояние визуализации равно **true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-152">The depth value is written to the depth buffer only if the render state is **TRUE**.</span></span>
...
<span data-ttu-id="f21a0-180">Если для этого элемента задано **значение true**, то отраженный цвет добавляется к базовому цвету после текстуры Cascade, но перед альфа-смешением.</span><span class="sxs-lookup"><span data-stu-id="f21a0-180">When this member is set to **TRUE**, the specular color is added to the base color after the texture cascade but before alpha blending.</span></span>
...
<span data-ttu-id="f21a0-246">Значение ссылочного типа int для теста набора элементов.</span><span class="sxs-lookup"><span data-stu-id="f21a0-246">An int reference value for the stencil test.</span></span> <span data-ttu-id="f21a0-247">Значение по умолчанию — 0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-247">The default value is 0.</span></span>
...
<span data-ttu-id="f21a0-271"><span id="D3DRS_WRAP5"></span><span id="d3drs_wrap5"></span>**D3DRS \_ WRAP5**</span><span class="sxs-lookup"><span data-stu-id="f21a0-271"><span id="D3DRS_WRAP5"></span><span id="d3drs_wrap5"></span>**D3DRS\_WRAP5**</span></span>
</dt> <dd>
...
<span data-ttu-id="f21a0-363">Значение float, которое управляет ослаблением размера на основе расстояния для примитивов точек.</span><span class="sxs-lookup"><span data-stu-id="f21a0-363">A float value that controls for distance-based size attenuation for point primitives.</span></span> <span data-ttu-id="f21a0-364">Активен, только если D3DRS \_ поинтскалинабле имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-364">Active only when D3DRS\_POINTSCALEENABLE is **TRUE**.</span></span> <span data-ttu-id="f21a0-365">Значение по умолчанию — 1,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-365">The default value is 1.0f.</span></span> <span data-ttu-id="f21a0-366">Диапазон для этого значения больше или равен 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-366">The range for this value is greater than or equal to 0.0f.</span></span> <span data-ttu-id="f21a0-367">Так как метод [**IDirect3DDevice9:: сетрендерстате**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) принимает значения типа DWORD, приложение должно привести переменную, содержащую значение, как показано в следующем примере кода.</span><span class="sxs-lookup"><span data-stu-id="f21a0-367">Because the [**IDirect3DDevice9::SetRenderState**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) method accepts DWORD values, your application must cast a variable that contains the value, as shown in the following code example.</span></span>
...
<span data-ttu-id="f21a0-368"><span id="D3DRS_POINTSCALE_B"></span><span id="d3drs_pointscale_b"></span>**D3DRS \_ поинтскале \_ B**</span><span class="sxs-lookup"><span data-stu-id="f21a0-368"><span id="D3DRS_POINTSCALE_B"></span><span id="d3drs_pointscale_b"></span>**D3DRS\_POINTSCALE\_B**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-369">Значение float, которое управляет ослаблением размера на основе расстояния для примитивов точек.</span><span class="sxs-lookup"><span data-stu-id="f21a0-369">A float value that controls for distance-based size attenuation for point primitives.</span></span> <span data-ttu-id="f21a0-370">Активен, только если D3DRS \_ поинтскалинабле имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-370">Active only when D3DRS\_POINTSCALEENABLE is **TRUE**.</span></span> <span data-ttu-id="f21a0-371">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-371">The default value is 0.0f.</span></span> <span data-ttu-id="f21a0-372">Диапазон для этого значения больше или равен 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-372">The range for this value is greater than or equal to 0.0f.</span></span> <span data-ttu-id="f21a0-373">Так как метод [**IDirect3DDevice9:: сетрендерстате**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) принимает значения типа DWORD, приложение должно привести переменную, содержащую значение, как показано в следующем примере кода.</span><span class="sxs-lookup"><span data-stu-id="f21a0-373">Because the [**IDirect3DDevice9::SetRenderState**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) method accepts DWORD values, your application must cast a variable that contains the value, as shown in the following code example.</span></span>
...
<span data-ttu-id="f21a0-374"><span id="D3DRS_POINTSCALE_C"></span><span id="d3drs_pointscale_c"></span>**D3DRS \_ поинтскале \_ C**</span><span class="sxs-lookup"><span data-stu-id="f21a0-374"><span id="D3DRS_POINTSCALE_C"></span><span id="d3drs_pointscale_c"></span>**D3DRS\_POINTSCALE\_C**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-375">Значение float, которое управляет ослаблением размера на основе расстояния для примитивов точек.</span><span class="sxs-lookup"><span data-stu-id="f21a0-375">A float value that controls for distance-based size attenuation for point primitives.</span></span> <span data-ttu-id="f21a0-376">Активен, только если D3DRS \_ поинтскалинабле имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-376">Active only when D3DRS\_POINTSCALEENABLE is **TRUE**.</span></span> <span data-ttu-id="f21a0-377">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-377">The default value is 0.0f.</span></span> <span data-ttu-id="f21a0-378">Диапазон для этого значения больше или равен 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-378">The range for this value is greater than or equal to 0.0f.</span></span> <span data-ttu-id="f21a0-379">Так как метод [**IDirect3DDevice9:: сетрендерстате**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) принимает значения типа DWORD, приложение должно привести переменную, содержащую значение, как показано в следующем примере кода.</span><span class="sxs-lookup"><span data-stu-id="f21a0-379">Because the [**IDirect3DDevice9::SetRenderState**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) method accepts DWORD values, your application must cast a variable that contains the value, as shown in the following code example.</span></span>
...
<span data-ttu-id="f21a0-380"><span id="D3DRS_MULTISAMPLEANTIALIAS"></span><span id="d3drs_multisampleantialias"></span>**D3DRS \_ мултисамплеантиалиас**</span><span class="sxs-lookup"><span data-stu-id="f21a0-380"><span id="D3DRS_MULTISAMPLEANTIALIAS"></span><span id="d3drs_multisampleantialias"></span>**D3DRS\_MULTISAMPLEANTIALIAS**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-381">Логическое значение, определяющее, как вычисляются отдельные выборки при использовании буфера целевой визуализации с несколькими образцами.</span><span class="sxs-lookup"><span data-stu-id="f21a0-381">bool value that determines how individual samples are computed when using a multisample render-target buffer.</span></span> <span data-ttu-id="f21a0-382">Если задано **значение true**, вычисляются несколько выборок, чтобы сглаживание выполнялось с помощью выборки в различных позициях выборки для каждого множественного примера.</span><span class="sxs-lookup"><span data-stu-id="f21a0-382">When set to **TRUE**, the multiple samples are computed so that full-scene antialiasing is performed by sampling at different sample positions for each multiple sample.</span></span> <span data-ttu-id="f21a0-383">Если задано **значение false**, то несколько выборок записываются с одним и тем же значением выборки, выборке на пиксельном центре, что позволяет отформатировать несглаженный буфер.</span><span class="sxs-lookup"><span data-stu-id="f21a0-383">When set to **FALSE**, the multiple samples are all written with the same sample value, sampled at the pixel center, which allows non-antialiased rendering to a multisample buffer.</span></span> <span data-ttu-id="f21a0-384">Это состояние рендеринга не действует при подготовке к просмотру в одном буфере выборки.</span><span class="sxs-lookup"><span data-stu-id="f21a0-384">This render state has no effect when rendering to a single sample buffer.</span></span> <span data-ttu-id="f21a0-385">Значение по умолчанию — **true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-385">The default value is **TRUE**.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-386"><span id="D3DRS_MULTISAMPLEMASK"></span><span id="d3drs_multisamplemask"></span>**D3DRS \_ мултисамплемаск**</span><span class="sxs-lookup"><span data-stu-id="f21a0-386"><span id="D3DRS_MULTISAMPLEMASK"></span><span id="d3drs_multisamplemask"></span>**D3DRS\_MULTISAMPLEMASK**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-387">Каждый бит в этой маске, начиная с наименее значимого бита (ЛСБ), управляет изменением одного из примеров в многовыборочной цели рендеринга.</span><span class="sxs-lookup"><span data-stu-id="f21a0-387">Each bit in this mask, starting at the least significant bit (LSB), controls modification of one of the samples in a multisample render target.</span></span> <span data-ttu-id="f21a0-388">Таким образом, в 8-примерном целевом объекте отрисовки младший байт включает 8 операций записи для каждого из восьми выборок.</span><span class="sxs-lookup"><span data-stu-id="f21a0-388">Thus, for an 8-sample render target, the low byte contains the eight write enables for each of the eight samples.</span></span> <span data-ttu-id="f21a0-389">Это состояние рендеринга не действует при подготовке к просмотру в одном буфере выборки.</span><span class="sxs-lookup"><span data-stu-id="f21a0-389">This render state has no effect when rendering to a single sample buffer.</span></span> <span data-ttu-id="f21a0-390">Значение по умолчанию — 0xFFFFFFFF.</span><span class="sxs-lookup"><span data-stu-id="f21a0-390">The default value is 0xFFFFFFFF.</span></span>

<span data-ttu-id="f21a0-391">Это состояние рендеринга позволяет использовать многопримерный буфер в качестве буфера накопления, выполняя многопроходную отрисовку геометрии, в которой каждый проход обновляет подмножество образцов.</span><span class="sxs-lookup"><span data-stu-id="f21a0-391">This render state enables use of a multisample buffer as an accumulation buffer, doing multipass rendering of geometry where each pass updates a subset of samples.</span></span>

<span data-ttu-id="f21a0-392">При наличии n многовыборочных и включенных образцов возможный объем отображаемого изображения должен быть k/n.</span><span class="sxs-lookup"><span data-stu-id="f21a0-392">If there are n multisamples and k enabled samples, the resulting intensity of the rendered image should be k/n.</span></span> <span data-ttu-id="f21a0-393">Каждый RGB-компонент каждого пикселя размещается на k/n.</span><span class="sxs-lookup"><span data-stu-id="f21a0-393">Each component RGB of every pixel is factored by k/n.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-394"><span id="D3DRS_PATCHEDGESTYLE"></span><span id="d3drs_patchedgestyle"></span>**D3DRS \_ патчеджестиле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-394"><span id="D3DRS_PATCHEDGESTYLE"></span><span id="d3drs_patchedgestyle"></span>**D3DRS\_PATCHEDGESTYLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-395">Задает, будут ли края исправлений использовать тесселяцию типа float.</span><span class="sxs-lookup"><span data-stu-id="f21a0-395">Sets whether patch edges will use float style tessellation.</span></span> <span data-ttu-id="f21a0-396">Возможные значения определяются перечисляемым типом [**D3DPATCHEDGESTYLE**](./d3dpatchedgestyle.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-396">Possible values are defined by the [**D3DPATCHEDGESTYLE**](./d3dpatchedgestyle.md) enumerated type.</span></span> <span data-ttu-id="f21a0-397">Значение по умолчанию — D3DPATCHEDGE \_ Дискретный.</span><span class="sxs-lookup"><span data-stu-id="f21a0-397">The default value is D3DPATCHEDGE\_DISCRETE.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-398"><span id="D3DRS_DEBUGMONITORTOKEN"></span><span id="d3drs_debugmonitortoken"></span>**D3DRS \_ дебугмонитортокен**</span><span class="sxs-lookup"><span data-stu-id="f21a0-398"><span id="D3DRS_DEBUGMONITORTOKEN"></span><span id="d3drs_debugmonitortoken"></span>**D3DRS\_DEBUGMONITORTOKEN**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-399">Задается только для отладки монитора.</span><span class="sxs-lookup"><span data-stu-id="f21a0-399">Set only for debugging the monitor.</span></span> <span data-ttu-id="f21a0-400">Возможные значения определяются перечисляемым типом [**D3DDEBUGMONITORTOKENS**](./d3ddebugmonitortokens.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-400">Possible values are defined by the [**D3DDEBUGMONITORTOKENS**](./d3ddebugmonitortokens.md) enumerated type.</span></span> <span data-ttu-id="f21a0-401">Обратите внимание, что если задан параметр D3DRS \_ дебугмонитортокен, вызов обрабатывается как передающий маркер в монитор отладки.</span><span class="sxs-lookup"><span data-stu-id="f21a0-401">Note that if D3DRS\_DEBUGMONITORTOKEN is set, the call is treated as passing a token to the debug monitor.</span></span> <span data-ttu-id="f21a0-402">Например, если параметр-After передает D3DDMT \_ Enable или D3DDMT \_ Disable в D3DRS \_ дебугмонитортокен-другие значения токена передаются, состояние (включено или отключено) монитора отладки сохраняется.</span><span class="sxs-lookup"><span data-stu-id="f21a0-402">For example, if - after passing D3DDMT\_ENABLE or D3DDMT\_DISABLE to D3DRS\_DEBUGMONITORTOKEN - other token values are passed in, the state (enabled or disabled) of the debug monitor will still persist.</span></span>

<span data-ttu-id="f21a0-403">Это состояние полезно только для отладочных сборок.</span><span class="sxs-lookup"><span data-stu-id="f21a0-403">This state is only useful for debug builds.</span></span> <span data-ttu-id="f21a0-404">По умолчанию монитор отладки имеет значение D3DDMT \_ Enable.</span><span class="sxs-lookup"><span data-stu-id="f21a0-404">The debug monitor defaults to D3DDMT\_ENABLE.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-405"><span id="D3DRS_POINTSIZE_MAX"></span><span id="d3drs_pointsize_max"></span>**D3DRS \_ POINTSIZE \_ Max**</span><span class="sxs-lookup"><span data-stu-id="f21a0-405"><span id="D3DRS_POINTSIZE_MAX"></span><span id="d3drs_pointsize_max"></span>**D3DRS\_POINTSIZE\_MAX**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-406">Значение float, указывающее максимальный размер, до которого будут относиться спрайты.</span><span class="sxs-lookup"><span data-stu-id="f21a0-406">A float value that specifies the maximum size to which point sprites will be clamped.</span></span> <span data-ttu-id="f21a0-407">Значение должно быть меньше или равно Макспоинтсизе члену [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) и больше или равно D3DRS \_ POINTSIZE \_ min.</span><span class="sxs-lookup"><span data-stu-id="f21a0-407">The value must be less than or equal to the MaxPointSize member of [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) and greater than or equal to D3DRS\_POINTSIZE\_MIN.</span></span> <span data-ttu-id="f21a0-408">Значение по умолчанию — 64,0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-408">The default value is 64.0.</span></span> <span data-ttu-id="f21a0-409">Так как метод [**IDirect3DDevice9:: сетрендерстате**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) принимает значения типа DWORD, приложение должно привести переменную, содержащую значение, как показано в следующем примере кода.</span><span class="sxs-lookup"><span data-stu-id="f21a0-409">Because the [**IDirect3DDevice9::SetRenderState**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) method accepts DWORD values, your application must cast a variable that contains the value, as shown in the following code example.</span></span>
...
<span data-ttu-id="f21a0-410"><span id="D3DRS_INDEXEDVERTEXBLENDENABLE"></span><span id="d3drs_indexedvertexblendenable"></span>**D3DRS \_ индекседвертексбленденабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-410"><span id="D3DRS_INDEXEDVERTEXBLENDENABLE"></span><span id="d3drs_indexedvertexblendenable"></span>**D3DRS\_INDEXEDVERTEXBLENDENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-411">Логическое значение, которое включает или отключает индексированное смешение вершин.</span><span class="sxs-lookup"><span data-stu-id="f21a0-411">bool value that enables or disables indexed vertex blending.</span></span> <span data-ttu-id="f21a0-412">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-412">The default value is **FALSE**.</span></span> <span data-ttu-id="f21a0-413">Если задано **значение true**, индексирование вершинного смешения включено.</span><span class="sxs-lookup"><span data-stu-id="f21a0-413">When set to **TRUE**, indexed vertex blending is enabled.</span></span> <span data-ttu-id="f21a0-414">Если задано **значение false**, индексирование вершинного смешения отключено.</span><span class="sxs-lookup"><span data-stu-id="f21a0-414">When set to **FALSE**, indexed vertex blending is disabled.</span></span> <span data-ttu-id="f21a0-415">Если это состояние рендеринга включено, пользователь должен передавать индексы матрицы в виде упакованной Двордвис каждой вершины.</span><span class="sxs-lookup"><span data-stu-id="f21a0-415">If this render state is enabled, the user must pass matrix indices as a packed DWORDwith every vertex.</span></span> <span data-ttu-id="f21a0-416">Если состояние прорисовки отключено и включен режим смешивания вершин через D3DRS \_ вертексбленд, то он эквивалентен индексам матриц 0, 1, 2, 3 в каждой вершине.</span><span class="sxs-lookup"><span data-stu-id="f21a0-416">When the render state is disabled and vertex blending is enabled through the D3DRS\_VERTEXBLEND state, it is equivalent to having matrix indices 0, 1, 2, 3 in every vertex.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-417"><span id="D3DRS_COLORWRITEENABLE"></span><span id="d3drs_colorwriteenable"></span>**D3DRS \_ колорвритинабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-417"><span id="D3DRS_COLORWRITEENABLE"></span><span id="d3drs_colorwriteenable"></span>**D3DRS\_COLORWRITEENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-418">Значение UINT, которое включает запись на канал для буфера цвета целевого объекта подготовки к просмотру.</span><span class="sxs-lookup"><span data-stu-id="f21a0-418">UINT value that enables a per-channel write for the render-target color buffer.</span></span> <span data-ttu-id="f21a0-419">Заданный бит приводит к изменению цветового канала во время трехмерной отрисовки.</span><span class="sxs-lookup"><span data-stu-id="f21a0-419">A set bit results in the color channel being updated during 3D rendering.</span></span> <span data-ttu-id="f21a0-420">Четкий бит приводит к неизменности канала цвета.</span><span class="sxs-lookup"><span data-stu-id="f21a0-420">A clear bit results in the color channel being unaffected.</span></span> <span data-ttu-id="f21a0-421">Эта функция доступна, если бит D3DPMISCCAPS \_ колорвритинабле может быть установлен в элементе примитивемисккапс структуры [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) для устройства.</span><span class="sxs-lookup"><span data-stu-id="f21a0-421">This functionality is available if the D3DPMISCCAPS\_COLORWRITEENABLE capabilities bit is set in the PrimitiveMiscCaps member of the [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) structure for the device.</span></span> <span data-ttu-id="f21a0-422">Это состояние визуализации не влияет на операцию очистки.</span><span class="sxs-lookup"><span data-stu-id="f21a0-422">This render state does not affect the clear operation.</span></span> <span data-ttu-id="f21a0-423">Значение по умолчанию — 0x0000000F.</span><span class="sxs-lookup"><span data-stu-id="f21a0-423">The default value is 0x0000000F.</span></span>

<span data-ttu-id="f21a0-424">Допустимые значения для этого состояния рендеринга: D3DCOLORWRITEENABLE \_ альфа, D3DCOLORWRITEENABLE \_ Blue, D3DCOLORWRITEENABLE \_ Green или D3DCOLORWRITEENABLE \_ Red flags.</span><span class="sxs-lookup"><span data-stu-id="f21a0-424">Valid values for this render state can be any combination of the D3DCOLORWRITEENABLE\_ALPHA, D3DCOLORWRITEENABLE\_BLUE, D3DCOLORWRITEENABLE\_GREEN, or D3DCOLORWRITEENABLE\_RED flags.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-425"><span id="D3DRS_TWEENFACTOR"></span><span id="d3drs_tweenfactor"></span>**D3DRS \_ твинфактор**</span><span class="sxs-lookup"><span data-stu-id="f21a0-425"><span id="D3DRS_TWEENFACTOR"></span><span id="d3drs_tweenfactor"></span>**D3DRS\_TWEENFACTOR**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-426">Значение float, которое управляет коэффициентом анимации.</span><span class="sxs-lookup"><span data-stu-id="f21a0-426">A float value that controls the tween factor.</span></span> <span data-ttu-id="f21a0-427">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-427">The default value is 0.0f.</span></span> <span data-ttu-id="f21a0-428">Так как метод [**IDirect3DDevice9:: сетрендерстате**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) принимает значения типа DWORD, приложение должно привести переменную, содержащую значение, как показано в следующем примере кода.</span><span class="sxs-lookup"><span data-stu-id="f21a0-428">Because the [**IDirect3DDevice9::SetRenderState**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate) method accepts DWORD values, your application must cast a variable that contains the value, as shown in the following code example.</span></span>
...
<span data-ttu-id="f21a0-429"><span id="D3DRS_BLENDOP"></span><span id="d3drs_blendop"></span>**D3DRS \_ блендоп**</span><span class="sxs-lookup"><span data-stu-id="f21a0-429"><span id="D3DRS_BLENDOP"></span><span id="d3drs_blendop"></span>**D3DRS\_BLENDOP**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-430">Значение, используемое для выбора арифметической операции, применяемой, когда в альфа-смешенном состоянии рендеринга D3DRS \_ алфабленденабле имеет значение **true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-430">Value used to select the arithmetic operation applied when the alpha blending render state, D3DRS\_ALPHABLENDENABLE, is set to **TRUE**.</span></span> <span data-ttu-id="f21a0-431">Допустимые значения определяются перечисляемым типом [**D3DBLENDOP**](./d3dblendop.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-431">Valid values are defined by the [**D3DBLENDOP**](./d3dblendop.md) enumerated type.</span></span> <span data-ttu-id="f21a0-432">Значение по умолчанию — D3DBLENDOP \_ Add.</span><span class="sxs-lookup"><span data-stu-id="f21a0-432">The default value is D3DBLENDOP\_ADD.</span></span>

<span data-ttu-id="f21a0-433">Если \_ возможность устройства D3DPMISCCAPS блендоп не поддерживается, \_ добавляется D3DBLENDOP Add.</span><span class="sxs-lookup"><span data-stu-id="f21a0-433">If the D3DPMISCCAPS\_BLENDOP device capability is not supported, then D3DBLENDOP\_ADD is performed.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-434"><span id="D3DRS_POSITIONDEGREE"></span><span id="d3drs_positiondegree"></span>**D3DRS \_ поситиондегри**</span><span class="sxs-lookup"><span data-stu-id="f21a0-434"><span id="D3DRS_POSITIONDEGREE"></span><span id="d3drs_positiondegree"></span>**D3DRS\_POSITIONDEGREE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-435">N — степень интерполяции для исправления.</span><span class="sxs-lookup"><span data-stu-id="f21a0-435">N-patch position interpolation degree.</span></span> <span data-ttu-id="f21a0-436">Значения могут быть D3DDEGREE \_ кубическим (по умолчанию) или D3DDEGREE \_ линейным.</span><span class="sxs-lookup"><span data-stu-id="f21a0-436">The values can be D3DDEGREE\_CUBIC (default) or D3DDEGREE\_LINEAR.</span></span> <span data-ttu-id="f21a0-437">Дополнительные сведения см. в разделе [**D3DDEGREETYPE**](./d3ddegreetype.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-437">For more information, see [**D3DDEGREETYPE**](./d3ddegreetype.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-438"><span id="D3DRS_NORMALDEGREE"></span><span id="d3drs_normaldegree"></span>**D3DRS \_ нормалдегри**</span><span class="sxs-lookup"><span data-stu-id="f21a0-438"><span id="D3DRS_NORMALDEGREE"></span><span id="d3drs_normaldegree"></span>**D3DRS\_NORMALDEGREE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-439">N — исправлять нормальную степень интерполяции.</span><span class="sxs-lookup"><span data-stu-id="f21a0-439">N-patch normal interpolation degree.</span></span> <span data-ttu-id="f21a0-440">Значения могут быть D3DDEGREE \_ линейным (по умолчанию) или D3DDEGREEным \_ квадратичным.</span><span class="sxs-lookup"><span data-stu-id="f21a0-440">The values can be D3DDEGREE\_LINEAR (default) or D3DDEGREE\_QUADRATIC.</span></span> <span data-ttu-id="f21a0-441">Дополнительные сведения см. в разделе [**D3DDEGREETYPE**](./d3ddegreetype.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-441">For more information, see [**D3DDEGREETYPE**](./d3ddegreetype.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-442"><span id="D3DRS_SCISSORTESTENABLE"></span><span id="d3drs_scissortestenable"></span>**D3DRS \_ сЦиссортестенабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-442"><span id="D3DRS_SCISSORTESTENABLE"></span><span id="d3drs_scissortestenable"></span>**D3DRS\_SCISSORTESTENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-443">**Значение true** , чтобы включить ножницное тестирование, и **false** , чтобы отключить его.</span><span class="sxs-lookup"><span data-stu-id="f21a0-443">**TRUE** to enable scissor testing and **FALSE** to disable it.</span></span> <span data-ttu-id="f21a0-444">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-444">The default value is **FALSE**.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-445"><span id="D3DRS_SLOPESCALEDEPTHBIAS"></span><span id="d3drs_slopescaledepthbias"></span>**D3DRS \_ слопескаледепсбиас**</span><span class="sxs-lookup"><span data-stu-id="f21a0-445"><span id="D3DRS_SLOPESCALEDEPTHBIAS"></span><span id="d3drs_slopescaledepthbias"></span>**D3DRS\_SLOPESCALEDEPTHBIAS**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-446">Используется для определения того, какой объем смещения можно применить к трехмерным примитивам для снижения степени борьбы с z.</span><span class="sxs-lookup"><span data-stu-id="f21a0-446">Used to determine how much bias can be applied to co-planar primitives to reduce z-fighting.</span></span> <span data-ttu-id="f21a0-447">Значение по умолчанию — 0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-447">The default value is 0.</span></span>

<span data-ttu-id="f21a0-448">смещение = (Max \* D3DRS \_ слопескаледепсбиас) + D3DRS \_ депсбиас.</span><span class="sxs-lookup"><span data-stu-id="f21a0-448">bias = (max \* D3DRS\_SLOPESCALEDEPTHBIAS) + D3DRS\_DEPTHBIAS.</span></span>

<span data-ttu-id="f21a0-449">где Max — это максимальная глубина глубины отображаемого треугольника.</span><span class="sxs-lookup"><span data-stu-id="f21a0-449">where max is the maximum depth slope of the triangle being rendered.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-450"><span id="D3DRS_ANTIALIASEDLINEENABLE"></span><span id="d3drs_antialiasedlineenable"></span>**D3DRS \_ антиалиаседлининабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-450"><span id="D3DRS_ANTIALIASEDLINEENABLE"></span><span id="d3drs_antialiasedlineenable"></span>**D3DRS\_ANTIALIASEDLINEENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-451">**Значение true** , чтобы включить сглаживание линий; **значение false** , чтобы отключить сглаживание линий.</span><span class="sxs-lookup"><span data-stu-id="f21a0-451">**TRUE** to enable line antialiasing, **FALSE** to disable line antialiasing.</span></span> <span data-ttu-id="f21a0-452">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-452">The default value is **FALSE**.</span></span>

<span data-ttu-id="f21a0-453">При подготовке к просмотру в многовыборочной цели рендеринга D3DRS \_ антиалиаседлининабле игнорируется и все строки отображаются с псевдонимами.</span><span class="sxs-lookup"><span data-stu-id="f21a0-453">When rendering to a multisample render target, D3DRS\_ANTIALIASEDLINEENABLE is ignored and all lines are rendered aliased.</span></span> <span data-ttu-id="f21a0-454">Используйте [**ID3DXLine**](id3dxline.md) для отображения сглаженных линий в многовыборочной цели рендеринга.</span><span class="sxs-lookup"><span data-stu-id="f21a0-454">Use [**ID3DXLine**](id3dxline.md) for antialiased line rendering in a multisample render target.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-455"><span id="D3DRS_MINTESSELLATIONLEVEL"></span><span id="d3drs_mintessellationlevel"></span>**D3DRS \_ минтесселлатионлевел**</span><span class="sxs-lookup"><span data-stu-id="f21a0-455"><span id="D3DRS_MINTESSELLATIONLEVEL"></span><span id="d3drs_mintessellationlevel"></span>**D3DRS\_MINTESSELLATIONLEVEL**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-456">Минимальный уровень тесселяции.</span><span class="sxs-lookup"><span data-stu-id="f21a0-456">Minimum tessellation level.</span></span> <span data-ttu-id="f21a0-457">Значение по умолчанию — 1,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-457">The default value is 1.0f.</span></span> <span data-ttu-id="f21a0-458">См. раздел [тесселяция (Direct3D 9)](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-458">See [Tessellation (Direct3D 9)](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-459"><span id="D3DRS_MAXTESSELLATIONLEVEL"></span><span id="d3drs_maxtessellationlevel"></span>**D3DRS \_ макстесселлатионлевел**</span><span class="sxs-lookup"><span data-stu-id="f21a0-459"><span id="D3DRS_MAXTESSELLATIONLEVEL"></span><span id="d3drs_maxtessellationlevel"></span>**D3DRS\_MAXTESSELLATIONLEVEL**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-460">Максимальный уровень тесселяции.</span><span class="sxs-lookup"><span data-stu-id="f21a0-460">Maximum tessellation level.</span></span> <span data-ttu-id="f21a0-461">Значение по умолчанию — 1,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-461">The default value is 1.0f.</span></span> <span data-ttu-id="f21a0-462">См. раздел [тесселяция (Direct3D 9)](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-462">See [Tessellation (Direct3D 9)](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-463"><span id="D3DRS_ADAPTIVETESS_X"></span><span id="d3drs_adaptivetess_x"></span>**D3DRS \_ адаптиветесс \_ X**</span><span class="sxs-lookup"><span data-stu-id="f21a0-463"><span id="D3DRS_ADAPTIVETESS_X"></span><span id="d3drs_adaptivetess_x"></span>**D3DRS\_ADAPTIVETESS\_X**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-464">Величина адаптивной мозаики в направлении по оси x.</span><span class="sxs-lookup"><span data-stu-id="f21a0-464">Amount to adaptively tessellate, in the x direction.</span></span> <span data-ttu-id="f21a0-465">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-465">Default value is 0.0f.</span></span> <span data-ttu-id="f21a0-466">См. раздел [Адаптивная тесселяция](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-466">See [Adaptive Tessellation](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-467"><span id="D3DRS_ADAPTIVETESS_Y"></span><span id="d3drs_adaptivetess_y"></span>**D3DRS \_ адаптиветесс \_ Y**</span><span class="sxs-lookup"><span data-stu-id="f21a0-467"><span id="D3DRS_ADAPTIVETESS_Y"></span><span id="d3drs_adaptivetess_y"></span>**D3DRS\_ADAPTIVETESS\_Y**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-468">Величина адаптивной мозаики в направлении оси y.</span><span class="sxs-lookup"><span data-stu-id="f21a0-468">Amount to adaptively tessellate, in the y direction.</span></span> <span data-ttu-id="f21a0-469">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-469">Default value is 0.0f.</span></span> <span data-ttu-id="f21a0-470">См. раздел [Адаптивная \_ тесселяция](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-470">See [Adaptive\_Tessellation](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-471"><span id="D3DRS_ADAPTIVETESS_Z"></span><span id="d3drs_adaptivetess_z"></span>**D3DRS \_ адаптиветесс \_ Z**</span><span class="sxs-lookup"><span data-stu-id="f21a0-471"><span id="D3DRS_ADAPTIVETESS_Z"></span><span id="d3drs_adaptivetess_z"></span>**D3DRS\_ADAPTIVETESS\_Z**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-472">Величина адаптивной мозаики в направлении по оси z.</span><span class="sxs-lookup"><span data-stu-id="f21a0-472">Amount to adaptively tessellate, in the z direction.</span></span> <span data-ttu-id="f21a0-473">Значение по умолчанию — 1,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-473">Default value is 1.0f.</span></span> <span data-ttu-id="f21a0-474">См. раздел [Адаптивная \_ тесселяция](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-474">See [Adaptive\_Tessellation](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-475"><span id="D3DRS_ADAPTIVETESS_W"></span><span id="d3drs_adaptivetess_w"></span>**D3DRS \_ адаптиветесс \_ W**</span><span class="sxs-lookup"><span data-stu-id="f21a0-475"><span id="D3DRS_ADAPTIVETESS_W"></span><span id="d3drs_adaptivetess_w"></span>**D3DRS\_ADAPTIVETESS\_W**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-476">Величина адаптивной тесселяции в направлении "w".</span><span class="sxs-lookup"><span data-stu-id="f21a0-476">Amount to adaptively tessellate, in the w direction.</span></span> <span data-ttu-id="f21a0-477">Значение по умолчанию — 0,0 f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-477">Default value is 0.0f.</span></span> <span data-ttu-id="f21a0-478">См. раздел [Адаптивная \_ тесселяция](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-478">See [Adaptive\_Tessellation](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-479"><span id="D3DRS_ENABLEADAPTIVETESSELLATION"></span><span id="d3drs_enableadaptivetessellation"></span>**D3DRS \_ енаблеадаптиветесселлатион**</span><span class="sxs-lookup"><span data-stu-id="f21a0-479"><span id="D3DRS_ENABLEADAPTIVETESSELLATION"></span><span id="d3drs_enableadaptivetessellation"></span>**D3DRS\_ENABLEADAPTIVETESSELLATION**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-480">**Значение true** , чтобы включить адаптивную тесселяцию, и **false** для отключения.</span><span class="sxs-lookup"><span data-stu-id="f21a0-480">**TRUE** to enable adaptive tessellation, **FALSE** to disable it.</span></span> <span data-ttu-id="f21a0-481">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-481">The default value is **FALSE**.</span></span> <span data-ttu-id="f21a0-482">См. раздел [Адаптивная \_ тесселяция](tessellation.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-482">See [Adaptive\_Tessellation](tessellation.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-483"><span id="D3DRS_TWOSIDEDSTENCILMODE"></span><span id="d3drs_twosidedstencilmode"></span>**D3DRS \_ твосидедстенЦилмоде**</span><span class="sxs-lookup"><span data-stu-id="f21a0-483"><span id="D3DRS_TWOSIDEDSTENCILMODE"></span><span id="d3drs_twosidedstencilmode"></span>**D3DRS\_TWOSIDEDSTENCILMODE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-484">**Значение true** включает двухстороннее набор элементов, **false** — отключает его.</span><span class="sxs-lookup"><span data-stu-id="f21a0-484">**TRUE** enables two-sided stenciling, **FALSE** disables it.</span></span> <span data-ttu-id="f21a0-485">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-485">The default value is **FALSE**.</span></span> <span data-ttu-id="f21a0-486">Приложение должно установить D3DRS \_ куллмоде в значение D3DCULL \_ None, чтобы включить режим с двумя сторонами набора элементов.</span><span class="sxs-lookup"><span data-stu-id="f21a0-486">The application should set D3DRS\_CULLMODE to D3DCULL\_NONE to enable two-sided stencil mode.</span></span> <span data-ttu-id="f21a0-487">Если порядок заполнения треугольника является по часовой стрелке, \_ будут использоваться операции с набором элементов D3DRS \* .</span><span class="sxs-lookup"><span data-stu-id="f21a0-487">If the triangle winding order is clockwise, the D3DRS\_STENCIL\* operations will be used.</span></span> <span data-ttu-id="f21a0-488">Если порядок поворота имеет значение против часовой стрелки, \_ \_ будут использоваться операции с набором элементов D3DRS CCW \* .</span><span class="sxs-lookup"><span data-stu-id="f21a0-488">If the winding order is counterclockwise, the D3DRS\_CCW\_STENCIL\* operations will be used.</span></span>

<span data-ttu-id="f21a0-489">Чтобы узнать, поддерживается ли двусторонний набор элементов, проверьте элемент СтенЦилкапс в [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) для D3DSTENCILCAPS \_ твосидед.</span><span class="sxs-lookup"><span data-stu-id="f21a0-489">To see if two-sided stencil is supported, check the StencilCaps member of [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) for D3DSTENCILCAPS\_TWOSIDED.</span></span> <span data-ttu-id="f21a0-490">См. также [D3DSTENCILCAPS](d3dstencilcaps.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-490">See also [D3DSTENCILCAPS](d3dstencilcaps.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-491"><span id="D3DRS_CCW_STENCILFAIL"></span><span id="d3drs_ccw_stencilfail"></span>**D3DRS \_ CCW \_ стенЦилфаил**</span><span class="sxs-lookup"><span data-stu-id="f21a0-491"><span id="D3DRS_CCW_STENCILFAIL"></span><span id="d3drs_ccw_stencilfail"></span>**D3DRS\_CCW\_STENCILFAIL**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-492">Операция с набором элементов, выполняемая при сбое теста трафарета CCW.</span><span class="sxs-lookup"><span data-stu-id="f21a0-492">Stencil operation to perform if CCW stencil test fails.</span></span> <span data-ttu-id="f21a0-493">Значения из перечисляемого типа [**D3DSTENCILOP**](./d3dstencilop.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-493">Values are from the [**D3DSTENCILOP**](./d3dstencilop.md) enumerated type.</span></span> <span data-ttu-id="f21a0-494">Значение по умолчанию — D3DSTENCILOP \_ держитесь.</span><span class="sxs-lookup"><span data-stu-id="f21a0-494">The default value is D3DSTENCILOP\_KEEP.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-495"><span id="D3DRS_CCW_STENCILZFAIL"></span><span id="d3drs_ccw_stencilzfail"></span>**D3DRS \_ CCW \_ стенЦилзфаил**</span><span class="sxs-lookup"><span data-stu-id="f21a0-495"><span id="D3DRS_CCW_STENCILZFAIL"></span><span id="d3drs_ccw_stencilzfail"></span>**D3DRS\_CCW\_STENCILZFAIL**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-496">Операция с набором элементов, которую необходимо выполнить, если пройден тест шаблона CCW и не пройден z-тест.</span><span class="sxs-lookup"><span data-stu-id="f21a0-496">Stencil operation to perform if CCW stencil test passes and z-test fails.</span></span> <span data-ttu-id="f21a0-497">Значения из перечисляемого типа [**D3DSTENCILOP**](./d3dstencilop.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-497">Values are from the [**D3DSTENCILOP**](./d3dstencilop.md) enumerated type.</span></span> <span data-ttu-id="f21a0-498">Значение по умолчанию — D3DSTENCILOP \_ держитесь.</span><span class="sxs-lookup"><span data-stu-id="f21a0-498">The default value is D3DSTENCILOP\_KEEP.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-499"><span id="D3DRS_CCW_STENCILPASS"></span><span id="d3drs_ccw_stencilpass"></span>**D3DRS \_ CCW \_ стенЦилпасс**</span><span class="sxs-lookup"><span data-stu-id="f21a0-499"><span id="D3DRS_CCW_STENCILPASS"></span><span id="d3drs_ccw_stencilpass"></span>**D3DRS\_CCW\_STENCILPASS**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-500">Операция с набором элементов, выполняемая, если пройден и набор элементов, и z-тесты.</span><span class="sxs-lookup"><span data-stu-id="f21a0-500">Stencil operation to perform if both CCW stencil and z-tests pass.</span></span> <span data-ttu-id="f21a0-501">Значения из перечисляемого типа [**D3DSTENCILOP**](./d3dstencilop.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-501">Values are from the [**D3DSTENCILOP**](./d3dstencilop.md) enumerated type.</span></span> <span data-ttu-id="f21a0-502">Значение по умолчанию — D3DSTENCILOP \_ держитесь.</span><span class="sxs-lookup"><span data-stu-id="f21a0-502">The default value is D3DSTENCILOP\_KEEP.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-503"><span id="D3DRS_CCW_STENCILFUNC"></span><span id="d3drs_ccw_stencilfunc"></span>**D3DRS \_ CCW \_ стенЦилфунк**</span><span class="sxs-lookup"><span data-stu-id="f21a0-503"><span id="D3DRS_CCW_STENCILFUNC"></span><span id="d3drs_ccw_stencilfunc"></span>**D3DRS\_CCW\_STENCILFUNC**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-504">Функция сравнения.</span><span class="sxs-lookup"><span data-stu-id="f21a0-504">The comparison function.</span></span> <span data-ttu-id="f21a0-505">Проверка трафаретного шаблона CCW передается, если функция шаблона ((ref & Mask) (маска шаблона &)) имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-505">CCW stencil test passes if ((ref & mask) stencil function (stencil & mask)) is **TRUE**.</span></span> <span data-ttu-id="f21a0-506">Значения из перечисляемого типа [**D3DCMPFUNC**](./d3dcmpfunc.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-506">Values are from the [**D3DCMPFUNC**](./d3dcmpfunc.md) enumerated type.</span></span> <span data-ttu-id="f21a0-507">Значение по умолчанию — D3DCMP \_ Always.</span><span class="sxs-lookup"><span data-stu-id="f21a0-507">The default value is D3DCMP\_ALWAYS.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-508"><span id="D3DRS_COLORWRITEENABLE1"></span><span id="d3drs_colorwriteenable1"></span>**D3DRS \_ COLORWRITEENABLE1**</span><span class="sxs-lookup"><span data-stu-id="f21a0-508"><span id="D3DRS_COLORWRITEENABLE1"></span><span id="d3drs_colorwriteenable1"></span>**D3DRS\_COLORWRITEENABLE1**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-509">Дополнительные значения Колорвритинабле для устройств.</span><span class="sxs-lookup"><span data-stu-id="f21a0-509">Additional ColorWriteEnable values for the devices.</span></span> <span data-ttu-id="f21a0-510">См. раздел D3DRS \_ колорвритинабле.</span><span class="sxs-lookup"><span data-stu-id="f21a0-510">See D3DRS\_COLORWRITEENABLE.</span></span> <span data-ttu-id="f21a0-511">Эта функция доступна, если бит D3DPMISCCAPS \_ индепендентвритемаскс может быть установлен в элементе примитивемисккапс структуры [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) для устройства.</span><span class="sxs-lookup"><span data-stu-id="f21a0-511">This functionality is available if the D3DPMISCCAPS\_INDEPENDENTWRITEMASKS capabilities bit is set in the PrimitiveMiscCaps member of the [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) structure for the device.</span></span> <span data-ttu-id="f21a0-512">Значение по умолчанию — 0x0000000f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-512">The default value is 0x0000000f.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-513"><span id="D3DRS_COLORWRITEENABLE2"></span><span id="d3drs_colorwriteenable2"></span>**D3DRS \_ COLORWRITEENABLE2**</span><span class="sxs-lookup"><span data-stu-id="f21a0-513"><span id="D3DRS_COLORWRITEENABLE2"></span><span id="d3drs_colorwriteenable2"></span>**D3DRS\_COLORWRITEENABLE2**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-514">Дополнительные значения Колорвритинабле для устройств.</span><span class="sxs-lookup"><span data-stu-id="f21a0-514">Additional ColorWriteEnable values for the devices.</span></span> <span data-ttu-id="f21a0-515">См. раздел D3DRS \_ колорвритинабле.</span><span class="sxs-lookup"><span data-stu-id="f21a0-515">See D3DRS\_COLORWRITEENABLE.</span></span> <span data-ttu-id="f21a0-516">Эта функция доступна, если бит D3DPMISCCAPS \_ индепендентвритемаскс может быть установлен в элементе примитивемисккапс структуры [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) для устройства.</span><span class="sxs-lookup"><span data-stu-id="f21a0-516">This functionality is available if the D3DPMISCCAPS\_INDEPENDENTWRITEMASKS capabilities bit is set in the PrimitiveMiscCaps member of the [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) structure for the device.</span></span> <span data-ttu-id="f21a0-517">Значение по умолчанию — 0x0000000f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-517">The default value is 0x0000000f.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-518"><span id="D3DRS_COLORWRITEENABLE3"></span><span id="d3drs_colorwriteenable3"></span>**D3DRS \_ COLORWRITEENABLE3**</span><span class="sxs-lookup"><span data-stu-id="f21a0-518"><span id="D3DRS_COLORWRITEENABLE3"></span><span id="d3drs_colorwriteenable3"></span>**D3DRS\_COLORWRITEENABLE3**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-519">Дополнительные значения Колорвритинабле для устройств.</span><span class="sxs-lookup"><span data-stu-id="f21a0-519">Additional ColorWriteEnable values for the devices.</span></span> <span data-ttu-id="f21a0-520">См. раздел D3DRS \_ колорвритинабле.</span><span class="sxs-lookup"><span data-stu-id="f21a0-520">See D3DRS\_COLORWRITEENABLE.</span></span> <span data-ttu-id="f21a0-521">Эта функция доступна, если бит D3DPMISCCAPS \_ индепендентвритемаскс может быть установлен в элементе примитивемисккапс структуры [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) для устройства.</span><span class="sxs-lookup"><span data-stu-id="f21a0-521">This functionality is available if the D3DPMISCCAPS\_INDEPENDENTWRITEMASKS capabilities bit is set in the PrimitiveMiscCaps member of the [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) structure for the device.</span></span> <span data-ttu-id="f21a0-522">Значение по умолчанию — 0x0000000f.</span><span class="sxs-lookup"><span data-stu-id="f21a0-522">The default value is 0x0000000f.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-523"><span id="D3DRS_BLENDFACTOR"></span><span id="d3drs_blendfactor"></span>**D3DRS \_ блендфактор**</span><span class="sxs-lookup"><span data-stu-id="f21a0-523"><span id="D3DRS_BLENDFACTOR"></span><span id="d3drs_blendfactor"></span>**D3DRS\_BLENDFACTOR**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-524">[**D3DCOLOR**](d3dcolor.md) используется для константного коэффициента смешения во время альфа-смешения.</span><span class="sxs-lookup"><span data-stu-id="f21a0-524">[**D3DCOLOR**](d3dcolor.md) used for a constant blend-factor during alpha blending.</span></span> <span data-ttu-id="f21a0-525">Эта функция доступна, если бит D3DPBLENDCAPS \_ блендфактор может быть установлен в сркблендкапс член [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) или **дестблендкапс D3DCAPS9**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-525">This functionality is available if the D3DPBLENDCAPS\_BLENDFACTOR capabilities bit is set in the SrcBlendCaps member of [**D3DCAPS9**](/windows/desktop/api/D3D9Caps/ns-d3d9caps-d3dcaps9) or the DestBlendCaps member of **D3DCAPS9**.</span></span> <span data-ttu-id="f21a0-526">См. [**D3DRENDERSTATETYPE**]().</span><span class="sxs-lookup"><span data-stu-id="f21a0-526">See [**D3DRENDERSTATETYPE**]().</span></span> <span data-ttu-id="f21a0-527">Значение по умолчанию — 0xFFFFFFFF.</span><span class="sxs-lookup"><span data-stu-id="f21a0-527">The default value is 0xffffffff.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-528"><span id="D3DRS_SRGBWRITEENABLE"></span><span id="d3drs_srgbwriteenable"></span>**D3DRS \_ сргбвритинабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-528"><span id="D3DRS_SRGBWRITEENABLE"></span><span id="d3drs_srgbwriteenable"></span>**D3DRS\_SRGBWRITEENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-529">Включение подготовки к просмотру для исправления гаммы в sRGB.</span><span class="sxs-lookup"><span data-stu-id="f21a0-529">Enable render-target writes to be gamma corrected to sRGB.</span></span> <span data-ttu-id="f21a0-530">Формат должен предоставлять D3DUSAGE \_ сргбврите.</span><span class="sxs-lookup"><span data-stu-id="f21a0-530">The format must expose D3DUSAGE\_SRGBWRITE.</span></span> <span data-ttu-id="f21a0-531">Значение по умолчанию — 0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-531">The default value is 0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-532"><span id="D3DRS_DEPTHBIAS"></span><span id="d3drs_depthbias"></span>**D3DRS \_ депсбиас**</span><span class="sxs-lookup"><span data-stu-id="f21a0-532"><span id="D3DRS_DEPTHBIAS"></span><span id="d3drs_depthbias"></span>**D3DRS\_DEPTHBIAS**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-533">Значение с плавающей запятой, используемое для сравнения значений глубины.</span><span class="sxs-lookup"><span data-stu-id="f21a0-533">A floating-point value that is used for comparison of depth values.</span></span> <span data-ttu-id="f21a0-534">См. раздел [смещение глубины (Direct3D 9)](depth-bias.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-534">See [Depth Bias (Direct3D 9)](depth-bias.md).</span></span> <span data-ttu-id="f21a0-535">Значение по умолчанию — 0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-535">The default value is 0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-536"><span id="D3DRS_WRAP8"></span><span id="d3drs_wrap8"></span>**D3DRS \_ WRAP8**</span><span class="sxs-lookup"><span data-stu-id="f21a0-536"><span id="D3DRS_WRAP8"></span><span id="d3drs_wrap8"></span>**D3DRS\_WRAP8**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-537">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-537">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-538"><span id="D3DRS_WRAP9"></span><span id="d3drs_wrap9"></span>**D3DRS \_ WRAP9**</span><span class="sxs-lookup"><span data-stu-id="f21a0-538"><span id="D3DRS_WRAP9"></span><span id="d3drs_wrap9"></span>**D3DRS\_WRAP9**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-539">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-539">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-540"><span id="D3DRS_WRAP10"></span><span id="d3drs_wrap10"></span>**D3DRS \_ WRAP10**</span><span class="sxs-lookup"><span data-stu-id="f21a0-540"><span id="D3DRS_WRAP10"></span><span id="d3drs_wrap10"></span>**D3DRS\_WRAP10**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-541">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-541">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-542"><span id="D3DRS_WRAP11"></span><span id="d3drs_wrap11"></span>**D3DRS \_ WRAP11**</span><span class="sxs-lookup"><span data-stu-id="f21a0-542"><span id="D3DRS_WRAP11"></span><span id="d3drs_wrap11"></span>**D3DRS\_WRAP11**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-543">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-543">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-544"><span id="D3DRS_WRAP12"></span><span id="d3drs_wrap12"></span>**D3DRS \_ WRAP12**</span><span class="sxs-lookup"><span data-stu-id="f21a0-544"><span id="D3DRS_WRAP12"></span><span id="d3drs_wrap12"></span>**D3DRS\_WRAP12**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-545">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-545">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-546"><span id="D3DRS_WRAP13"></span><span id="d3drs_wrap13"></span>**D3DRS \_ WRAP13**</span><span class="sxs-lookup"><span data-stu-id="f21a0-546"><span id="D3DRS_WRAP13"></span><span id="d3drs_wrap13"></span>**D3DRS\_WRAP13**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-547">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-547">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-548"><span id="D3DRS_WRAP14"></span><span id="d3drs_wrap14"></span>**D3DRS \_ WRAP14**</span><span class="sxs-lookup"><span data-stu-id="f21a0-548"><span id="D3DRS_WRAP14"></span><span id="d3drs_wrap14"></span>**D3DRS\_WRAP14**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-549">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-549">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-550"><span id="D3DRS_WRAP15"></span><span id="d3drs_wrap15"></span>**D3DRS \_ WRAP15**</span><span class="sxs-lookup"><span data-stu-id="f21a0-550"><span id="D3DRS_WRAP15"></span><span id="d3drs_wrap15"></span>**D3DRS\_WRAP15**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-551">См. раздел D3DRS \_ WRAP0.</span><span class="sxs-lookup"><span data-stu-id="f21a0-551">See D3DRS\_WRAP0.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-552"><span id="D3DRS_SEPARATEALPHABLENDENABLE"></span><span id="d3drs_separatealphablendenable"></span>**D3DRS \_ сепаратеалфабленденабле**</span><span class="sxs-lookup"><span data-stu-id="f21a0-552"><span id="D3DRS_SEPARATEALPHABLENDENABLE"></span><span id="d3drs_separatealphablendenable"></span>**D3DRS\_SEPARATEALPHABLENDENABLE**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-553">**Значение true** включает отдельный режим смешения для альфа-канала.</span><span class="sxs-lookup"><span data-stu-id="f21a0-553">**TRUE** enables the separate blend mode for the alpha channel.</span></span> <span data-ttu-id="f21a0-554">Значение по умолчанию — **FALSE**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-554">The default value is **FALSE**.</span></span>

<span data-ttu-id="f21a0-555">Если задано **значение false**, то коэффициенты смешения и операции, применяемые к альфа-каналу, должны быть такими же, как и для цвета.</span><span class="sxs-lookup"><span data-stu-id="f21a0-555">When set to **FALSE**, the render-target blending factors and operations applied to alpha are forced to be the same as those defined for color.</span></span> <span data-ttu-id="f21a0-556">Этот режим фактически **прикован в реализации** , не устанавливая ограничение D3DPMISCCAPS \_ сепаратеалфабленд.</span><span class="sxs-lookup"><span data-stu-id="f21a0-556">This mode is effectively hardwired to **FALSE** on implementations that don't set the cap D3DPMISCCAPS\_SEPARATEALPHABLEND.</span></span> <span data-ttu-id="f21a0-557">См. [D3DPMISCCAPS](d3dpmisccaps.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-557">See [D3DPMISCCAPS](d3dpmisccaps.md).</span></span>

<span data-ttu-id="f21a0-558">Тип отдельного альфа-смешения определяется с помощью \_ состояний отрисовки D3DRS сркблендалфа и D3DRS \_ дестблендалфа.</span><span class="sxs-lookup"><span data-stu-id="f21a0-558">The type of separate alpha blending is determined by the D3DRS\_SRCBLENDALPHA and D3DRS\_DESTBLENDALPHA render states.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-559"><span id="D3DRS_SRCBLENDALPHA"></span><span id="d3drs_srcblendalpha"></span>**D3DRS \_ сркблендалфа**</span><span class="sxs-lookup"><span data-stu-id="f21a0-559"><span id="D3DRS_SRCBLENDALPHA"></span><span id="d3drs_srcblendalpha"></span>**D3DRS\_SRCBLENDALPHA**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-560">Один член перечисляемого типа [**D3DBLEND**](./d3dblend.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-560">One member of the [**D3DBLEND**](./d3dblend.md) enumerated type.</span></span> <span data-ttu-id="f21a0-561">Это значение игнорируется, если D3DRS \_ сепаратеалфабленденабле имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-561">This value is ignored unless D3DRS\_SEPARATEALPHABLENDENABLE is **TRUE**.</span></span> <span data-ttu-id="f21a0-562">Значение по умолчанию — D3DBLEND \_ 1.</span><span class="sxs-lookup"><span data-stu-id="f21a0-562">The default value is D3DBLEND\_ONE.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-563"><span id="D3DRS_DESTBLENDALPHA"></span><span id="d3drs_destblendalpha"></span>**D3DRS \_ дестблендалфа**</span><span class="sxs-lookup"><span data-stu-id="f21a0-563"><span id="D3DRS_DESTBLENDALPHA"></span><span id="d3drs_destblendalpha"></span>**D3DRS\_DESTBLENDALPHA**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-564">Один член перечисляемого типа [**D3DBLEND**](./d3dblend.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-564">One member of the [**D3DBLEND**](./d3dblend.md) enumerated type.</span></span> <span data-ttu-id="f21a0-565">Это значение игнорируется, если D3DRS \_ сепаратеалфабленденабле имеет **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-565">This value is ignored unless D3DRS\_SEPARATEALPHABLENDENABLE is **TRUE**.</span></span> <span data-ttu-id="f21a0-566">Значение по умолчанию — D3DBLEND \_ нуль.</span><span class="sxs-lookup"><span data-stu-id="f21a0-566">The default value is D3DBLEND\_ZERO.</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-567"><span id="D3DRS_BLENDOPALPHA"></span><span id="d3drs_blendopalpha"></span>**D3DRS \_ блендопалфа**</span><span class="sxs-lookup"><span data-stu-id="f21a0-567"><span id="D3DRS_BLENDOPALPHA"></span><span id="d3drs_blendopalpha"></span>**D3DRS\_BLENDOPALPHA**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-568">Значение, используемое для выбора арифметической операции, применяемой к отдельной альфа-смешению, когда для состояния отрисовки D3DRS \_ сепаратеалфабленденабле задано **значение true**.</span><span class="sxs-lookup"><span data-stu-id="f21a0-568">Value used to select the arithmetic operation applied to separate alpha blending when the render state, D3DRS\_SEPARATEALPHABLENDENABLE, is set to **TRUE**.</span></span>

<span data-ttu-id="f21a0-569">Допустимые значения определяются перечисляемым типом [**D3DBLENDOP**](./d3dblendop.md) .</span><span class="sxs-lookup"><span data-stu-id="f21a0-569">Valid values are defined by the [**D3DBLENDOP**](./d3dblendop.md) enumerated type.</span></span> <span data-ttu-id="f21a0-570">Значение по умолчанию — D3DBLENDOP \_ Add.</span><span class="sxs-lookup"><span data-stu-id="f21a0-570">The default value is D3DBLENDOP\_ADD.</span></span>

<span data-ttu-id="f21a0-571">Если \_ возможность устройства D3DPMISCCAPS блендоп не поддерживается, \_ добавляется D3DBLENDOP Add.</span><span class="sxs-lookup"><span data-stu-id="f21a0-571">If the D3DPMISCCAPS\_BLENDOP device capability is not supported, then D3DBLENDOP\_ADD is performed.</span></span> <span data-ttu-id="f21a0-572">См. [D3DPMISCCAPS](d3dpmisccaps.md).</span><span class="sxs-lookup"><span data-stu-id="f21a0-572">See [D3DPMISCCAPS](d3dpmisccaps.md).</span></span>

</dd> <dt>

<span data-ttu-id="f21a0-573"><span id="D3DRS_FORCE_DWORD"></span><span id="d3drs_force_dword"></span>**D3DRS \_ Force \_ DWORD**</span><span class="sxs-lookup"><span data-stu-id="f21a0-573"><span id="D3DRS_FORCE_DWORD"></span><span id="d3drs_force_dword"></span>**D3DRS\_FORCE\_DWORD**</span></span>
</dt> <dd>

<span data-ttu-id="f21a0-574">Заставляет это перечисление компилироваться до 32 бит в размере.</span><span class="sxs-lookup"><span data-stu-id="f21a0-574">Forces this enumeration to compile to 32 bits in size.</span></span> <span data-ttu-id="f21a0-575">Без этого значения некоторые компиляторы позволяли бы компилировать это перечисление до размера, отличного от 32 бит.</span><span class="sxs-lookup"><span data-stu-id="f21a0-575">Without this value, some compilers would allow this enumeration to compile to a size other than 32 bits.</span></span> <span data-ttu-id="f21a0-576">Это значение не используется.</span><span class="sxs-lookup"><span data-stu-id="f21a0-576">This value is not used.</span></span>

</dd> </dl>

## <a name="remarks"></a><span data-ttu-id="f21a0-577">Remarks</span><span class="sxs-lookup"><span data-stu-id="f21a0-577">Remarks</span></span>



| <span data-ttu-id="f21a0-578">Состояния отрисовки</span><span class="sxs-lookup"><span data-stu-id="f21a0-578">Render states</span></span>        |   <span data-ttu-id="f21a0-579">Образец текстуры</span><span class="sxs-lookup"><span data-stu-id="f21a0-579">Texture sampler</span></span>                 |
|----------------------|--------------------|
| <span data-ttu-id="f21a0-580">PS \_ 1 \_ 1 – PS \_ 1 \_ 3</span><span class="sxs-lookup"><span data-stu-id="f21a0-580">ps\_1\_1 to ps\_1\_3</span></span> | <span data-ttu-id="f21a0-581">4 образцов текстуры</span><span class="sxs-lookup"><span data-stu-id="f21a0-581">4 texture samplers</span></span> |



 

<span data-ttu-id="f21a0-582">Direct3D определяет \_ константу D3DRENDERSTATE врапбиас в качестве удобства для включения или отключения переноса текстур на основе нуля целого числа набора координат текстуры (вместо явного использования одного из значений состояния D3DRS, переданных по \_ словам n).</span><span class="sxs-lookup"><span data-stu-id="f21a0-582">Direct3D defines the D3DRENDERSTATE\_WRAPBIAS constant as a convenience for applications to enable or disable texture wrapping, based on the zero-based integer of a texture coordinate set (rather than explicitly using one of the D3DRS\_WRAP n state values).</span></span> <span data-ttu-id="f21a0-583">Добавьте значение D3DRENDERSTATE \_ врапбиас в Отсчитываемый от нуля индекс набора координат текстуры, чтобы вычислить \_ значение D3DRS Wrap n, соответствующее этому индексу, как показано в следующем примере.</span><span class="sxs-lookup"><span data-stu-id="f21a0-583">Add the D3DRENDERSTATE\_WRAPBIAS value to the zero-based index of a texture coordinate set to calculate the D3DRS\_WRAP n value that corresponds to that index, as shown in the following example.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="f21a0-584">Требования</span><span class="sxs-lookup"><span data-stu-id="f21a0-584">Requirements</span></span>



| <span data-ttu-id="f21a0-585">Требование</span><span class="sxs-lookup"><span data-stu-id="f21a0-585">Requirement</span></span> | <span data-ttu-id="f21a0-586">Значение</span><span class="sxs-lookup"><span data-stu-id="f21a0-586">Value</span></span> |
|-------------------|----------------------------------------------------------------------------------------|
| <span data-ttu-id="f21a0-587">Заголовок</span><span class="sxs-lookup"><span data-stu-id="f21a0-587">Header</span></span><br/> | <dl> <span data-ttu-id="f21a0-588"><dt>D3D9Types. h</dt></span><span class="sxs-lookup"><span data-stu-id="f21a0-588"><dt>D3D9Types.h</dt></span></span> </dl> |



## <a name="see-also"></a><span data-ttu-id="f21a0-589">См. также</span><span class="sxs-lookup"><span data-stu-id="f21a0-589">See also</span></span>

<dl> <dt>

[<span data-ttu-id="f21a0-590">Перечисления Direct3D</span><span class="sxs-lookup"><span data-stu-id="f21a0-590">Direct3D Enumerations</span></span>](dx9-graphics-reference-d3d-enums.md)
</dt> <dt>

[<span data-ttu-id="f21a0-591">**IDirect3DDevice9:: Жетрендерстате**</span><span class="sxs-lookup"><span data-stu-id="f21a0-591">**IDirect3DDevice9::GetRenderState**</span></span>](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-getrenderstate)
</dt> <dt>

[<span data-ttu-id="f21a0-592">**IDirect3DDevice9::SetRenderState**</span><span class="sxs-lookup"><span data-stu-id="f21a0-592">**IDirect3DDevice9::SetRenderState**</span></span>](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-setrenderstate)
</dt> </dl>
