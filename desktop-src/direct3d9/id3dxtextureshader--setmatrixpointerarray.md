...
Задает массив указателей на нестандартные матрицы.
...
Уникальный идентификатор массива константных матриц. См. [D3DXHANDLE](d3dxfx.md).
...
Массив указателей на нестандартные матрицы. См. [**D3DXMATRIX**](d3dxmatrix.md).
