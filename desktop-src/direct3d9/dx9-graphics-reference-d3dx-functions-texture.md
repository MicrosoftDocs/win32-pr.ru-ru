...
ms.locfileid: "119728173"
---
# <a name="texture-functions-in-d3dx-9"></a>Функции текстуры в D3DX 9

D3DX предоставляет следующие функции текстурирования.
...
[Функции D3DX](dx9-graphics-reference-d3dx-functions.md)
</dt> <dt>
