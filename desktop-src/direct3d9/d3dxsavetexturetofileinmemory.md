...
---
# <a name="d3dxsavetexturetofileinmemory-function"></a>Функция D3DXSaveTextureToFileInMemory
...
Указатель на интерфейс [**IDirect3DBaseTexture9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dbasetexture9) , содержащий изображение для сохранения.
