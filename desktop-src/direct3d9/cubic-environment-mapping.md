...
## <a name="mipmapped-cubic-environment-maps"></a>Карты мипмаппед кубических окружений
...
## <a name="texture-coordinates-for-cubic-environment-maps"></a>координаты текстуры для Карты в кубических окружениях
