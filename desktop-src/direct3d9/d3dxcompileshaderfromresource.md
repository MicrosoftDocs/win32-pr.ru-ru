...
Необязательный указатель интерфейса, [**ID3DXInclude**](id3dxinclude.md), используемый для обработки \# директив include. Если это значение равно **null**, то \# включается либо при компиляции из файла, либо при компиляции из ресурса или памяти.
