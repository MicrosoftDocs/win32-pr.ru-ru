...
ms.locfileid: "118988322"
---
# <a name="d3dxsavetexturetofile-function"></a>Функция D3DXSaveTextureToFile
...
Указатель на интерфейс [**IDirect3DBaseTexture9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3dbasetexture9) , содержащий текстуру, которую необходимо сохранить.
