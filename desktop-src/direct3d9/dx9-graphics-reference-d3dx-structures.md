---
description: В этом разделе содержатся сведения о структурах, которые включены в библиотеку служебной программы D3DX в графике Direct3D 9.
...
ms.locfileid: "119728214"
---
# <a name="d3dx-structures-direct3d-9-graphics"></a>Структуры D3DX (графика Direct3D 9)
...
-   [**Расширения D3DXPLANE**](d3dxplane-extensions.md)
-   [**D3DXQUATERNION**](d3dxquaternion.md)
-   [**Расширения D3DXQUATERNION**](d3dxquaternion-extensions.md)
-   [**D3DXRTE \_ DESC**](d3dxrte-desc.md)
-   [**D3DXRTS \_ DESC**](d3dxrts-desc.md)
-   [**D3DXSHADER \_ константинфо**](d3dxshader-constantinfo.md)
-   [**D3DXSHADER \_ константтабле**](d3dxshader-constanttable.md)
-   [**D3DXSHADER \_ структмемберинфо**](d3dxshader-structmemberinfo.md)
...
-   [Расширения D3DXVECTOR2](d3dxvector2-extensions.md)
-   [**D3DXVECTOR3**](d3dxvector3.md)
-   [Расширения D3DXVECTOR3](d3dxvector3-extensions.md)
-   [**D3DXVECTOR4**](d3dxvector4.md)
-   [Расширения D3DXVECTOR4](d3dxvector4-extensions.md)
...
[Справочник по D3DX](dx9-graphics-reference-d3dx.md)
</dt> </dl>
