...
---
# <a name="d3dxquaternion-extensions"></a>Расширения D3DXQUATERNION

Предоставляет следующие перегрузки операторов и приведения типов для структур [**D3DXQUATERNION**](d3dxquaternion.md) .
...
Производные типы: \* LPD3DXQUATERNION

## <a name="remarks"></a>Комментарии

Дополнительные сведения о членах структуры см. в разделе [**D3DXQUATERNION**](d3dxquaternion.md).
