...
-   [Общие советы по повышению производительности](#general-performance-tips)
-   [Базы данных и отбор](#databases-and-culling)
-   [Пакетные примитивы](#batching-primitives)
-   [Советы по освещению](#lighting-tips)
...
## <a name="general-performance-tips"></a>Общие советы по повышению производительности
...
## <a name="lighting-tips"></a>Советы по освещению
