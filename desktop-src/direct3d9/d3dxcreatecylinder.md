...
---
# <a name="d3dxcreatecylinder-function"></a>Функция D3DXCreateCylinder
...
Указатель на интерфейс [**IDirect3DDevice9**](/windows/win32/api/d3d9helper/nn-d3d9helper-idirect3ddevice9) , представляющий устройство, связанное с созданной сеткой цилиндра.
...
Радиус в отрицательном конце оси Z. Значение должно быть больше или равно 0,0 f.
...
Радиус в положительном Z-конце. Значение должно быть больше или равно 0,0 f.
...
Созданный цилиндр выравнивается по центру источника, а его ось — по оси z.
