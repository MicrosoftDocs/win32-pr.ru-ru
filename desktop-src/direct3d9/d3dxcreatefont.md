...
Указывает, как Windows должна пытаться сопоставить желаемые размеры шрифтов и характеристики с фактическими шрифтами. Используйте OUT \_ \_ только \_ преЦис для экземпляра, чтобы всегда получать шрифт TrueType.
...
Указывает, как Windows должна соответствовать желаемому шрифту с реальным шрифтом. Он применяется только к растровым шрифтам и не должен влиять на шрифты TrueType.
