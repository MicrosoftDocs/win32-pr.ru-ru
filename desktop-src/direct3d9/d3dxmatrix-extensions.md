---
description: Расширения D3DXMATRIX
...
| Тип              | Расширение                          |
|---------------|---------------------------|
| Производный тип: | \*Расширения LPD3DXMATRIX |



 

Содержимое этой страницы было объединено со страницей [**D3DXMATRIX**](d3dxmatrix.md) .
