...
ms.locfileid: "118523405"
---
# <a name="templates-x-file-format-binary-encoding"></a>Шаблоны (формат файлов X, двоичное кодирование)

Шаблон имеет следующее определение синтаксиса.
