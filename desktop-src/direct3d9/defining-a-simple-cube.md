...
В следующем файле определяется простой куб с четырьмя красными сторонами и двумя зелеными сторонами. В этом файле необязательные сведения используются для добавления сведений в объект данных, определенный шаблоном [**сетки**](mesh.md) .
