...
ms.locfileid: "119122115"
---
# <a name="id3dxanimationcontrollergettrackanimationset-method"></a>Метод ID3DXAnimationController:: Жеттракканиматионсет

Возвращает набор анимации для данной записи.
...
Указатель на набор анимации [**ID3DXAnimationSet**](id3dxanimationset.md) для данной записи.
