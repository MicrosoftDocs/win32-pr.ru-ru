...
---
# <a name="writing-an-effect-direct3d-9"></a>Запись влияния (Direct3D 9)
...
Синтаксис эффектов подробно описан в [формате эффектов (Direct3D 9)](dx9-graphics-reference-effects-file-format.md). Как правило, результат инкапсулируется в файл эффектов (FX), но его также можно записать в виде текстовой строки в приложении.

## <a name="effect-example"></a>Пример действия

Эффекты содержат три типа состояния: состояние шейдера, состояние текстуры и образца и состояние конвейера. Ниже приведен пример воздействия на [Пример басичлсл](https://msdn.microsoft.com/library/Ee416223(v=VS.85).aspx):
...
## <a name="effects-contain-one-or-more-techniques-and-passes"></a>Эффекты содержат один или несколько методов и передаются
