...
Windows модель безопасности также обеспечивает автоматическое наследование ace дочерними объектами в соответствии с [правилами наследования ACE](/windows/desktop/SecAuthZ/ace-inheritance-rules). Это автоматическое наследование вместе с информацией о наследовании в каждой записи ACE определяет, как ограничения безопасности передаются вниз по иерархии каталогов.
