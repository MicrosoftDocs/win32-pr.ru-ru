...
Диспетчер транзакций ядра (KTM) использует коды системных ошибок в диапазоне от 6700 до 6799. Транзакционная NTFS (TxF) использует коды ошибок Windows в диапазоне от 6800 до 6899. Дополнительные сведения см. в разделе WinError. h и коды системных ошибок (6000-8199).
