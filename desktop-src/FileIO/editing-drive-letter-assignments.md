---
description: Добавление или удаление назначений постоянных букв диска. Эти назначения букв дисков сохраняются при завершении работы системы.
ms.assetid: 17a6df9d-07df-42f7-89c9-72a1d02141f6
title: Изменение назначений букв диска
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105663605"
---
# <a name="editing-drive-letter-assignments"></a><span data-ttu-id="b6b73-104">Изменение назначений букв диска</span><span class="sxs-lookup"><span data-stu-id="b6b73-104">Editing Drive Letter Assignments</span></span>

<span data-ttu-id="b6b73-105">В примере кода в этом разделе показано, как добавлять или удалять постоянные назначения букв дисков.</span><span class="sxs-lookup"><span data-stu-id="b6b73-105">The code example in this topic shows you how to add or remove persistent drive letter assignments.</span></span> <span data-ttu-id="b6b73-106">Эти назначения букв дисков сохраняются при завершении работы системы.</span><span class="sxs-lookup"><span data-stu-id="b6b73-106">These drive letter assignments persist through system shutdown.</span></span> <span data-ttu-id="b6b73-107">Дополнительные сведения см. в разделе [Назначение буквы диска тому](assigning-a-drive-letter-to-a-volume.md).</span><span class="sxs-lookup"><span data-stu-id="b6b73-107">For more information, see [Assigning a Drive Letter to a Volume](assigning-a-drive-letter-to-a-volume.md).</span></span>

<span data-ttu-id="b6b73-108">В примере кода используются следующие функции: [**дефинедосдевице**](/windows/desktop/api/FileAPI/nf-fileapi-definedosdevicew), [**делетеволумемаунтпоинт**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw), [**жетволуменамефорволумемаунтпоинт**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw)и [**сетволумемаунтпоинт**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa).</span><span class="sxs-lookup"><span data-stu-id="b6b73-108">The code example uses the following functions: [**DefineDosDevice**](/windows/desktop/api/FileAPI/nf-fileapi-definedosdevicew), [**DeleteVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw), [**GetVolumeNameForVolumeMountPoint**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw), and [**SetVolumeMountPoint**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa).</span></span>
