...
---
# <a name="editing-drive-letter-assignments"></a>Изменение назначений букв диска

В примере кода в этом разделе показано, как добавлять или удалять постоянные назначения букв дисков. Эти назначения букв дисков сохраняются при завершении работы системы. Дополнительные сведения см. в разделе [Назначение буквы диска тому](assigning-a-drive-letter-to-a-volume.md).

В примере кода используются следующие функции: [**дефинедосдевице**](/windows/desktop/api/FileAPI/nf-fileapi-definedosdevicew), [**делетеволумемаунтпоинт**](/windows/desktop/api/FileAPI/nf-fileapi-deletevolumemountpointw), [**жетволуменамефорволумемаунтпоинт**](/windows/desktop/api/FileAPI/nf-fileapi-getvolumenameforvolumemountpointw)и [**сетволумемаунтпоинт**](/windows/desktop/api/WinBase/nf-winbase-setvolumemountpointa).
