...
| Раздел                                                                                                 | Описание                                                                                                                                                                                                              |
|-------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Сравнение функциональных возможностей файловой системы](filesystem-functionality-comparison.md)<br/>            | Таблицы, в которых перечислены функциональные возможности и функции, поддерживают сравнение четырех основных файловых систем Windows, NTFS, exFAT, UDF и FAT32.<br/>                                                                           |
