...
title: Windows Обновить объектную модель агента
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119855453"
---
# <a name="windows-update-agent-object-model"></a>Windows Обновить объектную модель агента
...
| [**Update**](/windows/desktop/api/Wuapi/nn-wuapi-iupdate)                                             | Получение большинства сведений об обновлении, включая объединенные обновления, требования к источнику, удостоверение, описание, параметры удаления, приоритет загрузки, размер и крайний срок.                                                                |
