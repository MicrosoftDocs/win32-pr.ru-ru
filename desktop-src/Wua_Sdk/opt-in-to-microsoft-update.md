...
>
> Для создания этого раздела реестра требуются учетные данные администратора. для Windows Vista вызывающий объект должен создать раздел реестра в процессе с повышенными правами.
