...
Образец обновления определяется [**свойством Title в заголовке иупдате**](/windows/desktop/api/Wuapi/nf-wuapi-iupdate-get_title). в этом образце предлагается обновление для Windows Rights Management клиента 1,0.
