...
Интерфейс **ивиаимажефилтер** — это интерфейс расширения, реализованный разработчиками фильтра обработки изображений и вызываемый службой получения изображений Windows (WIA) 2,0.
