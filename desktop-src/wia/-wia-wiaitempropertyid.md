---
description: большая часть констант свойств Windowsного получения изображений (WIA) группируются в один перечислимый тип данных, виаитемпропертид для авторов скриптов.
...
ms.locfileid: "118207511"
---
# <a name="wiaitempropertyid"></a>виаитемпропертид

большая часть констант свойств Windowsного получения изображений (WIA) группируются в один перечислимый тип данных, виаитемпропертид для авторов скриптов.

В следующей таблице представлено сопоставление соглашений об именовании, используемых в сценариях и C++. Например, в скрипте префикс "Камерадевице" сопоставляется с \_ префиксом "WIA DPC" для соответствующей константы C++. В более конкретном примере свойство "Камерадевицефлашмоде" эквивалентно \_ \_ константе C++ "режим флэш-памяти WIA DPC \_ ". Описание каждого свойства см. в соответствующих разделах констант свойств. 

| Префикс скрипта  | Раздел C++ (префикс)                                                                    |
|----------------|---------------------------------------------------------------------------------------|
| Устройство         | [**Общие константы свойств устройства (WIA \_ DPA)**](-wia-wiaitempropcommondevice.md)   |
| камерадевице   | [**Константы свойств устройства камеры (WIA \_ DPC)**](-wia-wiaitempropcameradevice.md)   |
| сканнердевице  | [**Константы свойств устройства сканера (WIA \_ DPS)**](-wia-wiaitempropscannerdevice.md) |
| видеодевице    | [**Константы свойств видеоустройства WIA (WIA \_ ДПВ)**](-wia-wiaitempropvideodevice.md) |
| Picture        | [**Стандартные константы свойств элементов WIA (WIA \_ IPA)**](-wia-wiaitempropcommonitem.md)   |
| камерапиктуре  | [**Константы свойства элемента WIA камеры (WIA \_ IPC)**](-wia-wiaitempropcameraitem.md)   |
| сканнерпиктуре | [**Константы свойства элемента сканера WIA ( \_ IP-адреса WIA)**](-wia-wiaitempropscanneritem.md) |
