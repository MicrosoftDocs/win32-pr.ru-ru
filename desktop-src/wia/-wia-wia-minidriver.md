---
description: приложения видят устройства Windowsного получения изображений (WIA) в виде иерархического дерева объектов ивиаитем или IWiaItem2 с корневым элементом, представляющим само устройство.
