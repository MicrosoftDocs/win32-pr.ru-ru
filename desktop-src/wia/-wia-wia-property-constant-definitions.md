...
---
# <a name="wia-property-constant-definitions"></a><span data-ttu-id="5f99b-104">Определения констант свойств WIA</span><span class="sxs-lookup"><span data-stu-id="5f99b-104">WIA Property Constant Definitions</span></span>

<span data-ttu-id="5f99b-105">Ниже приведен список понятных имен и числовых идентификаторов свойств для получения образа Windows (WIA).</span><span class="sxs-lookup"><span data-stu-id="5f99b-105">The following is a list of Windows Image Acquisition (WIA) property friendly names and numerical IDs.</span></span> <span data-ttu-id="5f99b-106">Они представлены в виде определений констант Microsoft Visual Basic для удобного включения в приложения или сценарии.</span><span class="sxs-lookup"><span data-stu-id="5f99b-106">They are presented as Microsoft Visual Basic constant definitions, for convenient inclusion in applications or scripts.</span></span>

<span data-ttu-id="5f99b-107">Для Visual Basic приложений добавьте ссылку на «библиотеку типов получения изображений Microsoft Windows 1,01», где эти константы предоставляются в качестве типов перечисления.</span><span class="sxs-lookup"><span data-stu-id="5f99b-107">For Visual Basic applications, add a reference to "Microsoft Windows Image Acquisition 1.01 Type Library", where these constants are provided as enumeration types.</span></span>
