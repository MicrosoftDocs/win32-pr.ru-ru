---
description: при создании устройства Windows получения изображений (wia) создает иерархическое дерево элементов wia, представляющих устройство, а также папки и изображения, связанные с этим устройством.
