...
Интерфейс **идодовнлоадинтернал** используется для получения или задания расширенных свойств загрузки.

## <a name="methods"></a>Методы

Интерфейс **идодовнлоадинтернал** содержит следующие методы.
