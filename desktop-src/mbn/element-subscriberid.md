...
Определяет уникальный идентификатор профиля.
...
Дополнительные сведения см. в документации по элементу [**субскриберид**](./schema-subscriberid-mbnprofile-element.md) v1.
