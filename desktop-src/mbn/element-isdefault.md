...
Указывает, является ли этот профиль профилем по умолчанию.

Дополнительные сведения об этом элементе см. в документации по параметру [**Default**](./schema-isdefault-mbnprofile-element.md).
