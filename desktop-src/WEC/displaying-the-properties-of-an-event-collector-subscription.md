...
Можно просмотреть полезные сведения о подписке сборщика событий и ее источниках событий, извлекая и отображая свойства подписки.

> [!Note]
>
> Этот пример можно использовать для вывода значений свойств подписки. в командной строке можно ввести следующую команду:
>
...
Следующий пример кода следует процедуре для вывода свойств подписки сборщика событий и связанных с ней источников событий.
...
В следующем примере кода C++ показано, как отобразить свойства подписки сборщика событий.
