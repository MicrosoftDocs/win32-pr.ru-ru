...
Например, если Впдсервицесампледривер является единственным установленным устройством, приложение возвращает три поля данных: понятное имя ("пример устройства"), производитель ("Группа портативных устройств Windows") и описание ("устройства службы контактов 2000").
