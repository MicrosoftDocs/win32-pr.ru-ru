...
В примере в этом разделе вызывается команда **жетнумобжектс** MTP. (Полное описание этой команды и ее параметров см. в [спецификации MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)

Перед вызовом этой команды необходимо сначала настроить параметры команды.
...
После настройки параметров приложение вызывает команду.
...
После того как приложение вызовет команду, оно обрабатывает ответ от драйвера MTP.
