...
\_ \_ Функциональный объект для визуализации функциональной категории WPD \_ \_ описывает типы файлов мультимедиа, которые может визуализировать устройство.
