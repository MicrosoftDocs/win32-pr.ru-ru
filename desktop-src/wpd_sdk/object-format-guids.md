...
Формат файла на устройстве можно описать с помощью значения **GUID** . Это значение задается свойством " **\_ \_ Формат объекта WPD** ". Портативные устройства Windows определяют следующие форматы:
...
| \_ \_ флашпикс формат объекта \_ WPD              | Изображение (структурированный формат образа хранилища)                                                                                                                      |
...
| \_Формат объекта \_ WPD \_ Microsoft \_ Excel      | Формат файла документа Excel Microsoft Office                                                                                                                  |
| \_Формат объекта \_ WPD \_ Microsoft \_ PowerPoint | Формат файла документа PowerPoint Microsoft Office                                                                                                             |
| \_Формат объекта \_ WPD \_ Microsoft \_ WFC        | Формат файлов Windows Connect Now                                                                                                                              |
...
| \_Формат объекта WPD не \_ \_ указан           | Неопределенный или неопределенный формат объекта на устройстве. Используется для объектов, которые не могут быть заданы с помощью определенных кодов форматов портативных устройств Windows. |
