...
Портативные устройства Windows поддерживают следующие свойства атрибутов ресурсов.
...
| **\_ \_ Формат атрибута ресурса \_ WPD**        | **VT \_ CLSID**   | Значение идентификатора GUID, указывающее формат ресурса. Список форматов, определяемых портативными устройствами Windows, см. в разделе [форматы объектов](object-format-guids.md) . |
