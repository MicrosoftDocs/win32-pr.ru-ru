...
ms.locfileid: "119445154"
---
# <a name="wpd_content_type_contact_group"></a>\_тип содержимого \_ WPD \_ \_ Группа контактов

Объект, описывающий его тип как \_ тип содержимого \_ WPD \_ Группа контактов, \_ представляет группу контактов. Ссылки на объекты WPD этого объекта \_ \_ содержат список идентификаторов объектов для различных \_ \_ \_ контактных объектов типа содержимого WPD.
