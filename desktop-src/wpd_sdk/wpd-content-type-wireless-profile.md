...
ms.locfileid: "119445094"
---
# <a name="wpd_content_type_wireless_profile"></a>\_тип содержимого \_ WPD \_ профиль беспроводной сети \_

Объект, описывающий его тип как \_ тип содержимого \_ WPD \_ Wireless \_ Profile, представляет сведения, используемые для доступа к беспроводной сети.
...
|--------------------------------------------------------|-------------------------------------------------------|---------------------------|
| [**\_ресурс \_ по умолчанию для WPD**](wpd-resource-default.md) | Требуется, если объект представлен двоичными данными. | Содержит двоичные данные. |
