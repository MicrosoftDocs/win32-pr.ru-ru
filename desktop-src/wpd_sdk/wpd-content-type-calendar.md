...
Объект, описывающий его тип как \_ тип содержимого \_ WPD \_ Calendar, представляет календарь. Объект может представлять собой файл, содержащий сведения календаря, или папку, содержащую другие объекты, связанные с календарем, такие как задачи, встречи и т. д.
...
|--------------------------------------------------------|--------------------------------------------------|--------------------|
| [**\_ресурс \_ по умолчанию для WPD**](wpd-resource-default.md) | Требуется, если объект поддерживается двоичными данными. | Содержит данные. |
