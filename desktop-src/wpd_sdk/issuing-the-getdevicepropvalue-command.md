---
description: Выдача команды Жетдевицепропвалуе
ms.assetid: 60294ac6-06e0-4546-bbe9-da48d250e31e
title: Выдача команды Жетдевицепропвалуе
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105702567"
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="2b7a2-103">Выдача команды Жетдевицепропвалуе</span><span class="sxs-lookup"><span data-stu-id="2b7a2-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="2b7a2-104">В примере в этом разделе вызывается команда **жетдевицепропвалуе** MTP для получения свойства устройства **баттерилевел** .</span><span class="sxs-lookup"><span data-stu-id="2b7a2-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="2b7a2-105">(Полное описание этой команды и ее параметров см. в [спецификации MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="2b7a2-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="2b7a2-106">В случае с **жетдевицепропвалуе** в примере кода используется следующая последовательность:</span><span class="sxs-lookup"><span data-stu-id="2b7a2-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="2b7a2-107">\_команда WPD \_ MTP \_ \_ Execute \_ команда \_ с \_ данными \_ для \_ чтения</span><span class="sxs-lookup"><span data-stu-id="2b7a2-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="2b7a2-108">\_команда WPD \_ MTP \_ \_ Read \_ Data</span><span class="sxs-lookup"><span data-stu-id="2b7a2-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="2b7a2-109">\_команда WPD \_ , \_ \_ завершающая \_ \_ Перенос данных MTP</span><span class="sxs-lookup"><span data-stu-id="2b7a2-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="2b7a2-110">В следующем примере кода показано, как приложение инитатес последовательность команд.</span><span class="sxs-lookup"><span data-stu-id="2b7a2-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="2b7a2-111">В следующем примере кода показано, как приложение получает данные свойства.</span><span class="sxs-lookup"><span data-stu-id="2b7a2-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="2b7a2-112">В следующем примере кода показано, как приложение получает ответ устройства на команду.</span><span class="sxs-lookup"><span data-stu-id="2b7a2-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2b7a2-113">См. также</span><span class="sxs-lookup"><span data-stu-id="2b7a2-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2b7a2-114">Поддержка расширений MTP</span><span class="sxs-lookup"><span data-stu-id="2b7a2-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
