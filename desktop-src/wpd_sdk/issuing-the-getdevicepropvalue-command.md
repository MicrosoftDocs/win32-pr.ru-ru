...
---
# <a name="issuing-the-getdevicepropvalue-command"></a>Выдача команды Жетдевицепропвалуе

В примере в этом разделе вызывается команда **жетдевицепропвалуе** MTP для получения свойства устройства **баттерилевел** . (Полное описание этой команды и ее параметров см. в [спецификации MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)

В случае с **жетдевицепропвалуе** в примере кода используется следующая последовательность:

1.  \_команда WPD \_ MTP \_ \_ Execute \_ команда \_ с \_ данными \_ для \_ чтения
2.  \_команда WPD \_ MTP \_ \_ Read \_ Data
3.  \_команда WPD \_ , \_ \_ завершающая \_ \_ Перенос данных MTP

В следующем примере кода показано, как приложение инитатес последовательность команд.
...
В следующем примере кода показано, как приложение получает данные свойства.
...
В следующем примере кода показано, как приложение получает ответ устройства на команду.
