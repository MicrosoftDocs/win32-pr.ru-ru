...
Тип **перечисления \_ \_ \_ типов наследования службы WPD** указывает отношение наследования для службы.
...
<span id="WPD_SERVICE_INHERITANCE_IMPLEMENTATION"></span><span id="wpd_service_inheritance_implementation"></span>**\_ \_ Реализация наследования службы WPD \_**
</dt> <dd>

Служба наследует реализацию абстрактного определения службы.
...
[**Ипортабледевицесервицекапабилитиес:: Жетинхеритедсервицес**](/windows/desktop/api/PortableDeviceAPI/nf-portabledeviceapi-iportabledeviceservicecapabilities-getinheritedservices)
</dt> </dl>
