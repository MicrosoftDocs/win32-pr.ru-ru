...
Windows Портативные устройства могут поддерживать одну или несколько функциональных категорий. Эти категории описаны в следующей таблице.
...
| Служба хранилища                     | Устройство можно использовать для хранения файлов.                                               |
