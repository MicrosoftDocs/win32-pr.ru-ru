...
Тем не менее, если резервная копия не сохранила состояние загрузочной системы (см. раздел [резервное копирование и восстановление состояния системы в Windows server 2003 R2 и Windows server 2003 SP1](backing-up-and-restoring-system-state-under-vss.md)), следует проявлять значительную осторожность в восстановлении системных файлов.
