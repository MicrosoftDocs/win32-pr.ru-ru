---
title: Использование состояния Hold-Down маршрута
description: В следующем примере кода показано, как пометить место назначения для состояния удержания и как создать перечисление назначения, включающее маршруты, наявляющиеся в состоянии удержания.
...
ms.locfileid: "105672113"
---
# <a name="use-the-route-hold-down-state"></a><span data-ttu-id="a7c9c-103">Использование состояния Hold-Down маршрута</span><span class="sxs-lookup"><span data-stu-id="a7c9c-103">Use the Route Hold-Down State</span></span>

<span data-ttu-id="a7c9c-104">В следующем примере кода показано, как пометить место назначения для состояния удержания и как создать перечисление назначения, включающее маршруты, наявляющиеся в состоянии удержания.</span><span class="sxs-lookup"><span data-stu-id="a7c9c-104">The following sample code shows how to mark a destination for the hold-down state, and how to create a destination enumeration that includes routes that are in the hold-down state.</span></span>
