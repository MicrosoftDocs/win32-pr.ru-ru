...
ms.locfileid: "120035544"
---
# <a name="use-the-route-hold-down-state"></a>Использование состояния Hold-Down маршрута

В следующем примере кода показано, как пометить место назначения для состояния удержания и как создать перечисление назначения, включающее маршруты, наявляющиеся в состоянии удержания.
