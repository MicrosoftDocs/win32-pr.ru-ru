...
---
# <a name="enumerate-all-destinations"></a>Перечислить все назначения

В следующем примере кода показано, как перечислить все назначения в таблице маршрутизации.
