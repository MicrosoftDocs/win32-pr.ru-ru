---
title: Перечислить все назначения
description: В следующем примере кода показано, как перечислить все назначения в таблице маршрутизации.
...
ms.locfileid: "104068028"
---
# <a name="enumerate-all-destinations"></a><span data-ttu-id="0e727-103">Перечислить все назначения</span><span class="sxs-lookup"><span data-stu-id="0e727-103">Enumerate All Destinations</span></span>

<span data-ttu-id="0e727-104">В следующем примере кода показано, как перечислить все назначения в таблице маршрутизации.</span><span class="sxs-lookup"><span data-stu-id="0e727-104">The following sample code shows how to enumerate all destinations in the routing table.</span></span>
