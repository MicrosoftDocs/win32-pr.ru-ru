---
title: Доступ к непрозрачному указателю в месте назначения
description: В следующем примере кода показано, как получить доступ к непрозрачному указателю в назначении.
...
ms.locfileid: "104068095"
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="6da73-103">Доступ к непрозрачному указателю в месте назначения</span><span class="sxs-lookup"><span data-stu-id="6da73-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="6da73-104">В следующем примере кода показано, как получить доступ к непрозрачному указателю в назначении.</span><span class="sxs-lookup"><span data-stu-id="6da73-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
