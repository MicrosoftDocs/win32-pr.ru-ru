...
---
# <a name="access-the-opaque-pointer-in-a-destination"></a>Доступ к непрозрачному указателю в месте назначения

В следующем примере кода показано, как получить доступ к непрозрачному указателю в назначении.
