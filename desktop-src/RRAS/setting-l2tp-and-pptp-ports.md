---
title: Настройка портов L2TP и PPTP локальной службы RRAS
description: Этот пример возвращает и задает конфигурацию портов L2TP и PPTP локальной службы RRAS. Предполагается, что вызывающий процесс имеет достаточные привилегии для доступа к локальной службе RRAS.
ms.assetid: 9e4aa8d4-e09e-4c84-acf0-c505a58841a4
keywords:
- Настройка портов службы RRAS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103773757"
---
# <a name="setting-l2tp-and-pptp-ports-of-local-rras-service"></a><span data-ttu-id="90d71-105">Настройка портов L2TP и PPTP локальной службы RRAS</span><span class="sxs-lookup"><span data-stu-id="90d71-105">Setting L2TP and PPTP ports of local RRAS service</span></span>

<span data-ttu-id="90d71-106">Этот пример возвращает и задает конфигурацию портов L2TP и PPTP локальной службы RRAS.</span><span class="sxs-lookup"><span data-stu-id="90d71-106">This example gets and sets the L2TP and PPTP port configuration of the local RRAS service.</span></span> <span data-ttu-id="90d71-107">Предполагается, что вызывающий процесс имеет достаточные привилегии для доступа к локальной службе RRAS.</span><span class="sxs-lookup"><span data-stu-id="90d71-107">It assumes the calling process has sufficient privileges to access the local RRAS service.</span></span>
