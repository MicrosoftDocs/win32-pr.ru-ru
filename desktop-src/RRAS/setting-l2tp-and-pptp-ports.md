...
ms.locfileid: "120073774"
---
# <a name="setting-l2tp-and-pptp-ports-of-local-rras-service"></a>Настройка портов L2TP и PPTP локальной службы RRAS

Этот пример возвращает и задает конфигурацию портов L2TP и PPTP локальной службы RRAS. Предполагается, что вызывающий процесс имеет достаточные привилегии для доступа к локальной службе RRAS.
