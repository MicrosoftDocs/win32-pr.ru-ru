...
<td>Имя устройства на устройстве. INF-файл или носитель. Слишком длинный INI-файл. <br/></td>
</tr>
<tr class="even">
...
<td>Носитель. INI-файл ссылается на неизвестное имя устройства.<br/></td>
</tr>
<tr class="odd">
...
<td>Носитель. INI-файл ссылается на неизвестный тип устройства.<br/></td>
</tr>
<tr class="odd">
...
<td>Не удается прочитать носитель. INI-файл.<br/></td>
</tr>
<tr class="odd">
...
<td>Недопустимый параметр использования в ini-файле носителя.<br/></td>
</tr>
<tr class="odd">
...
<td>Не удается прочитать имя раздела с носителя. INI-файл.<br/></td>
</tr>
<tr class="even">
...
<td>Не удается прочитать тип устройства с носителя. INI-файл.<br/></td>
</tr>
<tr class="odd">
...
<td>Не удается прочитать имя устройства с носителя. INI-файл.<br/></td>
</tr>
<tr class="even">
...
<td>Не удается прочитать сведения об использовании с носителя. INI-файл.<br/></td>
</tr>
<tr class="odd">
...
<td>Системе не удалось прочесть максимальную скорость подключения перевозчика с носителя. INI-файл.<br/>
<blockquote>
[!Note]<br />
Не рекомендуется использовать в Windows Vista и более поздних версиях Windows.
</blockquote>
...
<td>Носитель. INI-файл пуст.<br/></td>
</tr>
<tr class="even">
...
<td>Неверный атрибут RADIUS типа туннеля для этого пользователя. <br/></td>
</tr>
<tr class="odd">
...
<blockquote>
[!Note]<br />
Windows 7 и более поздние версии: узел должен быть настроен для использования <strong>192.168.137.1</strong>
</blockquote>
<br/></td>
</tr>
<tr class="odd">
...
<td>Недопустимый идентификатор туннеля.<br/>
<blockquote>
[!Note]<br />
...
<td>Средство проверки подлинности не совпадает в пакете от RADIUS-сервера.<br/>
<blockquote>
[!Note]<br />
Поддерживается в Windows XP и более поздних версиях Windows.
</blockquote>
