...
description: В следующем примере кода показано, как создать перечисление зарегистрированных клиентов и получить сведения о клиенте из диспетчера таблиц маршрутизации.
...
ms.locfileid: "105650284"
---
# <a name="enumerate-the-registered-entities"></a><span data-ttu-id="62df9-103">Перечисление зарегистрированных сущностей</span><span class="sxs-lookup"><span data-stu-id="62df9-103">Enumerate the Registered Entities</span></span>

<span data-ttu-id="62df9-104">В следующем примере кода показано, как создать перечисление зарегистрированных клиентов и получить сведения о клиенте из диспетчера таблиц маршрутизации.</span><span class="sxs-lookup"><span data-stu-id="62df9-104">The following sample code shows how to create an enumeration of registered clients and obtain the client information from the routing table manager.</span></span>
