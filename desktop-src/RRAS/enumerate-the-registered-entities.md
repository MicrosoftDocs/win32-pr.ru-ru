...
---
# <a name="enumerate-the-registered-entities"></a>Перечисление зарегистрированных сущностей

В следующем примере кода показано, как создать перечисление зарегистрированных клиентов и получить сведения о клиенте из диспетчера таблиц маршрутизации.
