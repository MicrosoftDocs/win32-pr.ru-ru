...
ms.locfileid: "117790067"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a>Получение и вызов экспортированных методов для клиента

В следующем примере кода показано, как получить список методов, экспортированных клиентом, и как вызвать метод для этого клиента.
