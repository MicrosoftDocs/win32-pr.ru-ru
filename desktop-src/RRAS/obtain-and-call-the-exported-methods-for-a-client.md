---
title: Получение и вызов экспортированных методов для клиента
description: В следующем примере кода показано, как получить список методов, экспортированных клиентом, и как вызвать метод для этого клиента.
...
ms.locfileid: "104486560"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="38150-103">Получение и вызов экспортированных методов для клиента</span><span class="sxs-lookup"><span data-stu-id="38150-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="38150-104">В следующем примере кода показано, как получить список методов, экспортированных клиентом, и как вызвать метод для этого клиента.</span><span class="sxs-lookup"><span data-stu-id="38150-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
