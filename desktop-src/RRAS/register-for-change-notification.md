...
В следующем примере кода показано, как зарегистрировать уведомления об изменениях в таблице маршрутизации. В разделе «[Использование обратного вызова для уведомления о событиях](use-the-event-notification-callback.md)» показано, как использовать эти уведомления об изменениях.
