...
В следующем коде [**мпрадминмибентрижет**](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget) используется для получения таблицы ИНТЕРФЕЙСОВ MIB II с локального компьютера.
...
[**\_непрозрачные \_ сведения MIB**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_info)
</dt> <dt>

[**\_непрозрачный \_ запрос MIB**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_query)
</dt> <dt>
