...
Указывает, ограничивает набор удаленных маршрутов подмножеством, определенным этими флагами, и значениями соответствующих элементов структуры, на которые указывает параметр *критериарауте* . Флаги аналогичны параметрам, используемым в [**ртмкреатинумератионхандле**](rtmcreateenumerationhandle.md).
...
Выходные данные out, *Маршрутизация* указывает на первый маршрут, соответствующий указанным критериям.
...
[**ртмжетнекстрауте**](rtmgetnextroute.md)
</dt> </dl>
