...
description: В следующем примере кода показано, как зарегистрировать новую сущность с помощью диспетчера таблиц маршрутизации.
...
---
# <a name="register-with-the-routing-table-manager"></a><span data-ttu-id="9e940-103">Регистрация в диспетчере таблиц маршрутизации</span><span class="sxs-lookup"><span data-stu-id="9e940-103">Register with the Routing Table Manager</span></span>

<span data-ttu-id="9e940-104">В следующем примере кода показано, как зарегистрировать новую сущность с помощью диспетчера таблиц маршрутизации.</span><span class="sxs-lookup"><span data-stu-id="9e940-104">The following sample code shows how to register a new entity with the routing table manager.</span></span>
