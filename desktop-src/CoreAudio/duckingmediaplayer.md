...
-   DirectShow воспроизведения файла мультимедиа.
...
|-------------|-----------------------------------------------------------------------------------------------------|
| Пакет Windows SDK | \\Program files \\ Microsoft sdks \\ Windows \\ v 7.0 \\ samples \\ мультимедиа \\ Audio \\ дуккингмедиаплайер \\ ... |
...
1.  откройте файл дуккингмедиаплайер. sln в Visual Studio 2008.
