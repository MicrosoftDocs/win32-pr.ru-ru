...
следующий пример кода C++ является Windows приложением, которое отображает пиковое значение для устройства отрисовки по умолчанию:
