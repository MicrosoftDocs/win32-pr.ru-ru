...
См. [пример с высококачественным голосовым захватом (Майкрософт](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/multimedia/audio/aecmicarray)).
