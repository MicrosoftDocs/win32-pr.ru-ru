...
|-------------|-------------------------------------------------------------------------------------------------------|
| Пакет Windows SDK | \\Program Files \\ Microsoft SDK \\ Windows \\ v \\ 7.0 Samples \\ мультимедиа \\ Audio \\ дуккингкаптуресампле \\ ... |
...
1.  Откройте Дуккингкаптуресампле. sln в Visual Studio 2008.
