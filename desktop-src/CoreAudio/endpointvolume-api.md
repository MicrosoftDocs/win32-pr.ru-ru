...
-   приложения, управляющие основными уровнями громкости конечных точек аудио, аналогичны Windows программе управления томами Sndvol.exe.
-   Professional звуковых ("звуковых") приложений, требующих монопольного доступа к устройствам конечных точек аудио.
