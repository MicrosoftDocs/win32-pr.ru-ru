...
-   пользователь включает или отключает устройство конечной точки звука из диспетчер устройств или из панели управления Windows мультимедиа Mmsys.cpl.
