...
| <span id="AUDCLNT_STREAMFLAGS_RATEADJUST"></span><span id="audclnt_streamflags_rateadjust"></span><dl> <dt>**Аудклнт \_ СТРЕАМФЛАГС \_ ратеаджуст**</dt> <dt>0x00100000</dt> </dl>                                             | Эта константа является новой в Windows 7. Частота дискретизации потока корректируется на скорость, указанную приложением. Дополнительные сведения см. в подразделе "Примечания". <br/>                                                                                                                                                                                 |
