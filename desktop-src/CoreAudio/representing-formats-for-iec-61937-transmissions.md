...
Идентификаторы GUID для сжатых звуковых форматов, доступных в виде стандартных звуковых форматов IEC 61937, перечислены в следующей таблице. Эти форматы схожи с существующими представлениями форматов звука 3 (AC-3) и Digital театра (DTS) в Windows.
...
| 0x0b         | 0000000b-0cea-0010-8000-00aa00389b71<br/> \_ПОДТИП ксдатаформат \_ IEC61937 \_ DTS \_ HD<br/> | DTS HD  |
| 0x0b         | 0000010b-0cea-0010-8000-00aa00389b71<br/> \_ПОДТИП ксдатаформат \_ IEC61937 \_ dtsx \_ E1<br/> | DTS: X E1  |
| 0x0b         | 0000030b-0cea-0010-8000-00aa00389b71<br/> \_ПОДТИП ксдатаформат \_ IEC61937 \_ dtsx \_ E2<br/> | DTS: X E2  |
...
| 0x0E         | 00000164-0000-0010-8000-00aa00389b71<br/> \_ПОДТИП ксдатаформат \_ IEC61937 \_ WMA \_ Pro<br/>     | Windows Pro Media Audio (WMA)                                                                                                   |



 

драйвер класса HD audio, предоставляемый корпорацией майкрософт, поддерживает форматы PCM, AC3, DTS, AAC, Dolby digital Plus, WMA Pro, материалов (MLP). Идентификаторы GUID для сжатых звуковых форматов, которые не поддерживаются драйвером класса HD Audio и могут быть реализованы сторонними решениями, перечислены в следующей таблице.
...
wma Pro аудио содержимое может быть закодировано в одном из четырех профилей, перечисленных в следующей таблице.
...
значения, заданные приложением в \_ структуре вавеформатекстенсибле IEC61937 для представления WMA Pro как профиль M2, показаны в следующем примере.
