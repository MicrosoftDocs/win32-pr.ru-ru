---
description: начиная с Windows 8.1 кодек компонента Windows imaging Component (WIC) поддерживает чтение и запись данных изображений в собственной форме икбкр.
...
-   [Использование JPEG YC<sub>b</sub>C<sub>r</sub> Data](#using-jpeg-ycbcr-data)
    ...
    -   [Windows API компонентов работы с образами](#windows-imaging-component-apis)
...
только Windowsный кодек JPEG и определенные преобразования WIC поддерживают доступ к данным YC<sub>b</sub>C<sub>r</sub> . полный список см. в разделе [api компонента работы с образами Windows](#windows-imaging-component-apis) .
