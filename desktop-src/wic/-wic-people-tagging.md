---
description: в этом разделе рассказывается о новой схеме с расширенной платформой метаданных (XMP) Windows и свойстве photo пеопленамес 7, которое позволяет размечать лица в цифровой фотографии.
...
в этом разделе рассказывается о новой схеме с расширенной платформой метаданных (XMP) Windows и свойстве photo [пеопленамес](../properties/props-system-photo-peoplenames.md) 7, которое позволяет размечать лица в цифровой фотографии. в этом разделе также обсуждается использование API-интерфейса Windows imaging Component (WIC) для чтения и записи метаданных, необходимых для добавления тегов к пользователям.
