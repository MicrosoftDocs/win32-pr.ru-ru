...
---
# <a name="iwicbitmapcodecinfo_doessupportmultiframe_proxy-function"></a>ИвикбитмапкодеЦинфо \_ доессуппортмултифраме \_ -функция

Функция-посредник для метода [**доессуппортмултифраме**](/windows/desktop/api/Wincodec/nf-wincodec-iwicbitmapcodecinfo-doessupportmultiframe) .
...
*пфсуппортмултифраме* \[ заполняет\]
</dt> <dd>

Тип: **bool \** _

Указатель, получающий *значение _ true**, если кодек поддерживает изображения с несколькими кадрами; в противном случае — **значение false**.
