---
description: в разделе представлен декодер точечных рисунков, основной компонент кодека Windows imaging component (WIC), используемый для декодирования файлов изображений из потока.
...
ms.locfileid: "118711409"
---
# <a name="decoding-overview"></a>Общие сведения о декодировании

в разделе представлен декодер точечных рисунков, основной компонент кодека Windows imaging component (WIC), используемый для декодирования файлов изображений из потока.
