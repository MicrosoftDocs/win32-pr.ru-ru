---
description: Ссылки на документацию по методам и свойствам оболочки взаимодействия IAzScope2.
ms.assetid: 2e1fb2af-3512-416c-8716-7e1303783ea5
title: Интерфейс Microsoft. Interop. Security. Азролес. IAzScope2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105669006"
---
# <a name="microsoftinteropsecurityazrolesiazscope2-interface"></a>Интерфейс Microsoft. Interop. Security. Азролес. IAzScope2

Методы и свойства оболочки взаимодействия **Microsoft. Interop. Security. азролес. IAzScope2** описаны в версии COM метода или свойства. Ссылка на коррелированную документацию по COM следует за именем каждого члена.

## <a name="members"></a>Элементы

Интерфейс **Microsoft. Interop. Security. азролес. IAzScope2** имеет следующие типы членов:
...
Интерфейс **Microsoft. Interop. Security. азролес. IAzScope2** содержит следующие методы.



| Метод                                                                         | Описание                                                                                          |
|:-------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Азролес. IAzScope2. Аддполициадминистратор**        | [**Иазскопе:: Аддполициадминистратор**](/windows/desktop/api/Azroles/nf-azroles-iazscope-addpolicyadministrator)<br/>               |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Аддполициадминистраторнаме**    | [**Иазскопе:: Аддполициадминистраторнаме**](/windows/desktop/api/Azroles/nf-azroles-iazscope-addpolicyadministratorname)<br/>       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Аддполициреадер**               | [**Иазскопе:: Аддполициреадер**](/windows/desktop/api/Azroles/nf-azroles-iazscope-addpolicyreader)<br/>                             |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Аддполициреадернаме**           | [**Иазскопе:: Аддполициреадернаме**](/windows/desktop/api/Azroles/nf-azroles-iazscope-addpolicyreadername)<br/>                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Аддпропертитем**               | [**Иазскопе:: Аддпропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazscope-addpropertyitem)<br/>                             |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Креатеаппликатионграуп**        | [**Иазскопе:: Креатеаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazscope-createapplicationgroup)<br/>               |
| **Microsoft. Interop. Security. Азролес. IAzScope2. CreateRole**                    | [**Иазскопе:: CreateRole**](/windows/desktop/api/Azroles/nf-azroles-iazscope-createrole)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Креатеролеассигнмент**          | [**IAzScope2:: Креатеролеассигнмент**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-createroleassignment)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Креатероледефинитион**          | [**IAzScope2:: Креатероледефинитион**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-createroledefinition)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. CreateTask**                    | [**Иазскопе:: CreateTask**](/windows/desktop/api/Azroles/nf-azroles-iazscope-createtask)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеаппликатионграуп**        | [**Иазскопе::D Елетеаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deleteapplicationgroup)<br/>               |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеполициадминистратор**     | [**Иазскопе::D Елетеполициадминистратор**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletepolicyadministrator)<br/>         |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеполициадминистраторнаме** | [**Иазскопе::D Елетеполициадминистраторнаме**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletepolicyadministratorname)<br/> |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеполициреадер**            | [**Иазскопе::D Елетеполициреадер**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletepolicyreader)<br/>                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеполициреадернаме**        | [**Иазскопе::D Елетеполициреадернаме**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletepolicyreadername)<br/>               |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетепропертитем**            | [**Иазскопе::D Елетепропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletepropertyitem)<br/>                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетероле**                    | [**Иазскопе::D Елетероле**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deleterole)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетеролеассигнмент**          | [**IAzScope2::D Елетеролеассигнмент**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-deleteroleassignment)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делетероледефинитион**          | [**IAzScope2::D Елетероледефинитион**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-deleteroledefinition)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Делететаск**                    | [**Иазскопе::D Елететаск**](/windows/desktop/api/Azroles/nf-azroles-iazscope-deletetask)<br/>                                       |
| **Свойство Microsoft. Interop. Security. Азролес. IAzScope2..**                   | [**Иазскопе:: Property**](/windows/desktop/api/Azroles/nf-azroles-iazscope-getproperty)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Опенаппликатионграуп**          | [**Иазскопе:: Опенаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazscope-openapplicationgroup)<br/>                   |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Опенроле**                      | [**Иазскопе:: Опенроле**](/windows/desktop/api/Azroles/nf-azroles-iazscope-openrole)<br/>                                           |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Опенролеассигнмент**            | [**IAzScope2:: Опенролеассигнмент**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-openroleassignment)<br/>                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Опенроледефинитион**            | [**IAzScope2:: Опенроледефинитион**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-openroledefinition)<br/>                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Опентаск**                      | [**Иазскопе:: Опентаск**](/windows/desktop/api/Azroles/nf-azroles-iazscope-opentask)<br/>                                           |
| **Microsoft. Interop. Security. Азролес. IAzScope2. SetProperty**                   | [**Иазскопе:: SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazscope-setproperty)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Submit**                        | [**Иазскопе:: submit**](/windows/desktop/api/Azroles/nf-azroles-iazscope-submit)<br/>                                               |
...
| **Microsoft. Interop. Security. Азролес. IAzScope2. Бизрулесвритабле**<br/>         | Только для чтения<br/>  | [**Свойство Бизрулесвритабле объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_bizruleswritable)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Канбеделегатед**<br/>           | Только для чтения<br/>  | [**Свойство Канбеделегатед объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_canbedelegated)<br/>                     |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Описание**<br/>              | Чтение/запись<br/> | [**Свойство Description объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_description)<br/>                           |
| **Microsoft.Interop.Security.Azroles.IAzScope2.Name**<br/>                     | Чтение/запись<br/> | [**Свойство Name объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_name)<br/>                                         |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Полициадминистраторс**<br/>     | Только для чтения<br/>  | [**Свойство Полициадминистраторс объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyadministrators)<br/>         |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Полициадминистраторснаме**<br/> | Только для чтения<br/>  | [**Свойство Полициадминистраторснаме объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyadministratorsname)<br/> |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Полициреадерс**<br/>            | Только для чтения<br/>  | [**Свойство Полициреадерс объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyreaders)<br/>                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Полициреадерснаме**<br/>        | Только для чтения<br/>  | [**Свойство Полициреадерснаме объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyreadersname)<br/>               |
| **Microsoft. Interop. Security. Азролес. IAzScope2. RoleAssignments**<br/>          | Только для чтения<br/>  | [**Свойство RoleAssignments объекта IAzScope2**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-get_roleassignments)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. RoleDefinitions**<br/>          | Только для чтения<br/>  | [**Свойство RoleDefinitions объекта IAzScope2**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-get_roledefinitions)<br/>                 |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Roles**<br/>                    | Только для чтения<br/>  | [**Свойство Roles объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_roles)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. Tasks**<br/>                    | Только для чтения<br/>  | [**Свойство Tasks объекта Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_tasks)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. IAzScope2. доступный для записи**<br/>                 | Только для чтения<br/>  | [**Свойство с возможностью записи для Иазскопе**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_writable)<br/>                                 |
