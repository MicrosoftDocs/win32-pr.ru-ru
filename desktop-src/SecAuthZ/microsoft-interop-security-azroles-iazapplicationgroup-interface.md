...
| **Microsoft. Interop. Security. Азролес. Иазаппликатионграуп. Аддпропертитем**     | [**Иазаппликатионграуп:: Аддпропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addpropertyitem)<br/>         |
