---
description: Ссылки на документацию по методам и свойствам оболочки взаимодействия IAzApplicationGroup2.
ms.assetid: 2a0da33e-4093-4b94-94d3-171a6fabd1ba
title: Интерфейс Microsoft. Interop. Security. Азролес. IAzApplicationGroup2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105651670"
---
# <a name="microsoftinteropsecurityazrolesiazapplicationgroup2-interface"></a>Интерфейс Microsoft. Interop. Security. Азролес. IAzApplicationGroup2

Методы и свойства оболочки взаимодействия **Microsoft. Interop. Security. азролес. IAzApplicationGroup2** описаны в версии COM метода или свойства. Ссылка на коррелированную документацию по COM следует за именем каждого члена.

## <a name="members"></a>Элементы

Интерфейс **Microsoft. Interop. Security. азролес. IAzApplicationGroup2** имеет следующие типы членов:
...
Интерфейс **Microsoft. Interop. Security. азролес. IAzApplicationGroup2** содержит следующие методы.



| Метод                                                                          | Описание                                                                                             |
|:--------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аддаппмембер**        | [**Иазаппликатионграуп:: Аддаппмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappmember)<br/>                |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аддаппнонмембер**     | [**Иазаппликатионграуп:: Аддаппнонмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addappnonmember)<br/>          |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аддмембер**           | [**Иазаппликатионграуп:: Аддмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmember)<br/>                      |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аддмембернаме**       | [**Иазаппликатионграуп:: Аддмембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addmembername)<br/>              |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Адднонмембер**        | [**Иазаппликатионграуп:: Адднонмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmember)<br/>                |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Адднонмембернаме**    | [**Иазаппликатионграуп:: Адднонмембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addnonmembername)<br/>        |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аддпропертитем**     | [**Иазаппликатионграуп:: Аддпропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-addpropertyitem)<br/>          |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетеаппмембер**     | [**Иазаппликатионграуп::D Елетеаппмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappmember)<br/>          |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетеаппнонмембер**  | [**Иазаппликатионграуп::D Елетеаппнонмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deleteappnonmember)<br/>    |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетемембер**        | [**Иазаппликатионграуп::D Елетемембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemember)<br/>                |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетемембернаме**    | [**Иазаппликатионграуп::D Елетемембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletemembername)<br/>        |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетенонмембер**     | [**Иазаппликатионграуп::D Елетенонмембер**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmember)<br/>          |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетенонмембернаме** | [**Иазаппликатионграуп::D Елетенонмембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletenonmembername)<br/>  |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Делетепропертитем**  | [**Иазаппликатионграуп::D Елетепропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-deletepropertyitem)<br/>    |
| **Свойство Microsoft. Interop. Security. Азролес. IAzApplicationGroup2..**         | [**Иазаппликатионграуп:: Property**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-getproperty)<br/>                  |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. RoleAssignments**     | [**IAzApplicationGroup2:: RoleAssignments**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-roleassignments)<br/> |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. SetProperty**         | [**Иазаппликатионграуп:: SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-setproperty)<br/>                  |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Submit**              | [**Иазаппликатионграуп:: submit**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-submit)<br/>                            |
...
Интерфейс **Microsoft. Interop. Security. азролес. IAzApplicationGroup2** имеет следующие свойства.



| Свойство                                                                                   | Тип доступа           | Описание                                                                                                                |
|:-------------------------------------------------------------------------------------------|:----------------------|:---------------------------------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аппмемберс**<br/>          | Только для чтения<br/>  | [**Свойство Аппмемберс объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appmembers)<br/>                            |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Аппнонмемберс**<br/>       | Только для чтения<br/>  | [**Свойство Аппнонмемберс объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_appnonmembers)<br/>                      |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Бизруле**<br/>             | Чтение/запись<br/> | [**Свойство Бизруле объекта IAzApplicationGroup2**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizrule)<br/>                         |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Бизрулеимпортедпас**<br/> | Чтение/запись<br/> | [**Свойство Бизрулеимпортедпас объекта IAzApplicationGroup2**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizruleimportedpath)<br/> |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Бизрулелангуаже**<br/>     | Чтение/запись<br/> | [**Свойство Бизрулелангуаже объекта IAzApplicationGroup2**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup2-get_bizrulelanguage)<br/>         |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Описание**<br/>         | Чтение/запись<br/> | [**Свойство Description объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_description)<br/>                          |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Лдапкуери**<br/>           | Чтение/запись<br/> | [**Свойство Лдапкуери объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_ldapquery)<br/>                              |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Members**<br/>             | Только для чтения<br/>  | [**Свойство Members объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_members)<br/>                                  |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Мемберснаме**<br/>         | Только для чтения<br/>  | [**Свойство Мемберснаме объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_membersname)<br/>                          |
| **Microsoft.Interop.Security.Azroles.IAzApplicationGroup2.Name**<br/>                | Чтение/запись<br/> | [**Свойство Name объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_name)<br/>                                        |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. unmembers**<br/>          | Только для чтения<br/>  | [**Свойство Иазаппликатионграуп, не являющиеся членами**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembers)<br/>                            |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Нонмемберснаме**<br/>      | Только для чтения<br/>  | [**Свойство Нонмемберснаме объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_nonmembersname)<br/>                    |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. Type**<br/>                | Чтение/запись<br/> | [**Свойство Type объекта Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_type)<br/>                                        |
| **Microsoft. Interop. Security. Азролес. IAzApplicationGroup2. доступный для записи**<br/>            | Только для чтения<br/>  | [**Свойство с возможностью записи для Иазаппликатионграуп**](/windows/desktop/api/Azroles/nf-azroles-iazapplicationgroup-get_writable)<br/>                                |
