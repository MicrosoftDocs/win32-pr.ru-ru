---
description: Ссылки на документацию по методам и свойствам оболочки взаимодействия Иазролеассигнмент.
ms.assetid: abf9afee-9a7e-4572-8ead-497c11d0fac4
title: Интерфейс Microsoft. Interop. Security. Азролес. Иазролеассигнмент
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117780947"
---
# <a name="microsoftinteropsecurityazrolesiazroleassignment-interface"></a>Интерфейс Microsoft. Interop. Security. Азролес. Иазролеассигнмент

Методы и свойства оболочки взаимодействия **Microsoft. Interop. Security. азролес. иазролеассигнментассигнмент** описаны в версии COM метода или свойства. Ссылка на коррелированную документацию по COM следует за именем каждого члена.

## <a name="members"></a>Элементы

Интерфейс **Microsoft. Interop. Security. азролес. иазролеассигнмент** имеет следующие типы членов:
...
Интерфейс **Microsoft. Interop. Security. азролес. иазролеассигнмент** содержит следующие методы.



| Метод                                                                        | Описание                                                                                          |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддаппмембер**         | [**Иазроле:: Аддаппмембер**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addappmember)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддмембер**            | [**Иазроле:: Аддмембер**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmember)<br/>                                           |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддмембернаме**        | [**Иазроле:: Аддмембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addmembername)<br/>                                   |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддоператион**         | [**Иазроле:: Аддоператион**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addoperation)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддпропертитем**      | [**Иазроле:: Аддпропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addpropertyitem)<br/>                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Аддроледефинитион**    | [**Иазролеассигнмент:: Аддроледефинитион**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-addroledefinition)<br/>       |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. AddTask**              | [**Иазроле:: AddTask**](/windows/desktop/api/Azroles/nf-azroles-iazrole-addtask)<br/>                                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетеаппмембер**      | [**Иазроле::D Елетеаппмембер**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteappmember)<br/>                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетемембер**         | [**Иазроле::D Елетемембер**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemember)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетемембернаме**     | [**Иазроле::D Елетемембернаме**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletemembername)<br/>                             |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетеоператион**      | [**Иазроле::D Елетеоператион**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deleteoperation)<br/>                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетепропертитем**   | [**Иазроле::D Елетепропертитем**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletepropertyitem)<br/>                         |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делетероледефинитион** | [**Иазролеассигнмент::D Елетероледефинитион**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-deleteroledefinition)<br/> |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Делететаск**           | [**Иазроле::D Елететаск**](/windows/desktop/api/Azroles/nf-azroles-iazrole-deletetask)<br/>                                         |
| **Свойство Microsoft. Interop. Security. Азролес. Иазролеассигнмент..**          | [**Иазроле:: Property**](/windows/desktop/api/Azroles/nf-azroles-iazrole-getproperty)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. SetProperty**          | [**Иазроле:: SetProperty**](/windows/desktop/api/Azroles/nf-azroles-iazrole-setproperty)<br/>                                       |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнмент. Submit**               | [**Иазроле:: submit**](/windows/desktop/api/Azroles/nf-azroles-iazrole-submit)<br/>                                                 |
...
Интерфейс **Microsoft. Interop. Security. азролес. иазролеассигнмент** имеет следующие свойства.



| Свойство                                                                                      | Тип доступа           | Описание                                                                                           |
|:----------------------------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. ApplicationData**<br/> | Чтение/запись<br/> | [**Свойство ApplicationData объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_applicationdata)<br/>                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Аппмемберс**<br/>      | Только для чтения<br/>  | [**Свойство Аппмемберс объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_appmembers)<br/>                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Описание**<br/>     | Чтение/запись<br/> | [**Свойство Description объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_description)<br/>                             |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Members**<br/>         | Только для чтения<br/>  | [**Свойство Members объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_members)<br/>                                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Мемберснаме**<br/>     | Только для чтения<br/>  | [**Свойство Мемберснаме объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_membersname)<br/>                             |
| **Microsoft.Interop.Security.Azroles.IAzRoleAssignmentAssignment.Name**<br/>            | Чтение/запись<br/> | [**Свойство Name объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_name)<br/>                                           |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Operations**<br/>      | Только для чтения<br/>  | [**Свойство Operations объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_operations)<br/>                               |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. RoleDefinitions**<br/> | Только для чтения<br/>  | [**Свойство RoleDefinitions объекта Иазролеассигнмент**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-get_roledefinitions)<br/> |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Scope**<br/>           | Только для чтения<br/>  | [**Свойство Scope объекта Иазролеассигнмент**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignment-get_scope)<br/>                     |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. Tasks**<br/>           | Только для чтения<br/>  | [**Свойство Tasks объекта Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_tasks)<br/>                                         |
| **Microsoft. Interop. Security. Азролес. Иазролеассигнментассигнмент. доступный для записи**<br/>        | Только для чтения<br/>  | [**Свойство с возможностью записи для Иазроле**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_writable)<br/>                                   |
