...
- [Новые структуры VDS](#new-vds-structures)
- [Изменения в существующих перечислениях VDS](#modifications-to-existing-vds-enumerations)
- [Изменения в существующих структурах VDS](#modifications-to-existing-vds-structures)

## <a name="new-vds-interfaces"></a>Новые интерфейсы VDS
...
[**ивдшвпровидерсторажепулс**](/windows/desktop/api/Vds/nn-vds-ivdshwproviderstoragepools)  
[**IVdsLun2**](/windows/desktop/api/Vds/nn-vds-ivdslun2)  
[**ивдслуннумбер**](/windows/desktop/api/Vds/nn-vds-ivdslunnumber)  
[**ивдсопенвдиск**](/windows/desktop/api/Vds/nn-vds-ivdsopenvdisk)  
[**ивдссторажепул**](/windows/desktop/api/Vds/nn-vds-ivdsstoragepool)  
[**IVdsSubSystem2**](/windows/desktop/api/Vds/nn-vds-ivdssubsystem2)  
[**ивдссубсистеминтерконнект**](/windows/desktop/api/Vds/nn-vds-ivdssubsysteminterconnect)  
[**ивдсвдиск**](/windows/desktop/api/Vds/nn-vds-ivdsvdisk)  
[**ивдсвдпровидер**](/windows/desktop/api/Vds/nn-vds-ivdsvdprovider)  
[**IVdsVolume2**](/windows/desktop/api/Vds/nn-vds-ivdsvolume2)  
[**IVdsVolumeMF3**](/windows/desktop/api/Vds/nn-vds-ivdsvolumemf3)  


## <a name="new-vds-enumerations"></a>Новые перечисления VDS
...
## <a name="new-vds-structures"></a>Новые структуры VDS
...
## <a name="modifications-to-existing-vds-enumerations"></a>Изменения в существующих перечислениях VDS

[**VDS_ASYNC_OUTPUT_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_async_output_type) добавлены значения перечисления:
...
[**VDS_CONTROLLER_STATUS**](/windows/desktop/api/Vds/ne-vds-vds_controller_status) добавлено значение перечисления:

**VDS_CS_REMOVED**  


[**VDS_DISK_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_disk_flag) добавлено значение перечисления:

**VDS_DF_BOOT_FROM_DISK**  
**VDS_DF_CURRENT_READ_ONLY**  


[**VDS_DRIVE_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_drive_flag) добавлены значения перечисления:
...
[**VDS_DRIVE_STATUS**](/windows/desktop/api/Vds/ne-vds-vds_drive_status) добавлено значение перечисления:

**VDS_DRS_REMOVED**  


[**VDS_FILE_SYSTEM_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_file_system_type) добавлено значение перечисления:

**VDS_FST_EXFAT**  


[**VDS_HEALTH**](/windows/desktop/api/Vds/ne-vds-vds_health) добавлены значения перечисления:
...
[**VDS_HWPROVIDER_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_hwprovider_type) добавлены значения перечисления:

**VDS_HWT_SAS**  
**VDS_HWT_HYBRID**  


[**VDS_LUN_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_lun_flag) добавлены значения перечисления:
...
[**VDS_LUN_PLEX_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_lun_plex_type) добавлены значения перечисления:
...
[**VDS_LUN_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_lun_type) добавлены значения перечисления:
...
[**VDS_OBJECT_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_object_type) добавлены значения перечисления:
...
[**VDS_PORT_STATUS**](/windows/desktop/api/Vds/ne-vds-vds_port_status) добавлено значение перечисления:

**VDS_DRS_REMOVED**  


[**VDS_PROVIDER_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_provider_flag) добавлены значения перечисления:

**VDS_PF_SUPPORT_MIRROR**  
**VDS_PF_SUPPORT_RAID5**  


[**VDS_PROVIDER_TYPE**](/windows/desktop/api/Vds/ne-vds-vds_provider_type) добавлены значения перечисления:

**VDS_PT_VIRTUALDISK**  
**VDS_PT_MAX**  


[**VDS_SERVICE_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_service_flag) добавлены значения перечисления:

**VDS_SVF_SUPPORT_MIRROR**  
**VDS_SVF_SUPPORT_RAID5**  


[**VDS_SUB_SYSTEM_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_sub_system_flag) добавлены значения перечисления:
...
[**VDS_TRANSITION_STATE**](/windows/desktop/api/Vds/ne-vds-vds_transition_state) добавлено значение перечисления:

**VDS_TS_RESTRIPING**  


[**VDS_VERSION_SUPPORT_FLAG**](/windows/desktop/api/Vds/ne-vds-vds_version_support_flag) добавлены значения перечисления:
...
[**VDS_VOLUME_STATUS**](/windows/desktop/api/Vds/ne-vds-vds_volume_status) добавлено значение перечисления:

**VDS_VS_OFFLINE**  


## <a name="modifications-to-existing-vds-structures"></a>Изменения в существующих структурах VDS

[**VDS_CONTROLLER_NOTIFICATION**](/windows/desktop/api/Vds/ns-vds-vds_controller_notification) структура добавлены значения **улевент** :

VDS_NF_CONTROLLER_MODIFY  
VDS_NF_CONTROLLER_REMOVED  


[**VDS_DRIVE_NOTIFICATIONная**](/windows/desktop/api/Vds/ns-vds-vds_drive_notification) структура добавила значение **улевент** :

VDS_NF_DRIVE_REMOVED  


[**VDS_PORT_NOTIFICATION**](/windows/desktop/api/Vds/ns-vds-vds_port_notification) структура добавлены значения **улевент** :
