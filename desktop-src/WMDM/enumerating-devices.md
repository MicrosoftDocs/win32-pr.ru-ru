---
title: перечисление Windows носителей диспетчер устройств устройств
description: дополнительные сведения о перечислении устройств, обнаруженных Windows мультимедиа диспетчер устройств с помощью интерфейса перечисления.
...
- создание Windows мультимедиа диспетчер устройств приложений, перечисление устройств
