...
ms.locfileid: "119619963"
---
# <a name="interfaces-for-applications"></a>Интерфейсы для приложений

в этом разделе описываются интерфейсы, используемые или реализованные приложениями с помощью Windows Media диспетчер устройств SDK для взаимодействия с устройствами. Термин "приложение", используемый здесь, означает любой исполняемый файл, подключаемый модуль или COM-объект, который существует на настольном компьютере и требует высокого уровня взаимодействия с подключенным портативным устройством. это может быть приложение проигрывателя мультимедиа, подключаемый модуль проигрыватель Windows Media (если ему требуется прямой доступ к портативному устройству) или COM-объект измерения количества воспроизведения.
...
| [**ивмдевицеманажер**](/windows/desktop/api/mswmdm/nn-mswmdm-iwmdevicemanager)                 | интерфейс диспетчер устройств верхнего уровня Windows для приложений.                                                                                                                                              |
