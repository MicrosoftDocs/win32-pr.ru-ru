...
URL-адрес, по которому должны отправляться данные измерения. он выделяется Windows носителя диспетчер устройств и должен быть освобожден вызывающим объектом с помощью **сисфристринг**.
...
Данные контроля использования для отправки в службу измерения. он выделяется Windows носителя диспетчер устройств и должен быть освобожден вызывающим объектом с помощью **сисфристринг**.
