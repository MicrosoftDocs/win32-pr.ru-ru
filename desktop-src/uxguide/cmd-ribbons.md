...
Ленты впервые появились в Microsoft Office 2007. Чтобы узнать, почему в Office требуется использовать ленты и многие проблемы, связанные с лентой, см. [в статье о ленте](/archive/blogs/jensenh/the-story-of-the-ribbon).
...
- **Используйте выделение прописных букв, как в предложении.** Это более подходит для [тона](text-style-tone.md)Windows.
