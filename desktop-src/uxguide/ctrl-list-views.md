...
| | | <strong>Выбор столбца</strong><br /> Иногда представления списка имеют столько столбцов, которое не всегда удобно отображать. В этом случае лучшим подходом является отображение наиболее полезных столбцов по умолчанию и предоставление пользователям возможности добавлять или удалять столбцы по мере необходимости. <br /> | <img src="images/ctrl-list-views-image7.png" alt="Screen shot of list view with Column Chooser menu " /><br /> Если щелкнуть правой кнопкой мыши заголовок столбца, откроется контекстное меню, позволяющее пользователям добавлять или удалять столбцы.<br /><img src="images/ctrl-list-views-image8.png" alt="Screen shot of Choose Details dialog box " /><br /> Если щелкнуть Дополнительно в контекстном меню заголовка столбца, откроется диалоговое окно Выбор столбцов, позволяющее пользователям добавлять или удалять столбцы, а также изменять их порядок.<br /> | | <strong>Представление списка флажков</strong><br /> Разрешить пользователям выбирать несколько элементов.<br /> | Представления списков с множественным выбором имеют тот же внешний вид, что и одноэлементное представление списка, поэтому визуальные подсказки, которые поддерживают множественный выбор, отсутствуют. Представление списка флажков можно использовать, чтобы ясно указать, что возможен выбор нескольких элементов. Следовательно, этот шаблон следует использовать для задач, в которых несколько выделений являются важными или часто используемыми.<br /><img src="images/ctrl-list-views-image9.png" alt="Screen shot of dialog box with several check boxes " /><br /> В этом примере небольшое представление значков использует флажки, так как для нее очень важно выбрать несколько элементов.<br /> | | <strong>Список представлений с группами</strong><br /> Упорядочите данные по группам.<br /> | Хотя представления Details часто поддерживают сортировку данных по любому столбцу, представления списка дополнительно позволяют пользователям упорядочивать элементы по группам. Вот некоторые преимущества группирования:<br /><ul><li>Группы работают во всех представлениях (за исключением списка), поэтому, например, пользователи могли бы сгруппировать по исполнителям эскизы с большим количеством значков.</li><li>Группы могут быть высокоуровневые коллекциями, которые часто более важны, чем группирование данных напрямую. например, Windows Explorer группирует даты в день, вчера, прошлую неделю, ранее в этом году и давно.</li></ul><img src="images/ctrl-list-views-image10.png" alt="Screen shot of list view with several data groups " /><br /> в этом примере центр начальной настройки Windows отображает сгруппированные элементы в представлении списка.<br /> | 
