...
description: общие диалоговые окна Windows Microsoft состоят из диалоговых окон открытие файла, сохранение файла, открытие папки, поиск и замена, печать, настройка страницы, шрифт и цвет.
...
| Color<br/>             | Цвет... или выберите цвет...<br/>        |
