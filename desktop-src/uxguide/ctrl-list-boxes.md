...
| Метка | Применение |
|--------|-------|
| <strong>Списки с одним выбором</strong> Разрешить пользователям выбирать по одному элементу за раз. <br /> | <img src="images/ctrl-list-boxes-image4.png" alt="Screen shot of list box with one item selected " /><br /> В этом примере пользователи могут выбрать только один отображаемый элемент.<br /> | 
| <strong>Стандартные списки с множественным выбором</strong> Разрешить пользователям выбирать любое количество элементов, включая "нет".<br /> | Стандартные списки с множественным выбором имеют точно такой же внешний вид, как списки с одним выбором, поэтому нет визуальной подсказки о том, что список поддерживает множественный выбор. Поскольку пользователи должны обнаружить эту возможность, этот шаблон списка лучше использовать для задач, в которых выбор нескольких элементов не является необходимым и редко используется. <br /> Существует два различных режима множественного выбора: <a href="glossary.md">несколько</a> и <a href="glossary.md">Расширенные</a>. <strong>Режим расширенного выбора</strong> является наиболее распространенным, где выделение можно расширить путем перетаскивания или нажатием клавиш Shift + щелчок и Ctrl + щелчок для выбора групп смежных и несмежных значений соответственно. В <strong>режиме множественного выбора</strong>при щелчке любого элемента переключается состояние выбора, независимо от клавиш SHIFT и CTRL. Учитывая это необычное поведение, режим множественного выбора является устаревшим, и вместо него следует использовать списки с флажками.<br /><img src="images/ctrl-list-boxes-image5.png" alt="Screen shot of list box with several items selected " /><br /> В этом примере пользователи могут выбрать любое количество элементов, используя режим множественного выбора.<br /> | 
| <strong>Списки флажков</strong> Как и в стандартных списках с множественным выбором, списки флажков позволяют пользователям выбирать любое количество элементов, включая «нет».<br /> | В отличие от стандартных списков множественного выбора, флажки четко показывают, что возможен выбор нескольких элементов. Используйте этот шаблон списка для задач, в которых несколько выделений являются важными или часто используемыми. <br /><img src="images/ctrl-list-boxes-image6.png" alt="Screen shot of Toolbars check-box list " /><br /> В этом примере пользователи обычно выбирают более одного элемента, чтобы использовался список флажков.<br /> Учитывая это четкое указание о множественном выборе, можно предположить, что списки флажков предпочтительны для стандартных списков с множественным выбором. На практике для некоторых задач требуется несколько выборок или их интенсивное использование. Использование списка флажков в таких случаях позволяет привлечь слишком много внимания к выделенному фрагменту. Следовательно, <strong>Стандартные списки с множественным выбором гораздо более распространены.</strong><br /> | 
| <strong>Списки предварительного просмотра</strong> Может быть одиночным или множественным выделением, но они показывают результат предварительного выбора, а не просто текст.<br /> | <img src="images/ctrl-list-boxes-image7.png" alt="Screen shot of Window Color options preview " /><br /> В этом примере предварительный просмотр каждого параметра четко показывает результат выбора, что более эффективно, чем использование только текста.<br /> | 
| <strong>Построители списков</strong> Разрешить пользователям создавать список вариантов, добавляя по одному элементу за раз и при необходимости устанавливая порядок списка.<br /> | Построитель списка состоит из двух списков с одним выбором: список слева представляет собой фиксированный набор параметров, а список справа — построение списка. Между списками есть две командные кнопки: <br /><ul><li>Кнопка " <strong>Добавить</strong> ", которая перемещает выбранный в данный момент параметр в список, вставленный перед выбранным элементом. (Двойной щелчок элемента параметра оказывает тот же результат.)</li><li>Кнопка <strong>удаления</strong> , которая удаляет выбранный элемент из созданного списка и возвращает его в список параметров. (Двойной щелчок элемента в построенном списке оказывает такой же результат.) При необходимости в построенном списке можно <strong>переместить команды вверх</strong> и <strong>вниз</strong> , чтобы упорядочить элементы списка.</li></ul><img src="images/ctrl-list-boxes-image8.png" alt="Screen shot of Toolbar buttons list builder " /><br /> В этом примере Построитель списка используется для создания панели инструментов путем выбора элементов из набора доступных параметров и настройки их порядка.<br /> | 
| <strong>Добавить или удалить списки</strong> Разрешить пользователям создавать список вариантов, добавляя по одному или несколько элементов за раз и при необходимости задавая порядок списка (например, построители списков).<br /> | В отличие от построителя списка, при нажатии кнопки <strong>Добавить</strong> отображается диалоговое окно для выбора элементов, добавляемых в список. Использование отдельного диалогового окна обеспечивает значительную гибкость при выборе элементов. можно использовать специализированное средство выбора объектов или даже общее диалоговое окно. По сравнению с построителем списков этот вариант является более компактным, но требует немного больше усилий для добавления элементов. <br /><img src="images/ctrl-list-boxes-image9.png" alt="Screen shot of Menu contents list " /><br /> В этом примере пользователи могут добавлять или удалять средства из меню, а также задавать порядок.<br /> Хотя построитель списков и шаблоны списков для добавления и удаления значительно отличаются от других списков выбора, они предлагают два уникальных преимущества:<br /><ul><li>Пользователи имеют возможность контролировать порядок списка, как при построении списка, так и после.</li><li>Пользователи могут просматривать сводку по выбранным элементам, что может быть значительным преимуществом, если количество вариантов слишком велико.</li></ul>Их недостатки заключается в том, что им требуется гораздо больше пространства на экране, и их сложно использовать при создании большого списка элементов с нуля. Следовательно, они лучше использовать для создания коротких списков или изменения уже существующих списков.<br /> | 
