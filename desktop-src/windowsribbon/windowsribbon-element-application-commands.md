...
Представляет контейнер для всех команд, определенных приложением.
...
Может встречаться не более одного раза для каждого элемента [**приложения**](windowsribbon-element-application.md) .

## <a name="examples"></a>Примеры

В следующем примере показан элемент **Application. Commands** , содержащий манифест команд буфера обмена.
