...
На следующем снимке экрана показан [раскрывающийся список](windowsribbon-controls-dropdowngallery.md) элементов управления "Коллекция ленты" в Microsoft Paint для Windows 7.
