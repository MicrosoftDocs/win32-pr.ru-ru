...
description: как многофункциональная система представления команд, платформа Windows ribbon разработана для широкого создания графических ресурсов на протяжении всего пользовательского интерфейса ленты. Все ресурсы изображений объявляются в разметке ленты или запрашиваются из хост-приложения ленты.
ms.assetid: 37b57992-8da8-4e6b-869d-72a136f6ad77
keywords:
- Windows Лента, ресурсы изображений
- Лента, ресурсы изображений
- Windows Лента, прозрачность
- Лента, прозрачность
- Windows Лента, глубина цвета
- Лента, глубина цвета
- Windows Лента, контрастность
- Лента, контрастность
...
ms.locfileid: "119932599"
---
# <a name="specifying-ribbon-image-resources"></a>Указание ресурсов изображения ленты

как многофункциональная система представления команд, платформа Windows ribbon разработана для широкого создания графических ресурсов на протяжении всего пользовательского интерфейса ленты. Все ресурсы изображений объявляются в [разметке ленты](windowsribbon-schema.md) или запрашиваются из хост-приложения ленты.
