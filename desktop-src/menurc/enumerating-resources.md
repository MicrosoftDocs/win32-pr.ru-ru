...
* Функции [**енумресаурценамесв**](/windows/win32/api/Winbase/nf-winbase-enumresourcenamesw) и [**енумресаурценамесексв**](/windows/win32/api/libloaderapi/nf-libloaderapi-enumresourcenamesexw) предоставляют имя каждого ресурса в заданном типе.
