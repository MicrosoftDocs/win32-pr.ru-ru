...
| *Знак*             | Целочисленное значение, представляющее символ. Параметр *типа* должен быть **ASCII**.                                                                                                                                                           |
