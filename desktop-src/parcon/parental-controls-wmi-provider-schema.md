...
ms.locfileid: "119601214"
---
# <a name="parental-controls-wmi-provider-schema"></a>Схема поставщика WMI родительского контроля

Поставщик WMI родительского контроля — это экземпляр и поставщик метода. Создание экземпляров новых классов, чтение или изменение существующих свойств экземпляра и вызов методов управляются файлом Впкспров. mof.

Ниже приведен синтаксис Namespace. mof.
...
Следующий синтаксис — из файла рейтингов. mof
...
Следующий синтаксис — из Впксеттингс. mof
...
Следующий синтаксис — из Впкпровидер. mof
