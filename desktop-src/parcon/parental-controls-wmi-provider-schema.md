---
description: Поставщик WMI родительского контроля — это экземпляр и поставщик метода. Создание экземпляров новых классов, чтение или изменение существующих свойств экземпляра и вызов методов управляются файлом Впкспров. mof.
ms.assetid: 28d46969-448e-4a67-bfb3-4240b5cebe57
title: Схема поставщика WMI родительского контроля
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104497988"
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="950c7-104">Схема поставщика WMI родительского контроля</span><span class="sxs-lookup"><span data-stu-id="950c7-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="950c7-105">Поставщик WMI родительского контроля — это экземпляр и поставщик метода.</span><span class="sxs-lookup"><span data-stu-id="950c7-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="950c7-106">Создание экземпляров новых классов, чтение или изменение существующих свойств экземпляра и вызов методов управляются файлом Впкспров. mof.</span><span class="sxs-lookup"><span data-stu-id="950c7-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="950c7-107">Ниже приведен синтаксис Namespace. mof.</span><span class="sxs-lookup"><span data-stu-id="950c7-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="950c7-108">Следующий синтаксис — из файла рейтингов. mof</span><span class="sxs-lookup"><span data-stu-id="950c7-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="950c7-109">Следующий синтаксис — из Впксеттингс. mof</span><span class="sxs-lookup"><span data-stu-id="950c7-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="950c7-110">Следующий синтаксис — из Впкпровидер. mof</span><span class="sxs-lookup"><span data-stu-id="950c7-110">The following syntax is from WpcProvider.mof</span></span>
