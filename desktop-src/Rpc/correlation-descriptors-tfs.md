...
\_для Windows 2000 для поддержки [**/robust**](/windows/desktop/Midl/-robust), например функции «отказ в атаке», было добавлено надежное поле flags<2>. В первом байте определены следующие флаги:
