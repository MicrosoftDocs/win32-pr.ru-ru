...
Маркер контекста должен иметь тип [**void \***](/windows/desktop/Midl/void) или тип, который разрешается в [**void \***](/windows/desktop/Midl/void). Серверная программа приводит ее к требуемому типу.
