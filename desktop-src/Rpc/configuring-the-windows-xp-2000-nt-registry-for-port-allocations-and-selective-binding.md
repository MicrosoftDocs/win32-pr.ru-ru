...
Если ключ отсутствует или содержит недопустимое значение, вся конфигурация помечается как недопустимая, и все вызовы **рпксерверусепротсек \*** через [**нкакн \_ IP \_ TCP**](/windows/desktop/Midl/ncacn-ip-tcp) или [**нкадг \_ IP \_ UDP**](/windows/desktop/Midl/ncadg-ip-udp) завершатся сбоем.
...
| Приложение | основная сборка взаимодействия | уип | Результат                                  |
|-------------|-----|-----|-----------------------------------------|
