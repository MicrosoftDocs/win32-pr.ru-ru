...
-   Если тип связи является плоским типом без указателей, подпрограммы упаковки для соответствующего усерм-типа должны просто маршалировать данные в соответствии с макетом типа связи. Например:
...
-   Если тип связи является указателем на другой тип, подпрограммы упаковки для соответствующего усерм-типа должны маршалировать данные в соответствии с макетом для типа, на который указывает тип связи. Подсистема доставки ОНД отвечает за указатель. Например:
