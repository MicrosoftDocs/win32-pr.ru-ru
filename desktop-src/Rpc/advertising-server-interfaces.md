...
приложения могут использовать службу Active Directory, если клиентские и серверные программы работают под Windows 2000. компьютеры, на которых работают клиентские и серверные программы, должны быть членами домена Windows 2000.
