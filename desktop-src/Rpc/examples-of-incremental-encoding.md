...
ms.locfileid: "120021415"
---
# <a name="examples-of-incremental-encoding"></a>Примеры добавочной кодировки

В следующем разделе приведен пример использования обработчика сериализации добавочного стиля для кодирования типов.
