...
Многие раз службы выполняются как системные службы Windows, что означает, что они выполняются под учетной записью компьютера. Также рекомендуется взаимная проверка подлинности и создание имени участника-сервера.
