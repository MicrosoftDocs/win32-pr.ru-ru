...
Windows 7 или более поздней версии: ошибка проверки подлинности. Средство проверки подлинности отклонило учетные данные пользователя.
...
| Заголовок<br/>                   | <dl> <dt>Еафостеррор. h</dt> </dl> |
