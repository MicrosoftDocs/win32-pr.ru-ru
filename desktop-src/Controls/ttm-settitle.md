...
Задайте для параметра *wParam* одно из следующих значений, чтобы указать отображаемый значок. Начиная с Windows XP SP2 и более поздних версий этот параметр также может содержать значение **Хикон** . Значение, превышающее TTI \_ Error, считается **Хикон**.
