...
При создании страницы копия структуры **пропшитпаже** страницы передается в процедуру диалогового окна с [WM_INITDIALOG](../dlgbox/wm-initdialog.md) сообщением. Член *lParam* позволяет передавать сведения о приложении в процедуру диалогового окна. Не влияет на саму страницу.
