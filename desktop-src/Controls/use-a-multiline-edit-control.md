...
> [!Note]  
> Если окно содержит ленту Windows, размер элемента управления "поле ввода" должен быть скорректирован в соответствии с высотой ленты. Дополнительные сведения см. в разделе [Windows Ribbon Framework](/windows/desktop/windowsribbon/-uiplat-windowsribbon-entry).
