---
title: Изменить структуры элементов управления
description: Изменить структуры элементов управления
...
ms.locfileid: "119917114"
---
# <a name="edit-control-structures"></a>Изменить структуры элементов управления
