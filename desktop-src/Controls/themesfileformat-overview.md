...
при инициализации Windows операционная система перечисляет подкаталоги первого уровня для ресурсов% WinDir% \\ \\ , чтобы найти доступные темы. Системные файлы темы по умолчанию расположены в темах% WinDir% \\ ресурсов \\ . файлы пользовательских тем хранятся в файле% WinDir% \\ users \\ &lt; username &gt; \\ AppData \\ Local \\ Microsoft \\ Windows \\ themes.
