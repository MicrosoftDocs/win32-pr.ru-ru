---
title: Структуры списка
description: Структуры списка
...
ms.locfileid: "119971464"
---
# <a name="list-box-structures"></a>Структуры списка

## <a name="in-this-section"></a>В этом разделе

-   [**делетеитемструкт**](/windows/win32/api/winuser/ns-winuser-deleteitemstruct)
-   [**драглистинфо**](/windows/win32/api/commctrl/ns-commctrl-draglistinfo)
