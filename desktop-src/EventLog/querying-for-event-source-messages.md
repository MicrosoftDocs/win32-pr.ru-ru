...
ms.locfileid: "119927834"
---
# <a name="querying-for-event-information"></a>Запрос сведений о событии

В следующем примере показано, как открыть журнал событий, прочитать события из журнала, распечатать сведения о событиях, а затем закрыть журнал событий. Этот пример фильтрует события, записанные в примере в [сообщении о событии](reporting-an-event.md).
