...
---
# <a name="using-events-to-calculate-cpu-usage"></a>Использование событий для вычисления загрузки ЦП

В следующем примере показано, как использовать события для вычисления загрузки ЦП для набора инструкций. В этом примере предполагается, что поставщик создает оболочку для набора инструкций с типом события Start и типом завершающего события.
