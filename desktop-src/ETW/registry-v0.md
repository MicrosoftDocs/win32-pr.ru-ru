---
description: Registry_V0 класс. Этот класс является родительским классом для событий реестра. Следующий синтаксис упрощен из MOF-кода.
...
ms.locfileid: "118394236"
---
# <a name="registry_v0-class"></a>\_Класс v0 реестра
