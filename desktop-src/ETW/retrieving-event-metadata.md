...
ms.locfileid: "119766544"
---
# <a name="retrieving-event-metadata"></a>Получение метаданных события

В следующем примере показано, как использовать вспомогательные функции данных трассировки для получения метаданных для каждого события. См. также примеры, входящие в функции [**тдхкуерипровидерфиелдинформатион**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) и [**тдхенумератепровидерфиелдинформатион**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) .
