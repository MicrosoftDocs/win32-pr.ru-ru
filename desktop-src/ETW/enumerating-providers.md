...
ms.locfileid: "119755074"
---
# <a name="enumerating-providers"></a>Перечисление поставщиков

Чтобы получить список поставщиков, на которых установлены классы манифеста или MOF на компьютере, вызовите функцию [**тдхенумератепровидерс**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviders) .

В следующем примере показано, как перечислить поставщиков.
