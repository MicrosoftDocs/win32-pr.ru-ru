---
description: В следующем примере показано, как запустить сеанс трассировки, включить поставщик на основе манифеста или классического поставщика, отключить поставщик, а затем остановить сеанс.
...
---
# <a name="example-that-creates-a-session-and-enables-a-manifest-based-or-classic-provider"></a><span data-ttu-id="e9740-103">Пример, в котором создается сеанс и включается поставщик на основе манифеста или классического поставщика</span><span class="sxs-lookup"><span data-stu-id="e9740-103">Example that Creates a Session and Enables a Manifest-based or Classic Provider</span></span>

<span data-ttu-id="e9740-104">В следующем примере показано, как запустить сеанс трассировки, включить поставщик на основе манифеста или классического поставщика, отключить поставщик, а затем остановить сеанс.</span><span class="sxs-lookup"><span data-stu-id="e9740-104">The following example shows how to start a trace session, enables a manifest-based or classic provider, disables the provider and then stops the session.</span></span>
