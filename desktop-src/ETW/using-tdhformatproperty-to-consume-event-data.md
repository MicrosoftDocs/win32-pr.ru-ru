...
ms.locfileid: "118951233"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a>Использование Тдхформатпроперти для использования данных событий

В следующем примере показано, как использовать данные событий с помощью функции [**тдхформатпроперти**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .
