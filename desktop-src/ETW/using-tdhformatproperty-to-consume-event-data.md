---
description: В следующем примере показано, как использовать данные событий с помощью функции Тдхформатпроперти.
ms.assetid: 5ebd500c-420e-4979-a03a-49b687464b0e
title: Использование Тдхформатпроперти для использования данных событий
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104984552"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="49ac5-103">Использование Тдхформатпроперти для использования данных событий</span><span class="sxs-lookup"><span data-stu-id="49ac5-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="49ac5-104">В следующем примере показано, как использовать данные событий с помощью функции [**тдхформатпроперти**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .</span><span class="sxs-lookup"><span data-stu-id="49ac5-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
