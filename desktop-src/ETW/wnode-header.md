...
Б. Если Ресерведфлагс = = 2 (системное время): DOUBLE Тиместампскале = 1,0;  
...
В. Если Ресерведфлагс = = 3 (счетчик циклов ЦП): DOUBLE Тиместампскале = 10,0/файл_журнала. Логфилехеадер. Кпуспидинмхз;  
