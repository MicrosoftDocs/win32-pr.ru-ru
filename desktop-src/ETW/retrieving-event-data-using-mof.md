...
Начиная с Windows Vista, для использования событий, опубликованных с помощью классов MOF, рекомендуется использовать функции TDH данных трассировки. Дополнительные сведения см. в разделе [Получение данных о событиях с помощью TDH](retrieving-event-data-using-tdh.md).
