---
description: В следующем примере показано, как использовать данные событий с помощью функции Тдхжетпроперти.
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: Использование Тдхжетпроперти для использования данных событий
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103810925"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="0b62d-103">Использование Тдхжетпроперти для использования данных событий</span><span class="sxs-lookup"><span data-stu-id="0b62d-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="0b62d-104">В следующем примере показано, как использовать данные событий с помощью функции [**тдхжетпроперти**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .</span><span class="sxs-lookup"><span data-stu-id="0b62d-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
