...
ms.locfileid: "120083114"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a>Использование Тдхжетпроперти для использования данных событий

В следующем примере показано, как использовать данные событий с помощью функции [**тдхжетпроперти**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .
