...
---
# <a name="publishing-your-event-schema-for-a-manifest-based-provider"></a><span data-ttu-id="0a4c7-103">Публикация схемы событий для поставщика на основе манифеста</span><span class="sxs-lookup"><span data-stu-id="0a4c7-103">Publishing Your Event Schema for a Manifest-based Provider</span></span>

<span data-ttu-id="0a4c7-104">Поставщики [на основе манифеста](about-event-tracing.md) используют манифест для публикации схемы для своих событий.</span><span class="sxs-lookup"><span data-stu-id="0a4c7-104">[Manifest-based](about-event-tracing.md) providers use a manifest to publish the schema for their events.</span></span> <span data-ttu-id="0a4c7-105">Манифест внедряется в двоичный файл поставщика, что означает, что поставщик должен быть доступен на компьютере, чтобы потребитель использовал его события.</span><span class="sxs-lookup"><span data-stu-id="0a4c7-105">The manifest is embedded in the provider binary, which means that the provider must be available on the computer for the consumer to consume its events.</span></span> <span data-ttu-id="0a4c7-106">Подробные сведения о создании манифеста см. в разделе [написание манифеста инструментирования](../wes/writing-an-instrumentation-manifest.md).</span><span class="sxs-lookup"><span data-stu-id="0a4c7-106">For complete details on writing a manifest, see [Writing an Instrumentation Manifest](../wes/writing-an-instrumentation-manifest.md).</span></span>

<span data-ttu-id="0a4c7-107">Следующий манифест определяет события, которые используются в примерах в разделе [предоставление событий](providing-events.md) и [Использование событий](consuming-events.md) в документе.</span><span class="sxs-lookup"><span data-stu-id="0a4c7-107">The following manifest defines the events that are used in examples in the [Providing Events](providing-events.md) and [Consuming Events](consuming-events.md) section of the document.</span></span>
