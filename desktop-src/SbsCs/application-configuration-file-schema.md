---
description: Ниже приведен полный список схемы файла конфигурации приложения.
ms.assetid: c673dbff-cb64-4e90-88a8-c5f2c259f1d3
title: Схема файла конфигурации приложения
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104264824"
---
# <a name="application-configuration-file-schema"></a><span data-ttu-id="aab32-103">Схема файла конфигурации приложения</span><span class="sxs-lookup"><span data-stu-id="aab32-103">Application Configuration File Schema</span></span>

<span data-ttu-id="aab32-104">Ниже приведен полный список схемы файла конфигурации приложения.</span><span class="sxs-lookup"><span data-stu-id="aab32-104">The following is the complete listing of the application configuration file schema.</span></span>
