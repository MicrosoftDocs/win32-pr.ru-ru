...
Имя файла конфигурации приложения — это имя исполняемого объекта приложения, за которым следует .config.
...
Как первый подэлемент элемента **dependentAssembly** , **assemblyIdentity** описывает параллельную сборку, от которой зависит приложение. Файл конфигурации приложения перестраивает удостоверение этой требуемой сборки. Например, следующие **assemblyIdentity** и **bindingRedirect** перестраивают зависимость от корпорации Майкрософт. Windows. Самплеассембли от версии 2.0.0.0 до версии 2.1.0.0.
