---
description: Ниже приведен полный список схемы файла манифеста.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Схема файла манифеста
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105651535"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="44c94-103">Схема файла манифеста</span><span class="sxs-lookup"><span data-stu-id="44c94-103">Manifest File Schema</span></span>

<span data-ttu-id="44c94-104">Ниже приведен полный список схемы файла манифеста.</span><span class="sxs-lookup"><span data-stu-id="44c94-104">The following is the complete listing of the manifest file schema.</span></span>
