...
| **processorArchitecture** | Указывает процессор. Допустимые значения: x86 для 32-разрядных Windows и ia64 для 64-разрядной версии Windows. Необязательный элемент.                                                                                                                                                                                                                                                                                                                               |
...
Элемент **comClass** может иметь элементы <progid>...</progid> в качестве дочерних элементов, в которых перечислены зависимые от версии идентификаторы ProgID.
...
| proxyStubClsid32  | Сопоставляет идентификатор IID с идентификатором CLSID в 32-разрядных прокси-библиотеках.                                                                                                                                                |
