...
Если при установке существующего приложения COM+ из файла .msi возникает ошибка, приложение не отображается в оснастке "службы компонентов", но может появиться в окне "Установка и удаление программ". в этом случае его необходимо удалить вручную.
