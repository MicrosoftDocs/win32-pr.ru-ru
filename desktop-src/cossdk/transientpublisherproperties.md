---
description: Содержит объект для каждого временного свойства издателя для родительской коллекции Трансиентсубскриптионс. Временные подписки можно создавать на лету для запуска экземпляров объектов, и они исчезают при уничтожении объекта.
ms.assetid: 63921caa-5c22-4203-b1a3-f143928f4742
title: Коллекция Трансиентпублишерпропертиес
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105692030"
---
# <a name="transientpublisherproperties-collection"></a>Коллекция Трансиентпублишерпропертиес

Содержит объект для каждого временного свойства издателя для родительской коллекции [**трансиентсубскриптионс**](transientsubscriptions.md) . Временные подписки можно создавать на лету для запуска экземпляров объектов, и они исчезают при уничтожении объекта.
...
Коллекция **трансиентпублишерпропертиес** наследует от интерфейса [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) , но не содержит дополнительных элементов.
