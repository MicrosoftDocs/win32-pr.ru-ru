...
---
# <a name="dns-structures"></a>Структуры DNS

Для использования с DNS определяются следующие структуры.
...
В API DNS также включены следующие структуры записи ресурсов (RR). Эти структуры используются со структурой **DNS_RECORD** для программного управления записями ресурсов DNS.
