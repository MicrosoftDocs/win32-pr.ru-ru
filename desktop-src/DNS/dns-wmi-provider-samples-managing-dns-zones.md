---
title: Примеры поставщика WMI для DNS — управление зоны DNS
description: Примеры поставщика WMI для DNS — управление зоны DNS
...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="27d7f-104">Примеры поставщика WMI для DNS — управление зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="27d7f-105">В этом разделе описываются задачи создания скриптов, связанные с управлением зонами DNS.</span><span class="sxs-lookup"><span data-stu-id="27d7f-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="27d7f-106">Ссылки на подпрограммы в файле скрипта приведены ниже.</span><span class="sxs-lookup"><span data-stu-id="27d7f-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="27d7f-107">Создание зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="27d7f-108">Изменение зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="27d7f-109">Удаление зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="27d7f-110">Добавление IP-адреса зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="27d7f-111">Удаление IP-адреса зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="27d7f-112">Приостановка зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="27d7f-113">Возобновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="27d7f-114">Обновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="27d7f-115">Перезагрузить зону</span><span class="sxs-lookup"><span data-stu-id="27d7f-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="27d7f-116">Обновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="27d7f-117">Создание зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="27d7f-118">Изменение зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="27d7f-119">Удаление зоны DNS</span><span class="sxs-lookup"><span data-stu-id="27d7f-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="27d7f-120">Добавление IP-адреса зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="27d7f-121">Удаление IP-адреса зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="27d7f-122">Приостановка зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="27d7f-123">Возобновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="27d7f-124">Обновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="27d7f-125">Перезагрузить зону</span><span class="sxs-lookup"><span data-stu-id="27d7f-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="27d7f-126">Обновление зоны</span><span class="sxs-lookup"><span data-stu-id="27d7f-126">Refresh a Zone</span></span>
