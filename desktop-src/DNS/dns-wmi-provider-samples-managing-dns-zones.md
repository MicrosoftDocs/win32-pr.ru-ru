...
В этом разделе описываются задачи создания скриптов, связанные с управлением зонами DNS. Ссылки на подпрограммы в файле скрипта приведены ниже.

-   [Создание зоны DNS](#create-a-dns-zone)
-   [Изменение зоны DNS](#modify-a-dns-zone)
-   [Удаление зоны DNS](#delete-a-dns-zone)
-   [Добавление IP-адреса зоны](#add-a-zone-ip-address)
-   [Удаление IP-адреса зоны](#delete-a-zone-ip-address)
-   [Приостановка зоны](#pause-a-zone)
-   [Возобновление зоны](#resume-a-zone)
-   [Обновление зоны](#update-a-zone)
-   [Перезагрузить зону](#reload-a-zone)
-   [Обновление зоны](#refresh-a-zone)
...
## <a name="modify-a-dns-zone"></a>Изменение зоны DNS
...
## <a name="add-a-zone-ip-address"></a>Добавление IP-адреса зоны
...
## <a name="delete-a-zone-ip-address"></a>Удаление IP-адреса зоны
...
## <a name="pause-a-zone"></a>Приостановка зоны
...
## <a name="resume-a-zone"></a>Возобновление зоны
...
## <a name="update-a-zone"></a>Обновление зоны
...
## <a name="reload-a-zone"></a>Перезагрузить зону
...
## <a name="refresh-a-zone"></a>Обновление зоны
