---
title: Примеры поставщика WMI для DNS — управление записями ресурсов DNS
description: Примеры поставщика WMI для DNS — управление записями ресурсов DNS
...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a><span data-ttu-id="2c461-103">Примеры поставщика WMI для DNS — управление записями ресурсов DNS</span><span class="sxs-lookup"><span data-stu-id="2c461-103">DNS WMI Provider Samples—Managing DNS Resource Records</span></span>

<span data-ttu-id="2c461-104">В этом разделе описываются задачи создания скриптов, связанные с управлением записями ресурсов DNS.</span><span class="sxs-lookup"><span data-stu-id="2c461-104">This section demonstrates scripting tasks associated with managing DNS resource records.</span></span> <span data-ttu-id="2c461-105">Приведенные ниже ссылки позволяют перейти к подпрограммам в файле скрипта.</span><span class="sxs-lookup"><span data-stu-id="2c461-105">The links below jump to subroutines in the script file.</span></span>

-   [<span data-ttu-id="2c461-106">Список записей ресурсов</span><span class="sxs-lookup"><span data-stu-id="2c461-106">List resource records</span></span>](#list-resource-records)
-   [<span data-ttu-id="2c461-107">Добавление записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-107">Add a resource record</span></span>](#add-a-resource-record)
-   [<span data-ttu-id="2c461-108">Удаление записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-108">Delete a resource record</span></span>](#delete-a-resource-record)
-   [<span data-ttu-id="2c461-109">Изменение записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-109">Modify a resource record</span></span>](#modify-a-resource-record)
-   [<span data-ttu-id="2c461-110">Подключение к поставщику WMI DNS</span><span class="sxs-lookup"><span data-stu-id="2c461-110">Connect to the DNS WMI Provider</span></span>](#connect-to-the-dns-wmi-provider)

<span data-ttu-id="2c461-111">Общая реализация сценария выглядит следующим образом:</span><span class="sxs-lookup"><span data-stu-id="2c461-111">The general implementation of the script is as follows:</span></span>

1.  <span data-ttu-id="2c461-112">Для каждого типа записи ресурса создается класс.</span><span class="sxs-lookup"><span data-stu-id="2c461-112">A class is created for each resource record type.</span></span>
2.  <span data-ttu-id="2c461-113">Данные записи ресурса предоставляются с помощью входных данных командной строки пользователя и данных поставщика WMI DNS для каждого класса типа записи.</span><span class="sxs-lookup"><span data-stu-id="2c461-113">Resource record data is provided through user command-line inputs and DNS WMI Provider information for each record type class.</span></span>
3.  <span data-ttu-id="2c461-114">Общие функции, такие как List, DELETE и Modify, создаются и могут использоваться в отдельных классах типа записей ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2c461-114">Common functions such as list, delete, and modify are created and can be used on individual resource record type classes.</span></span>

<span data-ttu-id="2c461-115">В этом примере кода показаны задачи, связанные с управлением записями ресурсов DNS.</span><span class="sxs-lookup"><span data-stu-id="2c461-115">This code example shows tasks associated with Managing DNS resource records.</span></span>
...
## <a name="list-resource-records"></a><span data-ttu-id="2c461-116">Список записей ресурсов</span><span class="sxs-lookup"><span data-stu-id="2c461-116">List Resource Records</span></span>

<span data-ttu-id="2c461-117">В этом примере кода показаны задачи, связанные с выводом списка записей ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2c461-117">This code example shows tasks associated with listing resource records.</span></span>
...
## <a name="add-a-resource-record"></a><span data-ttu-id="2c461-118">Добавление записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-118">Add a Resource Record</span></span>

<span data-ttu-id="2c461-119">В этом примере кода показаны задачи, связанные с добавлением записей ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2c461-119">This code example shows tasks associated with adding resource records.</span></span>
...
## <a name="delete-a-resource-record"></a><span data-ttu-id="2c461-120">Удаление записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-120">Delete a Resource Record</span></span>

<span data-ttu-id="2c461-121">В этом примере кода показаны задачи, связанные с удалением записей ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2c461-121">This code example shows tasks associated with deleting resource records.</span></span>
...
## <a name="modify-a-resource-record"></a><span data-ttu-id="2c461-122">Изменение записи ресурса</span><span class="sxs-lookup"><span data-stu-id="2c461-122">Modify a Resource Record</span></span>

<span data-ttu-id="2c461-123">В этом примере кода показаны задачи, связанные с изменением записей ресурсов.</span><span class="sxs-lookup"><span data-stu-id="2c461-123">This code example shows tasks associated with changing resource records.</span></span>
...
## <a name="connect-to-the-dns-wmi-provider"></a><span data-ttu-id="2c461-124">Подключение к поставщику WMI DNS</span><span class="sxs-lookup"><span data-stu-id="2c461-124">Connect to the DNS WMI Provider</span></span>

<span data-ttu-id="2c461-125">В этом примере кода показаны задачи, связанные с подключением к поставщику WMI для DNS.</span><span class="sxs-lookup"><span data-stu-id="2c461-125">This code example shows tasks associated with connecting to a DNS WMI Provider.</span></span>
