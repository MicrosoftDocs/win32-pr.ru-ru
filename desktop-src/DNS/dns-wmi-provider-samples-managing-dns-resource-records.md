...
В этом разделе описываются задачи создания скриптов, связанные с управлением записями ресурсов DNS. Приведенные ниже ссылки позволяют перейти к подпрограммам в файле скрипта.

-   [Список записей ресурсов](#list-resource-records)
...
1.  Для каждого типа записи ресурса создается класс.
2.  Данные записи ресурса предоставляются с помощью входных данных командной строки пользователя и данных поставщика WMI DNS для каждого класса типа записи.
3.  Общие функции, такие как List, DELETE и Modify, создаются и могут использоваться в отдельных классах типа записей ресурсов.

В этом примере кода показаны задачи, связанные с управлением записями ресурсов DNS.
...
## <a name="list-resource-records"></a>Список записей ресурсов

В этом примере кода показаны задачи, связанные с выводом списка записей ресурсов.
...
## <a name="add-a-resource-record"></a>Добавление записи ресурса

В этом примере кода показаны задачи, связанные с добавлением записей ресурсов.
...
## <a name="delete-a-resource-record"></a>Удаление записи ресурса

В этом примере кода показаны задачи, связанные с удалением записей ресурсов.
...
## <a name="modify-a-resource-record"></a>Изменение записи ресурса

В этом примере кода показаны задачи, связанные с изменением записей ресурсов.
