...
ms.locfileid: "119795714"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a>Примеры поставщика WMI для DNS — управление DNS-сервером
...
В этом разделе описываются задачи создания скриптов, связанные с управлением DNS-сервером. Приведенные ниже ссылки переходят к подпрограммам в файле скрипта:

-   [Вывод свойств DNS-сервера](#list-dns-server-properties)
-   [Завершение, запуск или перезапуск DNS-сервера](#stop-start-or-restart-a-dns-server)
-   [Изменение свойств DNS-сервера](#modify-dns-server-properties)
-   [Добавление IP-адреса](#add-an-ip-address)
-   [Удаление IP-адреса](#delete-an-ip-address)
-   [Список зон](#list-zones)
...
## <a name="list-dns-server-properties"></a>Вывод свойств DNS-сервера
...
## <a name="stop-start-or-restart-a-dns-server"></a>Завершение, запуск или перезапуск DNS-сервера
...
## <a name="modify-dns-server-properties"></a>Изменение свойств DNS-сервера
...
## <a name="delete-an-ip-address"></a>Удаление IP-адреса
...
## <a name="list-zones"></a>Список зон
