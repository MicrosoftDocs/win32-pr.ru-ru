---
title: Примеры поставщика WMI для DNS — управление DNS-сервером
description: Примеры поставщика WMI для DNS — управление DNS-сервером
...
ms.locfileid: "104536419"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="3e0bb-103">Примеры поставщика WMI для DNS — управление DNS-сервером</span><span class="sxs-lookup"><span data-stu-id="3e0bb-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="3e0bb-104">Эта статья содержит ссылки на термин slave (ведомый). Корпорация Майкрософт больше не использует его.</span><span class="sxs-lookup"><span data-stu-id="3e0bb-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="3e0bb-105">Когда этот термин будет удален из программного обеспечения, мы удалим его из статьи.</span><span class="sxs-lookup"><span data-stu-id="3e0bb-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="3e0bb-106">В этом разделе описываются задачи создания скриптов, связанные с управлением DNS-сервером.</span><span class="sxs-lookup"><span data-stu-id="3e0bb-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="3e0bb-107">Приведенные ниже ссылки переходят к подпрограммам в файле скрипта:</span><span class="sxs-lookup"><span data-stu-id="3e0bb-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="3e0bb-108">Вывод свойств DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="3e0bb-109">Завершение, запуск или перезапуск DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="3e0bb-110">Изменение свойств DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="3e0bb-111">Добавление IP-адреса</span><span class="sxs-lookup"><span data-stu-id="3e0bb-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="3e0bb-112">Удаление IP-адреса</span><span class="sxs-lookup"><span data-stu-id="3e0bb-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="3e0bb-113">Список зон</span><span class="sxs-lookup"><span data-stu-id="3e0bb-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="3e0bb-114">Вывод свойств DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="3e0bb-115">Завершение, запуск или перезапуск DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="3e0bb-116">Изменение свойств DNS-сервера</span><span class="sxs-lookup"><span data-stu-id="3e0bb-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="3e0bb-117">Добавление IP-адреса</span><span class="sxs-lookup"><span data-stu-id="3e0bb-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="3e0bb-118">Удаление IP-адреса</span><span class="sxs-lookup"><span data-stu-id="3e0bb-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="3e0bb-119">Список зон</span><span class="sxs-lookup"><span data-stu-id="3e0bb-119">List Zones</span></span>
