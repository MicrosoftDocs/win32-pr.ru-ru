...
| **Изменить**                         | Обновляет значения TTL, флаг сопоставления, время ожидания, время ожидания кэша и домен результата, до значений, указанных в качестве входных параметров этого метода. Если новое значение параметра не указано, текущее значение параметра не изменяется. Метод возвращает ссылку на измененный объект в качестве выходного параметра. <br/> Квалификаторы: Реализовано<br/>                          |
