---
title: Обратные вызовы DNS
description: Обратные вызовы DNS
...
ms.locfileid: "103986050"
---
# <a name="dns-callbacks"></a>Обратные вызовы DNS

Для DNS определены следующие обратные вызовы.
