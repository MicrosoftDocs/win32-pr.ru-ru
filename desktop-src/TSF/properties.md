...
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Статический         | Объект статического свойства хранит данные свойства с текстом. Он также хранит диапазон текстовых данных для каждого диапазона, к которому применяется свойство. Итфреадонлипроперти:: GetType возвращает \_ \_ СТАТИЧЕСКУЮ категорию GUID тфкат пропстиле \_ .                                                                                                                                                                                                                      |
