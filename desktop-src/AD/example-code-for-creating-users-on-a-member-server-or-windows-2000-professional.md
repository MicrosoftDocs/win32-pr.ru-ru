---
title: пример кода для создания пользователей на рядовом сервере или Windows 2000 Professional
description: в следующем Visual Basic примере кода создается пользователь на рядовом сервере или Windows 2000 Professional.
ms.assetid: 0a0800d6-eb2c-4d88-b9d4-91640206fe7b
ms.tgt_platform: multiple
keywords:
- Active Directory примеры Active Directory, создание пользователей на рядовом сервере или Windows 2000 Professional
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "118962293"
---
# <a name="example-code-for-creating-users-on-a-member-server-or-windows-2000-professional"></a>пример кода для создания пользователей на рядовом сервере или Windows 2000 Professional

в следующем Visual Basic примере кода создается пользователь на рядовом сервере или Windows 2000 Professional.
