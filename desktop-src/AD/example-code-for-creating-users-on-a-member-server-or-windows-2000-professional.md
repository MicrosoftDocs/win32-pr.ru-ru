...
---
# <a name="example-code-for-creating-users-on-a-member-server-or-windows-2000-professional"></a>Пример кода для создания пользователей на рядовом сервере или в Windows 2000 Professional

В следующем примере кода Visual Basic создается пользователь на рядовом сервере или в Windows 2000 Professional.
