---
title: Пример кода для создания локальной группы
description: Пример кода для создания локальной группы
...
---
# <a name="example-code-for-creating-a-local-group"></a><span data-ttu-id="a5f0c-104">Пример кода для создания локальной группы</span><span class="sxs-lookup"><span data-stu-id="a5f0c-104">Example Code for Creating a Local Group</span></span>

<span data-ttu-id="a5f0c-105">В следующем примере кода C++ создается локальная группа на рядовом сервере или компьютере под управлением Windows NT Workstation или Windows 2000 Professional.</span><span class="sxs-lookup"><span data-stu-id="a5f0c-105">The following C++ code example creates a local group on a member server or a computer running on Windows NT Workstation or Windows 2000 Professional.</span></span>
...
<span data-ttu-id="a5f0c-106">В следующем Visual Basic примере кода создается локальная группа на рядовом сервере или компьютере под управлением Windows NT Workstation или Windows 2000 Professional.</span><span class="sxs-lookup"><span data-stu-id="a5f0c-106">The following Visual Basic code example creates a local group on a member server or a computer running on Windows NT Workstation or Windows 2000 Professional.</span></span>
