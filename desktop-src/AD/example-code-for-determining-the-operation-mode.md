...
Этот раздел содержит пример кода, который считывает свойство **нтмикседдомаин** домена и определяет режим работы.

В следующем примере кода C++ считывается свойство **нтмикседдомаин** домена и определяется режим работы.
