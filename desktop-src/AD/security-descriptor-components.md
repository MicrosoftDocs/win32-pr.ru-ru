...
-   Набор контрольных флагов управления **\_ дескрипторами \_ безопасности** , которые определяют значение дескриптора безопасности или его компонентов: например, флаг **\_ \_ защищенного списка DACL** позволяет защитить список DACL дескриптора безопасности от наследования ACE от родительского объекта.
