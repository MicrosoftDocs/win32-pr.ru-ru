...
Следующий пример кода можно использовать для реализации расширения страницы свойств Active Directory.

## <a name="ishellextinit-implementation"></a>Реализация Ишеллекстинит

Следующий пример кода C++ можно использовать для реализации методов [**ишеллекстинит**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="ishellpropsheetext-implementation"></a>Реализация Ишеллпропшитекст

Следующий пример кода C++ можно использовать для реализации методов [**ишеллпропшитекст**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .
...
## <a name="miscellaneous-implementation"></a>Прочая реализация

Следующий пример кода C++ можно использовать для реализации вспомогательных методов и функций, используемых в предыдущем примере кода.
