---
title: Пример кода для реализации COM-объекта страницы свойств
description: Следующий пример кода можно использовать для реализации расширения страницы свойств Active Directory.
...
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a><span data-ttu-id="1c156-104">Пример кода для реализации COM-объекта страницы свойств</span><span class="sxs-lookup"><span data-stu-id="1c156-104">Example Code for Implementation of the Property Sheet COM Object</span></span>

<span data-ttu-id="1c156-105">Следующий пример кода можно использовать для реализации расширения страницы свойств Active Directory.</span><span class="sxs-lookup"><span data-stu-id="1c156-105">The following code example can be used to implement an Active Directory property sheet extension.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="1c156-106">Реализация Ишеллекстинит</span><span class="sxs-lookup"><span data-stu-id="1c156-106">IShellExtInit Implementation</span></span>

<span data-ttu-id="1c156-107">Следующий пример кода C++ можно использовать для реализации методов [**ишеллекстинит**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .</span><span class="sxs-lookup"><span data-stu-id="1c156-107">The following C++ code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="ishellpropsheetext-implementation"></a><span data-ttu-id="1c156-108">Реализация Ишеллпропшитекст</span><span class="sxs-lookup"><span data-stu-id="1c156-108">IShellPropSheetExt Implementation</span></span>

<span data-ttu-id="1c156-109">Следующий пример кода C++ можно использовать для реализации методов [**ишеллпропшитекст**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .</span><span class="sxs-lookup"><span data-stu-id="1c156-109">The following C++ code example can be used to implement the [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) methods.</span></span>
...
## <a name="miscellaneous-implementation"></a><span data-ttu-id="1c156-110">Прочая реализация</span><span class="sxs-lookup"><span data-stu-id="1c156-110">Miscellaneous Implementation</span></span>

<span data-ttu-id="1c156-111">Следующий пример кода C++ можно использовать для реализации вспомогательных методов и функций, используемых в предыдущем примере кода.</span><span class="sxs-lookup"><span data-stu-id="1c156-111">The following C++ code example can be used to implement the utility methods and functions used in the previous code example.</span></span>
