...
---
# <a name="example-code-for-changing-the-scope-of-a-group"></a><span data-ttu-id="b88b2-104">Пример кода для изменения области группы</span><span class="sxs-lookup"><span data-stu-id="b88b2-104">Example Code for Changing the Scope of a Group</span></span>

<span data-ttu-id="b88b2-105">В следующем примере кода C++ изменяется область группы.</span><span class="sxs-lookup"><span data-stu-id="b88b2-105">The following C++ code example changes the scope of a group.</span></span>
...
<span data-ttu-id="b88b2-106">В следующем примере кода Visual Basic изменяется область группы.</span><span class="sxs-lookup"><span data-stu-id="b88b2-106">The following Visual Basic code example changes the scope of a group.</span></span>
