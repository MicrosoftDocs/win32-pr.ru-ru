...
ms.locfileid: "118191155"
---
# <a name="example-code-for-checking-for-membership-in-a-group"></a>Пример кода для проверки членства в группе

В следующем примере кода выполняется проверка абсолютного членства объекта путем рекурсивной проверки того, что объект является членом группы, или любой группы, вложенной в эту группу.
