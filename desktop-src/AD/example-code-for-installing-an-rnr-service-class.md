---
title: Пример кода для установки класса службы РНР
description: Следующая программа устанавливает класс службы РНР.
...
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="d34d6-105">Пример кода для установки класса службы РНР</span><span class="sxs-lookup"><span data-stu-id="d34d6-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="d34d6-106">Следующая программа устанавливает класс службы РНР.</span><span class="sxs-lookup"><span data-stu-id="d34d6-106">The following program installs an RnR Service class.</span></span>
