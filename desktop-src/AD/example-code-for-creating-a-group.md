---
title: Пример кода для создания группы
description: В этом разделе содержится пример кода, который создает группу.
...
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="e9676-104">Пример кода для создания группы</span><span class="sxs-lookup"><span data-stu-id="e9676-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="e9676-105">Следующий пример кода C++ содержит функцию, которая создает группу только явно заданных свойств (**CN**, **sAMAccountType**, **groupType**) и не содержит членов.</span><span class="sxs-lookup"><span data-stu-id="e9676-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="e9676-106">В следующем примере кода Visual Basic создается группа, в которой явно заданы только нужные свойства (**CN**, **sAMAccountType**, **groupType**) и не содержатся члены.</span><span class="sxs-lookup"><span data-stu-id="e9676-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
