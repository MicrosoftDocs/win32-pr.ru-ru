...
ms.locfileid: "118189717"
---
# <a name="example-code-for-using-the-global-catalog-to-find-users-in-a-forest"></a>Пример кода для использования глобального каталога для поиска пользователей в лесу

Этот раздел содержит примеры кода, используемые для поиска пользователей в лесу.

в следующем Visual Basic примере кода показано, как использовать ADSI для поиска пользователей в лесу.
...
В следующем примере кода C++ для поиска пользователей в лесу используются интерфейсы ADSI.
