---
title: Пример кода для использования глобального каталога для поиска пользователей в лесу
description: Этот раздел содержит примеры кода, используемые для поиска пользователей в лесу.
ms.assetid: bdcbfb7e-e1ea-4275-96b0-1c895e28e176
ms.tgt_platform: multiple
keywords:
- Active Directory примеры Active Directory, использование глобального каталога для поиска пользователей в лесу
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103773166"
---
# <a name="example-code-for-using-the-global-catalog-to-find-users-in-a-forest"></a><span data-ttu-id="fe59c-104">Пример кода для использования глобального каталога для поиска пользователей в лесу</span><span class="sxs-lookup"><span data-stu-id="fe59c-104">Example Code for Using the Global Catalog to Find Users in a Forest</span></span>

<span data-ttu-id="fe59c-105">Этот раздел содержит примеры кода, используемые для поиска пользователей в лесу.</span><span class="sxs-lookup"><span data-stu-id="fe59c-105">This topic includes code examples used to search for users in a forest.</span></span>

<span data-ttu-id="fe59c-106">В следующем Visual Basic примере кода показано, как использовать ADSI для поиска пользователей в лесу.</span><span class="sxs-lookup"><span data-stu-id="fe59c-106">The following Visual Basic code example shows how to use ADSI to search for users in a forest.</span></span>
...
<span data-ttu-id="fe59c-107">В следующем примере кода C++ для поиска пользователей в лесу используются интерфейсы ADSI.</span><span class="sxs-lookup"><span data-stu-id="fe59c-107">The following C++ code example uses ADSI to search for users in a forest.</span></span>
