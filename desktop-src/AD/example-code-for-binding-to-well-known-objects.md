...
ms.locfileid: "118191287"
---
# <a name="example-code-for-binding-to-well-known-objects"></a>Пример кода для привязки к хорошо известным объектам

В следующем примере кода C++ показано, как выполнить привязку к хорошо известному объекту с помощью строки привязки ВКГУИД.
