...
ms.locfileid: "118189795"
---
# <a name="example-code-for-updating-the-schema-cache"></a>Пример кода для обновления кэша схемы

Следующие функции C/C++ получают DNS-имя хозяина схемы (Жетсчемамастерднснаме) и обновляют кэш схемы на хозяине схемы (Упдатесчемамастеркаче). Чтобы использовать эти функции, вызовите Жетсчемамастерднснаме для получения DNS-имени хозяина схемы, передайте DNS-имя хозяина схемы в Упдатесчемамастеркаче, вызовите CoTaskMemFree в строке, содержащей DNS-имя хозяина схемы.

Дополнительные сведения см. [в разделе Обновление кэша схемы](updating-the-schema-cache.md).
