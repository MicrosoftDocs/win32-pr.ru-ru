...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a>Пример кода для реализации COM-объекта контекстного меню

Следующий пример кода можно использовать для реализации расширения контекстного меню Active Directory. В одном элементе контекстного меню отображается окно сообщения, содержащее путь к каждому выбранному элементу.

## <a name="ishellextinit-implementation"></a>Реализация Ишеллекстинит

Следующий пример кода можно использовать для реализации методов [**ишеллекстинит**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="icontextmenu-implementation"></a>Реализация IContextMenu

Следующий пример кода можно использовать для реализации методов [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) .
