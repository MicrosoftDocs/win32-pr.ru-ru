---
title: Пример кода для проверки права доступа к элементу управления в записи ACE
description: Следующий пример кода C++ проверяет указанный элемент управления на наличие прав доступа в ACE в списке управления доступом для указанного объекта.
ms.assetid: 03a96c99-eefb-4de5-a4ab-526eca7875cc
ms.tgt_platform: multiple
keywords:
- Пример кода для проверки права доступа к элементу управления в ACE AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104067385"
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a><span data-ttu-id="347e6-104">Пример кода для проверки права доступа к элементу управления в записи ACE</span><span class="sxs-lookup"><span data-stu-id="347e6-104">Example Code for Checking for a Control Access Right in an ACE</span></span>

<span data-ttu-id="347e6-105">Следующий пример кода C++ проверяет указанный элемент управления на наличие прав доступа в ACE в списке управления доступом для указанного объекта.</span><span class="sxs-lookup"><span data-stu-id="347e6-105">The following C++ code example verifies a specified control access right in an ACE in the ACL of the specified object.</span></span>
