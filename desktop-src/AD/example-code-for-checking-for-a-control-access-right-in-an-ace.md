...
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a>Пример кода для проверки права доступа к элементу управления в записи ACE

Следующий пример кода C++ проверяет указанный элемент управления на наличие прав доступа в ACE в списке управления доступом для указанного объекта.
