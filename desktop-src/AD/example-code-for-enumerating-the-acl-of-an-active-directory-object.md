...
ms.locfileid: "104067376"
---
# <a name="example-code-for-enumerating-the-acl-of-an-object-in-active-directory-domain-services"></a><span data-ttu-id="66f02-104">Пример кода для перечисления списка управления доступом объекта в службах домен Active Directory Services</span><span class="sxs-lookup"><span data-stu-id="66f02-104">Example Code for Enumerating the ACL of an Object in Active Directory Domain Services</span></span>

<span data-ttu-id="66f02-105">Следующие примеры кода можно использовать для перечисления списка управления доступом (ACL) объекта в службах домен Active Directory Services.</span><span class="sxs-lookup"><span data-stu-id="66f02-105">The following code examples can be used to enumerate the access control list (ACL) of an object in Active Directory Domain Services.</span></span>

<span data-ttu-id="66f02-106">В следующем примере кода показана функция, которая перечисляет доверенные лица объекта.</span><span class="sxs-lookup"><span data-stu-id="66f02-106">The following code example shows a function that enumerates the trustees of an object .</span></span>
...
<span data-ttu-id="66f02-107">В следующем примере кода показана функция, которая перечисляет доверенные лица объекта.</span><span class="sxs-lookup"><span data-stu-id="66f02-107">The following code example shows a function that enumerates the trustees of an object.</span></span>
