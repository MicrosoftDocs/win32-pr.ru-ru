...
ms.locfileid: "103773172"
---
# <a name="example-code-for-setting-read-property-rights-on-an-object"></a><span data-ttu-id="a9630-104">Пример кода для установки прав на чтение свойств объекта</span><span class="sxs-lookup"><span data-stu-id="a9630-104">Example Code for Setting Read Property Rights on an Object</span></span>

<span data-ttu-id="a9630-105">В следующем примере кода содержится функция, которая создает запись ACE, которая назначает доступ на чтение ко всем свойствам объекта указанному доверенному лицу.</span><span class="sxs-lookup"><span data-stu-id="a9630-105">The following code example contains a function that creates an ACE that assigns read access to all properties of the object to the specified trustee.</span></span>
