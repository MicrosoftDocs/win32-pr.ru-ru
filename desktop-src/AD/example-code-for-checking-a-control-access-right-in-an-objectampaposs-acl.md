...
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a>Пример кода для проверки прав доступа к элементу управления в ACL объекта

Следующий пример можно использовать, чтобы убедиться, что пользователь, выполнивший вход в систему, имеет разрешения на доступ к элементу управления для указанного объекта.
