---
title: Пример кода для проверки прав доступа к элементу управления в ACL объекта
description: Следующий пример можно использовать, чтобы убедиться, что пользователь, выполнивший вход в систему, имеет разрешения на доступ к элементу управления для указанного объекта.
ms.assetid: 360320b8-32bd-4141-924b-25833a2761c8
ms.tgt_platform: multiple
keywords:
- Пример кода для проверки прав доступа к элементу управления в ACL объекта
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103887688"
---
# <a name="example-code-for-checking-a-control-access-right-in-an-objects-acl"></a><span data-ttu-id="31779-104">Пример кода для проверки прав доступа к элементу управления в ACL объекта</span><span class="sxs-lookup"><span data-stu-id="31779-104">Example Code for Checking a Control Access Right in an Object's ACL</span></span>

<span data-ttu-id="31779-105">Следующий пример можно использовать, чтобы убедиться, что пользователь, выполнивший вход в систему, имеет разрешения на доступ к элементу управления для указанного объекта.</span><span class="sxs-lookup"><span data-stu-id="31779-105">The following example can be used to verify that the currently logged-on user has permissions for a control access right on the specified object.</span></span>
