...
---
# <a name="example-code-for-adding-a-domain-user-or-group-to-a-local-group"></a><span data-ttu-id="a7844-104">Пример кода для добавления пользователя или группы домена в локальную группу</span><span class="sxs-lookup"><span data-stu-id="a7844-104">Example Code for Adding a Domain User or Group to a Local Group</span></span>

<span data-ttu-id="a7844-105">Следующий пример кода C++ добавляет пользователя или группу домена в локальную группу на рядовом сервере или на компьютере под управлением Windows NT Workstation или Windows 2000 Professional.</span><span class="sxs-lookup"><span data-stu-id="a7844-105">The following C++ code example adds a domain user or group to a local group on a member server or a computer running on Windows NT Workstation or Windows 2000 Professional.</span></span>
...
<span data-ttu-id="a7844-106">В следующем Visual Basic примере кода добавляется пользователь или группа домена в локальную группу на рядовом сервере или на компьютере под управлением Windows NT Workstation или Windows 2000 Professional.</span><span class="sxs-lookup"><span data-stu-id="a7844-106">The following Visual Basic code example adds a domain user or group to a local group on a member server or a computer running on Windows NT Workstation or Windows 2000 Professional.</span></span>
