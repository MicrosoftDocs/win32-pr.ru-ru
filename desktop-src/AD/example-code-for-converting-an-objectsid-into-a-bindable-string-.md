...
ms.locfileid: "118191094"
---
# <a name="example-code-for-converting-an-objectsid-into-a-bindable-string"></a>Пример кода для преобразования objectSid в строку с возможностью привязки

В этом разделе содержится пример кода, который преобразует **objectSid** в строку с возможностью привязки для добавления члена, принадлежащего к домену нижнего уровня, в группу в домене верхнего уровня.

В следующем примере кода C++ показано, как преобразовать **objectSid** в строку с возможностью привязки.
