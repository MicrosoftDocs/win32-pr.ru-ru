...
Атрибут [**codepage**](/windows/desktop/ADSchema/a-codepage) указывает кодовую страницу для выбранного пользователем языка. это значение не используется Windows 2000.
