...
Точки подключения службы можно управлять с помощью скрипта VB. В следующем примере кода показано, как вывести список всех точек подключения службы в доменном имени, указанном в командной строке:
