---
title: Пример кода для создания пользователя
description: Этот раздел содержит примеры кода, которые создают пользователя в домене, управляемом службами домен Active Directory Services.
...
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="5e12d-104">Пример кода для создания пользователя</span><span class="sxs-lookup"><span data-stu-id="5e12d-104">Example Code for Creating a User</span></span>

<span data-ttu-id="5e12d-105">Этот раздел содержит примеры кода, которые создают пользователя в домене, управляемом службами домен Active Directory Services.</span><span class="sxs-lookup"><span data-stu-id="5e12d-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
