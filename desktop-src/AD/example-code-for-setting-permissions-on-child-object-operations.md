...
ms.locfileid: "118190092"
---
# <a name="example-code-for-setting-permissions-on-child-object-operations"></a>Пример кода для настройки разрешений для операций с дочерними объектами

В следующем примере кода C и C++ создается запись ACE, которая назначает права на создание для объектов пользователя указанному доверенному лицу.
