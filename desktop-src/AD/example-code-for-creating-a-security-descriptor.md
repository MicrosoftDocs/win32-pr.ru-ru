---
title: Пример кода для создания дескриптора безопасности
description: В этом разделе содержится пример кода Visual Basic, в котором показано, как создать объект дескриптора безопасности для объекта ADSI.
...
ms.locfileid: "104486608"
---
# <a name="example-code-for-creating-a-security-descriptor"></a><span data-ttu-id="ff6d7-104">Пример кода для создания дескриптора безопасности</span><span class="sxs-lookup"><span data-stu-id="ff6d7-104">Example Code for Creating a Security Descriptor</span></span>

<span data-ttu-id="ff6d7-105">В этом разделе содержится пример кода Visual Basic, в котором показано, как создать объект дескриптора безопасности для объекта ADSI.</span><span class="sxs-lookup"><span data-stu-id="ff6d7-105">This topic includes a Visual Basic code example that shows you how to create a security descriptor object for an ADSI object.</span></span>
