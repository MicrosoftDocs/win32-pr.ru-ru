...
ms.locfileid: "118190807"
---
# <a name="example-code-for-creating-a-security-descriptor"></a>Пример кода для создания дескриптора безопасности

в этом разделе содержится пример кода Visual Basic, в котором показано, как создать объект дескриптора безопасности для объекта ADSI.
