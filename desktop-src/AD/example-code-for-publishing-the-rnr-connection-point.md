...
- Регистрация и разрешение Windows Sockets AD, пример кода, публикация точки подключения РНР
...
ms.locfileid: "104252780"
---
# <a name="example-code-for-publishing-the-rnr-connection-point"></a><span data-ttu-id="352bc-106">Пример кода для публикации точки подключения РНР</span><span class="sxs-lookup"><span data-stu-id="352bc-106">Example Code for Publishing the RnR Connection Point</span></span>

<span data-ttu-id="352bc-107">Следующий пример кода используется службой Winsock для регистрации точки подключения РНР для службы.</span><span class="sxs-lookup"><span data-stu-id="352bc-107">The following code example is used by the Winsock service to register the RnR connection point for the service.</span></span>
