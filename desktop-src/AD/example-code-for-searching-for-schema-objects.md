---
title: Пример кода для поиска объектов схемы
description: Этот раздел содержит пример кода, используемый для поиска объектов схемы.
ms.assetid: 539e0127-1355-4606-97bd-49dfafb25f8d
ms.tgt_platform: multiple
keywords:
- Пример кода для поиска объектов схемы Active Directory
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103986147"
---
# <a name="example-code-for-searching-for-schema-objects"></a><span data-ttu-id="c3cb9-104">Пример кода для поиска объектов схемы</span><span class="sxs-lookup"><span data-stu-id="c3cb9-104">Example Code for Searching for Schema Objects</span></span>

<span data-ttu-id="c3cb9-105">Этот раздел содержит пример кода, используемый для поиска объектов схемы.</span><span class="sxs-lookup"><span data-stu-id="c3cb9-105">This topic includes a code example used to search for schema objects.</span></span>

<span data-ttu-id="c3cb9-106">В следующем примере кода C++ показано, как искать объекты схемы, для которых в атрибуте **systemFlags** заданы биты.</span><span class="sxs-lookup"><span data-stu-id="c3cb9-106">The following C++ code example shows how to search for schema objects that have bits set in the **systemFlags** attribute.</span></span>
...
<span data-ttu-id="c3cb9-107">В следующем примере кода C и C++ показано, как искать объекты схемы, реплицированные в глобальный каталог.</span><span class="sxs-lookup"><span data-stu-id="c3cb9-107">The following C and C++ code example shows how to search for schema objects replicated to the global catalog.</span></span>
...
<span data-ttu-id="c3cb9-108">В следующем примере кода C и C++ показано, как искать индексированные объекты схемы.</span><span class="sxs-lookup"><span data-stu-id="c3cb9-108">The following C and C++ code example shows how to search for indexed schema objects.</span></span>
