...
---
# <a name="example-code-for-searching-for-schema-objects"></a>Пример кода для поиска объектов схемы

Этот раздел содержит пример кода, используемый для поиска объектов схемы.

В следующем примере кода C++ показано, как искать объекты схемы, для которых в атрибуте **systemFlags** заданы биты.
...
В следующем примере кода C и C++ показано, как искать объекты схемы, реплицированные в глобальный каталог.
...
В следующем примере кода C и C++ показано, как искать индексированные объекты схемы.
