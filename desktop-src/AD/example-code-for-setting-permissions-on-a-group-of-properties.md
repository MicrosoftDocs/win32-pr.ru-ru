...
ms.locfileid: "118190102"
---
# <a name="example-code-for-setting-permissions-on-a-group-of-properties"></a>Пример кода для настройки разрешений для группы свойств

В следующих примерах кода на C и C++ создается элемент управления доступом, который назначает атрибутам набора свойств [**персональной информации**](/windows/desktop/ADSchema/r-personal-information) для указанного доверенного лица доступ на чтение и запись для атрибутов.
