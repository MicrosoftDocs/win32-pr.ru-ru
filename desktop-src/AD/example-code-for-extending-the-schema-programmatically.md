---
title: Пример кода для программного расширения схемы
description: В этом разделе содержится пример кода на C++, который программно расширяет схему Active Directory.
ms.assetid: e84678c5-ac12-424b-ba6c-c6cba23e4ff6
ms.tgt_platform: multiple
keywords:
- Пример кода для программного расширения схемы AD
...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="36bd3-105">Пример кода для программного расширения схемы</span><span class="sxs-lookup"><span data-stu-id="36bd3-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="36bd3-106">В этом разделе содержится пример кода на C++, который программно расширяет схему Active Directory.</span><span class="sxs-lookup"><span data-stu-id="36bd3-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
