---
title: Пример кода для настройки элемента управления права доступа ACE
description: Следующий пример кода C/C++ добавляет ACE для элемента управления право доступа к списку ACL объекта.
ms.assetid: 8fb5eb47-27ca-4e60-ad39-ca4392da4e7d
ms.tgt_platform: multiple
keywords:
- Пример кода для настройки элемента управления права доступа ACE
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104252778"
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="be951-104">Пример кода для настройки элемента управления права доступа ACE</span><span class="sxs-lookup"><span data-stu-id="be951-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="be951-105">Следующий пример кода C/C++ добавляет ACE для элемента управления право доступа к списку ACL объекта.</span><span class="sxs-lookup"><span data-stu-id="be951-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
