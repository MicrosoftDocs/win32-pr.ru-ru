---
title: Пример кода для создания раздела каталога приложений
description: Этот раздел содержит примеры кода для создания раздела каталога приложений.
ms.assetid: dc538afc-8529-42cf-a276-a4579d555557
ms.tgt_platform: multiple
keywords:
- Пример кода для создания раздела каталога приложений Active Directory
...
---
# <a name="example-code-for-creating-an-application-directory-partition"></a><span data-ttu-id="e2360-105">Пример кода для создания раздела каталога приложений</span><span class="sxs-lookup"><span data-stu-id="e2360-105">Example Code for Creating an Application Directory Partition</span></span>

<span data-ttu-id="e2360-106">В следующем примере кода C++ создается новый раздел каталога приложений с помощью ADSI.</span><span class="sxs-lookup"><span data-stu-id="e2360-106">The following C++ code example creates a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="e2360-107">В следующем примере кода Visual Basic сценариев выпуска показано, как создать новый раздел каталога приложений с помощью ADSI.</span><span class="sxs-lookup"><span data-stu-id="e2360-107">The following Visual Basic Scripting Edition code example shows how to create a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="e2360-108">В следующем Visual Basic примере кода .NET показано, как создать новый раздел каталога приложений с помощью [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="e2360-108">The following Visual Basic .NET code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
...
<span data-ttu-id="e2360-109">В следующем примере кода C# показано, как создать новый раздел каталога приложений с помощью [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="e2360-109">The following C# code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
