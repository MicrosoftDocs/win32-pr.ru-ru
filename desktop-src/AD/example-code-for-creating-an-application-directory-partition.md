...
В следующем примере кода C++ создается новый раздел каталога приложений с помощью ADSI.
...
В следующем примере кода C# показано, как создать новый раздел каталога приложений с помощью [System. DirectoryServices](/dotnet/api/system.directoryservices).
