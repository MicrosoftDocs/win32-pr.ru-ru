...
ms.locfileid: "118962243"
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a>Пример кода для чтения Дефаултсекуритидескриптор

В следующем примере кода считывается **дефаултсекуритидескриптор** для указанного класса объекта.
