...
| **\_текст о производительности hKey \_**    | Запрос строк на английском языке. Задайте для параметра *лпвалуенаме* значение "Counter" или "Help", чтобы получить имена или текст справки соответственно.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
