...
| 0xC0000BDE ( \_ Недопустимый PDH \_ sqldb)                             | База данных SQL не содержит допустимого набора таблиц для Perfmon.
| 0xC0000BDF (PDH \_ No \_ Counters)                               | для этого набора журналов SQL системного монитора не найдены счетчики.
...
| 0xC0000BE3 ( \_ \_ сбой при выборке SQL PDH \_ )                         | Сбой вызова SQLFetch с %1.
| 0xC0000BE4 ( \_ сбой PDH SQL \_ ROWCOUNT \_ )                      | Сбой вызова SQLRowCount с %1.
| 0xC0000BE5 ( \_ \_ \_ не удалось SQL дополнительные результаты PDH \_ )                 | Сбой вызова SQLMoreResults с %1.
| 0xC0000BE6 ( \_ \_ сбой подключения PDH SQL \_ )                       | Сбой вызова SQLConnect с %1.
...
| 0xC0000BF5 (PDH \_ недопустим \_ SQL \_ \_ формат журнала)                  | неверный формат журнала SQL. Правильный формат: `SQL:<DSN-name>!<LogSet-Name>` .
...
| 0xC0000BFD ( \_ сбой PDH SQL \_ ALTER \_ DETAIL \_ )                 | невозможно изменить макет таблицы каунтердетаил в базе данных SQL.
