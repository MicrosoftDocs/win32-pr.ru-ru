...
---
# <a name="enumerating-process-objects"></a>Перечисление объектов процессов

В следующем примере вызывается функция [**пдхенумобжектитемс**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) для перечисления экземпляров и счетчиков объектов процесса на локальном компьютере.
