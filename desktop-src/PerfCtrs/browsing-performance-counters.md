---
description: Пример кода, демонстрирующий Просмотр счетчиков производительности.
ms.assetid: 44c5cfa8-6449-45d8-ac30-979b99c086de
title: Просмотр счетчиков производительности
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105663253"
---
# <a name="browsing-performance-counters"></a><span data-ttu-id="ad419-103">Просмотр счетчиков производительности</span><span class="sxs-lookup"><span data-stu-id="ad419-103">Browsing Performance Counters</span></span>

<span data-ttu-id="ad419-104">В следующем примере показано, как вызвать [**пдхбровсекаунтерс**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) для просмотра счетчиков производительности.</span><span class="sxs-lookup"><span data-stu-id="ad419-104">The following example shows how to call [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) to browse performance counters.</span></span> <span data-ttu-id="ad419-105">В примере также показано, как получить и отформатировать необработанные данные счетчика для отображения.</span><span class="sxs-lookup"><span data-stu-id="ad419-105">The example also shows how to collect and format raw counter data for display.</span></span>
