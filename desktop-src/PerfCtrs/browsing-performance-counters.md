...
---
# <a name="browsing-performance-counters"></a>Просмотр счетчиков производительности

В следующем примере показано, как вызвать [**пдхбровсекаунтерс**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) для просмотра счетчиков производительности. В примере также показано, как получить и отформатировать необработанные данные счетчика для отображения.
