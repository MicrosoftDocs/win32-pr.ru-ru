...
> [!Note]
> При написании приложений OneCore Windows нельзя использовать функции абстрагирования вспомогательного метода для данных производительности. Вместо этого используйте [функции-потребители версии PerfLib v2](using-the-perflib-functions-to-consume-counter-data.md).
