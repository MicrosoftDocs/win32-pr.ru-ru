...
ms.locfileid: "117793583"
---
# <a name="reading-performance-data-from-a-log-file"></a>Чтение данных о производительности из файла журнала

В следующем примере считываются данные, записанные в файл журнала в примере [записи данных о производительности в файл журнала](writing-performance-data-to-a-log-file.md) . Она использует функцию [**пдхколлекткуеридата**](/windows/desktop/api/Pdh/nf-pdh-pdhcollectquerydata) для получения данных из файла журнала и функции [**пдхжетформаттедкаунтервалуе**](/windows/desktop/api/Pdh/nf-pdh-pdhgetformattedcountervalue) для форматирования данных для вывода.
