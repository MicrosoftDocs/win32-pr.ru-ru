...
keywords:
- Windows Система цветов (WCS), общие типы профилей
- WCS (Windows цветовая система), общие типы профилей
...
- цвета, профили
- Windows Система цветов (WCS), управление версиями
- WCS (Windows цветовая система), управление версиями
- Управление цветом изображений, контроль версий
- Управление цветом, контроль версий
- цвета, управление версиями
- Windows Система цветовой системы (WCS), локализация
- WCS (Windows цветовая система), локализация
...
стандартные профили WCS, поставляемые с Windows Vista, например sRGB. кдмп, имеют те же локализуемые свойства, что и другие профили.

стандартное решение Windows бы поместит локализованные строки в DLL MUI и ссылались на них следующим образом:
...
в Windowsной системе текст описания будет извлечен из ресурса с идентификатором 101 в соответствующей локализованной версии ресурсов MUI для mscms.dll. в системах, отличных от Windows, будут использоваться вложенные элементы wcs: Text, как описано выше.
