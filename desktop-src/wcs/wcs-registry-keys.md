...
keywords:
- Windows Система цветов (WCS), разделы реестра
- WCS (Windows цветовая система), разделы реестра
...
- Windows Система цветов (WCS), реестр
- WCS (Windows цветовая система), реестр
