...
Отправляется в приложение для уведомления об изменениях в окне IME. Окно получает это сообщение через функцию [**WindowProc**](/previous-versions/windows/desktop/legacy/ms633573(v=vs.85)) .
