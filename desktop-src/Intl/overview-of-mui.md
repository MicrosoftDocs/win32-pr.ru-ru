---
description: в этом разделе приводятся общие сведения о технологии многоязычный пользовательский интерфейс (MUI), поддержке платформ, предоставляемой для многоязыкового взаимодействия с пользователем, и преимуществах, предоставляемых ит-Windows экосистеме.
...
ms.locfileid: "122625780"
---
# <a name="overview-of-mui"></a>Обзор MUI

в этом разделе приводятся общие сведения о технологии многоязычный пользовательский интерфейс (MUI), поддержке платформ, предоставляемой для многоязыкового взаимодействия с пользователем, и преимуществах, предоставляемых ит-Windows экосистеме.
...
Во всем мире есть 193 стран и более 6 900 известных языков, используемых сегодня. На английском языке, несмотря на его роль в качестве бизнес-языка мира, говорят только 8,5% населения мира в качестве первого или второго языка. Чтобы предоставить собственную информацию 94% населения мира, эта информация должна быть доступна в 347 (около 5%) языков мира, имеющих по крайней мере миллион динамиков. Это особенно важно, так как тренды глобализации увеличивают ожидания этих пользователей в отношении технологий и их доступности на своих рынках.

необходимость локализовать программное обеспечение на других языках увеличилась в течение многих лет, и корпорация майкрософт предоставляет Windows Vista и другие продукты на других языках, чем когда-либо. эта эволюция особенно понятна в Microsoft Windows, так как она закончила поддержку 30 языков с Windows 98 почти 100 с Windows Vista, как показано на следующей линейчатой диаграмме.
...
поддержка дополнительных языков для Windows операционных систем, а также программных приложений, созданных для платформы Windows, требует новых стратегий, позволяющих реализовать все основные сценарии с минимальными затратами на проектирование.

технология MUI предназначена для разработчиков и независимых поставщиков программного обеспечения, надежде создавать и поддерживать многоязычные приложения для платформы Windows. многоязыковой интерфейс пользователя также имеет ключевое значение для изготовителей оборудования и предприятий, которые могут использовать его для развертывания операционной системы Windows и добавления приложений на компьютеры разных языков с помощью развертывания одного образа.
...
уровень поддержки, доступный для многоязыкового взаимодействия с пользователем на уровне операционной системы Windows и для разработки многоязыковых приложений на Windowsной платформе, изменился со временем и в разных версиях Windows.

поддерживаемая функциональность [до Windows Vista](evolution-of-mui-support-across-windows-versions.md) была довольно простой, с одноязыковыми Windowsными изображениями и возможностью добавления многоязычный пользовательский интерфейс пакетов в конкретных сценариях. Не была доступна поддержка разработчиков многоязычных приложений.

[с Windows Vista](evolution-of-mui-support-across-windows-versions.md)корпорация майкрософт внесла значительные инвестиции в mui, и Windows Vista создавалась с нуля на платформе MUI. хотя это и является основной стратегией в стратегии локализации Windows, так как она является ключевым средством для обеспечения Windows на более языках, чем раньше, оно является первым и главным для Windows пользователей, разработчиков и клиентов. Он предоставляет следующие основные преимущества:
...
<li>Windows Семейство серверов 2003</li>
...
MUI позитивно влияет на несколько аспектов Windows экосистемы:

-   [преимущества для разработчиков](benefits-of-mui-explained.md). многочисленные преимущества предоставляются разработчикам приложений с помощью поддержки API MUI для создания многоязычных приложений, смоделированных на основе тех же принципов, что и многоязычная поддержка в основном Windows операционной системе. К этим преимуществам относятся следующие:
