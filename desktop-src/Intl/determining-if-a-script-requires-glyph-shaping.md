...
ms.locfileid: "104272072"
---
# <a name="determining-if-a-script-requires-glyph-shaping"></a><span data-ttu-id="45c78-103">Определение, требует ли сценарий формирования глифов</span><span class="sxs-lookup"><span data-stu-id="45c78-103">Determining If a Script Requires Glyph Shaping</span></span>

<span data-ttu-id="45c78-104">В следующем примере вызывается [**скриптжетпропертиес**](/windows/desktop/api/Usp10/nf-usp10-scriptgetproperties) , чтобы определить, требуется ли для сценария каждого из последующих последовательных [элементов](uniscribe-glossary.md) формирование глифов.</span><span class="sxs-lookup"><span data-stu-id="45c78-104">The following example calls [**ScriptGetProperties**](/windows/desktop/api/Usp10/nf-usp10-scriptgetproperties) to find out if the script of each of several successive [items](uniscribe-glossary.md) requires glyph shaping.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="45c78-105">См. также</span><span class="sxs-lookup"><span data-stu-id="45c78-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="45c78-106">Использование Uniscribe</span><span class="sxs-lookup"><span data-stu-id="45c78-106">Using Uniscribe</span></span>](using-uniscribe.md)
</dt> </dl>
