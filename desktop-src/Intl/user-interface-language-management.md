...
в операционных системах, предшествующих Windows Vista, язык пользовательского интерфейса обычно совпадает с языком системного интерфейса по умолчанию. однако для Windows MUI два языка могут отличаться.
...
Windows В Vista и более поздних версиях параметры языка пользовательского интерфейса упорядочиваются в предварительно упорядоченном списке языков, используемом загрузчиком ресурсов. Чтобы сформировать список, операционная система объединяет несколько языков в порядке, указанном ниже.
