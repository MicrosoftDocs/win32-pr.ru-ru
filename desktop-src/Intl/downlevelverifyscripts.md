...
| Распространяемые компоненты<br/>          | api-интерфейсы для межязыкового доменного имени (IDN) майкрософт — Windows XP с пакетом обновления 2 (SP2), Windows Server 2003 с пакетом обновления 1, орвиндовс Vista<br/> |
