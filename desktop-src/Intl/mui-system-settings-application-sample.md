---
description: 'MUI: пример приложения для систем Параметры'
ms.assetid: 34cfd3a8-20b2-4a57-bc43-8da410cf9ae9
title: 'MUI: пример приложения для систем Параметры'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118390834"
---
# <a name="mui-system-settings-application-sample"></a>MUI: пример приложения для систем Параметры

Пример приложения, описанный в этом разделе, представляет собой простое приложение Hello MUI, которое поддерживает системные параметры для своих языков интерфейса пользователя.
