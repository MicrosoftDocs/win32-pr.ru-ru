...
Метод **ресетсркаус** класса [**\_ TPM Win32**](win32-tpm.md) сбрасывает значение авторизации корневого ключа хранилища (SRK), чтобы оно было совместимо с операционной системой.
