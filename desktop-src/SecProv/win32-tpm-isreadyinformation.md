...
ms.locfileid: "118890842"
---
# <a name="win32_tpmisreadyinformation-method"></a>\_Метод Win32 TPM:: исреадинформатион

Указывает, готов ли модуль TPM, и предоставляет дополнительные сведения о состоянии TPM. Параметр Information возвращает битовую маску сведений о том, что необходимо для полной инициализации TPM.
...
Возвращает битовую маску как часть информации, которая доступна для полной инициализации TPM.
...
| <span id="INFORMATION_TPM_SRK_AUTH"></span><span id="information_tpm_srk_auth"></span><dl> <dt>**Сведения о \_ 0x00000200 \_ \_ проверки подлинности TPM SRK**</dt> <dt></dt> </dl>                                  | значение авторизации корневого ключа служба хранилища (SRK) не равно нулю.<br/>                                                                                                                                                            |
...
| <span id="INFORMATION_DEVICEID"></span><span id="information_deviceid"></span><dl> <dt>**Сведения о \_ DEVICEID**</dt> <dt> 0x00800000</dt> </dl>                                                | Идентификатор устройства не создан.<br/>                                                                                                                                                                                 |
| <span id="INFORMATION_ATTESTATION_VULNERABILITY"></span><span id="information_attestation_vulnerability"></span><dl> <dt>**Сведения о \_ \_УЯЗВИМОСТЬ аттестации**</dt> <dt> 0x01000000</dt> </dl>                                                | В TPM есть уязвимость, связанная с аттестацией работоспособности.<br/>                                                                                                                                                                                 |
