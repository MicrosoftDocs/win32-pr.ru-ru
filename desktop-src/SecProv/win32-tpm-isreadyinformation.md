...
| <span id="INFORMATION_TPM_SRK_AUTH"></span><span id="information_tpm_srk_auth"></span><dl> <dt>**Сведения о \_ 0x00000200 \_ \_ проверки подлинности TPM SRK**</dt> <dt></dt> </dl>                                  | Значение авторизации корневого ключа хранилища (SRK) не является нулевым.<br/>                                                                                                                                                            |
