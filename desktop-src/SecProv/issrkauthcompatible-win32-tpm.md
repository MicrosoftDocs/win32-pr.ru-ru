---
description: метод иссркаускомпатибле \_ класса Tpm Win32 указывает, совместима ли авторизация служба хранилища корневого ключа (SRK) со значением, ожидаемым Windows Vista.
...
метод **иссркаускомпатибле** класса [**\_ Tpm Win32**](win32-tpm.md) указывает, совместима ли авторизация служба хранилища корневого ключа (SRK) со значением, ожидаемым Windows Vista.
...
*Иссркаускомпатибле* \[ заполняет\]
</dt> <dd>

Тип: **Boolean**

При значении **true** значение авторизации SRK имеет нулевое значение.
