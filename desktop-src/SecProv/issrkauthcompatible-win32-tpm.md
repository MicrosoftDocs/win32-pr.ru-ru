...
Метод **иссркаускомпатибле** класса [**\_ TPM Win32**](win32-tpm.md) указывает, совместима ли авторизация корневого ключа хранилища (SRK) со значением, ожидаемым Windows Vista.
