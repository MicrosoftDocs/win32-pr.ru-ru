...
ms.locfileid: "118530724"
---
# <a name="the-direct3d-12-core-10-feature-level"></a>Уровень компонентов Direct3D 12 Core 1.0

Основной уровень компонентов 1,0 является подмножеством полного набора функций Direct3D 12. Уровень компонентов Core 1,0 может предоставляться категорией устройств, которые называются *устройствами только для вычислений*. Общая модель драйвера для устройств, предназначенных только для вычислений, — это модель вычислений Microsoft COMPUTE Driver (МКДМ). мкдм — это масштабируемый одноранговый узел модели драйвера устройства (WDDM) Windows, имеющей более широкую область.
