...
---
# <a name="dml_element_wise_bit_or_operator_desc-structure-directmlh"></a>Структура DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESC (директмл. h)

Вычисляются побитовое или между соответствующим элементом входных десятков и записывает результат в выходной тензорные.
