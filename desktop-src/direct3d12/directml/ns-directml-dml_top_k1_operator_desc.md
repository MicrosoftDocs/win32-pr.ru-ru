...
* *Инпуттенсор*, *аутпутиндекстенсор* и *аутпутвалуетенсор* должны иметь одинаковые *DimensionCount*.
...
| аутпутвалуетенсор | Выходные данные | от 1 до 8 | FLOAT32, FLOAT16, INT32, INT16, INT8, UINT32, UINT16, UINT8 |
| аутпутиндекстенсор | Выходные данные | от 1 до 8 | ЗНАЧЕНИЕМ |
...
| аутпутвалуетенсор | Выходные данные | 4 | FLOAT32, FLOAT16, INT32, INT16, INT8, UINT32, UINT16, UINT8 |
| аутпутиндекстенсор | Выходные данные | 4 | ЗНАЧЕНИЕМ |
