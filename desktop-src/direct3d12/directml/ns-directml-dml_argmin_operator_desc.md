...
Выводит индексы элементов с минимальными значениями в одном или нескольких измерениях входного тензорные.
...
Объект тензорные, в который записываются результаты. Каждый элемент Output является результатом *аргмин* сокращения для подмножества элементов из *инпуттенсор*.
...
DML_AXIS_DIRECTION Аксисдиректион;
...
### <a name="example-1-applying-argmin-to-columns"></a>Пример 1. Применение *аргмин* к столбцам
...
### <a name="example-2-applying-argmin-to-rows"></a>Пример 2. Применение *аргмин* к строкам
...
### <a name="example-3-applying-argmin-to-all-axes-the-entire-tensor"></a>Пример 3. Применение *аргмин* ко всем осям (весь тензорные)
