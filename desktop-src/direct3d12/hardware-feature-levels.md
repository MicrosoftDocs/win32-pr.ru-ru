...
| [Мозаичные ресурсы](/windows/desktop/api/d3d12/ne-d3d12-d3d12_tiled_resources_tier)                                                                        | Партнеров ³                    | Партнеров ³                    | Необязательно                 | Необязательно                 |
| [Консервативная растрирование](conservative-rasterization.md)                                                             | 1 класса ³                    | Необязательно                  | Необязательно                 | Нет                       |
| [Упорядоченные представления средства прорисовки](rasterizer-order-views.md)                                                                   | да                       | Необязательно                  | Необязательно                 | Нет                       |
| [Фильтры min/max](/windows/desktop/api/d3d12/ne-d3d12-d3d12_filter)                                                                                      | Да                       | да                       | Необязательно                 | Нет                       |
| Отобразить буфер по умолчанию                                                                                                       | Необязательно                  | Необязательно                  | Необязательно                 | Необязательно                 |
| [Заданное значение ссылки на набор элементов в шейдере](shader-specified-stencil-reference-value.md)                                 | Необязательно                  | Необязательно                  | Необязательно                 | Нет                       |
...
[Запросы возможностей](capability-querying.md)
</dt> <dt>
