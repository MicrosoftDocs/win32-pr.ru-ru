...
---
# <a name="id3dx12pipelineparsercallbacksprimitivetopologytypecb-method"></a>ID3DX12PipelineParserCallbacks: метод:P Римитиветопологитипекб

Вызывает обратный вызов подобъекта типа топологии примитива объекта, реализующего этот интерфейс.
...
Тип: **[ **D3D12- \_ примитивный \_ \_ тип топологии**](/windows/desktop/api/d3d12/ne-d3d12-d3d12_primitive_topology_type)**

Сведения о подобъекте типа примитивной топологии, проанализированном из потока состояния конвейера.
...
[**Тип D3D12- \_ примитивной \_ топологии \_**](/windows/desktop/api/d3d12/ne-d3d12-d3d12_primitive_topology_type)
</dt> </dl>
