...
ms.locfileid: "119751734"
---
# <a name="d3d12_rect"></a>D3D12 \_ Rect

D3D12 \_ Rect объявляется как Rect. Дополнительные сведения о структуре этого прямоугольника GDI см. в разделе [**Rect**](/previous-versions//dd162897(v=vs.85)).
...
Эта структура является членом структуры [**области D3D12 \_ Discard \_**](/windows/desktop/api/d3d12/ns-d3d12-d3d12_discard_region) .
...
| Требование | Значение |
|-------------------|------------------------------------------------------------------------------------|
| Заголовок<br/> | <dl> <dt>D3D12. h</dt> </dl> |
...
[Основные структуры](direct3d-12-structures.md)
</dt> <dt>
