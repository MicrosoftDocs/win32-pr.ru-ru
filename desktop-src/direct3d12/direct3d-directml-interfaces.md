...
| [**IDMLDevice1**](/windows/desktop/direct3d12/directml/nn-directml-idmldevice1) | Представляет устройство Директмл, которое используется для создания операторов, привязки таблиц, средств записи команд и других объектов. |
