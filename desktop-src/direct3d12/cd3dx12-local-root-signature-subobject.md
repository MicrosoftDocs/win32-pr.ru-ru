---
title: Класс CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT (D3dx12. h)
description: Вспомогательный класс для создания локального корневого состояния подписи субожект.
keywords:
- Класс CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT
topic_type:
- apiref
api_name:
...
ms.locfileid: "121813067"
---
# <a name="cd3dx12_local_root_signature_subobject-class"></a>Класс CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT

Вспомогательный класс для создания локального корневого состояния подписи субожект.
...
Конструктор по умолчанию. Создает новый экземпляр **CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT**, инициализированный по умолчанию.

`CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT(CD3DX12_STATE_OBJECT_DESC&)`

Конструктор, создающий новый экземпляр **CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT** , инициализируемый с помощью содержимого объекта [**CD3DX12_STATE_OBJECT_DESC**](cd3dx12-state-object-desc.md) .
...
Возвращает тип подобъекта, представленного [D3D12_STATE_SUBOBJECT_TYPE_LOCAL_ROOT_SIGNATURE](/windows/win32/api/d3d12/ne-d3d12-d3d12_state_subobject_type) константой.
