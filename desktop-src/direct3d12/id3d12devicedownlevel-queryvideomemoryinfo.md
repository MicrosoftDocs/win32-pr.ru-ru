...
предоставляет статистику памяти для Windows 7. этот метод эквивалентен [IDXGIAdapter3:: куеривидеомеморинфо](/windows/win32/api/dxgi1_4/nf-dxgi1_4-idxgiadapter3-queryvideomemoryinfo), который недоступен в Windows 7.
...
| Требование | Значение |
|--------|------------------|
| Заголовок | d3d12downlevel. h и dxgi1_4. h |
