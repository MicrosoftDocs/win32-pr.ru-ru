...
---
# <a name="variable-rate-shading-vrs"></a>Заливка переменной скорости (ВРС)
...
![коарсепикселсизесуппорт](images/CoarsePixelSizeSupport.PNG "Размеры грубых пикселей")
...
![уровни](images/Tiers.PNG "Уровни ВРС")
...
![пользовательские средства объединения](images/Combiners.PNG "Комбинированные шейдеры")
...
## <a name="setsamplepositions"></a>сетсамплепоситионс
...
![нумберофковеражебитс](images/NumberOfCoverageBits.PNG "Биты покрытия")
...
![Coverage1x](images/Coverage1x.PNG "Покрытие на 1x")
...
## <a name="render-passes"></a>Проходы рендеринга
