...
- Избегайте ненужных копий и сбросов. Чтобы определить их, можно использовать автоматические предупреждения о производительности из [средства PIX on Windows](https://devblogs.microsoft.com/pix/).
