...
---
# <a name="fence-based-resource-management"></a>Управление ресурсами Fence-Based

Показывает, как управлять жизненным циклом данных ресурса путем отслеживания хода выполнения GPU через границы. Память можно эффективно повторно использовать с ограждениями, тщательно управляя доступностью свободного пространства в памяти, например в реализации кольцевого буфера для отправки кучи.
