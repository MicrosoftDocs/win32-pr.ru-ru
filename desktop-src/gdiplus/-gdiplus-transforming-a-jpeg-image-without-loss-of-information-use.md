...
Если ширина и высота изображения не кратны 16, то GDI+ будет лучше сохранять качество изображения при применении одного из поворотов или преобразований, показанных в приведенном выше списке.
