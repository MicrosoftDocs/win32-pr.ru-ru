...
|            |                                                                                                                                                                                                                                                                                                        |
|------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **id**     | Тег, определяющий элемент метаданных. Значения, которые могут быть назначены **идентификаторам** (Пропертитагимажетитле, Пропертитажекуипмаке, пропертитажексифекспосуретиме и Like), определяются в гдиплусимагинг. h.                                                                                           |
