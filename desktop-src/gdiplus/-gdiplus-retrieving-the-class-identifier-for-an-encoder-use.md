...
Функция Жетенкодерклсид в следующем примере получает тип MIME кодировщика и возвращает идентификатор класса (**CLSID**) этого кодировщика. Ниже приведены типы MIME кодировщиков, встроенных в Windows GDI+.
