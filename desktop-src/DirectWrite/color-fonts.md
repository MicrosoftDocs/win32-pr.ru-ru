...
-   [какие виды цветовых шрифтов Windows поддерживаются?](#what-kinds-of-color-fonts-does-windows-support)
-   [Использование цветовых шрифтов](#using-color-fonts)
    ...
    -   [Использование цветовых шрифтов в Microsoft Edge](#using-color-fonts-in-microsoft-edge)
...
## <a name="what-kinds-of-color-fonts-does-windows-support"></a>какие виды цветовых шрифтов Windows поддерживаются?

[Спецификация OpenType](https://www.microsoft.com/Typography/OpenTypeSpecification.aspx) определяет несколько способов внедрения информации о цвете в шрифт. начиная с Windows 10го обновления годовщины DirectWrite и Direct2D (а также построенные на них платформы Windows) поддерживают все эти подходы. Они представлены в следующей таблице:
...
С точки зрения разработчика, цветовые шрифты обычно используются так же, как монохромные шрифты. в XAML и Microsoft Edge frameworks текст можно использовать в качестве стиля цветовых шрифтов так же, как обычные шрифты, и по умолчанию текст будет отображаться в цвете. Однако если приложение напрямую вызывает API Direct2D (или Win2D API) для отрисовки текста, оно должно явно запрашивать визуализацию цветового шрифта.
...
### <a name="using-color-fonts-in-microsoft-edge"></a>Использование цветовых шрифтов в Microsoft Edge

цветовые шрифты отображаются по умолчанию на веб-сайтах и веб-приложениях, работающих на Microsoft Edge, включая элемент управления XAML [WebView](/uwp/api/windows.ui.xaml.controls.webview) . Просто используйте HTML и CSS для стиля текста с помощью цветового шрифта, а цветовые глифы будут подготавливаться к просмотру цветом.
