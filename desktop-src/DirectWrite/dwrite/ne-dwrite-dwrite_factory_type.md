...
| DWRITE_FACTORY_TYPE_ISOLATED2 | Указывает, что объект фабрики DirectWrite ограничен. Объекты, созданные из ограниченной фабрики, не используют и не изменяют внутреннее состояние или кэшированные данные, используемые другими фабриками. Кроме того, системная коллекция шрифтов содержит только хорошо известные шрифты.|
