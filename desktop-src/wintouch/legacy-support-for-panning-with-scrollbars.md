...
- Windows Сенсорный ввод, панорамирование с помощью полос прокрутки
...
- жесты, панорамирование с помощью полос прокрутки
- жесты, отключение
- Windows Сенсорные сообщения с колесиком мыши
- сообщения колесика мыши
- Windows Сенсорный ввод, Настройка панорамирования
...
запустите новый проект Win32 с помощью мастера Microsoft Visual Studio. убедитесь, что в качестве типа приложения выбрано приложение Windows. Вам не нужно включать поддержку библиотеки активных шаблонов (ATL). На следующем рисунке показано, как будет выглядеть проект после его запуска.
