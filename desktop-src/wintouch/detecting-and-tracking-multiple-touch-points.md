...
keywords:
- Windows Касание, несколько сенсорных точек
...
ниже приведены инструкции по отслеживанию нескольких сенсорных точек с помощью Windows touch.

1.  создание приложения и включение Windows Touch.
...
## <a name="create-an-application-and-enable-windows-touch"></a>создание приложения и включение Windows Touch

начните работу с приложением Microsoft Win32 с помощью мастера Microsoft Visual Studio. после завершения работы мастера добавьте поддержку Windows сенсорных сообщений, задав версию Windows в targetver. h, включая Windows. h и виндовскс. h в приложении. в следующем примере кода показано, как задать версию Windows в targetver. h.
