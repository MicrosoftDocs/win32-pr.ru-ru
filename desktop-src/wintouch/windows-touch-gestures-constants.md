...
**жестуреконфигмакскаунт**
</dt> <dd> <dl> <dt>

256
</dt> <dt>

Определяет максимальное число конфигураций жестов, которые можно включать в один вызов [**сетжестуреконфиг**](/windows/desktop/api/winuser/nf-winuser-setgestureconfig) или [**жетжестуреконфиг**](/windows/desktop/api/winuser/nf-winuser-getgestureconfig).
