...
Чтобы скомпилировать приложение, использующее эту функцию, определите **\_ Win32 \_ WinNT** как 0x0500 или более поздней версии. Дополнительные сведения см. [в разделе Использование заголовков Windows](../winprog/using-the-windows-headers.md).
...
| Header<br/>                   | <dl> <dt>Среадпуллегациаписет. h в Windows 8 и Windows Server 2012 (Включите Windows. h); </dt> <dt>Винбасе. h в Windows 7, Windows server 2008 R2, Windows Vista, Windows server 2008, Windows XP и Windows server 2003 (включая Windows. h)</dt> </dl> |
