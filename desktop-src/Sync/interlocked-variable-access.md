...
Простые операции чтения и записи для правильно согласованных 64-разрядных переменных являются атомарными для 64-разрядных систем Windows. Операции чтения и записи в 64-разрядные значения не обязательно должны быть атомарными в 32-разрядной версии Windows. Операции чтения и записи в переменные других размеров не обязательно должны быть атомарными на какой бы то ни было платформе.
