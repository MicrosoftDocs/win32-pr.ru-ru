---
description: Представляет сводную информацию о событии.
MS-HAID: vspixengine.SummaryItem
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Структура Суммаритем
ms.topic: reference
ms.date: 05/31/2018
...
Представляет сводную информацию о событии.
...
**Значение**  
Строка COM, содержащая значение, связанное с событием.
