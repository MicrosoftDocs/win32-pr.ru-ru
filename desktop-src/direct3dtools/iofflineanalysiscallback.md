...
Обратный вызов для возврата данных анализа вне сети.

## <a name="members"></a>Элементы

Интерфейс **иоффлинеаналисискаллбакк** наследует от интерфейса [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **Иоффлинеаналисискаллбакк** также имеет следующие типы членов:
