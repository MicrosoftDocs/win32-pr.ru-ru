---
title: Мешает удалению фильтра
description: В следующем примере кода показано, как сделать фильтр трудным для удаления, установив DACL.
...
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="d5966-103">Мешает удалению фильтра</span><span class="sxs-lookup"><span data-stu-id="d5966-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="d5966-104">В следующем примере кода показано, как сделать фильтр трудным для удаления, установив DACL.</span><span class="sxs-lookup"><span data-stu-id="d5966-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
