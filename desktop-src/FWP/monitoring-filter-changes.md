---
title: Мониторинг изменений фильтра
description: В следующем примере кода показано, как отслеживать добавление и удаление фильтров, которые могут повлиять на серверное приложение.
...
ms.locfileid: "104532279"
---
# <a name="monitoring-filter-changes"></a><span data-ttu-id="b33ad-103">Мониторинг изменений фильтра</span><span class="sxs-lookup"><span data-stu-id="b33ad-103">Monitoring Filter Changes</span></span>

<span data-ttu-id="b33ad-104">В следующем примере кода показано, как отслеживать добавление и удаление фильтров, которые могут повлиять на серверное приложение.</span><span class="sxs-lookup"><span data-stu-id="b33ad-104">The following sample code demonstrates how to monitor the addition and deletion of filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="b33ad-105">Условия фильтра совпадают с условиями, поддерживаемыми API нижнего уровня **испорталловед** .</span><span class="sxs-lookup"><span data-stu-id="b33ad-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
