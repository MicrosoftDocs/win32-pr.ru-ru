...
Идентификаторы для функций вызова, встроенных в платформу фильтрации Windows (WFP), представляются с помощью GUID. Эти идентификаторы определяются следующим образом.
...
> [!Note]  
> Для Windows 7 и более поздних версий используйте **фвпм \_ выноску " \_ обходной выносной стороны" \_ \_ \_ Listen \_ V6**.
...
> [!Note]  
> Для Windows 7 и более поздних версий следует использовать **\_ \_ \_ \_ \_ \_ назначение \_ ресурсов ALE фвпм** в выпуске границы выноски.
