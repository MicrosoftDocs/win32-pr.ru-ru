...
-   [**\_CALLBACK0 фвпм выноска \_ изменения \_**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_callout_change_callback0)
...
-   [**ФВПМ \_ подключение \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_connection_callback0)
...
-   \_ \_ обратный вызов события фвпм NET \_ :
    -   [**Фвпм \_ \_ \_ CALLBACK0 событий NET**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback0) (Windows 7)
    -   [**Фвпм \_ \_ \_ CALLBACK1 событий NET**](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback1) (Windows 8)
...
-   [**\_CALLBACK0 фвпм \_ изменения \_ фильтра**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_filter_change_callback0)
...
-   [**\_ \_ \_ CALLBACK0 изменения контекста поставщика \_ фвпм**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_provider_context_change_callback0)
-   Фвпмпровидерконтекстадд:
...
-   [**\_ \_ CALLBACK0 изменения поставщика \_ фвпм**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_provider_change_callback0)
...
Управление Подслоями

-   [**\_CALLBACK0 изменения ПОДСЛОЯ фвпм \_ \_**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_sublayer_change_callback0)
...
Управление системными портами

-   [**ФВПМ \_ системные \_ порты \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_system_ports_callback0)
...
-   [**\_ \_ CALLBACK0 события фвпм \_ VSWITCH**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_vswitch_event_callback0)
