...
Платформа фильтрации Windows (WFP) выполняет свои задачи, интегрируя следующие основные сущности: *слои*, *фильтры*, *оболочки совместимости* и *выноски*.
