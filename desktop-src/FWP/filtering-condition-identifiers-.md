---
title: Фильтрация идентификаторов условий (Фвпму. h)
description: Идентификаторы условий фильтрации платформы фильтрации Windows (WFP) представлены с помощью идентификатора GUID.
...
ms.locfileid: "103801036"
---
# <a name="filtering-condition-identifiers"></a>Фильтрация идентификаторов условий

Идентификаторы условий фильтрации платформы фильтрации Windows (WFP) представлены с помощью идентификатора **GUID**. Тип данных для значения условия для каждого условия фильтрации указывается как [**\_ \_ тип данных FWP**](/windows/desktop/api/Fwptypes/ne-fwptypes-fwp_data_type). Эти идентификаторы и их типы данных определяются здесь.

Стандартные условия перечислены первыми, за которыми следуют условия, относящиеся к пользовательскому режиму. Условия группируются по поддерживаемой операционной системе, что позволяет легко определить, какие условия поддерживаются для конкретной ОС.

> [!Note]  
> Каждое из следующих условий фильтрации доступно только в подмножестве уровней фильтрации WFP. Дополнительные сведения о доступности каждого условия на любом конкретном уровне см. в разделе [**Фильтрация условий, доступных на каждом слое фильтрации**](filtering-conditions-available-at-each-filtering-layer.md).
...
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="FWPM_CONDITION_IP_NEXTHOP_ADDRESS"></span><span id="fwpm_condition_ip_nexthop_address"></span><dl> <dt>**\_ \_ адрес IP- \_ \_ адреса для фвпм условия**</dt> </dl>                                             | IP-адрес интерфейса следующего прыжка.<br/> **Тип данных:** \_ \_ Маска адреса FWP \_ v4<br/>                                                                                                                                                                                        |
| <span id="FWPM_CONDITION_IP_NEXTHOP_INTERFACE"></span><span id="fwpm_condition_ip_nexthop_interface"></span><dl> <dt>**\_интерфейс фвпм условия \_ IP-адреса \_ \_**</dt> </dl>                                       | Интерфейс следующего прыжка, от которого будет относиться пакет. <br/> **Тип данных:** FWP \_ UINT64<br/>                                                                                                                                                                         |
| <span id="FWPM_CONDITION_NEXTHOP_INTERFACE_TYPE"></span><span id="fwpm_condition_nexthop_interface_type"></span><dl> <dt>**\_ \_ \_ тип интерфейса NEXTHOP условия \_ фвпм**</dt> </dl>                                 | Тип интерфейса для интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                            |
| <span id="FWPM_CONDITION_NEXTHOP_TUNNEL_TYPE"></span><span id="fwpm_condition_nexthop_tunnel_type"></span><dl> <dt>**\_ \_ \_ Тип туннеля для условия \_ фвпм**</dt> </dl>                                          | Тип туннеля интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                               |
| <span id="FWPM_CONDITION_NEXTHOP_INTERFACE_INDEX"></span><span id="fwpm_condition_nexthop_interface_index"></span><dl> <dt>**\_ \_ \_ индекс интерфейса NEXTHOP условия \_ фвпм**</dt> </dl>                              | Индекс интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                           |
| <span id="FWPM_CONDITION_NEXTHOP_SUB_INTERFACE_INDEX"></span><span id="fwpm_condition_nexthop_sub_interface_index"></span><dl> <dt>**\_ \_ \_ \_ индекс подинтерфейса фвпм условия NEXTHOP \_**</dt> </dl>                 | Индекс подинтерфейса интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                       |
| <span id="FWPM_CONDITION_ORIGINAL_PROFILE_ID"></span><span id="fwpm_condition_original_profile_id"></span><dl> <dt>**\_ \_ \_ идентификатор ИСХОДНОГО профиля \_ условия фвпм**</dt> </dl>                                          | Категория сети интерфейса прибытия или следующего прыжка, через которую создается поток ALE (входящий или исходящий трафик). <br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                  |
| <span id="FWPM_CONDITION_CURRENT_PROFILE_ID"></span><span id="fwpm_condition_current_profile_id"></span><dl> <dt>**\_ \_ \_ идентификатор текущего профиля \_ фвпм Condition**</dt> </dl>                                             | Категория сети интерфейса прибытия или следующего прыжка, через которую создается текущий пакет (входящий или исходящий). <br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                            |
| <span id="FWPM_CONDITION_LOCAL_INTERFACE_PROFILE_ID"></span><span id="fwpm_condition_local_interface_profile_id"></span><dl> <dt>**\_ \_ \_ идентификатор профиля ЛОКАЛЬНОГО интерфейса \_ условия \_ фвпм**</dt> </dl>                    | Категория сети интерфейса доставки.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                          |
| <span id="FWPM_CONDITION_ARRIVAL_INTERFACE_PROFILE_ID"></span><span id="fwpm_condition_arrival_interface_profile_id"></span><dl> <dt>**\_ \_ \_ \_ идентификатор профиля интерфейса фвпм условия \_ поступления**</dt> </dl>              | Категория сети интерфейса прибытия.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                           |
| <span id="FWPM_CONDITION_NEXTHOP_INTERFACE_PROFILE_ID"></span><span id="fwpm_condition_nexthop_interface_profile_id"></span><dl> <dt>**\_ \_ \_ \_ ИД профиля интерфейса \_ для фвпм условия**</dt> </dl>              | Категория сети интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                          |
| <span id="FWPM_CONDITION_REAUTHORIZE_REASON"></span><span id="fwpm_condition_reauthorize_reason"></span><dl> <dt>**Причина повторной \_ авторизации условия фвпм \_ \_**</dt> </dl>                                              | Причина повторной авторизации ранее авторизованного подключения.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                         |
| <span id="FWPM_CONDITION_ALE_REAUTH_REASON"></span><span id="fwpm_condition_ale_reauth_reason"></span><dl> <dt>**\_ \_ \_ Причина перепроверки подлинности ALE фвпм Condition \_**</dt> </dl>                                                | Причина повторной авторизации ранее авторизованного подключения, например **\_ \_ \_ \_ \_ изменения политики для FWP условий** , или одно из других значений в списке [**флагов условий фильтрации**](filtering-condition-flags-.md).<br/> **Тип данных:** FWP \_ UINT32<br/> |
| <span id="FWPM_CONDITION_ORIGINAL_ICMP_TYPE"></span><span id="fwpm_condition_original_icmp_type"></span><dl> <dt>**\_ \_ \_ Тип исходного ICMP \_ -условия фвпм**</dt> </dl>                                             | Тип ICMP, с которым был создан поток.<br/> **Тип данных:** FWP \_ UINT16<br/>                                                                                                                                                                                           |
| <span id="FWPM_CONDITION_IP_PHYSICAL_ARRIVAL_INTERFACE"></span><span id="fwpm_condition_ip_physical_arrival_interface"></span><dl> <dt>**\_ \_ \_ \_ интерфейс физического прибытия IP-адреса условия фвпм \_**</dt> </dl>           | LUID физического интерфейса, связанного с IP-адресом поступления.<br/> **Тип данных:** FWP \_ UINT64<br/>                                                                                                                                                               |
| <span id="FWPM_CONDITION_IP_PHYSICAL_NEXTHOP_INTERFACE"></span><span id="fwpm_condition_ip_physical_nexthop_interface"></span><dl> <dt>**\_интерфейс фвпм условия \_ IP-адреса на \_ физический адрес \_ \_**</dt> </dl>           | LUID физического интерфейса следующего прыжка.<br/> **Тип данных:** FWP \_ UINT64<br/>                                                                                                                                                                                      |
| <span id="FWPM_CONDITION_INTERFACE_QUARANTINE_EPOCH"></span><span id="fwpm_condition_interface_quarantine_epoch"></span><dl> <dt>**\_ \_ \_ эпоха карантина для интерфейса условия фвпм \_**</dt> </dl>                     | Число эпох, связанное с интерфейсом. Зарезервировано.<br/> **Тип данных:** FWP \_ UINT64<br/>                                                                                                                                                                                  |
| <span id="FWPM_CONDITION_ALE_SIO_FIREWALL_SOCKET_PROPERTY"></span><span id="fwpm_condition_ale_sio_firewall_socket_property"></span><dl> <dt>**\_ \_ \_ \_ \_ свойство сокета брандмауэра СУПЕРКОНТРОЛЛЕРА ввода/вывода ALE \_ фвпм**</dt> </dl> | Зарезервировано для внутреннего использования. <br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                                              |





| Константы, доступные для Windows Vista с SP1, Windows Server 2008 и более поздних версий                                                                                                                                                                           | Описание                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="FWPM_CONDITION_IP_ARRIVAL_INTERFACE"></span><span id="fwpm_condition_ip_arrival_interface"></span><dl> <dt>**\_ \_ \_ интерфейс появления IP-адреса условия фвпм \_**</dt> </dl>                       | LUID для сетевого интерфейса, связанного с IP-адресом поступления. <br/> **Тип данных:** FWP \_ UINT64<br/>                                                                                                                                                                                                                                                                                                                                                                          |
| <span id="FWPM_CONDITION_ARRIVAL_INTERFACE_TYPE"></span><span id="fwpm_condition_arrival_interface_type"></span><dl> <dt>**\_ \_ тип интерфейса появления условия фвпм \_ \_**</dt> </dl>                 | Тип сетевого интерфейса поступления, определенный центром имен, назначенным в Интернете (IANA). Дополнительные сведения см. на веб-сайте [https://www.iana.org/assignments/ianaiftype-mib](https://www.iana.org/assignments/ianaiftype-mib). <br/> **Возможные значения:** Значения типа интерфейса, перечисленные в файле заголовка Ипифконс. h.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                   |
| <span id="_FWPM_CONDITION_ARRIVAL_TUNNEL_TYPE"></span><span id="_fwpm_condition_arrival_tunnel_type"></span><dl> <dt>**Фвпм \_ \_ \_ \_ Тип туннеля появления условия**</dt> </dl>                       | Метод инкапсуляции, используемый туннелем, связанным с сетевым интерфейсом прибытия, если член типа имеет \_ тип \_ Tunnel. Тип туннеля определяется с помощью имени IANA (Internet Assigned Names Authority). Дополнительные сведения см. на веб-сайте [https://www.iana.org/assignments/ianaiftype-mib](https://www.iana.org/assignments/ianaiftype-mib). <br/> **Возможные значения:** \_Значения типа перечисления типа туннеля перечислены в файле заголовка ifdef. h.<br/> **Тип данных:** FWP \_ UINT32<br/> |
| <span id="FWPM_CONDITION_ARRIVAL_INTERFACE_INDEX"></span><span id="fwpm_condition_arrival_interface_index"></span><dl> <dt>**\_ \_ индекс интерфейса появления условия фвпм \_ \_**</dt> </dl>              | Индекс сетевого интерфейса прибытия, перечисленный сетевым стеком.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                                                                                                                                                                                                      |
| <span id="FWPM_CONDITION_ARRIVAL_SUB_INTERFACE_INDEX"></span><span id="fwpm_condition_arrival_sub_interface_index"></span><dl> <dt>**\_ \_ \_ \_ индекс подинтерфейса фвпм условия поступления условий \_**</dt> </dl> | Индекс сетевого интерфейса прибытия, перечисленный сетевым стеком. <br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                                                                                                                                                                                                     |
| <span id="FWPM_CONDITION_LOCAL_INTERFACE_INDEX"></span><span id="fwpm_condition_local_interface_index"></span><dl> <dt>**\_ \_ \_ индекс ЛОКАЛЬНОГО интерфейса \_ условия фвпм**</dt> </dl>                    | Индекс сетевого интерфейса, перечисленный сетевым стеком. <br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                                                                                                                                                                                                                                                             |
| <span id="FWPM_CONDITION_LOCAL_INTERFACE_TYPE"></span><span id="fwpm_condition_local_interface_type"></span><dl> <dt>**\_ \_ \_ тип ЛОКАЛЬНОГО интерфейса \_ условия фвпм**</dt> </dl>                       | Тип интерфейса, определяемый с помощью имени IANA (Internet Assigned Names Authority). Дополнительные сведения см. на веб-сайте [https://www.iana.org/assignments/ianaiftype-mib](https://www.iana.org/assignments/ianaiftype-mib). <br/> **Возможные значения:** Значения типа интерфейса, перечисленные в файле заголовка Ипифконс. h.<br/> **Тип данных:** FWP \_ UINT32<br/>                                                                                                                                          |
| <span id="FWPM_CONDITION_LOCAL_TUNNEL_TYPE"></span><span id="fwpm_condition_local_tunnel_type"></span><dl> <dt>**\_ \_ \_ тип локального туннеля \_ для состояния фвпм**</dt> </dl>                                | Метод инкапсуляции, используемый туннелем, если член типа имеет \_ тип \_ Tunnel. Тип туннеля определяется с помощью имени IANA (Internet Assigned Names Authority). Дополнительные сведения см. на веб-сайте [https://www.iana.org/assignments/ianaiftype-mib](https://www.iana.org/assignments/ianaiftype-mib). <br/> **Возможные значения:** \_Значения типа перечисления типа туннеля перечислены в файле заголовка ifdef. h.<br/> **Тип данных:** FWP \_ UINT32 <br/>                                              |
...
Следующие константы доступны только в пользовательском режиме.



| Условия пользовательского режима, доступные для Windows 8 и Windows Server 2012                                                                                                                       | Описание                                                                                                                                                               |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span id="FWPM_CONDITION_QM_MODE"></span><span id="fwpm_condition_qm_mode"></span><dl> <dt>**\_ \_ режим QM условия \_ фвпм**</dt> </dl> | Режим фильтра быстрого режима (QM). Возможные значения см. в разделе [**\_ \_ тип трафика IPSec**](/windows/desktop/api/Ipsectypes/ne-ipsectypes-ipsec_traffic_type) .<br/> **Тип данных:** FWP \_ UINT32<br/> |
