...
Идентификаторы подслоя платформы фильтрации Windows (WFP) представлены с помощью идентификатора GUID.
...
> [!Note]  
> Доступно только в Windows 8, Windows Server 2012 и более поздних версиях.
