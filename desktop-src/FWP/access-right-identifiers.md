...
description: Windows Платформа фильтрации (WFP) использует стандартные права доступа Win32, а также набор специальных прав доступа к платформе WFP, встроенных в платформу фильтрации.
...
ms.locfileid: "118951382"
---
# <a name="access-right-identifiers"></a>Идентификаторы прав доступа

Windows Платформа фильтрации (WFP) использует [стандартные права доступа Win32](/windows/desktop/SecAuthZ/standard-access-rights) , а также набор специальных прав доступа к платформе WFP, встроенных в платформу фильтрации. Эти права доступа используются для защиты объектов только в пользовательском режиме. Вызывающие объекты режима ядра обходят все проверки доступа.
...
[Windows Модель управления доступом к платформе фильтрации](access-control.md)
</dt> <dt>
