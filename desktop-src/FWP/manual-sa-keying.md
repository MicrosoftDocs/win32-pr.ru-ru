...
---
# <a name="manual-sa-keying"></a><span data-ttu-id="36b34-103">Ключ SA вручную</span><span class="sxs-lookup"><span data-stu-id="36b34-103">Manual SA Keying</span></span>

<span data-ttu-id="36b34-104">В следующем примере кода показано, как создать сопоставления безопасности (SA) с помощью платформы фильтрации Windows.</span><span class="sxs-lookup"><span data-stu-id="36b34-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
