...
---
# <a name="using-classify-options"></a>Использование параметров классификации

В следующих примерах кода демонстрируется использование параметров фильтра классификации для изменения процесса фильтрации.

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a>Включить сопоставление слабого источника для удаленного UDP-порта
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a>Изменение времени жизни простоя для потоков ALE
