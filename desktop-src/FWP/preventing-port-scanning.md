...
ms.locfileid: "119900794"
---
# <a name="preventing-port-scanning"></a>Запрет сканирования портов

В следующем примере кода показано, как предотвратить сканирование портов с помощью скрытых отклонений и автоматических сбросов.
