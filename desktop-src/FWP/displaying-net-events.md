---
title: Отображение событий NET
description: В следующем примере кода показано, как серверное приложение может располагать последние сетевые события, которые могли затронуть его.
...
ms.locfileid: "105681406"
---
# <a name="displaying-net-events"></a><span data-ttu-id="658fc-103">Отображение событий NET</span><span class="sxs-lookup"><span data-stu-id="658fc-103">Displaying Net Events</span></span>

<span data-ttu-id="658fc-104">В следующем примере кода показано, как серверное приложение может располагать последние сетевые события, которые могли затронуть его.</span><span class="sxs-lookup"><span data-stu-id="658fc-104">The following sample code demonstrates how a server application could locate recent net events that might have affected it.</span></span>

> [!Note]  
> <span data-ttu-id="658fc-105">Условия фильтра совпадают с условиями, поддерживаемыми API нижнего уровня **испорталловед** .</span><span class="sxs-lookup"><span data-stu-id="658fc-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
