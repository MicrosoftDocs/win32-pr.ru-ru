...
ms.locfileid: "118951293"
---
# <a name="displaying-net-events"></a>Отображение событий NET

В следующем примере кода показано, как серверное приложение может располагать последние сетевые события, которые могли затронуть его.
