...
ms.locfileid: "104336921"
---
# <a name="event-management"></a>Управление событиями

## <a name="in-this-section"></a>Содержание раздела

-   [**ФВПМ \_ net \_ event \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback0)
-   [*ФВПМ \_ net \_ event \_ CALLBACK1*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback1)
-   [*ФВПМ \_ net \_ event \_ CALLBACK2*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback2)
