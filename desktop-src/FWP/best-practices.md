...
-   Выполнять проверку пакетов на уровне потокового или датаграмма, а не на транспортном уровне.
    ...
    Это относится к разработке выносок. Дополнительные сведения см. в разделе [рекомендации по программированию драйвера выноски](/windows-hardware/drivers/network/callout-driver-programming-considerations) в комплекте драйверов для Windows (WDK).
