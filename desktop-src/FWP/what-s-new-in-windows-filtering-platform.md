...
description: Windows 8 и Windows Server 2012 появятся новые элементы программирования платформы фильтрации Windows.
...
ms.locfileid: "119766664"
---
# <a name="whats-new-in-windows-filtering-platform"></a>новые возможности платформы фильтрации Windows

Windows 8 и Windows Server 2012 появятся новые элементы программирования платформы фильтрации Windows. Новые функции включают следующие:
...
набор драйверов Windows также содержит сведения об [изменениях в WFP для Windows 8](/windows-hardware/drivers/network/wfp-changes-for-windows-8).

## <a name="windows-8-api-updates"></a>Windows 8 Обновления API

для Windows 8 и Windows Server 2012 были добавлены многие новые api.
...
## <a name="windows-7-updates-to-the-windows-filtering-platform"></a>Windows 7 обновлений для платформы фильтрации Windows

в документе [новые возможности платформы фильтрации Windows]() описаны многие обновления, внесенные в Windows 7. сведения также доступны в наборе драйверов Windows [для изменений в WFP для Windows 7](/windows-hardware/drivers/network/wfp-changes-for-windows-7).
