...
description: флаги условия фильтрации платформы фильтрации Windows (WFP) представлены битовыми битами.
...
ms.locfileid: "118150897"
---
# <a name="filtering-condition-flags"></a>Флаги условия фильтрации

флаги условия фильтрации платформы фильтрации Windows (WFP) представлены битовыми битами.
...
-   \_Поток уровня \_ фвпм \_ {v4 \| 6}
    > [!Note]  
    > доступно только на Windows Server 2008, Windows Vista с пакетом обновления 1 (SP1) и более поздних версиях.
...
| Заголовок<br/>                   | <dl> <dt>Фвптипес. h</dt> </dl> |
