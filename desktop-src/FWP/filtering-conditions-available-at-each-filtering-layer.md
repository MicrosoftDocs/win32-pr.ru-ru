...
- FWPM_CONDITION_IP_REMOTE_ADDRESS
- FWPM_CONDITION_PEER_NAME
## <a name="fwpm_layer_ipsec_km_demux_v4--fwpm_layer_ipsec_km_demux_v6"></a>FWPM_LAYER_IPSEC_KM_DEMUX_V4 И FWPM_LAYER_IPSEC_KM_DEMUX_V6
- FWPM_CONDITION_IP_LOCAL_ADDRESS
- FWPM_CONDITION_IP_REMOTE_ADDRESS
## <a name="fwpm_layer_ipsec_v4--fwpm_layer_ipsec_v6"></a>FWPM_LAYER_IPSEC_V4 И FWPM_LAYER_IPSEC_V6
- FWPM_CONDITION_IP_LOCAL_ADDRESS
- FWPM_CONDITION_IP_LOCAL_PORT
- FWPM_CONDITION_IP_PROTOCOL
- FWPM_CONDITION_IP_REMOTE_ADDRESS
