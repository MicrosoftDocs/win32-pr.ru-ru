...
В следующем примере кода показано, как заполнить условия фильтра, используемые серверным приложением для поиска фильтров и событий, влияющих на него.

> [!Note]  
> Эти условия аналогичны тем, которые поддерживаются API нижнего уровня **испорталловед** .
