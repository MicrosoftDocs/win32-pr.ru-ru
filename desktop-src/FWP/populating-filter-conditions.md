---
title: Заполнение условий фильтра
description: В следующем примере кода показано, как заполнить условия фильтра, используемые серверным приложением для поиска фильтров и событий, влияющих на него.
...
---
# <a name="populating-filter-conditions"></a><span data-ttu-id="f8333-103">Заполнение условий фильтра</span><span class="sxs-lookup"><span data-stu-id="f8333-103">Populating Filter Conditions</span></span>

<span data-ttu-id="f8333-104">В следующем примере кода показано, как заполнить условия фильтра, используемые серверным приложением для поиска фильтров и событий, влияющих на него.</span><span class="sxs-lookup"><span data-stu-id="f8333-104">The following sample code demonstrates how to populate filter conditions used by a server application to find filters and events that affect it.</span></span>

> [!Note]  
> <span data-ttu-id="f8333-105">Эти условия аналогичны тем, которые поддерживаются API нижнего уровня **испорталловед** .</span><span class="sxs-lookup"><span data-stu-id="f8333-105">These conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
