...
---
# <a name="using-transport-mode"></a>Использование транспортного режима

В следующем примере кода показано, как настроить транспортный режим IPsec с помощью AuthIP с проверкой подлинности пользователя и согласованием.
