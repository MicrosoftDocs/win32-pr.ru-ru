...
description: В следующем примере кода демонстрируется процесс, необходимый для удаления установки поставщика.
...
---
# <a name="uninstalling-a-provider"></a><span data-ttu-id="558ce-103">Удаление поставщика</span><span class="sxs-lookup"><span data-stu-id="558ce-103">Uninstalling a Provider</span></span>

<span data-ttu-id="558ce-104">В следующем примере кода демонстрируется процесс, необходимый для удаления установки поставщика.</span><span class="sxs-lookup"><span data-stu-id="558ce-104">The following sample code demonstrates the process required to remove a provider installation.</span></span>
