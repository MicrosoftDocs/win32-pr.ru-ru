---
title: Принудительное удаление фильтра
description: В следующем примере кода показано, как сделать пользователя с привилегией Такеовнершип, способной удалить фильтр.
...
ms.locfileid: "103778077"
---
# <a name="forcing-filter-deletion"></a><span data-ttu-id="8bb89-103">Принудительное удаление фильтра</span><span class="sxs-lookup"><span data-stu-id="8bb89-103">Forcing Filter Deletion</span></span>

<span data-ttu-id="8bb89-104">В следующем примере кода показано, как сделать пользователя с привилегией Такеовнершип, способной удалить фильтр.</span><span class="sxs-lookup"><span data-stu-id="8bb89-104">The following sample code demonstrates how to make a user with the TakeOwnership privilege capable of deleting a filter.</span></span>

> [!Note]  
> <span data-ttu-id="8bb89-105">Приложение установки может использовать эту функцию во время удаления, чтобы гарантировать успешное удаление всех объектов.</span><span class="sxs-lookup"><span data-stu-id="8bb89-105">A setup application might use this feature during an uninstall to ensure that all objects are successfully deleted.</span></span>
