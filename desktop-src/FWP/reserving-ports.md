---
title: Резервирование портов
description: В следующем примере кода показано, как использовать уровни назначения ресурсов для резервирования диапазона портов для администраторов.
...
---
# <a name="reserving-ports"></a><span data-ttu-id="07456-103">Резервирование портов</span><span class="sxs-lookup"><span data-stu-id="07456-103">Reserving Ports</span></span>

<span data-ttu-id="07456-104">В следующем примере кода показано, как использовать уровни назначения ресурсов для резервирования диапазона портов для администраторов.</span><span class="sxs-lookup"><span data-stu-id="07456-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="07456-105">См. также</span><span class="sxs-lookup"><span data-stu-id="07456-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="07456-106">**Условия фильтрации, доступные на каждом слое фильтрации**</span><span class="sxs-lookup"><span data-stu-id="07456-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
