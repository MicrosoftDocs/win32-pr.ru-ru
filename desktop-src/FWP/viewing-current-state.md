...
ms.locfileid: "119639004"
---
# <a name="viewing-current-state"></a>Просмотр текущего состояния

В следующем образце кода показано, как найти все фильтры, которые могут повлиять на серверное приложение.
