---
title: Просмотр текущего состояния
description: В следующем примере кода показано, как найти все фильтры, которые могут повлиять на серверное приложение.
...
ms.locfileid: "105681424"
---
# <a name="viewing-current-state"></a><span data-ttu-id="2e6ef-103">Просмотр текущего состояния</span><span class="sxs-lookup"><span data-stu-id="2e6ef-103">Viewing Current State</span></span>

<span data-ttu-id="2e6ef-104">В следующем образце кода показано, как найти все фильтры, которые могут повлиять на серверное приложение.</span><span class="sxs-lookup"><span data-stu-id="2e6ef-104">The following sample code demonstrates how to find all filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="2e6ef-105">Условия фильтра совпадают с условиями, поддерживаемыми API нижнего уровня **испорталловед** .</span><span class="sxs-lookup"><span data-stu-id="2e6ef-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
