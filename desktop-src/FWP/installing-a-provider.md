...
description: В следующем примере кода показана операция установки поставщика платформы фильтрации Windows.
...
ms.locfileid: "103888087"
---
# <a name="installing-a-provider"></a><span data-ttu-id="021e9-103">Установка поставщика</span><span class="sxs-lookup"><span data-stu-id="021e9-103">Installing a Provider</span></span>

<span data-ttu-id="021e9-104">В следующем образце кода показана операция установки поставщика платформы фильтрации Windows.</span><span class="sxs-lookup"><span data-stu-id="021e9-104">The following sample code demonstrates the provider installation operation of the Windows Filtering Platform.</span></span>
