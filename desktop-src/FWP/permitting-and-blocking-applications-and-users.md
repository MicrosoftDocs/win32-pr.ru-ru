...
---
# <a name="permitting-and-blocking-applications-and-users"></a>Разрешение и блокировка приложений и пользователей

В следующем образце кода показано, как добавить фильтр, который оценивается по ИДЕНТИФИКАТОРу пользователя или приложения.
