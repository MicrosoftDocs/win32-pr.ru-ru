...
| Имя                   | Описание                                                                                                                                                                                                                |
|------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **стреамингшадервар** | Необязательный элемент. Строка АСЦИ, однозначно определяющая имя переменной шейдера Geometry с выходом из потоков. Это необязательно, так как Конструктгсвиссо можно разместить непосредственно в вызове Сетжеометришадер или Биндинтерфацес. |
...
| Имя              | Описание                                                                                           |
|-------------------|-------------------------------------------------------------------------------------------------------|
| **Буфер**        | Необязательный элемент. Целое число, 0 <= buffer < 4, определяющее потоковый буфер, к которому будет переходить значение. |
| **Семантическ**      | Строка вместе с СемантиЦиндекс, указывающая значение для вывода.                                 |
| **семантиЦиндекс** | Необязательный элемент. Индекс, связанный с семантикой.                                                         |
| **Виде**          | Необязательный элемент. Маска компонента, указывающая, какие компоненты значения следует выводить.                       |
