...
---
# <a name="id3dx11effectconstantbuffersetconstantbuffer-method"></a>Метод ID3DX11EffectConstantBuffer:: Сетконстантбуффер

Установите константный буфер.
...
Указатель на интерфейс постоянного буфера. См. [**ID3D11Buffer**](/windows/desktop/api/D3D11/nn-d3d11-id3d11buffer).
