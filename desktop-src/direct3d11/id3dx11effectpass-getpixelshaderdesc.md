...
ms.locfileid: "118535012"
---
# <a name="id3dx11effectpassgetpixelshaderdesc-method"></a>Метод ID3DX11EffectPass:: Жетпикселшадердеск

Получите описание пиксельного шейдера.
...
Указатель на описание пиксельного шейдера (см. раздел [**D3DX11 \_ Pass \_ Shader \_ DESC**](d3dx11-pass-shader-desc.md)).
