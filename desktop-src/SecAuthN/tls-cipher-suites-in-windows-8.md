---
description: Дополнительные сведения о комплектах шифров TLS в Windows 8. Комплекты шифров можно согласовать только для тех версий TLS, которые их поддерживают.
...
ms.locfileid: "117785994"
---
# <a name="tls-cipher-suites-in-windows-8"></a>Комплекты шифров TLS в Windows 8
...
-   Разрешено, если приложение передает SCH с \_ использованием \_ надежного \_ шифрования: поставщик Microsoft SChannel будет отфильтровывать известные ненадежные наборы шифров, когда приложение использует \_ \_ флаг стойкого \_ шифрования SCH. в Windows 8 комплекты шифров RC4 отфильтровываются.
