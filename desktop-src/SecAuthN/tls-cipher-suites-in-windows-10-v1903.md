...
Для Windows 10, версии 1903, 1909 и 2004 следующие комплекты шифров включены и по умолчанию используют поставщик Schannel (Майкрософт) в этом порядке приоритета:
