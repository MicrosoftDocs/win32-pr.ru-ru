---
description: Позволяет транспортному приложению запрашивать дайджест- [*пакет безопасности*](../secgloss/s-gly.md) для определенных атрибутов [*контекста безопасности*](../secgloss/s-gly.md).
...
ms.locfileid: "104541159"
---
# <a name="querycontextattributes-digest-function"></a>Функция QueryContextAttributes (Digest)

Функция **QueryContextAttributes (Digest)** позволяет транспортному приложению запрашивать дайджест- [*пакет безопасности*](../secgloss/s-gly.md) для определенных [*атрибутов*](../secgloss/a-gly.md#_security_attribute_gly) [*контекста безопасности*](../secgloss/s-gly.md).
