...
ms.locfileid: "118917169"
---
# <a name="asynchronous-sspi"></a>Асинхронный SSPI

Заголовок асинхронного SSPI включает функции, поддерживающие асинхронные объекты контекста, позволяя вызывающим объектам устанавливать контексты безопасности между сервером и удаленными клиентами параллельно через жизненный цикл асинхронного вызова SSPI.
