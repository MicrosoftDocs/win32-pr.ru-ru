...
---
# <a name="tls-cipher-suites-in-windows-10-v1703"></a>Комплекты шифров TLS в Windows 10 v1703
...
Для Windows 10 версии 1703 следующие комплекты шифров включены и в этом порядке по умолчанию используют поставщик Microsoft SChannel:
