...
ms.locfileid: "117786203"
---
# <a name="tls-cipher-suites-in-windows-10-v1607"></a>комплекты шифров TLS в Windows 10 v1607
...
для Windows 10 версии 1607 и Windows Server 2016 следующие комплекты шифров включены по умолчанию и по этому приоритету используют поставщик Microsoft Schannel:
...
начиная с Windows 10, версии 1607 и Windows Server 2016 следующие наборы шифров PSK включены и по умолчанию используют поставщик Microsoft Schannel в этом порядке по приоритету.
