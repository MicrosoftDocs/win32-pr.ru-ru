...
Для Windows 10, версии 1607 и Windows Server 2016 следующие комплекты шифров включены и по умолчанию в этом порядке используют поставщик Microsoft SChannel:
...
Начиная с Windows 10, версии 1607 и Windows Server 2016, следующие комплекты шифров PSK включены и по умолчанию используют поставщик Microsoft Schannel в порядке приоритета:
