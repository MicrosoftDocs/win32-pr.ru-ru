...
---
# <a name="querycontextattributes-ntlm-function"></a>Функция QueryContextAttributes (NTLM)

Функция **QueryContextAttributes (NTLM)** позволяет транспортному приложению запрашивать [*пакет безопасности*](../secgloss/s-gly.md) NTLM для определенных [*атрибутов*](../secgloss/a-gly.md#_security_attribute_gly) [контекста безопасности](../secgloss/s-gly.md).
