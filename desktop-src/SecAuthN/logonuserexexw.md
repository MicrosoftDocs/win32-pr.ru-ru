...
Если этот параметр не равен **null**, то вызывающей стороне этой функции должно быть предоставлено и включено право доступа **SE \_ \_** .
...
| Версия<br/>                  | Логонусерексексв также доступен в выпуске Windows Server 2003 или Windows Кспвис для общего распространения.<br/> |
