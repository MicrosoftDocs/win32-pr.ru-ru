---
description: Позволяет транспортному приложению запрашивать [*пакет безопасности*](../secgloss/s-gly.md) Kerberos для определенных атрибутов [*контекста безопасности*](../secgloss/s-gly.md).
...
ms.locfileid: "104497283"
---
# <a name="querycontextattributes-kerberos-function"></a>Функция QueryContextAttributes (Kerberos)

Функция **QueryContextAttributes (Kerberos)** позволяет транспортному приложению запрашивать [*пакет безопасности*](../secgloss/s-gly.md) Kerberos для определенных [*атрибутов*](../secgloss/a-gly.md#_security_attribute_gly) [*контекста безопасности*](../secgloss/s-gly.md).
