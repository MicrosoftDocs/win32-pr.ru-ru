...
---
# <a name="g_wszwmvccomplexityexlive"></a><span data-ttu-id="151ae-105">g \_ всзвмвккомплекситексливе</span><span class="sxs-lookup"><span data-stu-id="151ae-105">g\_wszWMVCComplexityExLive</span></span>

<span data-ttu-id="151ae-106">Текущую документацию по кодекам Windows Media и обработчикам цифровых сигналов см [. в статье интерфейсы API аудио-и видеокодеков Windows Media и DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="151ae-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
