...
- Windows Пакет SDK для Media Format, многоканальное воспроизведение звука
- Windows Пакет SDK для формата мультимедиа, воспроизведение звука
...
ms.locfileid: "119808164"
---
# <a name="multichannel-audio-playback-in-directshow"></a>Многоканальное воспроизведение звука в DirectShow

для воспроизведения многоканального Windowsного звукового файла мультимедиа в DirectShow необходимо задать \_ свойство "хиресаутпут" непосредственно в декодере после его подключения к модулю чтения WM ASF. Настройка объекта модуля чтения не требуется. однако для непосредственной работы с DMO требуется вмкодекконст. h из [примера кода для использования Windows Media Audio и видео code interfaces](https://www.microsoft.com/downloads/details.aspx?FamilyId=92490D8A-4F2E-46F1-8835-B1D987B3C985&displaylang=en) download package.
