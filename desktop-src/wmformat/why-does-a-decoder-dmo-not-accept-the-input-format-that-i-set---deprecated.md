...
---
# <a name="why-does-a-decoder-dmo-not-accept-the-input-format-that-i-set"></a><span data-ttu-id="15395-105">Почему декодер DMO не принимает заданный формат ввода?</span><span class="sxs-lookup"><span data-stu-id="15395-105">Why does a decoder DMO not accept the input format that I set?</span></span>

<span data-ttu-id="15395-106">Текущую документацию по кодекам Windows Media и обработчикам цифровых сигналов см [. в статье интерфейсы API аудио-и видеокодеков Windows Media и DSP.](/previous-versions//dd464626(v=vs.85))</span><span class="sxs-lookup"><span data-stu-id="15395-106">For current documentation on Windows Media codecs and digital signal processors, see [Windows Media Audio and Video Codec and DSP APIs.](/previous-versions//dd464626(v=vs.85))</span></span>
