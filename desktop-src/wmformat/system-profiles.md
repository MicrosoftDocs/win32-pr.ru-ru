...
- Windows Пакет SDK для формата мультимедиа, идентификаторы профилей
...
> [!IMPORTANT]
> перечисленные ниже профили используют видеокодекы версии 8 Windows media Audio и Windows media Video. нет стандартных системных профилей, использующих кодеки Windows Media 9 Series. вы можете создать собственный профиль серии Windows Media 9 с помощью профиля версии 8 в качестве отправной точки. Дополнительные сведения см. в разделе [повторное использование конфигураций потоков](reusing-stream-configurations.md).
