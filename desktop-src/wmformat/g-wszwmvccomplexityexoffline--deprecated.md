...
description: Текущую документацию по кодекам Windows Media и обработчикам цифровых сигналов см. в статье интерфейсы API аудио-и видеокодеков Windows Media и DSP. | g_wszWMVCComplexityExOffline
ms.assetid: 2887d621-8f23-4b2d-ac49-5b552e10ac3a
keywords:
- g_wszWMVCComplexityExOffline формат Windows Media
topic_type:
- apiref
api_name:
...
ms.locfileid: "104273412"
---
# <a name="g_wszwmvccomplexityexoffline"></a>g \_ всзвмвккомплекситексоффлине
