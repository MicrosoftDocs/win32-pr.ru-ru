...
<td>Координата по оси X относительно видеокадра центра результатов диафрагмы.</td>
</tr>
<tr class="even">
<td>Центр по оси Y</td>
<td><strong>fEffectPara1</strong></td>
<td>Координата по оси Y относительно видеокадра центра результатов диафрагмы.</td>
</tr>
<tr class="odd">
<td>Ширина</td>
<td><strong>fEffectPara2</strong></td>
<td>Ширина вертикальной линии, в пикселях которой отображается новое изображение.</td>
</tr>
<tr class="even">
<td>Высота</td>
<td><strong>fEffectPara3</strong></td>
<td>Высота горизонтальной линии, которая отображает новое изображение (в пикселях).</td>
</tr>
<tr class="odd">
<td>Композиция</td>
