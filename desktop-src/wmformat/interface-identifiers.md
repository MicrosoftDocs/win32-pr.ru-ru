...
keywords:
- Windows Пакет SDK для формата мультимедиа, идентификаторы интерфейсов (IID)
...
ms.locfileid: "119808924"
---
# <a name="interface-identifiers"></a>Идентификаторы интерфейса

При вызове метода **QueryInterface** необходимо использовать идентификатор интерфейса (IID). IID — это значение глобального уникального идентификатора (GUID). в пакете SDK для Windows Media Format константа, назначенная IID для данного интерфейса, — это имя интерфейса с префиксом iid \_ .
...
| **ивмдрмреадер**                | IID \_ ивмдрмреадер                | d2827540-3ee7-432c-b14c-dc17f085d3b3 |
...
| **ивмреадеракцелератор**        | IID \_ ивмреадеракцелератор        | BDDC4D08-944D-4D52-A612-46C3FDA07DD4 |
