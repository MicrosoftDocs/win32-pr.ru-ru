...
<td>Координата по оси X относительно видеокадра центра воздействия колесика.</td>
</tr>
<tr class="even">
<td>Центр по оси Y</td>
<td><strong>fEffectPara1</strong></td>
<td>Координата по оси Y относительно видеокадра центра воздействия колесика.</td>
</tr>
<tr class="odd">
<td>Angle</td>
<td><strong>fEffectPara2</strong></td>
<td>Угол поворота (в градусах) периферийных элементов этого угла. Значение 0,0 указывает на старое изображение без выявила новый образ. Значение 90,0 указывает, что новый образ полностью отображен. Перемещение с 0,0 на 90,0 отображается с поворотом по часовой стрелке.<br/></td>
</tr>
<tr class="even">
<td>Композиция</td>
