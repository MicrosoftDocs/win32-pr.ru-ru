...
| [запись образа Потоки](writing-image-streams.md)                         | Описывает настройку входных данных для потока изображений.                                               |
| [Написание примеров видеороликов](writing-video-image-samples.md)             | Описывает, как настроить образцы видеороликов.                                                        |
| [запись переменной скорости Потоки](writing-variable-bit-rate-streams.md) | Описание процесса записи потоков с переменным битом скорости (VBR).                                                |
