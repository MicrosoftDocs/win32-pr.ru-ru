...
Основные функции объекта Reader можно разделить на следующие шаги. на этих этапах "приложение" относится к программе, которую вы пишете с помощью пакета SDK для Windows Media Format.
...
5.  Приложение отвечает за отрисовку данных после их доставки модулем чтения. пакет SDK для Windows Media Format не предоставляет никаких подпрограмм подготовки к просмотру. как правило, приложения используют другие пакеты sdk для подготовки данных к просмотру, такие как Microsoft DirectX® sdk, или мультимедийные функции пакета microsoft Windows Platform sdk.
