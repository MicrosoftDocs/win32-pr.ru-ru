...
keywords:
- Windows Пакет SDK для формата мультимедиа, чтение файлов
...
4.  Приложение отвечает за отрисовку данных после их доставки модулем чтения. пакет SDK для Windows Media Format не предоставляет никаких подпрограмм подготовки к просмотру. как правило, приложения используют другие пакеты sdk для визуализации данных, такие как пакет sdk microsoft Direct X, или мультимедийные функции пакета microsoft Windows Platform SDK.
