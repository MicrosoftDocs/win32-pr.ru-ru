---
title: HasScript
description: Атрибут HasScript — это атрибут уровня файла, указывающий, содержит ли файл какие-либо потоки скриптов.
ms.assetid: e94c37ea-e11c-4abd-91d1-8f82612d8cba
keywords:
- Формат Windows Media HasScript
topic_type:
- apiref
api_name:
- HasScript
...
ms.locfileid: "117847637"
---
# <a name="hasscript"></a>HasScript

Атрибут **HasScript** — это атрибут уровня файла, указывающий, содержит ли файл какие-либо потоки скриптов.
