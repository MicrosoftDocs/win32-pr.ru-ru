...
- Windows Пакет SDK для формата мультимедиа, сторонние кодеки
...
ms.locfileid: "118197083"
---
# <a name="to-create-asf-files-using-third-party-codecs"></a>Создание файлов ASF с помощью сторонних кодеков

пакет SDK для Windows Media Format можно использовать для создания файлов ASF, которые содержат цифровые файлы мультимедиа, закодированные с помощью любого выбранного вами кодека. При использовании кодека, не входящего в состав этого пакета SDK, необходимо выполнить следующие действия.
...
> [!Note]  
> эта статья относится к приложениям, использующим пакет SDK для Windows Media Format для помещения MPEG-2 (или других форматов сжатия, использующих кадры B) в контейнер файлов ASF.
