...
CNG предоставляет набор интерфейсов API, которые используются для создания, хранения и извлечения криптографических ключей. Список этих API-интерфейсов см. в разделе [функции хранилища ключей CNG](cng-key-storage-functions.md).
