...
|-------------------|-------------------------------------------------------------|
| Имя              | curve25519                                                  |
| Стандартный          | [Кривая 25519](https://cr.yp.to/ecdh/curve25519-20060209.pdf) |
| Размер ключа (в битах)   | 255                                                         |
| Поддерживается TLS       |                                                             |
| Идентификаторы объектов | None                                                        |
...
|-------------------|-------------------------------------------------------------------------------------------------------------------|
| Имя              | brainpoolP160r1                                                                                                   |
| Стандартный          | [Генерирование кривых ECC Brainpool Standard и создание кривых](https://www.teletrust.de/fileadmin/files/oid/oid_ECC-Brainpool-Standard-curves-V1.pdf) |
...
|-------------------|----------------------------------------------------------------|
| Имя              | ec192wapi                                                      |
| Стандартный          | Китайский национальный стандарт для беспроводных локальных сетей (GB 15629.11-2003) |
| Размер ключа (в битах)   | 192                                                            |
| Поддерживается TLS       | Нет                                                             |
...
|-------------------|------------------------------------------------------------------------------------------------------------------------------|
| Имя              | nistP192                                                                                                                     |
| Стандартный          | [Рекомендуемые эллиптические кривые для федерального использования правительственных учреждений](https://csrc.nist.gov/groups/ST/toolkit/documents/dss/NISTReCur.pdf) |
| Размер ключа (в битах)   | 192                                                                                                                          |
| Поддерживается TLS       | Да                                                                                                                          |
...
|-------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| Имя              | numsP256t1                                                                                                                              |
| Стандартный          | [Спецификация выбора кривой и поддерживаемые параметры кривой в MSR Екклиб](https://research.microsoft.com/pubs/219966/curvegen.pdf) |
| Размер ключа (в битах)   | 256                                                                                                                                     |
| Поддерживается TLS       | Нет                                                                                                                                      |
| Идентификаторы объектов | None                                                                                                                                    |
...
|-------------------|---------------------------------------------------------------------------------|
| Имя              | secP160k1                                                                       |
| Стандартный          | [Рекомендуемые параметры домена эллиптической кривой](https://www.secg.org/sec2-v2.pdf) |
| Размер ключа (в битах)   | 160                                                                             |
| Поддерживается TLS       | Да                                                                             |
