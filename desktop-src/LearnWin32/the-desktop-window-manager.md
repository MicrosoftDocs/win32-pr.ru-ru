...
-   Альтернативные представления. DWM может использовать поверхностные области различными способами. например, DWM — это технология, которая Windows переворачивать объемные, миниатюрные и анимированные переходы.
