...
Эти шаги примерно эквивалентны процессу компиляции и компоновки файлов кода. Visual Studio предоставляет набор редакторов ресурсов, которые упрощают создание и изменение ресурсов. (Эти средства недоступны в выпусках Express Visual Studio.) Но RC-файл — это просто текстовый файл, а синтаксис описан на сайте MSDN, поэтому можно создать RC-файл в любом текстовом редакторе. Дополнительные сведения см. в разделе [о файлах ресурсов](/windows/desktop/menurc/about-resource-files).
...
Сначала определите числовые идентификаторы для таблицы и для команд приложения. Эти значения являются произвольными. Для идентификаторов можно назначить символьные константы, определив их в файле заголовка. Например:
