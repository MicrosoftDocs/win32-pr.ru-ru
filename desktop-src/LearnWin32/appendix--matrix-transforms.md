...
> [!Note]  
> Эта диаграмма использует стандартную систему координат, используемую в геометрии, где на оси y настраивается положительная ось. Direct2D использует систему координат Windows, на которой отключается положительная ось y.
