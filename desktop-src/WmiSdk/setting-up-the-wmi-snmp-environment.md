...
Как мера безопасности, сообщество SNMP "Public" по умолчанию не создается. Вы можете создать сообщество, как описано в [разделе Параметры реестра сообщества](/previous-versions/windows/embedded/ms907028(v=msdn.10)). Если у вас нет сообщества, Создайте общедоступное сообщество для доступа к поставщику SNMP.
