...
<span id="_1015__Fatal_____fileName___line____OBJECT-TYPEs__identifier__from_module__identifier__and__identifier__from_module__identifier__are_assigned_the_same_OID_values_"></span><span id="_1015__fatal_____filename___line____object-types__identifier__from_module__identifier__and__identifier__from_module__identifier__are_assigned_the_same_oid_values_"></span><span id="_1015__FATAL_____FILENAME___LINE____OBJECT-TYPES__IDENTIFIER__FROM_MODULE__IDENTIFIER__AND__IDENTIFIER__FROM_MODULE__IDENTIFIER__ARE_ASSIGNED_THE_SAME_OID_VALUES_"></span>**<1015, Неустранимая>: " &lt; имя_файла &gt; : <строка \#>: OBJECT-TYPEs &lt; идентификатору из идентификатора модуля &gt; &lt; &gt; и &lt; идентификатора &gt; из &lt; идентификатора модуля &gt; присваиваются одинаковые значения OID"**
</dt> <dd>
