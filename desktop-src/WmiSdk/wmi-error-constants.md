...
Команда SQL должна быть перезапущена, так как в SQL есть взаимоблокировка. Это может быть возвращено только в том случае, если данные хранятся в базе данных SQL.
...
У этого компьютера нет необходимых разрешений на доступ к домену для поддержки функций безопасности, связанных с созданным экземпляром подписки. Обратитесь к администратору домена, чтобы добавить этот компьютер в группу авторизации доступа Windows.
...
Недопустимый синтаксис квалификатора. Вместо этого она должна иметь вид `qualifiername:type=value,scope(class|instance), flavorname`.
