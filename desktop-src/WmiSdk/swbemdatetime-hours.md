...
ms.locfileid: "120030384"
---
# <a name="swbemdatetimehours-property"></a>SWbemDateTime. hours, свойство

Свойство **hours** объекта [**SWbemDateTime**](swbemdatetime.md) Возвращает или задает значение, представляющее компонент часов для значения DateTime.
...
После получения или задания свойства **hours** объект [Err](/previous-versions//sbf5ze0e(v=vs.85)) может содержать приведенный ниже код ошибки.
...
Значение не находится в диапазоне от 0 до 23.
...
[**SWbemDateTime. ХаурсспеЦифиед**](swbemdatetime-hoursspecified.md)
</dt> <dt>
