...
-   Подключитесь к инструментарию WMI, если на веб-странице выполняется сценарий WMI. Нельзя использовать функцию GetObject при выполнении скриптов, внедренных в HTML-страницу, так как Internet Explorer запрещает использование GetObject в целях безопасности.
