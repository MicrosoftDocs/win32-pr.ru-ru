...
---
# <a name="wmi-tasks-computer-hardware"></a>Задачи WMI: оборудование компьютера

Задачи WMI для оборудования компьютера получают сведения о присутствии, состоянии или свойствах компонентов оборудования. Например, можно определить, является ли компьютер настольным или ноутбуком. Другие примеры см. в разделе TechNet Скриптцентер по адресу [https://www.microsoft.com/technet](https://technet.microsoft.com/default.aspx) .
...
<tbody>
<tr class="odd">
<td>... определить объем свободной памяти компьютера?</td>
<td>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-operatingsystem"><strong>Win32_OperatingSystem</strong></a> и свойство <strong>фрифисикалмемори</strong> .<br/> <span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
<col style="width: 100%" />
</colgroup>
...
<tr class="even">
<td>... как определить, есть ли у компьютера DVD-дисковод?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-cdromdrive"><strong>Win32_CDROMDrive</strong></a> и проверьте DVD-диск акронима в свойстве <strong>Name</strong> или <strong>DeviceID</strong> .</p>
<div class="code">
...
<tr class="odd">
<td>... определить, какой объем ОЗУ установлен на компьютере?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> и проверьте значение свойства <strong>тоталфисикалмемори</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... определить, имеет ли компьютер несколько процессоров?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-computersystem"><strong>Win32_ComputerSystem</strong></a> и свойство <strong>NumberOfProcessors</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... Определение наличия гнезда PCMCIA на компьютере?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-pcmciacontroller"><strong>Win32_PCMCIAController</strong></a> и проверьте значение свойства <strong>Count</strong> . Если параметр <strong>Count</strong> равен 0, то компьютер не имеет гнезд PCMCIA.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... выявление неработающих устройств (отмеченных значком восклицательного знака в <strong>Диспетчер устройств</strong>)?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-pnpentity"><strong>Win32_PnPEntity</strong></a> и используйте следующее предложение в <a href="querying-with-wql.md">WQL</a> -запросе. <strong>Где конфигманажерерроркоде <> 0</strong> Обратите внимание, что этот код может не обнаруживать USB-устройства с отсутствующими драйверами.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... определить свойства мыши, используемой на компьютере?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-pointingdevice"><strong>Win32_PointingDevice</strong></a> . Это возвращает свойства всех указывающих устройств, а не просто устройств мыши.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... определить скорость процессора, установленного на компьютере?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-processor"><strong>Win32_Processor</strong></a> и проверьте значение свойства <strong>максклоккспид</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... как определить, является ли компьютер корпусом Tower, Мини-башня, ноутбуком и т. д.?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> и проверьте значение свойства <strong>чассистипе</strong> .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... получить серийный номер и тег ресурса для компьютера?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-systemenclosure"><strong>Win32_SystemEnclosure</strong></a> и свойства <strong>SerialNumber</strong> и <strong>смбиосассеттаг</strong>.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="odd">
<td>... определить тип устройства, подключенного к USB-порту?</td>
<td><p>Используйте класс <a href="/previous-versions/windows/desktop/cimwin32a/win32-usbhub"><strong>Win32_USBHub</strong></a> и проверьте свойство <strong>Description</strong> . Это свойство может иметь такие значения, как &quot; запоминающее устройство &quot; или &quot; Поддержка печати &quot; .</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
<tr class="even">
<td>... определить, сколько ленточных накопителей установлено на компьютере?</td>
<td><p>Используйте класс <a href="/windows/desktop/CIMWin32Prov/win32-tapedrive"><strong>Win32_TapeDrive</strong></a> класса, а затем используйте метод <a href="swbemobjectset-count.md"><strong>SWbemObjectSet. Count</strong></a> . Если параметр count = 0, на компьютере не установлены ленточные накопители.</p>
<div class="code">
<span data-codelanguage="VisualBasic"></span>
<table>
<colgroup>
...
В следующем [примере кода](https://Gallery.TechNet.Microsoft.Com/scriptcenter/List-for-several-machines-1baf6df0) коллекции TechNet описывается, как получить список свободного места для всех дисков на нескольких компьютерах.
...
[Многопоточный сбор системных ресурсов с помощью PowerShell](https://Gallery.TechNet.Microsoft.Com/Multithreaded-System-Asset-856a8f7c) PowerShell в течнетгаллери собирает множество полезных системных сведений с помощью WMI и многопоточности с помощью PowerShell.
