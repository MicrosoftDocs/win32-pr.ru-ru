...
В предложении WHERE можно использовать строковые литералы, например "NTFS". Если вы хотите включить в строку следующие специальные символы, необходимо сначала escape-символ с помощью обратной косой черты ( \\ ):
