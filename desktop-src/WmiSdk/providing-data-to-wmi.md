...
-   Использование мастера ATL в Visual Studio.
    ...
    Мастер ATL создает код поставщика, реализующий связанный поставщик. При использовании мастера ATL можно указать, что вы хотите создать внутрипроцессный (DLL) или внепроцессных (exe) модель времени выполнения поставщика.
