...
Метод **Find** выполняет поиск в строке первого совпадения подстроки.
...
| Метод                                          | Описание                                             |
|:------------------------------------------------|:--------------------------------------------------------|
| [**Find (WCHAR)**](/windows/win32/api/chstring/nf-chstring-chstring-find(lpcwstr))     | Выполняет поиск **встр** в этой строке.<br/>    |
| [**Найти (ЛПКВСТР)**](/windows/win32/api/chstring/nf-chstring-chstring-find(lpcwstr)) | Выполняет поиск **лпквстр** в этой строке.<br/> |
