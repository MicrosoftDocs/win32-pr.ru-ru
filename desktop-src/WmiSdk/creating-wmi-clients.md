...
| [Запрос состояния дополнительных функций](querying-the-status-of-optional-features.md)                     | в Windows 7 инструментарий WMI реализовал класс [**Win32 \_ оптионалфеатуре**](/windows/desktop/CIMWin32Prov/win32-optionalfeature) . Этот класс получает состояние дополнительных компонентов, имеющихся на компьютере. |
