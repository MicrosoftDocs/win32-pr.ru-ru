---
description: вы можете объявить базовый экземпляр класса в службе управления Windows, используя MOF-файл (MOF). Можно также переопределить значения по умолчанию для экземпляра. Дополнительные сведения см. в разделе Установка значения свойства экземпляра.
...
ms.locfileid: "120097324"
---
# <a name="creating-an-instance-using-mof"></a>Создание экземпляра с помощью MOF

вы можете объявить базовый экземпляр класса в службе управления Windows, используя MOF-файл (MOF). Можно также переопределить значения по умолчанию для экземпляра. Дополнительные сведения см. в разделе [Установка значения свойства экземпляра](#setting-an-instance-property-value).
