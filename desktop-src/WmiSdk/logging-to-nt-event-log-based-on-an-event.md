...
Класс [**нтевентложевентконсумер**](nteventlogeventconsumer.md) записывает сообщение в журнал событий Windows при наступлении указанного события. Этот класс является стандартным потребителем событий, предоставляемым инструментарием WMI.
...
**Создание объекта-получателя события, записывающего данные в журнал событий Windows**
