...
---
# <a name="example-monitoring-multiple-event-queries-simultaneously"></a>Пример. одновременное отслеживание нескольких запросов событий

В следующем примере скрипта показано Асинхронное уведомление о событии, использующее метод [**SWbemServices.Exeкнотификатионкуерясинк**](swbemservices-execnotificationqueryasync.md) и объект [**свбемсинк**](swbemsink.md) .
