...
КОМПОНЕНТА компонент операционной системы Windows, позволяющий пользователям шифровать файлы и папки на диске NTFS, чтобы защитить их от несанкционированного доступа.
...
Пара, состоящая из открытого и закрытого ключей, которая используется для шифрования сеансовых ключей с целью безопасного хранения этих ключей и обмена ими с другими пользователями. пары ключей Exchange создаются путем вызова функции **криптженкэй** .
