...
Это предложение определяет такой тег для кодирования цветов пользовательского интерфейса Windows, определенных в файле заголовка Winuser. h.
...
1.  WMF — метафайл Windows (формат Win 3,1)
2.  EMF — метафайл Windows "Расширенный" (формат Win32)
3.  PICT — Mac OS Куиккдрав PICT File (все версии, но без записей QuickTime или других расширений)
4.  BMP — формат файла точечного рисунка Windows, форматы "OS/2" (БИТМАПКОРЕ), БИТМАПИНФО, BITMAPV4 и BITMAPV5
