---
description: Если это свойство имеет значение true, устройство является общим устройством.
...
Если это свойство имеет значение true, устройство является общим устройством.
