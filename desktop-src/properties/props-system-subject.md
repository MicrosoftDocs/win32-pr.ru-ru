---
description: Тема документа. Это свойство сопоставляется с темой свойства документа OLE.
...
ms.locfileid: "104156891"
---
# <a name="systemsubject"></a>System. subject

Тема документа. Это свойство сопоставляется с *темой* свойства документа OLE.
