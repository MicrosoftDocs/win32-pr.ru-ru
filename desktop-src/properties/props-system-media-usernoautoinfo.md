---
description: Если значение — true, не изменяйте метаданные этого файла. Устанавливается пользователем.
...
Если значение — true, не изменяйте метаданные этого файла. Устанавливается пользователем.
