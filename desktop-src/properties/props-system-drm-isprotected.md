---
description: Указывает, защищен ли файл с помощью цифрового Rights Management (DRM).
ms.assetid: 50b3ada0-bdf7-4c61-8cfc-17fbb4a7d1e6
title: System. DRM. для защиты
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105683316"
---
# <a name="systemdrmisprotected"></a>System. DRM. для защиты

Указывает, защищен ли файл с помощью цифрового Rights Management (DRM).
