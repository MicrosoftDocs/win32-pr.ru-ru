...
---
# <a name="systemshellsfgaoflagsstrings"></a>System. Shell. Сфгаофлагсстрингс

Выражает флаги СФГАО как строковые значения и используется в качестве оптимизации запроса.
