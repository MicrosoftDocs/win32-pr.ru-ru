---
description: Имя пространства имен оболочки элемента относительно родительской папки.
...
Имя пространства имен оболочки элемента относительно родительской папки.
