---
description: Если это свойство имеет значение true, устройство является устройством по умолчанию.
...
ms.locfileid: "120059454"
---
# <a name="systemdevicesisdefault"></a>System.Devices.IsDefault

Если это свойство имеет значение true, устройство является устройством по умолчанию.
