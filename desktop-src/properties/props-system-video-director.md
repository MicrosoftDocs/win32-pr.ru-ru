---
description: Указывает пользователя, который направляет видео.
ms.assetid: dd992d16-bd12-49e6-843b-f4a30aab33b6
title: System. Video. режиссер
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105712311"
---
# <a name="systemvideodirector"></a>System. Video. режиссер

Указывает пользователя, который направляет видео.
