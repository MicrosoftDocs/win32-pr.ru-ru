---
description: Если \_ значение — true, установщик устройства в настоящее время устанавливает программное обеспечение.
...
Если \_ значение — true, установщик устройства в настоящее время устанавливает программное обеспечение.
