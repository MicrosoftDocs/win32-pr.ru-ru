---
description: Прочитайте о свойстве System. Пропграуп. GPS. Не используйте это свойство для получения или задания значений. Он предназначен только в качестве маркера.
