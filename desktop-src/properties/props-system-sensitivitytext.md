---
description: Понятная пользователю форма System. чувствительность. Это значение не предназначено для синтаксического анализа программным способом.
...
Понятная пользователю форма [System. чувствительность](./props-system-sensitivity.md). Это значение не предназначено для синтаксического анализа программным способом.
