---
description: Список типов содержимого в элементе.
...
Список типов содержимого в элементе. Это значение представлено в виде векторного массива GUID, где каждый GUID представляет определенный тип, например URL-адреса или вложения.
