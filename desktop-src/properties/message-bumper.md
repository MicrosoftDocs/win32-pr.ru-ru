...
| [System. Message. flags](./props-system-message-flags.md)<br/>                           | Флаги, связанные с сообщениями электронной почты (например, ожидается уведомление о прочтении). Значения, сохраненные здесь Outlook, определяются для \_ \_ флагов сообщений PR.<br/> |
