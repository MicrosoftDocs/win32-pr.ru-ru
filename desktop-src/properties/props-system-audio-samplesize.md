---
description: Указывает размер образца для звукового файла в битах на выборку.
...
ms.locfileid: "105692751"
---
# <a name="systemaudiosamplesize"></a>System. Audio. SampleSize

Указывает размер образца для звукового файла в битах на выборку.
