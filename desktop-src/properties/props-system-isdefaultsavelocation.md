...
---
# <a name="systemisdefaultsavelocation"></a>System. Исдефаултсавелокатион

Определяет расположение для сохранения библиотеки по умолчанию для владельца библиотеки.
