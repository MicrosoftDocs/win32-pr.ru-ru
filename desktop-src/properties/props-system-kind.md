...
Сопоставляет расширения с различными. Папки поиска.
...
Расширения сопоставляются со значениями вида в реестре по адресу:
...
Список значений типа не является расширяемым.
