---
description: 'Значения СФГАО, используемые в Ишеллфолдер:: Жетаттрибутесоф.'
...
Значения [**сфгао**](../shell/sfgao.md) , используемые в [**Ишеллфолдер:: жетаттрибутесоф**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-ishellfolder-getattributesof).
