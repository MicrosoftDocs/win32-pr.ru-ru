...
ms.locfileid: "120059844"
---
# <a name="systemcalendarshowtimeas"></a>System. Calendar. Шовтимеас

Указывает состояние участника во время события. Пользователь может выбрать состояние "свободен", "занят", "под вопросом" или "вне офиса".
