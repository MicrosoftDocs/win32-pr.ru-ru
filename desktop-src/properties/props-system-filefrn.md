...
---
# <a name="systemfilefrn"></a>System. Филефрн

Уникальный идентификатор файла, также известный как номер ссылки на файл. Для данного файла это то же значение, что **и член** [**ID файла с \_ идентификатором « \_ \_ dir \_ info**](/windows/win32/api/winbase/ns-winbase-file_id_both_dir_info) », полученным при вызове [**жетфилеинформатионбихандликс**](/windows/win32/api/winbase/nf-winbase-getfileinformationbyhandleex).
