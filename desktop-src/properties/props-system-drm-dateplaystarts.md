---
description: Указывает, что начинаются права воспроизведения.
ms.assetid: a5d67f83-ac2c-4d6c-b370-654943670125
title: System. DRM. Датеплайстартс
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104347435"
---
# <a name="systemdrmdateplaystarts"></a>System. DRM. Датеплайстартс

Указывает, что начинаются права воспроизведения.
