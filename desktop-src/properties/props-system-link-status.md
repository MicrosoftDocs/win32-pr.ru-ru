...
ms.locfileid: "117683567"
---
# <a name="systemlinkstatus"></a>System. Link. status

Указывает, проверяется ли путь ссылки в [System. Link. таржетпарсингпас](./props-system-link-targetparsingpath.md) . Эти значения определены.
