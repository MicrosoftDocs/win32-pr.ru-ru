---
description: Указывает число пикселей на единицу разрешения в высоте изображения.
ms.assetid: 51d71fa6-8057-46b6-8427-187a5e69f1f4
title: System. Image. Вертикалресолутион
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119553844"
---
# <a name="systemimageverticalresolution"></a>System. Image. Вертикалресолутион

Указывает число пикселей на единицу разрешения в высоте изображения.
