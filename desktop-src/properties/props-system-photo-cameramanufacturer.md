---
description: Имя производителя камеры, которая заняла фотографию, в строковом формате.
...
Имя производителя камеры, которая заняла фотографию, в строковом формате.
