---
description: Используется для получения IBindCtx для элемента, который необходимо проанализировать.
...
Используется для получения [**IBindCtx**](/windows/win32/api/objidl/nn-objidl-ibindctx) для элемента, который необходимо проанализировать.
