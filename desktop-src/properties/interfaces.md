...
| [**ипропертидескриптионсеарчинфо**](/windows/win32/api/propsys/nn-propsys-ipropertydescriptionsearchinfo)                   | Предоставляет сведения, связанные с поиском для свойства. Сведения, предоставляемые этим интерфейсом, берутся из схемы [пропертидескриптион](./propdesc-schema-propertydescription.md) , элемента [сеарчинфо](./propdesc-schema-searchinfo.md) для данного свойства. Эта информация используется индексатором поиска Windows. Большинству вызывающих приложений не требуется вызывать этот интерфейс. |
