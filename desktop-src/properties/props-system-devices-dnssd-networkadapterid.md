---
description: Идентификатор GUID для сетевого адаптера, в котором будет осуществляться поиск службы.
...
Идентификатор GUID для сетевого адаптера, в котором будет осуществляться поиск службы.
