---
description: Состояние парных устройств. Значение true указывает, что устройство не связано с компьютером.
...
ms.locfileid: "104264291"
---
# <a name="systemdevicespaired"></a>System.Devices.Paired

Состояние парных устройств. Значение true указывает, что устройство не связано с компьютером.
