---
description: Содержимое структуры ШДЕСКРИПТИОНИД, представленной в виде буфера байтов.
ms.assetid: 985aebfe-7496-4d88-9e9c-c766969949b8
title: System. Дескриптионид
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105702328"
---
# <a name="systemdescriptionid"></a>System. Дескриптионид

Содержимое структуры [**шдескриптионид**](/windows/win32/api/shlobj_core/ns-shlobj_core-shdescriptionid) , представленной в виде буфера байтов.
