...
NULL указывает на нормальный случай (файл доступен в автономном режиме). Частичный вариант относится только к папкам, в которых некоторое содержимое может быть доступно в автономном режиме, а некоторые — нет.
...
## <a name="windows-10-version-1607-windows-10-version-1511-windows-10-version-1507-windows-81"></a>Windows 10, версия 1607, Windows 10, версия 1511, Windows 10, версия 1507, Windows 8.1
