---
description: Логическое значение, указывающее, является ли том корневым томом.
ms.assetid: 995b0f92-686b-40fb-aed0-5fd500c226f0
title: System. Volume. в корне
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119095331"
---
# <a name="systemvolumeisroot"></a>System. Volume. в корне

Логическое значение, указывающее, является ли том корневым томом.
