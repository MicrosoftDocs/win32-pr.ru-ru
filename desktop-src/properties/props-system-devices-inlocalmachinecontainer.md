---
description: Устройство находится в контейнере локальных компьютеров.
ms.assetid: 95b92f2a-614b-4fb1-b98e-6984de0a8377
title: System. Devices. Инлокалмачинеконтаинер
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118467636"
---
# <a name="systemdevicesinlocalmachinecontainer"></a>System. Devices. Инлокалмачинеконтаинер

Устройство находится в контейнере локальных компьютеров.
