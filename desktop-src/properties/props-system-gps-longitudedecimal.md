---
description: Указывает долготу, основанную на ссылке в подсписке PKEY \_ GPS \_ лонгитудереф. Вычисляется от PKEY \_ GPS \_ ЛОНГИТУДЕНУМЕРАТОР и PKEY \_ GPS \_ лонгитудеденоминатор.
ms.assetid: 3b5b421f-efdc-4a23-a6dd-58a4fe80431a
title: System. GPS. ЛонгитудедеЦимал
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118466510"
---
# <a name="systemgpslongitudedecimal"></a>System. GPS. ЛонгитудедеЦимал

Указывает долготу, основанную на ссылке в подсписке PKEY \_ GPS \_ лонгитудереф. Вычисляется от PKEY \_ GPS \_ ЛОНГИТУДЕНУМЕРАТОР и PKEY \_ GPS \_ лонгитудеденоминатор
