...
После оценки стратегии свойств необходимо определить, какие свойства должны отображаться в пользовательском интерфейсе проводника Windows и где. Существуют различные расположения, где свойства отображаются в режиме только для чтения. Изменение свойства, с другой стороны, включено только в диалоговом окне **Свойства** . Это диалоговое окно можно вызвать с помощью ссылки **изменить свойства** в **области просмотра** или в контекстном меню элемента.
