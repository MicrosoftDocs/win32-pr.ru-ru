---
description: Список свойств, отображаемых в подсказке, когда элемент находится в сети с высокой назначением.
...
ms.locfileid: "103909203"
---
# <a name="systemproplistquicktip"></a>System. Проплист. Куикктип

Список свойств, отображаемых в подсказке, когда элемент находится в сети с высокой назначением. Свойства с пустыми значениями не будут отображаться. Зарегистрируйтесь в регвалуе "Куикктип".
