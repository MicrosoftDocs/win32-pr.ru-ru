...
ms.locfileid: "120091214"
---
# <a name="systemgpslatitude"></a>System. GPS. Широта

Указывает широту. Это массив из трех значений, как показано ниже: индекс 0 — это градусы, индекс 1 — минуты, индекс 2 — секунды. Каждый из них вычисляется на основе значений в списке PKEY \_ GPS \_ ЛАТИТУДЕНУМЕРАТОР и PKEY \_ GPS \_ латитудеденоминатор.
