...
В новых функциях Windows Vista и более поздних версий требуется, чтобы существующая система свойств оболочки была расширена до:
