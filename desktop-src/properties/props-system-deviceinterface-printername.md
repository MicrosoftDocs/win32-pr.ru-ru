...
title: System. Девицеинтерфаце. Принтернаме
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119946454"
---
# <a name="systemdeviceinterfaceprintername"></a>System. Девицеинтерфаце. Принтернаме
...
```
propertyDescription
   name = System.DeviceInterface.PrinterName
   shellPKey = PKEY_DeviceInterface_PrinterName
   formatID = 0A7B84EF-0C27-463F-84EF-06C5070001BE
   propID = 10
   SearchInfo
