...
ms.locfileid: "119774534"
---
# <a name="systemsearchcontents"></a>System. Search. contents

Содержимое элемента. Это свойство предназначено только для ограничений запросов; его невозможно получить в результате запроса. Понятное имя службы индексирования — Content.
