---
description: Идентификатор поставщика из дескриптора USB-устройства USB-устройства.
...
Идентификатор поставщика из дескриптора USB-устройства USB-устройства.
