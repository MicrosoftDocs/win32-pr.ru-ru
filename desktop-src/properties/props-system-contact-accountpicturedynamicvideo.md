---
description: Это поток, содержащий данные, необходимые для отображения изображения учетной записи динамического видео контакта.
...
Это поток, содержащий данные, необходимые для отображения изображения учетной записи динамического видео контакта.
