---
description: Набор ключевых слов (также известных как &\# 0034; tags&\# 0034;) назначается элементу.
...
ms.locfileid: "118231379"
---
# <a name="systemkeywords"></a>System.Keywords

Набор ключевых слов (также известных как "Теги"), назначенный элементу.
