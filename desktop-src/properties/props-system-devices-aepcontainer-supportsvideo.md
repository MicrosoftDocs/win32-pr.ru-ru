---
description: Указывает, поддерживает ли контейнер конечной точки сопоставления устройств приведение видео.
...
ms.locfileid: "119598574"
---
# <a name="systemdevicesaepcontainersupportsvideo"></a>System.Devices.AepContainer.SupportsVideo

Указывает, поддерживает ли контейнер конечной точки сопоставления устройств приведение видео
