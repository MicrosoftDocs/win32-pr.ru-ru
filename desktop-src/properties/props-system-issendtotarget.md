---
description: Указывает, является ли элемент допустимым адресатом SendTo. Эти сведения предоставляются определенными папками оболочки.
ms.assetid: c2b30722-bc02-443b-9bdc-8b6c1c20d354
title: System. Иссендтотаржет
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119822394"
---
# <a name="systemissendtotarget"></a>System. Иссендтотаржет

Указывает, является ли элемент допустимым адресатом SendTo. Эти сведения предоставляются определенными папками оболочки.
