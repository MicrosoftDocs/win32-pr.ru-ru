---
description: Подсказка для состояния по умолчанию.
ms.assetid: 24DA07DD-A2C1-4a3e-9007-100BE6813A02
title: System. Devices. Дефаулттултип
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119885564"
---
# <a name="systemdevicesdefaulttooltip"></a>System. Devices. Дефаулттултип

Подсказка для состояния по умолчанию.
