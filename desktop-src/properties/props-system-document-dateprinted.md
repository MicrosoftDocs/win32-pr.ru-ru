---
description: Указывает дату и время последней печати документа. Имя прежних версий — &\# 0034; докластпринтед&\# 0034;.
...
Указывает дату и время последней печати документа. Имя прежних версий — "Докластпринтед".
