...
ms.locfileid: "119662304"
---
# <a name="systemcapacity"></a>System. Capacity

Общий объем дискового пространства, выраженный в байтах. Это свойство в основном используется для указания емкости носителей хранилища, таких как жесткие диски.
