---
description: Понятная пользователю форма System. Contact. Жендервалуе.
...
ms.locfileid: "104265335"
---
# <a name="systemcontactgender"></a>System. Contact. gender

Понятная пользователю форма [System. Contact. жендервалуе](./props-system-contact-gendervalue.md).
