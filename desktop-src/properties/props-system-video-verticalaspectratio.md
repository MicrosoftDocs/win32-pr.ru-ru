---
description: 'Указывает горизонтальную часть пропорций в пикселях. Часть Y в XX: YY. Например, 11 — часть Y 10:11.'
...
Указывает горизонтальную часть пропорций в пикселях. Часть Y в XX: YY. Например, 11 — часть Y 10:11.
