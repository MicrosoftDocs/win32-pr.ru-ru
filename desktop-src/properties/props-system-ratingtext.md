---
description: Понятная пользователю форма System. рейтингов. Это значение не предназначено для синтаксического анализа программным способом.
...
Понятная пользователю форма [System. рейтингов](./props-system-rating.md). Это значение не предназначено для синтаксического анализа программным способом.
