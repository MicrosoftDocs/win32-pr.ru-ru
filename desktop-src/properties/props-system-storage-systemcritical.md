---
description: Указывает, является ли носитель хранилища критически важным для системы.
...
Указывает, является ли носитель хранилища критически важным для системы.
