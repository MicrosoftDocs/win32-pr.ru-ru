...
ms.locfileid: "118229979"
---
# <a name="systemphotoexposureprogram"></a>System. photo. Експосурепрограм

Режим программы экспозиции камеры на момент съемки, считанный из данных файла изображения (EXIF).
