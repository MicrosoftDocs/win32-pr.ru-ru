---
description: Хранилище (также называемое обработчиком протокола), MAIL, АУТЛУКЕКСПРЕСС.
...
ms.locfileid: "118230673"
---
# <a name="systemmessagestore"></a>System.Message.Store

Хранилище (также называемое обработчиком протокола), MAIL, АУТЛУКЕКСПРЕСС.
