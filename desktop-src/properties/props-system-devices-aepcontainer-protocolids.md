---
description: Список идентификаторов протоколов, которые участвовали в создании контейнера конечной точки сопоставления устройств.
...
ms.locfileid: "105702488"
---
# <a name="systemdevicesaepcontainerprotocolids"></a>System.Devices.AepContainer.ProtocolIds

Список идентификаторов протоколов, которые участвовали в создании контейнера конечной точки сопоставления устройств
