---
description: Указывает скорость передачи данных в &\# 0034; бит в секунду&\# 0034; для потока видео. &\#0034. скорость&\# 0034;.
...
Указывает скорость передачи данных в "битах в секунду" для видеопотока. "Rate".
