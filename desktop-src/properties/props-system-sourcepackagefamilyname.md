---
description: Имя семейства пакетов для приложения, в котором был создан экземпляр элемента хранилища.
...
Имя семейства пакетов для приложения, в котором был создан экземпляр элемента хранилища.
