...
-   При доступе к файлам в проводнике Windows с целью чтения и записи значений свойств. Это выполняется в процессе.
