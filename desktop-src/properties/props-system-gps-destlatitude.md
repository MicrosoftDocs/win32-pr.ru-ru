...
---
# <a name="systemgpsdestlatitude"></a>System. GPS. Дестлатитуде

Указывает широту точки назначения. Это массив из трех значений, как показано ниже: индекс 0 — это градусы, индекс 1 — минуты, индекс 2 — секунды. Каждый из них вычисляется на основе значений в списке PKEY \_ GPS \_ ДЕСТЛАТИТУДЕНУМЕРАТОР и PKEY \_ GPS \_ дестлатитудеденоминатор.
