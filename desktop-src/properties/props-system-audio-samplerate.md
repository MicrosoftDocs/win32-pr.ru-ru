---
description: Указывает частоту дискретизации для звукового файла в примерах в секунду.
...
ms.locfileid: "103812545"
---
# <a name="systemaudiosamplerate"></a>System. Audio. SampleRate

Указывает частоту дискретизации для звукового файла в примерах в секунду.
