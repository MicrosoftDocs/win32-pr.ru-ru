---
description: Идентификатор безопасности пользователя, владеющего библиотекой.
...
ms.locfileid: "105711842"
---
# <a name="systemownersid"></a>System. OwnerSID

Идентификатор безопасности пользователя, владеющего библиотекой.
