---
description: Список свойств, отображаемых в диалоговом окне подтверждения операции с файлом.
...
Список свойств, отображаемых в диалоговом окне подтверждения операции с файлом. Свойства с пустыми значениями не будут отображаться. Если этот список не указан, вместо него используется список свойств подсказки. Зарегистрируйтесь в регвалуе "Филеоператионпромпт".
