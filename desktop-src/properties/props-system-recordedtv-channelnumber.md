---
description: Записанные ТЕЛЕВИЗИОНные каналы. Например, 42, 5, 53.
ms.assetid: daa738a0-b4db-4b8d-bd88-6ae66c10f7d1
title: System. Рекордедтв. Чаннелнумбер
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104080697"
---
# <a name="systemrecordedtvchannelnumber"></a>System. Рекордедтв. Чаннелнумбер

Записанные ТЕЛЕВИЗИОНные каналы. Например, 42, 5, 53.
