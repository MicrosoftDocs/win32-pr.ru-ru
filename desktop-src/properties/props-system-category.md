---
description: Не рекомендуется. Категория, которую можно назначить элементу, например документу или файлу.
...
ms.locfileid: "104423846"
---
# <a name="systemcategory"></a>System. Category

Не рекомендуется. Категория, которую можно назначить элементу, например документу или файлу. Это свойство наследуется из свойств документа OLE и является устаревшим для Windows Vista. Вместо этого следует использовать ключевые слова. Более старый код рассматривает это свойство как VT \_ LPSTR.
