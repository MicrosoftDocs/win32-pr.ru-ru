---
description: Определяет, является ли расположение или библиотека только поиском.
ms.assetid: a731ff53-65c2-4d31-adae-861e1fde26a2
title: System. Иссеарчонлитем
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119716534"
---
# <a name="systemissearchonlyitem"></a>System. Иссеарчонлитем

Определяет, является ли расположение или библиотека только поиском.
