...
Диспетчер области обхода содержимого (CSM) позволяет определять правила области, включающие или исключающие URL-адреса из области обхода для поиска Windows.
...
2.  Пользовательские правила задаются пользователями, изменяющими область в пользовательском интерфейсе параметров поиска Windows. Пользователи или другие приложения могут удалить все правила пользователя и вернуться к правилам по умолчанию.
