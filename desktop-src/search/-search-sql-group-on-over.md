...
Столбец GROUP ON &lt; &gt; может быть обычным или [идентификатором](-search-sql-identifiers.md) с разделителями для свойства в хранилище свойств.
...
| Пример ( &lt; &gt; \[ диапазоны групп столбцов \] )        | Результат                                                                                                                                                                                                                                                                         |
|--------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
