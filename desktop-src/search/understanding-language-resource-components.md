...
В следующей таблице перечислены действия и соответствующие результаты для предложения «рис. 1 иллюстрирует роль языковых ресурсов для поиска Windows во время создания индекса».
