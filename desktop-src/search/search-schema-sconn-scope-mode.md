---
description: '&lt;Элемент Mode &gt; указывает, следует ли включать или исключать URL-адрес из области соединителя поиска. Допустимые значения: include и Exclude. Этот элемент не имеет дочерних элементов и не имеет атрибутов.'
...
ms.locfileid: "122886751"
---
# <a name="mode-element-search-connector-schema"></a>Элемент Mode (схема соединителя поиска)

&lt;Элемент Mode &gt; указывает, следует ли включать или исключать URL-адрес из области соединителя поиска. Допустимые значения: `Include` и `Exclude`. Этот элемент не имеет дочерних элементов и не имеет атрибутов.
