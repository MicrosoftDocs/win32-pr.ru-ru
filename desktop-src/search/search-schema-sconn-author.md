---
description: Необязательный &lt; &gt; элемент Author указывает автора библиотеки. Этот элемент не имеет дочерних элементов и не имеет атрибутов.
...
ms.locfileid: "122887423"
---
# <a name="author-element-search-connector-schema"></a>Элемент Author (схема соединителя поиска)

Необязательный &lt; &gt; элемент Author указывает автора библиотеки. Этот элемент не имеет дочерних элементов и не имеет атрибутов.
