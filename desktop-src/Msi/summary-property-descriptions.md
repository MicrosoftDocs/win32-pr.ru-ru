...
<tbody>
<tr class="odd">
<td><a href="title-summary.md"><strong>Титуль</strong></a></td>
...
<tr class="even">
<td><a href="subject-summary.md"><strong>Тема</strong></a></td>
...
|---------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Титуль**](title-summary.md)                                | Описание этого файла в виде преобразования. Описание должно включать фразу "[Преобразование](database-transforms.md)".                                                                                                                                                                     |
| [**Тема**](subject-summary.md)                            | Имя продукта, установленного исходным пакетом установки. Это должно быть то же значение, что и свойство [**сводки субъекта**](subject-summary.md) в исходном пакете установки.                                                                                            |
