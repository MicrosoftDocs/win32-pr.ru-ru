...
title: Windows Рекомендации по использованию установщика
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119808964"
---
# <a name="windows-installer-best-practices"></a>Windows Рекомендации по использованию установщика
...
-   [соблюдение требований к сертификации Windowsных логотипов.](#meet-the-windows-logo-certification-requirements)
...
-   используйте установщик Windows 5,0 на Windows Server 2008 R2 и Windows 7. это установщик Windows версия, предоставляемая операционной системой.
-   используйте установщик Windows 4,5 на Windows Server 2008, Windows server 2003 с пакетом обновления 1 (sp1), Windows Vista с пакетом обновления 1 (sp1) или Windows XP с пакетом обновления 2 (sp2). сведения о получении последней версии установщик Windows см. в разделе [установщик Windows распространяемые пакеты](windows-installer-redistributables.md).
-   используйте установщик Windows 3,1 в Windows 2000 с пакетом обновления 3 (sp3). Windows В установщике версии 3,1 есть функции, упрощающие обслуживание приложений и [установку исправлений](patching.md).
...
-   список функций установщик Windows, не поддерживаемых более ранними версиями Windows Installer, см. в статье [новые возможности в установщик Windows](what-s-new-in-windows-installer.md).

## <a name="meet-the-windows-logo-certification-requirements"></a>соблюдение требований к сертификации Windowsных логотипов.
...
-   Возможность создания пакета из текстовых файлов может быть более интуитивно понятной для некоторых разработчиков. набор средств установщик Windows XML (WiX), доступный в сборках [Sourceforge.net](https://sourceforge.net/projects/wix) , Windows пакеты установки из исходного кода XML.
...
-   Сжимать файлы в установке и сохранять их в CAB-файл (.cab). Установщик позволяет хранить файл .cab в виде отдельного внешнего файла или в виде потока данных в самом пакете MSI. Дополнительные сведения см. [в разделе Использование ящиков и сжатых источников](using-cabinets-and-compressed-sources.md).
-   Удалите неиспользуемое дисковое пространство в файле .msi, используя один из параметров, описанных в разделе [уменьшение размера файла .msi](reducing-the-size-of-an--msi-file.md).
...
-   Храните исходные файлы пакета в расположении, которое не является временной папкой системы. Windows Исходные файлы установщика, хранящиеся во временной папке, могут стать недоступными для пользователей.
