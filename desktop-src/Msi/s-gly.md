...
[A](a-gly.md) [B](b-gly.md) [C](c-gly.md) [D](d-gly.md) [E](e-gly.md) [F](f-gly.md) [G](g-gly.md) р [. J K](i-gly.md) L [M](m-gly.md) N [O](o-gly.md) [P](p-gly.md) [Q](q-gly.md) [R](r-gly.md) S [T](t-gly.md) [U](u-gly.md) [V](v-gly.md) W X Y Z

<dl> <dt>

<span id="_msi_sequence_tables_gly"></span><span id="_MSI_SEQUENCE_TABLES_GLY"></span>**таблицы последовательности**
</dt> <dd>

Таблицы в [*базе данных установщика*](i-gly.md) , в которых перечислены действия последовательно. Дополнительные сведения см. в разделе [Использование таблицы последовательностей](using-a-sequence-table.md).

</dd> <dt>

<span id="_msi_source_list_gly"></span><span id="_MSI_SOURCE_LIST_GLY"></span>**исходный список**
</dt> <dd>

Указывает расположения, в которых установщик должен выполнять поиск [*внешних исходных файлов*](e-gly.md).
...
<span id="_msi_standard_user_gly"></span><span id="_MSI_STANDARD_USER_GLY"></span>**Стандартный пользователь**
</dt> <dd>
...
<span id="_msi_synchronous_execution_gly"></span><span id="_MSI_SYNCHRONOUS_EXECUTION_GLY"></span>**синхронное выполнение**
</dt> <dd>

Когда установщик ожидает завершения отдельного потока настраиваемого действия, прежде чем продолжить поток текущей установки. Дополнительные сведения см. в разделе [синхронные и асинхронные настраиваемые действия](synchronous-and-asynchronous-custom-actions.md) .
