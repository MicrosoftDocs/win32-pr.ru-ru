...
|------------------------|------------------------------|-----|----------|
| Сочетание клавиш               | [Идентификатор](identifier.md) | Д   | Нет        |
...
| Сочетание клавиш                 | [Integer](integer.md)       | Нет   | Д        |
| Значок\_                 | [Идентификатор](identifier.md) | Нет   | Д        |
| икониндекс              | [Integer](integer.md)       | Нет   | Д        |
| шовкмд                | [Integer](integer.md)       | Нет   | Д        |
| вкдир                  | [Идентификатор](identifier.md) | Нет   | Д        |
| дисплайресаурцедлл     | [Формате](formatted.md)   | Нет   | Д        |
| дисплайресаурцеид      | [Integer](integer.md)       | Нет   | Д        |
| дескриптионресаурцедлл | [Формате](formatted.md)   | Нет   | Д        |
| дескриптионресаурцеид  | [Integer](integer.md)       | Нет   | Д        |
...
Можно использовать следующие значения. значения задаются в соответствии с определением функции Windows API ShowWindow.
...
этот столбец ярлыка используется только при запуске в Windows Vista или Windows Server 2008, и в противном случае игнорируется. этот столбец доступен в версиях, предшествующих установщик Windows 4,0.
