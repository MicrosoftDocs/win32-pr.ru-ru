---
description: двоичные данные не могут быть вставлены в таблицу непосредственно с помощью запросов INSERT или UPDATE SQL.
...
ms.locfileid: "119996954"
---
# <a name="adding-binary-data-to-a-table-using-sql"></a>Добавление двоичных данных в таблицу с помощью SQL

двоичные данные не могут быть вставлены в таблицу непосредственно с помощью запросов INSERT или UPDATE SQL. Чтобы добавить двоичные данные в таблицу, необходимо сначала использовать маркер параметра (?) в запросе в качестве заполнителя для двоичного значения. Выполнение запроса должно включать запись, содержащую двоичные данные в одном из полей.

Маркер — это ссылка на параметр для значения, предоставленного в записи, отправленной с помощью запроса. он представлен в операторе SQL вопросительным знаком (?).
...
[примеры запросов к базе данных с помощью SQL и сценария](examples-of-database-queries-using-sql-and-script.md)
</dt> </dl>
