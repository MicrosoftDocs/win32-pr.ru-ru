...
| [**Тема**](subject-summary.md)                           | MNP2000                                                                          | Браузеры файлов могут отображать этот файл как продукт, устанавливаемый вместе с этой базой данных.                                  |
...
**Msiinfo.exe MNP2000.msi-T "база данных установки"-J Subject — установщик "Microsoft Corporation"-K ", MSI, база данных"-O ". эта база данных установщика содержит логику и данные, необходимые для установки Блокнот."-P; 1033-V {4966AEC4-3C59-4B07-9B98-1B6A7103C0D3}-G 200-W 0-N Orca-U 0**
