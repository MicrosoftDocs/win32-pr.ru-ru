...
Необходимо создать модули слияния на нескольких языках, преобразования языка и CAB-файлы, чтобы порядок файлов в CAB-файле совпадал с порядком установки файлов, указанных в [таблице File](file-table.md), даже после применения преобразования языка. Если порядок в модуле и в CAB-файле не совпадают, то модуль слияния использовать нельзя.
