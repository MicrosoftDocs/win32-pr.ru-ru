...
| Атрибуты | i4   |     | Да        | Атрибуты для учетной записи. Они определены как значения **типа DWORD** для \_ элемента flags USRI1 в \_ структуре пользователя \_ 1.                                                                                                                                                                              |
...
| кустомусераккаунтс | Атрибуты | Да        | 0        | 2147483647 |          |           | null                         |     |             |
