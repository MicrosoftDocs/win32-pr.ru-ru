---
description: Свойство «значение» возвращает идентификатор безопасности пользователя (SID), в котором доступен этот экземпляр продукта.
ms.assetid: b4e24961-4a0a-478c-be66-9862d40b75a3
title: Свойство Product. ведение
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105675975"
---
# <a name="productusersid-property"></a>Свойство Product. ведение

Свойство **«значение»** возвращает идентификатор безопасности пользователя (SID), в котором доступен этот экземпляр продукта.
