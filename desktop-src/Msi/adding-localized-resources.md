...
Пакет для французского языка устанавливает Readme.txt в каталог на французском языке, чтобы имя файла не конфликтовали с английской версией. Файл Readme.txt устанавливается вместе с компонентом «Блокнот», но правила компонентов не нуждаются в изменении кода компонента. В этом примере не следует изменять код компонента блокнота, поскольку RedPark.exe, значения реестра, указанные в [таблице реестра](registry-table.md), являются общими для обеих версий языка. См. [раздел Добавление данных реестра](adding-registry-information.md).
...
|-------------|------------------------------|----------------------------------|--------------------------------------------------------|
| Redpark.exe | Исполняемый файл текстового редактора. | В. \\ пример \\ блокнота \\Redpark.exe | \[ProgramFilesFolder \] \\ Red \_ парковки \\ французский \\Redpark.exe |
| Readme.txt  | Информационный файл.       | В. \\ пример \\ блокнота \\Readme.txt  | \[ProgramFilesFolder \] \\ Red \_ парковки \\ французский \\Readme.txt  |
| Help.txt    | Помощь в руководстве                  | В. \\ пример \\ блокнота \\Help.txt    | \[ProgramFilesFolder \] \\ Red \_ парковки \\ французский \\Help.txt    |
| Fre.txt     | Список телефона                   | В. \\ пример \\ блокнота \\Fre.txt     | \[ProgramFilesFolder \] \\ Red \_ парковки \\ французский \\Fre.txt     |
