...
---
# <a name="sample-ice-in-c"></a>Пример ICE в C++

Этот пример кода относится к пользовательскому действию ICE ( [ICE01](ice01.md)). Он проверяет, работает механизм ICE, отображая время. ICE отправляет сообщение, предоставляющее время, которое программа установки вызвала ICE. Эта ICE никогда не должна возвращать ошибку.
