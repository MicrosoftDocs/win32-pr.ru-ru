---
description: Windows Установщик принимает универсальный указатель ресурсов (URL) в качестве допустимого источника для установки.
...
ms.locfileid: "118637771"
---
# <a name="downloading-an-installation-from-the-internet"></a>Загрузка установки из Интернета

Windows Установщик принимает универсальный указатель ресурсов (URL) в качестве допустимого источника для установки. Windows Установщик может устанавливать пакеты, исправления и преобразования из расположения URL-адреса.
...
Для запуска установки из веб-браузера необходимо передать в установщик командную строку, аналогичную показанной ранее. В общем случае не следует загружать и устанавливать пакет, просто дважды щелкнув файл .msi в браузере. Файл .msi будет скачан в папку Temporary Internet Files и в установщик будет передана следующая команда:

**msiexec/i c: \\ \\ временные файлы интернета Windows \\package.msi**

Установка завершается сбоем, если пакету требуются внешние исходные файлы или ящики, так как они находятся не в том же расположении, что и файл .msi.
...
Windows Установщик версии 2,0 может использовать протоколы HTTP, FILE и FTP и не может использовать протоколы HTTPS и GOPHER.
