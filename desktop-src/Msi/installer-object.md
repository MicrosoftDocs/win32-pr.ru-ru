...
| [**Размер файла**](installer-filesize.md)                                   | Возвращает размер указанного файла.<br/>                                                                                                                                              |
...
| [**Компоненты**](installer-features.md)<br/>                           |                       | Возвращает объект [**стринглист**](stringlist-object.md) , перечисляющий набор опубликованных компонентов для указанного продукта.<br/>                                                                                                               |
...
| [**Продукты**](installer-products.md)<br/>                           |                       | Возвращает объект [**стринглист**](stringlist-object.md) , перечисляющий набор всех продуктов, установленных или объявленных для текущего пользователя и компьютера. <br/>                                                                                     |
