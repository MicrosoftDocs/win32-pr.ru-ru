...
|----------------|------------------------------|-----|----------|
| ServiceControl | [Идентификатор](identifier.md) | Да   | N        |
| Имя           | [Формате](formatted.md)   | Нет   | N        |
| Событие          | [Integer](integer.md)       | Нет   | N        |
| Аргументы      | [Формате](formatted.md)   | N   | Да        |
