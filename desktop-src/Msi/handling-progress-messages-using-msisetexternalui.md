...
ms.locfileid: "120044224"
---
# <a name="handling-progress-messages-using-msisetexternalui"></a>Обработка сообщений о ходе выполнения с помощью Мсисетекстерналуи

в следующем примере показано, как кодировать простой обработчик обратного вызова для получения установщик Windows сообщений о ходе установки.

> [!Note]  
> При использовании [**мсисетекстерналуи**](/windows/desktop/api/Msi/nf-msi-msisetexternaluia) с типом сообщений инсталлмессаже \_ филесинусе сообщение, отправленное в функцию внешнего обработчика пользовательского интерфейса, не содержит никаких сведений о файлах, используемых или в заголовках окон, которые используются в диалоговом окне " [филесинусе](filesinuse-dialog.md) ". Для получения сведений следует использовать [**мсисетекстерналуирекорд**](/windows/desktop/api/Msi/nf-msi-msisetexternaluirecord) .
