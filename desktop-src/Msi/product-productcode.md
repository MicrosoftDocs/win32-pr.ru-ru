---
description: Свойство ProductCode объекта Product возвращает идентификатор ProductCode идентификатора продукта.
ms.assetid: f8edbaf3-1694-4049-8cbd-ded03bd5c336
title: Product. ProductCode, свойство
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "105651695"
---
# <a name="productproductcode-property"></a>Product. ProductCode, свойство

Свойство **ProductCode** объекта [**Product**](product-object.md) возвращает идентификатор [**ProductCode**](productcode.md) идентификатора продукта.
