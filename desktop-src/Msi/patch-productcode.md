---
description: Свойство ProductCode объекта Patch возвращает идентификатор ProductCode идентификатора продукта.
ms.assetid: 11d81bc0-dac6-4135-9b60-31d39c3455da
title: Свойство patch. ProductCode
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118627657"
---
# <a name="patchproductcode-property"></a>Свойство patch. ProductCode

Свойство **ProductCode** объекта [**Patch**](patch-object.md) возвращает идентификатор [**ProductCode**](productcode.md) идентификатора продукта.
