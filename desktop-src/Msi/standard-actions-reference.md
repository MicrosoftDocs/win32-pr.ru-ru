...
| [инсталлсфпкаталогфиле](installsfpcatalogfile-action.md)       | Действие Инсталлсфпкаталогфиле устанавливает каталоги, используемые Windows Me для защиты файлов Windows.                                                                        |
...
| [ремовеинивалуес](removeinivalues-action.md)                   | Удаляет сведения из ini-файла, связанные с компонентом, указанным в таблице Инифиле.                                                                                     |
...
| [SEQUENCE](sequence-action.md)                                 | Выполняет действия в таблице, указанной свойством [**Sequence**](sequence.md) .                                                                                           |
...
| [вритеинивалуес](writeinivalues-action.md)                     | Записывает сведения о ini-файле.                                                                                                                                                 |
