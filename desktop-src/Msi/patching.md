...
Приложение, которое было установлено с помощью Microsoft установщик Windows, может быть обновлено путем переустановки обновленного пакета установки (MSI-файла) или путем применения исправления установщик Windows (MSP-файл) к приложению.
