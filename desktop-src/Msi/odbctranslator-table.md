...
<span id="Translator"></span><span id="translator"></span><span id="TRANSLATOR"></span>Переводчик
</dt> <dd>
...
DLL-файл для перемещения, указанный в столбце Переводчик. Столбец File \_ является внешним ключом в [таблице File](file-table.md). Имя файла, указанное в столбце filename этой записи таблицы файлов, должно быть указано в коротком формате имени файла. Синтаксис СФН \| лфн использовать нельзя.
...
файл DLL установки для транслятора, если он отличается от Переводчик столбца. Столбец File \_ является внешним ключом в [таблице File](file-table.md). Имя файла, указанное в столбце filename этой записи таблицы файлов, должно быть указано в коротком формате имени файла. Синтаксис СФН \| лфн использовать нельзя.
