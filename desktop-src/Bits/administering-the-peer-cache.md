...
description: примечание. начиная с Windows 7, фоновая интеллектуальная служба передачи (BITS) 3,0 модель однорангового кэширования не рекомендуется.
...
ms.locfileid: "119588754"
---
# <a name="administering-the-peer-cache"></a>Администрирование однорангового кэша

> [!Note]  
> начиная с Windows 7, фоновая интеллектуальная служба передачи (BITS) 3,0 модель однорангового кэширования не рекомендуется. Если установлена служба BITS 4,0, то модель однорангового кэширования BITS 3,0 недоступна.
