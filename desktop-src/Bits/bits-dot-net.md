...
Это пример полного набора команд для создания набора справочных файлов. Вам может потребоваться изменить команды на основе Visual Studio и Windows SDK установки и в зависимости от того, какие функции BITS и версии ОС вы используете. 
...
Информация в файлах DLL ссылок будет внедрена в окончательную программу. Вам не нужно поставлять файлы DLL ссылок в вашу программу; Вам нужно просто поставлять. Программы. 
...
В некоторых версиях Windows 10 нельзя напрямую создать объект Ибаккграундкопиманажер BITS с помощью интерфейсов 10,1 или 10,2. Вместо этого необходимо использовать несколько версий справочных файлов DLL Баккграундкопиманажер. Например, можно использовать версию 1,5 для создания объекта Ибаккграундкопиманажер, а затем привести результирующее задание или объекты файлов с помощью версий 10,1 или 10,2.
