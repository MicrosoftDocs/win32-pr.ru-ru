...
Запрашивает корректное завершение работы элемента управления ActiveX удаленный рабочий стол. Корректное завершение работы может включать в себя завершение сеанса службы удаленных рабочих столов пользователя, но не завершает работу сервера узла сеансов удаленный рабочий стол.
