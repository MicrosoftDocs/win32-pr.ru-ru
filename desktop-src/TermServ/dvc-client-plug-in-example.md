...
ms.locfileid: "119285604"
---
# <a name="dvc-client-plug-in-example"></a>Пример подключаемого модуля клиента DVC

В следующем примере кода C++ приведен пример создания подключаемого модуля динамического виртуального канала (DVC) клиента подключение к удаленному рабочему столу (RDC).
