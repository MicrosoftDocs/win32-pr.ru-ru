...
---
# <a name="msrdpclientnotsafeforscripting-class"></a>Класс Мсрдпклиентнотсафефорскриптинг

Клиентский элемент управления Microsoft RDP — версия 2
...
**Мсрдпклиентнотсафефорскриптинг** имеет следующие типы членов:
...
Класс **мсрдпклиентнотсафефорскриптинг** содержит следующие методы.
...
Класс **мсрдпклиентнотсафефорскриптинг** имеет следующие свойства.
...
| CLSID<br/>                    | \_МСРДПКЛИЕНТНОТСАФЕФОРСКРИПТИНГ CLSID определен как 7CACBD7B-0D99-468F-AC33-22E495C0AFE5<br/> |
