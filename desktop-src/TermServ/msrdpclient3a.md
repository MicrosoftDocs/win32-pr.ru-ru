...
---
# <a name="msrdpclient3a-class"></a>Класс MsRdpClient3a

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 4A
...
**MsRdpClient3a** имеет следующие типы членов:
...
Класс **MsRdpClient3a** содержит следующие методы.
...
Класс **MsRdpClient3a** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT3A CLSID определен как 6A6F4B83-45C5-4CA9-BDD9-0D81C12295E4<br/>     |
