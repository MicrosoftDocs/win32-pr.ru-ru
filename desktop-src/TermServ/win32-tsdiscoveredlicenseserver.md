...
Указывает, имеет ли учетная запись, используемая для запуска скрипта или .exe файл, который использует класс **Win32 \_ тсдисковередлиценсесервер** , доступ администратора к серверу лицензирования.
