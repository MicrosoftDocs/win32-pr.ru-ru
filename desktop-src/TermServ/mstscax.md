---
title: Класс Мстскакс
description: Клиентский элемент управления Microsoft Terminal Services (распространяемый пакет) — версия 1.
ms.assetid: 8B8FEF40-89A5-47C0-94EE-4F4B2B5738AB
ms.tgt_platform: multiple
keywords:
- службы удаленных рабочих столов класса Мстскакс
- Службы удаленных рабочих столов класс Мстскакс, описание
topic_type:
- apiref
api_name:
- MsTscAx
...
ms.locfileid: "104415156"
---
# <a name="mstscax-class"></a>Класс Мстскакс

Клиентский элемент управления Microsoft Terminal Services (распространяемый пакет) — версия 1
...
**Мстскакс** имеет следующие типы членов:
...
Класс **мстскакс** содержит следующие методы.
...
Класс **мстскакс** имеет следующие свойства.
...
| CLSID<br/>                    | CLSID \_ мстскакс определяется как 1FB464C8-09BB-4017-A2F5-EB742F04392F<br/>           |
