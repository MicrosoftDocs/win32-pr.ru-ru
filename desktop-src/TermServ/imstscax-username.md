...
Задавать свойство **username** необязательно. Если он не указан, пользователь может указать имя пользователя при появлении диалогового окна входа в систему Windows во время подключения.
