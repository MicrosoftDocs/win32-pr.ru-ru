...
ms.locfileid: "122468521"
---
# <a name="msrdpclient8notsafeforscripting-class"></a>Класс MsRdpClient8NotSafeForScripting

Клиентский элемент управления Microsoft RDP — версия 9
...
**MsRdpClient8NotSafeForScripting** имеет следующие типы членов:
...
Класс **MsRdpClient8NotSafeForScripting** содержит следующие методы.
...
Класс **MsRdpClient8NotSafeForScripting** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT8NOTSAFEFORSCRIPTING CLSID определен как A3BC03A0-041D-42E3-AD22-882B7865C9C5<br/> |
