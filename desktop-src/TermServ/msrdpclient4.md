...
ms.locfileid: "118350246"
---
# <a name="msrdpclient4-class"></a>Класс MsRdpClient4

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 5
...
**MsRdpClient4** имеет следующие типы членов:
...
Класс **MsRdpClient4** содержит следующие методы.
...
Класс **MsRdpClient4** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT4 CLSID определен как 4EDCB26C-D24C-4E72-AF07-B576699AC0DE<br/>      |
