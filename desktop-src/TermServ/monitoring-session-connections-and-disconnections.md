...
предыдущий формат имени объекта события по-прежнему поддерживается в Windows Server 2008 для обеспечения обратной совместимости. рекомендуется использовать более новый формат Windows Server 2008, так как он более безопасен.
