...
ms.locfileid: "122467070"
---
# <a name="msrdpclient6notsafeforscripting-class"></a>Класс MsRdpClient6NotSafeForScripting

Клиентский элемент управления Microsoft RDP — версия 7
...
**MsRdpClient6NotSafeForScripting** имеет следующие типы членов:
...
Класс **MsRdpClient6NotSafeForScripting** содержит следующие методы.
...
Класс **MsRdpClient6NotSafeForScripting** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT6NOTSAFEFORSCRIPTING CLSID определен как D2EA46A7-C2BF-426B-AF24-E19C44456399<br/> |
