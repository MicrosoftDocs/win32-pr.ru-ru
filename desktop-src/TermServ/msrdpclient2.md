---
title: Класс MsRdpClient2
description: Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 3.
ms.assetid: 8AAFBF03-A4F8-4C54-822F-E038E53CA505
ms.tgt_platform: multiple
keywords:
- службы удаленных рабочих столов класса MsRdpClient2
- Службы удаленных рабочих столов класс MsRdpClient2, описание
topic_type:
- apiref
api_name:
- MsRdpClient2
...
ms.locfileid: "105681886"
---
# <a name="msrdpclient2-class"></a>Класс MsRdpClient2

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 3
...
**MsRdpClient2** имеет следующие типы членов:
...
Класс **MsRdpClient2** содержит следующие методы.
...
Класс **MsRdpClient2** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT2 CLSID определен как 9059F30F-4EB1-4BD2-9FDC-36F43A218F4A<br/>      |
