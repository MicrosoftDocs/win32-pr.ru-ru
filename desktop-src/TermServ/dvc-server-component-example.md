...
---
# <a name="dvc-server-module-example"></a>Пример серверного модуля DVC

В следующем примере кода C++ приведен пример создания модуля динамического виртуального канала (DVC) на стороне сервера.
