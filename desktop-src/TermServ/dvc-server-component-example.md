---
title: Пример серверного модуля DVC
description: Пример кода C++, демонстрирующий создание модуля динамического виртуального канала (DVC) на стороне сервера.
...
ms.locfileid: "104253170"
---
# <a name="dvc-server-module-example"></a><span data-ttu-id="4ac3c-103">Пример серверного модуля DVC</span><span class="sxs-lookup"><span data-stu-id="4ac3c-103">DVC Server Module Example</span></span>

<span data-ttu-id="4ac3c-104">В следующем примере кода C++ приведен пример создания модуля динамического виртуального канала (DVC) на стороне сервера.</span><span class="sxs-lookup"><span data-stu-id="4ac3c-104">The following C++ code sample provides an example of how to create the server-side dynamic virtual channel (DVC) module.</span></span>
