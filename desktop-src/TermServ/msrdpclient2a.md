...
ms.locfileid: "118350301"
---
# <a name="msrdpclient2a-class"></a>Класс MsRdpClient2a

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 3a
...
**MsRdpClient2a** имеет следующие типы членов:
...
Класс **MsRdpClient2a** содержит следующие методы.
...
| CLSID<br/>                    | \_MSRDPCLIENT2A CLSID определен как 971127BB-259F-48C2-BD75-5F97A3331551<br/>     |
