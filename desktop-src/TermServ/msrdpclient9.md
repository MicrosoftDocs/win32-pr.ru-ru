...
ms.locfileid: "122474550"
---
# <a name="msrdpclient9-class"></a>Класс MsRdpClient9

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 10
...
**MsRdpClient9** имеет следующие типы членов:
...
Класс **MsRdpClient9** содержит следующие методы.
...
| CLSID<br/>                    | \_MSRDPCLIENT9 CLSID определен как 301B94BA-5D25-4A12-BFFE-3B6E7A616585<br/>      |
