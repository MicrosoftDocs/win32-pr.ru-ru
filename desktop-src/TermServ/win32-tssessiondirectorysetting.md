...
ms.locfileid: "119769284"
---
# <a name="win32_tssessiondirectorysetting-class"></a>\_Класс Win32 тссессиондиректорисеттинг
...
Класс **Win32 \_ тссессиондиректорисеттинг** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **Win32 \_ тссессиондиректорисеттинг** имеет следующие свойства.
...
Представляет экземпляр **Win32 \_ терминалсервице** , который можно настроить с помощью свойства **Setting** .
...
Тип данных: **Win32 \_ тссессиондиректори**
</dt> <dt>
...
Представляет параметры RDCB, которые могут быть применены к связанному серверу узла сеансов удаленных рабочих столов.
