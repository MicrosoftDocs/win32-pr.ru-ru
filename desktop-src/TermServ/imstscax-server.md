...
Это свойство должно быть установлено до вызова метода [**Connect**](imstscax-connect.md) . Это единственное свойство, которое необходимо задать перед подключением.
