...
ms.locfileid: "119771484"
---
# <a name="imsrdpclientnonscriptable3showredirectionwarningdialog-property"></a>Свойство IMsRdpClientNonScriptable3:: Шовредиректионварнингдиалог

Указывает или получает, должно ли отображаться диалоговое окно предупреждения перенаправления.
...
Указывает, следует ли отображать диалоговое окно "предупреждение перенаправления".
