...
---
# <a name="imsrdpclientadvancedsettingssmartsizing-property"></a>Свойство Имсрдпклиентадванцедсеттингс:: Смартсизинг

Указывает, следует ли масштабировать изображение, чтобы вместить клиентскую область элемента управления. Обратите внимание, что полосы прокрутки не отображаются, если свойство **смартсизинг** включено.

В отличие от большинства других свойств, это свойство может быть задано при соединении элемента управления.
...
Присвойте этому параметру значение **Variant \_ false** , чтобы отключить функцию или **вариант \_ true** , чтобы включить эту функцию.
