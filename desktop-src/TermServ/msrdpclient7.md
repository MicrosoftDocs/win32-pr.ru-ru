...
Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 8
...
**MsRdpClient7** имеет следующие типы членов:
...
Класс **MsRdpClient7** содержит следующие методы.
...
Класс **MsRdpClient7** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT7 CLSID определен как A9D7038D-B5ED-472E-9C47-94BEA90A5910<br/>      |
