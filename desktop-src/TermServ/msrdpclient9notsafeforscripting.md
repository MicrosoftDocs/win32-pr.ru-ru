...
ms.locfileid: "122480660"
---
# <a name="msrdpclient9notsafeforscripting-class"></a>Класс MsRdpClient9NotSafeForScripting

Клиентский элемент управления Microsoft RDP — версия 10
...
**MsRdpClient9NotSafeForScripting** имеет следующие типы членов:
...
Класс **MsRdpClient9NotSafeForScripting** содержит следующие методы.
...
Класс **MsRdpClient9NotSafeForScripting** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT9NOTSAFEFORSCRIPTING CLSID определен как 8B918B82-7985-4C24-89DF-C33AD2BBFBCD<br/> |
