...
Представляет информационную службу сервера централизованной публикации.
...
Класс **Win32 \_ тссистеминфо** имеет следующие свойства.
...
Номер версии этого поставщика WMI.
...
Группа пользователей удаленный рабочий стол в формате языка определения дескрипторов безопасности (SDDL).
