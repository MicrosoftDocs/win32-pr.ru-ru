...
Класс **WMI \_ Терминалсеттинг для Win32** представляет параметры, которые можно применить к терминалу.
...
Класс **Win32 \_ терминалсеттинг** имеет следующие свойства.
