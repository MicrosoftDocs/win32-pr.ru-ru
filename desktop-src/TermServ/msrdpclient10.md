...
ms.locfileid: "122465471"
---
# <a name="msrdpclient10-class"></a>Класс MsRdpClient10

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 11
...
**MsRdpClient10** имеет следующие типы членов:
...
Класс **MsRdpClient10** содержит следующие методы.
...
Класс **MsRdpClient10** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT10 CLSID определен как C0EFA91A-EEB7-41C7-97FA-F0ED645EFB24<br/>     |
