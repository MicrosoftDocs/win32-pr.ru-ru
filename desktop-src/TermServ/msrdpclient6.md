...
Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 7
...
**MsRdpClient6** имеет следующие типы членов:
...
Класс **MsRdpClient6** содержит следующие методы.
...
Класс **MsRdpClient6** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT6 CLSID определен как 7390F3D8-0439-4C05-91E3-CF5CB290C3D0<br/>      |
