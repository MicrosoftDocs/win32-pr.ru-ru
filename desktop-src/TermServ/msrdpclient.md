...
---
# <a name="msrdpclient-class"></a>Класс Мсрдпклиент

Клиентский элемент управления Microsoft RDP (распространяемый пакет) — версия 2
...
**Мсрдпклиент** имеет следующие типы членов:
...
Класс **мсрдпклиент** содержит следующие методы.
...
Класс **мсрдпклиент** имеет следующие свойства.
...
| CLSID<br/>                    | \_МСРДПКЛИЕНТ CLSID определен как 791fa017-2de3-492e-acc5-53c67a2b94d0<br/>       |
