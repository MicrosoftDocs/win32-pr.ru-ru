...
---
# <a name="win32_tsexpandenvironmentvariables-class"></a>\_Класс Win32 тсекспанденвиронментвариаблес
...
Класс **Win32 \_ тсекспанденвиронментвариаблес** имеет следующие типы членов:
...
Класс **Win32 \_ тсекспанденвиронментвариаблес** содержит следующие методы.



| Метод                                                                                  | Описание                                              |
|:----------------------------------------------------------------------------------------|:---------------------------------------------------------|
| [**EnvironmentVariables**](environmentvariables-win32-tsexpandenvironmentvariables.md) | Расширяет переменные среды, определенные системой.<br/> |
...
Класс **Win32 \_ тсекспанденвиронментвариаблес** имеет следующие свойства.
