...
-   приложение не ждет монопольного доступа к Windows или другим системным каталогам. это означает, что приложение не сохраняет временные или конфигурационные данные в Windows или других системных каталогах.
