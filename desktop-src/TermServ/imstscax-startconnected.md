...
Это свойство наиболее полезно, если свойства элемента управления заданы в списке параметров <OBJECT> тега, а не через вызовы скриптов.

Это свойство может использоваться, только если имя сервера указано также с помощью свойства сервера. Этот параметр должен быть задан перед запуском элемента управления, например путем включения его в список параметров <OBJECT> тега при использовании элемента управления на веб-странице.
