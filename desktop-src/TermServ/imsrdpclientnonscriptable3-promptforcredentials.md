...
Указывает или получает значение, указывающее, включено ли диалоговое окно Запрос учетных данных для подключения.
...
Указывает, включено ли диалоговое окно Запрос учетных данных для подключения.
