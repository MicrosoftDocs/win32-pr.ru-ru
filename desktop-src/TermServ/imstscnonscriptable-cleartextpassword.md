...
Задает удаленный рабочий стол пароля элемента управления ActiveX в текстовом формате.
...
Чтобы включить автоматический вход в систему, необходимо также задать свойства [**username**](imstscax-username.md) и [**domain**](imstscax-domain.md) . Если пароль не проходит проверку подлинности пользователя, на сервере отображается диалоговое окно входа в Windows, в котором пользователю предлагается ввести пароль.
