...
ms.locfileid: "118350256"
---
# <a name="msrdpclient2notsafeforscripting-class"></a>Класс MsRdpClient2NotSafeForScripting

Клиентский элемент управления Microsoft RDP — версия 3
...
**MsRdpClient2NotSafeForScripting** имеет следующие типы членов:
...
Класс **MsRdpClient2NotSafeForScripting** содержит следующие методы.
...
Класс **MsRdpClient2NotSafeForScripting** имеет следующие свойства.
...
| CLSID<br/>                    | \_MSRDPCLIENT2NOTSAFEFORSCRIPTING CLSID определен как 3523C2FB-4031-44E4-9A3B-F1E94986EE7F<br/> |
