...
---
# <a name="msrdpclient3notsafeforscripting-class"></a>Класс MsRdpClient3NotSafeForScripting

Клиентский элемент управления Microsoft RDP — версия 4
...
**MsRdpClient3NotSafeForScripting** имеет следующие типы членов:
...
Класс **MsRdpClient3NotSafeForScripting** содержит следующие методы.
...
Класс **MsRdpClient3NotSafeForScripting** имеет следующие свойства.
...
| CLSID<br/>                    | CLSID \_ MsRdpClient3NotSafeForScripting определяется как ACE575FD-1FCF-4074-9401-EBAB990FA9DE<br/> |
