...
---
# <a name="glrasterpos4sv-function"></a>Функция glRasterPos4sv
...
Указатель на массив из четырех элементов, задающий координаты x, y, z и w для текущей позиции точечного рисунка.
