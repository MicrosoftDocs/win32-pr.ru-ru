...
ms.locfileid: "118614735"
---
# <a name="glrasterpos2sv-function"></a>Функция glRasterPos2sv
...
Указатель на массив из двух элементов, задающий координаты x и y для текущей позиции в виде растрового изображения.
