...
| **translate**                 | [**глтранслатеф**](gltranslate.md),[**глтранслатед**](gltranslate.md)<br/>     | Перемещает источник системы координат на указанную точку путем умножения текущей матрицы на матрицу перевода.                                                              |
| **window**                    | [**глфрустум**](glfrustum.md)                                                         | При заданных координатах для обтравочных плоскостей текущая матрица умножается на матрицу перспективы.                                                                                  |
