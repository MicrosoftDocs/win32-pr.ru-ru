...
ms.locfileid: "118358806"
---
# <a name="glmultmatrixd-function"></a>Функция Глмултматриксд

Функции **глмултматриксд** и [**глмултматриксф**](glmultmatrixf.md) умножают текущую матрицу на произвольную матрицу.
