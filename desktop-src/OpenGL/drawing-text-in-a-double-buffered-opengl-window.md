...
Вы рисуете текст в окне OpenGL с двойной буферизацией, создавая списки отображения для выбранных символов в шрифте, а затем выполняя соответствующий список отображения для каждого символа, который необходимо нарисовать. Следующий пример кода создает контекст отрисовки, рисует красный треугольник, а затем помечает его текстом. Для этого примера кода предполагается, что существует контекст устройства с шрифтом и форматом пикселей.
