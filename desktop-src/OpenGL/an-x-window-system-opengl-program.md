...
---
# <a name="an-x-window-system-opengl-program"></a><span data-ttu-id="deeee-107">Программа X Window System OpenGL</span><span class="sxs-lookup"><span data-stu-id="deeee-107">An X Window System OpenGL Program</span></span>

<span data-ttu-id="deeee-108">Следующая программа является программой X Window System OpenGL с тем же кодом OpenGL, который используется в АУКСЕДЕМО. Пример программы на языке C, предоставляемый с пакетом Microsoft Platform SDK.</span><span class="sxs-lookup"><span data-stu-id="deeee-108">The following program is an X Window System OpenGL program with the same OpenGL code used in the AUXEDEMO.C sample program supplied with the Microsoft Platform SDK.</span></span> <span data-ttu-id="deeee-109">Сравните эту программу с программой Windows OpenGL в [программе, перенесенной в Windows](the-program-ported-to-win32.md).</span><span class="sxs-lookup"><span data-stu-id="deeee-109">Compare this program with the Windows OpenGL program in [The Program Ported to Windows](the-program-ported-to-win32.md).</span></span>
