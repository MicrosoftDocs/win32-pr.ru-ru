...
---
# <a name="glrasterpos3dv-function"></a>Функция glRasterPos3dv
...
Указатель на массив из трех элементов, задающий координаты x, y и z для текущей позиции растрового изображения.
