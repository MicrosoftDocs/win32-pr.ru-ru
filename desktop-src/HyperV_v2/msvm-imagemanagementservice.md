...
ms.locfileid: "119148407"
---
# <a name="msvm_imagemanagementservice-class"></a>\_Класс мсвм)

Управляет виртуальным носителем (VHD-файлы,. VHDX,. ISO или. VFD) для виртуальной машины.
...
Класс **мсвм \_ )** имеет следующие типы членов:
...
Класс **мсвм \_ )** содержит следующие методы.



| Метод                                                                                                           | Описание                                                                                                                                                                                                                                 |
|:-----------------------------------------------------------------------------------------------------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**аттачвиртуалхарддиск**](attachvirtualharddisk-msvm-imagemanagementservice.md)                               | Подключает файл образа виртуального диска в режиме замыкания на себя.<br/>                                                                                                                                                                             |
| [**компактвиртуалхарддиск**](compactvirtualharddisk-msvm-imagemanagementservice.md)                             | Сжимает файл виртуального жесткого диска.<br/>                                                                                                                                                                                               |
| [**конвертвиртуалхарддиск**](convertvirtualharddisk-msvm-imagemanagementservice.md)                             | Преобразует существующий виртуальный жесткий диск в другой тип или формат.<br/>                                                                                                                                                            |
| [**конвертвиртуалхарддисктовхдсет**](msvm-imagemanagementservice-convertvirtualharddisktovhdset.md)             | Преобразование файла виртуального жесткого диска путем создания нового файла набора ВИРТУАЛЬНЫХ жестких дисков вместе с существующим виртуальным жестким диском.<br/>                                                                                                                       |
| [**креатевиртуалфлоппидиск**](createvirtualfloppydisk-msvm-imagemanagementservice.md)                           | Создает файл виртуального гибкого диска.<br/>                                                                                                                                                                                              |
| [**креатевиртуалхарддиск**](createvirtualharddisk-msvm-imagemanagementservice.md)                               | Создает файл виртуального жесткого диска.<br/>                                                                                                                                                                                                |
| [**делетевхдснапшот**](msvm-imagemanagementservice-deletevhdsnapshot.md)                                       | Удаляет запись моментального снимка виртуального жесткого диска в файле набора виртуальных жестких дисков.<br/>                                                                                                                                                                              |
| [**финдмаунтедсторажеимажеинстанце**](msvm-imagemanagementservice-findmountedstorageimageinstance.md)           | Находит \_ объект Маунтедсторажеимаже мсвм для указанного пути к образу диска.<br/>                                                                                                                                                            |
| [**жетвхдсетинформатион**](msvm-imagemanagementservice-getvhdsetinformation.md)                                 | Извлекает сведения о файле набора виртуальных жестких дисков.<br/>                                                                                                                                                                                      |
| [**жетвхдснапшотинформатион**](msvm-imagemanagementservice-getvhdsnapshotinformation.md)                       | Извлекает сведения о моментальном снимке виртуального жесткого диска в файле набора виртуальных жестких дисков.<br/>                                                                                                                                                                |
| [**жетвиртуалдискчанжес**](msvm-imagemanagementservice-getvirtualdiskchanges.md)                               | Извлекает список изменений в заданной области виртуального диска, начиная с предоставленного ИД отказоустойчивого Отслеживание изменений или идентификатора моментального снимка Вхдсет.<br/>                                                                                     |
| [**жетвиртуалхарддисксеттингдата**](getvirtualharddisksettingdata-msvm-imagemanagementservice.md)               | Извлекает данные настройки, связанные с файлами виртуального жесткого диска.<br/>                                                                                                                                                                  |
| [**жетвиртуалхарддискстате**](getvirtualharddiskstate-msvm-imagemanagementservice.md)                           | Извлекает состояние файлов виртуального жесткого диска.<br/>                                                                                                                                                                                      |
| [**мержевиртуалхарддиск**](mergevirtualharddisk-msvm-imagemanagementservice.md)                                 | Слияние дочернего виртуального жесткого диска в цепочке разностного с одним или несколькими родительскими виртуальными жесткими дисками в цепочке.<br/>                                                                                                                |
| [**оптимизевхдсет**](msvm-imagemanagementservice-optimizevhdset.md)                                             | Оптимизирует файл набора виртуальных жестких дисков для использования меньшего места на диске.<br/>                                                                                                                                                                                 |
| [**Равен**](msvm-imagemanagementservice-requeststatechange.md)                                     | Запрашивает изменение состояния.<br/>                                                                                                                                                                                                         |
| [**ресизевиртуалхарддиск**](resizevirtualharddisk-msvm-imagemanagementservice.md)                               | Изменяет размер существующего виртуального жесткого диска.<br/>                                                                                                                                                                                           |
| [**сетпарентвиртуалхарддиск**](setparentvirtualharddisk-msvm-imagemanagementservice.md)                         | Обновляет родительский объект для указанных конечных и дочерних файлов виртуального жесткого диска.<br/>                                                                                                                                                     |
| [**сетвхдснапшотинформатион**](msvm-imagemanagementservice-setvhdsnapshotinformation.md)                       | Изменяет запись моментального снимка виртуального жесткого диска в файле набора виртуальных жестких дисков. Если идентификатор моментального снимка в вопросе уже существует, существующая запись моментального снимка будет перезаписана новой записью. В противном случае новая запись будет добавлена в файл набора виртуальных жестких дисков.<br/> |
| [**сетвиртуалхарддисксеттингдата**](setvirtualharddisksettingdata-msvm-imagemanagementservice.md)               | Задает файл виртуального жесткого диска.<br/>                                                                                                                                                                                                   |
| [**StartService**](msvm-imagemanagementservice-startservice.md)                                                 | запускает службу.<br/>                                                                                                                                                                                                              |
| [**StopService**](msvm-imagemanagementservice-stopservice.md)                                                   | останавливает службу.<br/>                                                                                                                                                                                                               |
| [**валидатеперсистентресерватионсуппорт**](msvm-imagemanagementservice-validatepersistentreservationsupport.md) | Проверяет, может ли файловая система поддерживать виртуальный жесткий диск с включенным постоянным резервированием.<br/>                                                                                                                            |
| [**валидатевиртуалхарддиск**](validatevirtualharddisk-msvm-imagemanagementservice.md)                           | Проверяет, можно ли открыть образ виртуального диска в режиме только для чтения.<br/>                                                                                                                                                          |
...
Класс **мсвм \_ )** имеет следующие свойства.
...
Краткое описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "Служба управления образами Hyper-V".
...
Имя класса или подкласса, используемого при создании экземпляра. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение "мсвм \_ )".
...
Описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "обеспечивает обслуживание управления образами для Hyper-V".
...
Отображаемое имя объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "Служба управления образами Hyper-V".
...
Метка, по которой известен объект. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение "vhdsvc".
...
Строка, которая предоставляет сведения о том, как можно достичь основного владельца службы (например, номер телефона, адрес электронной почты и т. д.). Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение **null**.
...
Последнее запрошенное или требуемое состояние элемента. Фактическое состояние элемента представлено параметром **EnabledState**. Это свойство предназначено для сравнения последнего запрошенного и текущего включенного или отключенного состояния. Конкретный экземпляр **енабледлогикалелемент** может не поддерживать **рекуестедстатечанже**. В этом случае используется значение 12 (неприменимо). Это свойство наследуется от [**CIM \_ енабледлогикалелемент**](/previous-versions//cc136818(v=vs.85))и всегда имеет значение 12 (неприменимо).
...
Указывает, запущена ли служба. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение **true**.
...
Доступ к классу **\_ ) мсвм** может быть ограничен фильтром контроля учетных записей. Дополнительные сведения см. в разделе [Управление учетными записями пользователей и инструментарий WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
