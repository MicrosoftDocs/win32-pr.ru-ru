...
Описывает основную поверхность рисования на контроллере экрана.
...
Класс **мсвм \_ видеохеад** имеет следующие типы членов:
...
Класс **мсвм \_ видеохеад** содержит следующие методы.
...
| [**Равен**](msvm-videohead-requeststatechange.md) | Запрашивает изменение состояния.<br/>      |
| [**Перезапуск**](msvm-videohead-reset.md)                           | Сбрасывает виртуальное устройство.<br/>    |
...
Класс **мсвм \_ видеохеад** имеет следующие свойства.
...
Число битов, используемых для вывода каждого пикселя. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Квалификаторы: **единицы** ("Пиксели")
</dt> </dl>

Текущее число точек по горизонтали. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Число цветов, поддерживаемое в текущих разрешениях. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Если в символьном режиме, число столбцов для этого контроллера экрана. В противном случае флагу присваивается значение 0. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Если в символьном режиме, число строк для этого видеоконтроллера. В противном случае флагу присваивается значение 0. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Квалификаторы: **единицы** ("Герц")
</dt> </dl>

Текущая частота обновления в герцах. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Текущий режим просмотра. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
<span id="Non-Interlaced_Operation"></span><span id="non-interlaced_operation"></span><span id="NON-INTERLACED_OPERATION"></span>**Операция без чередования** (3)
</dt> <dt>

<span id="Interlaced_Operation"></span><span id="interlaced_operation"></span><span id="INTERLACED_OPERATION"></span>**Операция чередования** (4)
</dt> </dl>
...
Текущее число пикселей по вертикали. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Это свойство наследуется [**от \_ CIM**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)-унаследованной модели и имеет значение "Microsoft:*GUID* \\ head \\ *index*".
...
Максимальная частота обновления контроллера экрана в герцах. Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Минимальная частота обновления видеоконтроллера (в герцах). Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)).
...
Текущий режим просмотра, когда свойство **куррентсканмоде** экземпляра имеет значение 1 (другое). Это свойство наследуется от [**CIM \_ видеохеад**](/previous-versions//cc136948(v=vs.85)) и имеет значение **null**.
...
Последнее запрошенное или требуемое состояние элемента. Фактическое состояние элемента представлено параметром **EnabledState**. Это свойство наследуется от [**CIM \_ енабледлогикалелемент**](/previous-versions//cc136818(v=vs.85)).
...
[**\_ВИДЕОХЕАД CIM**](cim-videohead.md)
</dt> <dt>

[**\_ВИДЕОХЕАД CIM**](/previous-versions//cc136948(v=vs.85))
</dt> <dt>
