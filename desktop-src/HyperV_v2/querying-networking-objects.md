---
description: В следующем примере кода C# извлекается и отображаются сведения о физических и виртуальных сетях для указанного коммутатора.
ms.assetid: 679168E2-C79F-4A7A-8C04-A309315CA670
title: Запрос сетевых объектов
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105662377"
---
# <a name="querying-networking-objects"></a><span data-ttu-id="509b8-103">Запрос сетевых объектов</span><span class="sxs-lookup"><span data-stu-id="509b8-103">Querying networking objects</span></span>

<span data-ttu-id="509b8-104">В следующем примере кода C# извлекается и отображаются сведения о физических и виртуальных сетях для указанного коммутатора.</span><span class="sxs-lookup"><span data-stu-id="509b8-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="509b8-105">Этот код взят из [примера сети Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span><span class="sxs-lookup"><span data-stu-id="509b8-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="509b8-106">Для выполнения этого примера используется следующий синтаксис командной строки:</span><span class="sxs-lookup"><span data-stu-id="509b8-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="509b8-107">**NetworkingSamples.exe енумератесвитч** *SwitchName*</span><span class="sxs-lookup"><span data-stu-id="509b8-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="509b8-108">где *SwitchName* — имя параметра, для которого нужно отобразить сведения.</span><span class="sxs-lookup"><span data-stu-id="509b8-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="509b8-109">Имя переключателя содержится в свойстве [**мсвм \_ Виртуалесернетсвитч. ElementName**](msvm-virtualethernetswitch.md) .</span><span class="sxs-lookup"><span data-stu-id="509b8-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
