...
ms.locfileid: "118949973"
---
# <a name="msvm_synthetic3dservice-class"></a>\_Класс мсвм Synthetic3DService

Описание искусственной службы трехмерного графического процессора.
...
Класс **мсвм \_ Synthetic3DService** имеет следующие типы членов:
...
Класс **мсвм \_ Synthetic3DService** содержит следующие методы.



| Метод                                                                                     | Описание                                                         |
|:-------------------------------------------------------------------------------------------|:--------------------------------------------------------------------|
| [**дисаблегпуфорвиртуализатион**](disablegpuforvirtualization-msvm-synthetic3dservice.md) | Отключает физический GPU для виртуализации.<br/>              |
| [**енаблегпуфорвиртуализатион**](enablegpuforvirtualization-msvm-synthetic3dservice.md)   | Включает физический GPU для виртуализации.<br/>               |
| [**модифисервицесеттингс**](modifyservicesettings-msvm-synthetic3dservice.md)             | Изменяет данные параметра для искусственной трехмерной службы.<br/> |
...
Класс **мсвм \_ Synthetic3DService** имеет следующие свойства.
