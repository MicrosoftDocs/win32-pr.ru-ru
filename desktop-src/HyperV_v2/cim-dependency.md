...
---
# <a name="cim_dependency-class-hyper-v-management"></a>Класс CIM_Dependency (Управление Hyper-V)

Представляет универсальную ассоциацию, используемую для установления отношений зависимости между управляемыми элементами.
...
Независимый объект в этой ассоциации.
