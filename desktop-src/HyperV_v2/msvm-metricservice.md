...
ms.locfileid: "119148317"
---
# <a name="msvm_metricservice-class"></a>\_Класс мсвм метриксервице

Предоставляет возможность управлять метриками.
...
Класс **мсвм \_ метриксервице** имеет следующие типы членов:
...
Класс **мсвм \_ метриксервице** содержит следующие методы.



| Метод                                                                    | Описание                                                                             |
|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| [**контролметрикс**](controlmetrics-msvm-metricservice.md)               | Используется для управления сбором метрик для управляемого элемента или элементов.<br/> |
| [**контролметриксбикласс**](msvm-metricservice-controlmetricsbyclass.md) | Управляет метриками по классу.<br/>                                               |
| [**контролсамплетимес**](msvm-metricservice-controlsampletimes.md)       | Задает время в образце элемента управления.<br/>                                               |
| [**жетметриквалуес**](msvm-metricservice-getmetricvalues.md)             | Извлекает значения метрик.<br/>                                                 |
| [**модифисервицесеттингс**](modifyservicesettings-msvm-metricservice.md) | Изменяет данные настройки для службы.<br/>                                   |
| [**Равен**](msvm-metricservice-requeststatechange.md)       | Запрашивает изменение состояния.<br/>                                                     |
| [**шовметрикс**](msvm-metricservice-showmetrics.md)                     | Показывает указанные метрики.<br/>                                                 |
| [**шовметриксбикласс**](msvm-metricservice-showmetricsbyclass.md)       | Показывает метрики по классу.<br/>                                                  |
| [**StartService**](msvm-metricservice-startservice.md)                   | запускает службу.<br/>                                                          |
| [**StopService**](msvm-metricservice-stopservice.md)                     | останавливает службу.<br/>                                                           |
...
Класс **мсвм \_ метриксервице** имеет следующие свойства.
...
Краткое описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "служба метрик Hyper-V".
...
Имя класса или подкласса, используемого при создании экземпляра. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение "мсвм \_ метриксервице".
...
Описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "обеспечивает управление WMI метриками Hyper-V".
...
Отображаемое имя объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "служба метрик Hyper-V".
...
Метка, по которой известен объект. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение "метриксвк".
