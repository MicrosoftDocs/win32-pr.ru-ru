---
description: В некоторых примерах виртуализации C# используются следующие служебные программы.
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: Общие служебные программы для примеров виртуализации (v2)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103911035"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="c91d5-103">Общие служебные программы для примеров виртуализации (v2)</span><span class="sxs-lookup"><span data-stu-id="c91d5-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="c91d5-104">В некоторых примерах виртуализации C# используются следующие служебные программы.</span><span class="sxs-lookup"><span data-stu-id="c91d5-104">The following utilities are used by some of the C# virtualization samples.</span></span>
