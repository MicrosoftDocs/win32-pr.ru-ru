...
ms.locfileid: "119980494"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a>Общие служебные программы для примеров виртуализации (v2)

В некоторых примерах виртуализации C# используются следующие служебные программы.
