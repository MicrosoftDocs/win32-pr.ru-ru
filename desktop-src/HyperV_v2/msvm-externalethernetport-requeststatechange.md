...
---
# <a name="requeststatechange-method-of-the-msvm_externalethernetport-class"></a>Метод RequestStateChange \_ класса мсвм екстерналесернетпорт
...
[**Мсвм \_ екстерналесернетпорт**](msvm-externalethernetport.md)
</dt> </dl>
