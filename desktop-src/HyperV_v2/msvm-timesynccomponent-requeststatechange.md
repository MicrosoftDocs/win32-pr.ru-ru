...
ms.locfileid: "119811814"
---
# <a name="requeststatechange-method-of-the-msvm_timesynccomponent-class"></a>Метод RequestStateChange \_ класса мсвм тимесинккомпонент
...
Может содержать ссылку на Конкретежоб, созданную для отслеживания перехода состояния, инициированного вызовом метода.
...
[**Мсвм \_ тимесинккомпонент**](msvm-timesynccomponent.md)
</dt> </dl>
