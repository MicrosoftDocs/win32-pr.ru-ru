...
---
# <a name="requeststatechange-method-of-the-msvm_externalfcport-class"></a>Метод RequestStateChange \_ класса мсвм екстерналфкпорт
...
[**Мсвм \_ екстерналфкпорт**](msvm-externalfcport.md)
</dt> </dl>
