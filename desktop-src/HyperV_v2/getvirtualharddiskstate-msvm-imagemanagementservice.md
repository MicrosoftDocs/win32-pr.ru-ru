...
ms.locfileid: "119532344"
---
# <a name="getvirtualharddiskstate-method-of-the-msvm_imagemanagementservice-class"></a>Метод Жетвиртуалхарддискстате \_ класса) мсвм
...
В случае успеха получает встроенный экземпляр класса [**мсвм \_ виртуалхарддискстате**](msvm-virtualharddiskstate.md) , который содержит сведения о состоянии виртуального жесткого диска.
...
В следующем примере C# показано, как вызвать метод **жетвиртуалхарддискстате** . Служебные программы, на которые указывают ссылки, можно найти в [общих служебных программах для примеров виртуализации (v2)](common-utilities-for-the-virtualization-samples-v2.md).
