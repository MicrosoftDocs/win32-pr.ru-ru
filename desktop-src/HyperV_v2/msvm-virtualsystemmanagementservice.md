...
| [**диагносенетворкконнектион**](msvm-virtualsystemmanagementservice-diagnosenetworkconnection.md)                     | Диагностика сетевого подключения виртуальной машины в среде виртуализации сети Windows.<br/>                                                                                                                                             |
...
| [**тестнетворкконнектион**](msvm-virtualsystemmanagementservice-testnetworkconnection.md)                             | Проверяет сетевое подключение виртуальной машины в среде виртуализации сети Windows.<br/>                                                                                                                                                 |
