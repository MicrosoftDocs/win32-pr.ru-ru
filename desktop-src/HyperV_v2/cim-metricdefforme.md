...
Представляет ассоциацию, в которой объект [**CIM \_ басеметрикдефинитион**](cim-basemetricdefinition.md) определяет метрики для управляемого элемента.
...
Класс **CIM \_ метрикдефформе** имеет следующие типы членов:
...
Управляемый элемент, связанный с определением метрики.
...
Определение метрики, связанное с управляемым элементом.
