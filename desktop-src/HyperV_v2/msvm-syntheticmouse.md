...
---
# <a name="msvm_syntheticmouse-class"></a>\_Класс мсвм синсетикмаусе

Представляет устройство искусственного мыши.
...
Класс **мсвм \_ синсетикмаусе** имеет следующие типы членов:
...
Класс **мсвм \_ синсетикмаусе** содержит следующие методы.



| Метод                                                                 | Описание                                                                   |
|:-----------------------------------------------------------------------|:------------------------------------------------------------------------------|
| [**кликкбуттон**](clickbutton-msvm-syntheticmouse.md)                 | Имитирует нажатие кнопки указанного устройства.<br/>           |
| **енабледевице**                                                       | Этот метод не поддерживается.<br/>                                      |
| [**жетбуттонстате**](getbuttonstate-msvm-syntheticmouse.md)           | Извлекает текущее состояние указанной кнопки устройства.<br/>        |
| **онлинедевице**                                                       | Этот метод не поддерживается.<br/>                                      |
| **куиесцедевице**                                                      | Этот метод не поддерживается.<br/>                                      |
| [**Равен**](msvm-syntheticmouse-requeststatechange.md)   | Запрашивает изменение состояния<br/>                                            |
| [**Перезапуск**](msvm-syntheticmouse-reset.md)                             | Выполняет сброс устройства.<br/>                                                 |
| **ресторепропертиес**                                                  | Этот метод не поддерживается.<br/>                                      |
| **савепропертиес**                                                     | Этот метод не поддерживается.<br/>                                      |
| [**сетабсолутепоситион**](setabsoluteposition-msvm-syntheticmouse.md) | Задает горизонтальное и вертикальное расположение курсора мыши.<br/>     |
| [**сетбуттонстате**](setbuttonstate-msvm-syntheticmouse.md)           | Задает текущее состояние указанной кнопки устройства.<br/>             |
| **SetPowerState**                                                      | Этот метод не поддерживается.<br/>                                      |
| [**сетскроллпоситион**](setscrollposition-msvm-syntheticmouse.md)     | Задает z-координату элемента управления "колесо" для указывающего устройства.<br/> |
...
Класс **мсвм \_ синсетикмаусе** имеет следующие свойства.
...
| Значение                                                                                | Значение                                           |
|--------------------------------------------------------------------------------------|---------------------------------------------------|
| <dl> <dt>**True**</dt> </dl>  | Координаты устройства являются абсолютными.<br/> |
| <dl> <dt>**Неверно**</dt> </dl> | Координаты устройства являются относительными.<br/> |
...
| Значение                                                                                                                                                                                                                           | Значение                                                                  |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|
| <span id="Enabled"></span><span id="enabled"></span><span id="ENABLED"></span><dl> <dt>**Включено**</dt> <dt>2</dt> </dl>     | Гостевая виртуальная машина поддерживает искусственную мышь.<br/>         |
| <span id="Disabled"></span><span id="disabled"></span><span id="DISABLED"></span><dl> <dt>**Отключено**</dt> <dt>3</dt> </dl> | Гостевая виртуальная машина не поддерживает искусственную мышь.<br/> |
...
| <dl> <dt>1</dt> </dl> | Не применяется<br/>         |
...
Квалификаторы: [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("миккэйс")
</dt> </dl>

Положение координаты z устройства мыши.
...
Строки, описывающие различные значения массива [**OperationalStatus**](msvm-bioselement.md) . Это свойство наследуется от [**CIM \_ манажедсистемелемент**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement).
...
Доступ к классу **\_ синсетикмаусе мсвм** может быть ограничен фильтром контроля учетных записей. Дополнительные сведения см. в разделе [Управление учетными записями пользователей и инструментарий WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
