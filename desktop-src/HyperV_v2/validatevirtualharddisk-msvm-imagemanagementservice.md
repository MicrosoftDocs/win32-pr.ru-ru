...
---
# <a name="validatevirtualharddisk-method-of-the-msvm_imagemanagementservice-class"></a>Метод Валидатевиртуалхарддиск \_ класса) мсвм
...
**Обнаружен цикл цепочки разностных виртуальных жестких дисков** (32787)
</dt> </dl>

## <a name="remarks"></a>Комментарии

Если виртуальный жесткий диск является разностным диском, открывается вся цепочка виртуальных дисков. Если ссылка разорвана в цепочке дисков, возвращается объект задания с соответствующей инициализированной ошибкой, а дочерний и родительский свойства инициализируются в расположение, в котором связь разорвана.
...
В следующем примере кода C# проверяется образ виртуального жесткого диска. Служебные программы, на которые указывают ссылки, можно найти в [общих служебных программах для примеров виртуализации (v2)](common-utilities-for-the-virtualization-samples-v2.md).
...
[**Валидатевиртуалхарддиск (v1)**](/previous-versions/windows/desktop/virtual/validatevirtualharddisk-msvm-imagemanagementservice)
</dt> <dt>
