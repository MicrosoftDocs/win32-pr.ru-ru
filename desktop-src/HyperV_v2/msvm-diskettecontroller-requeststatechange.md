...
ms.locfileid: "119681764"
---
# <a name="requeststatechange-method-of-the-msvm_diskettecontroller-class"></a>Метод RequestStateChange \_ класса мсвм дискеттеконтроллер
...
[**Мсвм \_ дискеттеконтроллер**](msvm-diskettecontroller.md)
</dt> </dl>
