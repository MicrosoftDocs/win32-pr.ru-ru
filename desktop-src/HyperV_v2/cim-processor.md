...
Представляет возможности и управление процессором.
...
Квалификаторы: [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("BITS"), **Пунит** ("bit")
</dt> </dl>
...
Квалификаторы: [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("мегагерц"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF- \| процессор \| 017,6 "), **Пунит** (" Герц \* 10 ^ 6 ")
</dt> </dl>

Текущая скорость процессора (в МГц).
...
Скорость (в МГц) интерфейса внешней шины (также называемая интерфейсной шиной).
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| \| -процессор 017,3 "), [**моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ процессор CIM**.**Осерфамилидескриптион**")
</dt> </dl>
...
**Процессор Intel (R) Core (TM) Duo для мобильных устройств** (41)
...
**Семейство процессоров AMD турион (TM) II Ultra Dual-Core Mobile M** (56)
...
**Семейство процессоров AMD турион (TM) II Dual-Core Mobile M** (57)
...
**Семейство процессоров AMD Athlon (TM) II Dual-Core Mobile M** (58)
...
**Процессор серии AMD Opteron (TM) 6100** (59)
...
**Процессор серии AMD Opteron (TM) 4100** (60)
...
**Семейство крусое (TM) TM5000** (120)
...
**Семейство крусое (TM) TM3000** (121)
...
**Семейство еффицеон (TM) TM8000** (122)
...
**Семейство процессоров AMD Семпрон (TM)** (133)
...
**Технология AMD турион (TM) 64 для мобильных устройств** (134)
...
**Семейство процессоров AMD Opteron (TM) с двумя ядрами** (135)
...
**AMD Athlon (TM) 64 X2 Dual-Core семейство процессоров** (136)
...
**Технология AMD турион (TM) 64 с мобильными устройствами x2** (137)
...
**AMD Phenom (TM) X2 Dual-Core семейство процессоров** (142)
...
**Двухъядерный процессор Intel (r) Xeon (r) 3000** (162)
...
**Двухъядерный процессор Intel (r) Xeon (r) 5100** (164)
...
**Двухъядерный процессор Intel (r) Xeon (r) 5000** (165)
...
**Процессор с двумя ядрами Intel (r) Xeon (r) LV** (166)
...
**Двухъядерный процессор Intel (r) Xeon (r)** (167)
...
**Двухъядерный процессор Intel (r) Xeon (r) 7100** (168)
...
**Двухъядерный процессор Intel (r) Xeon (r) 5200** (171)
...
**Двухъядерный процессор Intel (r) Xeon (r) 7200** (172)
...
**Процессор с несколькими ядрами Intel (r) Xeon (r) серии 7400** (175)
...
**Семейство процессоров AMD Athlon (TM) MP** (183)
...
**Четырехъядерный процессор Intel (R) Core (TM) 2** (194)
...
**Процессор Intel (R) Core (TM) 2 Extreme для мобильных устройств** (195)
...
**Процессор Intel (R) Core (TM) 2 Duo для мобильных устройств** (196)
...
**Процессор с двумя ядрами Intel (r) Celeron (r)** (199)
...
**VIA C7 (TM)-D, семейство процессоров** (211)
...
**Семейство процессоров VIA Еден (TM)** (213)
...
**Процессор с несколькими ядрами Intel (r) Xeon (r)** (214)
...
**Процессор с несколькими ядрами Intel (r) Xeon (r) серии 3400** (224)
...
**Семейство встраиваемых процессоров AMD Opteron (TM) Quad-Core** (230)
...
**Семейство процессоров AMD турион (TM) Ultra Dual-Core Mobile** (232)
...
**AMD турион (TM) Dual-Core семейство мобильных процессоров** (233)
...
**Семейство процессоров AMD Семпрон (TM) Si** (235)
...
**Семейство процессоров AMD Семпрон (TM) M** (239)
...
**Зарезервировано (с неинициализированным содержимым Flash)** (255)
...
**Зарезервировано (для будущего назначения специального назначения)** (65534)
...
Квалификаторы: [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("процент"), [**датчик**](/windows/desktop/WmiSdk/standard-qualifiers), [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIB. IETF \| Host-Resources-MIB. хрпроцессорлоад "), **Пунит** (" Percent ")
</dt> </dl>
...
Квалификаторы: [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("мегагерц"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF- \| процессор \| 017,5 "), **Пунит** (" Герц \* 10 ^ 6 ")
</dt> </dl>

Максимальная скорость процессора (в МГц).
...
Тип семейства процессоров, если свойство **Family** имеет значение **other** ("1"). Для этой строки следует задать значение NULL, если свойство Family имеет любое значение, отличное от **other**.
...
Глобальный уникальный идентификатор процессора в области семейства процессоров.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| \| -процессор 017,7 ")
</dt> </dl>

Сведения о сокете ЦП, которые содержат данные о том, как можно обновить процессор.
