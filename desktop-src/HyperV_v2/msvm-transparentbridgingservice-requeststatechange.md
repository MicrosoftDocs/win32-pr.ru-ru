...
ms.locfileid: "119746344"
---
# <a name="requeststatechange-method-of-the-msvm_transparentbridgingservice-class"></a>Метод RequestStateChange \_ класса мсвм транспарентбридгингсервице
...
Новое состояние. Сведения помещаются в свойство **RequestedState** экземпляра, если код возврата метода **RequestStateChange** равен 0 (задание завершено без ошибок) или 4096 (задание запущено). Дополнительные сведения см. в описании свойств **EnabledState** и **RequestedState** для элемента. Это должно быть одно из следующих значений.
...
[**Мсвм \_ транспарентбридгингсервице**](msvm-transparentbridgingservice.md)
</dt> </dl>
