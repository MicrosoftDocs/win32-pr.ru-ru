...
ms.locfileid: "118949629"
---
# <a name="msvm_virtualfcswitch-class"></a>\_Класс мсвм виртуалфксвитч

Представляет виртуальный Fibre Channel коммутатор. Каждый коммутатор связан с одним физическим Fibre Channel портом, к которому можно подключить множество портов искусственного Fibre Channel. Сам переключатель не настраивается с высокой назначением и действует в основном как заполнитель.
...
Класс **мсвм \_ виртуалфксвитч** имеет следующие типы членов:
...
Класс **мсвм \_ виртуалфксвитч** содержит следующие методы.



| Метод                                                                | Описание                              |
|:----------------------------------------------------------------------|:-----------------------------------------|
| [**Равен**](msvm-virtualfcswitch-requeststatechange.md) | Запрашивает изменение состояния.<br/>      |
...
Класс **мсвм \_ виртуалфксвитч** имеет следующие свойства.
...
Имя класса или подкласса, используемого при создании экземпляра. Это свойство наследуется [**от \_ системы CIM**](/windows/desktop/CIMWin32Prov/cim-system).
...
Метка, по которой известен объект. Это свойство наследуется [**от \_ системы CIM**](/windows/desktop/CIMWin32Prov/cim-system).
...
Это свойство наследуется от [**CIM \_ ComputerSystem**](/windows/desktop/CIMWin32Prov/cim-computersystem).
