...
ms.locfileid: "118950043"
---
# <a name="msvm_synth3dvideopool-class"></a>\_Класс мсвм Synth3dVideoPool

Содержит сведения о синтетических трехмерных графических процессорах (GPU), доступных в главной системе. Этот класс используется только в системах размещения, поддерживающих RemoteFX.
...
| Метод                                                                                             | Описание                                                                               |
|:---------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------|
| [**калкулатевидеомеморирекуирементс**](msvm-synth3dvideopool-calculatevideomemoryrequirements.md) | вычисляет объем видеопамяти, необходимый для RemoteFX виртуальной машины.<br/> |
...
указывает, имеет ли основное приложение gpu, поддерживающее RemoteFX, и являются ли их версии DirectX минимальными требованиями.
...
> [!Note]  
> не рекомендуется использовать в Windows 10, версии 1703 и Windows Server 2016.
