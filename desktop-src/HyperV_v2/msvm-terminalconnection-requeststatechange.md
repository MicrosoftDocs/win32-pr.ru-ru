...
---
# <a name="requeststatechange-method-of-the-msvm_terminalconnection-class"></a>Метод RequestStateChange \_ класса мсвм терминалконнектион
...
[**Мсвм \_ терминалконнектион**](msvm-terminalconnection.md)
</dt> </dl>
