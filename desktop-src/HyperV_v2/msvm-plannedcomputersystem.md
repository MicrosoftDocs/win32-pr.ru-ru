...
| <span id="Storage"></span><span id="storage"></span><span id="STORAGE"></span><dl> <dt>**Хранилище**</dt> <dt>3</dt> </dl>                                                                              |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| <span id="Central_Office_Switch"></span><span id="central_office_switch"></span><span id="CENTRAL_OFFICE_SWITCH"></span><dl> <dt>**Центральный офисный коммутатор**</dt> <dt>7</dt> </dl>                      |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| <span id="Storage_Virtualizer"></span><span id="storage_virtualizer"></span><span id="STORAGE_VIRTUALIZER"></span><dl> <dt>**Виртуализация хранилища**</dt> <dt>21</dt> </dl>                             |                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| <span id="Storage_Device_Enclosure"></span><span id="storage_device_enclosure"></span><span id="STORAGE_DEVICE_ENCLOSURE"></span><dl> <dt>**Корпус устройства хранения**</dt> <dt>31</dt> </dl>         | Указывает, что этот экземпляр представляет собой корпус, содержащий устройства хранения. <br/>                                                                                                                                                                                                                                                                                                                                                                                                                                           |
