...
Класс **мсвм \_ Synthetic3DDisplayController** имеет следующие типы членов:
...
Класс **мсвм \_ Synthetic3DDisplayController** содержит следующие методы.
...
| **Сброс**              | Этот метод не поддерживается.<br/> |
...
Класс **мсвм \_ Synthetic3DDisplayController** имеет следующие свойства.
...
Идентификатор устройства. Это свойство наследуется от [**CIM \_ ",**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)" и всегда имеет значение "Microsoft:*GUID*".
