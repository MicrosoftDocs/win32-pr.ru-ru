...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a><span data-ttu-id="3afd8-103">Экспорт конфигурации виртуальной машины</span><span class="sxs-lookup"><span data-stu-id="3afd8-103">Exporting the configuration of a virtual machine</span></span>

<span data-ttu-id="3afd8-104">В следующих примерах C# и Visual Basic Scripting Edition (VBScript) демонстрируется экспорт конфигурации виртуальной машины.</span><span class="sxs-lookup"><span data-stu-id="3afd8-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting the configuration of a virtual machine.</span></span> <span data-ttu-id="3afd8-105">Примеры, демонстрирующие экспорт виртуальной машины, можно найти в [**експортсистемдефинитион**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) и [экспортировать моментальный снимок разделов виртуальной машины](exporting-virtual-machines.md) .</span><span class="sxs-lookup"><span data-stu-id="3afd8-105">Samples that show exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) and [Exporting a snapshot of a virtual machine](exporting-virtual-machines.md) topics.</span></span>

<span data-ttu-id="3afd8-106">Упоминаемые служебные программы C# можно найти в [общих служебных программах для примеров виртуализации (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="3afd8-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="3afd8-107">См. также</span><span class="sxs-lookup"><span data-stu-id="3afd8-107">Related topics</span></span>

[<span data-ttu-id="3afd8-108">Экспорт моментального снимка виртуальной машины</span><span class="sxs-lookup"><span data-stu-id="3afd8-108">Exporting a snapshot of a virtual machine</span></span>](exporting-virtual-machines.md)

[<span data-ttu-id="3afd8-109">**експортсистемдефинитион**</span><span class="sxs-lookup"><span data-stu-id="3afd8-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
