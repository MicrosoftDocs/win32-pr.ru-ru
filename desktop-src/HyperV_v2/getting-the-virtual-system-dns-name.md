---
description: В следующих примерах C# и Visual Basic Scripting Edition (VBScript) извлекается DNS-имя виртуальной машины.
ms.assetid: 1E1F7E6F-5CF6-475F-8351-6A5F56B4FC8E
title: Получение DNS-имени виртуальной машины
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103913916"
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="14922-103">Получение DNS-имени виртуальной машины</span><span class="sxs-lookup"><span data-stu-id="14922-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="14922-104">В следующих примерах C# и Visual Basic Scripting Edition (VBScript) извлекается DNS-имя виртуальной машины.</span><span class="sxs-lookup"><span data-stu-id="14922-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="14922-105">Чтобы выполнить этот пример кода, необходимо установить службы интеграции клиента, и клиентская операционная система должна быть запущена.</span><span class="sxs-lookup"><span data-stu-id="14922-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="14922-106">См. также</span><span class="sxs-lookup"><span data-stu-id="14922-106">Related topics</span></span>

[<span data-ttu-id="14922-107">Общие служебные программы для примеров виртуализации (v2)</span><span class="sxs-lookup"><span data-stu-id="14922-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="14922-108">**Мсвм \_ ComputerSystem**</span><span class="sxs-lookup"><span data-stu-id="14922-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="14922-109">**Мсвм \_ квпексчанжекомпонент**</span><span class="sxs-lookup"><span data-stu-id="14922-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
