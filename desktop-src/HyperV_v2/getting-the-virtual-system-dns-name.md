...
---
# <a name="getting-the-virtual-machine-dns-name"></a>Получение DNS-имени виртуальной машины

В следующих примерах C# и Visual Basic Scripting Edition (VBScript) извлекается DNS-имя виртуальной машины.

Чтобы выполнить этот пример кода, необходимо установить службы интеграции клиента, и клиентская операционная система должна быть запущена.
...
[Общие служебные программы для примеров виртуализации (v2)](common-utilities-for-the-virtualization-samples-v2.md)

[**Мсвм \_ ComputerSystem**](msvm-computersystem.md)

[**Мсвм \_ квпексчанжекомпонент**](msvm-kvpexchangecomponent.md)
