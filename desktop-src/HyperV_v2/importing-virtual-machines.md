...
---
# <a name="migrating-virtual-machines"></a>Миграция виртуальных машин

В следующем примере кода C# показано, как использовать метод [**мигратевиртуалсистемтохост**](migratevirtualsystemtohost-msvm-virtualsystemmigrationservice.md) для выполнения простой миграции виртуальной машины. В этом примере пулы ресурсов используются для получения правильных путей VHD. Этот код взят из [примера миграции виртуальной машины Hyper-V](https://github.com/microsoftarchive/msdn-code-gallery-microsoft/tree/master/Official%20Windows%20Platform%20Sample/Hyper-V%20virtual%20machine%20migration%20sample).

Для выполнения этого примера используется следующий синтаксис командной строки:

**MigrationSamples.exe виртуальной машины и хранилища-простой** *саурцехост* *дестинатионхост* *VmName*

Ниже приведены параметры.

-   *Саурцехост* — имя текущего узла виртуальной машины.
-   *Дестинатионхост* — имя целевого узла.
...
Следующий код на C# содержит реализацию большинства служебных методов, вызываемых из приведенного выше примера.
