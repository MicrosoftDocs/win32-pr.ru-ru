...
---
# <a name="requeststatechange-method-of-the-msvm_internalethernetport-class"></a>Метод RequestStateChange \_ класса мсвм интерналесернетпорт
...
[**Мсвм \_ интерналесернетпорт**](msvm-internalethernetport.md)
</dt> </dl>
