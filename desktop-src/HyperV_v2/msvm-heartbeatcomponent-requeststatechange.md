...
---
# <a name="requeststatechange-method-of-the-msvm_heartbeatcomponent-class"></a>Метод RequestStateChange \_ класса мсвм хеартбеаткомпонент
...
[**Мсвм \_ хеартбеаткомпонент**](msvm-heartbeatcomponent.md)
</dt> </dl>
