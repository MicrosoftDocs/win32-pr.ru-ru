...
ms.locfileid: "120046843"
---
# <a name="cim_metricforme-class"></a>\_Класс CIM метрикформе

Представляет ассоциацию, в которой собираются значения метрик для управляемого элемента.
...
Класс **CIM \_ метрикформе** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **CIM \_ метрикформе** имеет следующие свойства.
