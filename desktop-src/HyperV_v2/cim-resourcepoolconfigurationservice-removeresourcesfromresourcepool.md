...
ms.locfileid: "119980874"
---
# <a name="removeresourcesfromresourcepool-method-of-the-cim_resourcepoolconfigurationservice-class"></a>Метод Ремовересаурцесфромресаурцепул \_ класса CIM ресаурцепулконфигуратионсервице

Запускает задание по удалению ресурсов из пула ресурсов.
...
Массив экземпляров [**CIM \_**](cim-logicaldevice.md) , которые необходимо удалить из пула.
...
[**\_ ResourcePool CIM**](cim-resourcepool.md) , представляющий пул, из которого удаляются ресурсы.
