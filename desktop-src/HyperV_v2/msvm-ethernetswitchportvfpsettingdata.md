---
description: Используйте, чтобы настроить VFP как обязательное для порта.
ms.assetid: efc54e06-26ff-4773-b4b4-a1c5e03d06cc
title: Класс Msvm_EthernetSwitchPortVfpSettingData
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "119681394"
---
# <a name="msvm_ethernetswitchportvfpsettingdata-class"></a>\_Класс мсвм есернетсвитчпортвфпсеттингдата

Используйте, чтобы настроить VFP как обязательное для порта.
...
Класс **мсвм \_ есернетсвитчпортвфпсеттингдата** не определяет никаких членов.
