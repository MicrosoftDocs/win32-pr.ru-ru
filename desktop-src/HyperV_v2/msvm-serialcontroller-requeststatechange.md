...
---
# <a name="requeststatechange-method-of-the-msvm_serialcontroller-class"></a>Метод RequestStateChange \_ класса мсвм сериалконтроллер
...
| Требование | Значение |
|-------------------------------------|---------------------------------------------------------------------------------------------------------|
| Минимальная версия клиента<br/> | Windows 8.1, версия 1703<br/>                                                                    |
...
[**Мсвм \_ сериалконтроллер**](msvm-serialcontroller.md)
</dt> </dl>
