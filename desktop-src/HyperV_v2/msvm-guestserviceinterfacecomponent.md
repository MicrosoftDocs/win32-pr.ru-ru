...
| <dl> <dt>5 (0x5)</dt> </dl>   | Драйверу для устройства требуется ресурс, который Windows не может управлять.<br/>                                                         |
...
| <dl> <dt>25 (0x19)</dt> </dl> | Устройство все еще настраивается.<br/>                                                                                       |
| <dl> <dt>26 (0x1A)</dt> </dl> | Устройство все еще настраивается.<br/>                                                                                       |
