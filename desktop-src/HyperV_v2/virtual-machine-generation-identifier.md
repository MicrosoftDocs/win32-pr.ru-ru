---
description: Windows 8 и Windows Server 2012 познакомьтесь с возможностью программного обеспечения, выполняемого на виртуальной машине, чтобы обнаружить, что событие сдвига времени могло произойти.
