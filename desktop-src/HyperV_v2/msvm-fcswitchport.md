...
ms.locfileid: "119014572"
---
# <a name="msvm_fcswitchport-class"></a>\_Класс мсвм фксвитчпорт
...
Представляет порт в виртуальном Fibre Channel коммутаторе.
...
Класс **мсвм \_ фксвитчпорт** имеет следующие типы членов:
...
Класс **мсвм \_ фксвитчпорт** содержит следующие методы.
...
| [**Равен**](msvm-fcswitchport-requeststatechange.md) | запрашивает изменение состояния.<br/>      |
| [**Перезапуск**](msvm-fcswitchport-reset.md)                           | Сбрасывает виртуальное устройство.<br/>    |
...
Класс **мсвм \_ фксвитчпорт** имеет следующие свойства.
