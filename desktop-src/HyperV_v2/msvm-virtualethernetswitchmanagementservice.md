...
---
# <a name="msvm_virtualethernetswitchmanagementservice-class"></a>\_Класс мсвм виртуалесернетсвитчманажементсервице

Представляет службу виртуализации, имеющуюся в одной системе узла. Мсвм \_ виртуалесернетсвитчманажементсервице используется для управления определением, изменением и удалением виртуальных коммутаторов Ethernet.
...
Класс **мсвм \_ виртуалесернетсвитчманажементсервице** имеет следующие типы членов:
...
Класс **мсвм \_ виртуалесернетсвитчманажементсервице** содержит следующие методы.



| Метод                                                                                               | Описание                                                                       |
|:-----------------------------------------------------------------------------------------------------|:----------------------------------------------------------------------------------|
| [**аддфеатуресеттингс**](addfeaturesettings-msvm-virtualethernetswitchmanagementservice.md)         | Добавляет параметры компонентов в конфигурацию порта коммутатора Ethernet.<br/> |
| [**аддресаурцесеттингс**](addresourcesettings-msvm-virtualethernetswitchmanagementservice.md)       | Добавляет ресурсы в конфигурацию виртуального коммутатора.<br/>                      |
| [**дефинесистем**](definesystem-msvm-virtualethernetswitchmanagementservice.md)                     | Создает новый виртуальный коммутатор.<br/>                                          |
| [**дестройсистем**](destroysystem-msvm-virtualethernetswitchmanagementservice.md)                   | Уничтожает виртуальный коммутатор.<br/>                                             |
| [**модифифеатуресеттингс**](modifyfeaturesettings-msvm-virtualethernetswitchmanagementservice.md)   | Изменяет настройки компонентов порта коммутатора Ethernet.<br/>              |
| [**модифиресаурцесеттингс**](modifyresourcesettings-msvm-virtualethernetswitchmanagementservice.md) | Изменяет параметры ресурсов для виртуального коммутатора.<br/>                       |
| [**модифисистемсеттингс**](modifysystemsettings-msvm-virtualethernetswitchmanagementservice.md)     | Изменяет параметры виртуального коммутатора.<br/>                                      |
| [**ремовефеатуресеттингс**](removefeaturesettings-msvm-virtualethernetswitchmanagementservice.md)   | Удаляет параметры компонента с порта коммутатора Ethernet.<br/>                 |
| [**ремовересаурцесеттингс**](removeresourcesettings-msvm-virtualethernetswitchmanagementservice.md) | Удаляет параметры виртуального ресурса из конфигурации виртуального коммутатора.<br/> |
| [**Равен**](msvm-virtualethernetswitchmanagementservice-requeststatechange.md)         | Запрашивает изменение состояния.<br/>                                               |
| [**StartService**](msvm-virtualethernetswitchmanagementservice-startservice.md)                     | запускает службу.<br/>                                                    |
| [**StopService**](msvm-virtualethernetswitchmanagementservice-stopservice.md)                       | останавливает службу.<br/>                                                     |
...
Класс **мсвм \_ виртуалесернетсвитчманажементсервице** имеет следующие свойства.
...
Краткое описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "Служба управления виртуальными сетями Hyper-V".
...
Имя класса или подкласса, используемого при создании экземпляра. Это свойство наследуется [**от \_ службы CIM**](/windows/desktop/CIMWin32Prov/cim-service)и всегда имеет значение "мсвм \_ виртуалесернетсвитчманажементсервице".
...
Описание объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "обеспечивает управление WMI сетевыми подключениями Hyper-V".
...
Отображаемое имя объекта. Это свойство наследуется от [**CIM \_ манажеделемент**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)и всегда имеет значение "Служба управления сетью Hyper-V".
...
Описывает текущее состояние службы. Это свойство наследуется от [**CIM \_ манажедсистемелемент**](/windows/desktop/CIMWin32Prov/cim-managedsystemelement)и всегда имеет значение "ОК".
