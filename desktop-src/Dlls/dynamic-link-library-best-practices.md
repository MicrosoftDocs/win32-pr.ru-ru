...
-   Создайте именованный канал или другой именованный объект (только для Windows 2000). В Windows 2000 именованные объекты предоставляются библиотекой DLL служб терминалов. Если эта библиотека DLL не инициализирована, вызовы к библиотеке DLL могут привести к сбою процесса.
...
-   Задайте глобальные указатели равными NULL, отключив инициализацию динамических членов. В Microsoft Windows Vista™ можно использовать функции однократной инициализации, чтобы блок кода выполнялся в многопоточной среде только один раз.
