...
| прокси-сервер \_ CLSID =<clsid>                                                                                                                                                                      | Указывает идентификатор класса для сервера. Если этот макрос не определен, то CLSID по умолчанию — это первый идентификатор интерфейса, который компилятор MIDL обнаруживает в спецификации IDL для прокси-сервера/заглушки. |
