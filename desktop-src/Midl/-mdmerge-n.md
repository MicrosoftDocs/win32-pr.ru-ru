...
| &lt;пространство имен &gt; : Int32 > 0 | Составьте все типы с совпадающим пространством имен на глубине, указанной в параметре. |
| &lt;пространство имен &gt; :-1           | Составьте все типы с совпадающим пространством имен в один файл для каждого пространства имен.          |
