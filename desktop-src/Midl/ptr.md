...
Полный указатель, указанный атрибутом **\[ ptr \]** , приближается к полной функциональности указателя языка C. Полный указатель может иметь значение **null** и может изменяться во время вызова от **null** к значению, отличному от **null**. служба хранилища, на которые указывают полные указатели, могут быть достигнуты другими именами в приложении, поддерживающими псевдонимы и циклы. Эта функциональность требует дополнительных издержек при удаленном вызове процедуры для определения данных, на которые ссылается указатель, определения того, является ли значение **нулевым**, и обнаруживать, указывают ли два указателя на одни и те же данные.
