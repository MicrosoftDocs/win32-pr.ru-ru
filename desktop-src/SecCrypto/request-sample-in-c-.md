...
В следующем примере показано, как можно использовать элемент управления регистрации сертификатов с объектом [**интерфейса ICertRequest**](/windows/desktop/api/Certcli/nn-certcli-icertrequest) для создания и отправки запроса на сертификат.
