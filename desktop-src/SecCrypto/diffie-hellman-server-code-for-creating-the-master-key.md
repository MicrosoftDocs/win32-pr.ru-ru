...
ms.locfileid: "117767627"
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a>Diffie-Hellman серверный код для создания главного ключа

В следующем примере показан типичный серверный код [*Диффи-Хелмана*](../secgloss/d-gly.md)/счаннел для создания [*главного ключа*](../secgloss/m-gly.md).
