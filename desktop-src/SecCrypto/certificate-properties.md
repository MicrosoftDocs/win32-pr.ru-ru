...
| Модули        | Для указания требуемых пользовательских свойств. В сертификат можно включать любое количество полей расширения. Имеется только в версии X. 509 3,0.<br/>                                            |
