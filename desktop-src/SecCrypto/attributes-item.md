...
ms.locfileid: "119879834"
---
# <a name="attributesitem-property"></a>Свойство Attributes. Item
...
Свойство **Item** извлекает объект [**атрибута**](attribute.md) , представляющий индексированный атрибут. Это свойство по умолчанию.
