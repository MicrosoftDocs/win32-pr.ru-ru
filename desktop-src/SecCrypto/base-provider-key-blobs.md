...
ms.locfileid: "117773046"
---
# <a name="base-provider-key-blobs"></a>Большие двоичные объекты ключа базового поставщика

Базовый поставщик и расширенный поставщик используют одинаковые [*Ключевые BLOB-объекты*](../secgloss/k-gly.md).
...
[*BLOB-объекты открытого ключа*](../secgloss/p-gly.md), тип **публиккэйблоб**, используются для хранения [*открытых ключей*](../secgloss/p-gly.md) за пределами [*поставщика служб шифрования*](../secgloss/c-gly.md) (CSP). Двоичные объекты открытого ключа базового поставщика имеют следующий формат.
...
[*Простые ключевые BLOB-объекты*](../secgloss/s-gly.md)типа **симплеблоб** используются для хранения и передачи ключей сеанса за пределами CSP. Большие двоичные объекты простых ключей базового поставщика всегда шифруются с помощью [*открытого ключа обмена ключами*](../secgloss/k-gly.md). Элемент **pbData** в **симплеблоб** представляет собой последовательность байтов в следующем формате.
