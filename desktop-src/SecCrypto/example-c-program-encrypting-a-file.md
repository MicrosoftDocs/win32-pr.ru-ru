...
ms.locfileid: "119007662"
---
# <a name="example-c-program-encrypting-a-file"></a>Пример программы на языке C: шифрование файла

В следующем примере выполняется шифрование файла данных. В этом примере в интерактивном режиме запрашиваются имя файла, содержащего зашифрованный [*текст*](../secgloss/p-gly.md) , и имя файла, в который записываются зашифрованные данные.

В примере пользователю предлагается ввести имена входного файла и выходного файла. Кроме того, пользователю предлагается указать, следует ли использовать пароль для создания ключа сеанса шифрования. Если для шифрования данных используется пароль, то в программе, которая расшифровывает файл, должен использоваться один и тот же пароль. Дополнительные сведения см. в разделе [Пример программы C: Расшифровка файла](example-c-program-decrypting-a-file.md).

Из-за изменения ограничений на Управление экспортом между выпусками операционной системы может измениться Стандартный [*поставщик служб шифрования*](../secgloss/c-gly.md) (CSP) и [*Длина ключа*](../secgloss/k-gly.md) по умолчанию. Важно, чтобы для шифрования и расшифровки использовался один и тот же CSP и длина ключа была явно задана для обеспечения взаимодействия на разных платформах операционной системы.
