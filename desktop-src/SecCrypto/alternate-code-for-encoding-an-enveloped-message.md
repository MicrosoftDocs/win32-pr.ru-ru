---
description: В следующем примере показан альтернативный процесс кодирования подписанного сообщения с использованием этого подписанного сообщения в качестве внутреннего содержимого для запечатанного сообщения. При подготовке к декодированию внутреннее содержимое проверяется для определения типа внутреннего содержимого.
ms.assetid: ba174e3c-bc2f-48bd-a1bf-fec491dc0ce3
title: Альтернативный код для кодирования запечатанного сообщения
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105663821"
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="c311c-104">Альтернативный код для кодирования запечатанного сообщения</span><span class="sxs-lookup"><span data-stu-id="c311c-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="c311c-105">В следующем примере показан альтернативный процесс кодирования подписанного сообщения с использованием этого подписанного сообщения в качестве [*внутреннего содержимого*](../secgloss/i-gly.md) для запечатанного сообщения.</span><span class="sxs-lookup"><span data-stu-id="c311c-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="c311c-106">При подготовке к декодированию внутреннее содержимое проверяется для определения типа внутреннего содержимого.</span><span class="sxs-lookup"><span data-stu-id="c311c-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="c311c-107">В этом примере показаны следующие функции CryptoAPI:</span><span class="sxs-lookup"><span data-stu-id="c311c-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="c311c-108">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="c311c-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="c311c-109">**цертопенсистемсторе**</span><span class="sxs-lookup"><span data-stu-id="c311c-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="c311c-110">**криптмсгкалкулатинкодедленгс**</span><span class="sxs-lookup"><span data-stu-id="c311c-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="c311c-111">**криптмсгопентоенкоде**</span><span class="sxs-lookup"><span data-stu-id="c311c-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="c311c-112">**криптмсгупдате**</span><span class="sxs-lookup"><span data-stu-id="c311c-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="c311c-113">**криптмсгжетпарам**</span><span class="sxs-lookup"><span data-stu-id="c311c-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="c311c-114">**криптмсгопентодекоде**</span><span class="sxs-lookup"><span data-stu-id="c311c-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="c311c-115">**цертфиндцертификатеинсторе**</span><span class="sxs-lookup"><span data-stu-id="c311c-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="c311c-116">**криптмсгклосе**</span><span class="sxs-lookup"><span data-stu-id="c311c-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="c311c-117">**цертклосесторе**</span><span class="sxs-lookup"><span data-stu-id="c311c-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="c311c-118">**криптрелеасеконтекст**</span><span class="sxs-lookup"><span data-stu-id="c311c-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="c311c-119">В этом примере также используются функции [**михандлиррор**](myhandleerror.md) и [**жетсигнерцерт**](getsignercert.md).</span><span class="sxs-lookup"><span data-stu-id="c311c-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="c311c-120">Код C для этих функций включен в пример.</span><span class="sxs-lookup"><span data-stu-id="c311c-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="c311c-121">Код, демонстрирующий эти и другие вспомогательные функции, см. в разделе [функции общего назначения](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="c311c-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
