...
ms.locfileid: "117773698"
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a>Альтернативный код для кодирования запечатанного сообщения

В следующем примере показан альтернативный процесс кодирования подписанного сообщения с использованием этого подписанного сообщения в качестве [*внутреннего содержимого*](../secgloss/i-gly.md) для запечатанного сообщения. При подготовке к декодированию внутреннее содержимое проверяется для определения типа внутреннего содержимого.
...
-   [**криптмсгкалкулатинкодедленгс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [**криптмсгопентоенкоде**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [**криптмсгупдате**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [**криптмсгжетпарам**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [**криптмсгопентодекоде**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [**цертфиндцертификатеинсторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [**криптмсгклосе**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
...
В этом примере также используются функции [**михандлиррор**](myhandleerror.md) и [**жетсигнерцерт**](getsignercert.md). Код C для этих функций включен в пример. Код, демонстрирующий эти и другие вспомогательные функции, см. в разделе [функции общего назначения](general-purpose-functions.md).
