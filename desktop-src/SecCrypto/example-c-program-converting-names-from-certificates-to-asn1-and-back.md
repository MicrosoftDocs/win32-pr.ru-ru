...
ms.locfileid: "119993064"
---
# <a name="example-c-program-converting-names-from-certificates-to-asn1-and-back"></a>Пример программы на языке C. Преобразование имен из сертификатов в ASN. 1 и обратно

В следующем примере выполняется перечисление сертификатов в [*хранилище сертификатов*](../secgloss/c-gly.md), выводится тема и пользователь каждого сертификата и преобразуется имя субъекта из каждого сертификата в его [*абстрактный синтаксис*](../secgloss/a-gly.md) (ASN. 1) в закодированной форме, а затем возвращается в декодированную форму.
...
-   Использование [**цертенумцертификатесинсторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) для получения первого сертификата из открытого хранилища.
-   Использование [**цертжетнаместринг**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa) для получения имени субъекта и имени пользователя из сертификата.
-   Использование [**цертнаметостр**](/windows/desktop/api/Wincrypt/nf-wincrypt-certnametostra) для преобразования имени субъекта из сертификата в форму в кодировке ASN. 1.
-   Использование [**CertStrToName**](/windows/desktop/api/Wincrypt/nf-wincrypt-certstrtonamea) для преобразования строки в кодировке ASN. 1 в ее декодированную форму.
-   Закрытие хранилища сертификатов с помощью [**цертклосесторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) и флага **\_ \_ \_ установки \_ флага Close Store** .
