...
Следующий пример кодирует и декодирует простые, общие данные и иллюстрирует следующие задачи и функции CryptoAPI.

-   Определение длины, необходимой буферу для хранения закодированных данных с помощью [**криптмсгкалкулатинкодедленгс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength).
...
-   Добавление содержимого в закодированное сообщение с помощью [**криптмсгупдате**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate).
-   Копирование закодированного сообщения в буфер с помощью [**криптмсгжетпарам**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam).
-   Закрытие закодированного сообщения с помощью [**криптмсгклосе**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose).
...
-   Использование [**криптмсгупдате**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate) и [**криптмсгжетпарам**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam) для получения раскодированных данных.
