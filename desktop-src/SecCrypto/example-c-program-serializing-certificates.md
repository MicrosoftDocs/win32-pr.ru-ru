...
-   Получение сертификата из хранилища с помощью [**цертенумцертификатесинсторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore).
...
-   Создание сериализованной формы [*контекста сертификата*](../secgloss/c-gly.md) и его свойств с помощью [**цертсериализецертификатесторилемент**](/windows/desktop/api/Wincrypt/nf-wincrypt-certserializecertificatestoreelement).
-   Создание нового сертификата из сериализованной строки и добавление его в хранилище сертификатов с помощью [**цертаддсериализеделементтосторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddserializedelementtostore).
-   Использование [**CertAddEncodedCertificateToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddencodedcertificatetostore) для создания нового сертификата из закодированной части существующего сертификата.
-   Использование [**цертклосесторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) для закрытия хранилища сертификатов.
