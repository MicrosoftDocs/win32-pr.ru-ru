---
description: В следующем примере показан типичный код на стороне сервера RSA/SChannel для создания главного ключа.
ms.assetid: 617cda1e-0619-4162-85eb-d1f5aa35fd1c
title: Код сервера RSA для создания главного ключа
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105683492"
---
# <a name="rsa-server-code-for-creating-the-master-key"></a><span data-ttu-id="aa799-103">Код сервера RSA для создания главного ключа</span><span class="sxs-lookup"><span data-stu-id="aa799-103">RSA Server Code for Creating the Master Key</span></span>

<span data-ttu-id="aa799-104">В следующем примере показан типичный код на стороне сервера RSA/SChannel для создания [*главного ключа*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="aa799-104">The following example shows typical RSA/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
