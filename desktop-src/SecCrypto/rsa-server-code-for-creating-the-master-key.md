...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a>Код сервера RSA для создания главного ключа

В следующем примере показан типичный код на стороне сервера RSA/SChannel для создания [*главного ключа*](../secgloss/m-gly.md).
