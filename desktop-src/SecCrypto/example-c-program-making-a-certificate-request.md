...
В следующем примере показана процедура, описанная в предыдущем разделе. В этом примере создается простой [*запрос сертификата*](../secgloss/c-gly.md) с одним подписывающий, отдельным [*атрибутом*](../secgloss/a-gly.md) [*относительного различающегося имени*](../secgloss/r-gly.md) (RDN) и без общих атрибутов.
...
В этом примере также используются функции [**битетостр**](bytetostr.md) и [**михандлиррор**](myhandleerror.md). Код для этих функций включен в пример. [Общего назначения функции](general-purpose-functions.md) содержат код для этих и других вспомогательных функций.
