---
description: В следующем примере показана процедура, описанная в предыдущем разделе. В этом примере создается простой запрос сертификата с одним подписывающий, отдельным атрибутом относительного различающегося имени (RDN) и без общих атрибутов.
...
ms.locfileid: "104546122"
---
# <a name="example-c-program-making-a-certificate-request"></a><span data-ttu-id="b40bf-104">Пример программы на языке C: Создание запроса на сертификат</span><span class="sxs-lookup"><span data-stu-id="b40bf-104">Example C Program: Making a Certificate Request</span></span>

<span data-ttu-id="b40bf-105">В следующем примере показана процедура, описанная в предыдущем разделе.</span><span class="sxs-lookup"><span data-stu-id="b40bf-105">The following example demonstrates the procedure outlined in the previous section.</span></span> <span data-ttu-id="b40bf-106">В этом примере создается простой [*запрос сертификата*](../secgloss/c-gly.md) с одним подписывающий, отдельным [*атрибутом*](../secgloss/a-gly.md) [*относительного различающегося имени*](../secgloss/r-gly.md) (RDN) и без общих атрибутов.</span><span class="sxs-lookup"><span data-stu-id="b40bf-106">This example creates a simple [*certificate request*](../secgloss/c-gly.md) with one signer, a single [*relative distinguished name*](../secgloss/r-gly.md) (RDN) [*attribute*](../secgloss/a-gly.md), and no general attributes.</span></span>

<span data-ttu-id="b40bf-107">В этом примере показаны следующие функции [*CryptoAPI*](../secgloss/c-gly.md) :</span><span class="sxs-lookup"><span data-stu-id="b40bf-107">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="b40bf-108">**CryptEncodeObject**</span><span class="sxs-lookup"><span data-stu-id="b40bf-108">**CryptEncodeObject**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject)
-   [<span data-ttu-id="b40bf-109">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="b40bf-109">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="b40bf-110">**CryptExportPublicKeyInfo**</span><span class="sxs-lookup"><span data-stu-id="b40bf-110">**CryptExportPublicKeyInfo**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptexportpublickeyinfo)
-   [<span data-ttu-id="b40bf-111">**CryptSignAndEncodeCertificate**</span><span class="sxs-lookup"><span data-stu-id="b40bf-111">**CryptSignAndEncodeCertificate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignandencodecertificate)

<span data-ttu-id="b40bf-112">В этом примере также используются функции [**битетостр**](bytetostr.md) и [**михандлиррор**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="b40bf-112">This example also uses the functions [**ByteToStr**](bytetostr.md) and [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="b40bf-113">Код для этих функций включен в пример.</span><span class="sxs-lookup"><span data-stu-id="b40bf-113">Code for these functions is included with the sample.</span></span> <span data-ttu-id="b40bf-114">[Общего назначения функции](general-purpose-functions.md) содержат код для этих и других вспомогательных функций.</span><span class="sxs-lookup"><span data-stu-id="b40bf-114">[General Purpose Functions](general-purpose-functions.md) lists code for these and other auxiliary functions.</span></span>
