...
<tr class="even">
<td><a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptprotectmemory"><strong>криптпротектмемори</strong></a></td>
...
<tr class="even">
<td><a href="/windows/desktop/api/Dpapi/nf-dpapi-cryptunprotectmemory"><strong>криптунпротектмемори</strong></a></td>
...
Следующие функции поддерживают [*двоичные объекты*](../secgloss/b-gly.md)формата обмена личной информацией (PFX).
...
| [**крипткатадминремовекаталог**](/windows/desktop/api/Mscat/nf-mscat-cryptcatadminremovecatalog)                     | Удаляет файл каталога и удаляет запись этого каталога из базы данных каталога Windows.                                                                                                                                                                                                                                         |
