---
description: Перечисляет расположения системных хранилищ сертификатов, хранилища системных сертификатов и физические хранилища, связанные с каждым системным хранилищем.
ms.assetid: bc4268ea-f657-4789-9d0a-6e5354508f86
title: 'Пример программы на C: перечисление системных и физических хранилищ'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105683824"
---
# <a name="example-c-program-listing-system-and-physical-stores"></a><span data-ttu-id="b26b8-103">Пример программы на C: перечисление системных и физических хранилищ</span><span class="sxs-lookup"><span data-stu-id="b26b8-103">Example C Program: Listing System and Physical Stores</span></span>

<span data-ttu-id="b26b8-104">В следующем примере перечисляются местоположения системных [*хранилищ сертификатов*](../secgloss/c-gly.md) , системные хранилища сертификатов и физические хранилища, связанные с каждым системным хранилищем.</span><span class="sxs-lookup"><span data-stu-id="b26b8-104">The following example enumerates the system [*certificate store*](../secgloss/c-gly.md) locations, the system certificate stores, and the physical stores associated with each system store.</span></span> <span data-ttu-id="b26b8-105">В этом примере демонстрируется создание функций обратного вызова и функций обратного вызова, которые вызывают другие функции обратного вызова.</span><span class="sxs-lookup"><span data-stu-id="b26b8-105">This example demonstrates the creation of callback functions and callback functions that call other callback functions.</span></span>

<span data-ttu-id="b26b8-106">В этом примере показаны следующие функции [*CryptoAPI*](../secgloss/c-gly.md) :</span><span class="sxs-lookup"><span data-stu-id="b26b8-106">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="b26b8-107">**цертенумсистемсторелокатион**</span><span class="sxs-lookup"><span data-stu-id="b26b8-107">**CertEnumSystemStoreLocation**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstorelocation)
-   [<span data-ttu-id="b26b8-108">**цертенумсистемсторе**</span><span class="sxs-lookup"><span data-stu-id="b26b8-108">**CertEnumSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstore)

<span data-ttu-id="b26b8-109">В этом примере также используется функция [**михандлиррор**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="b26b8-109">This example also uses the function [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="b26b8-110">Код для этой функции включен в пример.</span><span class="sxs-lookup"><span data-stu-id="b26b8-110">Code for this function is included with the sample.</span></span> <span data-ttu-id="b26b8-111">Код для этой и других вспомогательных функций также указан в разделе [общего назначения функции](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="b26b8-111">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
