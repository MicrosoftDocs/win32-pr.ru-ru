...
---
# <a name="example-c-program-listing-system-and-physical-stores"></a>Пример программы на C: перечисление системных и физических хранилищ

В следующем примере перечисляются местоположения системных [*хранилищ сертификатов*](../secgloss/c-gly.md) , системные хранилища сертификатов и физические хранилища, связанные с каждым системным хранилищем. В этом примере демонстрируется создание функций обратного вызова и функций обратного вызова, которые вызывают другие функции обратного вызова.

В этом примере показаны следующие функции [*CryptoAPI*](../secgloss/c-gly.md) :

-   [**цертенумсистемсторелокатион**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstorelocation)
-   [**цертенумсистемсторе**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstore)

В этом примере также используется функция [**михандлиррор**](myhandleerror.md). Код для этой функции включен в пример. Код для этой и других вспомогательных функций также указан в разделе [общего назначения функции](general-purpose-functions.md).
