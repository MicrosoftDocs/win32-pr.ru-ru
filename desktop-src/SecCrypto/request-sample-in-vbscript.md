...
ms.locfileid: "118900589"
---
# <a name="request-sample-in-vbscript"></a>Запрос примера в VBScript

В следующем примере кода на языке VBScript показано, как можно использовать элемент управления регистрации сертификатов с объектом Кцертрекуест для создания и отправки [*запроса на сертификат*](../secgloss/c-gly.md).
