...
---
# <a name="rsa-client-code-for-creating-the-master-key"></a>Код клиента RSA для создания главного ключа

В следующем примере показан типичный код на стороне клиента RSA/SChannel для создания [*главного ключа*](../secgloss/m-gly.md).
