...
| [**Закрыть**](store-close.md)   | Закрывает открытое хранилище сертификатов.<br/> **CAPICOM 2.0.0.3 и более ранние версии:** Метод [**Close**](store-close.md) не поддерживается.<br/>                                                               |
| [**Удалить**](store-delete.md) | Удаляет хранилище сертификатов, представленное текущим объектом [**хранилища**](certificate.md) .<br/> **CAPICOM 2.0.0.3 и более ранние версии:** Метод [**Delete**](store-delete.md) не поддерживается.<br/> |
...
| [**Открыт**](store-open.md)     | Открывает хранилище сертификатов.<br/>                                                                                                                                                                            |
