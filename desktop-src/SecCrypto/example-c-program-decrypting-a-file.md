...
ms.locfileid: "119007872"
---
# <a name="example-c-program-decrypting-a-file"></a>Пример программы на языке C. Расшифровка файла

В следующем примере показана расшифровка файла. В примере пользователю предлагается имя зашифрованного файла и имя файла, в который будут записываться расшифрованные данные. Файл с зашифрованными данными должен существовать. В примере создается или перезаписывается выходной файл.

В этом примере также запрашивается строка, используемая в качестве пароля. Если для создания ключа сеанса шифрования использовался пароль, то для создания ключа сеанса расшифровки необходимо указать этот же пароль. Дополнительные сведения см. [в разделе Пример программы C: шифрование файла](example-c-program-encrypting-a-file.md).
