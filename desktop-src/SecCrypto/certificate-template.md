---
description: Возвращает шаблон, связанный с сертификатом.
ms.assetid: 84fbf984-b932-4794-a939-de01e529d891
title: 'Метод ICertificate2:: Template'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Метод **шаблона** Возвращает шаблон, связанный с сертификатом. Этот метод появился в CAPICOM 2,0.
