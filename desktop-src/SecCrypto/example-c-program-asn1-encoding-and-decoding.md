...
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a>Пример программы на языке C: ASN. 1 кодирование и декодирование

В следующем примере показано использование [**криптенкодеобжектекс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) и [**криптдекодеобжектекс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex). Этот пример можно легко изменить для использования [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) и [**криптдекодеобжект**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).

В этом примере также используется измененная версия функции [**битетостр**](bytetostr.md) для печати [*абстрактной нотации синтаксиса*](../secgloss/a-gly.md) (ASN. 1) закодированной последовательности октетов. Он также использует [**михандлиррор**](myhandleerror.md). Код для этих функций включен в пример.
