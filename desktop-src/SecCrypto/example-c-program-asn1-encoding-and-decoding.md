---
description: Показывает использование Криптенкодеобжектекс и Криптдекодеобжектекс.
ms.assetid: 78108cd5-531e-4d0c-96cf-6f6264b7716c
title: 'Пример программы на языке C: ASN. 1 кодирование и декодирование'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104081224"
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a><span data-ttu-id="8936b-103">Пример программы на языке C: ASN. 1 кодирование и декодирование</span><span class="sxs-lookup"><span data-stu-id="8936b-103">Example C Program: ASN.1 Encoding and Decoding</span></span>

<span data-ttu-id="8936b-104">В следующем примере показано использование [**криптенкодеобжектекс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) и [**криптдекодеобжектекс**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span><span class="sxs-lookup"><span data-stu-id="8936b-104">The following example shows using [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) and [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span></span> <span data-ttu-id="8936b-105">Этот пример можно легко изменить для использования [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) и [**криптдекодеобжект**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span><span class="sxs-lookup"><span data-stu-id="8936b-105">This example can easily be modified to use [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) and [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span></span>

<span data-ttu-id="8936b-106">В этом примере также используется измененная версия функции [**битетостр**](bytetostr.md) для печати [*абстрактной нотации синтаксиса*](../secgloss/a-gly.md) (ASN. 1) закодированной последовательности октетов.</span><span class="sxs-lookup"><span data-stu-id="8936b-106">This example also uses a modified version of the function [**ByteToStr**](bytetostr.md) to print an [*Abstract Syntax Notation One*](../secgloss/a-gly.md) (ASN.1) encoded series of octets.</span></span> <span data-ttu-id="8936b-107">Он также использует [**михандлиррор**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="8936b-107">It also uses [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="8936b-108">Код для этих функций включен в пример.</span><span class="sxs-lookup"><span data-stu-id="8936b-108">Code for these functions is included with the sample.</span></span>
