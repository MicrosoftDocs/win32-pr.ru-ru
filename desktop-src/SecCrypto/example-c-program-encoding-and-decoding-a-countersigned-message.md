---
description: Показывает, как кодировать и декодировать сообщение скрепляющая подпись. В этом примере используется функция примера Михандлиррор. Код для функции Михандлиррор и других вспомогательных функций также указан в разделе общего назначения функции.
ms.assetid: 12930d4d-2ea5-4d95-b9cf-4f0dd351ce05
title: 'Пример программы на языке C: кодирование и декодирование сообщения скрепляющая подпись'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105684100"
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a><span data-ttu-id="4541a-105">Пример программы на языке C: кодирование и декодирование сообщения скрепляющая подпись</span><span class="sxs-lookup"><span data-stu-id="4541a-105">Example C Program: Encoding and Decoding a Countersigned Message</span></span>

<span data-ttu-id="4541a-106">В следующем примере показано, как кодировать и декодировать сообщение скрепляющая подпись.</span><span class="sxs-lookup"><span data-stu-id="4541a-106">The following example shows how to encode and decode a countersigned message.</span></span> <span data-ttu-id="4541a-107">В этом примере используется функция примера [**михандлиррор**](myhandleerror.md) .</span><span class="sxs-lookup"><span data-stu-id="4541a-107">This example uses the [**MyHandleError**](myhandleerror.md) example function.</span></span> <span data-ttu-id="4541a-108">Код для функции **михандлиррор** и других вспомогательных функций также указан в разделе [общего назначения функции](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="4541a-108">Code for the **MyHandleError** function and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
