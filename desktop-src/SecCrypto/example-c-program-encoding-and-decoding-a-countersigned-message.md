...
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a>Пример программы на языке C: кодирование и декодирование сообщения скрепляющая подпись

В следующем примере показано, как кодировать и декодировать сообщение скрепляющая подпись. В этом примере используется функция примера [**михандлиррор**](myhandleerror.md) . Код для функции **михандлиррор** и других вспомогательных функций также указан в разделе [общего назначения функции](general-purpose-functions.md).
