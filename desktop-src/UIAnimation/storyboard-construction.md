...
В этом обзоре основное внимание уделяется использованию переходов и раскадровок в анимации Windows. Общие сведения о компонентах анимации Windows см. в разделе [Общие сведения об анимации Windows](scenic-animation-api-overview.md).
