...
ms.locfileid: "119858234"
---
# <a name="multicast-programming-sample"></a>Пример многоадресного программирования

в следующем примере кода показано, как включить многоадресную функциональность в приложение Windows sockets с помощью параметров сокета.
