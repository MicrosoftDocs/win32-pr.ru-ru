...
---
# <a name="sample-code-for-a-service-provider"></a>Пример кода для поставщика услуг

Этот раздел содержит образец исходного кода, демонстрирующий реализацию функций **жетксбии** с помощью новых, независимых от протокола функций РНР. Разработчик должен реализовать эти функции в качестве отправной точки. Для соответствия спецификации Windows Sockets требуется много дополнительных функций.

> [!IMPORTANT]
> Не гарантируется компиляция следующего кода.
