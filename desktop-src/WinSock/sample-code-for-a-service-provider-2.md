...
ms.locfileid: "119794694"
---
# <a name="sample-code-for-a-service-provider"></a>Пример кода для поставщика услуг

Этот раздел содержит образец исходного кода, демонстрирующий реализацию функций **жетксбии** с помощью новых, независимых от протокола функций РНР. Разработчик должен реализовать эти функции в качестве отправной точки. для соответствия спецификации Windows sockets требуется еще много функций.
