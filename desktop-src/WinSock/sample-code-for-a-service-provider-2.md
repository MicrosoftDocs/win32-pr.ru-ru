---
description: Этот раздел содержит образец исходного кода, демонстрирующий реализацию функций Жетксбии с помощью новых, независимых от протокола функций РНР.
ms.assetid: d6246d47-11c2-4e4b-8a2b-17fd9cb041fc
title: Пример кода для поставщика услуг
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103812461"
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="ee87e-103">Пример кода для поставщика услуг</span><span class="sxs-lookup"><span data-stu-id="ee87e-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="ee87e-104">Этот раздел содержит образец исходного кода, демонстрирующий реализацию функций **жетксбии** с помощью новых, независимых от протокола функций РНР.</span><span class="sxs-lookup"><span data-stu-id="ee87e-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="ee87e-105">Разработчик должен реализовать эти функции в качестве отправной точки.</span><span class="sxs-lookup"><span data-stu-id="ee87e-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="ee87e-106">Для соответствия спецификации Windows Sockets требуется много дополнительных функций.</span><span class="sxs-lookup"><span data-stu-id="ee87e-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="ee87e-107">Не гарантируется компиляция следующего кода.</span><span class="sxs-lookup"><span data-stu-id="ee87e-107">The following code is not guaranteed to compile.</span></span>
