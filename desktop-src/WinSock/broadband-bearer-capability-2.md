...
---
# <a name="broadband-bearer-capability"></a>Возможности широкополосного носителя

В этом разделе перечислены значения, используемые для функции носителя широкополосной сети.
