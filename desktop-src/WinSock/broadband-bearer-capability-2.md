---
description: В этом разделе перечислены значения, используемые для функции носителя широкополосной сети.
ms.assetid: 9e45ca17-2aec-42e5-88a5-5ef1dc4238d9
title: Возможности широкополосного носителя
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104541626"
---
# <a name="broadband-bearer-capability"></a><span data-ttu-id="b759e-103">Возможности широкополосного носителя</span><span class="sxs-lookup"><span data-stu-id="b759e-103">Broadband Bearer Capability</span></span>

<span data-ttu-id="b759e-104">В этом разделе перечислены значения, используемые для функции носителя широкополосной сети.</span><span class="sxs-lookup"><span data-stu-id="b759e-104">This section lists the values used for the broadband bearer capability.</span></span>
