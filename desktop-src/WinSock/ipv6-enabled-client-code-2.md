---
description: Следующий код представляет собой независимый от IP-файла клиент. c, который является версией файла Симплек. c с поддержкой IPv6.
ms.assetid: a68439cd-0b27-447b-9766-e661c32eee09
title: Код клиента IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103991114"
---
# <a name="ipv6-enabled-client-code"></a><span data-ttu-id="4c43a-103">Код клиента IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="4c43a-103">IPv6-Enabled Client Code</span></span>

<span data-ttu-id="4c43a-104">Следующий код представляет собой независимый от IP-файла клиент. c, который является версией файла Симплек. c с поддержкой IPv6.</span><span class="sxs-lookup"><span data-stu-id="4c43a-104">The following code is the IP agnostic Client.c file, which is an IPv6-enabled version of the Simplec.c file.</span></span>
