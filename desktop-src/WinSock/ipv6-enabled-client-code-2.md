...
---
# <a name="ipv6-enabled-client-code"></a>Код клиента IPv6-Enabled

Следующий код представляет собой независимый от IP-файла клиент. c, который является версией файла Симплек. c с поддержкой IPv6.
