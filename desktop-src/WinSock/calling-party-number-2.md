...
---
# <a name="calling-party-number"></a><span data-ttu-id="0e8f4-103">Номер вызывающей стороны</span><span class="sxs-lookup"><span data-stu-id="0e8f4-103">Calling Party Number</span></span>

<span data-ttu-id="0e8f4-104">В этом разделе перечислены определения типов для номера вызывающей стороны.</span><span class="sxs-lookup"><span data-stu-id="0e8f4-104">This section lists the type definition for the calling party number.</span></span>
