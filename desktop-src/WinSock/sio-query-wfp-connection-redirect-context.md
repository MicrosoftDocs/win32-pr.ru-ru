...
код **управления \_ \_ \_ \_ \_ контекстом перенаправления подключения к службе SIO** получает контекст перенаправления для записи перенаправления, используемой службой перенаправления Windows фильтрации платформы (WFP).
...
в Windows 8 и Windows Server 2012, а также в более поздних версиях операционной системы поддерживается **\_ запрос на \_ \_ \_ перенаправление \_ подключения SIO** .
