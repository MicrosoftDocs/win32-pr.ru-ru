---
description: В этом разделе перечислены определения типов для высокоскоростных сведений о широкополосном уровне.
ms.assetid: b987dd6b-a611-4297-abaa-fd080cc94f6f
title: Сведения о низком уровне широкополосных данных
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103809760"
---
# <a name="broadband-lower-layer-information"></a><span data-ttu-id="fd8c0-103">Сведения о низком уровне широкополосных данных</span><span class="sxs-lookup"><span data-stu-id="fd8c0-103">Broadband Lower Layer Information</span></span>

<span data-ttu-id="fd8c0-104">В этом разделе перечислены определения типов для высокоскоростных сведений о широкополосном уровне.</span><span class="sxs-lookup"><span data-stu-id="fd8c0-104">This section lists the type definition for the broadband lower-layer information.</span></span>
