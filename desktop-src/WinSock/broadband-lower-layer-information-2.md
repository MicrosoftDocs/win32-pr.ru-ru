...
---
# <a name="broadband-lower-layer-information"></a>Сведения о низком уровне широкополосных данных

В этом разделе перечислены определения типов для высокоскоростных сведений о широкополосном уровне.
