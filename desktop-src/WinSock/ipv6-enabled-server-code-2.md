---
description: Следующий код является независимым от IP-адреса файлом Server. c, который представляет собой версию файла simple. c с поддержкой IPv6.
ms.assetid: 5e27c731-c9c7-4c49-91bd-6f4dee60460b
title: Код сервера IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104145034"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="d8b61-103">Код сервера IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="d8b61-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="d8b61-104">Следующий код является независимым от IP-адреса файлом Server. c, который представляет собой версию файла simple. c с поддержкой IPv6.</span><span class="sxs-lookup"><span data-stu-id="d8b61-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
