...
---
# <a name="ipv6-enabled-server-code"></a>Код сервера IPv6-Enabled

Следующий код является независимым от IP-адреса файлом Server. c, который представляет собой версию файла simple. c с поддержкой IPv6.
