...
Важно убедиться, что новые приложения Winsock и существующие приложения полностью совместимы с IPv6. Доступность пространства адресов IPv4 для новых выделений IPv4-адресов была исчерпана для Азии и Тихоокеанского региона в 2011. В течение нескольких лет ожидается, что другие части мира будут исчерпаны.
...
-   [Использование Internet Explorer для доступа к веб-сайтам IPv6](using-internet-explorer-to-access-ipv6-web-sites-2.md)
