...
---
# <a name="atm-traffic-descriptor"></a><span data-ttu-id="3b46f-103">Дескриптор трафика ATM</span><span class="sxs-lookup"><span data-stu-id="3b46f-103">ATM Traffic Descriptor</span></span>

<span data-ttu-id="3b46f-104">В этом разделе приводится список дескрипторов трафика ATM.</span><span class="sxs-lookup"><span data-stu-id="3b46f-104">This section lists the ATM traffic descriptor.</span></span>
