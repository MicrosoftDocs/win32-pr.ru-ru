...
IP-адрес \_ первоначального \_ прибытия, \_ Если параметр сокета поддерживается в Windows Server 2008 R2 и Windows 7.

## <a name="requirements"></a>Требования

| Требование | Значение |
|-|-|
| Header | <dl> <dt>Ws2def. h (включает Winsock2. h); </dt> <dt>Winsock2. h на Windows Server 2003 и Windows XP</dt> </dl> |
