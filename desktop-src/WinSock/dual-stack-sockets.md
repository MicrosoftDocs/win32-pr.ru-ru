---
description: для поддержки ipv4 и IPv6 в Windows XP с пакетом обновления 1 (SP1) и на Windows Server 2003 приложение должно создать два сокета, один сокет для использования с IPv4 и один сокет для использования с IPv6.
