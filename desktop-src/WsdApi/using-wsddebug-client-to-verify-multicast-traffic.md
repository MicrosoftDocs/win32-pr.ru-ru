...
В следующем примере выходных данных клиента отладки WSD отображается сообщение пробы. Элемент <WSA: Action> идентифицирует сообщение как сообщение пробы. Изучите поле <WSA: Action>, чтобы убедиться, что полученное сообщение является сообщением пробы.
...
В следующем примере выходных данных клиента отладки WSD отображается сообщение Hello. Элемент <WSA: Action> идентифицирует сообщение как сообщение Hello.
