...
| Элемент                                                                                                 | Описание                                                                                                                                                                                                           |
|---------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **CDATA**<br/>                                                                                    | Разделы Text и CDATA копируются в файл без изменения. Исходный код, который не является функцией входных данных контракта, может быть добавлен в выходные файлы с помощью текста и разделов CDATA.<br/> <br/> |
