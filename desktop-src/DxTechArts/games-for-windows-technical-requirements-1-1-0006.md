...
Мы не рекомендуем подписывать CAB-файлы, если они не являются достаточно мелкими (менее 100 МБ).
...
| RB, ФУНТОВ                                   | Краткие и левые обозначения спуска и метки контроллеров                                        |
