---
title: основные проблемы для заголовков Windows
...
ms.locfileid: "118396509"
---
# <a name="top-issues-for-windows-titles"></a>основные проблемы для заголовков Windows

группа "связи разработчиков Microsoft Windows games и Graphics" выполняет анализ производительности для многих Windows игр каждый год. Во время этих сеансов мы получаем практический опыт в отношении отзывов разработчиков и запросов, которые мы получаем ежедневно. Иногда мы можем отmysterious сбой или другую проблему в названии, что дает нам дополнительные сведения о проблемах, возникающих у разработчиков.
...
Кроме того, реальный размер повторно распространяемой папки можно настроить так, чтобы в нее включались только те CAB-файлы (.cab), которые действительно необходимы для целевых платформ и использования игр.
