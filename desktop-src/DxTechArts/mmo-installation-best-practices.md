...
Этот пример кода также будет работать в Windows Vista и Windows 7; Однако они также предоставляют программу командной строки Icacls для редактирования ACL файлов, которые можно использовать вместо этого.
