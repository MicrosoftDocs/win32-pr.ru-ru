...
description: в этой статье описывается Windows брандмауэр — почему он существует, что он делает и как это сделать. Что важнее всего, здесь описывается настройка игры для работы с брандмауэром.
...
ms.locfileid: "122882673"
---
# <a name="windows-firewall-for-game-developers"></a>Брандмауэр Windows для разработчиков игр

в этой статье описывается Windows брандмауэр — почему он существует, что он делает и как это сделать. Что важнее всего, здесь описывается настройка игры для работы с брандмауэром.

Содержимое:

-   [Что такое брандмауэр?](#what-is-a-firewall)
-   [Как узнать, затрагивается ли моя игра?](#how-can-i-tell-if-my-game-is-affected)
-   [брандмауэр до Windows XP с пакетом обновления 2 (SP2)](#the-firewall-before-windows-xp-sp2)
-   [Windows Брандмауэр XP с пакетом обновления 2 (SP2) лучше](#windows-xp-sp2-firewall-is-better)
...
## <a name="the-firewall-before-windows-xp-sp2"></a>брандмауэр до Windows XP с пакетом обновления 2 (SP2)
...
## <a name="windows-xp-sp2-firewall-is-better"></a>Windows Брандмауэр XP с пакетом обновления 2 (SP2) лучше

Windows Пакет обновления 2 (SP2) помещает варианты и параметры безопасности на передний план. Целью является защита по умолчанию и предоставление пользователю возможности получать сведения о том, какие приложения разрешено запускать на своем компьютере.

новый брандмауэр Windows доступен как в Windows XP с пакетом обновления 2, так и в Windows Server 2003 с пакетом обновления 1 (SP1). как и icf, это программный брандмауэр, поддерживающий как IPv4, так и IPv6, но в отличие от icf брандмауэр Windows:
...
| **Объектов** | (Корень пакета SDK) \\ Примеры на \\ языке C++FirewallInstallHelper.dll по дуге в других \\ \\ ячейках \\ &lt; &gt; \\ |
...
2.  Добавьте FirewallInstallHelper.dll в проект в виде файла поддержки.
    ...
    1.  на вкладке помощник Project откройте вкладку файлы приложения.
...
Брандмауэр будет оставаться в курсе. эти рекомендации позволят вашим заказчикам лучше работать с брандмауэром в Windowsной игре:
