...
| &lt;Диск &gt; : \\ Program Files                      | Файлы исполняемого приложения | X    |       |               |
| &lt;диск &gt; : \\ документы и Параметры \\ имя пользователя\* | Файлы каждого пользователя            | X    | X     | X             |
| &lt;диск &gt; : \\ документы и Параметры \\ все пользователи  | Все файлы пользователей               | X    | X     | X             |
