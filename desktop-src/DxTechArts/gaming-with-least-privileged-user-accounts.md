...
Windows поддерживает две файловые системы: FAT32 и NTFS. FAT32 — это устаревшая файловая система, которая поддерживается только для обеспечения обратной совместимости. NTFS поддерживает более мощные и надежные разрешения на доступ к файлам. Использование файловой системы NTFS в качестве розничных продавцов доставляют новые компьютеры с предварительно установленными ОС Windows на жестком диске с файловой системой NTFS. В системе Windows XP, основанной на NTFS, пользователи с учетными записями пользователей с минимальными правами имеют ограниченный доступ к нескольким папкам. Однако они будут иметь полный доступ к системе Windows XP на основе файловой системы FAT32.
...
| <Drive>: \\ Имя пользователя документов и параметров \\\* | Файлы каждого пользователя            | X    | X     | X             |
| <Drive>: \\ Documents and Settings \\ All Users  | Все файлы пользователей               | X    | X     | X             |
...
В учетной записи с минимальными правами доступа вы можете читать, записывать, создавать и удалять файлы в любой папке: Documents and Settings \\ username, Documents и Settings \\ All Users.
