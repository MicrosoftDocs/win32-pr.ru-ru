...
---
# <a name="ivmhostinfoosmajorversion-property"></a>Свойство Ивмхостинфо:: дочерний osmajorversion

\[Windows Virtual PC больше не доступна для использования в Windows 8. Вместо этого используйте [поставщик WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Извлекает основной номер версии операционной системы, работающей на размещающем компьютере.
