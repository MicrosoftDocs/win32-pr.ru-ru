...
ms.locfileid: "119653044"
---
# <a name="ivmvirtualmachinekeyboard-property"></a>Ивмвиртуалмачине:: Keyboard, свойство

\[Windows Virtual PC больше не доступен для использования в Windows 8. Вместо этого используйте [поставщик WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Извлекает устройство клавиатуры для виртуальной машины.
...
Объект [**ивмкэйбоард**](ivmkeyboard.md) .
