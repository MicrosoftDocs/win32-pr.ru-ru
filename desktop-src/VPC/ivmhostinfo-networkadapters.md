...
---
# <a name="ivmhostinfonetworkadapters-property"></a>Свойство Ивмхостинфо:: адаптера

\[Windows Virtual PC больше не доступна для использования в Windows 8. Вместо этого используйте [поставщик WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Получает перечисляемую коллекцию сетевых адаптеров на размещающем компьютере.
...
Коллекция сетевых интерфейсных карт. Это массив значений **BSTR** .
