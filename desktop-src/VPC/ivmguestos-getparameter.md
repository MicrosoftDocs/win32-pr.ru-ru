...
Виртуальная машина должна быть запущена, и при вызове этого метода должны быть установлены компоненты интеграции. этот метод поддерживается только для гостевых операционных систем на основе Windows.
