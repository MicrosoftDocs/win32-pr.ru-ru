...
## <a name="about-the-code-example"></a><span data-ttu-id="c8145-116">Сведения о примере кода</span><span class="sxs-lookup"><span data-stu-id="c8145-116">About the code example</span></span>
