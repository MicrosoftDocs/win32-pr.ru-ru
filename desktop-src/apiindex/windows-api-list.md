...
Ниже приведен список справочных материалов по интерфейсу прикладного программирования (API) Windows для настольных и серверных приложений.

С помощью API Windows можно разрабатывать приложения, которые успешно выполняются во всех версиях Windows, а также использовать возможности и возможности, уникальные для каждой версии. (Обратите внимание, что раньше это называлось API Win32. Имя API Windows более точно отражает его корни в 16-разрядной версии Windows и поддерживает 64-разрядную версию Windows.)

## <a name="user-interface"></a>Пользовательский интерфейс

API пользовательского интерфейса Windows создают и используют окна для вывода выходных данных, запроса вводимых пользователем данных и выполнения других задач, поддерживающих взаимодействие с пользователем. Большинство приложений создают по крайней мере одно окно.
...
-   [Многоязыковой интерфейс пользователя (MUI)](../intl/multilingual-user-interface-reference.md)
...
-   [Элементы пользовательского интерфейса](../devnotes/user-interface.md):
    ...
    -   [Панели инструментов](../controls/bumper-toolbar-toolbar-control-reference.md)
...
-   [Диспетчер анимации Windows](../uianimation/windows-animation-reference.md)
-   [Платформа ленты Windows](../windowsribbon/windowsribbon-reference-entry.md)

## <a name="windows-environment-shell"></a>Среда Windows (оболочка)

-   [Система свойств Windows](../properties/property-system-reference.md)
-   [Оболочка Windows](/previous-versions/windows/desktop/legacy/ff521731(v=vs.85))
...
-   [Окна и сообщения](../winmsg/windowing.md):
...
-   [Обмен данными](../dataxchg/data-exchange.md):

    -   [Буфер обмена](../dataxchg/clipboard-reference.md)
    -   [Платформа динамических данных Exchange (DDE)](../dataxchg/dynamic-data-exchange-reference.md)
    -   [Управление платформа динамических данных Exchange (ДДЕМЛ)](../dataxchg/dynamic-data-exchange-management-library-reference.md)
...
-   [Расширяемая подсистема хранилища](../extensible-storage-engine/extensible-storage-engine-reference.md)
...
-   [Состояние процесса (PSAPI)](../psapi/psapi-reference.md)
...
-   [Платформа устранения неполадок Windows](/previous-versions/windows/desktop/wintt/windows-troubleshooting-reference)
...
-   [Кодек аудио и видео Windows Media и DSP](/previous-versions//dd443208(v=vs.85))
-   [Windows Media Center](/previous-versions/windows/desktop/acquisition/programming-reference)
-   [Формат Windows Media](../wmformat/programming-reference.md)
-   [Службы общего доступа к библиотеке Windows Media](/previous-versions/windows/desktop/wmlss/windowsmedialibrarysharingservicesportal)
...
-   [Мультимедиа Windows](../multimedia/multimedia-reference.md)
...
-   [Доступ устройств](/previous-versions/windows/desktop/deviceaccess/device-access-api-c---programming-reference)
...
-   [Служба уведомлений о системных событиях (Сенс)](../sens/sens-reference.md)
...
-   [диспетчер устройств Windows Media](../wmdm/programming-reference.md)
-   [Портативные устройства Windows](../wpd_sdk/programming-reference.md)
...
-   [Общий доступ к рабочему столу Windows](/previous-versions/windows/desktop/rdp/windows-desktop-sharing-reference)
-   [Сведения о системе Windows](../sysinfo/windows-system-information.md)
...
-   [Родительский контроль](../parcon/parental-controls-reference.md)
...
-   [WMI в Защитнике Windows версии 2](/previous-versions/windows/desktop/defender/windows-defender-wmiv2-apis-portal)
-   [Windows Deployment Services](../wds/windows-deployment-services-portal.md)
-   [Подлинное преимущество Windows](/previous-versions/windows/desktop/wingen/windows-genuine-advantage-api-functions)
-   [Инфраструктура управления Windows](/previous-versions/windows/desktop/wmi_v2/wmi-reference)
...
-   [Средство оценки системы Windows](../winsat/winsat-reference.md)
-   [Агент обновления Windows](../wua_sdk/portal-client.md)

## <a name="networking-and-internet"></a>Сетевые подключения и Интернет
...
-   [Управление сетью](../netmgmt/network-management-reference.md)
...
-   [Службы HTTP Windows (WinHTTP)](../winhttp/winhttp-reference.md)
-   [Windows Internet (WinINet)](../wininet/wininet-reference.md)
-   [Сеть Windows (Внет)](../wnet/windows-networking-reference.md)
-   [Виртуализация сети Windows](/previous-versions/windows/desktop/wnv/windows-network-virtualization-portal)
-   [Платформа Windows RSS](/previous-versions/windows/desktop/ms684702(v=vs.85))
-   [Сокеты Windows (Winsock)](../winsock/winsock-reference.md)
-   [Веб-службы Windows](../wsw/windows-web-services-reference.md)
-   [Расширенный запрос XML HTTP](/previous-versions/windows/desktop/ixhr2/ixmlhttprequest2-portal)

## <a name="deprecated-or-legacy-apis"></a>Устаревшие или устаревшие API

Ниже перечислены технологии и интерфейсы API, устаревшие или замененные или устаревшие из клиентских и серверных операционных систем Windows.
...
-   [Сетевой платформа динамических данных Exchange (DDE)](../ipc/network-dde-reference.md)
-   [Служба удаленной установки](/previous-versions/windows/it-pro/windows-server-2003/cc786442(v=ws.10)). вместо этого используйте [службы развертывания Windows](../wds/windows-deployment-services-portal.md) .
-   [Служба виртуальных дисков (VDS)](../vds/vds-reference.md). вместо этого используйте [Управление хранилищем Windows](/previous-versions/windows/desktop/stormgmt/windows-storage-management-api-portal) .
-   Службы терминалов. Используйте [службы удаленных рабочих столов](../termserv/terminal-services-reference.md).
-   [Диспетчер прав Windows Media](/previous-versions//bb614742(v=vs.85))
...
-   [Боковая панель Windows](/previous-versions/windows/desktop/sidebar/-sidebar-ref-entry): вместо этого создайте приложения UWP.
-   [Windows SideShow](/previous-versions//ms744179(v=vs.85)): нет замены.
