...
ms.locfileid: "118428437"
---
# <a name="example-code-for-using-a-vlv-search"></a>Пример кода для использования поиска VLV

В следующих примерах кода для получения результатов поиска используется VLV Поиск.
...
В примерах функций этого раздела используются следующие примеры кода.
...
## <a name="getvlvitemcount-example-function"></a>Пример функции Жетвлвитемкаунт

В следующем примере кода показано, как использовать поиск VLV для получения оценки количества элементов, которые будут получены в результате поиска.
...
## <a name="getvlvitemtext-example-function"></a>Пример функции Жетвлвитемтекст

В следующем примере кода показано, как использовать поиск VLV для получения текста для одного элемента, основанного на индексе.
...
## <a name="getvlvitemsbystring-example-function"></a>Пример функции Жетвлвитемсбистринг

В следующем примере кода показано, как использовать поиск VLV для получения текста для указанного числа элементов на основе строки. В этом примере выполняется добавление сортировок, полученных в поле со списком.
