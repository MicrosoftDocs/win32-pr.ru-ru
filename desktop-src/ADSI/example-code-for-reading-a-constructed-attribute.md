...
ms.locfileid: "117840014"
---
# <a name="example-code-for-reading-a-constructed-attribute"></a>Пример кода для чтения сконструированного атрибута

В следующем примере кода показан метод, который можно использовать для получения значения атрибута, который будет работать со всеми типами атрибутов.
