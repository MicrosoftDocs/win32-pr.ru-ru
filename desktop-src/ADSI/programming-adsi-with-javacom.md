...
При компиляции убедитесь, что расширение языка Майкрософт включено. для этого выберите **&lt; &gt; свойства проекта...** в меню **Project** в окне проекта Visual J++. Затем перейдите на вкладку **Компиляция** в диалоговом окне **&lt; &gt; Свойства проекта** . Снимите флажок **Отключить расширения языка Майкрософт** . При компиляции из командной строки используйте параметр "/КС-", например:
