...
ms.locfileid: "118691063"
---
# <a name="iadsproperty-property-methods"></a>Методы свойств Иадспроперти

Методы свойств интерфейса [**иадспроперти**](/windows/desktop/api/Iads/nn-iads-iadsproperty) считывают и записывают свойства, описанные в следующей таблице. Дополнительные сведения о методах свойств см. в разделе [методы свойств интерфейса](interface-property-methods.md).
...
Поддерживает ли свойство одно или несколько значений.
...
Идентификатор объекта, зависящий от каталога.
...
Относительный путь к объекту синтаксиса.
...
В следующем примере кода проверяется атрибут **операционной** системы компьютера в сети с помощью поставщика WinNT.
...
В следующем примере кода проверяется атрибут **операционной** системы компьютера в сети с помощью поставщика WinNT. Для краткости проверка ошибок пропущена.
...
| IID<br/>                      | IID \_ иадспроперти определен как C8F93DD3-4ae0-11CF-9E73-00AA004A5691<br/>         |
