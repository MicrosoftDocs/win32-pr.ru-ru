...
**HKey \_ Локальная система \_ машин** \\  \\ **CurrentControlSet** \\ **Services** \\ **ADSI**, \\ **Трассировка** \\ ***processName***
...
**tracelog.exe-Start** *sessionname*  * *-GUID \# * * * * \_ GUID поставщика* **-f** *имя_файла* **-флаг** *флагов трассировки* **-Level** *TraceLevel*
