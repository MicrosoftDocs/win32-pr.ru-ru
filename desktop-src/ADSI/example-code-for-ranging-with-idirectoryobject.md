...
---
# <a name="example-code-for-ranging-with-idirectoryobject"></a>Пример кода для Идиректорйобжект

В следующем примере кода используется диапазон для получения членов группы с помощью интерфейса [**идиректорйобжект**](/windows/desktop/api/Iads/nn-iads-idirectoryobject) .
