...
---
# <a name="iadsprintjob-property-methods"></a>Методы свойств Иадспринтжоб

Методы свойств для интерфейса [**иадспринтжоб**](/windows/desktop/api/Iads/nn-iads-iadsprintjob) получают или задают свойства, описанные в следующей таблице. Дополнительные сведения см. в разделе [методы свойств интерфейса](interface-property-methods.md).
...
Строка ADsPath очереди печати, которая обрабатывает задание печати.
...
Пользователь, который будет уведомлен о завершении задания.
...
Строка ADsPath объекта User, которая будет уведомлена о завершении задания печати.
...
Самое раннее время запуска задания печати.
...
Время, когда задание было отправлено в очередь.
...
Общее число страниц в задании печати.
...
Последнее время, когда должно быть запущено задание печати.
...
Имя пользователя, отправившего задание печати.
...
Строка ADsPath объекта пользователя, отправившего это задание печати.
...
В следующем примере кода показано, как работать со свойствами объекта задания печати.
...
| IID<br/>                      | IID \_ иадспринтжоб определен как 32FB6780-1ED0-11CF-A988-00AA006BC149<br/>         |
