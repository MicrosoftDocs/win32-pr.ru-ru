...
ms.locfileid: "117840004"
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a>Пример кода для IDirectorySearch

В следующем примере кода используется диапазон для получения членов группы с помощью интерфейса [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .
