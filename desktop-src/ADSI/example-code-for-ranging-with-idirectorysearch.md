---
title: Пример кода для IDirectorySearch
description: В следующем примере кода используется диапазон для получения членов группы с помощью интерфейса IDirectorySearch.
ms.assetid: 13aba22f-c649-4dda-804f-01ba493cd6d7
ms.tgt_platform: multiple
keywords:
- Пример кода для IDirectorySearch ADSI
- Получение диапазона ADSI, пример кода, использование IDirectorySearch
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103986107"
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a><span data-ttu-id="8ba2e-105">Пример кода для IDirectorySearch</span><span class="sxs-lookup"><span data-stu-id="8ba2e-105">Example Code for Ranging with IDirectorySearch</span></span>

<span data-ttu-id="8ba2e-106">В следующем примере кода используется диапазон для получения членов группы с помощью интерфейса [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .</span><span class="sxs-lookup"><span data-stu-id="8ba2e-106">The following code example uses ranging to retrieve the members of a group using the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) interface.</span></span>
