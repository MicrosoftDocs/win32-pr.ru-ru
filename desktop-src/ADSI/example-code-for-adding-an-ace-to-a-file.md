...
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a>Пример кода для добавления элемента ACE в файл

В следующем примере кода показано, как использовать интерфейс [**иадссекуритютилити**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) для добавления ACE в файл.
