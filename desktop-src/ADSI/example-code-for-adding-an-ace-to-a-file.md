---
title: Пример кода для добавления элемента ACE в файл
description: В следующем примере кода показано, как использовать интерфейс Иадссекуритютилити для добавления ACE в файл.
ms.assetid: d47d3ebe-cc14-412d-be27-841e25b43c3a
ms.tgt_platform: multiple
keywords:
- Пример кода для добавления ACE в файл ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "105654135"
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a><span data-ttu-id="824d8-104">Пример кода для добавления элемента ACE в файл</span><span class="sxs-lookup"><span data-stu-id="824d8-104">Example Code for Adding an ACE to a File</span></span>

<span data-ttu-id="824d8-105">В следующем примере кода показано, как использовать интерфейс [**иадссекуритютилити**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) для добавления ACE в файл.</span><span class="sxs-lookup"><span data-stu-id="824d8-105">The following code example shows how to use the [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) interface to add an ACE to a file.</span></span>
