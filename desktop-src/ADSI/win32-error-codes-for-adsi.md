...
ADSI 2,0 сопоставляет коды ошибок LDAP набору кодов ошибок Win32, отличающихся от тех, которые использовались в ADSI для Windows 2000 и клиента DS. Различия перечислены в:
