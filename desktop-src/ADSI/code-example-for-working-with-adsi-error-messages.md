---
title: Пример кода для работы с сообщениями об ошибках ADSI
description: В следующем примере кода показано, как получить сообщение об ошибке ADSI.
ms.assetid: c09fea2e-b6c1-4318-a7a6-b1c4c30ef4cb
ms.tgt_platform: multiple
keywords:
- сообщения об ошибках и примеры кода для ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103887572"
---
# <a name="code-example-for-working-with-adsi-error-messages"></a><span data-ttu-id="4a0bf-104">Пример кода для работы с сообщениями об ошибках ADSI</span><span class="sxs-lookup"><span data-stu-id="4a0bf-104">Code Example for Working with ADSI Error Messages</span></span>

<span data-ttu-id="4a0bf-105">В следующем примере кода показано, как получить сообщение об ошибке ADSI.</span><span class="sxs-lookup"><span data-stu-id="4a0bf-105">The following code example shows how to retrieve an ADSI error message.</span></span>
