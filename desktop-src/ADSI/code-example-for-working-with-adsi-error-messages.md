...
---
# <a name="code-example-for-working-with-adsi-error-messages"></a>Пример кода для работы с сообщениями об ошибках ADSI

В следующем примере кода показано, как получить сообщение об ошибке ADSI.
