...
Уведомляет драйвер о том, что программный декодер начнет использовать компенсацию движения с указанным идентификатором GUID.
...
Обработчик для ранее созданного объекта режима ядра DirectDraw для устройства, на котором будет использоваться компенсация движения.

</dd> <dt>

*пукреатемокомпдата* \[ в, out\]
</dt> <dd>

Указатель на структуру [**DD \_ креатемокомпдата**](/windows/win32/api/ddrawint/ns-ddrawint-dd_createmocompdata) , которая содержит сведения, необходимые для начала использования компенсации движения.

</dd> </dl>

## <a name="return-value"></a>Возвращаемое значение

**Нтгдиддкреатемокомп** возвращает один из следующих кодов обратного вызова.
