---
description: В следующем примере показано, как использовать функцию Верифиеренумератересаурце и связанные элементы программирования для абстракции и классификации сведений о ресурсах, относящихся к конкретному процессу.
ms.assetid: e0c2c795-2960-44f9-8b63-2329f5b42e15
title: Использование перечисления ресурсов
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103990352"
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="4f2b1-103">Использование перечисления ресурсов</span><span class="sxs-lookup"><span data-stu-id="4f2b1-103">Using Resource Enumeration</span></span>

<span data-ttu-id="4f2b1-104">В следующем примере показано, как использовать функцию [**верифиеренумератересаурце**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) и связанные элементы программирования для абстракции и классификации сведений о ресурсах, относящихся к конкретному процессу.</span><span class="sxs-lookup"><span data-stu-id="4f2b1-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
