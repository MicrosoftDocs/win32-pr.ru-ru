...
---
# <a name="using-resource-enumeration"></a>Использование перечисления ресурсов

В следующем примере показано, как использовать функцию [**верифиеренумератересаурце**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) и связанные элементы программирования для абстракции и классификации сведений о ресурсах, относящихся к конкретному процессу.
