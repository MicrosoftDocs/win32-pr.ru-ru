...
ms.locfileid: "118956733"
---
# <a name="ntgdiddcancreated3dbuffer-function"></a>Функция NtGdiDdCanCreateD3DBuffer
...
Определяет, может ли драйвер создать команду уровня драйвера или буфер вершин указанного описания.
...
Указатель на структуру [**DD \_ канкреатесурфацедата**](/windows/win32/api/ddrawint/ns-ddrawint-dd_cancreatesurfacedata) . Эта структура содержит сведения, необходимые драйверу для определения возможности создания буфера команд или вершин.

</dd> </dl>

## <a name="return-value"></a>Возвращаемое значение

**NtGdiDdCanCreateD3DBuffer** возвращает один из следующих кодов обратного вызова.
