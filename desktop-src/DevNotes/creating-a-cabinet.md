...
ms.locfileid: "118667977"
---
# <a name="creating-a-cabinet"></a>Создание CAB-файла

Следующий синтаксис иллюстрирует создание CAB-файла.

> [!Note]  
> Этот код предназначен только для наглядных целей. Для компиляции необходимо определить функции обратного вызова.
...
[**фЦикреате**](/windows/desktop/api/Fci/nf-fci-fcicreate)
</dt> <dt>

[**фЦиаддфиле**](/windows/desktop/api/Fci/nf-fci-fciaddfile)
</dt> <dt>

[**фЦифлушфолдер**](/windows/desktop/api/Fci/nf-fci-fciflushfolder)
</dt> <dt>

[**фЦифлушкабинет**](/windows/desktop/api/Fci/nf-fci-fciflushcabinet)
</dt> <dt>

[**фЦидестрой**](/windows/desktop/api/Fci/nf-fci-fcidestroy)
</dt> <dt>
