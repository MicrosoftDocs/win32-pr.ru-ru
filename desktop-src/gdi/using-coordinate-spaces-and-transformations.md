...
ms.locfileid: "117885709"
---
# <a name="using-coordinate-spaces-and-transformations"></a>Использование пространств координат и преобразований

В этом разделе приведен пример, демонстрирующий следующие задачи:

-   Рисование графики с предопределенными единицами.
-   Центрирование графики в клиентской области приложения.
-   Масштабирование вывода графики до половины исходного размера.
-   Преобразование графического вывода 3/4 дюйма вправо.
-   Вращение графики на 30 градусов.
-   Наклон графического вывода вдоль оси x.
-   Отражение графического вывода о мнимой горизонтальной оси, нарисованной по средней точке.

Следующий пример использовался для создания иллюстраций, которые отображаются ранее в этом обзоре.
