...
ms.locfileid: "119965234"
---
# <a name="setting-the-pen-or-brush-color"></a>Настройка цвета пера или кисти

В следующем примере показано, как приложение может изменить цвет пера контроллера домена с помощью функции [**жетстоккобжект**](/windows/desktop/api/Wingdi/nf-wingdi-getstockobject) или [**Сетдкпенколор**](/windows/desktop/api/Wingdi/nf-wingdi-setdcpencolor) и функций [**сетдкбрушколор**](/windows/desktop/api/Wingdi/nf-wingdi-setdcbrushcolor) .
