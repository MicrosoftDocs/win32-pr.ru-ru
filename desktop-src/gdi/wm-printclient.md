...
Окна, которые могут использоваться в любом месте системы, например элементы управления, должны обрабатывать это сообщение. В других окнах может быть целесообразно обработать это сообщение, так как оно относительно легко реализуется.
