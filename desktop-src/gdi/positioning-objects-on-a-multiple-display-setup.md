...
ms.locfileid: "119558314"
---
# <a name="positioning-objects-on-a-multiple-display-setup"></a>Размещение объектов при настройке нескольких дисплеев

В следующем примере кода показано, как приложения могут правильно позиционировать объекты на несколько экранов. Обратите внимание, что значение RECT основано на источнике (0, 0).
