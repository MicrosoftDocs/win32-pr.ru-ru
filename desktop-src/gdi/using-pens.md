...
---
# <a name="using-pens"></a>Использование перьев

Этот раздел содержит образец кода, демонстрирующий внешний вид линий, созданных с помощью различных стилей и атрибутов пера.
