---
description: Альфа-смешение точечного рисунка
ms.assetid: 01ed3e2e-cfb3-42c9-9030-b64f9db088f1
title: Альфа-смешение точечного рисунка
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104985076"
---
# <a name="alpha-blending-a-bitmap"></a><span data-ttu-id="331c7-103">Альфа-смешение точечного рисунка</span><span class="sxs-lookup"><span data-stu-id="331c7-103">Alpha Blending a Bitmap</span></span>

<span data-ttu-id="331c7-104">В следующем примере кода окно делится на три области по горизонтали.</span><span class="sxs-lookup"><span data-stu-id="331c7-104">The following code sample divides a window into three horizontal areas.</span></span> <span data-ttu-id="331c7-105">Затем он рисует точечный рисунок с альфа-смешением в каждой области окна следующим образом:</span><span class="sxs-lookup"><span data-stu-id="331c7-105">Then it draws an alpha-blended bitmap in each of the window areas as follows:</span></span>

-   <span data-ttu-id="331c7-106">В верхней области константа Alpha = 50%, но нет исходного альфа-канала.</span><span class="sxs-lookup"><span data-stu-id="331c7-106">In the top area, constant alpha = 50% but there is no source alpha.</span></span>
-   <span data-ttu-id="331c7-107">В средней области константное альфа = 100% (отключено) и Source Alpha имеют значение 0 (прозрачный) в середине точечного рисунка и 0xFF (непрозрачный) в других местах.</span><span class="sxs-lookup"><span data-stu-id="331c7-107">In the middle area, constant alpha = 100% (disabled) and source alpha is 0 (transparent) in the middle of the bitmap and 0xff (opaque) elsewhere.</span></span>
-   <span data-ttu-id="331c7-108">В нижней области константа Alpha = 75% и изменения исходного альфа-канала.</span><span class="sxs-lookup"><span data-stu-id="331c7-108">In the bottom area, constant alpha = 75% and source alpha changes.</span></span>
