...
---
# <a name="alpha-blending-a-bitmap"></a>Альфа-смешение точечного рисунка

В следующем примере кода окно делится на три области по горизонтали. Затем он рисует точечный рисунок с альфа-смешением в каждой области окна следующим образом:

-   В верхней области константа Alpha = 50%, но нет исходного альфа-канала.
-   В средней области константное альфа = 100% (отключено) и Source Alpha имеют значение 0 (прозрачный) в середине точечного рисунка и 0xFF (непрозрачный) в других местах.
-   В нижней области константа Alpha = 75% и изменения исходного альфа-канала.
