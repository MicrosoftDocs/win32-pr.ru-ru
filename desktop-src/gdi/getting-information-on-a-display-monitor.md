...
ms.locfileid: "117886727"
---
# <a name="getting-information-on-a-display-monitor"></a>Получение сведений о мониторе отображения

В следующем примере кода показано, как использовать [**енумдисплайдевицес**](/windows/desktop/api/Winuser/nf-winuser-enumdisplaydevicesa) для получения сведений о мониторе монитора.
