---
description: В этом разделе содержится пример кода, позволяющий пользователю выбрать шрифт определенного размера (с помощью диалогового окна Выбор шрифта), выбрать путь обрезки (с помощью текста, нарисованного с этим шрифтом), а затем просмотреть результат обрезки в текст.
ms.assetid: 3eb5781b-972b-49a4-94db-9abda96fb195
title: Использование путей
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104156259"
---
# <a name="using-paths"></a><span data-ttu-id="201bc-103">Использование путей</span><span class="sxs-lookup"><span data-stu-id="201bc-103">Using Paths</span></span>

<span data-ttu-id="201bc-104">В этом разделе содержится пример кода, позволяющий пользователю выбрать шрифт определенного размера (с помощью диалогового окна Выбор шрифта), выбрать путь обрезки (с помощью текста, нарисованного с этим шрифтом), а затем просмотреть результат обрезки в текст.</span><span class="sxs-lookup"><span data-stu-id="201bc-104">This section contains a code sample that enables the user to select a font of a particular point size (by using the Choose Font dialog box), select a clip path (by using text drawn with this font), and then view the result of clipping to the text.</span></span>

<span data-ttu-id="201bc-105">Этот пример кода использовался для создания иллюстрации, отображаемой в [путях обрезки](clip-paths.md).</span><span class="sxs-lookup"><span data-stu-id="201bc-105">This code sample was used to create the illustration that appears in [Clip Paths](clip-paths.md).</span></span>
