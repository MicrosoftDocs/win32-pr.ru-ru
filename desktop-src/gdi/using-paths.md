...
---
# <a name="using-paths"></a>Использование путей

В этом разделе содержится пример кода, позволяющий пользователю выбрать шрифт определенного размера (с помощью диалогового окна Выбор шрифта), выбрать путь обрезки (с помощью текста, нарисованного с этим шрифтом), а затем просмотреть результат обрезки в текст.

Этот пример кода использовался для создания иллюстрации, отображаемой в [путях обрезки](clip-paths.md).
