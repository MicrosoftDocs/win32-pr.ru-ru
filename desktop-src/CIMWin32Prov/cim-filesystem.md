...
Класс **\_ файловой системы CIM** представляет собой файл или набор данных, который является локальным для компьютера или удаленно подключен с файлового сервера.
