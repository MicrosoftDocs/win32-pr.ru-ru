...
ms.locfileid: "119080998"
---
# <a name="cim_action-class"></a>\_Класс действия CIM

Класс **\_ действия CIM** — это операция, которая является частью процесса для создания программного элемента в следующем состоянии или для исключения программного элемента в текущем состоянии.
...
Класс **\_ действия CIM** имеет следующие методы.



| Метод                                              | Описание                                                   |
|:----------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-action.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Класс **\_ действия CIM** имеет следующие свойства.
...
Указывает, является ли конкретный объект **\_ действия CIM** частью последовательности действий, чтобы перевести текущий программный элемент в следующее состояние, например "установить", или удалить текущий программный элемент, например "Удалить".
...
Инструментарий WMI не реализует этот класс. См. раздел [Классы Win32](win32-provider.md) для классов, производных от **\_ действия CIM**.
