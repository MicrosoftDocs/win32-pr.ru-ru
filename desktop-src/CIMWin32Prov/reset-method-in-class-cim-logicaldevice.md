...
---
# <a name="reset-method-of-the-cim_logicaldevice-class-cimwin32-wmi-providers"></a>Метод Reset класса CIM_LogicalDevice (поставщики WMI CIMWin32)

Метод **Reset** \_ класса CIM логическое устройство запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[Модель \_ CIM](reset-method-in-class-cim-logicaldevice.md)
</dt> <dt>
