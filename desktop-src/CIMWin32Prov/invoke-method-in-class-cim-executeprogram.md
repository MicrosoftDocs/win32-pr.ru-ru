...
ms.locfileid: "120065104"
---
# <a name="invoke-method-of-the-cim_executeprogram-class"></a>Метод Invoke \_ класса CIM ексекутепрограм

Метод **Invoke** класса [**CIM \_ ексекутепрограм**](cim-executeprogram.md) принимает определенное действие. Сведения о том, как метод выполняет действие, зависят от реализации. Этот метод наследуется [**от \_ действия CIM**](cim-action.md).
...
[\_ЕКСЕКУТЕПРОГРАМ CIM](invoke-method-in-class-cim-executeprogram.md)
</dt> <dt>
