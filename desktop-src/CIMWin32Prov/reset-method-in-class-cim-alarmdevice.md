...
---
# <a name="reset-method-of-the-cim_alarmdevice-class"></a>Метод Reset \_ класса CIM алармдевице

Метод **Reset** класса [**CIM \_ алармдевице**](cim-alarmdevice.md) запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_АЛАРМДЕВИЦЕ CIM](reset-method-in-class-cim-alarmdevice.md)
</dt> <dt>
