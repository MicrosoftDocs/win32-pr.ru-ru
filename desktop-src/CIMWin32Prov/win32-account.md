---
description: Содержит сведения об учетных записях пользователей и группах, известных компьютерным системам, на которых работает Windows.
...
Абстрактный [класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ учетной записи Win32** содержит сведения об учетных записях пользователей и группах, известных компьютерным системам, на которых работает Windows. имена пользователей или групп, распознаваемых доменом Windows, являются потомками (или членами) этого класса.
