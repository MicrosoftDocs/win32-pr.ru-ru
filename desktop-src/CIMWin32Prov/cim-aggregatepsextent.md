...
Класс **CIM \_ аггрегатепсекстент** содержит следующие методы.
...
Класс **CIM \_ аггрегатепсекстент** является производным от [**CIM \_ сторажеекстент**](cim-storageextent.md).
