...
Класс **CIM \_ дискспацечекк** имеет следующие типы членов:
...
Класс **CIM \_ дискспацечекк** содержит следующие методы.
...
Класс **CIM \_ дискспацечекк** имеет следующие свойства.
