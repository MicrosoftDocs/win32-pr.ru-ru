...
[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ дкомаппликатион для Win32** представляет свойства DCOM-приложения.
...
Глобальный уникальный идентификатор (GUID) для DCOM-приложения.
...
[**\_Комаппликатион Win32**](win32-comapplication.md)
</dt> <dt>
