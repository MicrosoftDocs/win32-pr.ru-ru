...
ms.locfileid: "119751384"
---
# <a name="win32_comclassemulator-class"></a>\_Класс Win32 комклассемулатор

[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) взаимосвязей **Win32 \_ комклассемулатор** связывает две версии класса модели COM.
...
Класс **Win32 \_ комклассемулатор** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **Win32 \_ комклассемулатор** имеет следующие свойства.
...
Ссылка на экземпляр, представляющий COM-компонент, который содержит интерфейсы, имитирующие старую версию компонента.
...
Ссылка на экземпляр, представляющий COM-компонент с интерфейсами, которые могут эмулироваться новой версией компонента.
