...
ms.locfileid: "118418527"
---
# <a name="reset-method-of-the-cim_usbdevice-class"></a>Метод Reset \_ класса CIM усбдевице

Метод **Reset** \_ класса CIM усбдевице запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_УСБДЕВИЦЕ CIM](reset-method-in-class-cim-usbdevice.md)
</dt> <dt>
