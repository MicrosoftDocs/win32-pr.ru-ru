...
Windows Server 2008 содержит драйверы ИБП (APC) в ОС, что позволяет рассматривать ИБП как питание от аккумулятора. Это позволяет отслеживать состояние ИБП с помощью сценария и предпринимать необходимые действия.
