...
ms.locfileid: "119021092"
---
# <a name="cim_managementcontroller-class"></a>\_Класс CIM манажементконтроллер

Класс **CIM \_ манажементконтроллер** относится к возможностям и управлению контроллером управления.
...
Класс **CIM \_ манажементконтроллер** имеет следующие типы членов:
...
Класс **CIM \_ манажементконтроллер** содержит следующие методы.



| Метод                                                                          | Описание                                                                                                                              |
|:--------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-managementcontroller.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-managementcontroller.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ манажементконтроллер** имеет следующие свойства.
...
Класс **CIM \_ манажементконтроллер** является производным от [**\_ контроллера CIM**](cim-controller.md).
