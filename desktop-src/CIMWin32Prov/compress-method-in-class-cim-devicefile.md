...
ms.locfileid: "119816704"
---
# <a name="compress-method-of-the-cim_devicefile-class"></a>Метод сжатия \_ класса CIM девицефиле

Метод **сжатия** сжимает логический файл (или каталог), указанный в пути объекта. Этот метод наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[\_ДЕВИЦЕФИЛЕ CIM](compress-method-in-class-cim-devicefile.md)
</dt> <dt>
