...
ms.locfileid: "119751294"
---
# <a name="win32_heatpipe-class"></a>\_Класс Win32 хеатпипе

[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ хеатпипе для Win32** представляет свойства устройства охлаждения теплоотвода.
...
Класс **Win32 \_ хеатпипе** имеет следующие типы членов:
...
Класс **Win32 \_ хеатпипе** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ хеатпипе**](cim-heatpipe.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ хеатпипе**](cim-heatpipe.md) .<br/> |
...
Класс **Win32 \_ хеатпипе** имеет следующие свойства.
...
Если **значение равно true**, устройство охлаждения предоставляет активное охлаждение, не пассивное.
...
Уникальный идентификатор теплового канала.
...
Если **значение — true**, Управление питанием устройства может осуществляться в режиме приостановки и т. д. Свойство не указывает на то, что функции управления питанием включены в настоящее время, только что логическое устройство поддерживает управление питанием.
...
Класс **Win32 \_ хеатпипе** является производным от [**CIM \_ хеатпипе**](cim-heatpipe.md).
