...
Статический метод класса **SetTcpUseRFC1122UrgentPointer** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) используется для указания того, использует ли TCP спецификацию RFC 1122 для срочных данных или режим, используемый в производных системах проектирования программного обеспечения (BSD).
...
*TcpUseRFC1122UrgentPointer* \[ окне\]
</dt> <dd>

Если **значение — true**, TCP использует спецификацию RFC 1122. Если задано **значение false**, срочные данные отправляются в режиме, который используется системами, производными от BSD.
