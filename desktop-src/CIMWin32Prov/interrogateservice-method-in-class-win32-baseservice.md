...
ms.locfileid: "119760404"
---
# <a name="interrogateservice-method-of-the-win32_baseservice-class"></a>Метод Интеррогатесервице \_ класса Win32 басесервице

Метод  [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) интеррогатесервице запрашивает обновление состояния службы до Service Manager.
