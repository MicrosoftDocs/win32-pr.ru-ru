...
ms.locfileid: "119817564"
---
# <a name="cim_uninterruptiblepowersupply-class"></a>\_Класс CIM унинтерруптиблеповерсуппли

Класс **CIM \_ унинтерруптиблеповерсуппли** представляет возможности и управление источником бесперебойного питания (ИБП). Свойства ИБП указывают, когда обрезается или повышается Входящая мощность, а также сводные данные о батареях, генераторах и т. д., которые составляют устройство. Отдельные компоненты (например, несколько батарей) также могут быть независимо смоделированы и связаны с ИБП.
...
Класс **CIM \_ унинтерруптиблеповерсуппли** имеет следующие типы членов:
...
Класс **CIM \_ унинтерруптиблеповерсуппли** содержит следующие методы.



| Метод                                                                                | Описание                                                                                                                              |
|:--------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-uninterruptiblepowersupply.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-uninterruptiblepowersupply.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ унинтерруптиблеповерсуппли** имеет следующие свойства.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,15 ")
</dt> </dl>

Диапазон входного напряжения в настоящее время используется. Если в данный момент не выполняется прорисовка энергии, можно указать значение 6 ("ни одного"). Эти сведения необходимы в случае ИБП, подклассом [**\_ источника питания CIM**](cim-powersupply.md).

Это свойство наследуется [**от \_ источника питания CIM**](cim-powersupply.md).
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| UPS батарея \| 001,4 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" процент ")
</dt> </dl>

Процентная Оценка оставшегося полной оплаты за ИБП, использующий технологию аккумулятора.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| UPS аккумулятора \| 001,3 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" минуты ")
</dt> </dl>

Предполагаемое время в минутах, пока батарея, генератор или другой источник питания не будут исчерпаны в условиях текущей нагрузки, если выключена программа или она потеряна и остается выключенной.
...
Если **значение равно true**, источник питания является переключением (а не линейным).
...
Квалификаторы: [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("Герц")
</dt> </dl>

Частота (в герцах) в верхней части диапазона входной частоты источника питания 1. Значение 0 (нуль) подразумевает использование контроллера домена.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,17 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>

Частота в герцах в нижней части диапазона входной частоты источника питания 1. Значение 0 (нуль) подразумевает использование контроллера домена.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("милливольтах")
</dt> </dl>

Если напряжение в милливольтах превышает значение, указанное свойством **Range1InputVoltageHigh** , ИБП будет компенсировать, обрезая напряжение. Значение 0 (ноль) указывает, что напряжение, при котором происходит усечение, неизвестно.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("милливольтах")
</dt> </dl>

Если напряжение в милливольтах падает ниже значения, указанного свойством **Range1InputVoltageLow** , ИБП будет компенсировать, повышая напряжение с помощью источников питания. Значение 0 указывает, что напряжение, при котором происходит повышение, неизвестно.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,20 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>

Частота в герцах в высоком уровне диапазона входной частоты источника питания 2. Значение 0 (нуль) подразумевает использование контроллера домена.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,19 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>

Частота в герцах в нижней части диапазона входной частоты источника питания 2. Значение 0 означает, что DC.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("милливольтах")
</dt> </dl>

Если напряжение в милливольтах превышает значение, указанное свойством **Range2InputVoltageHigh** , ИБП будет компенсировать, обрезая напряжение. Значение 0 (ноль) указывает, что напряжение, при котором происходит усечение, неизвестно.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("милливольтах")
</dt> </dl>

Если напряжение в милливольтах падает ниже значения, указанного свойством **Range2InputVoltageLow** , ИБП будет компенсировать, повышая напряжение с помощью источников питания. Значение 0 (ноль) указывает, что напряжение, при котором происходит повышение, неизвестно.

Это свойство наследуется [**от \_ источника питания CIM**](cim-powersupply.md).

</dd> <dt>

**ремаинингкапаЦитистатус**
</dt> <dd> <dl> <dt>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Заряд батареи ибп \| 001,1 (DMTF)
</dt> </dl>

Сведения о емкости, остающейся в батареях ИБП, генераторе или другом источнике.
...
<span id="Normal"></span><span id="normal"></span><span id="NORMAL"></span>**Обычная** (2)


</dt> <dd>

Оставшиеся расчетные минуты времени выполнения больше, чем заданное состояние низкого энергопотребления (обычно две минуты).

</dd> <dt>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>**Низкая** (3)


</dt> <dd>

Оставшиеся расчетные минуты времени выполнения меньше или равны определению низкого энергопотребления.

</dd> <dt>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>**Исчерпано** (4)


</dt> <dd>

ИБП не сможет поддерживать текущую нагрузку при потере питания служебной программы (в том числе о том, что в настоящее время она отсутствует).
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| UPS батарея \| 001,2 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" секунды ")
</dt> </dl>

Затраченное время в секундах с момента последнего переключения ИБП на питание от аккумулятора, генератор или другой источник питания. Или, время с момента последнего перезапуска ИБП, в зависимости от того, что меньше. Если ИБП находится в режиме «в сети», будет возвращено значение 0 (нуль).
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,21 "), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) (" МВт ")
</dt> </dl>

Общая выходная мощность источника питания в МВт. Значение 0 (ноль) обозначает Unknown.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Источник питания DMTF \| 002,16 ")
</dt> </dl>

Тип переключения диапазона входного напряжения, реализованного в источнике питания.
...
Класс **CIM \_ унинтерруптиблеповерсуппли** является производным от [**\_ источника питания CIM**](cim-powersupply.md).

Инструментарий WMI не реализует этот класс. Классы WMI, производные от **CIM \_ унинтерруптиблеповерсуппли**, см. в разделе [Классы Win32](win32-provider.md).
