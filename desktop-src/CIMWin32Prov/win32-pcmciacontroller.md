...
ms.locfileid: "117834164"
---
# <a name="win32_pcmciacontroller-class"></a>\_Класс Win32 пкмЦиаконтроллер

[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ пкмЦиаконтроллер для Win32** управляет возможностями интерфейса адаптера памяти личного компьютера с контроллером контроллера PC Card (PCMCIA).
...
Класс **Win32 \_ пкмЦиаконтроллер** имеет следующие типы членов:
...
Класс **Win32 \_ пкмЦиаконтроллер** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ пкмЦиаконтроллер**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ пкмЦиаконтроллер**](cim-pcmciacontroller.md).<br/> |
...
Класс **Win32 \_ пкмЦиаконтроллер** имеет следующие свойства.
...
Квалификаторы: [**переопределить**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**Key**](../wmisdk/key-qualifier.md), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Уникальный идентификатор этого устройства с другими периферийными устройствами с помощью самонастраивающийся BIOS. Это свойство является производным [**от \_ CIM**](cim-logicaldevice.md)с параметром.
...
Это свойство наследуется от [**CIM \_ пкмЦиаконтроллер**](cim-pcmciacontroller.md).
...
Класс **Win32 \_ пкмЦиаконтроллер** является производным от [**CIM \_ пкмЦиаконтроллер**](cim-pcmciacontroller.md).
