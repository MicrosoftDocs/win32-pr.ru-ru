...
| Метод                                                              | Описание                                                                     |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-directoryspecification.md) | Оценивает определенную проверку. Этот метод не реализован инструментарием WMI.<br/> |
