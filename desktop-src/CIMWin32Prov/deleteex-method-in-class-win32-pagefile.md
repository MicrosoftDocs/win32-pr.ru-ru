...
ms.locfileid: "119918444"
---
# <a name="deleteex-method-of-the-win32_pagefile-class"></a>Метод Делетикс \_ класса файла подкачки Win32

Метод  [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) делетикс удаляет логический файл подкачки (или каталог), указанный в пути к объекту. **Делетикс** — это расширенная версия метода [**Delete**](delete-method-in-class-win32-directory.md) .
