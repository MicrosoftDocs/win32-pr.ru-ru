...
---
# <a name="reset-method-of-the-cim_binarysensor-class"></a>Метод Reset \_ класса CIM бинарисенсор

Метод **Reset** \_ класса CIM бинарисенсор запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_БИНАРИСЕНСОР CIM](reset-method-in-class-cim-binarysensor.md)
</dt> <dt>
