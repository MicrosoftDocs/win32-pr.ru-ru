...
ms.locfileid: "119918224"
---
# <a name="uncompress-method-of-the-cim_devicefile-class"></a>Метод uncompressия класса CIM \_ девицефиле

Метод **uncompressия** распаковать файл логического устройства (или каталог), указанный в пути к объекту. Этот метод наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[\_ДЕВИЦЕФИЛЕ CIM](uncompress-method-in-class-cim-devicefile.md)
</dt> <dt>
