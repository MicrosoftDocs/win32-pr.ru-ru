...
---
# <a name="win32_smbiosmemory-class"></a>\_Класс Win32 смбиосмемори

Абстрактный [класс WMI](../wmisdk/retrieving-a-class.md) **\_ смбиосмемори Win32** представляет свойства памяти системы компьютера, как показано в интерфейсе System Management BIOS (SMBIOS). Интерфейс SMBIOS не различает временные, временные и Flash-воспоминания. Класс [**\_ памяти CIM**](cim-memory.md) является родительским классом для всех типов памяти.
...
Класс **Win32 \_ смбиосмемори** имеет следующие типы членов:
...
Класс **Win32 \_ смбиосмемори** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ сторажеекстент**](cim-storageextent.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ сторажеекстент**](cim-storageextent.md).<br/> |
...
Класс **Win32 \_ смбиосмемори** имеет следующие свойства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32 — сведения об ошибке в памяти \| поставщика синдром"), [**Max**](../wmisdk/standard-qualifiers.md) (64)
</dt> </dl>

Массив октетов, содержащих дополнительные сведения об ошибке. Примером является проверка ошибок и исправление ошибки (ECC) синдром или возвращение битов проверки, если используется методология ошибок на основе CRC. В последнем случае, если распознана одна разрядная ошибка и известен алгоритм циклической проверки избыточности (CRC), можно определить точный бит, который не удалось выполнить. Этот тип данных (ECC синдром, бит проверки битов или бит четности или другая предоставленная информация поставщика) включен в это поле. Если свойство **errorInfo** равно 3 (ОК), это свойство не имеет смысла.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("MIB. IETF \| Host-Resources-MIB. хрсторажеаллокатионунитс "), [**Units**](../wmisdk/standard-qualifiers.md) (" bytes ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32-разрядный тип ошибки сведений об ошибках памяти \| ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 19 \| памяти, сопоставленные адреса \| конечного адреса")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32-разрядная ошибка со сведениями об ошибке в памяти \| ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32-разрядный адрес ошибки в информации об ошибках памяти \| ")
</dt> </dl>
...
Квалификаторы: [**arrayType**](../wmisdk/standard-qualifiers.md) ("индексированный"), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("SMBIOS"), [**Max**](../wmisdk/standard-qualifiers.md) (64)
</dt> </dl>
...
Квалификаторы: [**моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**\_ память CIM**](cim-memory.md)".**Осереррордескриптион**"), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32-разрядный тип ошибки сведений об ошибках памяти \| ")
</dt> </dl>

Тип ошибки, которая возникла в последнее время. Значения от 12 до 14 не используются. Возможность исправления указывается в свойстве **корректаблиррор**.
...
Квалификаторы: [**override**](../wmisdk/standard-qualifiers.md) ("еррормесодологи"), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 16, \| \| исправление ошибки памяти массива физической памяти")
</dt> </dl>

Сведения о алгоритмах четности и CRC, а также об ECC или других используемых механизмах.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 18 \| 32-разрядная ошибка при \| устранении ошибок в памяти"), [**единицы**](../wmisdk/standard-qualifiers.md) ("байт")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("SMBIOS"), [**Units**](../wmisdk/standard-qualifiers.md) ("BITS")
</dt> </dl>

Размер передачи данных в битах, вызвавших последнюю ошибку — 0 (ноль) указывает на отсутствие ошибки. Если свойство **errorInfo** равно 3 (ОК), то этому свойству должно быть присвоено значение 0 (ноль).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("MIB. \|Основной узел IETF-Resources-MIB. хрсторажесизе ")
</dt> </dl>
...
Квалификаторы: [**моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**\_ память CIM**](cim-memory.md)".**ErrorInfo**"), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" SMBIOS ")
</dt> </dl>

Произвольная строка, которая предоставляет дополнительные сведения, если свойство **ErrorType** имеет значение 1; в противном случае эта строка не имеет смысла.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 19 \| памяти, сопоставленные адреса \| начальный адрес")
</dt> </dl>

Начальный адрес, на который ссылается приложение или операционная система, который сопоставлен контроллером памяти для этого объекта памяти. Начальный адрес указывается в килобайтах.
...
Класс **Win32 \_ смбиосмемори** является производным от [**CIM \_ сторажеекстент**](cim-storageextent.md).
