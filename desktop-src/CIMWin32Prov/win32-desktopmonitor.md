...
[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ десктопмонитор для Win32** представляет тип монитора или устройства отображения, подключенного к компьютерной системе.
...
Класс **Win32 \_ десктопмонитор** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ десктопмонитор**](cim-desktopmonitor.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ десктопмонитор**](cim-desktopmonitor.md) .<br/> |
...
Класс **Win32 \_ десктопмонитор** имеет следующие свойства.
...
Пропускная способность монитора в мегагерцах. Если значение неизвестно, введите 0 (ноль).

Это свойство наследуется от [**CIM \_ десктопмонитор**](cim-desktopmonitor.md).
...
квалификаторы: [**ключ**](/windows/desktop/WmiSdk/key-qualifier), [**переопределение**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceId"), [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32API \| Windows GDI \| хмонитор")
</dt> </dl>

Уникальный идентификатор монитора рабочего стола.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32APIные \| функции контекста \| [**жетдевицекапс**](/windows/desktop/api/wingdi/nf-wingdi-getdevicecaps)"), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("пикселей на логический дюйм")
</dt> </dl>

Разрешение по оси x (горизонтальное направление) монитора.
...
Разрешение по оси y (вертикальное направление) монитора.
...
Логическая высота экрана в координатах экрана.
...
Логическая ширина экрана в экранных координатах.
