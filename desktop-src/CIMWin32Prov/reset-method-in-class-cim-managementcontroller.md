...
Метод **Reset** \_ класса CIM манажементконтроллер запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_МАНАЖЕМЕНТКОНТРОЛЛЕР CIM](reset-method-in-class-cim-managementcontroller.md)
</dt> <dt>
