...
ms.locfileid: "119971896"
---
# <a name="win32_pnpdevicepropertysecuritydescriptorarray-class"></a>\_Класс Win32 пнпдевицепропертисекуритидескриптораррай

Представляет свойство устройства PnP, состоящее из массива элементов [**Win32 \_ SecurityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor) .
...
Класс **Win32 \_ пнпдевицепропертисекуритидескриптораррай** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **Win32 \_ пнпдевицепропертисекуритидескриптораррай** имеет следующие свойства.
...
Тип данных: массив **[**Win32 \_ SecurityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor)**
</dt> <dt>
