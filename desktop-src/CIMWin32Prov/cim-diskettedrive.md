...
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>Класс CIM_DisketteDrive (поставщики WMI CIMWin32)

Класс **CIM \_ дискеттедриве** представляет возможности и управление флоппи-дисководом.
...
Класс **CIM \_ дискеттедриве** имеет следующие типы членов:
...
Класс **CIM \_ дискеттедриве** содержит следующие методы.
...
Класс **CIM \_ дискеттедриве** имеет следующие свойства.
...
Массив строк произвольной формы, которые содержат подробные пояснения для доступа к функциям устройств, указанным в массиве **capabilities** .
...
Класс **CIM \_ дискеттедриве** является производным от [**CIM \_ медиаакцессдевице**](cim-mediaaccessdevice.md).

Инструментарий WMI не реализует этот класс. Классы, производные от **CIM \_ дискеттедриве**, см. в разделе [Классы Win32](win32-provider.md).
