...
---
# <a name="setpowerstate-method-of-the-cim_desktopmonitor-class"></a>Метод SetPowerState \_ класса CIM десктопмонитор
...
[\_ДЕСКТОПМОНИТОР CIM](setpowerstate-method-in-class-cim-desktopmonitor.md)
</dt> <dt>
