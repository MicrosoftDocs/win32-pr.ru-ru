---
description: '\_Класс WMI TapeDrive инструментария Win32 представляет накопитель на магнитной ленте в компьютерной системе, на которой работает Windows. Ленточные накопители в основном различаются тем фактом, что доступ к ним можно получить только последовательно.'
...
Класс **WMI \_ TapeDrive** [инструментария](../wmisdk/retrieving-a-class.md) Win32 представляет накопитель на магнитной ленте в компьютерной системе, на которой работает Windows. Ленточные накопители в основном различаются тем фактом, что доступ к ним можно получить только последовательно.
...
Класс **Win32 \_ TapeDrive** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ TapeDrive**](cim-tapedrive.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ TapeDrive**](cim-tapedrive.md).<br/> |
...
Класс **Win32 \_ TapeDrive** имеет следующие свойства.
...
Квалификаторы: [**arrayType**](../wmisdk/standard-qualifiers.md) ("индексированный"), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("MIF. DMTF \| служба хранилища устройства \| 001,9 "," MIF. DMTF \| служба хранилища устройства \| 001,11 "," MIF. DMTF \| служба хранилища устройства \| 001,12 "," MIF. \|Диски DMTF \| 003,7 "), [**Моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ медиаакцессдевице**](cim-mediaaccessdevice.md).**Капабилитидескриптионс**")
</dt> </dl>
...
Квалификаторы: [**arrayType**](../wmisdk/standard-qualifiers.md) ("индексированный"), [**Моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ медиаакцессдевице**](cim-mediaaccessdevice.md).**Возможности**")
</dt> </dl>

Массив строк произвольной формы, предоставляющий более подробные объяснения для любых функций доступа к устройствам, указанных в массиве **capabilities** . Обратите внимание, что каждая запись этого массива связана с записью в массиве **capabilities** , расположенном по тому же индексу.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| ленточные структуры резервного копирования \| [**Лента \_ Получение \_ \_ параметров диска**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| Сжатие")
</dt> </dl>

Если задано **значение true**, аппаратное сжатие данных включено.
...
Квалификаторы: [**единицы**](../wmisdk/standard-qualifiers.md) ("байт")
</dt> </dl>
...
Квалификаторы: [**ключ**](../wmisdk/key-qualifier.md), [**Переопределение**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| File functions \| CreateFile")
</dt> </dl>

Уникальный идентификатор ленточного накопителя с другими устройствами в системе.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| ленточные структуры резервного копирования \| [**Лента \_ получить \_ \_ Параметры диска**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ECC")
</dt> </dl>

Если **значение — true**, устройство поддерживает исправление ошибок оборудования.
...
Размер зоны для предупреждения об окончании ленты (EOT).

Это свойство наследуется от [**CIM \_ TapeDrive**](cim-tapedrive.md).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| ленточные структуры резервного копирования \| [**Лента \_ получить \_ \_ Параметры диска**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| феатурешигх")
</dt> </dl>

Высокий порядок 32 бит флагов возможностей устройства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| ленточные структуры резервного копирования \| [**Лента \_ получить \_ \_ Параметры диска**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| феатуреслов")
</dt> </dl>

Младшие биты 32 флага возможностей устройства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| функции файла Win32API")
</dt> </dl>

имя устройства Windows CD rom, идентифицирующее изготовитель.

Пример: "ПЛЕКСТОР CD-ROM PX-12CS 1,01"
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Устройства с последовательным доступом DMTF \| 001,2 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" килобайтах ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32 \_ TapeDrive \| mediaType \| Tape Drive")
</dt> </dl>

Тип носителя, используемый этим устройством (или доступ к нему). В этом случае для него задается значение "ленточный накопитель".
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| ленточные структуры резервного копирования \| [**Лента \_ получить \_ \_ Параметры диска**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| репортсетмаркс")
</dt> </dl>

Если **значение — true**, отчеты сетмарк включены. Сетмарк Reporting использует специализированный записанный элемент, который не содержит пользовательских данных. Этот записанный элемент используется для создания схемы сегментации, которая является иерархически филемаркс. Сетмаркс обеспечивают более быстрое размещение на лентах с высокой емкостью.
