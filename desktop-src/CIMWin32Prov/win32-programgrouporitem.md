...
Абстрактный [класс WMI](../wmisdk/retrieving-a-class.md) **\_ програмграупоритем Win32** представляет логическую группу программ в меню " **Запуск \\ программ** " пользователя. Он содержит группы программ и элементы группы программ.
