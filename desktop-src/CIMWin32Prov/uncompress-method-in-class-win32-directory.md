...
---
# <a name="uncompress-method-of-the-win32_directory-class"></a>Метод uncompressия \_ класса каталога Win32

Метод **uncompressия** [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) распаковывает логический файл записи каталога (или каталог), указанный в пути к объекту.
...
Следующий пример сценария VBScript распаковывает папку c: \\ Scripts.
...
[**Повторно**](compress-method-in-class-win32-directory.md)
</dt> </dl>
