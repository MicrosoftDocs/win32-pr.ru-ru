---
description: '\_абстрактный класс WMI процессстартуп Win32 представляет конфигурацию запуска процесса на основе Windows.'
...
следующий пример кода VBScript создает Блокнот процесс на локальном компьютере. **Win32 \_ Процессстартуп** используется для настройки параметров процесса.
