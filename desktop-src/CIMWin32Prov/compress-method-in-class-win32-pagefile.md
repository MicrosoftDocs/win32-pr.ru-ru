...
---
# <a name="compress-method-of-the-win32_pagefile-class"></a>Метод сжатия \_ класса файла подкачки Win32

Метод **сжатия** [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) сжимает логический файл подкачки (или каталог), указанный в пути объекта.
