...
Метод **Rename** переименовывает логический файл (или каталог), указанный в пути к объекту. Переименование не поддерживается, если место назначения находится на другом диске или требуется перезапись существующего логического файла. Этот метод наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[\_Файл CIM](rename-method-in-class-cim-datafile.md)
</dt> <dt>
