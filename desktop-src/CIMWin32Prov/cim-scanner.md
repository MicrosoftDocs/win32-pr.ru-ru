...
**\_ Сканер CIM** представляет возможности и управление логическим устройством сканера.
...
Класс **\_ сканера CIM** содержит следующие методы.
...
Класс **\_ сканера CIM** имеет следующие свойства.
