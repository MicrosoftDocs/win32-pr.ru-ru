...
Статический метод класса **сеткипаливеинтервал** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) используется для установки интервала повторных попыток поддержания активности, пока не будет получен ответ.
...
*KeepAliveInterval* \[ окне\]
</dt> <dd>

Значение, в миллисекундах, для интервала, в течение которого выполняется повторная передача проверки активности до получения ответа.
...
Пример [изменения интервала проверки активности для всех сетевых адаптеров](https://Gallery.TechNet.Microsoft.Com/f6d4a0e7-5b59-42e3-888d-82a028e2bf35) VBScript настраивает интервал проверки активности для всех сетевых адаптеров на компьютере равным 300, 00 миллисекундам (5 минутам).
