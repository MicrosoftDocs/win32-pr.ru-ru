...
Метод **Reset** \_ класса CIM аггрегатепсекстент запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_АГГРЕГАТЕПСЕКСТЕНТ CIM](reset-method-in-class-cim-aggregatepsextent.md)
</dt> <dt>
