...
ms.locfileid: "119701044"
---
# <a name="cim_binarysensor-class"></a>\_Класс CIM бинарисенсор

Класс **CIM \_ Бинарисенсор** предоставляет логический вывод. Свойства **CurrentState** и **поссиблестатес** были добавлены для датчиков, поэтому создание подкласса **CIM \_ бинарисенсор** больше не требуется, хотя он сохраняется для обеспечения обратной совместимости. Двоичный датчик можно создать, создав датчик с двумя возможными состояниями.
...
Класс **CIM \_ бинарисенсор** имеет следующие типы членов:
...
Класс **CIM \_ бинарисенсор** содержит следующие методы.



| Метод                                                                  | Описание                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-binarysensor.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Определяет требуемое состояние электропитания для логического устройства и когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ бинарисенсор** имеет следующие свойства.
...
Значение "нормального" для датчика.
...
Описание значения "false" из двоичного датчика. Эти сведения могут отображаться для пользователя.

</dd> <dt>

**интерпретатионофтруе**
</dt> <dd> <dl> <dt>
...
Описание значения "true" из двоичного датчика. Эти сведения могут отображаться для пользователя.
...
Класс **CIM \_ бинарисенсор** является производным от [**\_ датчика CIM**](cim-sensor.md).
