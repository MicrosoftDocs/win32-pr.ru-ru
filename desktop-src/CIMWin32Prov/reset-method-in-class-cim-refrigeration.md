...
ms.locfileid: "119701194"
---
# <a name="reset-method-of-the-cim_refrigeration-class"></a>Метод Reset \_ класса CIM холодильника

Метод **Reset** \_ класса CIM холодильника запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_Холодильника CIM](reset-method-in-class-cim-refrigeration.md)
</dt> <dt>
