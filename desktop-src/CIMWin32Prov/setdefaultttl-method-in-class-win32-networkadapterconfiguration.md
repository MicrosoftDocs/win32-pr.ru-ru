...
Статический метод класса **сетдефаултттл** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) используется для установки значения срока жизни (TTL) по умолчанию в заголовке исходящих пакетов IP.
...
Значение срока жизни, заданное в заголовке исходящих IP-пакетов. Значение по умолчанию — 32; Допустимый диапазон: 1-255
...
В примере [изменения срока жизни по умолчанию для всех сетевых адаптеров](https://Gallery.TechNet.Microsoft.Com/scriptcenter/3a228fb8-5517-4e23-800e-2a15f427d05d) VBScript используется **сетдефаултттл** , чтобы установить значение срока жизни по умолчанию в заголовке исходящих пакетов IP равным 64.
