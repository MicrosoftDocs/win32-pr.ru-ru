...
ms.locfileid: "119701033"
---
# <a name="cim_bioselement-class-cimwin32-wmi-providers"></a>Класс CIM_BIOSElement (поставщики WMI CIMWin32)

Класс **CIM \_ биоселемент** представляет программное обеспечение низкого уровня, которое загружается в долговременное хранилище и используется для запуска и настройки компьютерной системы.
...
Имя, используемое для обнаружения этого программного элемента
...
Идентификатор программного элемента. Он предназначен для использования совместно с другими ключами для создания уникального представления этой [**\_ софтварилемент CIM**](cim-softwareelement.md).
...
Класс **CIM \_ биоселемент** является производным от [**CIM \_ софтварилемент**](cim-softwareelement.md).

Инструментарий WMI не реализует этот класс. Дополнительные сведения о классах, производных от **CIM \_ биоселемент**, см. в разделе [Классы Win32](win32-provider.md).
