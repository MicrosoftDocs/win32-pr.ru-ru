...
ms.locfileid: "119701524"
---
# <a name="reset-method-of-the-cim_currentsensor-class"></a>Метод Reset \_ класса CIM куррентсенсор

Метод **Reset** \_ класса CIM куррентсенсор запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_КУРРЕНТСЕНСОР CIM](reset-method-in-class-cim-currentsensor.md)
</dt> <dt>
