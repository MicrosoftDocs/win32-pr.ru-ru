...
ms.locfileid: "122884793"
---
# <a name="cim_fileaction-class"></a>\_Класс CIM филеактион

Класс **CIM \_ филеактион** позволяет автору размещать файлы, уже существующие на компьютере пользователя, а затем перемещать или копировать эти файлы в новое место.
...
Класс **CIM \_ филеактион** имеет следующие типы членов:
...
Класс **CIM \_ филеактион** содержит следующие методы.



| Метод                                                  | Описание                                                   |
|:--------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-fileaction.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ филеактион** имеет следующие свойства.
...
Инструментарий WMI не реализует этот класс. Классы, производные от **CIM \_ филеактион**, см. в разделе [Классы Win32](win32-provider.md).
