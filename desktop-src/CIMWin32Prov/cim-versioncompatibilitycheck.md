...
ms.locfileid: "118420391"
---
# <a name="cim_versioncompatibilitycheck-class"></a>\_Класс CIM версионкомпатибилитичекк

Класс **CIM \_ версионкомпатибилитичекк** указывает, разрешено ли создание следующего состояния программного элемента.
...
Класс **CIM \_ версионкомпатибилитичекк** содержит следующие методы.



| Метод                                                                 | Описание                                                   |
|:-----------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-versioncompatibilitycheck.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ версионкомпатибилитичекк** имеет следующие свойства.
...
Если **значение — true**, программный элемент может перейти к следующему состоянию независимо от того, существует ли в среде более новая или последняя версия программного элемента.

</dd> <dt>

**алловмултиплеверсионс**
</dt> <dd> <dl> <dt>
...
Управляет возможностью настройки нескольких версий продукта в системе.
...
Если **значение — true**, программный элемент может переходить к следующему состоянию, независимо от того, существует ли в среде программный элемент той же версии.
