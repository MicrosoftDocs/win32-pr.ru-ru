...
ms.locfileid: "119752274"
---
# <a name="startservice-method-of-the-win32_systemdriver-class"></a>Метод StartService \_ класса Win32 SystemDriver

Метод **StartService** пытается поместить службу, управляемую драйвером системы, в состояние запуска.
...
Следующий код PowerShell запускает службу "класс принтера Microsoft USB".
