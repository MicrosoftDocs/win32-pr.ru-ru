...
---
# <a name="win32_portablebattery-class"></a>\_Класс Win32 портаблебаттери

[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ портаблебаттери для Win32** содержит свойства, связанные с переносным аккумулятором, например ноутбук ноутбука.
...
Класс **Win32 \_ портаблебаттери** имеет следующие типы членов:
...
Класс **Win32 \_ портаблебаттери** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                        |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**\_ батарее CIM**](cim-battery.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**разделе \_ аккумулятор CIM**](cim-battery.md).<br/> |
...
Класс **Win32 \_ портаблебаттери** имеет следующие свойства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,14 ")
</dt> </dl>

Описание состояния зарядки аккумулятора. Значение 10 (undefine) недопустимо в схеме модель CIM (CIM), так как в интерфейсе управления рабочим столом (DMI) это означает, что батарея не установлена. В этом случае не следует создавать экземпляры этого объекта.
...
**Зарядка и критическая** ошибка (9)
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 22. \| Коэффициент мощности проектирования")
</dt> </dl>

Коэффициент умножения значения **десигнкапаЦити** , чтобы убедиться, что значение диаграмме милливаттах Hour не является переполнением для реализаций спецификации данных Smart аккумулятора (сбдс).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,7 ")
</dt> </dl>
...
Имя первого конкретного класса, который отображается в цепочке наследования, используемой при создании экземпляра. При использовании с другими ключевыми свойствами класса свойство позволяет однозначно идентифицировать все экземпляры этого класса и его подклассов.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,8 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" диаграмме милливаттах-hours ")
</dt> </dl>

Разработайте емкость аккумулятора в диаграмме милливаттах-hours. Если это свойство не поддерживается, введите 0 (ноль).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Переносная батарея DMTF \| 002,9 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Проектирование напряжения батареи в милливольтах. Если этот атрибут не поддерживается, введите 0 (ноль).
...
Квалификаторы: [**единицы**](../wmisdk/standard-qualifiers.md) ("процент")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,15 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" минуты ")
</dt> </dl>
...
Ожидаемое время существования аккумулятора в минутах, предполагая, что батарея полностью заряжена. Это свойство представляет общий ожидаемый срок работы батареи, а не текущий оставшийся срок, который указывается свойством **EstimatedRunTime** .
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,11 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" диаграмме милливаттах-hours ")
</dt> </dl>

Полная плата за батарею в диаграмме милливаттах-часах. Сравнение этого значения со свойством **десигнкапаЦити** определяет, когда батарея требует замены. Окончание работы батареи обычно происходит, когда свойство **фуллчаржекапаЦити** становится менее 80% от свойства **десигнкапаЦити** . Если это свойство не поддерживается, введите 0 (ноль).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 22 \| Location")
</dt> </dl>

Физическое расположение аккумулятора. Это свойство заполняется изготовителем компьютера.

Пример: "на задней панели слева"
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 22 \| Дата изготовления")
</dt> </dl>

Дата изготовления аккумулятора.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 22 \| Manufacturer")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| тип SMBIOS 22 \| Максимальная ошибка в данных аккумулятора"), [**единиц**](../wmisdk/standard-qualifiers.md) ("процент")
</dt> </dl>

Разница между самым высоким приблизительным объемом энергии в батарее и текущим значением, полученным от аккумулятора.
...
Максимальное время (в минутах) для полной зарядки аккумулятора. Это свойство представляет время, которое будет выплатить полностью исчерпанный аккумулятор, а не текущее оставшееся время, которое указывается в свойстве **тиметофуллчарже** .
...
Квалификаторы: [**maxlen**](../wmisdk/standard-qualifiers.md) (64), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("MIF. \|Портативная батарея DMTF \| 002,10 ")
</dt> </dl>

Номер версии спецификации данных со смарт-батареей, поддерживаемый этим аккумулятором. Если батарея не поддерживает эту функцию, значение должно остаться пустым.
...
Время в секундах, прошедшее с момента последнего переключения ИБП компьютера на питание от аккумулятора или с момента последнего перезапуска системы или ИБП, в зависимости от того, какое значение меньше. Если батарея находится в оперативном режиме, возвращается значение 0 (нуль).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Портативная батарея DMTF \| 002,16 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" минуты ")
</dt> </dl>

Оставшееся время в минутах для полной оплаты батареи по текущей ставке и использованию.
...
Класс **Win32 \_ портаблебаттери** является производным от [**\_ аккумулятора CIM**](cim-battery.md).
