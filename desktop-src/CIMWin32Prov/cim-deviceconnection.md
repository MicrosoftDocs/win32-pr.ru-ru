...
Класс сопоставления **CIM \_ девицеконнектион** представляет два или более подключенных устройства.
...
Логическое значение типа [**CIM \_**](cim-logicaldevice.md) , которое описывает второе логическое устройство, подключенное к предшествующему устройству.
...
Инструментарий WMI не реализует этот класс. Дополнительные сведения о классах, производных от **CIM \_ девицеконнектион**, см. в разделе [Классы Win32](win32-provider.md).
