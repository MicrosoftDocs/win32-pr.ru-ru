...
ms.locfileid: "122883666"
---
# <a name="cim_executeprogram-class"></a>\_Класс CIM ексекутепрограм

Класс **CIM \_ ексекутепрограм** представляет файлы, которые могут быть выполнены в системе, в которой установлен программный элемент.
...
Класс **CIM \_ ексекутепрограм** имеет следующие типы членов:
...
Класс **CIM \_ ексекутепрограм** содержит следующие методы.



| Метод                                                      | Описание                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-executeprogram.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ ексекутепрограм** имеет следующие свойства.
...
Строка, которая может быть вызвана в системной командной строке.
