...
ms.locfileid: "119827674"
---
# <a name="win32_temperatureprobe-class"></a>\_Класс Win32 температурепробе

[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ температурепробе для Win32** представляет свойства датчика температуры (электронный термометр).

Большая часть информации, предоставляемой классом WMI **\_ Температурепробе для Win32** , получена из SMBIOS. Чтение в реальном времени для свойства **куррентреадинг** не может быть извлечено из таблиц SMBIOS. По этой причине текущие реализации WMI не заполняют свойство **куррентреадинг** . Присутствие свойства **куррентреадинг** зарезервировано для будущего использования.
...
Класс **Win32 \_ температурепробе** имеет следующие типы членов:
...
Класс **Win32 \_ температурепробе** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                                                     |
|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-temperaturesensor.md) в [**CIM \_ датчик температуры**](cim-temperaturesensor.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-temperaturesensor.md) в [**CIM \_ датчик температуры**](cim-temperaturesensor.md) .<br/> |
...
Класс **Win32 \_ температурепробе** имеет следующие свойства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Пробная температура DMTF \| 001,19 ")
</dt> </dl>

Точность датчика для измеряемого свойства. Его значение записывается как плюс или минус сотые доли процента. Точность, разрешение и допуск используются для вычисления фактического значения измеряемого физического свойства. Точность может быть различной и зависит от того, линейно ли устройство находится в динамическом диапазоне.
...
Имя первого конкретного класса, который отображается в цепочке наследования, используемой при создании экземпляра. При использовании с другими ключевыми свойствами класса это свойство позволяет уникально идентифицировать все экземпляры класса и его подклассов.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,5 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Текущее значение, указываемое датчиком.

Текущие реализации WMI не заполняют свойство **куррентреадинг** . Присутствие свойства **куррентреадинг** зарезервировано для будущего использования.
...
Уникальный идентификатор текущей проверки.
...
Дополнительные сведения об ошибке, записанной в **ластерроркоде**, и сведения о любых корректирующих действиях, которые можно предпринять.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,13 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговое значение датчика для указания диапазонов (минимальное и максимальное значения), определяющих операционные условия датчика, которые могут быть нормальными, некритическими, критически важными или неустранимыми. Если **куррентреадинг** находится между **ловерсрешолдкритикал** и **ловерсрешолдфатал**, то текущее состояние является критически важным.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,15 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговое значение датчика для указания диапазонов (минимальное и максимальное значения), определяющих операционные условия датчика, которые могут быть нормальными, некритическими, критически важными или неустранимыми. Если **куррентреадинг** находится ниже **ловерсрешолдфатал**, текущее состояние является неустранимым.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,11 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговое значение датчика для указания диапазонов (минимальное и максимальное значения), определяющих операционные условия датчика, которые могут быть нормальными, некритическими, критически важными или неустранимыми. Если **куррентреадинг** находится между **ловерсрешолднонкритикал** и **упперсрешолднонкритикал**, датчик сообщает о нормальном значении. Если **куррентреадинг** находится между **ловерсрешолднонкритикал** и **ловерсрешолдкритикал**, текущее состояние является некритическим.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,9 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,10 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,6 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,7 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,8 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Рекомендации для пользователя в качестве обычного минимального диапазона для цифрового датчика.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,17 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" сотые доли градусов centigrade ")
</dt> </dl>
...
Значение для свойства **CreationClassName** компьютера.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,18 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Допуск датчика для измеряемого свойства. Допуск, а также разрешение и точность используются для вычисления фактического значения измеряемого физического свойства. Допуск может различаться в зависимости от того, является ли устройство линейным по отношению к динамическому диапазону.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,14 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), которые определяют операционные условия датчика, которые могут быть нормальными, некритическими, критическими или неустранимыми. Если **куррентреадинг** находится между **упперсрешолдкритикал** и **упперсрешолдфатал**, то текущее состояние является критически важным.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,16 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), которые определяют операционные условия датчика, которые могут быть нормальными, некритическими, критическими или неустранимыми. Если **куррентреадинг** выше **упперсрешолдфатал**, текущее состояние является неустранимым.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд температуры DMTF \| 001,12 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли градусов centigrade ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), которые определяют операционные условия датчика, которые могут быть нормальными, некритическими, критическими или неустранимыми. Если **куррентреадинг** находится между **ловерсрешолднонкритикал** и **упперсрешолднонкритикал**, датчик сообщает о нормальном значении. Если **куррентреадинг** находится между **упперсрешолднонкритикал** и **упперсрешолдкритикал**, текущее состояние является некритическим.
...
Класс **Win32 \_ температурепробе** является производным от [**CIM \_ датчик температуры**](cim-temperaturesensor.md).

## <a name="examples"></a>Примеры

В следующем примере возвращаются данные проверки температуры для локального компьютера.
