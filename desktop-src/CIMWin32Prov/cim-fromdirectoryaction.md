...
Ассоциация **\_ фромдиректоряктион CIM** определяет исходный каталог для действия с файлом. При использовании этой ассоциации предполагается, что исходный каталог был создан предыдущим действием. Эта ассоциация не может существовать с Ассоциацией [**CIM \_ фромдиректориспеЦификатион**](cim-fromdirectoryspecification.md) ; действие файла может содержать только один исходный каталог.
...
Класс **CIM \_ фромдиректоряктион** имеет следующие типы членов:
