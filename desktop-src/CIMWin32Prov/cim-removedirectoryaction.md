...
ms.locfileid: "122880102"
---
# <a name="cim_removedirectoryaction-class"></a>\_Класс CIM ремоведиректоряктион

Класс **CIM \_ ремоведиректоряктион** удаляет каталоги для программных элементов.
...
Класс **CIM \_ ремоведиректоряктион** имеет следующие типы членов:
...
Класс **CIM \_ ремоведиректоряктион** содержит следующие методы.
...
Класс **CIM \_ ремоведиректоряктион** имеет следующие свойства.
...
Если **значение — true**, каталог должен быть пустым для удаления.
