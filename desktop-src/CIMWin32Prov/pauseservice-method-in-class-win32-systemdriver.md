...
ms.locfileid: "120003094"
---
# <a name="pauseservice-method-of-the-win32_systemdriver-class"></a>Метод PauseService \_ класса Win32 SystemDriver

Метод  [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) PauseService пытается разместить службу, управляемую драйвером логической системы, в приостановленном состоянии.
...
Возвращает значение 0 (ноль), если запрос **PauseService** был принят, 1 (один), если запрос не поддерживается, и любое другое число для указания ошибки.
...
Следующий код PowerShell пытается приостановить работу службы "класс принтера Microsoft USB".
