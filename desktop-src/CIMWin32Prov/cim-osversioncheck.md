...
ms.locfileid: "118422141"
---
# <a name="cim_osversioncheck-class"></a>\_Класс CIM осверсиончекк

Класс **CIM \_ осверсиончекк** указывает версии операционной системы, которые могут поддерживать программный элемент. Проверка может выполняться для определенного, минимального, максимального или диапазона выпусков операционной системы. Чтобы указать конкретную версию операционной системы, минимальная и максимальная версии должны быть равны. Чтобы указать минимальную версию, необходимо указать только минимальную версию. Чтобы указать максимальную версию, необходимо указать только максимальную версию. Чтобы указать диапазон, необходимо указать как минимальную, так и максимальную версии.

Тип операционной системы указывается в свойстве **таржетоператингсистем** программного элемента-владельца. Подробные сведения о проверках сравниваются с соответствующими сведениями в объекте [**\_ операционной системы CIM**](cim-operatingsystem.md) , на который ссылается Ассоциация [**\_ инсталледос CIM**](cim-installedos.md) для объекта [**CIM \_ ComputerSystem**](cim-computersystem.md) , описывающего среду. По крайней мере один класс **\_ операционной системы CIM** должен удовлетворять сведениям о условии, чтобы проверка была удовлетворена. Иными словами, не все операционные системы на соответствующей компьютерной системе должны соответствовать условию. Кроме того, свойство **OSType** класса версии **системы \_ CIM** должно соответствовать типу свойства **таржетоператингсистем** .
...
Класс **CIM \_ осверсиончекк** имеет следующие типы членов:
...
Класс **CIM \_ осверсиончекк** содержит следующие методы.



| Метод                                                      | Описание                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Invoke**](invoke-method-in-class-cim-osversioncheck.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ осверсиончекк** имеет следующие свойства.
...
Квалификаторы: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**модель \_ CIM**](cim-operatingsystem.md).**Версия**")
</dt> </dl>
