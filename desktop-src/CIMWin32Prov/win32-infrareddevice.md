...
ms.locfileid: "119699534"
---
# <a name="win32_infrareddevice-class"></a>\_Класс Win32 инфрареддевице

[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ инфрареддевице для Win32** представляет возможности и управление инфракрасным устройством.
...
Класс **Win32 \_ инфрареддевице** имеет следующие типы членов:
...
Класс **Win32 \_ инфрареддевице** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                                                |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ инфраредконтроллер**](cim-infraredcontroller.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ инфраредконтроллер**](cim-infraredcontroller.md) .<br/> |
...
Класс **Win32 \_ инфрареддевице** имеет следующие свойства.
...
Уникальный идентификатор инфракрасного устройства.
...
Максимальное число напрямую предоставляемых сущностей, поддерживающих это устройство. Если число неизвестно, следует использовать значение 0 (нуль).
...
Дата и время последнего сброса контроллера. Это может означать, что контроллер был выключен или повторно инициализирован.
...
Класс **Win32 \_ инфрареддевице** является производным от [**CIM \_ инфраредконтроллер**](cim-infraredcontroller.md).
