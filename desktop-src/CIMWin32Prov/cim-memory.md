...
Класс **\_ памяти CIM** представляет возможности и управление логическими устройствами, связанными с памятью.
...
Класс **\_ памяти CIM** содержит следующие методы.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Memory Device \| 002,12 "," MIF. \|Массив физической памяти DMTF \| 001,8 "), [**моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ память CIM**".**Осереррордескриптион**")
</dt> </dl>
...
Квалификаторы: [**моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ память CIM**".**ErrorInfo**")
</dt> </dl>
...
Инструментарий WMI не реализует этот класс. Классы, производные от **\_ памяти CIM**, см. в разделе [Классы Win32](win32-provider.md).
