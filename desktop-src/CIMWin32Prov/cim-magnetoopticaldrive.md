...
Класс **CIM \_ магнетуптикалдриве** представляет возможности и управление дисководом для магнитооптических дисков, подтипом устройства доступа к носителю.
...
Класс **CIM \_ магнетуптикалдриве** содержит следующие методы.
...
> [!Note]  
> Каждая запись массива связана с записью в массиве **capabilities** , расположенной по тому же индексу.
...
Класс **CIM \_ магнетуптикалдриве** является производным от [**CIM \_ медиаакцессдевице**](cim-mediaaccessdevice.md).
