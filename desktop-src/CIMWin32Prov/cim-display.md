...
Класс **- \_ дисплей CIM** является родительским классом для группирования различных устройств вывода.
...
Класс **\_ дисплеев CIM** содержит эти методы.
...
Класс **\_ дисплеев CIM** имеет эти свойства.
...
Произвольная строка, которая предоставляет сведения об ошибке, записанной в свойствах **ластерроркоде** , которые необходимо выполнить.
...
Инструментарий WMI не реализует этот класс. Классы, производные **от \_ представления CIM**, см. в разделе [Классы Win32](win32-provider.md).
