...
ms.locfileid: "118678648"
---
# <a name="cim_pcvideocontroller-class"></a>\_Класс CIM пквидеоконтроллер

**CIM \_ пквидеоконтроллер** представляет возможности и управление видеоконтроллером персональных компьютеров, подтипом видеоконтроллера.
...
Класс **CIM \_ пквидеоконтроллер** имеет следующие типы членов:
...
Класс **CIM \_ пквидеоконтроллер** содержит следующие методы.



| Метод                                                                       | Описание                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-pcvideocontroller.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ пквидеоконтроллер** имеет следующие свойства.
...
Квалификаторы: [**моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ Видеоконтроллер**](cim-videocontroller.md).**Капабилитидескриптионс**")
</dt> </dl>

Графические и трехмерные возможности видеоконтроллера.

Это свойство наследуется от [**CIM \_ Видеоконтроллер**](cim-videocontroller.md).
...
<span id="Graphics_Accelerator"></span><span id="graphics_accelerator"></span><span id="GRAPHICS_ACCELERATOR"></span>**Графический ускоритель** (2)
...
<span id="3D_Accelerator"></span><span id="3d_accelerator"></span><span id="3D_ACCELERATOR"></span>**трехмерный ускоритель** (3)
...
Квалификаторы: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("индексированный"), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ Видеоконтроллер**](cim-videocontroller.md).**Акцелераторкапабилитиес**")
</dt> </dl>

Строки произвольной формы, содержащие подробные объяснения для функций ускорителя видео, указанных в массиве **акцелераторкапабилитиес** .

> [!Note]  
> Каждая запись массива связана с записью в массиве **акцелераторкапабилитиес** , расположенной по тому же индексу.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,12 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" BITS ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,11 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" пикселей ")
</dt> </dl>
...
Число цветов, поддерживаемое в текущих разрешениях.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,14 ")
</dt> </dl>

Если в символьном режиме, число столбцов для видеоконтроллера; в противном случае введите 0.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,13 ")
</dt> </dl>

Если в символьном режиме, число строк для этого видеоконтроллера; в противном случае введите 0.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,15 "), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,8 ")
</dt> </dl>

Текущий режим просмотра. Это свойство наследуется от [**CIM \_ Видеоконтроллер**](cim-videocontroller.md).
...
<span id="Interlaced"></span><span id="interlaced"></span><span id="INTERLACED"></span>С **чередованием** (3)
...
<span id="Non_Interlaced"></span><span id="non_interlaced"></span><span id="NON_INTERLACED"></span>**Без чередования** (4)
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,10 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" пикселей ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Порт шины DMTF \| 001,9 ")
</dt> </dl>

Максимальное количество напрямую обрабатываемых сущностей, поддерживаемых контроллером. Если число неизвестно или неограниченно, следует использовать значение 0.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,5 "), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>

Максимальная частота обновления видеоконтроллера в герцах.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,4 "), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) (" Герц ")
</dt> </dl>

Минимальная частота обновления видеоконтроллера в герцах.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Порт шины DMTF \| 001,2 "," MIF. \|Диски DMTF \| 003,3 ")
</dt> </dl>

Протокол, используемый контроллером для доступа к контролируемым устройствам.

Это свойство наследуется [**от \_ контроллера CIM**](cim-controller.md). Возможны следующие значения.
...
**Протокол SCSI Fibre Channel** (10)
...
**Протокол последовательной шины SCSI-2 (1394)** (12)
...
**Маркер IEEE 802,5 Token-Ring** (33)
...
**Расширенная поддержка ATA/IDE** (42)
...
**Твирп (двусторонняя ИК-связь)** (44)
...
**Sir (последовательная ИК-связь)** (46)
...
Дата и время последнего сброса этого контроллера, означающие, что контроллер был выключен или повторно инициализирован.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,2 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,6 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| Video \| 003,3 ")
</dt> </dl>
...
Произвольная строка, описывающая процессор или контроллер видео.
...
Класс **CIM \_ пквидеоконтроллер** является производным от [**CIM \_ Видеоконтроллер**](cim-videocontroller.md).

Инструментарий WMI не реализует этот класс. Классы WMI, производные от [**CIM \_ пквидеоконтроллер**](cim-videocontroller.md), см. в разделе [Классы Win32](win32-provider.md).
