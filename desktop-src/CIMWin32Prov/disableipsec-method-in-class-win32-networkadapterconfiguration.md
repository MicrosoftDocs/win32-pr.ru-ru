...
Метод  [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) Дисаблеипсек используется для отключения протокола IPSec на этом сетевом адаптере с поддержкой TCP/IP.
...
Следующий пример сценария VBScript отключает IP-безопасность на компьютере. Обратите внимание, что в целях безопасности фактический вызов Дисаблеипсек записывается в комментарий.
