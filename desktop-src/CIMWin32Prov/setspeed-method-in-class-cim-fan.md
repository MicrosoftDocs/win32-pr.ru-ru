...
Метод **сетспид** требует, чтобы скорость вентилятора была установлена в значение, указанное в входном параметре метода.
...
Запрошенная скорость вентилятора, в революции в минуту.
...
[\_Вентилятор CIM](setspeed-method-in-class-cim-fan.md)
</dt> <dt>
