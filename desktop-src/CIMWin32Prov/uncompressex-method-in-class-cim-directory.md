...
ms.locfileid: "117834529"
---
# <a name="uncompressex-method-of-the-cim_directory-class"></a>Метод Ункомпрессекс \_ класса каталога CIM

Метод **ункомпрессекс** распаковывает логический файл записи каталога (или каталог), указанный в пути к объекту. Этот метод является расширенной версией метода [**uncompressия**](uncompress-method-in-class-cim-directory.md) и наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[**\_Каталог CIM**](uncompressex-method-in-class-cim-directory.md)
</dt> <dt>
