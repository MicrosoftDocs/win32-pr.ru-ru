...
 [Класс WMI](../wmisdk/retrieving-a-class.md) **\_ нетворклогинпрофиле для Win32** представляет данные сетевого входа конкретного пользователя в компьютерной системе под Windows. Сюда входят, но не ограничиваются состояние пароля, права доступа, дисковые квоты и пути к каталогам входа.
...
Количество неудачных попыток ввода пароля при входе в систему компьютера под Windows.
...
Учетная запись компьютера для рабочей станции или сервера Windows, который является членом этого домена.
