...
---
# <a name="win32_pnpdevicepropertystringarray-class"></a>\_Класс Win32 пнпдевицепропертистрингаррай

Представляет свойство устройства PnP, состоящее из массива **строковых** элементов.
...
Класс **Win32 \_ пнпдевицепропертистрингаррай** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **Win32 \_ пнпдевицепропертистрингаррай** имеет следующие свойства.
