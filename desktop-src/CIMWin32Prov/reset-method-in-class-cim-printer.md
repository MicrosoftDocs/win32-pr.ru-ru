...
ms.locfileid: "119701204"
---
# <a name="reset-method-of-the-cim_printer-class"></a>Метод Reset класса модели CIM \_

Метод **Reset** \_ класса принтера CIM запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_Принтер CIM](reset-method-in-class-cim-printer.md)
</dt> <dt>
