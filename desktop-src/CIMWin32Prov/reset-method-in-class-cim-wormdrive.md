...
ms.locfileid: "119700494"
---
# <a name="reset-method-of-the-cim_wormdrive-class"></a>Метод Reset \_ класса CIM вормдриве

Метод **Reset** класса CIM \_ [**вормдриве**](cim-wormdrive.md) запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_ВОРМДРИВЕ CIM](reset-method-in-class-cim-wormdrive.md)
</dt> <dt>
