...
ms.locfileid: "119878694"
---
# <a name="reset-method-of-the-cim_diskettedrive-class"></a>Метод Reset \_ класса CIM дискеттедриве

Метод **Reset** \_ класса CIM дискеттедриве запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_ДИСКЕТТЕДРИВЕ CIM](reset-method-in-class-cim-diskettedrive.md)
</dt> <dt>
