...
---
# <a name="cim_biosloadedinnv-class"></a>\_Класс CIM биослоадединнв

Класс **CIM \_ биослоадединнв** связывает элемент BIOS и долговременное хранилище, в котором он загружается.
...
Класс **CIM \_ биослоадединнв** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **CIM \_ биослоадединнв** имеет следующие свойства.
...
Тип данных: **CIM \_ нонволатилестораже**
</dt> <dt>
...
[**\_ Нонволатилестораже CIM**](cim-nonvolatilestorage.md) , описывающий долговременное хранилище.
...
[**\_ Биоселемент CIM**](cim-bioselement.md) , описывающий BIOS, хранящийся в энергонезависимым экстенте.
...
Конечный адрес, по которому BIOS находится в долговременном хранилище.
...
Начальный адрес, по которому BIOS находится в долговременном хранилище.
...
Класс **CIM \_ биослоадединнв** является производным от [**\_ зависимости CIM**](cim-dependency.md).
