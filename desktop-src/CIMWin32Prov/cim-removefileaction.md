...
ms.locfileid: "122887210"
---
# <a name="cim_removefileaction-class"></a>\_Класс CIM ремовефилеактион

Класс **CIM \_ ремовефилеактион** удаляет файлы.
...
Класс **CIM \_ ремовефилеактион** имеет следующие типы членов:
...
Класс **CIM \_ ремовефилеактион** содержит следующие методы.
...
Класс **CIM \_ ремовефилеактион** имеет следующие свойства.
