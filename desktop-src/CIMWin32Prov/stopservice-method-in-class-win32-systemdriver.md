...
Метод **"** неработающий [класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) " помещает службу, представленную объектом [**Win32 \_ SystemDriver**](win32-systemdriver.md) , в остановленном состоянии.
...
Следующий код PowerShell останавливает службу "класс принтера Microsoft USB".
