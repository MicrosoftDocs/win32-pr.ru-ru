...
Класс **CIM \_ фисикалпаккаже** представляет физические элементы, содержащие или ведущие другие компоненты. Примерами являются корпус стойки или плата адаптера.
...
Класс **CIM \_ фисикалпаккаже** имеет следующие типы членов:
...
Класс **CIM \_ фисикалпаккаже** содержит следующие методы.



| Метод                                                                   | Описание                                                                                                                                      |
|:-------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Является совместимым**](iscompatible-method-in-class-cim-physicalpackage.md) | Проверяет, может ли связанный физический элемент быть включен в физический пакет или вставлен в него. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ фисикалпаккаже** имеет следующие свойства.
...
Инструментарий WMI не реализует этот класс. Сведения о классах WMI, которые являются производными от **CIM \_ фисикалпаккаже**, см. в разделе [Классы Win32](win32-provider.md).
