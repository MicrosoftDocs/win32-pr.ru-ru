...
Класс **CIM \_ хеатпипе** представляет возможности и управление охлаждающим устройством с теплоотводом.
...
Класс **CIM \_ хеатпипе** содержит следующие методы.
...
Класс **CIM \_ хеатпипе** имеет следующие свойства.
...
Инструментарий WMI не реализует этот класс. Классы, производные от **CIM \_ хеатпипе**, см. в разделе [Классы Win32](win32-provider.md).
