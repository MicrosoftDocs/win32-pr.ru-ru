...
ms.locfileid: "119972054"
---
# <a name="win32_pnpdeviceproperty-class"></a>\_Класс Win32 пнпдевицепроперти

Базовый тип для классов, представляющих свойство, возвращаемое методом [**Win32 \_ пнпентити**](win32-pnpentity.md)::[**жетдевицепропертиес**](getdeviceproperties-win32-pnpentity.md) .
...
Класс **Win32 \_ пнпдевицепроперти** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **Win32 \_ пнпдевицепроперти** имеет следующие свойства.
