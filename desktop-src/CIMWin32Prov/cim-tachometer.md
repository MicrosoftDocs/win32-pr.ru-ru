...
ms.locfileid: "119547834"
---
# <a name="cim_tachometer-class"></a>\_Класс тахометра CIM

Класс **\_ тахометра CIM** существует для обратной совместимости с более ранними определениями схемы CIM. Благодаря дополнениям к классам [**\_ датчиков CIM**](cim-sensor.md) и [**модели cim \_ NumericSensor**](cim-numericsensor.md) в версии 2,2 больше не требуется. Тахометр можно определить, установив свойство **сенсортипе** , наследуемое от **\_ датчика CIM**, на 5 ("тахометр"). Другие свойства этого класса жестко запрограммированы на постоянные значения, соответствующие определениям в иерархии датчика.
...
Класс **\_ тахометра CIM** имеет следующие типы членов:
...
Класс **\_ тахометра CIM** содержит следующие методы.



| Метод                                                                | Описание                                                                                                                              |
|:----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-tachometer.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-tachometer.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **\_ тахометра CIM** имеет эти свойства.
...
Квалификаторы: [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("сотые доли процента")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("куррентреадинг"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолдкритикал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолдфатал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолднонкритикал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("максреадабле"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("минреадабле"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("номиналреадинг"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("нормалмакс"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("нормалмин"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**Переопределение**](/windows/desktop/WmiSdk/standard-qualifiers) ("разрешение"), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("десятые революции в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Допуск"), [**единиц**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолдкритикал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолдфатал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолднонкритикал"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("революция в минуту")
</dt> </dl>
...
Класс **\_ тахометра CIM** является производным от [**CIM \_ NumericSensor**](cim-numericsensor.md).
