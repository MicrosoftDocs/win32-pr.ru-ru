...
Класс **CIM \_ медиаакцессдевице** представляет возможность доступа к одному или нескольким носителям, а затем использует носитель для хранения и извлечения данных.
...
Инструментарий WMI не реализует этот класс. Классы, производные от **CIM \_ медиаакцессдевице**, см. в разделе [Классы Win32](win32-provider.md).
