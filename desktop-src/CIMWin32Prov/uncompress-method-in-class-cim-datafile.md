...
ms.locfileid: "120002894"
---
# <a name="uncompress-method-of-the-cim_datafile-class"></a>Метод uncompressия класса CIM \_ File

Метод **uncompressия** распаковывает логический файл данных (или каталог), указанный в пути к объекту. Этот метод наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
Метод **uncompressия** в [**\_ файле CIM**](cim-datafile.md) реализуется инструментарием WMI.
...
[**\_Файл CIM**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
