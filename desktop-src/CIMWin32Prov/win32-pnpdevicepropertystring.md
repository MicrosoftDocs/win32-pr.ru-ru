...
---
# <a name="win32_pnpdevicepropertystring-class"></a>\_Класс Win32 пнпдевицепропертистринг

Представляет свойство устройства PnP типа **String**.
...
Класс **Win32 \_ пнпдевицепропертистринг** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **Win32 \_ пнпдевицепропертистринг** имеет следующие свойства.
