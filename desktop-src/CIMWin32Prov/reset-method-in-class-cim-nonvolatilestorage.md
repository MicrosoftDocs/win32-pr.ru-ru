...
ms.locfileid: "118418859"
---
# <a name="reset-method-of-the-cim_nonvolatilestorage-class"></a>Метод Reset \_ класса CIM нонволатилестораже

Метод **Reset** \_ класса CIM нонволатилестораже запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_НОНВОЛАТИЛЕСТОРАЖЕ CIM](reset-method-in-class-cim-nonvolatilestorage.md)
</dt> <dt>
