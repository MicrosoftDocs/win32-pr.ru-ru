---
description: Представляет свойства звукового устройства в компьютерной системе, на которой работает Windows.
...
[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ саунддевице для Win32** представляет свойства звукового устройства в компьютерной системе, на которой работает Windows.
...
Класс **Win32 \_ саунддевице** содержит следующие методы.
...
Класс **Win32 \_ саунддевице** имеет следующие свойства.
...
Квалификаторы: [**Переопределение**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**ключ**](../wmisdk/key-qualifier.md), [**maxlen**](../wmisdk/standard-qualifiers.md) (260), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ медиаресаурцес \\ \\ Wave \| DeviceID")
</dt> </dl>

Уникальный идентификатор звукового устройства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("WMI"), [**Units**](../wmisdk/standard-qualifiers.md) ("килобайты")
</dt> </dl>

Размер буфера прямого доступа к памяти.
...
Изготовитель звукового устройства.

Пример: "творческие лаборатории"
...
Начальный адрес ввода-вывода, назначенный порту MPU-401 звукового устройства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32APIные \| структуры мультимедиа \| [**вавеауткапс**](/windows/win32/api/mmeapi/ns-mmeapi-waveoutcaps) \| сзпнаме")
</dt> </dl>

Название продукта звукового устройства.

Пример: "Creative Labs Саундбластер AWE64PNP"
...
Образец PowerShell " [Свойства звуковой карты](https://Gallery.TechNet.Microsoft.Com/scriptcenter/86550b1a-bb3f-47c3-8056-bbd57e508b7a) " извлекает сведения обо всех звуковых картах, установленных на компьютере.

Следующий пример сценария VBScript извлекает сведения обо всех звуковых картах, установленных на компьютере.
