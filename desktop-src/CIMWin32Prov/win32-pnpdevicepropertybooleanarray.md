...
---
# <a name="win32_pnpdevicepropertybooleanarray-class"></a>\_Класс Win32 пнпдевицепропертибулеанаррай

Представляет свойство устройства PnP, состоящее из массива **логических** элементов.
...
Класс **Win32 \_ пнпдевицепропертибулеанаррай** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **Win32 \_ пнпдевицепропертибулеанаррай** имеет следующие свойства.
