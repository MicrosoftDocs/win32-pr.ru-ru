...
---
# <a name="win32_pnpdevicepropertysint16array-class"></a>\_Класс Win32 PnPDevicePropertySint16Array

Представляет свойство устройства PnP, состоящее из массива элементов **Sint16** .
...
Класс **Win32 \_ PnPDevicePropertySint16Array** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **Win32 \_ PnPDevicePropertySint16Array** имеет следующие свойства.
