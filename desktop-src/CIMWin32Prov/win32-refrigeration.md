...
ms.locfileid: "118958903"
---
# <a name="win32_refrigeration-class"></a>\_Класс Win32 холодильника

[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ холодильника для Win32** представляет свойства устройства холодильника.
...
Класс **Win32 \_ холодильника** имеет следующие типы членов:
...
Класс **Win32 \_ холодильника** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ холодильника**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ холодильника**](cim-refrigeration.md).<br/> |
...
Класс **Win32 \_ холодильника** имеет следующие свойства.
...
При **значении true** устройство охлаждения обеспечивает активное охлаждение, а не пассивное охлаждение.
...
Уникальный идентификатор устройства холодильника.
...
Дополнительные сведения об ошибке, записанной в **ластерроркоде**, и любых корректирующих действиях, которые могут быть выполнены.
...
Класс **Win32 \_ холодильника** является производным от [**CIM \_ холодильника**](cim-refrigeration.md).
