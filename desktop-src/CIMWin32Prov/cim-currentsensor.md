...
ms.locfileid: "119924634"
---
# <a name="cim_currentsensor-class"></a>\_Класс CIM куррентсенсор

Класс **CIM \_ куррентсенсор** существует для обеспечения обратной совместимости с более ранними определениями схемы CIM.

Добавление к [**\_ датчику CIM**](cim-sensor.md) и [**cim \_ NumericSensor**](cim-numericsensor.md) в версии 2,2 больше не требуется. Класс **CIM \_ куррентсенсор** можно определить, установив свойство **сенсортипе** , наследуемое от **\_ датчика CIM**, на 4 ("Current"). Другие свойства этого класса жестко запрограммированы на постоянные значения, которые соответствуют определениям в иерархии датчика.
...
Класс **CIM \_ куррентсенсор** имеет следующие типы членов:
...
Класс **CIM \_ куррентсенсор** содержит следующие методы.



| Метод                                                                   | Описание                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-currentsensor.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ куррентсенсор** имеет следующие свойства.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("точность"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая пробная зонда 001,19 (DMTF \| )
</dt> </dl>

Точность датчика для измеряемого свойства. Его значение записывается как плюс или минус сотые доли процента. Это свойство, а также свойства **разрешения** и **допуска** используются для вычисления фактического значения измеряемого физического свойства. Точность может различаться в зависимости от того, является ли устройство линейным по отношению к динамическому диапазону.

Это свойство наследуется от [**CIM \_ NumericSensor**](cim-numericsensor.md).
...
Устройство находится в режиме энергосбережения, но его точное состояние неизвестно.
...
Устройство находится в режиме энергосбережения и по-прежнему работает, но может демонстрировать снижение производительности.
...
Устройство не работает, но его можно полностью быстро включить.
...
Предупреждение Power Save.

Устройство находится в состоянии предупреждения и режиме энергосбережения.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("куррентреадинг"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,5 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>
...
Если **значение равно true**, датчик линейно помещается в динамический диапазон.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолдкритикал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,13 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик под критическими условиями. Если свойство **куррентреадинг** находится между **ловерсрешолдкритикал** и **ловерсрешолдфатал**, то текущее состояние является критическим.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолдфатал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,15 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик при неустранимых условиях. Если свойство **куррентреадинг** находится ниже **ловерсрешолдфатал**, то текущее состояние является неустранимым.

Это свойство наследуется от [**CIM \_ NumericSensor**](cim-numericsensor.md).

</dd> <dt>

**ловерсрешолднонкритикал**
</dt> <dd> <dl> <dt>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("ловерсрешолднонкритикал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,11 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик как обычные или некритические условия. Если свойство **куррентреадинг** находится между **ловерсрешолднонкритикал** и **упперсрешолднонкритикал**, то датчик сообщает о нормальном значении. Если свойство **куррентреадинг** , однако, находится между **ловерсрешолднонкритикал** и **ловерсрешолдкритикал**, то текущее состояние не является критическим.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("максреадабле"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,9 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Самое большое значение измеряемого свойства, которое может быть считано цифровым датчиком.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("минреадабле"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,10 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Наименьшее значение измеряемого свойства, которое может быть считано цифровым датчиком.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("номиналреадинг"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,6 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("нормалмакс"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,7 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Нормальный максимальный диапазон для числового датчика.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("нормалмин"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,8 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>
...
Идентификатор устройства Win32 самонастраивающийся логического устройства.
...
Поддерживается метод [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) .
...
Метод [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) может быть вызван с параметром *PowerState* , установленным в значение 5 ("цикл электропитания").
...
Метод [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) может быть вызван с параметром *PowerState* , установленным в значение 5 ("цикл электропитания"), и параметром *времени* , установленным на определенную дату и время (или интервал) для включения питания.
...
Если **значение — true**, устройство может управляться питанием, то есть перевести в состояние энергосбережения. Это свойство не указывает на то, что функции управления питанием в настоящее время включены или включены, какие функции поддерживаются. Дополнительные сведения см. в разделе массив **поверманажементкапабилитиес** .

Если **false**, то целочисленное значение 1 для строки "не поддерживается" должно быть единственной записью в массиве **поверманажементкапабилитиес** .
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("разрешение"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,17 (DMTF), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) ("десятые доли миллиампс")
</dt> </dl>

Способность датчика разрешать различия в измеряемом свойстве. Это свойство, а также свойства **точности** и **допуска** используются для вычисления фактического значения измеряемого физического свойства. Это значение может различаться в зависимости от того, является ли устройство линейным по отношению к динамическому диапазону.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Допуск"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,18 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Допуск датчика для измеряемого свойства. Это свойство, а также свойства **разрешения** и **точности** используются для вычисления фактического значения измеряемого физического свойства. Допуск может различаться в зависимости от того, является ли устройство линейным по отношению к динамическому диапазону.

</dd> <dt>

**упперсрешолдкритикал**
</dt> <dd> <dl> <dt>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолдкритикал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,14 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик под критическими условиями. Если свойство **куррентреадинг** находится между **упперсрешолдкритикал** и **упперсрешолдфатал**, то текущее состояние является критическим.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолдфатал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,16 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик при неустранимых условиях. Если свойство **куррентреадинг** выше **упперсрешолдфатал**, то текущее состояние является неустранимым.

Это свойство наследуется от [**CIM \_ NumericSensor**](cim-numericsensor.md).

</dd> <dt>

**упперсрешолднонкритикал**
</dt> <dd> <dl> <dt>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("упперсрешолднонкритикал"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Текущая зонда \| 001,12 (DMTF), [**единицы измерения**](/windows/desktop/WmiSdk/standard-qualifiers) ("миллиампс")
</dt> </dl>

Пороговое значение, указывающее, работает ли датчик как обычные или некритические условия. Если свойство **куррентреадинг** находится между **ловерсрешолднонкритикал** и **упперсрешолднонкритикал**, то датчик сообщает о нормальном значении. Если свойство **куррентреадинг** , однако, находится между **упперсрешолднонкритикал** и **упперсрешолдкритикал**, то текущее состояние не является критическим.
...
Класс **CIM \_ куррентсенсор** является производным от [**CIM \_ NumericSensor**](cim-numericsensor.md).

Инструментарий WMI не реализует этот класс. Дополнительные сведения о классах WMI, производных от **CIM \_ куррентсенсор**, см. в разделе [Классы Win32](win32-provider.md).
