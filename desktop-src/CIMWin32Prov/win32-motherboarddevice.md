---
description: '\_класс WMI мосербоарддевице для Win32 представляет устройство, которое содержит центральные компоненты системы Windows компьютера.'
...
[класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ мосербоарддевице для Win32** представляет устройство, которое содержит центральные компоненты системы Windows компьютера.
...
Класс **Win32 \_ мосербоарддевице** содержит следующие методы.
...
Уникальный идентификатор этой материнской платы.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| hKey \_ локальный \_ компьютер \\ \\ \\ \\ Описание оборудования \\ \\ System \\ \\ мултифунктионадаптер \| идентификатор")
</dt> </dl>

Тип основной Шины материнской платы.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| hKey \_ Local \_ Machine \\ \\ \\ \\ Description \\ \\ System описания системы")
</dt> </dl>

Номер редакции материнской платы.
...
Тип дополнительной шины материнской платы.
...
Класс **Win32 \_ мосербоарддевице** является производным от [**CIM \_**](cim-logicaldevice.md)-класса.

## <a name="examples"></a>Примеры

В следующих примерах кода [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) и [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) извлекается информация о материнской плате.

В следующем примере кода VBScript извлекаются сведения о материнской плате.
