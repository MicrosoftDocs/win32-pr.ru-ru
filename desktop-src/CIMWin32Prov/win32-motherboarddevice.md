...
[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ мосербоарддевице для Win32** представляет устройство, которое содержит центральные компоненты компьютерной системы Windows.
