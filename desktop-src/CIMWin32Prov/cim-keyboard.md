...
ms.locfileid: "119438454"
---
# <a name="cim_keyboard-class"></a>\_Класс клавиатуры CIM

Класс **\_ клавиатуры CIM** представляет возможности и управление логическим устройством с клавиатурой.
...
Класс **\_ клавиатуры CIM** имеет следующие типы членов:
...
Класс **\_ клавиатуры CIM** имеет следующие методы.



| Метод                                                              | Описание                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Reset**](reset-method-in-class-cim-keyboard.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **\_ клавиатуры CIM** имеет эти свойства.
...
Произвольная строка, указывающая формат и расположение клавиатуры.
...
Целое число, указывающее, включен ли пароль аппаратного уровня на клавиатуре для предотвращения локального ввода.
...
Класс **\_ клавиатуры CIM** является производным от [**CIM \_ усердевице**](cim-userdevice.md).

Инструментарий WMI не реализует этот класс. Классы, производные **от \_ CIM**, см. в разделе [Классы Win32](win32-provider.md).
