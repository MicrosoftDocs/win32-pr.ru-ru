...
ms.locfileid: "120077494"
---
# <a name="geteffectivepermission-method-of-the-cim_devicefile-class"></a>Метод Жетеффективепермиссион \_ класса CIM девицефиле

Метод **жетеффективепермиссион** определяет, есть ли у вызывающего объекта агрегированные разрешения на объект [**CIM \_ девицефиле**](cim-devicefile.md) , а также общую папку, в которой находится файл или каталог, как указано в аргументе **разрешения** . Этот метод наследуется от [**CIM \_ LogicalFile**](cim-logicalfile.md).
...
[**\_ДЕВИЦЕФИЛЕ CIM**](geteffectivepermission-method-in-class-cim-devicefile.md)
</dt> <dt>
