...
ms.locfileid: "120064854"
---
# <a name="invoke-method-of-the-cim_rebootaction-class"></a>Метод Invoke \_ класса CIM ребутактион

Метод **Invoke** класса [**CIM \_ ребутактион**](cim-rebootaction.md) принимает определенное действие. Сведения о том, как метод выполняет действие, зависят от реализации. Этот метод наследуется [**от \_ действия CIM**](cim-action.md).
...
[\_РЕБУТАКТИОН CIM](invoke-method-in-class-cim-rebootaction.md)
</dt> <dt>
