...
---
# <a name="invoke-method-of-the-cim_settingcheck-class"></a>Метод Invoke \_ класса CIM сеттингчекк

Метод **Invoke** класса [**CIM \_ сеттингчекк**](cim-settingcheck.md) оценивает определенную проверку. Сведения о том, как метод оценивает определенную проверку в контексте CIM, описывается неабстрактными подклассами [**\_ проверки CIM**](cim-check.md) . Этот метод наследуется **от \_ проверки CIM**.
...
[\_СЕТТИНГЧЕКК CIM](invoke-method-in-class-cim-settingcheck.md)
</dt> <dt>
