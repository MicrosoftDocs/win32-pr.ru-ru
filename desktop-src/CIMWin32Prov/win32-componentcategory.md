...
Класс **WMI \_ компоненткатегори** [инструментария](/windows/desktop/WmiSdk/retrieving-a-class) Win32 представляет категорию компонента. Категории компонентов — это группы классов модели COM с определенным набором функций, которыми они являются общими. Клиент, использующий эти интерфейсы, запрашивает в реестре заголовок категории и уникальный идентификатор **CategoryID**, который создается из глобального уникального идентификатора (GUID).
...
Квалификаторы: [**Key**](/windows/desktop/WmiSdk/key-qualifier), [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (16), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| категории компонентов Win32API \| [**CATEGORYINFO**](/windows/win32/api/comcat/ns-comcat-categoryinfo) \| CATID")
</dt> </dl>

Идентификатор GUID для этой категории компонентов.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("имя"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| категории компонентов Win32API \| [**CATEGORYINFO**](/windows/win32/api/comcat/ns-comcat-categoryinfo) \| сздескриптион")
</dt> </dl>

Свойство Name указывает описательное имя этой категории компонента.
