...
Класс **CIM \_ фисикалекстент** имеет следующие типы членов:
...
Класс **CIM \_ фисикалекстент** содержит следующие методы.



| Метод                                                                    | Описание                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Перезапуск**](reset-method-in-class-cim-physicalextent.md)                 | Запрашивает сброс логического устройства. Не реализовано инструментарием WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-physicalextent.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ фисикалекстент** имеет следующие свойства.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("размер"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Физические экстенты DMTF \| 001,4 ")
</dt> </dl>
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("нумберофблоккс"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Физические экстенты DMTF \| 001,3 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Физические экстенты DMTF \| 001,6 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" байт ")
</dt> </dl>

Число байтов данных пользователя, которые необходимо пропустить перед началом извлечения данных после записи.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Физические экстенты DMTF \| 001,7 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" байт ")
</dt> </dl>

Число байтов, которое должно быть зарезервировано для проверки данных.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. \|Физические экстенты DMTF \| 001,8 "), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" байт ")
</dt> </dl>

Число байтов, которое должно быть зарезервировано для данных пользователя.
...
Класс **CIM \_ фисикалекстент** является производным от [**CIM \_ сторажеекстент**](cim-storageextent.md).
