...
api_location:
- CIMWin32.dll
ms.openlocfilehash: 2ee8d41f2762e102e4e509f9f9dba534d22ef83c04e0f275b21d619135ee817b
ms.sourcegitcommit: e858bbe701567d4583c50a11326e42d7ea51804b
ms.translationtype: MT
ms.contentlocale: ru-RU
ms.lasthandoff: 08/11/2021
ms.locfileid: "119079598"
---
# <a name="win32_voltageprobe-class"></a>\_Класс Win32 волтажепробе

[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ волтажепробе для Win32** представляет свойства датчика напряжения (Electronic волтметер).
...
Класс **Win32 \_ волтажепробе** имеет следующие типы членов:
...
Класс **Win32 \_ волтажепробе** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ датчик напряжения**](cim-voltagesensor.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ датчик напряжения**](cim-voltagesensor.md).<br/> |
...
Класс **Win32 \_ волтажепробе** имеет следующие свойства.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,19 ")
</dt> </dl>

Точность датчика для измеряемого свойства. Значение точности записывается как плюс или минус сотые доли процента. Точность, а также разрешение и допуск используются для вычисления фактического значения измеряемого физического свойства. Точность может быть различной и зависит от того, является ли устройство линейным в динамическом диапазоне.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,5 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Уникальный идентификатор проверки напряжения.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,13 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), чтобы определить, работает ли датчик как обычные, некритические, критические или неустранимые. Если **куррентреадинг** находится между **ловерсрешолдкритикал** и **ловерсрешолдфатал**, то текущее состояние является критически важным.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,15 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), чтобы определить, работает ли датчик как обычные, некритические, критические или неустранимые. Если **куррентреадинг** находится ниже **ловерсрешолдфатал**, текущее состояние является неустранимым.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,11 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,9 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Самое большое значение измеряемого свойства, которое может читать цифровой датчик.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,10 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Наименьшее значение измеряемого свойства, которое может читать цифровой датчик.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,6 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,7 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,8 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Руководство для пользователя, чтобы указать нормальный минимальный диапазон для числового датчика.
...
Если **значение — true**, устройство может управляться с помощью управления питанием. Это означает, что его можно перевести в режим приостановки и т. д. Свойство не указывает на то, что функции управления питанием в настоящее время включены, но это означает, что логическое устройство поддерживает управление питанием.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,17 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" десятые доли милливольтах ")
</dt> </dl>

Способность датчика разрешать различия в измеряемом свойстве. Это значение может различаться и зависит от того, является ли устройство линейным в динамическом диапазоне.
...
Значение свойства **CreationClassName** компьютера с областями.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,18 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Допуск датчика для измеряемого свойства. Допуск, а также разрешение и точность используются для вычисления фактического значения измеряемого физического свойства. Допуск может различаться и зависит от того, является ли устройство линейным в динамическом диапазоне.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,14 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,16 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>

Пороговые значения датчика задают диапазоны (минимальное и максимальное значения), чтобы определить, работает ли датчик в нормальных, некритических, критических или неустранимых условиях. Если **куррентреадинг** выше **упперсрешолдфатал**, текущее состояние является неустранимым.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. \|Зонд напряжения DMTF \| 001,12 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" милливольтах ")
</dt> </dl>
...
Класс **Win32 \_ волтажепробе** является производным от [**CIM \_ датчик напряжения**](cim-voltagesensor.md).
