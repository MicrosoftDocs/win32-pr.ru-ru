...
ms.locfileid: "119218594"
---
# <a name="cim_biosfeature-class"></a>\_Класс CIM биосфеатуре

Класс **CIM \_ биосфеатуре** представляет возможности низкоуровневого программного обеспечения, используемого для запуска и настройки компьютерной системы.
...
Класс **CIM \_ биосфеатуре** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Элемент Property

Класс **CIM \_ биосфеатуре** имеет следующие свойства.
...
Квалификаторы: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("индексированный"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Характеристика BIOS \| 003,4 "), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ биосфеатуре**.**Характеристики**")
</dt> </dl>

Массив строк произвольной формы, предоставляющий подробные объяснения функций BIOS, указанных в массиве **характеристик** .

> [!Note]  
> Каждая запись в этом массиве связана с записью в массиве **характеристик** , которая находится в том же индексе.
...
Квалификаторы: [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("индексированный"), [**Маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Характеристика BIOS \| 003,3 "), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ биосфеатуре**.**Чарактеристикдескриптионс**")
</dt> </dl>

Массив целых чисел, указывающий возможности, поддерживаемые BIOS. Значение 3 недопустимо в схеме CIM, так как оно представляет, что в DMI не поддерживаются функции BIOS. В этом случае не следует создавать экземпляры этого объекта.
...
<span id="Undefined"></span><span id="undefined"></span><span id="UNDEFINED"></span>Не **определено** (3)
...
<span id="ISA_Support"></span><span id="isa_support"></span><span id="ISA_SUPPORT"></span>**Поддержка ISA** (4)
...
<span id="MCA_Support"></span><span id="mca_support"></span><span id="MCA_SUPPORT"></span>**Поддержка MCA** (5)
...
<span id="EISA_Support"></span><span id="eisa_support"></span><span id="EISA_SUPPORT"></span>**Поддержка EISA** (6)
...
<span id="PCI_Support"></span><span id="pci_support"></span><span id="PCI_SUPPORT"></span>**Поддержка PCI** (7)
...
<span id="PCMCIA_Support"></span><span id="pcmcia_support"></span><span id="PCMCIA_SUPPORT"></span>**Поддержка PCMCIA** (8)
...
<span id="PnP_Support"></span><span id="pnp_support"></span><span id="PNP_SUPPORT"></span>**Поддержка PnP** (9)
...
<span id="APM_Support"></span><span id="apm_support"></span><span id="APM_SUPPORT"></span>**Поддержка APM** (10)
...
<span id="Upgradeable_BIOS"></span><span id="upgradeable_bios"></span><span id="UPGRADEABLE_BIOS"></span>**Обновляемая BIOS** (11)
...
<span id="BIOS_Shadowing_Allowed"></span><span id="bios_shadowing_allowed"></span><span id="BIOS_SHADOWING_ALLOWED"></span>**Разрешена теневая версия BIOS** (12)


</dt> <dd>

Разрешена теневая версия BIOS.

</dd> <dt>

<span id="VL_VESA_Support"></span><span id="vl_vesa_support"></span><span id="VL_VESA_SUPPORT"></span>

<span id="VL_VESA_Support"></span><span id="vl_vesa_support"></span><span id="VL_VESA_SUPPORT"></span>**Поддержка корпоративного протокола VESA** (13)


</dt> <dd>

Поддержка корпоративного лицензирования VESA.

</dd> <dt>

<span id="ESCD_Support"></span><span id="escd_support"></span><span id="ESCD_SUPPORT"></span>

<span id="ESCD_Support"></span><span id="escd_support"></span><span id="ESCD_SUPPORT"></span>**Поддержка ESCD** (14)
...
<span id="LS-120_Support"></span><span id="ls-120_support"></span><span id="LS-120_SUPPORT"></span>**Поддержка Ls-120** (15)
...
<span id="ACPI_Support"></span><span id="acpi_support"></span><span id="ACPI_SUPPORT"></span>**Поддержка ACPI** (16)
...
<span id="I2O_Boot_Support"></span><span id="i2o_boot_support"></span><span id="I2O_BOOT_SUPPORT"></span>**Поддержка загрузки I2O** (17)


</dt> <dd>

Поддержка загрузки I2O.

</dd> <dt>

<span id="USB_Legacy_Support"></span><span id="usb_legacy_support"></span><span id="USB_LEGACY_SUPPORT"></span>

<span id="USB_Legacy_Support"></span><span id="usb_legacy_support"></span><span id="USB_LEGACY_SUPPORT"></span>**Поддержка устаревших устройств USB** (18)


</dt> <dd>

Поддержка устаревших устройств USB.

</dd> <dt>

<span id="AGP_Support"></span><span id="agp_support"></span><span id="AGP_SUPPORT"></span>

<span id="AGP_Support"></span><span id="agp_support"></span><span id="AGP_SUPPORT"></span>**Поддержка AGP** (19)
...
<span id="PC_Card"></span><span id="pc_card"></span><span id="PC_CARD"></span>**Плата PC Card** (20)
...
<span id="Smart_Battery"></span><span id="smart_battery"></span><span id="SMART_BATTERY"></span>**Интеллектуальный аккумулятор** (24)
...
Свойство Name определяет метку, по которой объект известен всему миру за пределами системы обработки данных. Эта метка является понятным для человека именем, которое однозначно определяет элемент в контексте пространства имен элемента.
...
Класс **CIM \_ биосфеатуре** является производным от [**CIM \_ софтварефеатуре**](cim-softwarefeature.md).
