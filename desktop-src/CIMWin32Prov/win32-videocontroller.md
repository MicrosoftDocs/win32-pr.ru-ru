...
[Класс WMI](../wmisdk/retrieving-a-class.md) **\_ Видеоконтроллер для Win32** представляет возможности и Управление емкостью видеоконтроллера в компьютерной системе под управлением Windows.
...
Класс **Win32 \_ Видеоконтроллер** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ пквидеоконтроллер**](cim-pcvideocontroller.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ пквидеоконтроллер**](cim-pcvideocontroller.md).<br/> |
...
Класс **Win32 \_ Видеоконтроллер** имеет следующие свойства.
...
Квалификаторы: [**моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ Видеоконтроллер**](cim-videocontroller.md).**Капабилитидескриптионс**")
</dt> </dl>

Массив графических и трехмерных возможностей видеоконтроллера.
...
Общий набор микросхем, используемый этим контроллером для сравнения совместимости с системой.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| хардвареинформатион. DACType")
</dt> </dl>

Имя или идентификатор микросхемы цифрового преобразования (DAC). Кодировка этого свойства — буквенно-цифровая.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| хардвареинформатион. MemorySize"), [**Units**](../wmisdk/standard-qualifiers.md) ("bytes")
</dt> </dl>
...
Квалификаторы: [**arrayType**](../wmisdk/standard-qualifiers.md) ("индексированный"), [**Моделкорреспонденце**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ Видеоконтроллер**](cim-videocontroller.md).**Акцелераторкапабилитиес**")
</dt> </dl>

Строки произвольной формы, предоставляющие более подробные объяснения для любого из функций ускорителя видео, указанных в массиве **акцелераторкапабилитиес** . Обратите внимание, что каждая запись этого массива связана с записью в массиве **акцелераторкапабилитиес** , расположенной по тому же индексу.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32APIные \| функции контекста устройства \| [**жетдевицекапс**](/windows/win32/api/wingdi/nf-wingdi-getdevicecaps)")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,12 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" BITS ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,11 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" пикселей ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,14 ")
</dt> </dl>

Число столбцов для этого видеоконтроллера (в символьном режиме). В противном случае введите 0 (ноль).
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,13 ")
</dt> </dl>

Число строк для этого видеоконтроллера (в символьном режиме). В противном случае введите 0 (ноль).
...
Квалификаторы: [**override**](../wmisdk/standard-qualifiers.md) ("куррентрефрешрате"), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Хардвареинформатион."), [**Units**](../wmisdk/standard-qualifiers.md) ("Герц")
</dt> </dl>

Частота, с которой видеоконтроллер обновляет изображение для монитора. Значение 0 (ноль) указывает, что используется скорость по умолчанию, а 0xFFFFFFFF указывает, что используется оптимальная скорость.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,8 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,10 "), [**единицы**](../wmisdk/standard-qualifiers.md) (" пикселей ")
</dt> </dl>
...
Текущее число перьев, зависящих от устройства. Значение 0xFFFF означает, что устройство не поддерживает перья.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32APIные \| функции контекста устройства \| енумдисплайсеттингс")
</dt> </dl>

Тип изображения видеоконтроллера. Свойство может иметь одно из стандартных значений или определенное драйвером значение, которое больше или равно 256. Если выбрано смешение линий, контроллер использует метод сглаживания, который создает четко определенные границы между черным, белым и серым масштабированием. Цветовой дизеринг не подходит для изображений, которые содержат непрерывные оттенки интенсивности и тона, такие как отсканированные фотографии.
...
**Сглаживание с помощью тонкой кисти** (3)
...
**Устройство имеет серый масштаб** (5)
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| класс Win32Registry System \\ \\ CurrentControlSet \\ \\ Services \\ \\ \\ \\ ")
</dt> </dl>

Дата и время последнего изменения текущего установленного видеодрайвера.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| функции библиотеки установки файлов Win32API \| GetFileVersionInfo")
</dt> </dl>

Номер версии видеодрайвера.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| Printing and Printing spool Structures \| \| дмикминтент")
</dt> </dl>

Определенное значение одного из трех возможных методов сопоставления цветов или целей, которые должны использоваться по умолчанию. Это свойство используется в основном для приложений, не поддерживающих ICM. ICM приложения устанавливают намерения, используя функции ICM. Это свойство может быть стандартным значением или заданным драйвером, которое больше или равно 256. Сопоставление цветов на основе насыщенности — наиболее подходящий вариант для бизнес-графиков, когда нежелательно сглаживание. Сопоставление цветов на основе контрастности — наиболее подходящий вариант для отсканированных или фотографических изображений при необходимости сглаживания. Цвет, оптимизированный для точного соответствия требуемому цвету, наиболее подходит для использования с деловыми логотипами или другими изображениями при необходимости точного соответствия цветов.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| Printing and Printing spool Structures \| \| дмикммесод")
</dt> </dl>

Метод обработки ICM. Для приложений, не использующих ICM, это свойство определяет, включен ли ICM. Для ICM приложений Система проверяет это свойство, чтобы определить, как обрабатывалась поддержка ICM. Это свойство может быть предопределенным значением или заданным драйвером значением, превышающим или равным 256. Значение определяет, какая система обрабатывает сопоставление цветов изображения.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (" \| \\ \\ класс управления Win32Registry системы CurrentControlSet \\ \\ \\ \\ \\ \\ {4D36E968-E325-11CE-BFC1-08002BE10318} \\ \\ 0000")
</dt> </dl>
...
INF-файла, в котором находятся сведения о видеоролике Windows.
...
Имя установленного драйвера устройства вывода.
...
Максимальный объем поддерживаемой памяти в байтах.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,5 "), [**единицы измерения**](../wmisdk/standard-qualifiers.md) (" Герц ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,4 "), [**единицы измерения**](../wmisdk/standard-qualifiers.md) (" Герц ")
</dt> </dl>
...
**Значение true** показывает, что для вывода изображений используется серый масштаб.
...
Это свойство наследуется от [**CIM \_ пквидеоконтроллер**](cim-pcvideocontroller.md).
...
Число зарезервированных записей в системной палитре. Операционная система может зарезервировать записи для поддержки стандартных цветов для полос задач и других отображаемых элементов рабочего стола. Этот индекс действителен только в том случае, если драйвер устройства задает бит **\_ палитры RC** в индексе растеркапс и доступен только в том случае, если драйвер совместим с 16-разрядной системой Windows. Если в системе не используется палитра, **ресерведсистемпалеттинтриес** не устанавливается.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32API \| Printing and Printing spool Structures \| \| дмспекверсион")
</dt> </dl>
...
Текущее число элементов цветового индекса в системной палитре. Этот индекс действителен только в том случае, если драйвер устройства задает бит **\_ палитры RC** в индексе растеркапс и доступен только в том случае, если драйвер совместим с 16-разрядной системой Windows. Если в системе не используется палитра, **системпалеттинтриес** не устанавливается.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,2 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,6 ")
</dt> </dl>
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) (MIF. DMTF \| Video \| 003,3 ")
</dt> </dl>
...
Текущие параметры разрешения, цвета и режима сканирования видеоконтроллера.

Пример: "1024 x 768 x 256 Colors"
...
Произвольная строка, описывающая обработчик видео.
...
Дополнительные сведения об использовании этого класса, например получение сведений с нескольких мониторов, см. [в статье Использование PowerShell для обнаружения сведений о нескольких мониторах](https://blogs.technet.com/b/heyscriptingguy/archive/2013/10/03/use-powershell-to-discover-multi-monitor-information.aspx).

## <a name="examples"></a>Примеры

В [списке свойства видеоконтроллера](https://Gallery.TechNet.Microsoft.Com/6c1a585c-742f-4f51-bb57-23838e8f011f) в формате VBScript перечислены свойства контроллера видео.

В следующем примере PowerShell перечислены свойства контроллера видео.
