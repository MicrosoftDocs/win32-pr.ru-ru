...
Класс **CIM \_ продуктфисикалелементс** представляет физические элементы, составляющие продукт.
...
Класс **CIM \_ продуктфисикалелементс** имеет следующие свойства.
...
Ссылка на физический элемент, который является частью продукта.
