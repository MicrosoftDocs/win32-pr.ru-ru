...
Класс **CIM \_ усбдевице** представляет характеристики управления USB-устройства.
...
Конфигурация, выбранная в настоящее время для устройства. Если значение равно 0 (нулю), устройство не настроено.
...
Инструментарий WMI не реализует этот класс. Классы WMI, реализующие **CIM \_ усбдевице**, см. в разделе [Классы Win32](win32-provider.md).
