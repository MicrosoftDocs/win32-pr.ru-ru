...
Статический метод [класса WMI](/windows/desktop/WmiSdk/retrieving-a-class) **сетипусезероброадкаст** используется для задания использования IP-датаграмм без широковещательной рассылки.
...
*Ипусезероброадкаст* \[ окне\]
</dt> <dd>

Если задано **значение true**, используется широковещательная рассылка по IP-адресу. Значение по умолчанию — **false**.
