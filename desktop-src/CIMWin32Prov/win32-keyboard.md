---
description: '\_Класс WMI клавиатуры Win32 представляет клавиатуру, установленную в компьютерной системе, на которой работает Windows.'
...
ms.locfileid: "119878644"
---
# <a name="win32_keyboard-class"></a>\_Класс клавиатуры Win32

[Класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ клавиатуры Win32** представляет клавиатуру, установленную в компьютерной системе, на которой работает Windows.
...
Класс **\_ клавиатуры Win32** имеет следующие типы членов:
...
Класс **\_ клавиатуры Win32** имеет следующие методы.



| Метод            | Описание                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-controller.md) на [**\_ клавиатуре CIM**](cim-keyboard.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) на [**\_ клавиатуре CIM**](cim-keyboard.md) .<br/> |
...
Класс **\_ клавиатуры Win32** имеет следующие свойства.
...
Квалификаторы: [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceID"), [**ключ**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Дополнительные сведения об ошибке, записанной в **ластерроркоде**, и корректирующие действия, которые могут быть выполнены.
...
Произвольная строка, указывающая макет клавиатуры.

Это свойство наследуется [**от \_ клавиатуры CIM**](cim-keyboard.md).
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (MIF. DMTF \| System Security аппаратная безопасность \| 001,2 ")
</dt> </dl>

Состояние пароля на уровне оборудования, включенного на клавиатуре (значение = 4), запрет локального ввода.
...
Класс **\_ клавиатуры Win32** является производным от [**\_ клавиатуры CIM**](cim-keyboard.md).

## <a name="examples"></a>Примеры

Следующий код PowerShell находит беспроводную клавиатуру и мышь.
...
В следующем примере сценария VBScript перечислены свойства клавиатуры.
