...
Класс **\_ микросхем CIM** представляет тип оборудования интегрированной цепи, включая ASIC, процессоры, микросхемы памяти и т. д.
...
Конструктивный фактор для микросхемы. Можно указать следующие значения.
...
Инструментарий WMI не реализует этот класс. Дополнительные сведения о классах, производных от **\_ микросхемы CIM**, см. в разделе [Классы Win32](win32-provider.md).
