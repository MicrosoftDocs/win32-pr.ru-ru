...
ms.locfileid: "119700614"
---
# <a name="reset-method-of-the-cim_volumeset-class"></a>Метод Reset \_ класса набора ТОМОВ CIM

Метод **Reset** класса набора [**\_ томов CIM**](cim-volumeset.md) запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_Том CIM](reset-method-in-class-cim-volumeset.md)
</dt> <dt>
