---
description: '\_класс WMI шины Win32 представляет физическую шину, которая отображается на компьютере с операционной системой Windows. любой экземпляр Windowsной шины является потомком (или членом) этого класса.'
...
ms.locfileid: "119020322"
---
# <a name="win32_bus-class"></a>\_Класс шины Win32

[класс WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ шины Win32** представляет физическую шину, которая отображается на компьютере с операционной системой Windows. любой экземпляр Windowsной шины является потомком (или членом) этого класса.
...
Класс **\_ шины Win32** имеет следующие типы членов:
...
Класс **\_ шины Win32** имеет следующие методы.



| Метод            | Описание                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_**](cim-logicaldevice.md) .<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. документацию по методу [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_**](cim-logicaldevice.md) .<br/> |
...
Класс **\_ шины Win32** имеет следующие свойства.
...
Логический номер, назначенный физической шине.
...
Квалификаторы: [**маппингстрингс**](/windows/desktop/WmiSdk/standard-qualifiers) (" \| \| тип интерфейса Win32API чврес \_ ")
</dt> </dl>

Тип физической шины. Это значение будет одним из значений в перечислении **\_ типа интерфейса** , определенного в Bus. h.
...
**Максимальный тип интерфейса** (16)
...
Уникальное имя, идентифицирующее шину.
...
Класс **\_ шины Win32** является производным от [**CIM \_**](cim-logicaldevice.md)-класса.
