...
ms.locfileid: "119700254"
---
# <a name="reset-method-of-the-cim_cachememory-class"></a>Метод Reset \_ класса CIM качемемори

Метод **Reset** \_ класса CIM качемемори запрашивает сброс логического устройства. Этот метод наследуется [**от \_ CIM**](cim-logicaldevice.md)-ого модели.
...
[\_КАЧЕМЕМОРИ CIM](reset-method-in-class-cim-cachememory.md)
</dt> <dt>
