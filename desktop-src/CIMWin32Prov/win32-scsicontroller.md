...
Класс **Win32 \_ сксиконтроллер** содержит следующие методы.



| Метод            | Описание                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Сброс**         | Не реализован. Чтобы реализовать этот метод, см. метод [**Reset**](reset-method-in-class-cim-controller.md) в [**CIM \_ сксиконтроллер**](cim-scsicontroller.md).<br/>                 |
| **SetPowerState** | Не реализован. Чтобы реализовать этот метод, см. метод [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) в [**CIM \_ сксиконтроллер**](cim-scsicontroller.md).<br/> |
...
Число тайм-аутов, произошедших после значения **тимеофластресет** .

Это свойство наследуется от [**CIM \_ сксиконтроллер**](cim-scsicontroller.md).
...
Квалификаторы: [**ключ**](../wmisdk/key-qualifier.md), [**Переопределение**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ девицемап \\ \\ SCSI")
</dt> </dl>

Уникальный идентификатор контроллера SCSI с другими устройствами в системе.
...
Квалификаторы: не [**рекомендуется**](../wmisdk/standard-wmi-qualifiers.md), [**Маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ девицемап \\ \\ SCSI \| ")
</dt> </dl>

Порядок, в котором устройства перечислены с помощью этого контроллера SCSI.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Services \\ \\ \| портдривер")
</dt> </dl>

Имя файла драйвера контроллера SCSI.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Enum \\ \\ root \| хвревисион")
</dt> </dl>

Номер версии оборудования контроллера SCSI.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ девицемап \\ \\ SCSI \| ")
</dt> </dl>

Номер индекса контроллера SCSI в системном реестре.
...
Квалификаторы: [**маппингстрингс**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| система \\ \\ CurrentControlSet \\ \\ Enum \\ \\ root \| произв.")
</dt> </dl>

Имя производителя контроллера SCSI.
...
**Защищено с помощью SCC (команда контроллера SCSI-3)** (5)
...
**Защищено с помощью SCC-2 (команда контроллера SCSI-3)** (6)
