...
ms.locfileid: "119924894"
---
# <a name="cim_coolingdevice-class"></a>\_Класс CIM кулингдевице

Класс **CIM \_ кулингдевице** представляет возможности и управление охлаждающими устройствами.
...
Класс **CIM \_ кулингдевице** имеет следующие типы членов:
...
Класс **CIM \_ кулингдевице** содержит следующие методы.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Определяет требуемое состояние электропитания для логического устройства, а также когда устройство должно быть переведено в это состояние. Не реализовано инструментарием WMI.<br/> |
...
Класс **CIM \_ кулингдевице** имеет следующие свойства.
...
Класс **CIM \_ кулингдевице** является производным от [**CIM \_**](cim-logicaldevice.md)-класса.

Инструментарий WMI не реализует этот класс. Классы, производные от **CIM \_ кулингдевице**, см. в разделе [Классы Win32](win32-provider.md).
