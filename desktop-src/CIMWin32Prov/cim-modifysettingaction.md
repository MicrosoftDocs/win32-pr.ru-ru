...
Класс **CIM \_ модифисеттингактион** представляет сведения для изменения определенного файла параметров для конкретной записи с указанным значением.
...
Класс **CIM \_ модифисеттингактион** содержит следующие методы.



| Метод                                                           | Описание                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Вызвать**](invoke-method-in-class-cim-modifysettingaction.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Тип действия, выполняемого с указанной записью параметра. Для дополнений предполагается, что регистр учитывается. Однако предполагается, что удаления не чувствительны к регистру.
...
<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Удалить** (1)
...
Добавляет к концу указанной записи.

</dd> <dt>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**Удалить** (3)
...
Имя файла изменяемой записи файла параметров.
...
Ключ раздела изменяемой записи параметра.
