...
Класс **CIM \_ меморичекк** указывает условие для минимального объема памяти, который должен быть доступен в системе. Значение указывается в свойстве **MemorySize** . Подробные сведения о проверках сравниваются со значением свойства **фрифисикалмемори** объекта среды CIM, [**на \_**](cim-operatingsystem.md) который ссылается Ассоциация [**\_ инсталледос CIM**](cim-installedos.md) для объекта [**CIM \_ ComputerSystem**](cim-computersystem.md) , описывающего среду. Если значение свойства **фрифисикалмемори** больше или равно значению, указанному в **MemorySize**, условие выполнено.
...
Класс **CIM \_ меморичекк** содержит следующие методы.



| Метод                                                   | Описание                                                   |
|:---------------------------------------------------------|:--------------------------------------------------------------|
| [**Вызвать**](invoke-method-in-class-cim-memorycheck.md) | Выполняет определенное действие. Не реализовано инструментарием WMI.<br/> |
...
Квалификаторы: [**моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**система \_ CIM**](cim-operatingsystem.md)".**Фрифисикалмемори**"), [**единицы**](/windows/desktop/WmiSdk/standard-qualifiers) (" килобайтах ")
</dt> </dl>

Объем памяти, который должен существовать в компьютерной системе для правильного выполнения программного элемента.
...
Класс **CIM \_ меморичекк** наследуется от [**\_ проверки CIM**](cim-check.md).
