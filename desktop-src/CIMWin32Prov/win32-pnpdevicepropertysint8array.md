...
---
# <a name="win32_pnpdevicepropertysint8array-class"></a>\_Класс Win32 PnPDevicePropertySint8Array

Представляет свойство устройства PnP, состоящее из массива элементов **Sint8** .
...
Класс **Win32 \_ PnPDevicePropertySint8Array** имеет следующие типы членов:

-   [Свойства](#properties)

### <a name="properties"></a>Свойства

Класс **Win32 \_ PnPDevicePropertySint8Array** имеет следующие свойства.
