...
ms.locfileid: "122882858"
---
# <a name="cim_softwareelementversioncheck-class"></a>\_Класс CIM софтварилементверсиончекк

Класс **CIM \_ софтварилементверсиончекк** представляет тип программного элемента, который должен существовать в среде. Эта проверка может выполняться для определенного, минимального, максимального или диапазона версий. Чтобы указать конкретную версию, Нижняя и верхняя версии должны быть одинаковыми. Чтобы указать минимальную версию, укажите только более низкую версию. Чтобы указать максимальную версию, укажите только верхнюю версию. Чтобы указать диапазон, необходимо указать как верхную, так и нижнюю версию. Подробные сведения о проверках сравниваются с соответствующими сведениями, найденными в объекте [**CIM \_ софтварилемент**](cim-softwareelement.md) , на который ссылается Ассоциация [**\_ инсталледсофтварилемент CIM**](cim-installedsoftwareelement.md) для объекта [**CIM \_ ComputerSystem**](cim-computersystem.md) . По крайней мере один **CIM \_ софтварилемент** должен удовлетворять сведениям о условии, чтобы проверка была удовлетворена.
...
Класс **CIM \_ софтварилементверсиончекк** имеет следующие типы членов:
...
Класс **CIM \_ софтварилементверсиончекк** содержит следующие методы.
...
Класс **CIM \_ софтварилементверсиончекк** имеет следующие свойства.
...
Если **значение равно true**, то условие должно существовать в среде (например, если файл находится в системе, метод [**Invoke**](invoke-method-in-class-cim-softwareelementversioncheck.md) должен возвращать **значение true**). Если **значение равно false**, условие не должно существовать (например, если файл не находится в системе, метод **Invoke** должен возвращать **значение false**).
...
Квалификаторы: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ софтварилемент**](cim-softwareelement.md).**Версия**")
</dt> </dl>
...
Квалификаторы: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ софтварилемент**](cim-softwareelement.md).**Name**")
</dt> </dl>
...
Квалификаторы: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ софтварилемент**](cim-softwareelement.md).**Софтварилементстате**")
</dt> </dl>
...
Квалификаторы: [**maxlen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**Моделкорреспонденце**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ софтварилемент**](cim-softwareelement.md).**Таржетоператингсистем**")
</dt> </dl>
...
Максимальная версия программного элемента, для которого выполняется проверка.
