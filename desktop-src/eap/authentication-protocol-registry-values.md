...
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Тип           | REG_DWORD                                                                                                                                                                                             |
| Описание    | Указывает, должен ли RAS отображать стандартное диалоговое окно имени пользователя Windows NT или Windows 2000 (значение 1) или вызывать [**расеапжетидентити**](/previous-versions/windows/desktop/api/Raseapif/nf-raseapif-raseapgetidentity) (значение 0). Значение по умолчанию — 1. |
...
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Тип           | REG_DWORD                                                                                                                                                                                  |
| Описание    | Указывает, должен ли RAS отображать стандартное диалоговое окно пароля Windows NT или Windows 2000. Если это значение существует и равно 0, служба RAS не будет отображать диалоговое окно пароля. Значение по умолчанию — 1. |
