...
---
# <a name="creating-a-driverproc-function"></a><span data-ttu-id="2cec0-107">Создание функции Дриверпрок</span><span class="sxs-lookup"><span data-stu-id="2cec0-107">Creating a DriverProc Function</span></span>

<span data-ttu-id="2cec0-108">Создание функции [дриверпрок](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) во многом аналогично созданию процедуры окна.</span><span class="sxs-lookup"><span data-stu-id="2cec0-108">You create a [DriverProc](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) function in much the same way as you create a window procedure.</span></span> <span data-ttu-id="2cec0-109">Функция состоит из оператора **switch** , и каждый вариант обрабатывает данное сообщение драйвера, возвращая значение, указывающее на успешное выполнение или сбой.</span><span class="sxs-lookup"><span data-stu-id="2cec0-109">The function consists of a **switch** statement, and each case processes a given driver message, returning a value indicating success or failure.</span></span> <span data-ttu-id="2cec0-110">Функция **дриверпрок** имеет следующую форму:</span><span class="sxs-lookup"><span data-stu-id="2cec0-110">The **DriverProc** function has the following form:</span></span>
