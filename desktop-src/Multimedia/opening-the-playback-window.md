...
ms.locfileid: "104068585"
---
# <a name="opening-the-playback-window"></a><span data-ttu-id="3b90b-104">Открытие окна воспроизведения</span><span class="sxs-lookup"><span data-stu-id="3b90b-104">Opening the Playback Window</span></span>

<span data-ttu-id="3b90b-105">В следующем примере показано, как использовать команду [**MCI \_ Open**](mci-open.md) , чтобы задать родительское окно и создать дочерний элемент этого окна.</span><span class="sxs-lookup"><span data-stu-id="3b90b-105">The following example shows how to use the [**MCI\_OPEN**](mci-open.md) command to set a parent window and create a child of that window.</span></span>
