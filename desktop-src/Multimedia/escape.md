...
Управляющая команда отправляет сведения об устройстве на устройство. Устройства видеодиск распознают эту команду.
...
<span id="lpszEscape"></span><span id="lpszescape"></span><span id="LPSZESCAPE"></span>*лпсзескапе*
</dt> <dd>

Пользовательские данные для отправки на устройство.
...
Следующая команда отправляет escape-строку "SA" на устройство видеодиск.
