...
ms.locfileid: "118371601"
---
# <a name="reading-from-one-stream-and-writing-to-another"></a>Чтение из одного потока и запись в другой

В следующем примере считываются данные из потока, выполняется что-то с данными, а сжатые данные записываются в поток нового файла.
