...
ms.locfileid: "119804534"
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a>Использование функций редактирования и помещение файла в буфер обмена

В следующем примере показано удаление, копирование или удаление сегментов из массива потоков. Вырезанные и скопированные потоки объединяются в новый файл и помещаются в буфер обмена. В число используемых функций входят [**едитстреамклоне**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**едитстреамкопи**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)и [**едитстреамкут**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).
