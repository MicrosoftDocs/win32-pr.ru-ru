...
ms.locfileid: "119689294"
---
# <a name="recording-with-a-waveform-audio-device"></a>Запись с помощью устройства Waveform-Audio

В следующем примере открывается устройство аудио-сигнала с новым файлом, записями за указанное время, выполняется запись и пользователю предлагается сохранить запись при необходимости. В нем используется функция [**мЦисендкомманд**](/previous-versions//dd757160(v=vs.85)) .
