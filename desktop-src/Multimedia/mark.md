...
keywords:
- команда mark Windows мультимедиа
topic_type:
- apiref
api_name:
- mark
...
| запись | Записывает метку в текущей позиции. Для достижения этой команды может потребоваться, чтобы ВИДЕОМАГНИТОФОН был в режиме воспроизведения или записи.                    |
