...
ms.locfileid: "118372656"
---
# <a name="playing-a-waveform-audio-file"></a>Воспроизведение файла Waveform-Audio

В следующем примере открывается устройство аудио-аудио и воспроизводится звуковой файл с аудио-файлами, заданный параметром *лпсзвавефиленаме* , с помощью функции [**мЦисендкомманд**](/previous-versions//dd757160(v=vs.85)) .
