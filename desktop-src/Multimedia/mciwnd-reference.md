---
title: Справочник по МЦивнд
description: Справочник по МЦивнд
ms.assetid: 11fba6bb-17f1-4fbe-b148-4755a3c6216a
keywords:
- MCI (интерфейс управления мультимедийными файлами), Справочник по МЦивнд
- Класс окна МЦивнд, Справочник
- Окно МЦивнд, справочные материалы
...
В этом разделе описываются функции, сообщения и макросы, связанные с классом окна МЦивнд. Эти элементы группируются следующим образом.
...
## <a name="file-and-device-management"></a>Управление файлами и устройствами
...
## <a name="playback-options"></a>Параметры воспроизведения
...
## <a name="pause-and-resume-playback"></a>Приостановка и возобновление воспроизведения
...
## <a name="image-and-palette-adjustments"></a>Корректировки изображения и палитры
...
## <a name="event-and-error-notification"></a>Событие и уведомление об ошибке
...
## <a name="mci-device-settings"></a>Параметры устройства MCI
...
## <a name="mci-command-string-interface"></a>Интерфейс Command-String MCI
