...
ms.locfileid: "118136608"
---
# <a name="producing-a-dialog-box-for-selecting-a-filter"></a>Создание диалогового окна для выбора фильтра

Приложение может позволить пользователям выбрать произвольную операцию фильтрации и применить ее к данным аудио-сигнала. В следующем примере приложение выделяет буфер для хранения фильтра, а затем использует функцию [**акмфилтерчусе**](/windows/desktop/api/Msacm/nf-msacm-acmfilterchoose) для выбора фильтра. Функции в этом примере должны вызываться с соответствующим фильтром или тегом фильтра.
