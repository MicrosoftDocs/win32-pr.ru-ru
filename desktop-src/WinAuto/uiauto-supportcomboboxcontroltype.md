...
|--------------|--------------|
| <ul><li>ComboBox<ul><li>Edit (0 или 1)</li><li>Список (0 или 1)</li><li>List Item (дочерний для List; 0 или более)</li><li>Button (1)</li></ul></li></ul> | <ul><li>ComboBox<ul><li>List Item (0 или более)</li></ul></li></ul> | 
