...
ms.locfileid: "120098054"
---
# <a name="value-map-annotation-sample"></a>Пример заметки к карте значений

Вырежьте, вставьте и измените следующий пример кода для собственного использования. Следуйте инструкциям в комментариях, помеченных с помощью/ \* TODO \* /.
