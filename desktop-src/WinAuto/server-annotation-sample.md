---
title: Пример аннотации сервера
description: Пример аннотации сервера
...
ms.locfileid: "105710039"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="2ded7-103">Пример аннотации сервера</span><span class="sxs-lookup"><span data-stu-id="2ded7-103">Server Annotation Sample</span></span>

<span data-ttu-id="2ded7-104">Ниже приведен пример аннотации сервера.</span><span class="sxs-lookup"><span data-stu-id="2ded7-104">The following is an example of server annotation.</span></span> <span data-ttu-id="2ded7-105">Следуйте инструкциям в комментариях, помеченных с помощью/ \* TODO \* /.</span><span class="sxs-lookup"><span data-stu-id="2ded7-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
