...
---
# <a name="server-annotation-sample"></a>Пример аннотации сервера

Ниже приведен пример аннотации сервера. Следуйте инструкциям в комментариях, помеченных с помощью/ \* TODO \* /.
