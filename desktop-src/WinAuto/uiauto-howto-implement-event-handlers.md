...
ms.locfileid: "120098384"
---
# <a name="how-to-implement-event-handlers"></a>Реализация обработчиков событий

В этом разделе содержится пример кода, в котором показано, как реализовать интерфейсы, позволяющие клиентам принимать и обслуживать события автоматизации пользовательского интерфейса Майкрософт. В нем рассматриваются следующие темы:

-   [Обработка общих событий автоматизации пользовательского интерфейса](#handling-general-ui-automation-events)
-   [Обработка событий Focus-Changed](#handling-focus-changed-events)
-   [Обработка событий Property-Changed](#handling-property-changed-events)
-   [Обработка событий Structure-Changed](#handling-structure-changed-events)
-   [Связанные темы](#related-topics)

## <a name="handling-general-ui-automation-events"></a>Обработка общих событий автоматизации пользовательского интерфейса

следующий пример кода представляет собой консольное приложение Microsoft Windows, которое реализует обработчик событий автоматизации пользовательского интерфейса для общих событий автоматизации пользовательского интерфейса. Этот пример обрабатывает события создания и уничтожения для всплывающих подсказок и других окон.
...
## <a name="handling-focus-changed-events"></a>Обработка событий Focus-Changed

следующий пример кода представляет собой Windows консольное приложение, которое реализует обработчик для событий изменения фокуса.
...
## <a name="handling-property-changed-events"></a>Обработка событий Property-Changed

следующий пример кода представляет собой Windows консольное приложение, которое реализует обработчик событий изменения свойства.
...
## <a name="handling-structure-changed-events"></a>Обработка событий Structure-Changed

следующий пример кода представляет собой Windows консольное приложение, реализующее обработчик событий изменения структуры.
