...
|--------------|--------------|
| <ul><li>Ползунок<ul><li>Button (2 или 4)</li><li>Бегунок (1)</li><li>ListItem (0 или более)</li></ul></li></ul> | <ul><li>Ползунок<ul><li>ListItem (0 или более)</li></ul></li></ul> | 
...
| [**UIA \_ контролтипепропертид**](uiauto-automation-element-propids.md)                   | **Slider** | Это значение одинаково для всех инфраструктур.                                                                                                                                                                                     |
