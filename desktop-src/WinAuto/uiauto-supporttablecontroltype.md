...
|--------------|--------------|
| <ul><li>Таблица<ul><li>Text (0 или 1)</li><li>Заголовок (0 или более)</li><li>Различные элементы управления (0 или более)</li></ul></li></ul> | <ul><li>Таблица<ul><li>Текст (1 или более)</li><li>Различные элементы управления (0 или более)</li></ul></li></ul> | 
