...
При вызове [**SetFocus**](/windows/desktop/api/UIAutomationClient/nf-uiautomationclient-iuiautomationelement-setfocus) в элементе модели автоматизации пользовательского интерфейса для элемента данных обозреватель Microsoft Windows Explorer возвращается успешно и заставляет фокус быть установленным элементом управления редактирования в поддереве элемента данных.
