...
Чтобы внести исправления в файл ресурсов, можно либо изменить файл напрямую, либо воспользоваться инструментом «порядок табуляции» в Microsoft Visual Studio. для доступа к средству выбора порядка табуляции в Visual Studio можно нажать клавиши CTRL + D или выбрать **последовательность табуляции** в меню **формат** .
