...
| Имя атрибута, понятное имя                             | Тип     | Эквивалент CSS              | Эквивалентный TOM                                            | Комментировать                   |
|-----------------------------------------------------------|----------|-----------------------------|-----------------------------------------------------------|---------------------------|
| \_Стиль шрифта \_ : полужирный, полужирный<br/>                        | Логическое значение VT \_ | Шрифт-вес: полужирный           | Полужирный                                                      |                           |
...
| \_Цвет стиля шрифта \_ , цвет<br/>                       | VT \_ I4   | Color                       | ForeColor                                                 | Стиль COLORREF РБГ        |
