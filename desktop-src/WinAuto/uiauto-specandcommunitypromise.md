...
© Корпорация Майкрософт (Microsoft Corporation). Все права защищены. Разрешение на копирование, отображение и распространение этого документа доступно в статье [Модель автоматизации пользовательского интерфейса](uiauto-specandcommunitypromise.md).
...
## <a name="ui-automation-community-promise"></a>Обязательство сообщества по автоматизации пользовательского интерфейса
