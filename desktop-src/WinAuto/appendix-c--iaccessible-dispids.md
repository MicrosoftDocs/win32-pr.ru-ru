...
ms.locfileid: "119998884"
---
# <a name="appendix-c-iaccessible-dispids"></a>Приложение в. идентификаторы DISPID

DISPID позволяет реализовать интерфейс [**IDispatch**](idispatch-interface.md) для поиска различных методов и свойств сдвоенного интерфейса.
