...
Панель приложения — это элемент пользовательского интерфейса, который предоставляет пользователю навигацию, команды и средства. Для приложений Магазина Windows можно отобразить панели приложений для приложений, нажав клавиши Windows + Z.
