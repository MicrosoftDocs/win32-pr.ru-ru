...
| [Защита потока управления (CFG)](control-flow-guard.md)<br/>                                                                | Обсуждаются уязвимости повреждения памяти.<br/>                                                                                                                                    |
...
| [Оптимизация поиска в библиотеке MSDN](how-to-optimize-your-msdn-library-search.md)<br/>                          | Описывает варианты поиска содержимого пакета SDK для системы безопасности в библиотеке MSDN.<br/>                                                                                                           |
