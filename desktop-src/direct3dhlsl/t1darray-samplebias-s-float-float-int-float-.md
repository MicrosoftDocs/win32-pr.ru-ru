...
---
# <a name="samplebiassamplebiassfloatfloatintfloat-function-for-texture1darray"></a>Функция Самплебиас:: Самплебиас (S, float, float, int, float) для Texture1DArray
...
[Методы Самплебиас](texture1darray-samplebias.md)
</dt> </dl>
