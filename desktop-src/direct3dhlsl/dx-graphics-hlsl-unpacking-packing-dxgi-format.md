...
> Заголовок D3DX \_ дксгиформатконверт. inl поставляется в устаревшей версии пакета SDK DirectX. Он также включен в пакет NuGet [Microsoft. дкссдк. D3DX](https://www.nuget.org/packages/Microsoft.DXSDK.D3DX) .
