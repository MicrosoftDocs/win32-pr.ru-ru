...
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2d"></a>Функция Самплебиас:: Самплебиас (S, float, float, int, float, uint) для Texture2D

Пример [**Texture2D**](sm5-object-texture2d.md). После применения значения смещения к уровню mipmap с необязательным значением для создания среза образца уровня детализации (Лод) до значения. Возвращает состояние операции.
