...
---
# <a name="flow-control-limitations"></a>Ограничения управления потоком
...
-   [Взаимодействие элемента управления потоком Per-Pixel с градиентами экрана](#interaction-of-per-pixel-flow-control-with-screen-gradients)
...
## <a name="interaction-of-per-pixel-flow-control-with-screen-gradients"></a>Взаимодействие элемента управления потоком Per-Pixel с градиентами экрана
...
-   Сценарий а. операции, которые не разрешены внутри управления потоком, которые могут различаться в пикселах примитива. К ним относятся операции, перечисленные в следующей таблице. 
    ...
    | Инструкция                                                                                                      | Допускается в управлении потоком в следующих случаях:                       |
    |------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------|
