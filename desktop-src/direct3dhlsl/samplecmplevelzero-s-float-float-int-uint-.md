...
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatintuint-function-for-texture2d"></a>Функция Самплекмплевелзеро:: Самплекмплевелзеро (S, float, float, int, uint) для Texture2D

Пример [**Texture2D**](sm5-object-texture2d.md) только для mipmap уровня 0 и сравнивает результат со значением сравнения. Возвращает состояние операции.
...
[Методы Самплекмплевелзеро](texture2d-samplecmplevelzero.md)
</dt> </dl>
