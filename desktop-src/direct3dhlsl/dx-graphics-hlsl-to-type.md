...
<td><p>Необязательный элемент. Любой <a href="dx-graphics-hlsl-scalar.md">скалярный тип HLSL</a> или <a href="dx-graphics-hlsl-vector.md"><strong>тип HLSL Vector</strong></a>, заключенный в угловые скобки. Тип по умолчанию — <strong>float4</strong>.</p></td>
</tr>
<tr class="odd">
