...
---
# <a name="endswitch-sm4---asm"></a>ендсвитч (SM4-ASM)

Завершает оператор [switch](switch--sm4---asm-.md) .
...
Формат маркера содержит смещение соответствующей инструкции switch в шейдере для удобства.
