...
ms.locfileid: "118510293"
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture2d"></a>Функция Самплелевел:: Самплелевел (S, float, float, int, uint) для Texture2D

Пример [**Texture2D**](sm5-object-texture2d.md) на указанном уровне mipmap и возвращает состояние операции.
...
[Методы Самплелевел](texture2d-samplelevel.md)
</dt> </dl>
