...
ms.locfileid: "117724309"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture1d"></a>Функция Самплекмп:: Самплекмп (S, float, float, int, float, uint) для Texture1D
