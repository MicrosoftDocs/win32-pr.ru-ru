...
Возвращает обратную величину квадратного корня указанного значения.
...
Обратная часть квадратного корня параметра *x* .

## <a name="remarks"></a>Примечания

Эта функция использует следующую формулу: 1/ **sqrt**(*x*).
