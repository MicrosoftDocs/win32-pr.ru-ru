...
-   Управление потоком. Эти инструкции добавляют возможности управления потоком, такие как [цикл](loop---vs.md)... [ендлуп](endloop---vs.md), [If](if-bool---vs.md)... [else](else---vs.md)... запросы [endif — VS](endif---vs.md)и подпрограмм.
...
| Имя                                                                           | Описание                                                                                                     | Слоты инструкций | Настройка | Арифметические | Управление потоком | Оператор new |
|--------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------|-------------------|-------|------------|--------------|-----|
