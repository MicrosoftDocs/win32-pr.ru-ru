...
|                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Различия между Direct3D 9 и Direct3D 10:<br/> В Direct3D 9 каждая единица шейдера имела один и небольшой файл регистра констант для хранения всех переменных шейдера констант. Разведение всех шейдеров с ограниченным пространством, необходимым для частого перезапуска констант с помощью ЦП.<br/> В Direct3D 10 константы хранятся в неизменяемых буферах в памяти и управляются как любые другие ресурсы. Количество буферов констант, которые может создать приложение, не ограничено. Организуя константы в буферы по частоте обновления и использования, объем пропускной способности, необходимый для обновления констант в соответствии со всеми шейдерами, может значительно снизиться.<br/> |
