...
|--------------------------------------------|--------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| VS \_ 2 \_ SW, VS \_ 3 \_ SW, PS \_ 2 \_ SW, PS \_ 3 \_ SW | Число инструкций                   | Без ограничений                                                                                                                         |
...
| PS \_ 2 \_ SW                                  | Глубина зависимого чтения                 | Без ограничений                                                                                                                         |
| VS \_ 2 \_ SW                                  | инструкции и метки управления потоком | Без ограничений                                                                                                                         |
