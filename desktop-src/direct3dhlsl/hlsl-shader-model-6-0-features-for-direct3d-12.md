...
| **Термин** | **Определение** |
|-|-|
| Полоса | Один поток выполнения. Модели шейдеров до версии 6,0 предоставляют только один из них на уровне языка, благодаря чему расширение параллельной обработки SIMD полностью достигает реализации. |
