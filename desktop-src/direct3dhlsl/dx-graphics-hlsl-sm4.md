...
|---------|------------|
| Набор инструкций | <a href="dx-graphics-hlsl-intrinsic-functions.md"><strong>Функции HLSL</strong></a> | 
| Набор регистров | Набор регистров доступен через члены в постоянных и текстурных буферах с использованием семантики HLSL для таких операций, как упаковка компонентов.<ul><li>Регистры шейдеров пикселей (см. раздел <a href="dx-graphics-hlsl-sm4-registers-ps-4-0.md">регистры-ps_4_0</a> и <a href="dx-graphics-hlsl-sm4-registers-ps-4-1.md">регистры-ps_4_1</a>)</li><li>Регистры шейдеров вершин (см. раздел <a href="dx-graphics-hlsl-sm4-registers-vs-4-0.md">регистры-vs_4_0</a> и <a href="dx-graphics-hlsl-sm4-registers-vs-4-1.md">регистры-vs_4_1</a>)</li><li>Регистры шейдеров Geometry (см. раздел <a href="dx-graphics-hlsl-sm4-registers-gs-4-0.md">регистры-gs_4_0</a> и <a href="dx-graphics-hlsl-sm4-registers-gs-4-1.md">регистры-gs_4_1</a>)</li></ul> | 
