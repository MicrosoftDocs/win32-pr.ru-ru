...
ms.locfileid: "117726262"
---
# <a name="frac"></a>фрак

Возвращает дробную (или десятичную) часть x; значение больше или равно 0 и меньше 1.

См. также [TRUNC](./dx-graphics-hlsl-trunc.md).
