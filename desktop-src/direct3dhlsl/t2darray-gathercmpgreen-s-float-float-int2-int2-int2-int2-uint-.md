...
ms.locfileid: "119788244"
---
# <a name="texture2darraygathercmpgreensfloatfloatint2int2int2int2uint-function"></a>Функция Texture2DArray:: Гасеркмпгрин (S, float, float, int2, int2, int2, int2, uint)
