...
ms.locfileid: "117725472"
---
# <a name="texcubeproj"></a>текскубепрож

Выберет текстуру Куба с помощью проектного деления; Координата текстуры делится на t. w до того, как происходит поиск.



| RET Текскубепрож (s, t) |
|-----------------------|
