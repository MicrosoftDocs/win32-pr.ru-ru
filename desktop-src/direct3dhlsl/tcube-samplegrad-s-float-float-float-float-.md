...
---
# <a name="samplegradsamplegradsfloatfloatfloatfloat-function-for-texturecube"></a>Функция Самплеград:: Самплеград (S, float, float, float, float) для Текстурекубе
...
[Методы Самплеград](texturecube-samplegrad.md)
</dt> <dt>
