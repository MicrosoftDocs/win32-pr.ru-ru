...
|                                                                                                                                                                                                                                                                                                        |
|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Различия между Direct3D 9 и Direct3D 10 и 11:<br/> В отличие от автоматического выделения констант в Direct3D 9, которые не выполняли упаковку и назначают каждую переменную набору регистров float4, переменные константы HLSL следуют правилам упаковки в Direct3D 10 и 11.<br/> |
