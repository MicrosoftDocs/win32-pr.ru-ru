...
Компонентно-ориентированное векторное число меньше, чем сравнение.



| илт dest \[ . Mask \] , src0 \[ . свиззле \] , src1 \[ . свиззле\] |
|-------------------------------------------------------|
...
| Элемент                                                            | Описание                                       |
|-----------------------------------------------------------------|---------------------------------------------------|
| <span id="dest"></span><span id="DEST"></span>*dest*<br/> | Результат операции.<br/>           |
