...
ms.locfileid: "118285024"
---
# <a name="texture2dgathercmpbluesfloatfloatint2int2int2int2-function"></a>Функция Texture2D:: Гасеркмпблуе (S, float, float, int2, int2, int2, int2)
