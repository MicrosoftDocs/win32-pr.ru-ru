...
| Имя |  Type              | Версия 1 \_ 1 | Версия 1 \_ 2      | Версия 1 \_ 3     | Версия 1 \_ 4             |
|------|--------------------|----------|------|------|--------------|
| c\#  | Регистр констант  | 8        | 8    | 8    | 8            |
| Cерверный\#  | Временный регистр | 2        | 2    | 2    | 6            |
| t\#  | Регистр текстуры   | 4        | 4    | 4    | 6            |
| 3,3\#  | Регистр цвета     | 2        | 2    | 2    | 2 на этапе 2 |
...
| 3,3\#  | Регистр цвета     | от 0 до 1                                              | Все версии |
