---
title: Схема WinSAT
description: Для определения допустимых запросов XPath можно использовать схему средства оценки системы Windows (WinSAT).
...
ms.locfileid: "103888011"
---
# <a name="winsat-schema"></a><span data-ttu-id="42e2d-103">Схема WinSAT</span><span class="sxs-lookup"><span data-stu-id="42e2d-103">WinSAT Schema</span></span>

<span data-ttu-id="42e2d-104">\[Перечисления WinSAT могут быть изменены или недоступны для выпусков после Windows 8.1.\]</span><span class="sxs-lookup"><span data-stu-id="42e2d-104">\[WinSAT enumerations may be altered or unavailable for releases after Windows 8.1.\]</span></span>

<span data-ttu-id="42e2d-105">Для определения допустимых запросов XPath можно использовать схему средства оценки системы Windows (WinSAT).</span><span class="sxs-lookup"><span data-stu-id="42e2d-105">You can use the Windows System Assessment Tool (WinSAT) schema to determine valid XPath queries to run.</span></span> <span data-ttu-id="42e2d-106">Чтобы выполнить запрос XPath, ознакомьтесь с одним из следующих методов.</span><span class="sxs-lookup"><span data-stu-id="42e2d-106">To run an XPath query, see one of the following methods:</span></span>

-   [<span data-ttu-id="42e2d-107">**Икуеряллвинсатассессментс:: Get \_ аллксмл**</span><span class="sxs-lookup"><span data-stu-id="42e2d-107">**IQueryAllWinSATAssessments::get\_AllXML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml)
-   [<span data-ttu-id="42e2d-108">**Икуерирецентвинсатассессмент:: Get \_ XML**</span><span class="sxs-lookup"><span data-stu-id="42e2d-108">**IQueryRecentWinSATAssessment::get\_XML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryrecentwinsatassessment-get_xml)

<span data-ttu-id="42e2d-109">Элемент **WinSAT** может иметь элемент **винсатассессментс** в качестве родительского элемента при вызове метода [**Get \_ аллксмл**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) .</span><span class="sxs-lookup"><span data-stu-id="42e2d-109">The **WinSAT** element can have a **WinsatAssessments** element as a parent element when you call the [**get\_AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) method.</span></span>

<span data-ttu-id="42e2d-110">Ниже приведена схема WinSAT, которую можно использовать для определения XPath.</span><span class="sxs-lookup"><span data-stu-id="42e2d-110">The following is the WinSAT schema that you can use to determine the XPath.</span></span>
